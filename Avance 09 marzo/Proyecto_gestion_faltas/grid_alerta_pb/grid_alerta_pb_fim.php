...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____grid_alerta_pb"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____grid_alerta_pb"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_alerta_pb']['embutida_filho'] as $ind => $sc_init)
          {
