...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____tabs_alertas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____tabs_alertas"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_alertas']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_alertas']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tabs_alertas']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tabs_alertas']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tabs_alertas']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tabs_alertas']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tabs_alertas']['aba_saida']);
       $fecha_modal = true;
   }
