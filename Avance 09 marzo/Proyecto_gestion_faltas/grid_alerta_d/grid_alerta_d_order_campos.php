...
<?php
   ...
   $Ord_Cmp = new grid_alerta_d_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_alerta_d_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["practitioners_practitioner_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["practitioners_practitioner_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["practitioners_practitioner_id"] : "Nombre y apellido";
   ...
   $tab_labels["practitioners_area_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["practitioners_area_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["practitioners_area_id"] : "Área";
...
WHERE
   ...
   $tab_labels["leve"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["leve"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["leve"] : "Leve";
   ...
   {
       $tab_def_campos['moderada'] = "SELECT
    COUNT(fl.fault_list_id) AS cantidad_fault_type_id_1
FROM
    faults_list AS fl
JOIN
...
WHERE
   ...
   $tab_labels["moderada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["moderada"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["moderada"] : "Moderada";
...
WHERE
   ...
   $tab_labels["grave"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["grave"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["grave"] : "Grave";
...
GROUP BY
   ...
   $tab_labels["alerta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["alerta"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['labels']["alerta"] : "Alerta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_alerta_d_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_alerta_d']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
