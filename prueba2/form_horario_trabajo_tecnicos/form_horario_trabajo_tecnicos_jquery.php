...
function scEventControl_onFocus(oField, iSeq) {
  ...
  if ("dia_semana_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
  if ("id_tecnico_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_horario_trabajo_tecnicos_' + iSeqRow).bind('change', function() { sc_form_horario_trabajo_tecnicos_id_horario_trabajo_tecnicos__onchange(this, iSeqRow) });
  $('#id_sc_field_id_tecnico_' + iSeqRow).bind('change', function() { sc_form_horario_trabajo_tecnicos_id_tecnico__onchange(this, iSeqRow) });
  $('#id_sc_field_dia_semana_' + iSeqRow).bind('blur', function() { sc_form_horario_trabajo_tecnicos_dia_semana__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_horario_trabajo_tecnicos_dia_semana__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_horario_trabajo_tecnicos_dia_semana__onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_inicial_' + iSeqRow).bind('blur', function() { sc_form_horario_trabajo_tecnicos_hora_inicial__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_horario_trabajo_tecnicos_hora_inicial__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_horario_trabajo_tecnicos_hora_inicial__onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_final_' + iSeqRow).bind('blur', function() { sc_form_horario_trabajo_tecnicos_hora_final__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_horario_trabajo_tecnicos_hora_final__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_horario_trabajo_tecnicos_hora_final__onfocus(this, iSeqRow) });
  $('#id_sc_field_md_dias_' + iSeqRow).bind('change', function() { sc_form_horario_trabajo_tecnicos_md_dias__onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_horario_trabajo_tecnicos_id_horario_trabajo_tecnicos__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_horario_trabajo_tecnicos_id_tecnico__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_horario_trabajo_tecnicos_dia_semana__onblur(oThis, iSeqRow) {
  do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_dia_semana__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_dia_semana__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_inicial__onblur(oThis, iSeqRow) {
  do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_inicial__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_inicial__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_final__onblur(oThis, iSeqRow) {
  do_ajax_form_horario_trabajo_tecnicos_validate_hora_final_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_final__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_hora_final__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_horario_trabajo_tecnicos_md_dias__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_horario_trabajo_tecnicos_form" + pageNo).hide();
}
...
{
    $.ajax({
        url: "form_horario_trabajo_tecnicos.php",
        dataType: "json",
        method: "POST",
        data: {
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_horario_trabajo_tecnicos')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
