...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['estado_actual']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['estado_actual']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['estado_actual'];
      }
   }
