   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_estado' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_order'] ['ag_estado'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_display'] ['ag_estado'] [$metricIndex] ['display']) {
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_array_resumo'] == "OK")
      {
          ...
          $this->array_total_estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['estado_actual'];
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_estado']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_estado'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_estado'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_estado'] as $i_sum => $d_sum)
           {
