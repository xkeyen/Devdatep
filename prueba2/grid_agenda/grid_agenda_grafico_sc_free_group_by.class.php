...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $prep_label['fecha_inicial_scgb_19'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "";
      $prep_label['valor_total'] = "Valor Total";
      $prep_label['estado_actual'] = "Estado Actual";
      $prep_label['id_tecnico'] = "Id Tecnico";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $this->label[$x] = $prep_label[$cmp_gb];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
