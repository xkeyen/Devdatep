   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'ag_mensual';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_mensual' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'ag_mensual';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_order'] ['ag_mensual'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_display'] ['ag_mensual'] [$metricIndex] ['display']) {
...
SCEOT;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                ...
                $this->array_line_fecha_inicial_scgb_40 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total_line']['fecha_inicial_scgb_40'];
            }
          $this->array_total_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['fecha_inicial'];
          $this->array_total_fecha_inicial_scgb_40 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['fecha_inicial_scgb_40'];
      ...
      else
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['fecha_inicial_scgb_40'] = $this->array_total_fecha_inicial_scgb_40;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total_line']['fecha_inicial_scgb_40'] = $this->array_line_fecha_inicial_scgb_40;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['fecha_inicial_scgb_40'] = $Lab_fecha_inicial_scgb_40; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['ag_mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['ag_mensual'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_geral[1][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][3];
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][4];
      ...
      if ($this->Tem_Res_Compara) {
          ...
          $this->array_total_geral[2][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][3];
          $this->array_total_geral[2][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][4];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
