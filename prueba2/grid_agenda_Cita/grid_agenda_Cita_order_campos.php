<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_agenda_Cita']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_agenda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_agenda"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_agenda"] : "Id Agenda";
   $tab_ger_campos['fecha_inicial'] = "on";
   $tab_def_campos['fecha_inicial'] = "fecha_inicial";
   $tab_labels["fecha_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["fecha_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["fecha_inicial"] : "Fecha Inicial";
   $tab_ger_campos['hora_inicial'] = "on";
   $tab_def_campos['hora_inicial'] = "hora_inicial";
   $tab_labels["hora_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["hora_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["hora_inicial"] : "Hora Inicial";
   $tab_ger_campos['estado_actual'] = "on";
   $tab_def_campos['estado_actual'] = "estado_actual";
   $tab_labels["estado_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["estado_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["estado_actual"] : "Estado Actual";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_cliente"] : "Id Cliente";
   $tab_ger_campos['evaluacion'] = "on";
   $tab_def_campos['evaluacion'] = "evaluacion";
   $tab_labels["evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["evaluacion"] : "Evaluacion";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["valor"] : "Valor";
   $tab_ger_campos['costes_adicionales'] = "on";
   $tab_def_campos['costes_adicionales'] = "costes_adicionales";
   $tab_labels["costes_adicionales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["costes_adicionales"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["costes_adicionales"] : "Costes Adicionales";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["descuento"] : "Descuento";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["valor_total"] : "Valor Total";
   $tab_ger_campos['id_tecnico'] = "on";
   $tab_def_campos['id_tecnico'] = "id_tecnico";
   $tab_labels["id_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_Cita']['labels']["id_tecnico"] : "Id Tecnico";
