...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_id_cliente_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_clientes_id_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_nombre_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_nombre_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_telefono_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_telefono_cliente_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_clientes_telefono_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_direccion_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_direccion_cliente_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_clientes_direccion_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ciudad_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_ciudad_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_ciudad_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_distrito_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_distrito_cliente_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_clientes_distrito_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_postal_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_postal_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_postal_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_usuario_login' + iSeqRow).bind('blur', function() { sc_form_clientes_usuario_login_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_clientes_usuario_login_onchange(this, iSeqRow) })
...
function sc_form_clientes_nombre_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clientes_telefono_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clientes_direccion_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clientes_ciudad_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clientes_distrito_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clientes_postal_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
