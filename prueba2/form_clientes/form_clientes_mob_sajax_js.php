...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_mob_submit_form(var_id_cliente, var_nombre_cliente, var_email_cliente, var_telefono_cliente, var_direccion_cliente, var_pais_cliente, var_ciudad_cliente, var_distrito_cliente, var_postal_cliente, var_usuario_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_mob_submit_form_cb);
