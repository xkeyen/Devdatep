...
<?php
   ...
   $Ord_Cmp = new grid_tecnicos_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tecnicos_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['nombre_tecnico'] = "nombre_tecnico";
   $tab_labels["nombre_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["nombre_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["nombre_tecnico"] : "Nombre Tecnico";
   $tab_ger_campos['email_tecnico'] = "on";
   $tab_def_campos['email_tecnico'] = "email_tecnico";
   $tab_labels["email_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["email_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["email_tecnico"] : "Email Tecnico";
   $tab_ger_campos['telefono_tecnico'] = "on";
   $tab_def_campos['telefono_tecnico'] = "telefono_tecnico";
   $tab_labels["telefono_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["telefono_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['labels']["telefono_tecnico"] : "Telefono Tecnico";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tecnicos_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tecnicos_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
