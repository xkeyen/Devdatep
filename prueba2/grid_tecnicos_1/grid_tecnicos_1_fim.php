...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba2_____grid_tecnicos_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba2_____grid_tecnicos_1"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tecnicos_1'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tecnicos_1']['embutida_filho'] as $ind => $sc_init)
          {
