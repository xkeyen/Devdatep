...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_pais_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_pais_ini.php");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pais']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_ciudades_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_ciudades_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ciudades']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_ciudades'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_clientes_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_clientes_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
$menu_menuData['data'] = array();
$str_disabled = 'N';
$str_label = "" . $this->Nm_lang['lang_menu_ajustes'] . "";
$str_hint = "";
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pais']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pais']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menu_menuData['data']['itens']['item_1']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_pais&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ciudades']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ciudades']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menu_menuData['data']['itens']['item_1']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_ciudades&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
$str_label = "" . $this->Nm_lang['lang_menu_ayuda'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menu_menuData['data']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-question",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'icon_check'     => "S",
                                                  'id'     => "item_2",
...
$menu_menuData['data']['itens']['item_2']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=https://www.scriptcase.ne&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "blank",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
$str_label = "" . $this->Nm_lang['lang_menu_salir'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menu_menuData['data']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
...
$menu_menuData['data']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
<div id='main_menu_table' class='scMenuHMoldura'>
    ...
    <div id="Iframe_control" style=''>
      <iframe id="iframe_menu" name="menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "https://scriptcaseblog.net/es/"); ?> " ></iframe>
<?php
...
function writeHtmlIframeControlRec($arr_itens)
{
    ...
    {
        ?>
        <iframe id="iframe_<?php echo $id; ?>" name="menu_<?php echo $id; ?>_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: ;" src=""></iframe>
        <?php
        if(isset($item['itens']) && !empty($item['itens']))
        {
...
function menu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"dark-cobalt","layout":"H","header_string":"","header_string_pos":"H","check_split":"S","check_toolbar":"S","check_show_search_path":"S","check_shortcut_label":"S","check_start_expanded":"S","check_use_loader":"N","should_reload":"S","layout_usr_pos":"out","usercheck":"S","username":"","userimage":"","userdesc":"","logo":"..\/_lib\/img\/grp__NM__menu_img__NM__logoLimpioBe.png","logo_compact":"","pick_themes":["dark-cobalt","dark-coffee"],"shortcuts":[],"items":[{"text":"{lang_menu_ajustes}","app":"","icon":"fas fa-cog","icon_check":"S","id":"item_1","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Paises","app":"grid_pais","icon":"fas fa-file","icon_check":"S","id":"item_4","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Ciudades","app":"grid_ciudades","icon":"fas fa-file","icon_check":"S","id":"item_5","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"},{"text":"{lang_menu_ayuda}","app":"","icon":"fas fa-question","icon_check":"S","id":"item_2","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Soporte","app":"https:\/\/www.scriptcase.ne","icon":"fas fa-file","icon_check":"S","id":"item_6","hint":"","link_target":"blank","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"},{"text":"{lang_menu_salir}","app":"","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_3","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Clientes","app":"grid_clientes","icon":"fas fa-file","icon_check":"S","id":"item_7","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"user_items":[],"tb_items":[{"text":"B\u00fasqueda","app":"search","icon":"fas fa-search","icon_check":"S","display":"S","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"S","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"S","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Atajos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"S","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"}]}', true);
    ...
    $apl_default = 'https://scriptcaseblog.net/es/';
    ...
    <div class="container-row">
      <div class="wrapper">
        <div class="logo"><a id="sc-menu-link-home" href="./"><span class="only-sr">Scriptcase menubar home </span><img
              class="d-none xl:d-block" src="<?php echo "../_lib/img/grp__NM__menu_img__NM__logoLimpioBe.png"; ?>"
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu") {
        ...
        if (isset($_COOKIE['sc_actual_lang_prueba2'])) {
            $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_prueba2'];
        }
    }
}
