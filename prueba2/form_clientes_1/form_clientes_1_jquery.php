...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_id_cliente_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_clientes_1_id_cliente_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_clientes_1_id_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_nombre_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_1_nombre_cliente_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_clientes_1_nombre_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_email_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_email_cliente_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_clientes_1_email_cliente_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_clientes_1_email_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefono_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_telefono_cliente_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_clientes_1_telefono_cliente_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_clientes_1_telefono_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_direccion_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_direccion_cliente_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_clientes_1_direccion_cliente_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_clientes_1_direccion_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_ciudad_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_ciudad_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_1_ciudad_cliente_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_clientes_1_ciudad_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_distrito_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_distrito_cliente_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_clientes_1_distrito_cliente_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_clientes_1_distrito_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_pais_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_pais_cliente_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_clientes_1_pais_cliente_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_1_pais_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_postal_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_1_postal_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_clientes_1_postal_cliente_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_clientes_1_postal_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario_login' + iSeqRow).bind('blur', function() { sc_form_clientes_1_usuario_login_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_clientes_1_usuario_login_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_clientes_1_usuario_login_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_clientes_1_id_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_id_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_id_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_id_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_nombre_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_nombre_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_nombre_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_nombre_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_email_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_email_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_email_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_email_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_telefono_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_telefono_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_telefono_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_telefono_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_direccion_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_direccion_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_direccion_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_direccion_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_ciudad_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_ciudad_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_ciudad_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_ciudad_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_distrito_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_distrito_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_distrito_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_distrito_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_pais_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_pais_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_pais_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_pais_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_postal_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_postal_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_1_postal_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_postal_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_1_usuario_login_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_1_validate_usuario_login();
  scCssBlur(oThis);
}

function sc_form_clientes_1_usuario_login_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clientes_1_usuario_login_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_clientes_1_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_clientes_1')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
