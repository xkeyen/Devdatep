...
class grid_tecnicos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tecnicos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tecnicos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tecnicos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono_tecnico')
      {
          $telefono_tecnico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono_tecnico($telefono_tecnico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_tecnico')
      {
          $nombre_tecnico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_tecnico($nombre_tecnico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_email_tecnico')
      {
          $email_tecnico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_email_tecnico($email_tecnico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tecnicos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tecnicos/grid_tecnicos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_tecnicos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tecnicos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tecnicos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tecnicos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tecnicos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_telefono_tecnico_cond#NMF#' + search_get_sel_txt('SC_telefono_tecnico_cond') + '@NMF@';
  str_out += 'SC_telefono_tecnico#NMF#' + search_get_text('SC_telefono_tecnico') + '@NMF@';
  str_out += 'id_ac_telefono_tecnico#NMF#' + search_get_text('id_ac_telefono_tecnico') + '@NMF@';
  str_out += 'SC_id_tecnico_cond#NMF#' + search_get_sel_txt('SC_id_tecnico_cond') + '@NMF@';
  str_out += 'SC_id_tecnico#NMF#' + search_get_text('SC_id_tecnico') + '@NMF@';
  str_out += 'SC_nombre_tecnico_cond#NMF#' + search_get_sel_txt('SC_nombre_tecnico_cond') + '@NMF@';
  str_out += 'SC_nombre_tecnico#NMF#' + search_get_text('SC_nombre_tecnico') + '@NMF@';
  str_out += 'id_ac_nombre_tecnico#NMF#' + search_get_text('id_ac_nombre_tecnico') + '@NMF@';
  str_out += 'SC_email_tecnico_cond#NMF#' + search_get_sel_txt('SC_email_tecnico_cond') + '@NMF@';
  str_out += 'SC_email_tecnico#NMF#' + search_get_text('SC_email_tecnico') + '@NMF@';
  str_out += 'id_ac_email_tecnico#NMF#' + search_get_text('id_ac_email_tecnico') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nombre_tecnico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombre_tecnico").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_tecnico",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nombre_tecnico").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_tecnico").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_email_tecnico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_email_tecnico").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_email_tecnico",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_email_tecnico").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_email_tecnico").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_telefono_tecnico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_telefono_tecnico").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono_tecnico",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_telefono_tecnico").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_telefono_tecnico").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $telefono_tecnico_cond, $telefono_tecnico, $telefono_tecnico_autocomp,
             $id_tecnico_cond, $id_tecnico,
             $nombre_tecnico_cond, $nombre_tecnico, $nombre_tecnico_autocomp,
             $email_tecnico_cond, $email_tecnico, $email_tecnico_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $telefono_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['telefono_tecnico']; 
          $telefono_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['telefono_tecnico_cond']; 
          $id_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['id_tecnico']; 
          $id_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['id_tecnico_cond']; 
          $nombre_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nombre_tecnico']; 
          $nombre_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nombre_tecnico_cond']; 
          $email_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['email_tecnico']; 
          $email_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['email_tecnico_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['NM_operador']; 
          if (strtoupper($id_tecnico_cond) != "II" && strtoupper($id_tecnico_cond) != "QP" && strtoupper($id_tecnico_cond) != "NP" && strtoupper($id_tecnico_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_tecnico, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($telefono_tecnico_cond) || empty($telefono_tecnico_cond))
      {
         $telefono_tecnico_cond = "qp";
      }
      if (!isset($id_tecnico_cond) || empty($id_tecnico_cond))
      {
         $id_tecnico_cond = "gt";
      }
      if (!isset($nombre_tecnico_cond) || empty($nombre_tecnico_cond))
      {
         $nombre_tecnico_cond = "qp";
      }
      if (!isset($email_tecnico_cond) || empty($email_tecnico_cond))
      {
         $email_tecnico_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_telefono_tecnico = (in_array($telefono_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_tecnico = (in_array($id_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_tecnico = (in_array($nombre_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_email_tecnico = (in_array($email_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($telefono_tecnico) || $telefono_tecnico == "")
      {
          $telefono_tecnico = "";
      }
      if (isset($telefono_tecnico) && !empty($telefono_tecnico))
      {
         $tmp_pos = (is_string($telefono_tecnico)) ? strpos($telefono_tecnico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono_tecnico = substr($telefono_tecnico, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nombre_tecnico) || $nombre_tecnico == "")
      {
          $nombre_tecnico = "";
      }
      if (isset($nombre_tecnico) && !empty($nombre_tecnico))
      {
         $tmp_pos = (is_string($nombre_tecnico)) ? strpos($nombre_tecnico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_tecnico = substr($nombre_tecnico, 0, $tmp_pos);
         }
      }
      if (!isset($email_tecnico) || $email_tecnico == "")
      {
          $email_tecnico = "";
      }
      if (isset($email_tecnico) && !empty($email_tecnico))
      {
         $tmp_pos = (is_string($email_tecnico)) ? strpos($email_tecnico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $email_tecnico = substr($email_tecnico, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_telefono_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['telefono_tecnico'])) ? $this->New_label['telefono_tecnico'] : "Telefono Tecnico"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_telefono_tecnico_cond" name="telefono_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_tecnico'), this, 'telefono_tecnico')">
       <OPTION value="qp" <?php if ("qp" == $telefono_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono_tecnico" <?php echo $str_hide_telefono_tecnico?> valign="top">
 ...
 $nmgp_tab_label .= "telefono_tecnico?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $telefono_tecnico;
      }
?>
<INPUT  type="text" id="SC_telefono_tecnico" name="telefono_tecnico" value="<?php echo NM_encode_input($telefono_tecnico) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_telefono_tecnico" name="telefono_tecnico_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_id_tecnico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_tecnico'])) ? $this->New_label['id_tecnico'] : "Id Tecnico"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_tecnico_cond" name="id_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_tecnico'), this, 'id_tecnico')">
       <OPTION value="gt" <?php if ("gt" == $id_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
...
?>
<INPUT  type="text" id="SC_id_tecnico" name="id_tecnico" value="<?php echo NM_encode_input($id_tecnico) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nombre_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_tecnico'])) ? $this->New_label['nombre_tecnico'] : "Nombre Tecnico"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_tecnico_cond" name="nombre_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_tecnico'), this, 'nombre_tecnico')">
       <OPTION value="qp" <?php if ("qp" == $nombre_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_tecnico" <?php echo $str_hide_nombre_tecnico?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombre_tecnico'])) ? $this->New_label['nombre_tecnico'] : "Nombre Tecnico";
 $nmgp_tab_label .= "nombre_tecnico?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nombre_tecnico;
      }
?>
<INPUT  type="text" id="SC_nombre_tecnico" name="nombre_tecnico" value="<?php echo NM_encode_input($nombre_tecnico) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_tecnico" name="nombre_tecnico_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_email_tecnico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['email_tecnico'])) ? $this->New_label['email_tecnico'] : "Email Tecnico"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_email_tecnico_cond" name="email_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_email_tecnico'), this, 'email_tecnico')">
       <OPTION value="qp" <?php if ("qp" == $email_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $email_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $email_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $email_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_email_tecnico" <?php echo $str_hide_email_tecnico?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      {
          $sAutocompValue = $email_tecnico;
      }
?>
<INPUT  type="text" id="SC_email_tecnico" name="email_tecnico" value="<?php echo NM_encode_input($email_tecnico) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_email_tecnico" name="email_tecnico_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tecnicos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tecnicos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tecnicos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.telefono_tecnico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_telefono_tecnico'), document.F1.telefono_tecnico_cond, 'telefono_tecnico');
   document.F1.telefono_tecnico.value = "";
   document.F1.telefono_tecnico_autocomp.value = "";
   document.F1.id_tecnico_cond.value = 'gt';
   ...
   document.F1.nombre_tecnico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombre_tecnico'), document.F1.nombre_tecnico_cond, 'nombre_tecnico');
   document.F1.nombre_tecnico.value = "";
   document.F1.nombre_tecnico_autocomp.value = "";
   document.F1.email_tecnico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_email_tecnico'), document.F1.email_tecnico_cond, 'email_tecnico');
   document.F1.email_tecnico.value = "";
   document.F1.email_tecnico_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_telefono_tecnico_cond'] = 'cond';
      $tp_fields['SC_telefono_tecnico'] = 'text_aut';
      $tp_fields['id_ac_telefono_tecnico'] = 'text_aut';
      $tp_fields['SC_id_tecnico_cond'] = 'cond';
      $tp_fields['SC_id_tecnico'] = 'text';
      $tp_fields['SC_nombre_tecnico_cond'] = 'cond';
      $tp_fields['SC_nombre_tecnico'] = 'text_aut';
      $tp_fields['id_ac_nombre_tecnico'] = 'text_aut';
      $tp_fields['SC_email_tecnico_cond'] = 'cond';
      $tp_fields['SC_email_tecnico'] = 'text_aut';
      $tp_fields['id_ac_email_tecnico'] = 'text_aut';
   ...
   {
      global $telefono_tecnico_cond, $telefono_tecnico, $telefono_tecnico_autocomp,
             $id_tecnico_cond, $id_tecnico,
             $nombre_tecnico_cond, $nombre_tecnico, $nombre_tecnico_autocomp,
             $email_tecnico_cond, $email_tecnico, $email_tecnico_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($telefono_tecnico_autocomp) && empty($telefono_tecnico))
      {
          $telefono_tecnico = $telefono_tecnico_autocomp;
      }
      if (!empty($nombre_tecnico_autocomp) && empty($nombre_tecnico))
      {
          $nombre_tecnico = $nombre_tecnico_autocomp;
      }
      if (!empty($email_tecnico_autocomp) && empty($email_tecnico))
      {
          $email_tecnico = $email_tecnico_autocomp;
      }
      $telefono_tecnico_cond_salva = $telefono_tecnico_cond; 
      if (!isset($telefono_tecnico_input_2) || $telefono_tecnico_input_2 == "")
      {
          $telefono_tecnico_input_2 = $telefono_tecnico;
      }
      ...
      $nombre_tecnico_cond_salva = $nombre_tecnico_cond; 
      if (!isset($nombre_tecnico_input_2) || $nombre_tecnico_input_2 == "")
      {
          $nombre_tecnico_input_2 = $nombre_tecnico;
      }
      $email_tecnico_cond_salva = $email_tecnico_cond; 
      if (!isset($email_tecnico_input_2) || $email_tecnico_input_2 == "")
      {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['telefono_tecnico'] = $telefono_tecnico; 
      if (is_array($telefono_tecnico) && !empty($telefono_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $telefono_tecnico;
      }
      elseif ($telefono_tecnico_cond_salva == "nu" || $telefono_tecnico_cond_salva == "nn" || $telefono_tecnico_cond_salva == "ep" || $telefono_tecnico_cond_salva == "ne" || !empty($telefono_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $telefono_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['telefono_tecnico_cond'] = $telefono_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "telefono_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $telefono_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['telefono_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['id_tecnico'] = $id_tecnico; 
      if (is_array($id_tecnico) && !empty($id_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $id_tecnico;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $id_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['id_tecnico_cond'] = $id_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "id_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $id_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['id_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nombre_tecnico'] = $nombre_tecnico; 
      if (is_array($nombre_tecnico) && !empty($nombre_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $nombre_tecnico;
      }
      elseif ($nombre_tecnico_cond_salva == "nu" || $nombre_tecnico_cond_salva == "nn" || $nombre_tecnico_cond_salva == "ep" || $nombre_tecnico_cond_salva == "ne" || !empty($nombre_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $nombre_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nombre_tecnico_cond'] = $nombre_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "nombre_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $nombre_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['nombre_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['email_tecnico'] = $email_tecnico; 
      if (is_array($email_tecnico) && !empty($email_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $email_tecnico;
      }
      elseif ($email_tecnico_cond_salva == "nu" || $email_tecnico_cond_salva == "nn" || $email_tecnico_cond_salva == "ep" || $email_tecnico_cond_salva == "ne" || !empty($email_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $email_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['email_tecnico_cond'] = $email_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "email_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $email_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['email_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($telefono_tecnico != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono_tecnico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['telefono_tecnico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono_tecnico'] = $telefono_tecnico;
      }
      $Conteudo = $id_tecnico;
      if (strtoupper($id_tecnico_cond) != "II" && strtoupper($id_tecnico_cond) != "QP" && strtoupper($id_tecnico_cond) != "NP" && strtoupper($id_tecnico_cond) != "IN") 
      { 
    ...
    if ($nombre_tecnico != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_tecnico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_tecnico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_tecnico'] = $nombre_tecnico;
      }
      $nmgp_def_dados = array();
    if ($email_tecnico != '') {
      $email_tecnico_look = (is_string($email_tecnico) ? substr($this->Db->qstr($email_tecnico), 1, -1) : $email_tecnico); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['email_tecnico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['email_tecnico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['email_tecnico'] = $email_tecnico;
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($telefono_tecnico) || $telefono_tecnico_cond == "nu" || $telefono_tecnico_cond == "nn" || $telefono_tecnico_cond == "ep" || $telefono_tecnico_cond == "ne")
      {
         $this->monta_condicao("telefono_tecnico", $telefono_tecnico_cond, $telefono_tecnico, "", "telefono_tecnico", "VARCHAR", false);
      }

      //----- $id_tecnico
      $this->Date_part = false;
      if (isset($id_tecnico) || $id_tecnico_cond == "nu" || $id_tecnico_cond == "nn" || $id_tecnico_cond == "ep" || $id_tecnico_cond == "ne")
      {
      ...
      //----- $nombre_tecnico
      $this->Date_part = false;
      if (isset($nombre_tecnico) || $nombre_tecnico_cond == "nu" || $nombre_tecnico_cond == "nn" || $nombre_tecnico_cond == "ep" || $nombre_tecnico_cond == "ne")
      {
         $this->monta_condicao("nombre_tecnico", $nombre_tecnico_cond, $nombre_tecnico, "", "nombre_tecnico", "VARCHAR", false);
      }

      //----- $email_tecnico
      $this->Date_part = false;
      if (isset($email_tecnico) || $email_tecnico_cond == "nu" || $email_tecnico_cond == "nn" || $email_tecnico_cond == "ep" || $email_tecnico_cond == "ne")
      {
         $this->monta_condicao("email_tecnico", $email_tecnico_cond, $email_tecnico, "", "email_tecnico", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['cond_pesq'] .= $this->NM_operador;
