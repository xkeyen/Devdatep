...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fecha_nacimiento";$Nm_numeric[] = "id_tecnico";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_telefono_tecnico_cond" name="telefono_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_tecnico'), this, 'telefono_tecnico')">
      ...
      <br><span id="id_hide_telefono_tecnico"  <?php echo $str_hide_telefono_tecnico?>><?php
      if ($telefono_tecnico != "")
      {
      $telefono_tecnico_look = (is_string($telefono_tecnico) ? substr($this->Db->qstr($telefono_tecnico), 1, -1) : $telefono_tecnico); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id_tecnico"  <?php echo $str_hide_id_tecnico?>><INPUT  type="text" id="SC_id_tecnico" name="id_tecnico" value="<?php echo NM_encode_input($id_tecnico) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombre_tecnico_cond" name="nombre_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_tecnico'), this, 'nombre_tecnico')">
      ...
      <br><span id="id_hide_nombre_tecnico"  <?php echo $str_hide_nombre_tecnico?>><?php
      if ($nombre_tecnico != "")
      {
      $nombre_tecnico_look = (is_string($nombre_tecnico) ? substr($this->Db->qstr($nombre_tecnico), 1, -1) : $nombre_tecnico); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_email_tecnico_cond" name="email_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_email_tecnico'), this, 'email_tecnico')">
      ...
      <br><span id="id_hide_email_tecnico"  <?php echo $str_hide_email_tecnico?>><?php
      if ($email_tecnico != "")
      {
      $email_tecnico_look = (is_string($email_tecnico) ? substr($this->Db->qstr($email_tecnico), 1, -1) : $email_tecnico); 
      $nmgp_def_dados = array(); 
