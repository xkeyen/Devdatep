...
<?php
   ...
   $Ord_Cmp = new grid_tecnicos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tecnicos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nombre_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["nombre_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["nombre_tecnico"] : "Nombre Tecnico";
   ...
   $tab_labels["telefono_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["telefono_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["telefono_tecnico"] : "Telefono Tecnico";
   ...
   $tab_def_campos['fecha_nacimiento'] = "fecha_nacimiento";
   $tab_labels["fecha_nacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["fecha_nacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["fecha_nacimiento"] : "Fecha Nacimiento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tecnicos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
