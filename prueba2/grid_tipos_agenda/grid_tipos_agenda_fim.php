...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba2_____grid_tipos_agenda"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba2_____grid_tipos_agenda"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipos_agenda_1'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipos_agenda']['embutida_filho'] as $ind => $sc_init)
          {
