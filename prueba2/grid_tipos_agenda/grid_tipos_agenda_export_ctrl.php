<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipos_agenda']['sc_process_barr'] = true;
require_once('../grid_tipos_agenda/index.php');
unset($_SESSION['scriptcase']['grid_tipos_agenda']['sc_process_barr']);
$ExportCtrl = new grid_tipos_agenda_export_control;
$ExportCtrl->Export_barr();

class grid_tipos_agenda_export_control
{
