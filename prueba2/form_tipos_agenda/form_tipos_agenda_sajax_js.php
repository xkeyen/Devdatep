  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipos_agenda" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipos_agenda_form();
	}
...
?>
  ...
  function do_ajax_form_tipos_agenda_validate_id_tipos_agenda_(iNumLinha)
  {
    ...
    x_ajax_form_tipos_agenda_validate_id_tipos_agenda_(var_id_tipos_agenda_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_id_tipos_agenda__cb);
  } // do_ajax_form_tipos_agenda_validate_id_tipos_agenda_

  function do_ajax_form_tipos_agenda_validate_id_tipos_agenda__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_id_tipos_agenda__cb

  // ---------- Validate descripcion_
  function do_ajax_form_tipos_agenda_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_descripcion__cb);
  } // do_ajax_form_tipos_agenda_validate_descripcion_

  function do_ajax_form_tipos_agenda_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_descripcion__cb

  // ---------- Validate duracion_mostrada_
  function do_ajax_form_tipos_agenda_validate_duracion_mostrada_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_duracion_mostrada_(var_duracion_mostrada_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_duracion_mostrada__cb);
  } // do_ajax_form_tipos_agenda_validate_duracion_mostrada_

  function do_ajax_form_tipos_agenda_validate_duracion_mostrada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_duracion_mostrada__cb

  // ---------- Validate tipo_duracion_
  function do_ajax_form_tipos_agenda_validate_tipo_duracion_(iNumLinha)
  {
    var nomeCampo_tipo_duracion_ = "tipo_duracion_" + iNumLinha;
    var var_tipo_duracion_ = scAjaxGetFieldText(nomeCampo_tipo_duracion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_tipo_duracion_(var_tipo_duracion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_tipo_duracion__cb);
  } // do_ajax_form_tipos_agenda_validate_tipo_duracion_

  function do_ajax_form_tipos_agenda_validate_tipo_duracion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_tipo_duracion__cb

  // ---------- Validate duracion_
  function do_ajax_form_tipos_agenda_validate_duracion_(iNumLinha)
  {
    var nomeCampo_duracion_ = "duracion_" + iNumLinha;
    var var_duracion_ = scAjaxGetFieldText(nomeCampo_duracion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_duracion_(var_duracion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_duracion__cb);
  } // do_ajax_form_tipos_agenda_validate_duracion_

  function do_ajax_form_tipos_agenda_validate_duracion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_duracion__cb

  // ---------- Validate valor_
  function do_ajax_form_tipos_agenda_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_valor__cb);
  } // do_ajax_form_tipos_agenda_validate_valor_

  function do_ajax_form_tipos_agenda_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_valor__cb

  // ---------- Validate activado_
  function do_ajax_form_tipos_agenda_validate_activado_(iNumLinha)
  {
    var nomeCampo_activado_ = "activado_" + iNumLinha;
    var var_activado_ = scAjaxGetFieldRadio(nomeCampo_activado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_validate_activado_(var_activado_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_validate_activado__cb);
  } // do_ajax_form_tipos_agenda_validate_activado_

  function do_ajax_form_tipos_agenda_validate_activado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_validate_activado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipos_agenda_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipos_agenda_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipos_agenda_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipos_agenda_add_new_line_cb);
  } // do_ajax_form_tipos_agenda_add_new_line

  function do_ajax_form_tipos_agenda_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_tipos_agenda_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipos_agenda_backup_line(iNumLinha)
  {
    var var_id_tipos_agenda_ = scAjaxGetFieldHidden("id_tipos_agenda_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_backup_line(var_id_tipos_agenda_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipos_agenda_backup_line_cb);
  } // do_ajax_form_tipos_agenda_backup_line

  function do_ajax_form_tipos_agenda_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipos_agenda_backup_line_cb

  function do_ajax_form_tipos_agenda_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tipos_agenda_cancel_insert

  function do_ajax_form_tipos_agenda_cancel_update(iSeqVert)
  {
    do_ajax_form_tipos_agenda_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipos_agenda_cancel_update

  function do_ajax_form_tipos_agenda_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipos_agenda_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipos_agenda_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_table_refresh(var_id_tipos_agenda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_table_refresh_cb);
  } //  do_ajax_form_tipos_agenda_table_refresh

  function do_ajax_form_tipos_agenda_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tipos_agenda_table_refresh_cb_after_alert);
  } // do_ajax_form_tipos_agenda_table_refresh_cb
  function do_ajax_form_tipos_agenda_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipos_agenda_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipos_agenda_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipos_agenda_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tipos_agenda_submit_form(var_id_tipos_agenda_, var_descripcion_, var_duracion_mostrada_, var_tipo_duracion_, var_duracion_, var_valor_, var_activado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_agenda_submit_form_cb);
  } // do_ajax_form_tipos_agenda_submit_form

  function do_ajax_form_tipos_agenda_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipos_agenda_submit_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_submit_form_cb
  function do_ajax_form_tipos_agenda_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipos_agenda_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipos_agenda_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tipos_agenda_navigate_form, function() {});
    } else {
      perform_ajax_form_tipos_agenda_navigate_form();
    }
  }

  function perform_ajax_form_tipos_agenda_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipos_agenda_cancel_insert(sc_form_tipos_agenda_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_navigate_form(var_id_tipos_agenda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_navigate_form_cb);
  } // do_ajax_form_tipos_agenda_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipos_agenda_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipos_agenda_navigate_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_navigate_form_cb
  function do_ajax_form_tipos_agenda_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tipos_agenda_navigate_form_cb_after_alert

    function sc_form_tipos_agenda_get_last_line_number()
    {
    ...
    } //sc_form_tipos_agenda_get_last_line_number

  function sc_hide_form_tipos_agenda_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["id_tipos_agenda_" + iNumLinha] = {"label": "Id Tipos Agenda<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["descripcion_" + iNumLinha] = {"label": "Descripcion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["duracion_mostrada_" + iNumLinha] = {"label": "Duracion Mostrada<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["tipo_duracion_" + iNumLinha] = {"label": "Tipo Duracion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["duracion_" + iNumLinha] = {"label": "Duracion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["valor_" + iNumLinha] = {"label": "Valor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["activado_" + iNumLinha] = {"label": "Activado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
