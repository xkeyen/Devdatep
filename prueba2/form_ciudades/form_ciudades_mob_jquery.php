...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["pais_iso" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["pais_iso" + iSeqRow] && scEventControl_data["pais_iso" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["pais_iso" + iSeqRow] && scEventControl_data["pais_iso" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_pais_iso' + iSeqRow).bind('blur', function() { sc_form_ciudades_pais_iso_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_ciudades_pais_iso_onfocus(this, iSeqRow) });
...
function sc_form_ciudades_pais_iso_onblur(oThis, iSeqRow) {
  do_ajax_form_ciudades_mob_validate_pais_iso();
  scCssBlur(oThis);
}

function sc_form_ciudades_pais_iso_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("pais_iso", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_pais_iso(row, status);
...
function displayChange_field_pais_iso(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_ciudades_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_ciudades_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
