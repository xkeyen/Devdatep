...
?>
  ...
  // ---------- Validate pais_iso
  function do_ajax_form_ciudades_mob_validate_pais_iso()
  {
    var nomeCampo_pais_iso = "pais_iso";
    var var_pais_iso = scAjaxGetFieldText(nomeCampo_pais_iso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_pais_iso(var_pais_iso, var_script_case_init, do_ajax_form_ciudades_mob_validate_pais_iso_cb);
  } // do_ajax_form_ciudades_mob_validate_pais_iso

  function do_ajax_form_ciudades_mob_validate_pais_iso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais_iso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_pais_iso_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_ciudades_mob_submit_form()
  {
    ...
    var var_pais_iso = scAjaxGetFieldText("pais_iso");
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_mob_submit_form(var_id, var_pais_iso, var_nombre, var_distrito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudades_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[1] = "pais_iso";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "distrito";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudades_fld_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pais_iso": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudades_fld_pais_iso'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudades_fld_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "distrito": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudades_fld_distrito'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["pais_iso"][1] = "pais_iso";
  ...
  var ajax_field_id = {
    ...
    "pais_iso": new Array("hidden_field_label_pais_iso", "hidden_field_data_pais_iso"),
