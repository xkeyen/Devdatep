...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_distrito_cond" name="distrito_cond" onChange="nm_campos_between(document.getElementById('id_vis_distrito'), this, 'distrito')">
      ...
      <br><span id="id_hide_distrito"  <?php echo $str_hide_distrito?>><?php
      if ($distrito != "")
      {
      $distrito_look = (is_string($distrito) ? substr($this->Db->qstr($distrito), 1, -1) : $distrito); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pais_iso_cond" name="pais_iso_cond" onChange="nm_campos_between(document.getElementById('id_vis_pais_iso'), this, 'pais_iso')">
      ...
      <br><span id="id_hide_pais_iso"  <?php echo $str_hide_pais_iso?>><?php
      if ($pais_iso != "")
      {
      $pais_iso_look = (is_string($pais_iso) ? substr($this->Db->qstr($pais_iso), 1, -1) : $pais_iso); 
      $nmgp_def_dados = array(); 
