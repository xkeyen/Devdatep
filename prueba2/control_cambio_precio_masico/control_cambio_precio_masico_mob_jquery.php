...
function scEventControl_onCalculator_porcentaje() {
  if (!_scCalculatorControl["id_sc_field_porcentaje"]) {
    ...
    do_ajax_control_cambio_precio_masico_mob_event_porcentaje_onblur();
  }
...
function scHidePage(pageNo) {
	$("#id_control_cambio_precio_masico_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_cambio_precio_masico_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
