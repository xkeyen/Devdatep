...
$old_error_handler = set_error_handler("control_cambio_precio_masico_scriptcase_error_handler");

function control_cambio_precio_masico_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_cambio_precio_masico']['contr_erro']) && $_SESSION['scriptcase']['control_cambio_precio_masico']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_cambio_precio_masico->contr_control_cambio_precio_masico->Apl_com_erro = true;
            if ($inicial_control_cambio_precio_masico->contr_control_cambio_precio_masico->NM_ajax_flag)
            {
                $inicial_control_cambio_precio_masico->contr_control_cambio_precio_masico->NM_ajax_info['errList']['geral_control_cambio_precio_masico'][] = $msg;
                return;
            }
            control_cambio_precio_masico_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_cambio_precio_masico_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_cambio_precio_masico'])  && '' != $_SESSION['scriptcase']['error_icon']['control_cambio_precio_masico'])  ? $_SESSION['scriptcase']['error_icon']['control_cambio_precio_masico']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_cambio_precio_masico']) && '' != $_SESSION['scriptcase']['error_close']['control_cambio_precio_masico']) ? $_SESSION['scriptcase']['error_close']['control_cambio_precio_masico'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_cambio_precio_masico']) && '' != $_SESSION['scriptcase']['error_span_title']['control_cambio_precio_masico']) ? $_SESSION['scriptcase']['error_span_title']['control_cambio_precio_masico'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_cambio_precio_masico']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_cambio_precio_masico']) ? $_SESSION['scriptcase']['error_icon_title']['control_cambio_precio_masico'] : '';
?>
