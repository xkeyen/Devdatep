<?php  
  ...
  session_start() ;
  class control_cambio_precio_masico_form_teste
  {
   function control_cambio_precio_masico_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_cambio_precio_masico/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_cambio_precio_masico</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="control_cambio_precio_masico"> 
</form> 
...
<?php
  ...
  $frm_teste = new control_cambio_precio_masico_form_teste();
  $frm_teste->control_cambio_precio_masico_teste();
?>
