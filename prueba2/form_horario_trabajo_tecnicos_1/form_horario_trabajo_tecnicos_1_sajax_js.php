  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_horario_trabajo_tecnicos_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_horario_trabajo_tecnicos_1_form();
	}
...
?>
  ...
  // ---------- Validate id_horario_trabajo_tecnicos_
  function do_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos_(iNumLinha)
  {
    var nomeCampo_id_horario_trabajo_tecnicos_ = "id_horario_trabajo_tecnicos_" + iNumLinha;
    var var_id_horario_trabajo_tecnicos_ = scAjaxGetFieldHidden(nomeCampo_id_horario_trabajo_tecnicos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos_(var_id_horario_trabajo_tecnicos_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos_

  function do_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_horario_trabajo_tecnicos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_horario_trabajo_tecnicos_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_id_horario_trabajo_tecnicos__cb

  // ---------- Validate id_tecnico_
  function do_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico_(iNumLinha)
  {
    var nomeCampo_id_tecnico_ = "id_tecnico_" + iNumLinha;
    var var_id_tecnico_ = scAjaxGetFieldText(nomeCampo_id_tecnico_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico_(var_id_tecnico_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico_

  function do_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tecnico_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tecnico_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_id_tecnico__cb

  // ---------- Validate dia_semana_
  function do_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana_(iNumLinha)
  {
    var nomeCampo_dia_semana_ = "dia_semana_" + iNumLinha;
    var var_dia_semana_ = scAjaxGetFieldText(nomeCampo_dia_semana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana_(var_dia_semana_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana_

  function do_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dia_semana_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dia_semana_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_dia_semana__cb

  // ---------- Validate hora_inicial_
  function do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial_(iNumLinha)
  {
    var nomeCampo_hora_inicial_ = "hora_inicial_" + iNumLinha;
    var var_hora_inicial_ = scAjaxGetFieldText(nomeCampo_hora_inicial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial_(var_hora_inicial_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial_

  function do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "hora_inicial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "hora_inicial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_inicial__cb

  // ---------- Validate hora_final_
  function do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final_(iNumLinha)
  {
    var nomeCampo_hora_final_ = "hora_final_" + iNumLinha;
    var var_hora_final_ = scAjaxGetFieldText(nomeCampo_hora_final_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final_(var_hora_final_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final_

  function do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "hora_final_" + iLineNumber;
    }
    else
    {
      sFieldValid = "hora_final_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_1_validate_hora_final__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_horario_trabajo_tecnicos_1_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_horario_trabajo_tecnicos_1_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_horario_trabajo_tecnicos_1_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_add_new_line_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_add_new_line

  function do_ajax_form_horario_trabajo_tecnicos_1_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_horario_trabajo_tecnicos_1_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_horario_trabajo_tecnicos_1_backup_line(iNumLinha)
  {
    var var_id_horario_trabajo_tecnicos_ = scAjaxGetFieldHidden("id_horario_trabajo_tecnicos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_1_backup_line(var_id_horario_trabajo_tecnicos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_backup_line_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_backup_line

  function do_ajax_form_horario_trabajo_tecnicos_1_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_1_backup_line_cb

  function do_ajax_form_horario_trabajo_tecnicos_1_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_horario_trabajo_tecnicos_1_cancel_insert

  function do_ajax_form_horario_trabajo_tecnicos_1_cancel_update(iSeqVert)
  {
    do_ajax_form_horario_trabajo_tecnicos_1_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_horario_trabajo_tecnicos_1_cancel_update

  function do_ajax_form_horario_trabajo_tecnicos_1_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_horario_trabajo_tecnicos_1_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_horario_trabajo_tecnicos_1_table_refresh()
  {
    var var_id_horario_trabajo_tecnicos_ = document.F2.id_horario_trabajo_tecnicos_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_horario_trabajo_tecnicos_1_table_refresh(var_id_horario_trabajo_tecnicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb);
  } //  do_ajax_form_horario_trabajo_tecnicos_1_table_refresh

  function do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_horario_trabajo_tecnicos_.value = scAjaxGetKeyValue("id_horario_trabajo_tecnicos_");
    ...
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb
  function do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_horario_trabajo_tecnicos_1_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_horario_trabajo_tecnicos_1_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_horario_trabajo_tecnicos_1_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_horario_trabajo_tecnicos_ = scAjaxGetFieldHidden("id_horario_trabajo_tecnicos_" + iNumLinha);
    var var_id_tecnico_ = scAjaxGetFieldText("id_tecnico_" + iNumLinha);
    var var_dia_semana_ = scAjaxGetFieldText("dia_semana_" + iNumLinha);
    var var_hora_inicial_ = scAjaxGetFieldText("hora_inicial_" + iNumLinha);
    var var_hora_final_ = scAjaxGetFieldText("hora_final_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_horario_trabajo_tecnicos_1_submit_form(var_id_horario_trabajo_tecnicos_, var_id_tecnico_, var_dia_semana_, var_hora_inicial_, var_hora_final_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_submit_form

  function do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb
  function do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_horario_trabajo_tecnicos_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_horario_trabajo_tecnicos_1_navigate_form, function() {});
    } else {
      perform_ajax_form_horario_trabajo_tecnicos_1_navigate_form();
    }
  }

  function perform_ajax_form_horario_trabajo_tecnicos_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_horario_trabajo_tecnicos_1_navigate_form(var_id_horario_trabajo_tecnicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_horario_trabajo_tecnicos_.value = scAjaxGetKeyValue("id_horario_trabajo_tecnicos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb
  function do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_1_navigate_form_cb_after_alert

    function sc_form_horario_trabajo_tecnicos_1_get_last_line_number()
    {
    ...
    } //sc_form_horario_trabajo_tecnicos_1_get_last_line_number

  function sc_hide_form_horario_trabajo_tecnicos_1_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_horario_trabajo_tecnicos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_tecnico_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dia_semana_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "hora_inicial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "hora_final_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha] = {"label": "Id Horario Trabajo Tecnicos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["id_tecnico_" + iNumLinha] = {"label": "Id Tecnico<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["dia_semana_" + iNumLinha] = {"label": "Dia Semana<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["hora_inicial_" + iNumLinha] = {"label": "Hora Inicial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["hora_final_" + iNumLinha] = {"label": "Hora Final<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_horario_trabajo_tecnicos_"][iNumLinha] = "id_horario_trabajo_tecnicos_" + iNumLinha;
    ajax_field_mult["id_tecnico_"][iNumLinha] = "id_tecnico_" + iNumLinha;
    ajax_field_mult["dia_semana_"][iNumLinha] = "dia_semana_" + iNumLinha;
    ajax_field_mult["hora_inicial_"][iNumLinha] = "hora_inicial_" + iNumLinha;
    ajax_field_mult["hora_final_"][iNumLinha] = "hora_final_" + iNumLinha;
    ajax_field_id["id_horario_trabajo_tecnicos_" + iNumLinha] = new Array("hidden_field_label_id_horario_trabajo_tecnicos_", "hidden_field_data_id_horario_trabajo_tecnicos_" + iNumLinha);
    ajax_field_id["id_tecnico_" + iNumLinha] = new Array("hidden_field_label_id_tecnico_", "hidden_field_data_id_tecnico_" + iNumLinha);
    ajax_field_id["dia_semana_" + iNumLinha] = new Array("hidden_field_label_dia_semana_", "hidden_field_data_dia_semana_" + iNumLinha);
    ajax_field_id["hora_inicial_" + iNumLinha] = new Array("hidden_field_label_hora_inicial_", "hidden_field_data_hora_inicial_" + iNumLinha);
    ajax_field_id["hora_final_" + iNumLinha] = new Array("hidden_field_label_hora_final_", "hidden_field_data_hora_final_" + iNumLinha);
    ajax_error_count["id_horario_trabajo_tecnicos_" + iNumLinha] = "off";
    ajax_error_count["id_tecnico_" + iNumLinha] = "off";
    ajax_error_count["dia_semana_" + iNumLinha] = "off";
    ajax_error_count["hora_inicial_" + iNumLinha] = "off";
    ajax_error_count["hora_final_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_horario_trabajo_tecnicos_" + iNumLinha] = "on";
    ajax_read_only["id_tecnico_" + iNumLinha] = "off";
    ajax_read_only["dia_semana_" + iNumLinha] = "off";
    ajax_read_only["hora_inicial_" + iNumLinha] = "off";
    ajax_read_only["hora_final_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_horario_trabajo_tecnicos_" + iNumLinha] = "on";
    ajax_read_only["id_tecnico_" + iNumLinha] = "on";
    ajax_read_only["dia_semana_" + iNumLinha] = "on";
    ajax_read_only["hora_inicial_" + iNumLinha] = "on";
    ajax_read_only["hora_final_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha] = null;
    ajax_error_list["id_tecnico_" + iNumLinha] = null;
    ajax_error_list["dia_semana_" + iNumLinha] = null;
    ajax_error_list["hora_inicial_" + iNumLinha] = null;
    ajax_error_list["hora_final_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_horario_trabajo_tecnicos_": new Array(),
    "id_tecnico_": new Array(),
    "dia_semana_": new Array(),
    "hora_inicial_": new Array(),
    "hora_final_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_horario_trabajo_tecnicos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_tecnico_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tecnico_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tecnico_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tecnico_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tecnico_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dia_semana_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dia_semana_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dia_semana_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dia_semana_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dia_semana_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["hora_inicial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["hora_inicial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["hora_inicial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["hora_inicial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["hora_inicial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["hora_final_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["hora_final_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["hora_final_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["hora_final_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["hora_final_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_horario_trabajo_tecnicos_'])) ? $this->nmgp_cmp_readonly['id_horario_trabajo_tecnicos_'] : 'on';
?>
    scAjaxFieldRead("id_horario_trabajo_tecnicos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tecnico_'])) ? $this->nmgp_cmp_readonly['id_tecnico_'] : 'off';
?>
    scAjaxFieldRead("id_tecnico_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dia_semana_'])) ? $this->nmgp_cmp_readonly['dia_semana_'] : 'off';
?>
    scAjaxFieldRead("dia_semana_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['hora_inicial_'])) ? $this->nmgp_cmp_readonly['hora_inicial_'] : 'off';
?>
    scAjaxFieldRead("hora_inicial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['hora_final_'])) ? $this->nmgp_cmp_readonly['hora_final_'] : 'off';
?>
    scAjaxFieldRead("hora_final_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_horario_trabajo_tecnicos_" + iSeq, "on");
    scAjaxFieldRead("id_tecnico_" + iSeq, "on");
    scAjaxFieldRead("dia_semana_" + iSeq, "on");
    scAjaxFieldRead("hora_inicial_" + iSeq, "on");
    scAjaxFieldRead("hora_final_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_horario_trabajo_tecnicos_" + iRow] || "on" == ajax_error_count["id_tecnico_" + iRow] || "on" == ajax_error_count["dia_semana_" + iRow] || "on" == ajax_error_count["hora_inicial_" + iRow] || "on" == ajax_error_count["hora_final_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_horario_trabajo_tecnicos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_tecnico_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dia_semana_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_hora_inicial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_hora_final_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_horario_trabajo_tecnicos_" + iRow] && "off" == ajax_error_count["id_tecnico_" + iRow] && "off" == ajax_error_count["dia_semana_" + iRow] && "off" == ajax_error_count["hora_inicial_" + iRow] && "off" == ajax_error_count["hora_final_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_horario_trabajo_tecnicos_" + iRow] = "off";
        ajax_error_count["id_tecnico_" + iRow] = "off";
        ajax_error_count["dia_semana_" + iRow] = "off";
        ajax_error_count["hora_inicial_" + iRow] = "off";
        ajax_error_count["hora_final_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_horario_trabajo_tecnicos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_tecnico_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dia_semana_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_hora_inicial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_hora_final_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_horario_trabajo_tecnicos_" == sIndex)
    {
