<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_horario_trabajo_tecnicos_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_horario_trabajo_tecnicos_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_horario_trabajo_tecnicos_1"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($this->NM_ajax_info['masterValue']) && !empty($this->NM_ajax_info['masterValue']))
  {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos_1']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos_1']['dashboard_info']['under_dashboard']) {
          echo "  var dbParentFrame = $(parent.document).find(\"[name='" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos_1']['dashboard_info']['parent_widget'] . "']\")";
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_horario_trabajo_tecnicos_1_submit_form(y, z);
