<?php  
  ...
  session_start() ;
  class form_horario_trabajo_tecnicos_1_form_teste
  {
   function form_horario_trabajo_tecnicos_1_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_horario_trabajo_tecnicos_1/img";
...
<?php
  ...
  $frm_teste = new form_horario_trabajo_tecnicos_1_form_teste();
  $frm_teste->form_horario_trabajo_tecnicos_1_teste();
?>
