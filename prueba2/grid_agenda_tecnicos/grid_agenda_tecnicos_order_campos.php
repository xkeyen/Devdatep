...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_agenda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["id_agenda"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["id_agenda"] : "Id Agenda";
   $tab_ger_campos['fecha_inicial'] = "on";
   $tab_def_campos['fecha_inicial'] = "fecha_inicial";
   $tab_labels["fecha_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["fecha_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["fecha_inicial"] : "Fecha Inicial";
   $tab_ger_campos['hora_inicial'] = "on";
   $tab_def_campos['hora_inicial'] = "hora_inicial";
   $tab_labels["hora_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["hora_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["hora_inicial"] : "Hora Inicial";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["id_cliente"] : "Id Cliente";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["valor_total"] : "Valor Total";
   $tab_ger_campos['estado_actual'] = "on";
   $tab_def_campos['estado_actual'] = "estado_actual";
   $tab_labels["estado_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["estado_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["estado_actual"] : "Estado Actual";
   $tab_ger_campos['evaluacion'] = "on";
   $tab_def_campos['evaluacion'] = "evaluacion";
   $tab_labels["evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_tecnicos']['labels']["evaluacion"] : "Evaluacion";
