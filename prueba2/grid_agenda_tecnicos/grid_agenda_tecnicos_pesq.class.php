...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> agenda</TITLE>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $fecha_inicial_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_dia']; 
          $fecha_inicial_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_mes']; 
          $fecha_inicial_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_ano']; 
          $fecha_inicial_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_dia']; 
          $fecha_inicial_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_mes']; 
          $fecha_inicial_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_ano']; 
          $fecha_inicial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_cond']; 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_estado_actual_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['estado_actual'])) ? $this->New_label['estado_actual'] : "Estado Actual"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_estado_actual_cond" name="estado_actual_cond" onChange="nm_campos_between(document.getElementById('id_vis_estado_actual'), this, 'estado_actual')">
...
?>
      ...
      <TD id='SC_valor_total_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['valor_total'])) ? $this->New_label['valor_total'] : "Valor Total"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_valor_total_cond" name="valor_total_cond" onChange="nm_campos_between(document.getElementById('id_vis_valor_total'), this, 'valor_total')">
...
<INPUT  type="text" id="SC_valor_total" name="valor_total" value="<?php echo NM_encode_input($valor_total) ?>" size=6 alt="{datatype: 'decimal', maxLength: 6, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_fecha_inicial_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha_inicial'])) ? $this->New_label['fecha_inicial'] : "Fecha Inicial"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fecha_inicial_cond" name="fecha_inicial_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_inicial'), this, 'fecha_inicial')">
     ...
     <TD  class="scFilterFieldEven"><SPAN id="Nm_bi_dados_fecha_inicial" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_fecha_inicial"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha_inicial" <?php echo $str_hide_fecha_inicial?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fecha_inicial"  <?php echo $str_display_fecha_inicial; ?> class="scFilterFieldFontEven">
...
?>
 ...
 {
    $('#SC_fecha_inicial_dia').bind('change', function() {sc_grid_agenda_tecnicos_valida_dia(this)});
    $('#SC_fecha_inicial_input_2_dia').bind('change', function() {sc_grid_agenda_tecnicos_valida_dia(this)});
    $('#SC_fecha_inicial_input_2_mes').bind('change', function() {sc_grid_agenda_tecnicos_valida_mes(this)});
    $('#SC_fecha_inicial_mes').bind('change', function() {sc_grid_agenda_tecnicos_valida_mes(this)});
 }
...
<?php
   ...
   function trata_campos()
   {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_dia'] = $fecha_inicial_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_mes'] = $fecha_inicial_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_ano'] = $fecha_inicial_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_dia'] = $fecha_inicial_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_mes'] = $fecha_inicial_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2_ano'] = $fecha_inicial_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_inicial_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_inicial_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_inicial_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_inicial_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_inicial_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_inicial_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_cond'] = $fecha_inicial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "fecha_inicial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['opc'] = $fecha_inicial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_inicial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($fecha_inicial_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial'] = $val[0];
          ...
          if ($fecha_inicial_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_inicial_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_inicial']['label'] = $nmgp_tab_label['fecha_inicial'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_inicial']['descr'] = $nmgp_tab_label['fecha_inicial'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_inicial']['hint']  = $nmgp_tab_label['fecha_inicial'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
