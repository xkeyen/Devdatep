...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_40']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_40']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_40'];
      }
   }
