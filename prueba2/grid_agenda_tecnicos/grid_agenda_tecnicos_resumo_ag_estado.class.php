...
class grid_agenda_tecnicos_resumo
{
   ...
   var $cnt_estado_actual_estado_actual;
   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['estado_actual'],
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_estado' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_order'] ['ag_estado'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_display'] ['ag_estado'] [$metricIndex] ['display']) {
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] == "OK")
      {
          ...
          $this->array_total_estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['estado_actual'];
   ...
   function completeMatrix()
   {
       ...
       $this->comp_sum = array(
           ...
           3 => "Estado Actual (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_estado_actual as $i_estado_actual => $d_estado_actual) {
           if (!isset($i_estado_actual, $this->comp_label[0]) || !in_array($i_estado_actual, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_estado_actual[4] ] = $d_estado_actual[3];
               $this->comp_label[0][ $d_estado_actual[4] ] = $d_estado_actual[3];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_estado_actual => $l_estado_actual) {
           if (isset($this->array_total_estado_actual[$i_estado_actual])) {
               $this->comp_group[$i_estado_actual] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_estado_actual;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Estado Actual (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'estado_actual',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_estado_actual)),
               'label_y'  => $this->getChartText(strip_tags("Estado Actual (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      if (is_array($this->array_total_estado_actual)) {
          ksort($this->array_total_estado_actual);
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $cnt_estado_actual, $quebra_estado_actual, $quebra_estado_actual_orig)
   {
      //----- Estado Actual
      if (!isset($this->array_total_estado_actual[$quebra_estado_actual_orig]))
      {
         $this->array_total_estado_actual[$quebra_estado_actual_orig][0] = 1;
         $this->array_total_estado_actual[$quebra_estado_actual_orig][1] = $sum_valor_total;
         $this->array_total_estado_actual[$quebra_estado_actual_orig][2] = 1;
         $this->array_total_estado_actual[$quebra_estado_actual_orig][3] = $quebra_estado_actual;
         $this->array_total_estado_actual[$quebra_estado_actual_orig][4] = $quebra_estado_actual_orig;
      }
      else
      {
         $this->array_total_estado_actual[$quebra_estado_actual_orig][0]++;
         $this->array_total_estado_actual[$quebra_estado_actual_orig][1] = bcadd($this->array_total_estado_actual[$quebra_estado_actual_orig][1], $sum_valor_total, 10);
         $this->array_total_estado_actual[$quebra_estado_actual_orig][2] ++;
      }
   }
   ...
   {
      if (isset($this->array_total_estado_actual))
      {
         $arr_temp_0 = $this->array_total_estado_actual;
         foreach ($this->array_total_estado_actual as $campo_estado_actual => $dados_estado_actual)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_estado_actual[$campo_estado_actual][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_estado_actual[$campo_estado_actual][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_estado_actual][$ind_missing][0] = 0;
                $arr_temp_0[$campo_estado_actual][$ind_missing][1] = 0;
                $arr_temp_0[$campo_estado_actual][$ind_missing][2] = 0;
                $arr_temp_0[$campo_estado_actual][$ind_missing][3] = $dados_estado_actual[$ind_exists][3];
                $arr_temp_0[$campo_estado_actual][$ind_missing][4] = $dados_estado_actual[$ind_exists][4];
            }
            ksort($arr_temp_0[$campo_estado_actual]);
            $this->array_total_estado_actual[$campo_estado_actual] = $arr_temp_0[$campo_estado_actual];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('ag_estado', 'estado_actual');
     $campos_order = $this->Ini->Get_date_order_groupby("estado_actual", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->estado_actual, $this->estado_actual, $this->estado_actual_orig);
            }
   }
//
