...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba2_____grid_agenda_tecnicos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba2_____grid_agenda_tecnicos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_agenda'] = array();
   $fecha_janela = false;
