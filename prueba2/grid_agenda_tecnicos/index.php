<?php
   ...
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']         = "conn_mysql_1";
...
class grid_agenda_tecnicos_ini
{
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_form_agenda;
   var $link_grid_clientes_direcciones_cons;
   var $link_grid_new_cons_emb;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20240119"; 
      $this->nm_hr_criacao   = "102821"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240123"; 
      $this->nm_hr_ult_alt   = "103558"; 
...
// 
      ...
      elseif (!isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['actual_lang']) || $_SESSION['scriptcase']['grid_agenda_tecnicos']['actual_lang'] != $this->str_lang) {
          ...
          setcookie('sc_actual_lang_prueba2',$this->str_lang,'0','/');
      }
...
<?php
      ...
      $Tmp_apl_lig = "form_agenda";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_agenda_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_agenda_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["form_agenda"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '';
      $this->sc_lig_target["A_@scinf__@scinf_form_agenda"] = '';
      $Tmp_apl_lig = "grid_new";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/grid_new_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/grid_new_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["grid_new"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_ga_detalle"] = '_self';
      $this->sc_lig_target["C_@scinf_ga_detalle_@scinf_grid_new"] = '_self';
      ...
      $this->link_form_agenda =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_agenda') . "/" ; 
      ...
      $this->link_grid_new_cons_emb =  $this->root . $this->path_link  . "" . SC_dir_app_name('grid_new') . "/index.php" ; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_new']['ind_tree'] = 0;
...
/*NM*/            $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']))
      {
          ...
          db_conect_devel($con_devel, $this->root . $this->path_prod, 'prueba2', 2, $this->force_db_utf8); 
      ...
      {
          if (!isset($_SESSION['glo_id_tecnico'])) 
          {
              $this->nm_falta_var .= "glo_id_tecnico; ";
          }
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'], $this->root . $this->path_prod, 'prueba2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
class grid_agenda_tecnicos_sub_css
{
   function __construct()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_new']['SC_herda_css'] = "S"; 
      $_SESSION['sc_session'][$script_case_init]['grid_new']['embutida'] = true;
      include_once ($this->Ini->link_grid_new_cons_emb);
      $this->grid_new = new grid_new_sub_css ;
      $_SESSION['sc_session'][$script_case_init]['grid_new']['embutida'] = false;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($glo_id_tecnico)) 
          {
              $_SESSION['glo_id_tecnico'] = $glo_id_tecnico;
              nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_id_tecnico"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'])) {
       ...
       { 
           ...
           foreach ($todo as $param)
           {
                ...
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_mensual")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    if ($cadapar[0] == "fecha_inicial")
                    {
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('ag_mensual', 'fecha_inicial');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
                    }
                    elseif ($cadapar[0] == "fecha_inicial_scgb_40")
                    {
                        $cadapar[0] = str_replace("fecha_inicial_scgb_40", "fecha_inicial", $cadapar[0]);
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('ag_mensual', 'fecha_inicial_scgb_40');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda_tecnicos']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda_tecnicos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " agenda";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['sc_free_group_by']['fecha_inicial_scgb_19'] = "" . $this->Ini->Nm_lang['lang_othr_valueWEEK'] . "";
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['sc_free_group_by']['fecha_inicial_scgb_19'] = 'WEEK';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['ag_mensual']['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mensual']['fecha_inicial'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mensual']['fecha_inicial'] = 'YYYYMM';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_def_sql']['ag_mensual']['fecha_inicial'] = 'fecha_inicial';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['ag_mensual']['fecha_inicial_scgb_40'] = "" . $this->Ini->Nm_lang['lang_othr_valueWEEK'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mensual']['fecha_inicial_scgb_40'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mensual']['fecha_inicial_scgb_40'] = 'WEEK';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_def_sql']['ag_mensual']['fecha_inicial_scgb_40'] = 'fecha_inicial';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_All_Groupby'] = array('ag_estado' => 'all', 'sc_free_group_by' => 'all', 'ag_mensual' => 'all');
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          ...
          $Arr_free_labels['fecha_inicial'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "Fecha Inicial") . "";
          $Arr_free_labels['fecha_inicial_scgb_19'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", "Fecha Inicial") . "";
          $Arr_free_labels['valor_total'] = "Valor Total";
          $Arr_free_labels['estado_actual'] = "Estado Actual";
          $Arr_free_labels['id_tecnico'] = "Id Tecnico";
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_estado")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = "Estado Actual";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_mensual")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "Fecha Inicial");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", "Fecha Inicial");
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "valor_total",
                   'label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "Valor Total",
                   'options' => array(
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][2] = array('label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][3] = array('label' => "Estado Actual (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")", 'display' => true);
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_estado']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_estado'] = array(
               ...
               array(
                   ...
                   'label' => "Estado Actual (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
                   'label_field' => "Estado Actual",
                   'options' => array(
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][2] = array('label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][3] = array('label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][4] = array('label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual'][] = 4;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_mensual']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_mensual'] = array(
               array(
                   'cmp_res' => "valor_total",
                   'label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "Valor Total",
               ...
               array(
                   'cmp_res' => "valor_total",
                   'label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")",
                   'label_field' => "Valor Total",
                   'options' => array(
               ...
               array(
                   'cmp_res' => "valor_total",
                   'label' => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
                   'label_field' => "Valor Total",
                   'options' => array(
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'] = " where (id_tecnico=" . $_SESSION['glo_id_tecnico'] . ")";
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> agenda :: PDF</TITLE>
...
$_SESSION['scriptcase']['grid_agenda_tecnicos']['contr_erro'] = 'off';
  ...
  function close_emb()
  {
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $ix     = 0;
       $fields = array();
       $Cmps_check_return = array('estado_actual','id_tecnico');
   ...
   function SC_processa_dyn_search($fields, $Res_comp='dyn')
   {
       ...
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "estado_actual" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_label']['estado_actual'];
               if ($dados['cond'] == "NU" || $dados['cond'] == "NN" || $dados['cond'] == "EP" || $dados['cond'] == "NE")
               {
                   $this->SC_proc_dyn_search_all($dados['cond'], '', "estado_actual", 'N', 'INT', $Label_cmp, false);
               }
               else
               {
                   $this->SC_proc_dyn_search_lookup($dados['cond'], $dados['vls'][0], 'estado_actual', 'N', 'INT', $Label_cmp);
               }
           }
   ...
   {
      if (in_array($cmp_del, array('fecha_inicial')))
      {
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> agenda :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (isset($_COOKIE['sc_apl_default_prueba2'])) {
           $apl_def = explode(",", $_COOKIE['sc_apl_default_prueba2']);
       }
       elseif (is_file($root . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_prueba2'])) {
               $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_prueba2'];
           }
       }
   }
   ...
   { 
       ...
       if (isset($_POST["glo_id_tecnico"])) 
       {
           $_SESSION["glo_id_tecnico"] = $_POST["glo_id_tecnico"];
           nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_id_tecnico"]);
       }
       if (isset($_GET["glo_id_tecnico"])) 
       {
           $_SESSION["glo_id_tecnico"] = $_GET["glo_id_tecnico"];
           nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_id_tecnico"]);
       }
       if (!isset($_SESSION["glo_id_tecnico"])) 
       {
           $_SESSION["glo_id_tecnico"] = "";
       }
