...
class grid_agenda_tecnicos_resumo
{
   ...
   var $array_total_fecha_inicial_scgb_40;
   ...
   var $max_fecha_inicial_valor_total;
   var $avg_fecha_inicial_valor_total;
   var $sc_proc_quebra_fecha_inicial_scgb_40;
   var $count_fecha_inicial_scgb_40;
   var $sum_fecha_inicial_scgb_40_valor_total;
   var $max_fecha_inicial_scgb_40_valor_total;
   var $avg_fecha_inicial_scgb_40_valor_total;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fecha_inicial_scgb_40 = array();
   ...
   if ($this->Ini->Embutida_iframe) {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                ...
                'fecha_inicial_scgb_40' => [
                    ...
                    'datatype' => 'date',
                    'lowercase' => 'fecha_inicial_scgb_40',
                    'summary_values_array' => 'array_total_fecha_inicial_scgb_40',
                    'summary_line_values_array' => 'array_line_fecha_inicial_scgb_40',
                    'order_by_index' => self::TOTAL_ARRAY_VALUE_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'fecha_inicial_scgb_40',
                    'link_protect_string' => '@aspass@',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
            ...
            'metric' => [
                ...
                'valor_total-X' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_valor_total_X',
                    'css_class' => "css_valor_total_max_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => true,
                ],
                'valor_total-A' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_valor_total_A',
                    'css_class' => "css_valor_total_avg_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => true,
                ],
            ...
            'dimension_by_lowercase' => [
                ...
                'fecha_inicial_scgb_40' => 'fecha_inicial_scgb_40',
            ],
            'metric_by_index' => [
                2 => 'valor_total-S',
                3 => 'valor_total-X',
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['fecha_inicial', 'fecha_inicial_scgb_40'],
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_mensual';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_mensual' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_mensual';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_order'] ['ag_mensual'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_display'] ['ag_mensual'] [$metricIndex] ['display']) {
...
SCEOT;
    ...
    function aux_format_valor_total_X($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_format_valor_total_A($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
...
SCEOT;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                ...
                $this->array_line_fecha_inicial_scgb_40 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_40'];
            }
          $this->array_total_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial'];
          $this->array_total_fecha_inicial_scgb_40 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial_scgb_40'];
      ...
      else
      {
            ...
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $this->array_line_fecha_inicial_scgb_40 = $this->array_total_fecha_inicial_scgb_40;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial_scgb_40'] = $this->array_total_fecha_inicial_scgb_40;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_40'] = $this->array_line_fecha_inicial_scgb_40;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['json_use_label'])
       {
          ...
          $Lab_fecha_inicial_scgb_40 = "fecha_inicial_scgb_40";
       }
       else
       {
       $Lab_fecha_inicial = "Fecha Inicial";
       $Lab_fecha_inicial =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_fecha_inicial);
       $Lab_fecha_inicial_scgb_40 = "Fecha Inicial";
       $Lab_fecha_inicial_scgb_40 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", $Lab_fecha_inicial_scgb_40);
       }
       $this->comp_field = array(
           $Lab_fecha_inicial,
           $Lab_fecha_inicial_scgb_40,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial'] = $Lab_fecha_inicial; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_40'] = $Lab_fecha_inicial_scgb_40; 
       ...
       $this->comp_sum = array(
           ...
           3 => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")",
           4 => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mensual'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           4 => array('field' => "valor_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valor_total_sum",
           3 => "css_valor_total_max",
           4 => "css_valor_total_avg",
       );
       ...
       foreach ($this->array_total_fecha_inicial as $i_fecha_inicial => $d_fecha_inicial) {
           if (!isset($i_fecha_inicial, $this->comp_label[0]) || !in_array($i_fecha_inicial, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fecha_inicial[5] ] = $d_fecha_inicial[4];
               $this->comp_label[0][ $d_fecha_inicial[5] ] = $d_fecha_inicial[4];
           }
           foreach ($this->array_total_fecha_inicial_scgb_40[$i_fecha_inicial] as $i_fecha_inicial_scgb_40 => $d_fecha_inicial_scgb_40) {
               if (!isset($i_fecha_inicial_scgb_40, $this->comp_label[1][ $d_fecha_inicial[5] ]) || !in_array($i_fecha_inicial_scgb_40, $this->comp_label[1][ $d_fecha_inicial[5] ], true)) {
                   $this->comp_index[1][ $d_fecha_inicial_scgb_40[5] ] = $d_fecha_inicial_scgb_40[4];
                   $this->comp_label[1][ $d_fecha_inicial[5] ][ $d_fecha_inicial_scgb_40[5] ] = $d_fecha_inicial_scgb_40[4];
               }
           }
       }
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'fecha_inicial_scgb_40', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fecha_inicial => $l_fecha_inicial) {
           ...
           foreach ($this->comp_label[1][$i_fecha_inicial] as $i_fecha_inicial_scgb_40 => $l_fecha_inicial_scgb_40) {
               if (isset($this->array_total_fecha_inicial_scgb_40[$i_fecha_inicial][$i_fecha_inicial_scgb_40])) {
                   $this->comp_group[$i_fecha_inicial][$i_fecha_inicial_scgb_40] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_fecha_inicial_scgb_40;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
           ...
           '1|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial_scgb_40',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial_scgb_40)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $where_compara   = "";
      $this->Total->Calc_resumo_ag_mensual("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])) )
       {
          ...
          $this->Total->Calc_resumo_ag_mensual("res", $this->NM_export, 2);
      ...
      if (is_array($this->array_total_fecha_inicial_scgb_40)) {
          ksort($this->array_total_fecha_inicial_scgb_40);
      }
      ...
      $this->array_total_geral[1][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][3];
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][4];
      ...
      if ($this->Tem_Res_Compara) {
          ...
          $this->array_total_geral[2][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][3];
          $this->array_total_geral[2][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][4];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $max_valor_total, $avg_valor_total, $quebra_fecha_inicial, $quebra_fecha_inicial_scgb_40, $quebra_fecha_inicial_orig, $quebra_fecha_inicial_scgb_40_orig)
   {
      ...
      if (!isset($this->array_total_fecha_inicial[$quebra_fecha_inicial_orig]))
      {
         ...
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][2] = $max_valor_total;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][3] = $avg_valor_total;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][4] = $quebra_fecha_inicial;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][5] = $quebra_fecha_inicial_orig;
      }
      else
      {
         ...
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][2] = max($this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][2], $max_valor_total);
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][3] = bcadd($this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][3], $avg_valor_total, 10);
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "
      if (!isset($this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig]))
      {
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][0] = 1;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][1] = $sum_valor_total;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][2] = $max_valor_total;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][3] = $avg_valor_total;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][4] = $quebra_fecha_inicial_scgb_40;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][5] = $quebra_fecha_inicial_scgb_40_orig;
      }
      else
      {
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][0]++;
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][1] = bcadd($this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][1], $sum_valor_total, 10);
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][2] = max($this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][2], $max_valor_total);
         $this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][3] = bcadd($this->array_total_fecha_inicial_scgb_40[$quebra_fecha_inicial_orig][$quebra_fecha_inicial_scgb_40_orig][3], $avg_valor_total, 10);
      }
   }
      ...
      if (isset($this->array_total_fecha_inicial))
      {
         ...
         foreach ($this->array_total_fecha_inicial as $campo_fecha_inicial => $dados_fecha_inicial)
         {
            ...
            if (!empty($ind_missing)) {
                ...
                $arr_temp_0[$campo_fecha_inicial][$ind_missing][3] = 0;
                $arr_temp_0[$campo_fecha_inicial][$ind_missing][4] = $dados_fecha_inicial[$ind_exists][4];
                $arr_temp_0[$campo_fecha_inicial][$ind_missing][5] = $dados_fecha_inicial[$ind_exists][5];
            }
            ksort($arr_temp_0[$campo_fecha_inicial]);
            $this->array_total_fecha_inicial[$campo_fecha_inicial] = $arr_temp_0[$campo_fecha_inicial];
            if (isset($this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial]))
            {
               $arr_temp_1 = $this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial];
               foreach ($this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial] as $campo_fecha_inicial_scgb_40 => $dados_fecha_inicial_scgb_40)
               {
                  $ind_exists  = "";
                  $ind_missing = "";
                  if (!isset($this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial][$campo_fecha_inicial_scgb_40][1])) {
                      $ind_exists  = 2;
                      $ind_missing = 1;
                  }
                  if (!isset($this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial][$campo_fecha_inicial_scgb_40][2])) {
                      $ind_exists  = 1;
                      $ind_missing = 2;
                  }
                  if (!empty($ind_missing)) {
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][0] = 0;
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][1] = 0;
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][2] = 0;
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][3] = 0;
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][4] = $dados_fecha_inicial_scgb_40[$ind_exists][4];
                      $arr_temp_1[$campo_fecha_inicial_scgb_40][$ind_missing][5] = $dados_fecha_inicial_scgb_40[$ind_exists][5];
                  }
                  ksort($arr_temp_1[$campo_fecha_inicial_scgb_40]);
                  $this->array_total_fecha_inicial_scgb_40[$campo_fecha_inicial][$campo_fecha_inicial_scgb_40] = $arr_temp_1[$campo_fecha_inicial_scgb_40];
               } 
            } 
         } 
      } 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('ag_mensual', 'fecha_inicial');
     $campos_order = $this->Ini->Get_date_order_groupby("fecha_inicial", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('ag_mensual', 'fecha_inicial_scgb_40');
     $campos_order = $this->Ini->Get_date_order_groupby("fecha_inicial", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fecha_inicial_scgb_40 = $this->fecha_inicial;
            ...
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('ag_mensual', 'fecha_inicial');
            ...
            $this->fecha_inicial = $this->Ini->GB_date_format($TP_Time . $this->fecha_inicial, $Format_tst, $Prefix_dat, "N", "F/Y");
            $Format_tst = $this->Ini->Get_Gb_date_format('ag_mensual', 'fecha_inicial_scgb_40');
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('ag_mensual', 'fecha_inicial_scgb_40');
            $TP_Time    = (in_array('fecha_inicial_scgb_40', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
            $this->fecha_inicial_scgb_40_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fecha_inicial_scgb_40, $Format_tst);
            $this->fecha_inicial_scgb_40 = $this->Ini->GB_date_format($TP_Time . $this->fecha_inicial_scgb_40, $Format_tst, $Prefix_dat);
            $this->estado_actual = $this->look_estado_actual ;
            $this->id_tecnico = $this->look_id_tecnico ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->valor_total, $this->valor_total, $this->fecha_inicial, $this->fecha_inicial_scgb_40, $this->fecha_inicial_orig,  $this->fecha_inicial_scgb_40_orig);
            }
   }
//
