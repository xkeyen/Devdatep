...
class grid_agenda_tecnicos_resumo
{
   ...
   var $array_total_fecha_inicial_scgb_19;
   var $array_total_valor_total;
   var $array_total_estado_actual;
   var $array_total_id_tecnico;
   ...
   var $sc_proc_quebra_fecha_inicial_scgb_19;
   var $count_fecha_inicial_scgb_19;
   var $sum_fecha_inicial_scgb_19_valor_total;
   var $sc_proc_quebra_valor_total;
   var $count_valor_total;
   var $sum_valor_total_valor_total;
   var $sc_proc_quebra_estado_actual;
   var $count_estado_actual;
   var $sum_estado_actual_valor_total;
   var $sc_proc_quebra_id_tecnico;
   var $count_id_tecnico;
   var $sum_id_tecnico_valor_total;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fecha_inicial_scgb_19 = array();
      $this->array_total_valor_total           = array();
      $this->array_total_estado_actual         = array();
      $this->array_total_id_tecnico            = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_agenda_tecnicos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_agenda_tecnicos'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'fecha_inicial' => [
                    'label' => sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "Fecha Inicial"),
                    'datatype' => 'date',
                ...
                'fecha_inicial_scgb_19' => [
                    'label' => sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", "Fecha Inicial"),
                    'datatype' => 'date',
                    'lowercase' => 'fecha_inicial_scgb_19',
                    'summary_values_array' => 'array_total_fecha_inicial_scgb_19',
                    'summary_line_values_array' => 'array_line_fecha_inicial_scgb_19',
                    'order_by_index' => self::TOTAL_ARRAY_VALUE_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'fecha_inicial_scgb_19',
                    'link_protect_string' => '@aspass@',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
                'valor_total' => [
                    'label' => "Valor Total",
                    'datatype' => 'decimal',
                    'lowercase' => 'valor_total',
                    'summary_values_array' => 'array_total_valor_total',
                    'summary_line_values_array' => 'array_line_valor_total',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'valor_total',
                    'link_protect_string' => '',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
                'estado_actual' => [
                    'label' => "Estado Actual",
                    'datatype' => 'int',
                    'lowercase' => 'estado_actual',
                    'summary_values_array' => 'array_total_estado_actual',
                    'summary_line_values_array' => 'array_line_estado_actual',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'estado_actual',
                    'link_protect_string' => '',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
                'id_tecnico' => [
                    'label' => "Id Tecnico",
                    'datatype' => 'int',
                    'lowercase' => 'id_tecnico',
                    'summary_values_array' => 'array_total_id_tecnico',
                    'summary_line_values_array' => 'array_line_id_tecnico',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'id_tecnico',
                    'link_protect_string' => '',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
            ...
            'dimension_by_lowercase' => [
                ...
                'fecha_inicial_scgb_19' => 'fecha_inicial_scgb_19',
    ...
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_x_axys'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_group_by'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_x_axys'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_y_axys'] = [];

            $dimensionCount = 0;

            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_x_axys'] [] = $dimensionCount;
            ...
            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_y_axys'] [] = $dimensionCount;

                $dimensionCount++;
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['dimension_order'] = [];
            foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
            }
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            $dimensionName = $this->SC_APP_info['dimension_by_lowercase'] [$dimensionNameLower];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_order_direction'] [$dimensionIndex];

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summary_cache']);
        }
    }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                grid_agenda_tecnicos_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_agenda_tecnicos_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_agenda_tecnicos@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_agenda_tecnicos'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_agenda_tecnicos'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_agenda_tecnicos'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['opcao']) {
            return true;
        }
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'];
       ...
       $this->fecha_inicial = (isset($Busca_temp['fecha_inicial'])) ? $Busca_temp['fecha_inicial'] : ""; 
       $tmp_pos = (is_string($this->fecha_inicial)) ? strpos($this->fecha_inicial, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fecha_inicial))
       {
           $this->fecha_inicial = substr($this->fecha_inicial, 0, $tmp_pos);
       }
       $fecha_inicial_2 = (isset($Busca_temp['fecha_inicial_input_2'])) ? $Busca_temp['fecha_inicial_input_2'] : ""; 
       $this->fecha_inicial_2 = $fecha_inicial_2; 
     } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "estado_actual?#?" . "Estado Actual" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "id_tecnico?#?" . "Id Tecnico" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "valor_total?#?" . "Valor Total" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "fecha_inicial?#?" . "Fecha Inicial" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']))
      {
          ob_start();
          $tmp_opc = $opc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']['opc'];
          $this->Ini->process_cond_bi($opc, $bi_dt1, $bi_dt2);
          $NM_func_dyn_ch_bi = "formata_bi_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']['cmp'];
          ...
          $oJson = new Services_JSON();
          echo $oJson->encode($this->Arr_result);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_agenda_tecnicos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial'];
                $this->array_line_fecha_inicial_scgb_19 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_19'];
                $this->array_line_valor_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['valor_total'];
                $this->array_line_estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['estado_actual'];
                $this->array_line_id_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['id_tecnico'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_fecha_inicial = array();
                $this->array_total_fecha_inicial_scgb_19 = array();
                $this->array_total_valor_total = array();
                $this->array_total_estado_actual = array();
                ...
                $this->array_line_fecha_inicial_scgb_19 = $this->array_total_fecha_inicial_scgb_19;
                $this->array_line_valor_total = $this->array_total_valor_total;
                $this->array_line_estado_actual = $this->array_total_estado_actual;
                $this->array_line_id_tecnico = $this->array_total_id_tecnico;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_clear_total'] = true;
            }
          $this->array_total_fecha_inicial = array();
          $this->array_total_fecha_inicial_scgb_19 = array();
          $this->array_total_valor_total = array();
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial'] = $this->array_total_fecha_inicial;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial_scgb_19'] = $this->array_total_fecha_inicial_scgb_19;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['valor_total'] = $this->array_total_valor_total;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['estado_actual'] = $this->array_total_estado_actual;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['id_tecnico'] = $this->array_total_id_tecnico;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_19'] = $this->array_line_fecha_inicial_scgb_19;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['valor_total'] = $this->array_line_valor_total;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['estado_actual'] = $this->array_line_estado_actual;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['id_tecnico'] = $this->array_line_id_tecnico;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary() && !$this->aux_isExport()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['json_use_label'])
       {
          $Lab_fecha_inicial = "fecha_inicial";
          $Lab_fecha_inicial_scgb_19 = "fecha_inicial_scgb_19";
          $Lab_valor_total = "valor_total";
          $Lab_estado_actual = "estado_actual";
          $Lab_id_tecnico = "id_tecnico";
       }
       else
       {
       $Lab_fecha_inicial = "Fecha Inicial";
       $Lab_fecha_inicial =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_fecha_inicial);
       $Lab_fecha_inicial_scgb_19 = "Fecha Inicial";
       $Lab_fecha_inicial_scgb_19 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", $Lab_fecha_inicial_scgb_19);
       $Lab_valor_total = "Valor Total";
       $Lab_estado_actual = "Estado Actual";
       $Lab_id_tecnico = "Id Tecnico";
       }
       $prep_field = array();
       $prep_field['fecha_inicial'] = $Lab_fecha_inicial;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial'] = $Lab_fecha_inicial; 
       $prep_field['fecha_inicial_scgb_19'] = $Lab_fecha_inicial_scgb_19;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_19'] = $Lab_fecha_inicial_scgb_19; 
       $prep_field['valor_total'] = $Lab_valor_total;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor_total'] = $Lab_valor_total; 
       $prep_field['estado_actual'] = $Lab_estado_actual;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['estado_actual'] = $Lab_estado_actual; 
       $prep_field['id_tecnico'] = $Lab_id_tecnico;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_tecnico'] = $Lab_id_tecnico; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_agenda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_agenda'] = "Id Agenda"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial'] = "Fecha Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_inicial'] = "Hora Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_cliente'] = "Id Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor_total'] = "Valor Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['estado_actual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['estado_actual'] = "Estado Actual"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['evaluacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['evaluacion'] = "Evaluacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['ga_detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['ga_detalle'] = "detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_tecnico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_tecnico'] = "Id Tecnico"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['costes_adicionales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['costes_adicionales'] = "Costes Adicionales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['descuento'] = "Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_19'] = "Fecha Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_40']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_40'] = "Fecha Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_final'] = "Fecha Final"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_final'] = "Hora Final"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['recurrencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['recurrencia'] = "Recurrencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['periodo'] = "Periodo"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['fecha_inicial']['alin'] = "''";
       $Arr_parms['fecha_inicial']['link'] = "S";
       $Arr_parms['fecha_inicial_scgb_19']['alin'] = "''";
       $Arr_parms['fecha_inicial_scgb_19']['link'] = "S";
       $Arr_parms['valor_total']['alin'] = "''";
       $Arr_parms['valor_total']['link'] = "S";
       $Arr_parms['estado_actual']['alin'] = "''";
       $Arr_parms['estado_actual']['link'] = "S";
       $Arr_parms['id_tecnico']['alin'] = "''";
       $Arr_parms['id_tecnico']['link'] = "S";
       $Arr_parms['fecha_inicial']['fill'] = "true";
       $Arr_parms['fecha_inicial']['order'] = "value";
       $Arr_parms['fecha_inicial']['order_start'] = 'asc';
       $Arr_parms['fecha_inicial']['order_invert'] = 'false';
       $Arr_parms['fecha_inicial']['order_enabled'] = 'true';
       $Arr_parms['fecha_inicial']['order_datatype'] = 'date';
       $Arr_parms['fecha_inicial']['rating_function'] = '';
       $Arr_parms['fecha_inicial_scgb_19']['fill'] = "true";
       $Arr_parms['fecha_inicial_scgb_19']['order'] = "value";
       $Arr_parms['fecha_inicial_scgb_19']['order_start'] = 'asc';
       $Arr_parms['fecha_inicial_scgb_19']['order_invert'] = 'false';
       $Arr_parms['fecha_inicial_scgb_19']['order_enabled'] = 'true';
       $Arr_parms['fecha_inicial_scgb_19']['order_datatype'] = 'date';
       $Arr_parms['fecha_inicial_scgb_19']['rating_function'] = '';
       $Arr_parms['valor_total']['fill'] = "true";
       $Arr_parms['valor_total']['order'] = "label";
       $Arr_parms['valor_total']['order_start'] = 'asc';
       $Arr_parms['valor_total']['order_invert'] = 'false';
       $Arr_parms['valor_total']['order_enabled'] = 'true';
       $Arr_parms['valor_total']['order_datatype'] = 'decimal';
       $Arr_parms['valor_total']['rating_function'] = '';
       $Arr_parms['estado_actual']['fill'] = "true";
       $Arr_parms['estado_actual']['order'] = "label";
       $Arr_parms['estado_actual']['order_start'] = 'asc';
       $Arr_parms['estado_actual']['order_invert'] = 'false';
       $Arr_parms['estado_actual']['order_enabled'] = 'true';
       $Arr_parms['estado_actual']['order_datatype'] = 'int';
       $Arr_parms['estado_actual']['rating_function'] = '';
       $Arr_parms['id_tecnico']['fill'] = "true";
       $Arr_parms['id_tecnico']['order'] = "label";
       $Arr_parms['id_tecnico']['order_start'] = 'asc';
       $Arr_parms['id_tecnico']['order_invert'] = 'false';
       $Arr_parms['id_tecnico']['order_enabled'] = 'true';
       $Arr_parms['id_tecnico']['order_datatype'] = 'int';
       $Arr_parms['id_tecnico']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['fecha_inicial'] = array(0 => 'fecha_inicial', 1 => '@aspass@');
       $prep_links_fl['fecha_inicial_scgb_19'] = array(0 => 'fecha_inicial_scgb_19', 1 => '@aspass@');
       $prep_links_fl['valor_total'] = array(0 => 'valor_total', 1 => '');
       $prep_links_fl['estado_actual'] = array(0 => 'estado_actual', 1 => '');
       $prep_links_fl['id_tecnico'] = array(0 => 'id_tecnico', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_agenda_tecnicos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'fecha_inicial' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'fecha_inicial_scgb_19' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial_scgb_19',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial_scgb_19)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'valor_total',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_valor_total)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'estado_actual',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_estado_actual)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'id_tecnico',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_id_tecnico)),
               'label_y'  => $this->getChartText(strip_tags("Valor Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_agenda_tecnicos_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_agenda_tecnicos_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_agenda_tecnicos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_agenda_tecnicos']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_agenda_tecnicos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_agenda_tecnicos']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_agenda_tecnicos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'] . ")";
              }
              else {
                  $tmp_cmd = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'];
              }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][2];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][2];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
...
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " agenda</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_agenda_tecnicos_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_agenda_tecnicos_jquery_7023.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_agenda_tecnicos_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_agenda_tecnicos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_agenda_tecnicos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_agenda_tecnicos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_agenda_tecnicos&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_graf_flash.php?nome_apl=grid_agenda_tecnicos&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_agenda_tecnicos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_agenda_tecnicos_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_agenda_tecnicos_config_pivot.php?nome_apl=grid_agenda_tecnicos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_agenda_tecnicos_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_agenda_tecnicos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_agenda_tecnicos_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_agenda_tecnicos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_agenda_tecnicos_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_agenda_tecnicos@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_agenda_tecnicos_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_agenda_tecnicos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_charts']);
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_agenda_tecnicos_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_agenda_tecnicos_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_inicial = (isset($Busca_temp['fecha_inicial'])) ? $Busca_temp['fecha_inicial'] : ""; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " agenda</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $quebra_fecha_inicial, $quebra_fecha_inicial_scgb_19, $quebra_valor_total, $quebra_estado_actual, $quebra_id_tecnico, $quebra_fecha_inicial_orig, $quebra_fecha_inicial_scgb_19_orig, $quebra_valor_total_orig, $quebra_estado_actual_orig, $quebra_id_tecnico_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_valor_total . ', 10);
          }
          ');
      }
   }
 ...
 /*-----*/ 
      if (isset($contr_cmp_gb[0]))
      {
       ...
       /*-----*/ 
            if (isset($contr_cmp_gb[1]))
            {
               eval ("\$arr_name_1  = \$this->array_total_" . $contr_cmp_gb[1] . "['" . $cmp_name_0 . "']" . ";");
               foreach ($arr_name_1 as $cmp_name_1  => $dados_gb)
               {
                  $ind_exists  = "";
                  $ind_missing = "";
                  if (!isset($arr_name_1[$cmp_name_1][1])) {
                      $ind_exists  = 2;
                      $ind_missing = 1;
                  }
                  if (!isset($arr_name_1[$cmp_name_1][2])) {
                      $ind_exists  = 1;
                      $ind_missing = 2;
                  }
                  if (!empty($ind_missing)) {
                      $arr_name_1[$cmp_name_1][$ind_missing][0] = 0;
                      $arr_name_1[$cmp_name_1][$ind_missing][1] = 0;
                      $arr_name_1[$cmp_name_1][$ind_missing][2] = $dados_gb[$ind_exists][2];
                      $arr_name_1[$cmp_name_1][$ind_missing][3] = $dados_gb[$ind_exists][3];
                      ksort($arr_name_1[$cmp_name_1]);
                      eval ("\$this->array_total_" . $contr_cmp_gb[1] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "'] = \$arr_name_1['" . $cmp_name_1 . "'];");
                  }
             /*-----*/ 
                  if (isset($contr_cmp_gb[2]))
                  {
                     eval ("\$arr_name_2  = \$this->array_total_" . $contr_cmp_gb[2] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . ";");
                     foreach ($arr_name_2 as $cmp_name_2  => $dados_gb)
                     {
                        $ind_exists  = "";
                        $ind_missing = "";
                        if (!isset($arr_name_2[$cmp_name_2][1])) {
                            $ind_exists  = 2;
                            $ind_missing = 1;
                        }
                        if (!isset($arr_name_2[$cmp_name_2][2])) {
                            $ind_exists  = 1;
                            $ind_missing = 2;
                        }
                        if (!empty($ind_missing)) {
                            $arr_name_2[$cmp_name_2][$ind_missing][0] = 0;
                            $arr_name_2[$cmp_name_2][$ind_missing][1] = 0;
                            $arr_name_2[$cmp_name_2][$ind_missing][2] = $dados_gb[$ind_exists][2];
                            $arr_name_2[$cmp_name_2][$ind_missing][3] = $dados_gb[$ind_exists][3];
                            ksort($arr_name_2[$cmp_name_2]);
                            eval ("\$this->array_total_" . $contr_cmp_gb[2] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . "['" . $cmp_name_2 . "'] = \$arr_name_2['" . $cmp_name_2 . "'];");
                        }
                   /*-----*/ 
                        if (isset($contr_cmp_gb[3]))
                        {
                           eval ("\$arr_name_3  = \$this->array_total_" . $contr_cmp_gb[3] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . "['" . $cmp_name_2 . "']" . ";");
                           foreach ($arr_name_3 as $cmp_name_3  => $dados_gb)
                           {
                              $ind_exists  = "";
                              $ind_missing = "";
                              if (!isset($arr_name_3[$cmp_name_3][1])) {
                                  $ind_exists  = 2;
                                  $ind_missing = 1;
                              }
                              if (!isset($arr_name_3[$cmp_name_3][2])) {
                                  $ind_exists  = 1;
                                  $ind_missing = 2;
                              }
                              if (!empty($ind_missing)) {
                                  $arr_name_3[$cmp_name_3][$ind_missing][0] = 0;
                                  $arr_name_3[$cmp_name_3][$ind_missing][1] = 0;
                                  $arr_name_3[$cmp_name_3][$ind_missing][2] = $dados_gb[$ind_exists][2];
                                  $arr_name_3[$cmp_name_3][$ind_missing][3] = $dados_gb[$ind_exists][3];
                                  ksort($arr_name_3[$cmp_name_3]);
                                  eval ("\$this->array_total_" . $contr_cmp_gb[3] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . "['" . $cmp_name_2 . "']" . "['" . $cmp_name_3 . "'] = \$arr_name_3['" . $cmp_name_3 . "'];");
                              }
                         /*-----*/ 
                              if (isset($contr_cmp_gb[4]))
                              {
                                 eval ("\$arr_name_4  = \$this->array_total_" . $contr_cmp_gb[4] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . "['" . $cmp_name_2 . "']" . "['" . $cmp_name_3 . "']" . ";");
                                 foreach ($arr_name_4 as $cmp_name_4  => $dados_gb)
                                 {
                                    $ind_exists  = "";
                                    $ind_missing = "";
                                    if (!isset($arr_name_4[$cmp_name_4][1])) {
                                        $ind_exists  = 2;
                                        $ind_missing = 1;
                                    }
                                    if (!isset($arr_name_4[$cmp_name_4][2])) {
                                        $ind_exists  = 1;
                                        $ind_missing = 2;
                                    }
                                    if (!empty($ind_missing)) {
                                        $arr_name_4[$cmp_name_4][$ind_missing][0] = 0;
                                        $arr_name_4[$cmp_name_4][$ind_missing][1] = 0;
                                        $arr_name_4[$cmp_name_4][$ind_missing][2] = $dados_gb[$ind_exists][2];
                                        $arr_name_4[$cmp_name_4][$ind_missing][3] = $dados_gb[$ind_exists][3];
                                        ksort($arr_name_4[$cmp_name_4]);
                                        eval ("\$this->array_total_" . $contr_cmp_gb[4] . "['" . $cmp_name_0 . "']" . "['" . $cmp_name_1 . "']" . "['" . $cmp_name_2 . "']" . "['" . $cmp_name_3 . "']" . "['" . $cmp_name_4 . "'] = \$arr_name_4['" . $cmp_name_4 . "'];");
                                    }
                                 } 
                              } 
                           } 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT id_agenda, str_replace (convert(char(10),fecha_inicial,102), '.', '-') + ' ' + convert(char(8),fecha_inicial,20), str_replace (convert(char(10),hora_inicial,102), '.', '-') + ' ' + convert(char(8),hora_inicial,20), id_cliente, valor_total, estado_actual, evaluacion, id_tecnico, valor, costes_adicionales, descuento from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT id_agenda, fecha_inicial, hora_inicial, id_cliente, valor_total, estado_actual, evaluacion, id_tecnico, valor, costes_adicionales, descuento from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT id_agenda, convert(char(23),fecha_inicial,121), convert(char(23),hora_inicial,121), id_cliente, valor_total, estado_actual, evaluacion, id_tecnico, valor, costes_adicionales, descuento from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT id_agenda, fecha_inicial, hora_inicial, id_cliente, valor_total, estado_actual, evaluacion, id_tecnico, valor, costes_adicionales, descuento from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->hora_inicial = $rs_res->fields[2] ;  
            $this->id_cliente = $rs_res->fields[3] ;  
            $this->valor_total = $rs_res->fields[4] ;  
            $this->valor_total =  str_replace(",", ".", $this->valor_total);
            $this->estado_actual = $rs_res->fields[5] ;  
            $this->evaluacion = $rs_res->fields[6] ;  
            $this->id_tecnico = $rs_res->fields[7] ;  
            ...
            $this->fecha_inicial_orig = $this->fecha_inicial;
            $this->fecha_inicial_scgb_19_orig = $this->fecha_inicial_scgb_19;
            $this->valor_total_orig = $this->valor_total;
            $this->estado_actual_orig = $this->estado_actual;
            $this->id_tecnico_orig = $this->id_tecnico;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->fecha_inicial, $this->fecha_inicial_scgb_19, $this->valor_total, $this->estado_actual, $this->id_tecnico, $this->fecha_inicial_orig,  $this->fecha_inicial_scgb_19_orig,  $this->valor_total_orig,  $this->estado_actual_orig,  $this->id_tecnico_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'])?'none':'';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "fecha_inicial")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "fecha_inicial";
                           $lin_obj = $this->grid_search_fecha_inicial($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('estado_actual','id_tecnico','valor_total','fecha_inicial');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_estado_actual($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_estado_actual_cond_" . $ind . "' name='cond_grid_search_estado_actual_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"estado_actual\", $ind)'>";
       ...
       $lin_obj .= "       <br>";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['estado_actual'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['estado_actual'][] = trim($rs->fields[0]);
   ...
   function grid_search_id_tecnico($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <br>";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['id_tecnico'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['id_tecnico'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_fecha_inicial($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_fecha_inicial_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_fecha_inicial_cond_" . $ind . "' name='cond_grid_search_fecha_inicial_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_change_bi(\"fecha_inicial\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_fecha_inicial_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $Form_base          = "ddmmyyyy";
       $date_format_show   = "";
       ...
       if (substr($opc, 0, 3) == "bi_")
       {
           ...
           if ($opc != "bi_TP")
           {
               ...
               $this->formata_bi_fecha_inicial($opc, $bi_dt1, $bi_dt2, $tmp_opc);
           }
       }
       else
       {
       ...
       $lin_obj .= "<SPAN id=\"ID_bi_dados_grid_fecha_inicial_" . $ind . "\" style=\"display:" . $display_bi . ";\">" . $bi_dt1 . $bi_dt2 . "</SPAN>";
       $lin_obj .= "<SPAN id=\"ID_nm_dados_grid_fecha_inicial_" . $ind . "\" style=\"display:" . $display_nm . ";\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_ano_val_" . $ind . "' name='val_grid_search_fecha_inicial_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_mes_val_" . $ind . "' name='val_grid_search_fecha_inicial_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_dia_val_" . $ind . "' name='val_grid_search_fecha_inicial_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "&nbsp;";
       ...
       $lin_obj .= "       <span id=\"grid_fecha_inicial_in_2_" . $ind . "\" style=\"display:" . $display_in_2 . "\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_v2__ano_val_" . $ind . "' name='val_grid_search_fecha_inicial_v2__ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_v2__mes_val_" . $ind . "' name='val_grid_search_fecha_inicial_v2__mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_inicial_v2__dia_val_" . $ind . "' name='val_grid_search_fecha_inicial_v2__dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "&nbsp;";
       $lin_obj .= "" . $date_format_show . "";
   ...
   function formata_bi_fecha_inicial($opc, &$bi_dt1, &$bi_dt2, $opc_bi)
   {
       $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "prueba2/grid_agenda_tecnicos";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_agenda_tecnicos_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_agenda_tecnicos_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_inicial_mes'] =  'sc_grid_agenda_tecnicos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_inicial_dia'] =  'sc_grid_agenda_tecnicos_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_inicial_v2__mes'] =  'sc_grid_agenda_tecnicos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_inicial_v2__dia'] =  'sc_grid_agenda_tecnicos_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_inicial_mes']", 'value' => 'sc_grid_agenda_tecnicos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_inicial_dia']", 'value' => 'sc_grid_agenda_tecnicos_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_inicial_v2__mes']", 'value' => 'sc_grid_agenda_tecnicos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_inicial_v2__dia']", 'value' => 'sc_grid_agenda_tecnicos_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                 if (tmp == 'fecha_inicial')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_inicial_dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_inicial_mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_inicial_v2__dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_inicial_v2__mes';\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'fecha_inicial')\r\n");
       $nm_saida->saida("                 {\r\n");
