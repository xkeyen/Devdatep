<?php  
  ...
  session_start() ;
  class grid_agenda_tecnicos_form_teste
  {
  function grid_agenda_tecnicos_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_agenda_tecnicos</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
glo_id_tecnico&nbsp;&nbsp;<input type=text name="glo_id_tecnico" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_agenda_tecnicos"> 
</form> 
<script language=javascript> 
 document.FCons.glo_id_tecnico.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_agenda_tecnicos_form_teste();
  $frm_teste->grid_agenda_tecnicos_teste();
?>
