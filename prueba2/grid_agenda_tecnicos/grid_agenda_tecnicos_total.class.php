...
class grid_agenda_tecnicos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['campos_busca']))
      { 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo, $res_export=false, $ind_compara="")
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
          $cmps_quebra_atual[] = $cmp;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']))
      {
          $cmps_quebra_atual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb'];
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_clear_total']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_clear_total']) {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_clear_total']);
      $ind_cmps  = 2;
      $ind_alias = "1";
      $cmp_dim   = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_ag_estado($destino_resumo, $res_export=false, $ind_compara="")
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('estado_actual' => "estado_actual");
      $cmps_quebra_atual = array("estado_actual");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']))
      {
          $cmps_quebra_atual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb'];
      }
   ...
   function Res_Totaliza_ag_estado($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "estado_actual") {
                  $this->Lookup->lookup_ag_estado_estado_actual($$Cada_dim,  $estado_actual);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   //----- 
   function Calc_resumo_ag_mensual($destino_resumo, $res_export=false, $ind_compara="")
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sql_tot_res']);
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fecha_inicial' => "fecha_inicial",'fecha_inicial_scgb_40' => "fecha_inicial");
      $cmps_quebra_atual = array("fecha_inicial","fecha_inicial_scgb_40");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb']))
      {
          $cmps_quebra_atual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_force_fiels_gb'];
      }
      ...
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $arr_compara = "[" . $ind_compara . "]";
          $this->Res_Totaliza_ag_mensual($ind_qb, $cmp_gb, $arr_tots . $arr_compara, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
   ...
   function Res_Totaliza_ag_mensual($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      ...
      $format_dimensions['fecha_inicial']['reg'] = "N";
      $format_dimensions['fecha_inicial']['msk'] = "F/Y";
      $format_dimensions['fecha_inicial_scgb_40']['reg'] = "S";
      $format_dimensions['fecha_inicial_scgb_40']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              $prep_look  = $Cada_dim . "_SC_look";
              $$prep_look = $rt->fields[$Ind_sql];
              $SC_prep = $this->Ini->Get_format_dimension($Ind_sql, 'ag_mensual', $Cada_dim, $rt, $format_dimensions[$Cada_dim]['reg'], $format_dimensions[$Cada_dim]['msk']);
              $SC_orig = $Cada_dim . "_orig";
              $SC_graf = "val_grafico_" . $Cada_dim;
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
          ...
          {
              $where_ok = (empty($this->sc_where_atual)) ? " where " . $sql_where : $this->sc_where_atual . " and " . $sql_where;
              $vl_statistic = $this->Calc_statist_manual_ag_mensual($where_ok);
              foreach ($vl_statistic as $ind => $val)
              {
                  $rt->fields[$ind] = $val;
              }
   ...
   function quebra_geral_sc_free_group_by($res_limit=false, $res_export=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_geral_ag_estado($res_limit=false, $res_export=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_total), count(estado_actual) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(valor_total), count(estado_actual) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      ...
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "OK";
   } 

   //---- 
   function quebra_geral_ag_mensual($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang , $id_cliente, $estado_actual, $id_tecnico;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] == "OK") 
      { 
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_total), max(valor_total), avg(valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(valor_total), max(valor_total), avg(valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      ...
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral'][4] = $rt->fields[3]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  estado_actual
   function quebra_estado_actual_ag_estado($estado_actual, $arg_sum_estado_actual) 
   {
      global $tot_estado_actual, $id_cliente, $estado_actual, $id_tecnico;
      $tot_estado_actual = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_total), count(estado_actual) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
      { 
         $nm_comando .= " where estado_actual" . $arg_sum_estado_actual ; 
      } 
      else 
      { 
         $nm_comando .= " and estado_actual" . $arg_sum_estado_actual ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_estado_actual[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_estado_actual[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
   } 

   //-----  fecha_inicial
   function quebra_fecha_inicial_ag_mensual($fecha_inicial, $arg_sum_fecha_inicial) 
   {
   ...
   function quebra_fecha_inicial_scgb_40_ag_mensual($fecha_inicial, $fecha_inicial_scgb_40, $arg_sum_fecha_inicial, $arg_sum_fecha_inicial_scgb_40) 
   {
      global $tot_fecha_inicial_scgb_40, $id_cliente, $estado_actual, $id_tecnico;
      $tot_fecha_inicial_scgb_40 = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_total), max(valor_total), avg(valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
      { 
         $nm_comando .= " where " .  $this->Sc_groupby_fecha_inicial . $arg_sum_fecha_inicial . " and " .  $this->Sc_groupby_fecha_inicial_scgb_40 . $arg_sum_fecha_inicial_scgb_40 ; 
      } 
      else 
      { 
         $nm_comando .= " and " .  $this->Sc_groupby_fecha_inicial . $arg_sum_fecha_inicial . " and " .  $this->Sc_groupby_fecha_inicial_scgb_40 . $arg_sum_fecha_inicial_scgb_40 ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_fecha_inicial_scgb_40[0] = NM_encode_input(sc_strip_script($fecha_inicial_scgb_40)) ; 
      $tot_fecha_inicial_scgb_40[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fecha_inicial_scgb_40[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_fecha_inicial_scgb_40[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_fecha_inicial_scgb_40[4] = (string)$rt->fields[3]; 
      $rt->Close(); 
   } 
