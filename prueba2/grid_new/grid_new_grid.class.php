...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq'])) {
...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pesq_tab_label']))
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pesq_tab_label'] .= "detalles_agenda_id_detalles_agenda?#?" . "Id Detalles Agenda" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pesq_tab_label'] .= "detalles_agenda_id_tipos_agenda?#?" . "Id Tipos Agenda" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pesq_tab_label'] .= "detalles_agenda_id_agenda?#?" . "Id Agenda" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pesq_tab_label'] .= "tipos_agenda_descripcion?#?" . "Descripcion" . "?@?";
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] || $this->Ini->Embutida_iframe)
   {
   ...
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_new']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_new']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_new']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_new']['lig_edit'] = "N";}
   ...
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_orig'] = " where (detalles_agenda.id_agenda=" . $_SESSION['par_agenda_id'] . ")";  
...
//----- 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['initialize']) ? true : false;
...
<?php
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_new_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_new_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_new_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_new_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_new_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $this->NM_opcao != "pdf") {
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_new_jquery_4063.js\"></script>\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida']) {  
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-grid_new-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
...
$nm_saida->saida("    </style>\r\n");
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_new-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_new-1\");\r\n");
...
$nm_saida->saida("}\r\n");
 ...
 { 
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_new_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_new_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
   ...
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'])
   { 
       ...
       else
       {
          ...
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_Ind_Groupby'] == "sc_free_total")
           {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['proc_pdf_vert'])
   {
   }
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['tipos_agenda_descripcion'])) ? $this->New_label['tipos_agenda_descripcion'] : "Descripcion";
   $classColFld = "";
   $classColTitle = "";
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['tipos_agenda_duracion'])) ? $this->New_label['tipos_agenda_duracion'] : "Duracion";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['detalles_agenda_id_detalles_agenda'])) ? $this->New_label['detalles_agenda_id_detalles_agenda'] : "Id Detalles Agenda";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['detalles_agenda_id_agenda'])) ? $this->New_label['detalles_agenda_id_agenda'] : "Id Agenda";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['ordem_cmp'] == $fieldName) {
...
// 
   $SC_Label = (isset($this->New_label['tipos_agenda_descripcion'])) ? $this->New_label['tipos_agenda_descripcion'] : "Descripcion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['tipos_agenda_descripcion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipos_agenda_duracion'])) ? $this->New_label['tipos_agenda_duracion'] : "Duracion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['tipos_agenda_duracion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipos_agenda_valor'])) ? $this->New_label['tipos_agenda_valor'] : "Valor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['tipos_agenda_valor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['detalles_agenda_id_detalles_agenda'])) ? $this->New_label['detalles_agenda_id_detalles_agenda'] : "Id Detalles Agenda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['detalles_agenda_id_detalles_agenda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['detalles_agenda_id_tipos_agenda'])) ? $this->New_label['detalles_agenda_id_tipos_agenda'] : "Id Tipos Agenda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['detalles_agenda_id_tipos_agenda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['detalles_agenda_id_agenda'])) ? $this->New_label['detalles_agenda_id_agenda'] : "Id Agenda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['labels']['detalles_agenda_id_agenda'] = $SC_Label; 
...
// 
   ...
   {  
          ...
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              ...
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_new_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_tipos_agenda_descripcion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['tipos_agenda_descripcion']) || $this->NM_cmp_hidden['tipos_agenda_descripcion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'] && !empty($conteudo)) 
          { 
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $SC_Label_atu['tipos_agenda_descripcion'] = (isset($this->New_label['tipos_agenda_descripcion'])) ? $this->New_label['tipos_agenda_descripcion'] : 'Descripcion'; 
          $SC_Label_atu['tipos_agenda_duracion'] = (isset($this->New_label['tipos_agenda_duracion'])) ? $this->New_label['tipos_agenda_duracion'] : 'Duracion'; 
          $SC_Label_atu['tipos_agenda_valor'] = (isset($this->New_label['tipos_agenda_valor'])) ? $this->New_label['tipos_agenda_valor'] : 'Valor'; 
          $SC_Label_atu['detalles_agenda_id_detalles_agenda'] = (isset($this->New_label['detalles_agenda_id_detalles_agenda'])) ? $this->New_label['detalles_agenda_id_detalles_agenda'] : 'Id Detalles Agenda'; 
          ...
          $SC_Label_atu['detalles_agenda_id_agenda'] = (isset($this->New_label['detalles_agenda_id_agenda'])) ? $this->New_label['detalles_agenda_id_agenda'] : 'Id Agenda'; 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'] as $cada_field)
          { 
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_new&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['json'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_json_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
              ...
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_new&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['csv'][] = "csv_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_new/grid_new_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']) < 4)
       {
   ...
   function grid_search_tipos_agenda_descripcion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct tipos_agenda.descripcion from " . $this->Ini->nm_tabela . " where (detalles_agenda.id_agenda=" . $_SESSION['par_agenda_id'] . ") and tipos_agenda.descripcion = '$tipos_agenda_descripcion_look' order by tipos_agenda.descripcion"; 
   ...
   function lookup_ajax_tipos_agenda_descripcion($tipos_agenda_descripcion)
   {
       ...
       $tipos_agenda_descripcion_look = (is_string($tipos_agenda_descripcion) ? substr($this->Db->qstr($tipos_agenda_descripcion), 1, -1) : $tipos_agenda_descripcion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct tipos_agenda.descripcion from " . $this->Ini->nm_tabela . " where (detalles_agenda.id_agenda=" . $_SESSION['par_agenda_id'] . ") and  tipos_agenda.descripcion like '%" . $tipos_agenda_descripcion . "%' order by tipos_agenda.descripcion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function JS_grid_search()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('tipos_agenda_descripcion', 'tipos_agenda_duracion', 'tipos_agenda_valor', 'detalles_agenda_id_detalles_agenda', 'detalles_agenda_id_tipos_agenda', 'detalles_agenda_id_agenda'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_new', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_new_iframe.php\";\r\n");
   ...
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_new')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_new', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
...
$_SESSION['scriptcase']['grid_new']['contr_erro'] = 'on';
