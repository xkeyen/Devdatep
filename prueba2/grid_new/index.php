<?php
   ...
   $_SESSION['scriptcase']['grid_new']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/conf";
   ...
   $_SESSION['scriptcase']['grid_new']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['grid_new']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_new']['glo_nm_conexao']         = "conn_mysql_2";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_new']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_new']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20240122"; 
      $this->nm_hr_criacao   = "104602"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240122"; 
      $this->nm_hr_ult_alt   = "110208"; 
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_new']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_new']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_new']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_new']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_new']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_new']['sub_cons_schema_filter'];
      } 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_new']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_new']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_new']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
// 
      ...
      {
          $this->nm_tabela = "tipos_agenda INNER JOIN detalles_agenda ON tipos_agenda.id_tipos_agenda = detalles_agenda.id_detalles_agenda"; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_new']['glo_nm_conexao'], $this->root . $this->path_prod, 'prueba2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_new']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_new']['embutida'])
      {
   ...
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($par_agenda_id)) 
          {
              ...
              nm_limpa_str_grid_new($_SESSION["par_agenda_id"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'])) {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_new']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_new']['pivot_tabular']);
              }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] = "json_res"; 
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida_opcao'] = "";
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "tipos_agenda_descripcion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "tipos_agenda_duracion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "tipos_agenda_valor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "detalles_agenda_id_detalles_agenda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "detalles_agenda_id_tipos_agenda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "detalles_agenda_id_agenda";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['usr_cmp_sel']['detalles_agenda_id_detalles_agenda'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['usr_cmp_sel']['detalles_agenda_id_tipos_agenda'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['usr_cmp_sel']['detalles_agenda_id_agenda'] = "off";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opc_liga']['inicial']))
          {
              ...
              $_SESSION['sc_session'][$script_case_init]['grid_new']['orig_pesq'] = "grid";
          }
      }
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_lookup'] = "";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_new.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_new/grid_new_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_new_json.class.php"); 
          } 
          $this->json  = new grid_new_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_new/grid_new_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_new_res_json.class.php"); 
          } 
          $this->json  = new grid_new_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['dashboard_refresh_after_chart'])) {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_new_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_new_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_new_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid'] . ")"; 
              }
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq_grid'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['fast_search'][0] = $in_fields;
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_prueba2'])) {
               $_SESSION['scriptcase']['grid_new']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_prueba2'];
           }
       }
   }
   ...
   { 
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_new']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_new']['mostra_edit'] = "S";
       }
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_new']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_new']['sc_modal'] = false;
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_new']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_new']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
      ...
      if ('ajax_fixed_columns_grid_save' == $nmgp_opcao) {
          _de1543deaf9745b7b4ca65dd5ef1673c_saveFixedColumnsGrid($_POST['fixed_index'], $_POST['fixed_action'], $_POST['script_case_init']);
      }
      if ('ajax_fixed_columns_grid_load' == $nmgp_opcao) {
          _de1543deaf9745b7b4ca65dd5ef1673c_loadFixedColumnsGrid($_POST['script_case_init']);
      }
...
//
   ...
   function grid_new_pack_protect_string($sString)
   {
    ...
    function grid_new_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_new']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
    ...
    function _de1543deaf9745b7b4ca65dd5ef1673c_initializeFixedColumnsGrid($script_case_init)
    {
        if (!isset($_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid'])) {
            $_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid'] = '';
        }
    }

    function _de1543deaf9745b7b4ca65dd5ef1673c_saveFixedColumnsGrid($index, $action, $script_case_init)
    {
        _de1543deaf9745b7b4ca65dd5ef1673c_initializeFixedColumnsGrid($script_case_init);

        if ('on' == $action) {
            $_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid'] = $index;
        } elseif (0 < $index) {
            $_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid'] = $index - 1;
        } else {
            $_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid'] = '';
        }
    ...
    function _de1543deaf9745b7b4ca65dd5ef1673c_loadFixedColumnsGrid($script_case_init)
    {
        _de1543deaf9745b7b4ca65dd5ef1673c_initializeFixedColumnsGrid($script_case_init);
        ...
        echo json_encode(
            array(
                'status' => 'ok',
                'last_index' =>$_SESSION['sc_session'][$script_case_init]['grid_new']['fixed_columns_grid']
            )
        );
        exit;
    }
