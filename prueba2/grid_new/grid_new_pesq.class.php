...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "detalles_agenda_id_detalles_agenda";$Nm_numeric[] = "detalles_agenda_id_tipos_agenda";$Nm_numeric[] = "detalles_agenda_id_agenda";$Nm_numeric[] = "tipos_agenda_duracion";$Nm_numeric[] = "tipos_agenda_valor";
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $detalles_agenda_id_detalles_agenda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_detalles_agenda']; 
          $detalles_agenda_id_detalles_agenda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_detalles_agenda_cond']; 
          $detalles_agenda_id_tipos_agenda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_tipos_agenda']; 
          $detalles_agenda_id_tipos_agenda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_tipos_agenda_cond']; 
          $detalles_agenda_id_agenda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_agenda']; 
          $detalles_agenda_id_agenda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_agenda_cond']; 
          $tipos_agenda_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['tipos_agenda_descripcion']; 
          $tipos_agenda_descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['tipos_agenda_descripcion_cond']; 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_detalles_agenda_id_detalles_agenda_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['detalles_agenda_id_detalles_agenda'])) ? $this->New_label['detalles_agenda_id_detalles_agenda'] : "Id Detalles Agenda"; ?></TD>
...
<INPUT  type="text" id="SC_detalles_agenda_id_tipos_agenda" name="detalles_agenda_id_tipos_agenda" value="<?php echo NM_encode_input($detalles_agenda_id_tipos_agenda) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_detalles_agenda_id_agenda_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['detalles_agenda_id_agenda'])) ? $this->New_label['detalles_agenda_id_agenda'] : "Id Agenda"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_detalles_agenda_id_agenda" name="detalles_agenda_id_agenda" value="<?php echo NM_encode_input($detalles_agenda_id_agenda) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_tipos_agenda_descripcion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tipos_agenda_descripcion'])) ? $this->New_label['tipos_agenda_descripcion'] : "Descripcion"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
   ...
   function trata_campos()
   {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_detalles_agenda'] = $detalles_agenda_id_detalles_agenda; 
      if (is_array($detalles_agenda_id_detalles_agenda) && !empty($detalles_agenda_id_detalles_agenda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0] = $detalles_agenda_id_detalles_agenda;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0][0] = $detalles_agenda_id_detalles_agenda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_detalles_agenda_cond'] = $detalles_agenda_id_detalles_agenda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['cmp'] = "detalles_agenda_id_detalles_agenda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['opc'] = $detalles_agenda_id_detalles_agenda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']['detalles_agenda_id_detalles_agenda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_tipos_agenda'] = $detalles_agenda_id_tipos_agenda; 
      if (is_array($detalles_agenda_id_tipos_agenda) && !empty($detalles_agenda_id_tipos_agenda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0] = $detalles_agenda_id_tipos_agenda;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0][0] = $detalles_agenda_id_tipos_agenda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_tipos_agenda_cond'] = $detalles_agenda_id_tipos_agenda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['cmp'] = "detalles_agenda_id_tipos_agenda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['opc'] = $detalles_agenda_id_tipos_agenda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']['detalles_agenda_id_tipos_agenda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_agenda'] = $detalles_agenda_id_agenda; 
      if (is_array($detalles_agenda_id_agenda) && !empty($detalles_agenda_id_agenda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0] = $detalles_agenda_id_agenda;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0][0] = $detalles_agenda_id_agenda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['detalles_agenda_id_agenda_cond'] = $detalles_agenda_id_agenda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['cmp'] = "detalles_agenda_id_agenda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['opc'] = $detalles_agenda_id_agenda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']['detalles_agenda_id_agenda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['tipos_agenda_descripcion'] = $tipos_agenda_descripcion; 
      if (is_array($tipos_agenda_descripcion) && !empty($tipos_agenda_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0] = $tipos_agenda_descripcion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['val'][0][0] = $tipos_agenda_descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['campos_busca']['tipos_agenda_descripcion_cond'] = $tipos_agenda_descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['cmp'] = "tipos_agenda_descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid]['opc'] = $tipos_agenda_descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['grid_pesq']['tipos_agenda_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
