<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tipos_agenda_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_descripcion"] : "Descripcion";
   ...
   $tab_labels["tipos_agenda_duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_duracion"] : "Duracion";
   ...
   $tab_labels["tipos_agenda_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_new']['labels']["tipos_agenda_valor"] : "Valor";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_new']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_new']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_new']['ordem_quebra'][$campo][$sqldef] = $ordem;
