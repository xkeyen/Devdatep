<?php
include_once('menu_1_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['menu_1']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_1']['glo_nm_conexao']        = "";
    $_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
...
class menu_1_class
{
 ...
 function menu_1_menu()
 {
    global $menu_1_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_1']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_1/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_1');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_1_erro.php");
}
include_once(dirname(__FILE__) . "/menu_1_erro.class.php"); 
$this->Erro = new menu_1_erro();
$str_path = substr($_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_1']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_1_menuData         = array();
$menu_1_menuData['path'] = array();
$menu_1_menuData['url']  = array();
$menu_1_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_1_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_1_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_1_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_1_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_1_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_1_menuData['url']['web']   = str_replace("\\", '/', $menu_1_menuData['url']['web']);
$menu_1_menuData['path']['root'] = substr($menu_1_menuData['path']['sys'],  0, -1 * strlen($menu_1_menuData['url']['web']));
$menu_1_menuData['path']['app']  = substr($menu_1_menuData['path']['sys'],  0, strrpos($menu_1_menuData['path']['sys'],  '/'));
$menu_1_menuData['path']['link'] = substr($menu_1_menuData['path']['app'],  0, strrpos($menu_1_menuData['path']['app'],  '/'));
$menu_1_menuData['path']['link'] = substr($menu_1_menuData['path']['link'], 0, strrpos($menu_1_menuData['path']['link'], '/')) . '/';
$menu_1_menuData['path']['app'] .= '/';
$menu_1_menuData['url']['app']   = substr($menu_1_menuData['url']['web'],  0, strrpos($menu_1_menuData['url']['web'],  '/'));
$menu_1_menuData['url']['link']  = substr($menu_1_menuData['url']['app'],  0, strrpos($menu_1_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] == "S")
{
    $menu_1_menuData['url']['link']  = substr($menu_1_menuData['url']['link'], 0, strrpos($menu_1_menuData['url']['link'], '/'));
}
$menu_1_menuData['url']['link']  .= '/';
$menu_1_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_1']['sc_apl_link'] = $menu_1_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_1']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_1']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_1']['actual_lang']) || $_SESSION['scriptcase']['menu_1']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_1']['actual_lang'] = $this->str_lang;
...
include_once("menu_1_toolbar.php");

$this->tab_grupo[0] = "prueba2/";
if ($_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "menu_1";
     $_SESSION['scriptcase']['menu_apls']['menu_1'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_1']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_1']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_1']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_1']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_1']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_1']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_1']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_1']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_1']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_1']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_1']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_1']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_1']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_1']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_1']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_1']['init']))
{
    $_SESSION['sc_session'][1]['menu_1']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_1']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_1']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_1'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_1'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_1'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_1'))
{
    $_SESSION['sc_session'][1]['menu_1']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_1'] = "javascript:window.close()";
}
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_new_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_new_ini.php");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_new']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_new'] = "on";
        }
    }
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_agenda_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_agenda_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_agenda']))
        {
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_1'];
...
$menu_1_menuData['data']['itens']['item_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_1",
                                                  'target'      => $this->menu_1_target('_self'),
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_new']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_new']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Solicitar Cita";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menu_1_menuData['data']['itens']['item_1']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_new&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menu_1_menuData['data']['itens']['item_1']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_agenda&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menu_1_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menu_1_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menu_1_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menu_1_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_1_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($menu_1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_1']))
{
    $menu_1_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['menu_1'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['menu_1']))
{
    $menu_1_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['menu_1'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['menu_1']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['menu_1']))
{
    $menu_1_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['menu_1'];
}
if (is_file("menu_1_help.txt"))
{
    $Arq_WebHelp = file("menu_1_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_1_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->menu_1_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_1']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_1']))
{
    sc_menu_delete($menu_1_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['menu_1']);
    sc_menu_delete($menu_1_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['menu_1']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_1']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_1']))
{
    sc_menu_disable($menu_1_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['menu_1']);
    sc_menu_disable($menu_1_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['menu_1']);
}
...
<head>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
<script type="text/javascript">
   ...
   {
           var str_location = document.getElementById('iframe_menu_1').contentWindow.location.toString();
...
/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_1_message.js"></script>
...
if(isset($menu_1_menuData['data']) && is_array($menu_1_menuData['data']))
{
    foreach($menu_1_menuData['data'] as $layer => $arr_item)
    {
...
if(isset($menu_1_menuData['data_vertical']) && is_array($menu_1_menuData['data_vertical']))
{
    foreach($menu_1_menuData['data_vertical'] as $layer => $arr_item)
    {
        if(isset($arr_item['itens']) && !empty($arr_item['itens']))
        {
            writeJsIframeControlRec($arr_item['itens'], $seq);
...
if(isset($menu_1_menuData['data_user']) && is_array($menu_1_menuData['data_user']))
{
    foreach($menu_1_menuData['data_user'] as $layer => $arr_item)
    {
        if(isset($arr_item['itens']) && !empty($arr_item['itens']))
        {
            writeJsIframeControlRec($arr_item['itens'], $seq);
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl, fa_ico)
{
    ...
    iframe.name = 'menu_1_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_1'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_1_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "menu_1_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_1")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_1_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "menu_1_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "menu_1" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_1').length)
        $('#iframe_menu_1')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->menu_1_MenuH($menu_1_menuData, $path_imag_cab, $strAlign); ?>
    ...
    <div id="Iframe_control" style=''>
      <iframe id="iframe_menu_1" name="menu_1_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_1_pag_ini.php"); ?>"></iframe>
<?php
...
function writeHtmlIframeControlRec($arr_itens)
{
    ...
    {
        ?>
        <iframe id="iframe_<?php echo $id; ?>" name="menu_1_<?php echo $id; ?>_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>
        <?php
        if(isset($item['itens']) && !empty($item['itens']))
        {
...
function menu_1_Header()
{
?>
    
<?php
}function menu_1_MenuH($menu_1_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->menu_1_escreveMenu($menu_1_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function menu_1_Footer()
{
?>
    
<?php
}
function menu_1_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"dark-cobalt","layout":"H","header_string":"","header_string_pos":"H","check_split":"S","check_toolbar":"S","check_show_search_path":"S","check_shortcut_label":"S","check_start_expanded":"S","check_use_loader":"N","should_reload":"S","layout_usr_pos":"out","usercheck":"S","username":"","userimage":"","userdesc":"","logo":"","logo_compact":"","pick_themes":["dark-cobalt","dark-coffee"],"shortcuts":[],"items":[{"text":"Cliente","app":"","icon":"fas fa-file","icon_check":"S","id":"item_1","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Solicitar Cita","app":"grid_new","icon":"fas fa-file","icon_check":"S","id":"item_2","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Listado de Citas","app":"grid_agenda","icon":"fas fa-file","icon_check":"S","id":"item_3","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"}],"user_items":[],"tb_items":[{"text":"B\u00fasqueda","app":"search","icon":"fas fa-search","icon_check":"S","display":"S","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"S","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"S","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Atajos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"S","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"}]}', true);
    ...
    {
        $apl_default = "menu_1_form_php.php?sc_item_menu=menu_1&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_1']['glo_nm_usa_grupo'];
    }
...
}function menu_1_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->menu_1_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function menu_1_target($str_target)
{
   ...
   {
        $_SESSION['scriptcase']['menu_1']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_1']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_1']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_1']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_1") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_1']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_1']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_1']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_prueba2'])) {
            $_SESSION['scriptcase']['menu_1']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_prueba2'];
        }
    }
}
...
$contr_menu_1 = new menu_1_class;
$contr_menu_1->menu_1_menu();
