...
?>
  ...
  function do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda()
  {
    ...
    x_ajax_form_tipos_agenda_1_validate_id_tipos_agenda(var_id_tipos_agenda, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_cb);
  } // do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda

  function do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipos_agenda_1_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_descripcion_cb);
  } // do_ajax_form_tipos_agenda_1_validate_descripcion

  function do_ajax_form_tipos_agenda_1_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_descripcion_cb

  // ---------- Validate duracion_mostrada
  function do_ajax_form_tipos_agenda_1_validate_duracion_mostrada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_duracion_mostrada(var_duracion_mostrada, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_cb);
  } // do_ajax_form_tipos_agenda_1_validate_duracion_mostrada

  function do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_cb

  // ---------- Validate tipo_duracion
  function do_ajax_form_tipos_agenda_1_validate_tipo_duracion()
  {
    var nomeCampo_tipo_duracion = "tipo_duracion";
    var var_tipo_duracion = scAjaxGetFieldText(nomeCampo_tipo_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_tipo_duracion(var_tipo_duracion, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_tipo_duracion_cb);
  } // do_ajax_form_tipos_agenda_1_validate_tipo_duracion

  function do_ajax_form_tipos_agenda_1_validate_tipo_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_tipo_duracion_cb

  // ---------- Validate duracion
  function do_ajax_form_tipos_agenda_1_validate_duracion()
  {
    var nomeCampo_duracion = "duracion";
    var var_duracion = scAjaxGetFieldText(nomeCampo_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_duracion(var_duracion, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_duracion_cb);
  } // do_ajax_form_tipos_agenda_1_validate_duracion

  function do_ajax_form_tipos_agenda_1_validate_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_duracion_cb

  // ---------- Validate valor
  function do_ajax_form_tipos_agenda_1_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_valor(var_valor, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_valor_cb);
  } // do_ajax_form_tipos_agenda_1_validate_valor

  function do_ajax_form_tipos_agenda_1_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_valor_cb

  // ---------- Validate activado
  function do_ajax_form_tipos_agenda_1_validate_activado()
  {
    var nomeCampo_activado = "activado";
    var var_activado = scAjaxGetFieldText(nomeCampo_activado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_activado(var_activado, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_activado_cb);
  } // do_ajax_form_tipos_agenda_1_validate_activado

  function do_ajax_form_tipos_agenda_1_validate_activado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_activado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipos_agenda_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipos_agenda_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_1_submit_form(var_id_tipos_agenda, var_descripcion, var_duracion_mostrada, var_tipo_duracion, var_duracion, var_valor, var_activado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_agenda_1_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_tipos_agenda_1_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_1_navigate_form(var_id_tipos_agenda, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_1_navigate_form_cb);
...
?>
  ...
  var ajax_error_list = {
    "id_tipos_agenda": {"label": "Id Tipos Agenda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descripcion": {"label": "Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "duracion_mostrada": {"label": "Duracion Mostrada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tipo_duracion": {"label": "Tipo Duracion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "duracion": {"label": "Duracion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "valor": {"label": "Valor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "activado": {"label": "Activado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
