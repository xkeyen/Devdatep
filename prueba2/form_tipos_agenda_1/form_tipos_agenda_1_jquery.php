...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_tipos_agenda' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_id_tipos_agenda_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_tipos_agenda_1_id_tipos_agenda_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_descripcion_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_tipos_agenda_1_descripcion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_duracion_mostrada' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_duracion_mostrada_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_tipos_agenda_1_duracion_mostrada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_duracion' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_tipo_duracion_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_tipos_agenda_1_tipo_duracion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_duracion' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_duracion_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tipos_agenda_1_duracion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_tipos_agenda_1_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_activado' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_activado_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_tipos_agenda_1_activado_onchange(this, iSeqRow) })
...
function sc_form_tipos_agenda_1_id_tipos_agenda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_descripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_duracion_mostrada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_tipo_duracion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_duracion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tipos_agenda_1_activado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
