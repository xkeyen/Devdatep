...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombre_tecnico_line" id="hidden_field_data_nombre_tecnico" style="<?php echo $sStyleHidden_nombre_tecnico; ?>"> <span class="scFormLabelOddFormat css_nombre_tecnico_label" style=""><span id="id_label_nombre_tecnico"><?php echo $this->nm_new_label['nombre_tecnico']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_email_tecnico_line" id="hidden_field_data_email_tecnico" style="<?php echo $sStyleHidden_email_tecnico; ?>"> <span class="scFormLabelOddFormat css_email_tecnico_label" style=""><span id="id_label_email_tecnico"><?php echo $this->nm_new_label['email_tecnico']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telefono_tecnico_line" id="hidden_field_data_telefono_tecnico" style="<?php echo $sStyleHidden_telefono_tecnico; ?>"> <span class="scFormLabelOddFormat css_telefono_tecnico_label" style=""><span id="id_label_telefono_tecnico"><?php echo $this->nm_new_label['telefono_tecnico']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_nacimiento_line" id="hidden_field_data_fecha_nacimiento" style="<?php echo $sStyleHidden_fecha_nacimiento; ?>"> <span class="scFormLabelOddFormat css_fecha_nacimiento_label" style=""><span id="id_label_fecha_nacimiento"><?php echo $this->nm_new_label['fecha_nacimiento']; ?></span></span><br>
