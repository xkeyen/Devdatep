...
//
   ...
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao']         = "conn_mysql_1";
   $NM_dir_atual = getcwd();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'prueba2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'prueba2', 1, $this->force_db_utf8);
    }
    else {
