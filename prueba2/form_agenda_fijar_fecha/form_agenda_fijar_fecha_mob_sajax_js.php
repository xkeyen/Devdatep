  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_agenda_fijar_fecha_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_agenda_fijar_fecha_mob_form();
	}
...
?>
  ...
  function do_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial()
  {
    var nomeCampo_fecha_inicial = "fecha_inicial";
    var var_fecha_inicial = scAjaxGetFieldText(nomeCampo_fecha_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial(var_fecha_inicial, var_script_case_init, do_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial

  function do_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_fecha_inicial_cb

  // ---------- Validate hora_inicial
  function do_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial()
  {
    var nomeCampo_hora_inicial = "hora_inicial";
    var var_hora_inicial = scAjaxGetFieldSelect(nomeCampo_hora_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial(var_hora_inicial, var_script_case_init, do_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial

  function do_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_hora_inicial_cb

  // ---------- Validate valor_total
  function do_ajax_form_agenda_fijar_fecha_mob_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_fijar_fecha_mob_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_agenda_fijar_fecha_mob_validate_valor_total_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_valor_total

  function do_ajax_form_agenda_fijar_fecha_mob_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_valor_total_cb

  // ---------- Validate dia_semana
  function do_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana()
  {
    var nomeCampo_dia_semana = "dia_semana";
    var var_dia_semana = scAjaxGetFieldText(nomeCampo_dia_semana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana(var_dia_semana, var_script_case_init, do_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana

  function do_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_fijar_fecha_mob_validate_dia_semana_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_agenda_fijar_fecha_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_agenda_fijar_fecha_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fecha_inicial = scAjaxGetFieldText("fecha_inicial");
    var var_hora_inicial = scAjaxGetFieldSelect("hora_inicial");
    var var_valor_total = scAjaxGetFieldText("valor_total");
    var var_dia_semana = scAjaxGetFieldText("dia_semana");
    var var_id_agenda = scAjaxGetFieldText("id_agenda");
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_fijar_fecha_mob_submit_form(var_fecha_inicial, var_hora_inicial, var_valor_total, var_dia_semana, var_id_agenda, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_submit_form

  function do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb_after_alert);
  } // do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb
  function do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_agenda_fijar_fecha_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_agenda_fijar_fecha_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_agenda_fijar_fecha_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_agenda_fijar_fecha_mob_navigate_form();
    }
  }

  function perform_ajax_form_agenda_fijar_fecha_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_fijar_fecha_mob_navigate_form(var_id_agenda, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb);
  } // do_ajax_form_agenda_fijar_fecha_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_fijar_fecha_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb
  function do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_agenda_fijar_fecha_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_agenda_fijar_fecha_mob_navigate_form_cb_after_alert

  function sc_hide_form_agenda_fijar_fecha_mob_form()
  {
  ...
  ajax_field_list[0] = "fecha_inicial";
  ajax_field_list[1] = "hora_inicial";
  ajax_field_list[2] = "valor_total";
  ajax_field_list[3] = "dia_semana";
  ...
  var ajax_error_list = {
    ...
    "dia_semana": {"label": "dia_semana", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
