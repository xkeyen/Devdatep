...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba2_____grid_clientes_direcciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba2_____grid_clientes_direcciones"]);
   }
