<?php  
  ...
  session_start() ;
  class grid_clientes_direcciones_form_teste
  {
  function grid_clientes_direcciones_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_clientes_direcciones</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
par_id_cliente&nbsp;&nbsp;<input type=text name="par_id_cliente" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_clientes_direcciones"> 
</form> 
<script language=javascript> 
 document.FCons.par_id_cliente.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_clientes_direcciones_form_teste();
  $frm_teste->grid_clientes_direcciones_teste();
?>
