<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_clientes_direcciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_prueba2.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["id_cliente"] : "Id Cliente";
   $tab_ger_campos['nombre_cliente'] = "on";
   $tab_def_campos['nombre_cliente'] = "nombre_cliente";
   $tab_labels["nombre_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["nombre_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["nombre_cliente"] : "Nombre Cliente";
   $tab_ger_campos['email_cliente'] = "on";
   $tab_def_campos['email_cliente'] = "email_cliente";
   $tab_labels["email_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["email_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["email_cliente"] : "Email Cliente";
   $tab_ger_campos['telefono_cliente'] = "on";
   $tab_def_campos['telefono_cliente'] = "telefono_cliente";
   $tab_labels["telefono_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["telefono_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["telefono_cliente"] : "Telefono Cliente";
   $tab_ger_campos['direccion_cliente'] = "on";
   $tab_def_campos['direccion_cliente'] = "direccion_cliente";
   $tab_labels["direccion_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["direccion_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["direccion_cliente"] : "Direccion Cliente";
   $tab_ger_campos['ciudad_cliente'] = "on";
   $tab_def_campos['ciudad_cliente'] = "ciudad_cliente";
   $tab_labels["ciudad_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["ciudad_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["ciudad_cliente"] : "Ciudad Cliente";
   $tab_ger_campos['postal_cliente'] = "on";
   $tab_def_campos['postal_cliente'] = "postal_cliente";
   $tab_labels["postal_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["postal_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["postal_cliente"] : "Postal Cliente";
   $tab_ger_campos['pais_cliente'] = "on";
   $tab_def_campos['pais_cliente'] = "pais_cliente";
   $tab_labels["pais_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["pais_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["pais_cliente"] : "Pais Cliente";
