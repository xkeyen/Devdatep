  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tecnicos_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tecnicos_1_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_tecnico
  function do_ajax_form_tecnicos_1_mob_validate_id_tecnico()
  {
    var nomeCampo_id_tecnico = "id_tecnico";
    var var_id_tecnico = scAjaxGetFieldHidden(nomeCampo_id_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_id_tecnico(var_id_tecnico, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_id_tecnico_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_id_tecnico

  function do_ajax_form_tecnicos_1_mob_validate_id_tecnico_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_id_tecnico_cb

  // ---------- Validate nombre_tecnico
  function do_ajax_form_tecnicos_1_mob_validate_nombre_tecnico()
  {
    var nomeCampo_nombre_tecnico = "nombre_tecnico";
    var var_nombre_tecnico = scAjaxGetFieldText(nomeCampo_nombre_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_nombre_tecnico(var_nombre_tecnico, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_nombre_tecnico_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_nombre_tecnico

  function do_ajax_form_tecnicos_1_mob_validate_nombre_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_tecnico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_nombre_tecnico_cb

  // ---------- Validate email_tecnico
  function do_ajax_form_tecnicos_1_mob_validate_email_tecnico()
  {
    var nomeCampo_email_tecnico = "email_tecnico";
    var var_email_tecnico = scAjaxGetFieldText(nomeCampo_email_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_email_tecnico(var_email_tecnico, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_email_tecnico_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_email_tecnico

  function do_ajax_form_tecnicos_1_mob_validate_email_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email_tecnico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_email_tecnico_cb

  // ---------- Validate telefono_tecnico
  function do_ajax_form_tecnicos_1_mob_validate_telefono_tecnico()
  {
    var nomeCampo_telefono_tecnico = "telefono_tecnico";
    var var_telefono_tecnico = scAjaxGetFieldText(nomeCampo_telefono_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_telefono_tecnico(var_telefono_tecnico, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_telefono_tecnico_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_telefono_tecnico

  function do_ajax_form_tecnicos_1_mob_validate_telefono_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telefono_tecnico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_telefono_tecnico_cb

  // ---------- Validate usuario_login
  function do_ajax_form_tecnicos_1_mob_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldText(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_usuario_login_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_usuario_login

  function do_ajax_form_tecnicos_1_mob_validate_usuario_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_usuario_login_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento

  function do_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_fecha_nacimiento_cb

  // ---------- Validate md
  function do_ajax_form_tecnicos_1_mob_validate_md()
  {
    var nomeCampo_md = "md";
    var var_md = scAjaxGetFieldText(nomeCampo_md);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_1_mob_validate_md(var_md, var_script_case_init, do_ajax_form_tecnicos_1_mob_validate_md_cb);
  } // do_ajax_form_tecnicos_1_mob_validate_md

  function do_ajax_form_tecnicos_1_mob_validate_md_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "md";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_1_mob_validate_md_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tecnicos_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tecnicos_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_tecnico = scAjaxGetFieldHidden("id_tecnico");
    var var_nombre_tecnico = scAjaxGetFieldText("nombre_tecnico");
    var var_email_tecnico = scAjaxGetFieldText("email_tecnico");
    var var_telefono_tecnico = scAjaxGetFieldText("telefono_tecnico");
    ...
    scAjaxProcOn();
    x_ajax_form_tecnicos_1_mob_submit_form(var_id_tecnico, var_nombre_tecnico, var_email_tecnico, var_telefono_tecnico, var_usuario_login, var_fecha_nacimiento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tecnicos_1_mob_submit_form_cb);
  } // do_ajax_form_tecnicos_1_mob_submit_form

  function do_ajax_form_tecnicos_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tecnicos_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tecnicos_1_mob_submit_form_cb
  function do_ajax_form_tecnicos_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tecnicos_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_horario_trabajo_tecnicos_mob"] = "off";

  function do_ajax_form_tecnicos_1_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tecnicos_1_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tecnicos_1_mob_navigate_form();
    }
  }

  function perform_ajax_form_tecnicos_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_horario_trabajo_tecnicos_mob"] = "on";
    x_ajax_form_tecnicos_1_mob_navigate_form(var_id_tecnico, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tecnicos_1_mob_navigate_form_cb);
  } // do_ajax_form_tecnicos_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tecnicos_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tecnicos_1_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_tecnico.value = scAjaxGetKeyValue("id_tecnico");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob"] && "nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tecnicos_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tecnicos_1_mob_navigate_form_cb
  function do_ajax_form_tecnicos_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tecnicos_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tecnicos_1_mob_navigate_form_cb_after_alert

  function sc_hide_form_tecnicos_1_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_horario_trabajo_tecnicos_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "nombre_tecnico";
  ajax_field_list[2] = "email_tecnico";
  ajax_field_list[3] = "telefono_tecnico";
  ajax_field_list[4] = "usuario_login";
  ajax_field_list[5] = "fecha_nacimiento";
  ajax_field_list[6] = "md";
  ...
  var ajax_error_list = {
    ...
    "nombre_tecnico": {"label": "Nombre Tecnico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email_tecnico": {"label": "Email Tecnico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "telefono_tecnico": {"label": "Telefono Tecnico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "fecha_nacimiento": {"label": "Fecha Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "md": {"label": "md", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "md": new Array("hidden_field_label_md", "hidden_field_data_md")
  };
