<?php  
  ...
  session_start() ;
  class form_ciudades_form_teste
  {
   function form_ciudades_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_ciudades/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_ciudades</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_ciudades"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_ciudades_form_teste();
  $frm_teste->form_ciudades_teste();
?>
