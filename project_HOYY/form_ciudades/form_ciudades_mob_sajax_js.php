  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ciudades_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ciudades_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_ciudades_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_id(var_id, var_script_case_init, do_ajax_form_ciudades_mob_validate_id_cb);
  } // do_ajax_form_ciudades_mob_validate_id

  function do_ajax_form_ciudades_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_id_cb

  // ---------- Validate id_cliente
  function do_ajax_form_ciudades_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_ciudades_mob_validate_id_cliente_cb);
  } // do_ajax_form_ciudades_mob_validate_id_cliente

  function do_ajax_form_ciudades_mob_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_id_cliente_cb

  // ---------- Validate codigo_pais_iso
  function do_ajax_form_ciudades_mob_validate_codigo_pais_iso()
  {
    var nomeCampo_codigo_pais_iso = "codigo_pais_iso";
    var var_codigo_pais_iso = scAjaxGetFieldSelect(nomeCampo_codigo_pais_iso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_codigo_pais_iso(var_codigo_pais_iso, var_script_case_init, do_ajax_form_ciudades_mob_validate_codigo_pais_iso_cb);
  } // do_ajax_form_ciudades_mob_validate_codigo_pais_iso

  function do_ajax_form_ciudades_mob_validate_codigo_pais_iso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_pais_iso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_codigo_pais_iso_cb

  // ---------- Validate nombre
  function do_ajax_form_ciudades_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_ciudades_mob_validate_nombre_cb);
  } // do_ajax_form_ciudades_mob_validate_nombre

  function do_ajax_form_ciudades_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_nombre_cb

  // ---------- Validate distrito
  function do_ajax_form_ciudades_mob_validate_distrito()
  {
    var nomeCampo_distrito = "distrito";
    var var_distrito = scAjaxGetFieldText(nomeCampo_distrito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_mob_validate_distrito(var_distrito, var_script_case_init, do_ajax_form_ciudades_mob_validate_distrito_cb);
  } // do_ajax_form_ciudades_mob_validate_distrito

  function do_ajax_form_ciudades_mob_validate_distrito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "distrito";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_mob_validate_distrito_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ciudades_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ciudades_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_cliente = scAjaxGetFieldSelect("id_cliente");
    var var_codigo_pais_iso = scAjaxGetFieldSelect("codigo_pais_iso");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_distrito = scAjaxGetFieldText("distrito");
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_mob_submit_form(var_id, var_id_cliente, var_codigo_pais_iso, var_nombre, var_distrito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudades_mob_submit_form_cb);
  } // do_ajax_form_ciudades_mob_submit_form

  function do_ajax_form_ciudades_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ciudades_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ciudades_mob_submit_form_cb
  function do_ajax_form_ciudades_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ciudades_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ciudades_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ciudades_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_ciudades_mob_navigate_form();
    }
  }

  function perform_ajax_form_ciudades_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ciudades_mob_navigate_form_cb);
  } // do_ajax_form_ciudades_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudades_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ciudades_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ciudades_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ciudades_mob_navigate_form_cb
  function do_ajax_form_ciudades_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ciudades_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ciudades_mob_navigate_form_cb_after_alert

  function sc_hide_form_ciudades_mob_form()
  {
  ...
  ajax_field_list[1] = "id_cliente";
  ajax_field_list[2] = "codigo_pais_iso";
  ajax_field_list[3] = "nombre";
  ajax_field_list[4] = "distrito";
  ...
  var ajax_error_list = {
    ...
    "codigo_pais_iso": {"label": "Codigo Pais Iso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "distrito": {"label": "Distrito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "codigo_pais_iso": new Array(),
    "nombre": new Array(),
    "distrito": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["id_cliente"][1] = "id_cliente";
  ajax_field_mult["codigo_pais_iso"][1] = "codigo_pais_iso";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["distrito"][1] = "distrito";
  ...
  var ajax_field_id = {
    ...
    "codigo_pais_iso": new Array("hidden_field_label_codigo_pais_iso", "hidden_field_data_codigo_pais_iso"),
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "distrito": new Array("hidden_field_label_distrito", "hidden_field_data_distrito")
  };
