  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ciudades" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_ciudades_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_id(var_id, var_script_case_init, do_ajax_form_ciudades_validate_id_cb);
  } // do_ajax_form_ciudades_validate_id

  function do_ajax_form_ciudades_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_id_cb

  // ---------- Validate id_cliente
  function do_ajax_form_ciudades_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_ciudades_validate_id_cliente_cb);
  } // do_ajax_form_ciudades_validate_id_cliente

  function do_ajax_form_ciudades_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_id_cliente_cb

  // ---------- Validate codigo_pais_iso
  function do_ajax_form_ciudades_validate_codigo_pais_iso()
  {
    var nomeCampo_codigo_pais_iso = "codigo_pais_iso";
    var var_codigo_pais_iso = scAjaxGetFieldSelect(nomeCampo_codigo_pais_iso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_codigo_pais_iso(var_codigo_pais_iso, var_script_case_init, do_ajax_form_ciudades_validate_codigo_pais_iso_cb);
  } // do_ajax_form_ciudades_validate_codigo_pais_iso

  function do_ajax_form_ciudades_validate_codigo_pais_iso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_codigo_pais_iso_cb

  // ---------- Validate nombre
  function do_ajax_form_ciudades_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_ciudades_validate_nombre_cb);
  } // do_ajax_form_ciudades_validate_nombre

  function do_ajax_form_ciudades_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_nombre_cb

  // ---------- Validate distrito
  function do_ajax_form_ciudades_validate_distrito()
  {
    var nomeCampo_distrito = "distrito";
    var var_distrito = scAjaxGetFieldText(nomeCampo_distrito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_distrito(var_distrito, var_script_case_init, do_ajax_form_ciudades_validate_distrito_cb);
  } // do_ajax_form_ciudades_validate_distrito

  function do_ajax_form_ciudades_validate_distrito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_distrito_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ciudades_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ciudades_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_submit_form(var_id, var_id_cliente, var_codigo_pais_iso, var_nombre, var_distrito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudades_submit_form_cb);
  } // do_ajax_form_ciudades_submit_form

  function do_ajax_form_ciudades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ciudades_submit_form_cb_after_alert);
  } // do_ajax_form_ciudades_submit_form_cb
  function do_ajax_form_ciudades_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ciudades_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ciudades_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ciudades_navigate_form, function() {});
    } else {
      perform_ajax_form_ciudades_navigate_form();
    }
  }

  function perform_ajax_form_ciudades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ciudades_navigate_form_cb);
  } // do_ajax_form_ciudades_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudades']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ciudades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ciudades_navigate_form_cb_after_alert);
  } // do_ajax_form_ciudades_navigate_form_cb
  function do_ajax_form_ciudades_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ciudades_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ciudades_navigate_form_cb_after_alert

  function sc_hide_form_ciudades_form()
  {
