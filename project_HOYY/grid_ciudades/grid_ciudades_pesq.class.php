...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigo_pais_iso')
      {
          $codigo_pais_iso = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigo_pais_iso($codigo_pais_iso);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> ciudades</TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_cliente#NMF#' + search_get_text('SC_id_cliente') + '@NMF@';
  str_out += 'SC_codigo_pais_iso_cond#NMF#' + search_get_sel_txt('SC_codigo_pais_iso_cond') + '@NMF@';
  str_out += 'SC_codigo_pais_iso#NMF#' + search_get_text('SC_codigo_pais_iso') + '@NMF@';
  str_out += 'id_ac_codigo_pais_iso#NMF#' + search_get_text('id_ac_codigo_pais_iso') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_codigo_pais_iso").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codigo_pais_iso").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigo_pais_iso",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_codigo_pais_iso").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codigo_pais_iso").val( $(this).val() );
       }
     }
   });
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> ciudades</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $codigo_pais_iso_cond, $codigo_pais_iso, $codigo_pais_iso_autocomp,
      ...
      { 
          ...
          $id_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['id_cliente']; 
          $id_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['id_cliente_cond']; 
          $codigo_pais_iso = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['codigo_pais_iso']; 
          $codigo_pais_iso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['codigo_pais_iso_cond']; 
          ...
          if (strtoupper($id_cliente_cond) != "II" && strtoupper($id_cliente_cond) != "QP" && strtoupper($id_cliente_cond) != "NP" && strtoupper($id_cliente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($codigo_pais_iso_cond) || empty($codigo_pais_iso_cond))
      {
         $codigo_pais_iso_cond = "qp";
      }
      ...
      $str_hide_codigo_pais_iso = (in_array($codigo_pais_iso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($id_cliente)) ? strpos($id_cliente, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($codigo_pais_iso) || $codigo_pais_iso == "")
      {
          $codigo_pais_iso = "";
      }
      if (isset($codigo_pais_iso) && !empty($codigo_pais_iso))
      {
         $tmp_pos = (is_string($codigo_pais_iso)) ? strpos($codigo_pais_iso, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $codigo_pais_iso = substr($codigo_pais_iso, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_id_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_cliente_cond" name="id_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente'), this, 'id_cliente')">
       <OPTION value="gt" <?php if ("gt" == $id_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_id_cliente" name="id_cliente" value="<?php echo NM_encode_input($id_cliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_codigo_pais_iso_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo_pais_iso'])) ? $this->New_label['codigo_pais_iso'] : "Codigo Pais Iso"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codigo_pais_iso_cond" name="codigo_pais_iso_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_pais_iso'), this, 'codigo_pais_iso')">
       <OPTION value="qp" <?php if ("qp" == $codigo_pais_iso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigo_pais_iso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigo_pais_iso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigo_pais_iso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo_pais_iso" <?php echo $str_hide_codigo_pais_iso?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codigo_pais_iso'])) ? $this->New_label['codigo_pais_iso'] : "Codigo Pais Iso";
 $nmgp_tab_label .= "codigo_pais_iso?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $codigo_pais_iso;
      }
?>
<INPUT  type="text" id="SC_codigo_pais_iso" name="codigo_pais_iso" value="<?php echo NM_encode_input($codigo_pais_iso) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo_pais_iso" name="codigo_pais_iso_autocomp" size="3"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_cliente_cond.value = 'gt';
   ...
   document.F1.codigo_pais_iso_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codigo_pais_iso'), document.F1.codigo_pais_iso_cond, 'codigo_pais_iso');
   document.F1.codigo_pais_iso.value = "";
   document.F1.codigo_pais_iso_autocomp.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_id_cliente'] = 'text';
      $tp_fields['SC_codigo_pais_iso_cond'] = 'cond';
      $tp_fields['SC_codigo_pais_iso'] = 'text_aut';
      $tp_fields['id_ac_codigo_pais_iso'] = 'text_aut';
   ...
   {
      global $nombre_cond, $nombre, $nombre_autocomp,
             $id_cond, $id,
             $id_cliente_cond, $id_cliente,
             $codigo_pais_iso_cond, $codigo_pais_iso, $codigo_pais_iso_autocomp, $nmgp_tab_label;
      ...
      if (!empty($codigo_pais_iso_autocomp) && empty($codigo_pais_iso))
      {
          $codigo_pais_iso = $codigo_pais_iso_autocomp;
      }
      ...
      $codigo_pais_iso_cond_salva = $codigo_pais_iso_cond; 
      if (!isset($codigo_pais_iso_input_2) || $codigo_pais_iso_input_2 == "")
      {
          $codigo_pais_iso_input_2 = $codigo_pais_iso;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_cliente_cond != "in")
      {
          nm_limpa_numero($id_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['id_cliente'] = $id_cliente; 
      if (is_array($id_cliente) && !empty($id_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['val'][0] = $id_cliente;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['val'][0][0] = $id_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['id_cliente_cond'] = $id_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['cmp'] = "id_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['opc'] = $id_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['grid_pesq']['id_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['codigo_pais_iso'] = $codigo_pais_iso; 
      if (is_array($codigo_pais_iso) && !empty($codigo_pais_iso))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['val'][0] = $codigo_pais_iso;
      }
      elseif ($codigo_pais_iso_cond_salva == "nu" || $codigo_pais_iso_cond_salva == "nn" || $codigo_pais_iso_cond_salva == "ep" || $codigo_pais_iso_cond_salva == "ne" || !empty($codigo_pais_iso))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['val'][0][0] = $codigo_pais_iso;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['campos_busca']['codigo_pais_iso_cond'] = $codigo_pais_iso_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['cmp'] = "codigo_pais_iso"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid]['opc'] = $codigo_pais_iso_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['grid_pesq']['codigo_pais_iso'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
    ...
    if ($codigo_pais_iso != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigo_pais_iso'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codigo_pais_iso'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigo_pais_iso'] = $codigo_pais_iso;
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $id_cliente
      $this->Date_part = false;
      if (isset($id_cliente) || $id_cliente_cond == "nu" || $id_cliente_cond == "nn" || $id_cliente_cond == "ep" || $id_cliente_cond == "ne")
      {
         $this->monta_condicao("id_cliente", $id_cliente_cond, $id_cliente, "", "id_cliente", "INT", false);
      }

      //----- $codigo_pais_iso
      $this->Date_part = false;
      if (isset($codigo_pais_iso) || $codigo_pais_iso_cond == "nu" || $codigo_pais_iso_cond == "nn" || $codigo_pais_iso_cond == "ep" || $codigo_pais_iso_cond == "ne")
      {
         $this->monta_condicao("codigo_pais_iso", $codigo_pais_iso_cond, $codigo_pais_iso, "", "codigo_pais_iso", "CHAR", false);
      }
   }
