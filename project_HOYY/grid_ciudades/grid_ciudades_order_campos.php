...
<?php
   ...
   $Ord_Cmp = new grid_ciudades_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ciudades_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id"] : "Id";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id_cliente"] : "Id Cliente";
   $tab_ger_campos['codigo_pais_iso'] = "on";
   $tab_def_campos['codigo_pais_iso'] = "codigo_pais_iso";
   $tab_labels["codigo_pais_iso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["codigo_pais_iso"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["codigo_pais_iso"] : "Codigo Pais Iso";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['distrito'] = "on";
   $tab_def_campos['distrito'] = "distrito";
   $tab_labels["distrito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["distrito"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["distrito"] : "Distrito";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ciudades']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ciudades']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ciudades_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ciudades']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
