...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_cliente";$Nm_numeric[] = "id";$Nm_numeric[] = "id_cliente";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_cliente_cond" name="id_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente'), this, 'id_cliente')">
      ...
      <br><span id="id_hide_id_cliente"  <?php echo $str_hide_id_cliente?>><INPUT  type="text" id="SC_id_cliente" name="id_cliente" value="<?php echo NM_encode_input($id_cliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_pais_iso_cond" name="codigo_pais_iso_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_pais_iso'), this, 'codigo_pais_iso')">
      ...
      <br><span id="id_hide_codigo_pais_iso"  <?php echo $str_hide_codigo_pais_iso?>><?php
      if ($codigo_pais_iso != "")
      {
      $codigo_pais_iso_look = (is_string($codigo_pais_iso) ? substr($this->Db->qstr($codigo_pais_iso), 1, -1) : $codigo_pais_iso); 
      $nmgp_def_dados = array(); 
