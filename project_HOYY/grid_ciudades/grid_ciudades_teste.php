<?php  
  ...
  session_start() ;
  class grid_ciudades_form_teste
  {
  function grid_ciudades_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_ciudades</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_ciudades"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_ciudades_form_teste();
  $frm_teste->grid_ciudades_teste();
?>
