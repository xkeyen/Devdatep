...
//
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label']))
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label'] .= "nombre?#?" . "Nombre" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label'] .= "id?#?" . "Id" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label'] .= "id_cliente?#?" . "Id Cliente" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label'] .= "codigo_pais_iso?#?" . "Codigo Pais Iso" . "?@?";
   }
   ...
   $this->Cmps_ord_def['codigo_pais_iso'] = " asc";
   ...
   { 
       ...
       $this->codigo_pais_iso = (isset($Busca_temp['codigo_pais_iso'])) ? $Busca_temp['codigo_pais_iso'] : ""; 
       $tmp_pos = (is_string($this->codigo_pais_iso)) ? strpos($this->codigo_pais_iso, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->codigo_pais_iso))
       {
           $this->codigo_pais_iso = substr($this->codigo_pais_iso, 0, $tmp_pos);
       }
   } 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT id, id_cliente, codigo_pais_iso, nombre, distrito from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       ...
       $this->codigo_pais_iso = $this->rs_grid->fields[2] ;  
       $this->nombre = $this->rs_grid->fields[3] ;  
       $this->distrito = $this->rs_grid->fields[4] ;  
       $GLOBALS["id_cliente"] = $this->rs_grid->fields[1] ;  
       $GLOBALS["id_cliente"] = (string)$GLOBALS["id_cliente"] ;
       $GLOBALS["codigo_pais_iso"] = $this->rs_grid->fields[2] ;  
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_ciudades_jquery_7923.js\"></script>\r\n");
...
$nm_saida->saida("}\r\n");
 ...
 {  
   ...
   $this->css_codigo_pais_iso_label = $compl_css_emb . "css_codigo_pais_iso_label";
   $this->css_codigo_pais_iso_grid_line = $compl_css_emb . "css_codigo_pais_iso_grid_line";
...
// 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_id_cliente_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_id_cliente_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_codigo_pais_iso()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['codigo_pais_iso'])) ? $this->New_label['codigo_pais_iso'] : "Codigo Pais Iso";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['codigo_pais_iso']) || $this->NM_cmp_hidden['codigo_pais_iso'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_codigo_pais_iso_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo_pais_iso_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('codigo_pais_iso');
        $fieldSortIcon = $this->scGetColumnOrderIcon('codigo_pais_iso', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_codigo_pais_iso_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_codigo_pais_iso_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('codigo_pais_iso')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['distrito'])) ? $this->New_label['distrito'] : "Distrito";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
// 
   ...
   $SC_Label = (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['labels']['id_cliente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['codigo_pais_iso'])) ? $this->New_label['codigo_pais_iso'] : "Codigo Pais Iso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['labels']['codigo_pais_iso'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : "Nombre";
...
// 
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['mostra_edit'] != "N"){ 
              ...
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_ciudades . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_ciudades', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_ciudades . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_ciudades', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->id . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_ciudades@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "grid_ciudades/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_ciudades&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "grid_ciudades/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_ciudades&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_id_cliente()
 {
      ...
      if (!isset($this->NM_cmp_hidden['id_cliente']) || $this->NM_cmp_hidden['id_cliente'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'id_cliente', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'id_cliente', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_id_cliente_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_id_cliente_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_id_cliente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_codigo_pais_iso()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['codigo_pais_iso']) || $this->NM_cmp_hidden['codigo_pais_iso'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->codigo_pais_iso));
              $conteudo_original = NM_encode_input(sc_strip_script($this->codigo_pais_iso));
          }
          else {
              $conteudo = sc_strip_script($this->codigo_pais_iso); 
              $conteudo_original = sc_strip_script($this->codigo_pais_iso); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          $this->Lookup->lookup_codigo_pais_iso($conteudo , $this->codigo_pais_iso) ; 
          $str_tem_display = $conteudo;
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'codigo_pais_iso', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'codigo_pais_iso', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_codigo_pais_iso_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_codigo_pais_iso_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_codigo_pais_iso_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $SC_Label_atu['id_cliente'] = (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : 'Id Cliente'; 
          $SC_Label_atu['codigo_pais_iso'] = (isset($this->New_label['codigo_pais_iso'])) ? $this->New_label['codigo_pais_iso'] : 'Codigo Pais Iso'; 
          $SC_Label_atu['nombre'] = (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : 'Nombre'; 
          $SC_Label_atu['distrito'] = (isset($this->New_label['distrito'])) ? $this->New_label['distrito'] : 'Distrito'; 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['field_order'] as $cada_field)
          { 
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ciudades/grid_ciudades_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_ciudades&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ciudades/grid_ciudades_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ciudades/grid_ciudades_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ciudades/grid_ciudades_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_form_ciudades . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_ciudades'); return false;;", "nm_gp_submit1('" .  $this->Ini->link_form_ciudades . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_ciudades'); return false;;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['SC_Ind_Groupby'] != "sc_free_total")
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['csv'][] = "csv_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ciudades/grid_ciudades_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "id_cliente")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "id_cliente";
                           $lin_obj = $this->grid_search_id_cliente($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "codigo_pais_iso")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "codigo_pais_iso";
                           $lin_obj = $this->grid_search_codigo_pais_iso($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('nombre','id','id_cliente','codigo_pais_iso');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ciudades']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
   ...
   function grid_search_id_cliente($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_id_cliente_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_id_cliente_cond_" . $ind . "' name='cond_grid_search_id_cliente_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"id_cliente\", $ind)'>";
       $selected = ($opc == "gt") ? " selected" : "";
       $lin_obj .= "        <option value='gt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_grtr'] . "</option>";
       $selected = ($opc == "lt") ? " selected" : "";
       $lin_obj .= "        <option value='lt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_less'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_id_cliente_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       nmgp_Form_Num_Val($val_cmp, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_id_cliente_val_" . $ind . "' name='val_grid_search_id_cliente_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=10 alt=\"{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_codigo_pais_iso($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_codigo_pais_iso_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_codigo_pais_iso_cond_" . $ind . "' name='cond_grid_search_codigo_pais_iso_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"codigo_pais_iso\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_codigo_pais_iso_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $codigo_pais_iso = $val_cmp;
       if ($codigo_pais_iso != "")
       {
       $codigo_pais_iso_look = (is_string($codigo_pais_iso) ? substr($this->Db->qstr($codigo_pais_iso), 1, -1) : $codigo_pais_iso); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct codigo_pais_iso from " . $this->Ini->nm_tabela . " where codigo_pais_iso = '$codigo_pais_iso_look' order by codigo_pais_iso"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
       ...
       if (isset($nmgp_def_dados[0][$codigo_pais_iso]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$codigo_pais_iso];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_codigo_pais_iso_val_" . $ind . "' name='val_grid_search_codigo_pais_iso_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=3 alt=\"{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_codigo_pais_iso" . $ind . "' name='val_grid_search_codigo_pais_iso_autocomp" . $ind . "' size='3' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function lookup_ajax_codigo_pais_iso($codigo_pais_iso)
   {
       $codigo_pais_iso = substr($this->Db->qstr($codigo_pais_iso), 1, -1);
       $this->NM_case_insensitive = false;
       $codigo_pais_iso_look = (is_string($codigo_pais_iso) ? substr($this->Db->qstr($codigo_pais_iso), 1, -1) : $codigo_pais_iso); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct codigo_pais_iso from " . $this->Ini->nm_tabela . " where  codigo_pais_iso like '%" . $codigo_pais_iso . "%' order by codigo_pais_iso"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "project_HOYY/grid_ciudades";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'codigo_pais_iso')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_codigo_pais_iso = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_codigo_pais_iso\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                             nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                             origem: \"grid\",\r\n");
       $nm_saida->saida("                             field: \"codigo_pais_iso\",\r\n");
       $nm_saida->saida("                             max_itens: \"10\",\r\n");
       $nm_saida->saida("                             cod_desc: \"N\",\r\n");
       $nm_saida->saida("                             script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           },\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_codigo_pais_iso_val_\" + x_codigo_pais_iso).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_codigo_pais_iso_val_\" + x_codigo_pais_iso).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'id_cliente')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'codigo_pais_iso')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
        ...
        elseif($filter_type == 'quicksearch')
        {
            if(
                ...
                (
                    ...
                    in_array($field, array('id', 'id_cliente', 'codigo_pais_iso', 'nombre', 'distrito'))
                    ) ||
