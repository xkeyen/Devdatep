...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["project_HOYY_____Grafico_pais"]))
   {
      unset($_SESSION['session_sec_aplicacao']["project_HOYY_____Grafico_pais"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grafico_pais']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Grafico_pais']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grafico_pais']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Grafico_pais']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Grafico_pais']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Grafico_pais']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Grafico_pais']['embutida_filho'] as $ind => $sc_init)
          {
