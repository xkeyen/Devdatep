...
//
   ...
   $_SESSION['scriptcase']['form_agenda_mob']['glo_nm_perfil']          = "";
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['run_iframe'] = "";
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_agenda_mob']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'project_HOYY', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'project_HOYY', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    {
        if ('ajax_form_agenda_mob_validate_id_agenda' == $_POST['rs'])
        {
            $id_agenda = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_id_tecnico' == $_POST['rs'])
        {
            $id_tecnico = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_id_cliente' == $_POST['rs'])
        {
            $id_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_valor' == $_POST['rs'])
        {
            $valor = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_costes_adicionales' == $_POST['rs'])
        {
            $costes_adicionales = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_descuento' == $_POST['rs'])
        {
            $descuento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_valor_total' == $_POST['rs'])
        {
            $valor_total = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_fecha_inicial' == $_POST['rs'])
        {
            $fecha_inicial = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_hora_inicial' == $_POST['rs'])
        {
            $hora_inicial = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_fecha_final' == $_POST['rs'])
        {
            $fecha_final = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_hora_final' == $_POST['rs'])
        {
            $hora_final = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_estado_actual' == $_POST['rs'])
        {
            $estado_actual = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_recurrencia' == $_POST['rs'])
        {
            $recurrencia = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_periodo' == $_POST['rs'])
        {
            $periodo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_agenda_mob_validate_evaluacion' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_agenda_mob_validate_id_agenda");
    sajax_export("ajax_form_agenda_mob_validate_id_tecnico");
    sajax_export("ajax_form_agenda_mob_validate_id_cliente");
    sajax_export("ajax_form_agenda_mob_validate_valor");
    sajax_export("ajax_form_agenda_mob_validate_costes_adicionales");
    sajax_export("ajax_form_agenda_mob_validate_descuento");
    sajax_export("ajax_form_agenda_mob_validate_valor_total");
    sajax_export("ajax_form_agenda_mob_validate_fecha_inicial");
    sajax_export("ajax_form_agenda_mob_validate_hora_inicial");
    sajax_export("ajax_form_agenda_mob_validate_fecha_final");
    sajax_export("ajax_form_agenda_mob_validate_hora_final");
    sajax_export("ajax_form_agenda_mob_validate_estado_actual");
    sajax_export("ajax_form_agenda_mob_validate_recurrencia");
    sajax_export("ajax_form_agenda_mob_validate_periodo");
    sajax_export("ajax_form_agenda_mob_validate_evaluacion");
    ...
    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }
...
//
    ...
    function ajax_form_agenda_mob_validate_id_agenda($id_agenda, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        ...
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_id_agenda';
    ...
    function ajax_form_agenda_mob_validate_id_tecnico($id_tecnico, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_id_tecnico';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_id_cliente($id_cliente, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_id_cliente';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_valor($valor, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_valor';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_costes_adicionales($costes_adicionales, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_costes_adicionales';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_descuento($descuento, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_descuento';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_valor_total($valor_total, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_valor_total';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_fecha_inicial($fecha_inicial, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_fecha_inicial';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_hora_inicial($hora_inicial, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_hora_inicial';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_fecha_final($fecha_final, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_fecha_final';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_hora_final($hora_final, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_hora_final';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_estado_actual($estado_actual, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_estado_actual';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_recurrencia($recurrencia, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_recurrencia';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_periodo($periodo, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_periodo';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_validate_evaluacion($evaluacion, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_evaluacion';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_navigate_form($id_agenda, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
   ...
   function form_agenda_mob_pack_ajax_response()
   {
      ...
      if (isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['wizard'];
      }
...
//-----
      {
         ...
         if (isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnDisabled']) && '' != $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnDisabled'])
         {
            form_agenda_mob_pack_btn_disabled($aResp);
         }
         if (isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnLabel']) && '' != $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnLabel'])
         {
            form_agenda_mob_pack_btn_label($aResp);
         }
         ...
         {
/* mantis 0021191 */            $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['buttonDisplay'] = $inicial_form_agenda_mob->contr_form_agenda_mob->nmgp_botoes;
   ...
   function form_agenda_mob_pack_btn_disabled(&$aResp)
   {
      global $inicial_form_agenda_mob;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // form_agenda_mob_pack_ajax_alert

   function form_agenda_mob_pack_btn_label(&$aResp)
   {
      global $inicial_form_agenda_mob;
      $aResp['btnLabel'] = array();
      foreach ($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
   ...
   function form_agenda_mob_pack_ajax_alert(&$aResp)
   {
      global $inicial_form_agenda_mob;
// PHP 8.0
      if (!isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
   ...
   function form_agenda_mob_pack_ajax_message(&$aResp)
   {
      global $inicial_form_agenda_mob;
// PHP 8.0
      if (!isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
   ...
   function form_agenda_mob_pack_ajax_nav_Summary(&$aResp)
   {
      ...
      $aResp['navSummary']['summary_line'] = $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['summary_line'];
