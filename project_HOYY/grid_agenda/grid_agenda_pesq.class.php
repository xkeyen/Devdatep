...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_agenda_cond#NMF#' + search_get_sel_txt('SC_id_agenda_cond') + '@NMF@';
  str_out += 'SC_id_agenda#NMF#' + search_get_text('SC_id_agenda') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $valor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['valor']; 
          $valor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['valor_cond']; 
          $id_agenda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_agenda']; 
          $id_agenda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_agenda_cond']; 
          ...
          $id_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_cliente']; 
          $id_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_cliente_cond']; 
          ...
          { 
              nmgp_Form_Num_Val($valor, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($id_agenda_cond) != "II" && strtoupper($id_agenda_cond) != "QP" && strtoupper($id_agenda_cond) != "NP" && strtoupper($id_agenda_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_agenda, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      ...
      if (!isset($id_agenda_cond) || empty($id_agenda_cond))
      {
         $id_agenda_cond = "gt";
      }
      ...
      $str_hide_id_agenda = (in_array($id_agenda_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($valor)) ? strpos($valor, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($id_agenda) || $id_agenda == "")
      {
          $id_agenda = "";
      }
      if (isset($id_agenda) && !empty($id_agenda))
      {
         $tmp_pos = (is_string($id_agenda)) ? strpos($id_agenda, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_agenda = substr($id_agenda, 0, $tmp_pos);
         }
      }
...
<INPUT  type="text" id="SC_valor" name="valor" value="<?php echo NM_encode_input($valor) ?>" size=6 alt="{datatype: 'decimal', maxLength: 6, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_agenda_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_agenda'])) ? $this->New_label['id_agenda'] : "Id Agenda"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_agenda_cond" name="id_agenda_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_agenda'), this, 'id_agenda')">
       <OPTION value="gt" <?php if ("gt" == $id_agenda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_agenda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_agenda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_agenda" <?php echo $str_hide_id_agenda?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_agenda'])) ? $this->New_label['id_agenda'] : "Id Agenda";
 $nmgp_tab_label .= "id_agenda?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_agenda" name="id_agenda" value="<?php echo NM_encode_input($id_agenda) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_id_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_tecnico'])) ? $this->New_label['id_tecnico'] : "Id Tecnico"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_tecnico_cond" name="id_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_tecnico'), this, 'id_tecnico')">
...
?>
<INPUT  type="text" id="SC_id_tecnico" name="id_tecnico" value="<?php echo NM_encode_input($id_tecnico) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_cliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_cliente_cond" name="id_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente'), this, 'id_cliente')">
...
?>
<INPUT  type="text" id="SC_id_cliente" name="id_cliente" value="<?php echo NM_encode_input($id_cliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_agenda_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_agenda'), document.F1.id_agenda_cond, 'id_agenda');
   document.F1.id_agenda.value = "";
...
<?php
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_id_agenda_cond'] = 'cond';
      $tp_fields['SC_id_agenda'] = 'text';
   ...
   function trata_campos()
   {
      global $valor_cond, $valor,
             $id_agenda_cond, $id_agenda,
             $id_tecnico_cond, $id_tecnico,
             $id_cliente_cond, $id_cliente, $nmgp_tab_label;
      ...
      $id_agenda_cond_salva = $id_agenda_cond; 
      if (!isset($id_agenda_input_2) || $id_agenda_input_2 == "")
      {
          $id_agenda_input_2 = $id_agenda;
      }
      ...
      if ($valor_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($valor, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($id_agenda_cond != "in")
      {
          nm_limpa_numero($id_agenda, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['valor'] = $valor; 
      if (is_array($valor) && !empty($valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0] = $valor;
      }
      elseif ($valor_cond_salva == "nu" || $valor_cond_salva == "nn" || $valor_cond_salva == "ep" || $valor_cond_salva == "ne" || !empty($valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0][0] = $valor;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['valor_cond'] = $valor_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['cmp'] = "valor"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['opc'] = $valor_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['grid_pesq']['valor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_agenda'] = $id_agenda; 
      if (is_array($id_agenda) && !empty($id_agenda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0] = $id_agenda;
      }
      elseif ($id_agenda_cond_salva == "nu" || $id_agenda_cond_salva == "nn" || $id_agenda_cond_salva == "ep" || $id_agenda_cond_salva == "ne" || !empty($id_agenda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0][0] = $id_agenda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_agenda_cond'] = $id_agenda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['cmp'] = "id_agenda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['opc'] = $id_agenda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['grid_pesq']['id_agenda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_cliente'] = $id_cliente; 
      if (is_array($id_cliente) && !empty($id_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0] = $id_cliente;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['val'][0][0] = $id_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['campos_busca']['id_cliente_cond'] = $id_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['cmp'] = "id_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid]['opc'] = $id_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['grid_pesq']['id_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      ...
      $this->cmp_formatado['id_agenda'] = $Conteudo;
      $Conteudo = $id_tecnico;
      if (strtoupper($id_tecnico_cond) != "II" && strtoupper($id_tecnico_cond) != "QP" && strtoupper($id_tecnico_cond) != "NP" && strtoupper($id_tecnico_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      {
         $this->monta_condicao("valor", $valor_cond, $valor, "", "valor", "DECIMAL", false);
      }

      //----- $id_agenda
      $this->Date_part = false;
      if (isset($id_agenda) || $id_agenda_cond == "nu" || $id_agenda_cond == "nn" || $id_agenda_cond == "ep" || $id_agenda_cond == "ne")
      {
         $this->monta_condicao("id_agenda", $id_agenda_cond, $id_agenda, "", "id_agenda", "INT", false);
      }
