...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["project_HOYY_____grid_agenda"]))
   {
      unset($_SESSION['session_sec_aplicacao']["project_HOYY_____grid_agenda"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida_filho'] as $ind => $sc_init)
          {
