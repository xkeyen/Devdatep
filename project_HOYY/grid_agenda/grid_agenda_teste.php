<?php  
  ...
  session_start() ;
  class grid_agenda_form_teste
  {
  function grid_agenda_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_agenda</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_agenda"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_agenda_form_teste();
  $frm_teste->grid_agenda_teste();
?>
