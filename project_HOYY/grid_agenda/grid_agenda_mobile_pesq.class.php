...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_agenda_cond" name="id_agenda_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_agenda'), this, 'id_agenda')">
      ...
      <br><span id="id_hide_id_agenda"  <?php echo $str_hide_id_agenda?>><INPUT  type="text" id="SC_id_agenda" name="id_agenda" value="<?php echo NM_encode_input($id_agenda) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_tecnico_cond" name="id_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_tecnico'), this, 'id_tecnico')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_cliente_cond" name="id_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente'), this, 'id_cliente')">
