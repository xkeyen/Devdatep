...
?>
  ...
  // ---------- Validate login
  function do_ajax_form_usuarios_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_login(var_login, var_script_case_init, do_ajax_form_usuarios_validate_login_cb);
  } // do_ajax_form_usuarios_validate_login

  function do_ajax_form_usuarios_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_login_cb

  // ---------- Validate contrasena
  function do_ajax_form_usuarios_validate_contrasena()
  {
    var nomeCampo_contrasena = "contrasena";
    var var_contrasena = scAjaxGetFieldText(nomeCampo_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_contrasena(var_contrasena, var_script_case_init, do_ajax_form_usuarios_validate_contrasena_cb);
  } // do_ajax_form_usuarios_validate_contrasena

  function do_ajax_form_usuarios_validate_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_contrasena_cb

  // ---------- Validate nombre
  function do_ajax_form_usuarios_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_usuarios_validate_nombre_cb);
  } // do_ajax_form_usuarios_validate_nombre

  function do_ajax_form_usuarios_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_nombre_cb

  // ---------- Validate email
  function do_ajax_form_usuarios_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_email(var_email, var_script_case_init, do_ajax_form_usuarios_validate_email_cb);
  } // do_ajax_form_usuarios_validate_email

  function do_ajax_form_usuarios_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_email_cb
  ...
  function do_ajax_form_usuarios_validate_codigo_activacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_codigo_activacion(var_codigo_activacion, var_script_case_init, do_ajax_form_usuarios_validate_codigo_activacion_cb);
  } // do_ajax_form_usuarios_validate_codigo_activacion

  function do_ajax_form_usuarios_validate_codigo_activacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_codigo_activacion_cb

  // ---------- Validate privilegio_administrador
  function do_ajax_form_usuarios_validate_privilegio_administrador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_privilegio_administrador(var_privilegio_administrador, var_script_case_init, do_ajax_form_usuarios_validate_privilegio_administrador_cb);
  } // do_ajax_form_usuarios_validate_privilegio_administrador

  function do_ajax_form_usuarios_validate_privilegio_administrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_privilegio_administrador_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_usuarios_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_submit_form(var_login, var_contrasena, var_nombre, var_email, var_activo, var_codigo_activacion, var_privilegio_administrador, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_usuarios_navigate_form, function() {});
    } else {
      perform_ajax_form_usuarios_navigate_form();
    }
  }

  function perform_ajax_form_usuarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_navigate_form_cb);
