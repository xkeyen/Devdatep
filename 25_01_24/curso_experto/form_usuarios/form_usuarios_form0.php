...
else
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['link_info']['remove_border']) {
...
<?php 
          ...
          $SC_Label_atu['login'] = (isset($this->nm_new_label['login'])) ? $this->nm_new_label['login'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_login'] . ''; 
          $SC_Label_atu['contrasena'] = (isset($this->nm_new_label['contrasena'])) ? $this->nm_new_label['contrasena'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_contrasena'] . ''; 
          $SC_Label_atu['nombre'] = (isset($this->nm_new_label['nombre'])) ? $this->nm_new_label['nombre'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_nombre'] . ''; 
          $SC_Label_atu['email'] = (isset($this->nm_new_label['email'])) ? $this->nm_new_label['email'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_email'] . ''; 
          $SC_Label_atu['activo'] = (isset($this->nm_new_label['activo'])) ? $this->nm_new_label['activo'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_activo'] . ''; 
          $SC_Label_atu['codigo_activacion'] = (isset($this->nm_new_label['codigo_activacion'])) ? $this->nm_new_label['codigo_activacion'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_codigo_activacion'] . ''; 
          $SC_Label_atu['privilegio_administrador'] = (isset($this->nm_new_label['privilegio_administrador'])) ? $this->nm_new_label['privilegio_administrador'] : '' . $this->Ini->Nm_lang['lang_usuarios_fld_privilegio_administrador'] . ''; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['btn_label']['breload'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contrasena_label" id="hidden_field_label_contrasena" style="<?php echo $sStyleHidden_contrasena; ?>"><span id="id_label_contrasena"><?php echo $this->nm_new_label['contrasena']; ?></span></TD>
    <TD class="scFormDataOdd css_contrasena_line" id="hidden_field_data_contrasena" style="<?php echo $sStyleHidden_contrasena; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_activo_line" id="hidden_field_data_activo" style="<?php echo $sStyleHidden_activo; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_activacion_label" id="hidden_field_label_codigo_activacion" style="<?php echo $sStyleHidden_codigo_activacion; ?>"><span id="id_label_codigo_activacion"><?php echo $this->nm_new_label['codigo_activacion']; ?></span></TD>
    <TD class="scFormDataOdd css_codigo_activacion_line" id="hidden_field_data_codigo_activacion" style="<?php echo $sStyleHidden_codigo_activacion; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_privilegio_administrador_label" id="hidden_field_label_privilegio_administrador" style="<?php echo $sStyleHidden_privilegio_administrador; ?>"><span id="id_label_privilegio_administrador"><?php echo $this->nm_new_label['privilegio_administrador']; ?></span></TD>
    <TD class="scFormDataOdd css_privilegio_administrador_line" id="hidden_field_data_privilegio_administrador" style="<?php echo $sStyleHidden_privilegio_administrador; ?>">
