<?php  
  ...
  session_start() ;
  class form_usuarios_form_teste
  {
   function form_usuarios_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_usuarios/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_usuarios</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_usuarios"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_usuarios_form_teste();
  $frm_teste->form_usuarios_teste();
?>
