...
?>
  ...
  // ---------- Validate login
  function do_ajax_form_usuarios_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_login(var_login, var_script_case_init, do_ajax_form_usuarios_mob_validate_login_cb);
  } // do_ajax_form_usuarios_mob_validate_login

  function do_ajax_form_usuarios_mob_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_login_cb

  // ---------- Validate contrasena
  function do_ajax_form_usuarios_mob_validate_contrasena()
  {
    var nomeCampo_contrasena = "contrasena";
    var var_contrasena = scAjaxGetFieldText(nomeCampo_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_contrasena(var_contrasena, var_script_case_init, do_ajax_form_usuarios_mob_validate_contrasena_cb);
  } // do_ajax_form_usuarios_mob_validate_contrasena

  function do_ajax_form_usuarios_mob_validate_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contrasena";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_contrasena_cb

  // ---------- Validate nombre
  function do_ajax_form_usuarios_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_usuarios_mob_validate_nombre_cb);
  } // do_ajax_form_usuarios_mob_validate_nombre

  function do_ajax_form_usuarios_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_nombre_cb

  // ---------- Validate email
  function do_ajax_form_usuarios_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_email(var_email, var_script_case_init, do_ajax_form_usuarios_mob_validate_email_cb);
  } // do_ajax_form_usuarios_mob_validate_email

  function do_ajax_form_usuarios_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_email_cb

  // ---------- Validate activo
  function do_ajax_form_usuarios_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldText(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
  ...
  // ---------- Validate codigo_activacion
  function do_ajax_form_usuarios_mob_validate_codigo_activacion()
  {
    var nomeCampo_codigo_activacion = "codigo_activacion";
    var var_codigo_activacion = scAjaxGetFieldText(nomeCampo_codigo_activacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_codigo_activacion(var_codigo_activacion, var_script_case_init, do_ajax_form_usuarios_mob_validate_codigo_activacion_cb);
  } // do_ajax_form_usuarios_mob_validate_codigo_activacion

  function do_ajax_form_usuarios_mob_validate_codigo_activacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_activacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_codigo_activacion_cb

  // ---------- Validate privilegio_administrador
  function do_ajax_form_usuarios_mob_validate_privilegio_administrador()
  {
    var nomeCampo_privilegio_administrador = "privilegio_administrador";
    var var_privilegio_administrador = scAjaxGetFieldText(nomeCampo_privilegio_administrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_mob_validate_privilegio_administrador(var_privilegio_administrador, var_script_case_init, do_ajax_form_usuarios_mob_validate_privilegio_administrador_cb);
  } // do_ajax_form_usuarios_mob_validate_privilegio_administrador

  function do_ajax_form_usuarios_mob_validate_privilegio_administrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "privilegio_administrador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_mob_validate_privilegio_administrador_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_usuarios_mob_submit_form()
  {
    ...
    var var_contrasena = scAjaxGetFieldText("contrasena");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_email = scAjaxGetFieldText("email");
    var var_activo = scAjaxGetFieldText("activo");
    var var_codigo_activacion = scAjaxGetFieldText("codigo_activacion");
    var var_privilegio_administrador = scAjaxGetFieldText("privilegio_administrador");
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_mob_submit_form(var_login, var_contrasena, var_nombre, var_email, var_activo, var_codigo_activacion, var_privilegio_administrador, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_mob_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_usuarios_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_usuarios_mob_navigate_form();
    }
  }

  function perform_ajax_form_usuarios_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_mob_navigate_form_cb);
...
?>
  ...
  ajax_field_list[1] = "contrasena";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "activo";
  ajax_field_list[5] = "codigo_activacion";
  ajax_field_list[6] = "privilegio_administrador";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "contrasena": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_contrasena'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "activo": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_activo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "codigo_activacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_codigo_activacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "privilegio_administrador": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuarios_fld_privilegio_administrador'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "login": new Array(),
    "contrasena": new Array(),
    "nombre": new Array(),
    "email": new Array(),
    "activo": new Array(),
    "codigo_activacion": new Array(),
    "privilegio_administrador": new Array()
  };
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["contrasena"][1] = "contrasena";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["codigo_activacion"][1] = "codigo_activacion";
  ajax_field_mult["privilegio_administrador"][1] = "privilegio_administrador";

  var ajax_field_id = {
    "login": new Array("hidden_field_label_login", "hidden_field_data_login"),
    "contrasena": new Array("hidden_field_label_contrasena", "hidden_field_data_contrasena"),
    ...
    "codigo_activacion": new Array("hidden_field_label_codigo_activacion", "hidden_field_data_codigo_activacion"),
    "privilegio_administrador": new Array("hidden_field_label_privilegio_administrador", "hidden_field_data_privilegio_administrador")
  };
  ...
  var ajax_read_only = {
    ...
    "email": "off",
    "activo": "off",
    "codigo_activacion": "off",
    "privilegio_administrador": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("privilegio_administrador" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
