...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_detalle"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_agenda_detalle</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['embutida_filho'] as $ind => $sc_init)
          {
