...
<?php
   ...
   $Ord_Cmp = new grid_agenda_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_agenda_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['tipos_agenda_descripcion'] = "tipos_agenda_descripcion";
   }
   else
   {
       $tab_def_campos['tipos_agenda_descripcion'] = "tipos_agenda.descripcion";
   }
   $tab_labels["tipos_agenda_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_descripcion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_descripcion'] . "";
   $tab_ger_campos['tipos_agenda_duracion_mostrada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipos_agenda_duracion_mostrada'] = "tipos_agenda_duracion_mostrada";
   }
   else
   {
       $tab_def_campos['tipos_agenda_duracion_mostrada'] = "tipos_agenda.duracion_mostrada";
   }
   $tab_labels["tipos_agenda_duracion_mostrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_duracion_mostrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_duracion_mostrada"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] . "";
   $tab_ger_campos['tipos_agenda_duracion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipos_agenda_duracion'] = "tipos_agenda_duracion";
   }
   else
   {
       $tab_def_campos['tipos_agenda_duracion'] = "tipos_agenda.duracion";
   }
   $tab_labels["tipos_agenda_duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_duracion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_duracion'] . "";
   $tab_ger_campos['tipos_agenda_tipo_duracion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipos_agenda_tipo_duracion'] = "tipos_agenda_tipo_duracion";
   }
   else
   {
       $tab_def_campos['tipos_agenda_tipo_duracion'] = "tipos_agenda.tipo_duracion";
   }
   $tab_labels["tipos_agenda_tipo_duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_tipo_duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_tipo_duracion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] . "";
   $tab_ger_campos['tipos_agenda_valor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipos_agenda_valor'] = "tipos_agenda_valor";
   }
   else
   {
       $tab_def_campos['tipos_agenda_valor'] = "tipos_agenda.valor";
   }
   $tab_labels["tipos_agenda_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['labels']["tipos_agenda_valor"] : "Valor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_agenda_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_agenda_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
