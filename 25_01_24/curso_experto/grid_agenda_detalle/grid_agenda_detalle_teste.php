<?php  
  ...
  session_start() ;
  class grid_agenda_detalle_form_teste
  {
  function grid_agenda_detalle_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_agenda_detalle</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
par_agenda_id&nbsp;&nbsp;<input type=text name="par_agenda_id" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_agenda_detalle"> 
</form> 
<script language=javascript> 
 document.FCons.par_agenda_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_agenda_detalle_form_teste();
  $frm_teste->grid_agenda_detalle_teste();
?>
