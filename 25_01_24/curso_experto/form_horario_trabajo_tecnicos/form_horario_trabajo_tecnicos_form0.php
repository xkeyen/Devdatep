...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " " . $this->Ini->Nm_lang['lang_tbl_horario_trabajo_tecnicos'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " " . $this->Ini->Nm_lang['lang_tbl_horario_trabajo_tecnicos'] . ""); } ?></TITLE>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['btn_prueba'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['btn_disabled']['btn_prueba']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['btn_disabled']['btn_prueba']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['btn_label']['btn_prueba']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['btn_label']['btn_prueba']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['btn_label']['btn_prueba'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "btn_prueba", "scBtnFn_btn_prueba()", "scBtnFn_btn_prueba()", "sc_btn_prueba_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<script type="text/javascript">
	...
	function scBtnFn_btn_prueba() {
		if ($("#sc_btn_prueba_top").length && $("#sc_btn_prueba_top").is(":visible")) {
		    if ($("#sc_btn_prueba_top").hasClass("disabled")) {
		        return;
		    }
			sc_btn_btn_prueba()
			 return;
