  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_horario_trabajo_tecnicos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_horario_trabajo_tecnicos_form();
	}
...
?>
  ...
  function do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana_(iNumLinha)
  {
    var nomeCampo_dia_semana_ = "dia_semana_" + iNumLinha;
    var var_dia_semana_ = scAjaxGetFieldSelect(nomeCampo_dia_semana_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_validate_dia_semana_(var_dia_semana_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana_

  function do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_validate_dia_semana__cb

  // ---------- Validate hora_inicial_
  function do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial_(iNumLinha)
  {
    var nomeCampo_hora_inicial_ = "hora_inicial_" + iNumLinha;
    var var_hora_inicial_ = scAjaxGetFieldText(nomeCampo_hora_inicial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial_(var_hora_inicial_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial_

  function do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_validate_hora_inicial__cb

  // ---------- Validate hora_final_
  function do_ajax_form_horario_trabajo_tecnicos_validate_hora_final_(iNumLinha)
  {
    var nomeCampo_hora_final_ = "hora_final_" + iNumLinha;
    var var_hora_final_ = scAjaxGetFieldText(nomeCampo_hora_final_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_validate_hora_final_(var_hora_final_, iNumLinha, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_validate_hora_final__cb);
  } // do_ajax_form_horario_trabajo_tecnicos_validate_hora_final_

  function do_ajax_form_horario_trabajo_tecnicos_validate_hora_final__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_horario_trabajo_tecnicos_validate_hora_final__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_horario_trabajo_tecnicos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_horario_trabajo_tecnicos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_horario_trabajo_tecnicos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_add_new_line_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_add_new_line

  function do_ajax_form_horario_trabajo_tecnicos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_horario_trabajo_tecnicos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_horario_trabajo_tecnicos_backup_line(iNumLinha)
  {
    var var_id_horario_trabajo_tecnicos_ = scAjaxGetFieldText("id_horario_trabajo_tecnicos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_horario_trabajo_tecnicos_backup_line(var_id_horario_trabajo_tecnicos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_backup_line_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_backup_line

  function do_ajax_form_horario_trabajo_tecnicos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_backup_line_cb

  function do_ajax_form_horario_trabajo_tecnicos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_horario_trabajo_tecnicos_cancel_insert

  function do_ajax_form_horario_trabajo_tecnicos_cancel_update(iSeqVert)
  {
    do_ajax_form_horario_trabajo_tecnicos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_horario_trabajo_tecnicos_cancel_update

  function do_ajax_form_horario_trabajo_tecnicos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_horario_trabajo_tecnicos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_horario_trabajo_tecnicos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_horario_trabajo_tecnicos_table_refresh(var_id_horario_trabajo_tecnicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb);
  } //  do_ajax_form_horario_trabajo_tecnicos_table_refresh

  function do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb
  function do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_horario_trabajo_tecnicos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_horario_trabajo_tecnicos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_horario_trabajo_tecnicos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_dia_semana_ = scAjaxGetFieldSelect("dia_semana_" + iNumLinha);
...
?>
    x_ajax_form_horario_trabajo_tecnicos_submit_form(var_dia_semana_, var_hora_inicial_, var_hora_final_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_horario_trabajo_tecnicos_submit_form_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_submit_form

  function do_ajax_form_horario_trabajo_tecnicos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_submit_form_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_submit_form_cb
  function do_ajax_form_horario_trabajo_tecnicos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_horario_trabajo_tecnicos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_horario_trabajo_tecnicos_navigate_form, function() {});
    } else {
      perform_ajax_form_horario_trabajo_tecnicos_navigate_form();
    }
  }

  function perform_ajax_form_horario_trabajo_tecnicos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_horario_trabajo_tecnicos_navigate_form(var_id_horario_trabajo_tecnicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb);
  } // do_ajax_form_horario_trabajo_tecnicos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_horario_trabajo_tecnicos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb_after_alert);
  } // do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb
  function do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_horario_trabajo_tecnicos_navigate_form_cb_after_alert

    function sc_form_horario_trabajo_tecnicos_get_last_line_number()
    {
    ...
    } //sc_form_horario_trabajo_tecnicos_get_last_line_number

  function sc_hide_form_horario_trabajo_tecnicos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["dia_semana_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_horario_trabajo_tecnicos_fld_dia_semana'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["hora_inicial_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_horario_trabajo_tecnicos_fld_hora_inicial'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["hora_final_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_horario_trabajo_tecnicos_fld_hora_final'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["dia_semana_" + iRow] || "on" == ajax_error_count["hora_inicial_" + iRow] || "on" == ajax_error_count["hora_final_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["dia_semana_" + iRow] && "off" == ajax_error_count["hora_inicial_" + iRow] && "off" == ajax_error_count["hora_final_" + iRow]))
    {
      if (bErrorRow)
      {
