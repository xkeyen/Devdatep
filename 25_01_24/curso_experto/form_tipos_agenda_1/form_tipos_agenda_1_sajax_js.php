  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipos_agenda_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipos_agenda_1_form();
	}
...
?>
  ...
  // ---------- Validate id_tipos_agenda_
  function do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_(iNumLinha)
  {
    var nomeCampo_id_tipos_agenda_ = "id_tipos_agenda_" + iNumLinha;
    var var_id_tipos_agenda_ = scAjaxGetFieldHidden(nomeCampo_id_tipos_agenda_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_(var_id_tipos_agenda_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda__cb);
  } // do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_

  function do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tipos_agenda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tipos_agenda_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda__cb

  // ---------- Validate descripcion_
  function do_ajax_form_tipos_agenda_1_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_descripcion__cb);
  } // do_ajax_form_tipos_agenda_1_validate_descripcion_

  function do_ajax_form_tipos_agenda_1_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_descripcion__cb

  // ---------- Validate duracion_mostrada_
  function do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_(iNumLinha)
  {
    var nomeCampo_duracion_mostrada_ = "duracion_mostrada_" + iNumLinha;
    var var_duracion_mostrada_ = scAjaxGetFieldText(nomeCampo_duracion_mostrada_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_duracion_mostrada_(var_duracion_mostrada_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_duracion_mostrada__cb);
  } // do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_

  function do_ajax_form_tipos_agenda_1_validate_duracion_mostrada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duracion_mostrada_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duracion_mostrada_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_duracion_mostrada__cb

  // ---------- Validate tipo_duracion_
  function do_ajax_form_tipos_agenda_1_validate_tipo_duracion_(iNumLinha)
  {
    var nomeCampo_tipo_duracion_ = "tipo_duracion_" + iNumLinha;
    var var_tipo_duracion_ = scAjaxGetFieldText(nomeCampo_tipo_duracion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_tipo_duracion_(var_tipo_duracion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_tipo_duracion__cb);
  } // do_ajax_form_tipos_agenda_1_validate_tipo_duracion_

  function do_ajax_form_tipos_agenda_1_validate_tipo_duracion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_duracion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_duracion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_tipo_duracion__cb

  // ---------- Validate duracion_
  function do_ajax_form_tipos_agenda_1_validate_duracion_(iNumLinha)
  {
    var nomeCampo_duracion_ = "duracion_" + iNumLinha;
    var var_duracion_ = scAjaxGetFieldText(nomeCampo_duracion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_duracion_(var_duracion_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_duracion__cb);
  } // do_ajax_form_tipos_agenda_1_validate_duracion_

  function do_ajax_form_tipos_agenda_1_validate_duracion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duracion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duracion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_duracion__cb

  // ---------- Validate valor_
  function do_ajax_form_tipos_agenda_1_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_valor__cb);
  } // do_ajax_form_tipos_agenda_1_validate_valor_

  function do_ajax_form_tipos_agenda_1_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_valor__cb

  // ---------- Validate activado_
  function do_ajax_form_tipos_agenda_1_validate_activado_(iNumLinha)
  {
    var nomeCampo_activado_ = "activado_" + iNumLinha;
    var var_activado_ = scAjaxGetFieldRadio(nomeCampo_activado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_validate_activado_(var_activado_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agenda_1_validate_activado__cb);
  } // do_ajax_form_tipos_agenda_1_validate_activado_

  function do_ajax_form_tipos_agenda_1_validate_activado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "activado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "activado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_1_validate_activado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipos_agenda_1_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipos_agenda_1_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipos_agenda_1_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipos_agenda_1_add_new_line_cb);
  } // do_ajax_form_tipos_agenda_1_add_new_line

  function do_ajax_form_tipos_agenda_1_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_tipos_agenda_1_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipos_agenda_1_backup_line(iNumLinha)
  {
    var var_id_tipos_agenda_ = scAjaxGetFieldHidden("id_tipos_agenda_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_1_backup_line(var_id_tipos_agenda_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipos_agenda_1_backup_line_cb);
  } // do_ajax_form_tipos_agenda_1_backup_line

  function do_ajax_form_tipos_agenda_1_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipos_agenda_1_backup_line_cb

  function do_ajax_form_tipos_agenda_1_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tipos_agenda_1_cancel_insert

  function do_ajax_form_tipos_agenda_1_cancel_update(iSeqVert)
  {
    do_ajax_form_tipos_agenda_1_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipos_agenda_1_cancel_update

  function do_ajax_form_tipos_agenda_1_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipos_agenda_1_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipos_agenda_1_table_refresh()
  {
    var var_id_tipos_agenda_ = document.F2.id_tipos_agenda_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_1_table_refresh(var_id_tipos_agenda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_1_table_refresh_cb);
  } //  do_ajax_form_tipos_agenda_1_table_refresh

  function do_ajax_form_tipos_agenda_1_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_tipos_agenda_.value = scAjaxGetKeyValue("id_tipos_agenda_");
    ...
    scAjaxAlert(do_ajax_form_tipos_agenda_1_table_refresh_cb_after_alert);
  } // do_ajax_form_tipos_agenda_1_table_refresh_cb
  function do_ajax_form_tipos_agenda_1_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipos_agenda_1_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipos_agenda_1_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipos_agenda_1_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_duracion_mostrada_ = scAjaxGetFieldText("duracion_mostrada_" + iNumLinha);
    var var_tipo_duracion_ = scAjaxGetFieldText("tipo_duracion_" + iNumLinha);
    var var_duracion_ = scAjaxGetFieldText("duracion_" + iNumLinha);
    var var_valor_ = scAjaxGetFieldText("valor_" + iNumLinha);
    var var_activado_ = scAjaxGetFieldRadio("activado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipos_agenda_1_submit_form(var_id_tipos_agenda_, var_descripcion_, var_duracion_mostrada_, var_tipo_duracion_, var_duracion_, var_valor_, var_activado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_agenda_1_submit_form_cb);
  } // do_ajax_form_tipos_agenda_1_submit_form

  function do_ajax_form_tipos_agenda_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipos_agenda_1_submit_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_1_submit_form_cb
  function do_ajax_form_tipos_agenda_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipos_agenda_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipos_agenda_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tipos_agenda_1_navigate_form, function() {});
    } else {
      perform_ajax_form_tipos_agenda_1_navigate_form();
    }
  }

  function perform_ajax_form_tipos_agenda_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipos_agenda_1_cancel_insert(sc_form_tipos_agenda_1_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_1_navigate_form(var_id_tipos_agenda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_1_navigate_form_cb);
  } // do_ajax_form_tipos_agenda_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipos_agenda_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_tipos_agenda_.value = scAjaxGetKeyValue("id_tipos_agenda_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipos_agenda_1_navigate_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_1_navigate_form_cb
  function do_ajax_form_tipos_agenda_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tipos_agenda_1_navigate_form_cb_after_alert

    function sc_form_tipos_agenda_1_get_last_line_number()
    {
    ...
    } //sc_form_tipos_agenda_1_get_last_line_number

  function sc_hide_form_tipos_agenda_1_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_tipos_agenda_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duracion_mostrada_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_duracion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duracion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "activado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_tipos_agenda_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_id_tipos_agenda'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["duracion_mostrada_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["tipo_duracion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["duracion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["activado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_activado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_tipos_agenda_"][iNumLinha] = "id_tipos_agenda_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["duracion_mostrada_"][iNumLinha] = "duracion_mostrada_" + iNumLinha;
    ajax_field_mult["tipo_duracion_"][iNumLinha] = "tipo_duracion_" + iNumLinha;
    ajax_field_mult["duracion_"][iNumLinha] = "duracion_" + iNumLinha;
    ajax_field_mult["valor_"][iNumLinha] = "valor_" + iNumLinha;
    ajax_field_mult["activado_"][iNumLinha] = "activado_" + iNumLinha;
    ajax_field_id["id_tipos_agenda_" + iNumLinha] = new Array("hidden_field_label_id_tipos_agenda_", "hidden_field_data_id_tipos_agenda_" + iNumLinha);
    ajax_field_id["descripcion_" + iNumLinha] = new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_" + iNumLinha);
    ajax_field_id["duracion_mostrada_" + iNumLinha] = new Array("hidden_field_label_duracion_mostrada_", "hidden_field_data_duracion_mostrada_" + iNumLinha);
    ajax_field_id["tipo_duracion_" + iNumLinha] = new Array("hidden_field_label_tipo_duracion_", "hidden_field_data_tipo_duracion_" + iNumLinha);
    ajax_field_id["duracion_" + iNumLinha] = new Array("hidden_field_label_duracion_", "hidden_field_data_duracion_" + iNumLinha);
    ajax_field_id["valor_" + iNumLinha] = new Array("hidden_field_label_valor_", "hidden_field_data_valor_" + iNumLinha);
    ajax_field_id["activado_" + iNumLinha] = new Array("hidden_field_label_activado_", "hidden_field_data_activado_" + iNumLinha);
    ajax_error_count["id_tipos_agenda_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["duracion_mostrada_" + iNumLinha] = "off";
    ajax_error_count["tipo_duracion_" + iNumLinha] = "off";
    ajax_error_count["duracion_" + iNumLinha] = "off";
    ajax_error_count["valor_" + iNumLinha] = "off";
    ajax_error_count["activado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_tipos_agenda_" + iNumLinha] = "on";
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["duracion_mostrada_" + iNumLinha] = "off";
    ajax_read_only["tipo_duracion_" + iNumLinha] = "off";
    ajax_read_only["duracion_" + iNumLinha] = "off";
    ajax_read_only["valor_" + iNumLinha] = "off";
    ajax_read_only["activado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["duracion_mostrada_" + iNumLinha] = "on";
    ajax_read_only["tipo_duracion_" + iNumLinha] = "on";
    ajax_read_only["duracion_" + iNumLinha] = "on";
    ajax_read_only["valor_" + iNumLinha] = "on";
    ajax_read_only["activado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_tipos_agenda_" + iNumLinha] = null;
    ajax_error_list["descripcion_" + iNumLinha] = null;
    ajax_error_list["duracion_mostrada_" + iNumLinha] = null;
    ajax_error_list["tipo_duracion_" + iNumLinha] = null;
    ajax_error_list["duracion_" + iNumLinha] = null;
    ajax_error_list["valor_" + iNumLinha] = null;
    ajax_error_list["activado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_tipos_agenda_": new Array(),
    "descripcion_": new Array(),
    "duracion_mostrada_": new Array(),
    "tipo_duracion_": new Array(),
    "duracion_": new Array(),
    "valor_": new Array(),
    "activado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_tipos_agenda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tipos_agenda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tipos_agenda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tipos_agenda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tipos_agenda_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["duracion_mostrada_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duracion_mostrada_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duracion_mostrada_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duracion_mostrada_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duracion_mostrada_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tipo_duracion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_duracion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_duracion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_duracion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_duracion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["duracion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duracion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duracion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duracion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duracion_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["activado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["activado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["activado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["activado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["activado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tipos_agenda_'])) ? $this->nmgp_cmp_readonly['id_tipos_agenda_'] : 'on';
?>
    scAjaxFieldRead("id_tipos_agenda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duracion_mostrada_'])) ? $this->nmgp_cmp_readonly['duracion_mostrada_'] : 'off';
?>
    scAjaxFieldRead("duracion_mostrada_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_duracion_'])) ? $this->nmgp_cmp_readonly['tipo_duracion_'] : 'off';
?>
    scAjaxFieldRead("tipo_duracion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duracion_'])) ? $this->nmgp_cmp_readonly['duracion_'] : 'off';
?>
    scAjaxFieldRead("duracion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['activado_'])) ? $this->nmgp_cmp_readonly['activado_'] : 'off';
?>
    scAjaxFieldRead("activado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_tipos_agenda_" + iSeq, "on");
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("duracion_mostrada_" + iSeq, "on");
    scAjaxFieldRead("tipo_duracion_" + iSeq, "on");
    scAjaxFieldRead("duracion_" + iSeq, "on");
    scAjaxFieldRead("valor_" + iSeq, "on");
    scAjaxFieldRead("activado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_tipos_agenda_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["duracion_mostrada_" + iRow] || "on" == ajax_error_count["tipo_duracion_" + iRow] || "on" == ajax_error_count["duracion_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["activado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_tipos_agenda_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duracion_mostrada_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_duracion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duracion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_activado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_tipos_agenda_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["duracion_mostrada_" + iRow] && "off" == ajax_error_count["tipo_duracion_" + iRow] && "off" == ajax_error_count["duracion_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["activado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_tipos_agenda_" + iRow] = "off";
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["duracion_mostrada_" + iRow] = "off";
        ajax_error_count["tipo_duracion_" + iRow] = "off";
        ajax_error_count["duracion_" + iRow] = "off";
        ajax_error_count["valor_" + iRow] = "off";
        ajax_error_count["activado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_tipos_agenda_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duracion_mostrada_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_duracion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duracion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_activado_" + iRow).removeClass("scFormErrorLine");
    }
  }
