<?php
class form_tipos_agenda_1_form extends form_tipos_agenda_1_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php 
          ...
          $SC_Label_atu['id_tipos_agenda_'] = (isset($this->nm_new_label['id_tipos_agenda_'])) ? $this->nm_new_label['id_tipos_agenda_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_id_tipos_agenda'] . ''; 
          $SC_Label_atu['descripcion_'] = (isset($this->nm_new_label['descripcion_'])) ? $this->nm_new_label['descripcion_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_descripcion'] . ''; 
          $SC_Label_atu['duracion_mostrada_'] = (isset($this->nm_new_label['duracion_mostrada_'])) ? $this->nm_new_label['duracion_mostrada_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] . ''; 
          $SC_Label_atu['tipo_duracion_'] = (isset($this->nm_new_label['tipo_duracion_'])) ? $this->nm_new_label['tipo_duracion_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] . ''; 
          $SC_Label_atu['duracion_'] = (isset($this->nm_new_label['duracion_'])) ? $this->nm_new_label['duracion_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion'] . ''; 
          $SC_Label_atu['valor_'] = (isset($this->nm_new_label['valor_'])) ? $this->nm_new_label['valor_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_valor'] . ''; 
          $SC_Label_atu['activado_'] = (isset($this->nm_new_label['activado_'])) ? $this->nm_new_label['activado_'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_activado'] . ''; 
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_tipos_agenda_1);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_tipos_agenda_1 = $this->form_vert_form_tipos_agenda_1;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_tipos_agenda_1))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_tipos_agenda_1 as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_tipos_agenda_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['id_tipos_agenda_']; 
       ...
       $this->descripcion_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['descripcion_']; 
       ...
       $this->duracion_mostrada_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['duracion_mostrada_']; 
       ...
       $this->tipo_duracion_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['tipo_duracion_']; 
       ...
       $this->duracion_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['duracion_']; 
       ...
       $this->valor_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['valor_']; 
       $valor_ = $this->valor_; 
       $sStyleHidden_valor_ = '';
       ...
       $this->activado_ = $this->form_vert_form_tipos_agenda_1[$sc_seq_vert]['activado_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_tipos_agenda_1_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_tipos_agenda_1_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tipos_agenda_1_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_tipos_agenda_1_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_tipos_agenda_1_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_tipos_agenda_1_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php 
       $this->form_fixed_column_no++;
}?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['Lookup_activado_'][] = 'S'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['Lookup_activado_'][] = 'N'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_tipos_agenda_1 = $guarda_form_vert_form_tipos_agenda_1;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_1']['run_modal'])
{
?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_form_tipos_agenda_1_add_new_line(); return false;
			 return;
		}
