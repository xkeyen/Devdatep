<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_tipos_agenda_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_tipos_agenda_']); ?>">
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_tipos_agenda_1_submit_form(y, z);
