...
function scEventControl_onCalculator_valor_() {
  if (!_scCalculatorControl["id_sc_field_valor_"]) {
    _scCalculatorBlurOk["id_sc_field_valor_"] = true;
    do_ajax_form_tipos_agenda_1_event_valor__onblur();
  }
} // scEventControl_onCalculator_valor_

var scEventControl_data = {};

function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_tipos_agenda_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_id_tipos_agenda__onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_tipos_agenda_1_id_tipos_agenda__onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_tipos_agenda_1_id_tipos_agenda__onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_descripcion__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tipos_agenda_1_descripcion__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tipos_agenda_1_descripcion__onfocus(this, iSeqRow) });
  $('#id_sc_field_duracion_mostrada_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_duracion_mostrada__onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_tipos_agenda_1_duracion_mostrada__onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_tipos_agenda_1_duracion_mostrada__onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_duracion_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_tipo_duracion__onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_tipos_agenda_1_tipo_duracion__onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_tipos_agenda_1_tipo_duracion__onfocus(this, iSeqRow) });
  $('#id_sc_field_duracion_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_duracion__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tipos_agenda_1_duracion__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tipos_agenda_1_duracion__onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_valor__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tipos_agenda_1_valor__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_tipos_agenda_1_valor__onfocus(this, iSeqRow) });
  $('#id_sc_field_activado_' + iSeqRow).bind('blur', function() { sc_form_tipos_agenda_1_activado__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tipos_agenda_1_activado__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tipos_agenda_1_activado__onfocus(this, iSeqRow) });
  $('.sc-ui-radio-activado_' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_tipos_agenda_1_id_tipos_agenda__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_id_tipos_agenda_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_id_tipos_agenda__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_id_tipos_agenda__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_descripcion__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_descripcion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_descripcion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_descripcion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_duracion_mostrada__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_duracion_mostrada_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_duracion_mostrada__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_duracion_mostrada__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_tipo_duracion__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_tipo_duracion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_tipo_duracion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_tipo_duracion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_duracion__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_duracion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_duracion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_duracion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_valor__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_valor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_valor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_valor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_activado__onblur(oThis, iSeqRow) {
  do_ajax_form_tipos_agenda_1_validate_activado_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipos_agenda_1_activado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipos_agenda_1_activado__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_tipos_agenda_1_form" + pageNo).hide();
}
...
function scJQCalculatorAdd(iSeqRow) {
  _scCalculatorBlurOk["id_sc_field_activado_" + iSeqRow] = true;
  $("#id_sc_field_valor_" + iSeqRow).calculator({
    onOpen: function(value, inst) {
      if (typeof _scCalculatorControl !== "undefined") {
        if (!_scCalculatorControl["id_sc_field_valor_" + iSeqRow]) {
          _scCalculatorControl["id_sc_field_valor_" + iSeqRow] = true;
        }
      }
      value = scJQCalculatorUnformat(value, "#id_sc_field_valor_" + iSeqRow, '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_grp']); ?>', <?php echo $this->field_config['valor_']['symbol_fmt']; ?>, '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_dec']); ?>', '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_mon']); ?>');
      $(this).val(value);
    ...
    onClose: function(value, inst) {
      ...
      if (typeof _scCalculatorControl !== "undefined") {
        if (_scCalculatorControl["id_sc_field_valor_" + iSeqRow]) {
          _scCalculatorControl["id_sc_field_valor_" + iSeqRow] = null;
        }
      }
      value = scJQCalculatorFormat(value, "#id_sc_field_valor_" + iSeqRow, '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_grp']); ?>', <?php echo $this->field_config['valor_']['symbol_fmt']; ?>, '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_dec']); ?>', 2, '<?php echo str_replace("'", "\'", $this->field_config['valor_']['symbol_mon']); ?>');
      $(this).val(value);
      if (oldValue != value) {
        $(this).trigger('change');
      }
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tipos_agenda_1')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
