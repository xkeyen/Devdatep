<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_clientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_clientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_id_cliente'] . "";
   $tab_ger_campos['nombre_cliente'] = "on";
   $tab_def_campos['nombre_cliente'] = "nombre_cliente";
   $tab_labels["nombre_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombre_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombre_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_nombre_cliente'] . "";
   $tab_ger_campos['email_cliente'] = "on";
   $tab_def_campos['email_cliente'] = "email_cliente";
   $tab_labels["email_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["email_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["email_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_email_cliente'] . "";
   $tab_ger_campos['telefono_cliente'] = "on";
   $tab_def_campos['telefono_cliente'] = "telefono_cliente";
   $tab_labels["telefono_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_telefono_cliente'] . "";
   $tab_ger_campos['direccion_cliente'] = "on";
   $tab_def_campos['direccion_cliente'] = "direccion_cliente";
   $tab_labels["direccion_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["direccion_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["direccion_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_direccion_cliente'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_clientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_clientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_clientes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
