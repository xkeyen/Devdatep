  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clientes_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_clientes_1_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_cliente
  function do_ajax_form_clientes_1_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldHidden(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_id_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_id_cliente

  function do_ajax_form_clientes_1_mob_validate_id_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_id_cliente_cb

  // ---------- Validate nombre_cliente
  function do_ajax_form_clientes_1_mob_validate_nombre_cliente()
  {
    var nomeCampo_nombre_cliente = "nombre_cliente";
    var var_nombre_cliente = scAjaxGetFieldText(nomeCampo_nombre_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_nombre_cliente(var_nombre_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_nombre_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_nombre_cliente

  function do_ajax_form_clientes_1_mob_validate_nombre_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_nombre_cliente_cb

  // ---------- Validate email_cliente
  function do_ajax_form_clientes_1_mob_validate_email_cliente()
  {
    var nomeCampo_email_cliente = "email_cliente";
    var var_email_cliente = scAjaxGetFieldText(nomeCampo_email_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_email_cliente(var_email_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_email_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_email_cliente

  function do_ajax_form_clientes_1_mob_validate_email_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_email_cliente_cb

  // ---------- Validate telefono_cliente
  function do_ajax_form_clientes_1_mob_validate_telefono_cliente()
  {
    var nomeCampo_telefono_cliente = "telefono_cliente";
    var var_telefono_cliente = scAjaxGetFieldText(nomeCampo_telefono_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_telefono_cliente(var_telefono_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_telefono_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_telefono_cliente

  function do_ajax_form_clientes_1_mob_validate_telefono_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_telefono_cliente_cb

  // ---------- Validate direccion_cliente
  function do_ajax_form_clientes_1_mob_validate_direccion_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_direccion_cliente(var_direccion_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_direccion_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_direccion_cliente

  function do_ajax_form_clientes_1_mob_validate_direccion_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_direccion_cliente_cb

  // ---------- Validate ciudad_cliente
  function do_ajax_form_clientes_1_mob_validate_ciudad_cliente()
  {
    var nomeCampo_ciudad_cliente = "ciudad_cliente";
    var var_ciudad_cliente = scAjaxGetFieldText(nomeCampo_ciudad_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_ciudad_cliente(var_ciudad_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_ciudad_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_ciudad_cliente

  function do_ajax_form_clientes_1_mob_validate_ciudad_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_ciudad_cliente_cb

  // ---------- Validate distrito_cliente
  function do_ajax_form_clientes_1_mob_validate_distrito_cliente()
  {
    var nomeCampo_distrito_cliente = "distrito_cliente";
    var var_distrito_cliente = scAjaxGetFieldText(nomeCampo_distrito_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_distrito_cliente(var_distrito_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_distrito_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_distrito_cliente

  function do_ajax_form_clientes_1_mob_validate_distrito_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_distrito_cliente_cb

  // ---------- Validate pais_cliente
  function do_ajax_form_clientes_1_mob_validate_pais_cliente()
  {
    var nomeCampo_pais_cliente = "pais_cliente";
    var var_pais_cliente = scAjaxGetFieldText(nomeCampo_pais_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_pais_cliente(var_pais_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_pais_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_pais_cliente

  function do_ajax_form_clientes_1_mob_validate_pais_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_pais_cliente_cb

  // ---------- Validate postal_cliente
  function do_ajax_form_clientes_1_mob_validate_postal_cliente()
  {
    var nomeCampo_postal_cliente = "postal_cliente";
    var var_postal_cliente = scAjaxGetFieldText(nomeCampo_postal_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_postal_cliente(var_postal_cliente, var_script_case_init, do_ajax_form_clientes_1_mob_validate_postal_cliente_cb);
  } // do_ajax_form_clientes_1_mob_validate_postal_cliente

  function do_ajax_form_clientes_1_mob_validate_postal_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_postal_cliente_cb

  // ---------- Validate usuario_login
  function do_ajax_form_clientes_1_mob_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldSelect(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_mob_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_form_clientes_1_mob_validate_usuario_login_cb);
  } // do_ajax_form_clientes_1_mob_validate_usuario_login

  function do_ajax_form_clientes_1_mob_validate_usuario_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_mob_validate_usuario_login_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clientes_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clientes_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_1_mob_submit_form(var_id_cliente, var_nombre_cliente, var_email_cliente, var_telefono_cliente, var_direccion_cliente, var_ciudad_cliente, var_distrito_cliente, var_pais_cliente, var_postal_cliente, var_usuario_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_1_mob_submit_form_cb);
  } // do_ajax_form_clientes_1_mob_submit_form

  function do_ajax_form_clientes_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clientes_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clientes_1_mob_submit_form_cb
  function do_ajax_form_clientes_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clientes_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clientes_1_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clientes_1_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clientes_1_mob_navigate_form();
    }
  }

  function perform_ajax_form_clientes_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_1_mob_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clientes_1_mob_navigate_form_cb);
  } // do_ajax_form_clientes_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clientes_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clientes_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clientes_1_mob_navigate_form_cb
  function do_ajax_form_clientes_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clientes_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clientes_1_mob_navigate_form_cb_after_alert

  function sc_hide_form_clientes_1_mob_form()
  {
