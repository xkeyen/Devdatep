  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clientes_1" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_cliente
  function do_ajax_form_clientes_1_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldHidden(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_id_cliente_cb);
  } // do_ajax_form_clientes_1_validate_id_cliente

  function do_ajax_form_clientes_1_validate_id_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_id_cliente_cb

  // ---------- Validate nombre_cliente
  function do_ajax_form_clientes_1_validate_nombre_cliente()
  {
    var nomeCampo_nombre_cliente = "nombre_cliente";
    var var_nombre_cliente = scAjaxGetFieldText(nomeCampo_nombre_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_nombre_cliente(var_nombre_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_nombre_cliente_cb);
  } // do_ajax_form_clientes_1_validate_nombre_cliente

  function do_ajax_form_clientes_1_validate_nombre_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_nombre_cliente_cb

  // ---------- Validate email_cliente
  function do_ajax_form_clientes_1_validate_email_cliente()
  {
    var nomeCampo_email_cliente = "email_cliente";
    var var_email_cliente = scAjaxGetFieldText(nomeCampo_email_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_email_cliente(var_email_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_email_cliente_cb);
  } // do_ajax_form_clientes_1_validate_email_cliente

  function do_ajax_form_clientes_1_validate_email_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_email_cliente_cb

  // ---------- Validate telefono_cliente
  function do_ajax_form_clientes_1_validate_telefono_cliente()
  {
    var nomeCampo_telefono_cliente = "telefono_cliente";
    var var_telefono_cliente = scAjaxGetFieldText(nomeCampo_telefono_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_telefono_cliente(var_telefono_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_telefono_cliente_cb);
  } // do_ajax_form_clientes_1_validate_telefono_cliente

  function do_ajax_form_clientes_1_validate_telefono_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telefono_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_telefono_cliente_cb

  // ---------- Validate direccion_cliente
  function do_ajax_form_clientes_1_validate_direccion_cliente()
  {
    var nomeCampo_direccion_cliente = "direccion_cliente";
    var var_direccion_cliente = scAjaxGetFieldText(nomeCampo_direccion_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_direccion_cliente(var_direccion_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_direccion_cliente_cb);
  } // do_ajax_form_clientes_1_validate_direccion_cliente

  function do_ajax_form_clientes_1_validate_direccion_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "direccion_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_direccion_cliente_cb

  // ---------- Validate ciudad_cliente
  function do_ajax_form_clientes_1_validate_ciudad_cliente()
  {
    var nomeCampo_ciudad_cliente = "ciudad_cliente";
    var var_ciudad_cliente = scAjaxGetFieldText(nomeCampo_ciudad_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_ciudad_cliente(var_ciudad_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_ciudad_cliente_cb);
  } // do_ajax_form_clientes_1_validate_ciudad_cliente

  function do_ajax_form_clientes_1_validate_ciudad_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_ciudad_cliente_cb

  // ---------- Validate distrito_cliente
  function do_ajax_form_clientes_1_validate_distrito_cliente()
  {
    var nomeCampo_distrito_cliente = "distrito_cliente";
    var var_distrito_cliente = scAjaxGetFieldText(nomeCampo_distrito_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_distrito_cliente(var_distrito_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_distrito_cliente_cb);
  } // do_ajax_form_clientes_1_validate_distrito_cliente

  function do_ajax_form_clientes_1_validate_distrito_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "distrito_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_distrito_cliente_cb

  // ---------- Validate pais_cliente
  function do_ajax_form_clientes_1_validate_pais_cliente()
  {
    var nomeCampo_pais_cliente = "pais_cliente";
    var var_pais_cliente = scAjaxGetFieldText(nomeCampo_pais_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_pais_cliente(var_pais_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_pais_cliente_cb);
  } // do_ajax_form_clientes_1_validate_pais_cliente

  function do_ajax_form_clientes_1_validate_pais_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_pais_cliente_cb

  // ---------- Validate postal_cliente
  function do_ajax_form_clientes_1_validate_postal_cliente()
  {
    var nomeCampo_postal_cliente = "postal_cliente";
    var var_postal_cliente = scAjaxGetFieldText(nomeCampo_postal_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_postal_cliente(var_postal_cliente, var_script_case_init, do_ajax_form_clientes_1_validate_postal_cliente_cb);
  } // do_ajax_form_clientes_1_validate_postal_cliente

  function do_ajax_form_clientes_1_validate_postal_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "postal_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_postal_cliente_cb

  // ---------- Validate usuario_login
  function do_ajax_form_clientes_1_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldSelect(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_1_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_form_clientes_1_validate_usuario_login_cb);
  } // do_ajax_form_clientes_1_validate_usuario_login

  function do_ajax_form_clientes_1_validate_usuario_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_1_validate_usuario_login_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clientes_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clientes_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_cliente = scAjaxGetFieldHidden("id_cliente");
    var var_nombre_cliente = scAjaxGetFieldText("nombre_cliente");
    var var_email_cliente = scAjaxGetFieldText("email_cliente");
    var var_telefono_cliente = scAjaxGetFieldText("telefono_cliente");
    var var_direccion_cliente = scAjaxGetFieldText("direccion_cliente");
    var var_ciudad_cliente = scAjaxGetFieldText("ciudad_cliente");
    var var_distrito_cliente = scAjaxGetFieldText("distrito_cliente");
    var var_pais_cliente = scAjaxGetFieldText("pais_cliente");
    var var_postal_cliente = scAjaxGetFieldText("postal_cliente");
    var var_usuario_login = scAjaxGetFieldSelect("usuario_login");
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_1_submit_form(var_id_cliente, var_nombre_cliente, var_email_cliente, var_telefono_cliente, var_direccion_cliente, var_ciudad_cliente, var_distrito_cliente, var_pais_cliente, var_postal_cliente, var_usuario_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_1_submit_form_cb);
  } // do_ajax_form_clientes_1_submit_form

  function do_ajax_form_clientes_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clientes_1_submit_form_cb_after_alert);
  } // do_ajax_form_clientes_1_submit_form_cb
  function do_ajax_form_clientes_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clientes_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clientes_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clientes_1_navigate_form, function() {});
    } else {
      perform_ajax_form_clientes_1_navigate_form();
    }
  }

  function perform_ajax_form_clientes_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_cliente = document.F2.id_cliente.value;
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_1_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clientes_1_navigate_form_cb);
  } // do_ajax_form_clientes_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clientes_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_cliente.value = scAjaxGetKeyValue("id_cliente");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clientes_1_navigate_form_cb_after_alert);
  } // do_ajax_form_clientes_1_navigate_form_cb
  function do_ajax_form_clientes_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clientes_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clientes_1_navigate_form_cb_after_alert

  function sc_hide_form_clientes_1_form()
  {
  ...
  ajax_field_list[0] = "id_cliente";
  ajax_field_list[1] = "nombre_cliente";
  ajax_field_list[2] = "email_cliente";
  ajax_field_list[3] = "telefono_cliente";
  ajax_field_list[4] = "direccion_cliente";
  ajax_field_list[5] = "ciudad_cliente";
  ajax_field_list[6] = "distrito_cliente";
  ajax_field_list[7] = "pais_cliente";
  ajax_field_list[8] = "postal_cliente";
  ajax_field_list[9] = "usuario_login";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_id_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_nombre_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_email_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "telefono_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_telefono_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "direccion_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_direccion_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ciudad_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_ciudad_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "distrito_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_distrito_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pais_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_pais_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "postal_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_postal_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "usuario_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_usuario_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "nombre_cliente": new Array(),
    "email_cliente": new Array(),
    "telefono_cliente": new Array(),
    "direccion_cliente": new Array(),
    "ciudad_cliente": new Array(),
    "distrito_cliente": new Array(),
    "pais_cliente": new Array(),
    "postal_cliente": new Array(),
    "usuario_login": new Array()
  };
  ajax_field_mult["id_cliente"][1] = "id_cliente";
  ajax_field_mult["nombre_cliente"][1] = "nombre_cliente";
  ajax_field_mult["email_cliente"][1] = "email_cliente";
  ajax_field_mult["telefono_cliente"][1] = "telefono_cliente";
  ajax_field_mult["direccion_cliente"][1] = "direccion_cliente";
  ajax_field_mult["ciudad_cliente"][1] = "ciudad_cliente";
  ajax_field_mult["distrito_cliente"][1] = "distrito_cliente";
  ajax_field_mult["pais_cliente"][1] = "pais_cliente";
  ajax_field_mult["postal_cliente"][1] = "postal_cliente";
  ...
  var ajax_field_id = {
    ...
    "nombre_cliente": new Array("hidden_field_label_nombre_cliente", "hidden_field_data_nombre_cliente"),
    "email_cliente": new Array("hidden_field_label_email_cliente", "hidden_field_data_email_cliente"),
    "telefono_cliente": new Array("hidden_field_label_telefono_cliente", "hidden_field_data_telefono_cliente"),
    "direccion_cliente": new Array("hidden_field_label_direccion_cliente", "hidden_field_data_direccion_cliente"),
    "ciudad_cliente": new Array("hidden_field_label_ciudad_cliente", "hidden_field_data_ciudad_cliente"),
    "distrito_cliente": new Array("hidden_field_label_distrito_cliente", "hidden_field_data_distrito_cliente"),
    "pais_cliente": new Array("hidden_field_label_pais_cliente", "hidden_field_data_pais_cliente"),
    "postal_cliente": new Array("hidden_field_label_postal_cliente", "hidden_field_data_postal_cliente"),
  ...
  var ajax_read_only = {
    ...
    "nombre_cliente": "off",
    "email_cliente": "off",
    "telefono_cliente": "off",
    "direccion_cliente": "off",
    "ciudad_cliente": "off",
    "distrito_cliente": "off",
    "pais_cliente": "off",
    "postal_cliente": "off",
    "usuario_login": "off"
  };
