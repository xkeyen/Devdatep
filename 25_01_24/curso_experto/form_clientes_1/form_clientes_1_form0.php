...
<?php 
          ...
          $SC_Label_atu['id_cliente'] = (isset($this->nm_new_label['id_cliente'])) ? $this->nm_new_label['id_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_id_cliente'] . ''; 
          $SC_Label_atu['nombre_cliente'] = (isset($this->nm_new_label['nombre_cliente'])) ? $this->nm_new_label['nombre_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_nombre_cliente'] . ''; 
          ...
          $SC_Label_atu['telefono_cliente'] = (isset($this->nm_new_label['telefono_cliente'])) ? $this->nm_new_label['telefono_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_telefono_cliente'] . ''; 
          $SC_Label_atu['direccion_cliente'] = (isset($this->nm_new_label['direccion_cliente'])) ? $this->nm_new_label['direccion_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_direccion_cliente'] . ''; 
          $SC_Label_atu['ciudad_cliente'] = (isset($this->nm_new_label['ciudad_cliente'])) ? $this->nm_new_label['ciudad_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_ciudad_cliente'] . ''; 
          $SC_Label_atu['distrito_cliente'] = (isset($this->nm_new_label['distrito_cliente'])) ? $this->nm_new_label['distrito_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_distrito_cliente'] . ''; 
          ...
          $SC_Label_atu['postal_cliente'] = (isset($this->nm_new_label['postal_cliente'])) ? $this->nm_new_label['postal_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_postal_cliente'] . ''; 
          $SC_Label_atu['usuario_login'] = (isset($this->nm_new_label['usuario_login'])) ? $this->nm_new_label['usuario_login'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_usuario_login'] . ''; 
