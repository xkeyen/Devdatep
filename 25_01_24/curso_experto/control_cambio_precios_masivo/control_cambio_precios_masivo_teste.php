<?php  
  ...
  session_start() ;
  class control_cambio_precios_masivo_form_teste
  {
   function control_cambio_precios_masivo_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_cambio_precios_masivo/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_cambio_precios_masivo</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="control_cambio_precios_masivo"> 
</form> 
...
<?php
  ...
  $frm_teste = new control_cambio_precios_masivo_form_teste();
  $frm_teste->control_cambio_precios_masivo_teste();
?>
