  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipos_agenda_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipos_agenda_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_tipos_agenda
  function do_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda()
  {
    var nomeCampo_id_tipos_agenda = "id_tipos_agenda";
    var var_id_tipos_agenda = scAjaxGetFieldHidden(nomeCampo_id_tipos_agenda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda(var_id_tipos_agenda, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda

  function do_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tipos_agenda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_id_tipos_agenda_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipos_agenda_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_descripcion_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_descripcion

  function do_ajax_form_tipos_agenda_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_descripcion_cb

  // ---------- Validate duracion_mostrada
  function do_ajax_form_tipos_agenda_mob_validate_duracion_mostrada()
  {
    var nomeCampo_duracion_mostrada = "duracion_mostrada";
    var var_duracion_mostrada = scAjaxGetFieldText(nomeCampo_duracion_mostrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_duracion_mostrada(var_duracion_mostrada, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_duracion_mostrada_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_duracion_mostrada

  function do_ajax_form_tipos_agenda_mob_validate_duracion_mostrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "duracion_mostrada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_duracion_mostrada_cb

  // ---------- Validate tipo_duracion
  function do_ajax_form_tipos_agenda_mob_validate_tipo_duracion()
  {
    var nomeCampo_tipo_duracion = "tipo_duracion";
    var var_tipo_duracion = scAjaxGetFieldText(nomeCampo_tipo_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_tipo_duracion(var_tipo_duracion, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_tipo_duracion_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_tipo_duracion

  function do_ajax_form_tipos_agenda_mob_validate_tipo_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_duracion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_tipo_duracion_cb

  // ---------- Validate duracion
  function do_ajax_form_tipos_agenda_mob_validate_duracion()
  {
    var nomeCampo_duracion = "duracion";
    var var_duracion = scAjaxGetFieldText(nomeCampo_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_duracion(var_duracion, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_duracion_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_duracion

  function do_ajax_form_tipos_agenda_mob_validate_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_duracion_cb

  // ---------- Validate valor
  function do_ajax_form_tipos_agenda_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_valor_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_valor

  function do_ajax_form_tipos_agenda_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_valor_cb

  // ---------- Validate activado
  function do_ajax_form_tipos_agenda_mob_validate_activado()
  {
    var nomeCampo_activado = "activado";
    var var_activado = scAjaxGetFieldText(nomeCampo_activado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agenda_mob_validate_activado(var_activado, var_script_case_init, do_ajax_form_tipos_agenda_mob_validate_activado_cb);
  } // do_ajax_form_tipos_agenda_mob_validate_activado

  function do_ajax_form_tipos_agenda_mob_validate_activado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agenda_mob_validate_activado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipos_agenda_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipos_agenda_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_tipos_agenda = scAjaxGetFieldHidden("id_tipos_agenda");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_duracion_mostrada = scAjaxGetFieldText("duracion_mostrada");
    var var_tipo_duracion = scAjaxGetFieldText("tipo_duracion");
    var var_duracion = scAjaxGetFieldText("duracion");
    var var_valor = scAjaxGetFieldText("valor");
    var var_activado = scAjaxGetFieldText("activado");
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_mob_submit_form(var_id_tipos_agenda, var_descripcion, var_duracion_mostrada, var_tipo_duracion, var_duracion, var_valor, var_activado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_agenda_mob_submit_form_cb);
  } // do_ajax_form_tipos_agenda_mob_submit_form

  function do_ajax_form_tipos_agenda_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipos_agenda_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_mob_submit_form_cb
  function do_ajax_form_tipos_agenda_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipos_agenda_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipos_agenda_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tipos_agenda_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tipos_agenda_mob_navigate_form();
    }
  }

  function perform_ajax_form_tipos_agenda_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_tipos_agenda = document.F2.id_tipos_agenda.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agenda_mob_navigate_form(var_id_tipos_agenda, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agenda_mob_navigate_form_cb);
  } // do_ajax_form_tipos_agenda_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipos_agenda_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_tipos_agenda.value = scAjaxGetKeyValue("id_tipos_agenda");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipos_agenda_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tipos_agenda_mob_navigate_form_cb
  function do_ajax_form_tipos_agenda_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tipos_agenda_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipos_agenda_mob_navigate_form_cb_after_alert

  function sc_hide_form_tipos_agenda_mob_form()
  {
  ...
  ajax_field_list[0] = "id_tipos_agenda";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "duracion_mostrada";
  ajax_field_list[3] = "tipo_duracion";
  ajax_field_list[4] = "duracion";
  ajax_field_list[5] = "valor";
  ajax_field_list[6] = "activado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_tipos_agenda": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_id_tipos_agenda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "duracion_mostrada": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tipo_duracion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "duracion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "valor": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "activado": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agenda_fld_activado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_tipos_agenda": new Array(),
    "descripcion": new Array(),
    "duracion_mostrada": new Array(),
    "tipo_duracion": new Array(),
    "duracion": new Array(),
    "valor": new Array(),
    "activado": new Array()
  };
  ajax_field_mult["id_tipos_agenda"][1] = "id_tipos_agenda";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["duracion_mostrada"][1] = "duracion_mostrada";
  ajax_field_mult["tipo_duracion"][1] = "tipo_duracion";
  ajax_field_mult["duracion"][1] = "duracion";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["activado"][1] = "activado";

  var ajax_field_id = {
    "id_tipos_agenda": new Array("hidden_field_label_id_tipos_agenda", "hidden_field_data_id_tipos_agenda"),
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "duracion_mostrada": new Array("hidden_field_label_duracion_mostrada", "hidden_field_data_duracion_mostrada"),
    "tipo_duracion": new Array("hidden_field_label_tipo_duracion", "hidden_field_data_tipo_duracion"),
    ...
    "activado": new Array("hidden_field_label_activado", "hidden_field_data_activado")
  };

  var ajax_read_only = {
    "id_tipos_agenda": "on",
    "descripcion": "off",
    "duracion_mostrada": "off",
    "tipo_duracion": "off",
    "duracion": "off",
    "valor": "off",
    "activado": "off"
