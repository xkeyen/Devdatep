...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['insert_validation']; ?>">
<?php
}
?>
...
<?php 
          ...
          $SC_Label_atu['id_tipos_agenda'] = (isset($this->nm_new_label['id_tipos_agenda'])) ? $this->nm_new_label['id_tipos_agenda'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_id_tipos_agenda'] . ''; 
          $SC_Label_atu['descripcion'] = (isset($this->nm_new_label['descripcion'])) ? $this->nm_new_label['descripcion'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_descripcion'] . ''; 
          $SC_Label_atu['duracion_mostrada'] = (isset($this->nm_new_label['duracion_mostrada'])) ? $this->nm_new_label['duracion_mostrada'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] . ''; 
          $SC_Label_atu['tipo_duracion'] = (isset($this->nm_new_label['tipo_duracion'])) ? $this->nm_new_label['tipo_duracion'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] . ''; 
          $SC_Label_atu['duracion'] = (isset($this->nm_new_label['duracion'])) ? $this->nm_new_label['duracion'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_duracion'] . ''; 
          $SC_Label_atu['valor'] = (isset($this->nm_new_label['valor'])) ? $this->nm_new_label['valor'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_valor'] . ''; 
          $SC_Label_atu['activado'] = (isset($this->nm_new_label['activado'])) ? $this->nm_new_label['activado'] : '' . $this->Ini->Nm_lang['lang_tipos_agenda_fld_activado'] . ''; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agenda']['btn_label']['delete'];
        }
?>
