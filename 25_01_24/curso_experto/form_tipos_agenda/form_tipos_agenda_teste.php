<?php  
  ...
  session_start() ;
  class form_tipos_agenda_form_teste
  {
   function form_tipos_agenda_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tipos_agenda/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tipos_agenda</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_tipos_agenda"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tipos_agenda_form_teste();
  $frm_teste->form_tipos_agenda_teste();
?>
