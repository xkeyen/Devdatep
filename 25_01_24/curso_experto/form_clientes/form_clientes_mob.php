...
//
   ...
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao']         = "conn_mysql";
   $NM_dir_atual = getcwd();
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] = "";
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    {
        if ('ajax_form_clientes_mob_validate_id_cliente' == $_POST['rs'])
        {
            $id_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_nombre_cliente' == $_POST['rs'])
        {
        ...
        if ('ajax_form_clientes_mob_validate_telefono_cliente' == $_POST['rs'])
        {
            $telefono_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_direccion_cliente' == $_POST['rs'])
        {
            $direccion_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_ciudad_cliente' == $_POST['rs'])
        {
            $ciudad_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_distrito_cliente' == $_POST['rs'])
        {
        ...
        if ('ajax_form_clientes_mob_validate_postal_cliente' == $_POST['rs'])
        {
            $postal_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_usuario_login' == $_POST['rs'])
        {
            $usuario_login = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_refresh_pais_cliente' == $_POST['rs'])
        {
            $pais_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nmgp_refresh_fields = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        }
        if ('ajax_form_clientes_mob_autocomp_pais_cliente' == $_POST['rs'])
        {
            $pais_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
        }
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['select_html']['ciudad_cliente'] = "class=\"sc-js-input scFormObjectOdd css_ciudad_cliente_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_ciudad_cliente\" name=\"ciudad_cliente\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['select_html']['usuario_login'] = "class=\"sc-js-input scFormObjectOdd css_usuario_login_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_usuario_login\" name=\"usuario_login\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_clientes_mob_validate_id_cliente");
    sajax_export("ajax_form_clientes_mob_validate_nombre_cliente");
    sajax_export("ajax_form_clientes_mob_validate_email_cliente");
    sajax_export("ajax_form_clientes_mob_validate_telefono_cliente");
    sajax_export("ajax_form_clientes_mob_validate_direccion_cliente");
    sajax_export("ajax_form_clientes_mob_validate_ciudad_cliente");
    sajax_export("ajax_form_clientes_mob_validate_distrito_cliente");
    sajax_export("ajax_form_clientes_mob_validate_pais_cliente");
    sajax_export("ajax_form_clientes_mob_validate_postal_cliente");
    sajax_export("ajax_form_clientes_mob_validate_usuario_login");
    sajax_export("ajax_form_clientes_mob_refresh_pais_cliente");
    sajax_export("ajax_form_clientes_mob_autocomp_pais_cliente");
...
//
    ...
    function ajax_form_clientes_mob_validate_id_cliente($id_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        ...
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_id_cliente';
    ...
    function ajax_form_clientes_mob_validate_nombre_cliente($nombre_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_nombre_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_telefono_cliente($telefono_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_telefono_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_direccion_cliente($direccion_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_direccion_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_ciudad_cliente($ciudad_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_ciudad_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_distrito_cliente($distrito_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_distrito_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_postal_cliente($postal_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_postal_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_usuario_login($usuario_login, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_usuario_login';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_refresh_pais_cliente($pais_cliente, $nmgp_refresh_fields, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'refresh_pais_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
                  'pais_cliente' => NM_utf8_urldecode($pais_cliente),
    ...
    function ajax_form_clientes_mob_autocomp_pais_cliente($pais_cliente)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'autocomp_pais_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
                  'pais_cliente' => NM_utf8_urldecode($pais_cliente),
                  'buffer_output' => true,
                 );
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['pais_cliente'] = utf8_decode(urldecode($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['pais_cliente']));
        if ($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['buffer_output'])
        {
            ob_start();
        }
    ...
    function ajax_form_clientes_mob_submit_form($id_cliente, $nombre_cliente, $email_cliente, $telefono_cliente, $direccion_cliente, $ciudad_cliente, $distrito_cliente, $pais_cliente, $postal_cliente, $usuario_login, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
...
//-----
      {
         ...
         {
/* mantis 0021191 */            $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['buttonDisplay'] = $inicial_form_clientes_mob->contr_form_clientes_mob->nmgp_botoes;
...
//---
   ...
   function form_clientes_mob_pack_ajax_nav_Summary(&$aResp)
   {
      ...
      $aResp['navSummary']['summary_line'] = $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['summary_line'];
