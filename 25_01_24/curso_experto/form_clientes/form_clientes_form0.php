 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-pais_cliente", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     do_ajax_form_clientes_refresh_pais_cliente(sRow);
     if ('function' == typeof do_ajax_form_clientes_event_pais_cliente_onchange) { do_ajax_form_clientes_event_pais_cliente_onchange(sRow); }
    }
   }
...
else
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['remove_border']) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombre_cliente_label" id="hidden_field_label_nombre_cliente" style="<?php echo $sStyleHidden_nombre_cliente; ?>"><span id="id_label_nombre_cliente"><?php echo $this->nm_new_label['nombre_cliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre_cliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
