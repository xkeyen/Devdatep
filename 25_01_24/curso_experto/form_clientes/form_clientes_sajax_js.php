...
?>
  ...
  // ---------- Validate id_cliente
  function do_ajax_form_clientes_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldHidden(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_clientes_validate_id_cliente_cb);
  } // do_ajax_form_clientes_validate_id_cliente

  function do_ajax_form_clientes_validate_id_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_id_cliente_cb

  // ---------- Validate nombre_cliente
  function do_ajax_form_clientes_validate_nombre_cliente()
  {
    var nomeCampo_nombre_cliente = "nombre_cliente";
    var var_nombre_cliente = scAjaxGetFieldText(nomeCampo_nombre_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_nombre_cliente(var_nombre_cliente, var_script_case_init, do_ajax_form_clientes_validate_nombre_cliente_cb);
  } // do_ajax_form_clientes_validate_nombre_cliente

  function do_ajax_form_clientes_validate_nombre_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_nombre_cliente_cb

  // ---------- Validate email_cliente
  function do_ajax_form_clientes_validate_email_cliente()
  {
    var nomeCampo_email_cliente = "email_cliente";
    var var_email_cliente = scAjaxGetFieldText(nomeCampo_email_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_email_cliente(var_email_cliente, var_script_case_init, do_ajax_form_clientes_validate_email_cliente_cb);
  } // do_ajax_form_clientes_validate_email_cliente

  function do_ajax_form_clientes_validate_email_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_email_cliente_cb

  // ---------- Validate telefono_cliente
  function do_ajax_form_clientes_validate_telefono_cliente()
  {
    var nomeCampo_telefono_cliente = "telefono_cliente";
    var var_telefono_cliente = scAjaxGetFieldText(nomeCampo_telefono_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_telefono_cliente(var_telefono_cliente, var_script_case_init, do_ajax_form_clientes_validate_telefono_cliente_cb);
  } // do_ajax_form_clientes_validate_telefono_cliente

  function do_ajax_form_clientes_validate_telefono_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_telefono_cliente_cb

  // ---------- Validate direccion_cliente
  function do_ajax_form_clientes_validate_direccion_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_direccion_cliente(var_direccion_cliente, var_script_case_init, do_ajax_form_clientes_validate_direccion_cliente_cb);
  } // do_ajax_form_clientes_validate_direccion_cliente

  function do_ajax_form_clientes_validate_direccion_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_direccion_cliente_cb

  // ---------- Validate ciudad_cliente
  function do_ajax_form_clientes_validate_ciudad_cliente()
  {
    var nomeCampo_ciudad_cliente = "ciudad_cliente";
    var var_ciudad_cliente = scAjaxGetFieldSelect(nomeCampo_ciudad_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_ciudad_cliente(var_ciudad_cliente, var_script_case_init, do_ajax_form_clientes_validate_ciudad_cliente_cb);
  } // do_ajax_form_clientes_validate_ciudad_cliente

  function do_ajax_form_clientes_validate_ciudad_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_ciudad_cliente_cb

  // ---------- Validate distrito_cliente
  function do_ajax_form_clientes_validate_distrito_cliente()
  {
    var nomeCampo_distrito_cliente = "distrito_cliente";
    var var_distrito_cliente = scAjaxGetFieldText(nomeCampo_distrito_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_distrito_cliente(var_distrito_cliente, var_script_case_init, do_ajax_form_clientes_validate_distrito_cliente_cb);
  } // do_ajax_form_clientes_validate_distrito_cliente

  function do_ajax_form_clientes_validate_distrito_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_distrito_cliente_cb

  // ---------- Validate pais_cliente
  function do_ajax_form_clientes_validate_pais_cliente()
  {
  } // do_ajax_form_clientes_validate_pais_cliente

  function do_ajax_form_clientes_validate_pais_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_pais_cliente_cb

  // ---------- Validate postal_cliente
  function do_ajax_form_clientes_validate_postal_cliente()
  {
    var nomeCampo_postal_cliente = "postal_cliente";
    var var_postal_cliente = scAjaxGetFieldText(nomeCampo_postal_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_postal_cliente(var_postal_cliente, var_script_case_init, do_ajax_form_clientes_validate_postal_cliente_cb);
  } // do_ajax_form_clientes_validate_postal_cliente

  function do_ajax_form_clientes_validate_postal_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_postal_cliente_cb

  // ---------- Validate usuario_login
  function do_ajax_form_clientes_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldSelect(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_form_clientes_validate_usuario_login_cb);
  } // do_ajax_form_clientes_validate_usuario_login

  function do_ajax_form_clientes_validate_usuario_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_usuario_login_cb

  // ---------- Refresh pais_cliente
  function do_ajax_form_clientes_refresh_pais_cliente()
  {
    var var_pais_cliente = scAjaxGetFieldText("pais_cliente");
    var var_nmgp_refresh_fields = "ciudad_cliente";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_refresh_pais_cliente(var_pais_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clientes_refresh_pais_cliente_cb);
  } // do_ajax_form_clientes_refresh_pais_cliente

  function do_ajax_form_clientes_refresh_pais_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_refresh_pais_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_submit_form()
  {
    ...
    var var_ciudad_cliente = scAjaxGetFieldSelect("ciudad_cliente");
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_submit_form(var_id_cliente, var_nombre_cliente, var_email_cliente, var_telefono_cliente, var_direccion_cliente, var_ciudad_cliente, var_distrito_cliente, var_pais_cliente, var_postal_cliente, var_usuario_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_clientes_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clientes_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clientes_navigate_form_cb);
