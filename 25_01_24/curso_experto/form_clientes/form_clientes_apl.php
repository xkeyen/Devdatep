...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_clientes']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clientes']['opc_ant'] = "inicio";
      }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clientes']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clientes']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " " . $this->Ini->Nm_lang['lang_tbl_clientes'] . "";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opc_ant'] : "";
      } 
...
//
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_clientes_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clientes_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dados_select']['usuario_login']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->usuario_login = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dados_select']['usuario_login'];
          } 
...
//---------------------------------------------------------
    ...
    function ValidateField_nombre_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre_cliente'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['ciudad_cliente'])) {
       return;
               ...
               if (!empty($this->ciudad_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente']) && !in_array($this->ciudad_cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['usuario_login'])) {
       return;
               ...
               if (!empty($this->usuario_login) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login']) && !in_array($this->usuario_login, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_ciudad_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['ciudad_cliente']['valList'][$i] = form_clientes_pack_protect_string($v);
          }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_clientes_pack_protect_string(NM_charset_to_utf8($this->pais_cliente))]) ? $aLookup[0][form_clientes_pack_protect_string(NM_charset_to_utf8($this->pais_cliente))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Lookup_usuario_login'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['usuario_login']['valList'][$i] = form_clientes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['ordem_ord'] == " desc") {
