<?php  
  ...
  session_start() ;
  class form_clientes_form_teste
  {
   function form_clientes_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_clientes/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_clientes</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_clientes"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_clientes_form_teste();
  $frm_teste->form_clientes_teste();
?>
