   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_estado' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['last_displayed_group_by'] = 'ag_estado';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['summarizing_fields_order'] ['ag_estado'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_admin'] ['summarizing_fields_display'] ['ag_estado'] [$metricIndex] ['display']) {
...
SCEOT;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                ...
                $this->array_line_fecha_inicial_scgb_41 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total_line']['fecha_inicial_scgb_41'];
            }
          $this->array_total_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total']['fecha_inicial'];
          $this->array_total_fecha_inicial_scgb_41 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total']['fecha_inicial_scgb_41'];
      ...
      else
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total']['fecha_inicial_scgb_41'] = $this->array_total_fecha_inicial_scgb_41;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['arr_total_line']['fecha_inicial_scgb_41'] = $this->array_line_fecha_inicial_scgb_41;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['labels']['fecha_inicial_scgb_41'] = $Lab_fecha_inicial_scgb_41; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_order']['ag_estado']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_order']['ag_estado'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_order']['ag_estado'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['summarizing_fields_display']['ag_estado'] as $i_sum => $d_sum)
           {
