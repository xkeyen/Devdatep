...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "";
      $prep_label['fecha_inicial_scgb_19'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "";
      $prep_label['valor_total'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "";
      $prep_label['estado_actual'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "";
      $prep_label['id_tecnico'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . "";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_admin']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
