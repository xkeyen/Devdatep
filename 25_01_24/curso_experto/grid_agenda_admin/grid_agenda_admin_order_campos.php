...
<?php
   ...
   $Ord_Cmp = new grid_agenda_admin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_agenda_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_agenda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["id_agenda"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["id_agenda"] : "" . $this->Nm_lang['lang_agenda_fld_id_agenda'] . "";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["id_cliente"] : "" . $this->Nm_lang['lang_agenda_fld_id_cliente'] . "";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["valor_total"] : "" . $this->Nm_lang['lang_agenda_fld_valor_total'] . "";
   $tab_ger_campos['fecha_inicial'] = "on";
   $tab_def_campos['fecha_inicial'] = "fecha_inicial";
   $tab_labels["fecha_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["fecha_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["fecha_inicial"] : "" . $this->Nm_lang['lang_agenda_fld_fecha_inicial'] . "";
   $tab_ger_campos['hora_inicial'] = "on";
   $tab_def_campos['hora_inicial'] = "hora_inicial";
   $tab_labels["hora_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["hora_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["hora_inicial"] : "" . $this->Nm_lang['lang_agenda_fld_hora_inicial'] . "";
   $tab_ger_campos['estado_actual'] = "on";
   $tab_def_campos['estado_actual'] = "estado_actual";
   $tab_labels["estado_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["estado_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["estado_actual"] : "" . $this->Nm_lang['lang_agenda_fld_estado_actual'] . "";
   $tab_ger_campos['evaluacion'] = "on";
   $tab_def_campos['evaluacion'] = "evaluacion";
   $tab_labels["evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['labels']["evaluacion"] : "" . $this->Nm_lang['lang_agenda_fld_evaluacion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_agenda_admin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_agenda_admin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
