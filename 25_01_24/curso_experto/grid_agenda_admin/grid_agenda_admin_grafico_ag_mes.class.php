...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->NM_tit_val[2]     = strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")");
      $this->NM_ind_val[2]     = 2;
      $this->array_decimais[2] = 2;
      $this->NM_tit_val[3]     = strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")");
      $this->NM_ind_val[3]     = 3;
