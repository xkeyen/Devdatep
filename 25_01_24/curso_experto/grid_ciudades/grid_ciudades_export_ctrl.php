<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ciudades']['sc_process_barr'] = true;
require_once('../grid_ciudades/index.php');
unset($_SESSION['scriptcase']['grid_ciudades']['sc_process_barr']);
$ExportCtrl = new grid_ciudades_export_control;
$ExportCtrl->Export_barr();

class grid_ciudades_export_control
{
