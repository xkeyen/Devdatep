...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["id"] : "" . $this->Nm_lang['lang_ciudades_fld_id'] . "";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["nombre"] : "" . $this->Nm_lang['lang_ciudades_fld_nombre'] . "";
   $tab_ger_campos['pais_iso'] = "on";
   $tab_def_campos['pais_iso'] = "pais_iso";
   $tab_labels["pais_iso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["pais_iso"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["pais_iso"] : "" . $this->Nm_lang['lang_ciudades_fld_pais_iso'] . "";
   $tab_ger_campos['distrito'] = "on";
   $tab_def_campos['distrito'] = "distrito";
   $tab_labels["distrito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["distrito"])) ? $_SESSION['sc_session'][$sc_init]['grid_ciudades']['labels']["distrito"] : "" . $this->Nm_lang['lang_ciudades_fld_distrito'] . "";
