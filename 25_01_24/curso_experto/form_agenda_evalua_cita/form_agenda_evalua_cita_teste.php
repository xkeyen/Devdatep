<?php  
  ...
  session_start() ;
  class form_agenda_evalua_cita_form_teste
  {
   function form_agenda_evalua_cita_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_agenda_evalua_cita/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_agenda_evalua_cita</FONT></B> 
<br> 
<br> 
...
id_agenda&nbsp;&nbsp;<input type=text name=id_agenda size=20><br> 
<input type="submit" value="form_agenda_evalua_cita"> 
</form> 
<script language=javascript> 
 document.Fedit.id_agenda.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_agenda_evalua_cita_form_teste();
  $frm_teste->form_agenda_evalua_cita_teste();
?>
