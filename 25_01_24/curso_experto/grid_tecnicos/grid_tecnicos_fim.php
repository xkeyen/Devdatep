...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_tecnicos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_tecnicos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tecnicos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tecnicos']['embutida_filho'] as $ind => $sc_init)
          {
