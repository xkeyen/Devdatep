...
//
   ...
   $this->New_label['nombre_tecnico'] = "" . $this->Ini->Nm_lang['lang_tecnicos_fld_nombre_tecnico'] . "";
   $this->New_label['email_tecnico'] = "" . $this->Ini->Nm_lang['lang_tecnicos_fld_email_tecnico'] . "";
   $this->New_label['telefono_tecnico'] = "" . $this->Ini->Nm_lang['lang_tecnicos_fld_telefono_tecnico'] . "";
   ...
   $this->New_label['fecha_nacimiento'] = "" . $this->Ini->Nm_lang['lang_tecnicos_fld_fecha_nacimiento'] . "";
...
//
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['ordem_select']['nombre_tecnico'] = 'asc'; 
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tecnicos'] ?> :: PDF</TITLE>
...
<?php
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " " . $this->Ini->Nm_lang['lang_tbl_tecnicos'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_tecnicos_jquery_4976.js\"></script>\r\n");
...
//----- 
 function cabecalho_normal()
 {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " " . $this->Ini->Nm_lang['lang_tbl_tecnicos'] . "</div>\r\n");
...
// 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nombre_tecnico'])) ? $this->New_label['nombre_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_nombre_tecnico'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['telefono_tecnico'])) ? $this->New_label['telefono_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_telefono_tecnico'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['fecha_nacimiento'])) ? $this->New_label['fecha_nacimiento'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_fecha_nacimiento'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_filtro'];
// 
   $SC_Label = (isset($this->New_label['nombre_tecnico'])) ? $this->New_label['nombre_tecnico'] : "";
   ...
   $SC_Label = (isset($this->New_label['telefono_tecnico'])) ? $this->New_label['telefono_tecnico'] : "";
   ...
   $SC_Label = (isset($this->New_label['fecha_nacimiento'])) ? $this->New_label['fecha_nacimiento'] : "";
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_email_tecnico()
 {
      ...
      if (!isset($this->NM_cmp_hidden['email_tecnico']) || $this->NM_cmp_hidden['email_tecnico'] != "off") { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;")
          { 
          $str_tem_display = $conteudo;
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && !empty($conteudo)) 
          { 
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $SC_Label_atu['nombre_tecnico'] = (isset($this->New_label['nombre_tecnico'])) ? $this->New_label['nombre_tecnico'] : '' . $this->Ini->Nm_lang['lang_tecnicos_fld_nombre_tecnico'] . ''; 
          ...
          $SC_Label_atu['telefono_tecnico'] = (isset($this->New_label['telefono_tecnico'])) ? $this->New_label['telefono_tecnico'] : '' . $this->Ini->Nm_lang['lang_tecnicos_fld_telefono_tecnico'] . ''; 
          ...
          $SC_Label_atu['fecha_nacimiento'] = (isset($this->New_label['fecha_nacimiento'])) ? $this->New_label['fecha_nacimiento'] : '' . $this->Ini->Nm_lang['lang_tecnicos_fld_fecha_nacimiento'] . ''; 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['field_order'] as $cada_field)
          { 
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_tecnicos/grid_tecnicos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_tecnicos/grid_tecnicos_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_tecnicos/grid_tecnicos_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_tecnicos/grid_tecnicos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
