...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["nombre_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["nombre_tecnico"] : "" . $this->Nm_lang['lang_tecnicos_fld_nombre_tecnico'] . "";
   ...
   $tab_labels["telefono_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["telefono_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tecnicos']['labels']["telefono_tecnico"] : "" . $this->Nm_lang['lang_tecnicos_fld_telefono_tecnico'] . "";
