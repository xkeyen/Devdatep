...
?>
  ...
  function do_ajax_form_agenda_validate_valor_total()
  {
    ...
    var var_valor_total = scAjaxGetFieldHidden(nomeCampo_valor_total);
  ...
  // ---------- Validate dia_de_semana
  function do_ajax_form_agenda_validate_dia_de_semana()
  {
    var nomeCampo_dia_de_semana = "dia_de_semana";
    var var_dia_de_semana = scAjaxGetFieldText(nomeCampo_dia_de_semana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_validate_dia_de_semana(var_dia_de_semana, var_script_case_init, do_ajax_form_agenda_validate_dia_de_semana_cb);
  } // do_ajax_form_agenda_validate_dia_de_semana

  function do_ajax_form_agenda_validate_dia_de_semana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dia_de_semana";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_validate_dia_de_semana_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_agenda_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_submit_form(var_valor_total, var_fecha_inicial, var_hora_inicial, var_dia_de_semana, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agenda_submit_form_cb);
...
?>
  ...
  ajax_field_list[0] = "valor_total";
  ajax_field_list[1] = "fecha_inicial";
  ajax_field_list[2] = "hora_inicial";
  ajax_field_list[3] = "dia_de_semana";
  ...
  var ajax_error_list = {
    ...
    "dia_de_semana": {"label": "dia_de_semana", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["dia_de_semana"][1] = "dia_de_semana";
  ...
  var ajax_field_id = {
    ...
    "dia_de_semana": new Array("hidden_field_label_dia_de_semana", "hidden_field_data_dia_de_semana")
  };
