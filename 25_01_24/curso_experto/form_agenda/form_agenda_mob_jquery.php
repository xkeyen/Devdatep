...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["dia_de_semana" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["dia_de_semana" + iSeqRow] && scEventControl_data["dia_de_semana" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["dia_de_semana" + iSeqRow] && scEventControl_data["dia_de_semana" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dia_de_semana' + iSeqRow).bind('blur', function() { sc_form_agenda_dia_de_semana_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_agenda_dia_de_semana_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_agenda_dia_de_semana_onblur(oThis, iSeqRow) {
  do_ajax_form_agenda_mob_validate_dia_de_semana();
  scCssBlur(oThis);
}

function sc_form_agenda_dia_de_semana_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	displayChange_field("dia_de_semana", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_dia_de_semana(row, status);
}
...
function displayChange_field_dia_de_semana(row, status) {
    var fieldId;
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_fecha_inicial" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_agenda_mob_validate_fecha_inicial(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecha_final" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_agenda_mob_validate_fecha_final(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
