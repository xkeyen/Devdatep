...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_agenda']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_agenda']['opc_ant'] = "inicio";
      }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_agenda']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_agenda']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " " . $this->Ini->Nm_lang['lang_tbl_agenda'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_agenda']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opc_ant'] : "";
      } 
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_agenda']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_agenda']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
//
      ...
      if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form" && !$this->Apl_com_erro)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['sc_redir_atualiz'] == "ok")
          {
...
$_SESSION['scriptcase']['form_agenda']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['hora_inicial'])) {
       return;
               ...
               if (!empty($this->hora_inicial) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial']) && !in_array($this->hora_inicial, $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial']))
               {
                   $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_agenda']['keyVal'] = form_agenda_pack_protect_string($this->nmgp_dados_form['id_agenda']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial'] = array(); 
}
if ($this->dia_de_semana != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_agenda_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_agenda_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Lookup_hora_inicial'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['hora_inicial']['valList'][$i] = form_agenda_pack_protect_string($v);
          }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_agenda)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['opcao'] = '';
   ...
   { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['parms'] = "id_agenda?#?$this->id_agenda?@?"; 
      }
      $this->NM_commit_db(); 
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['ordem_ord'] == " desc") {
