...
?>
  ...
  function do_ajax_form_agenda_mob_validate_dia_de_semana()
  {
    var nomeCampo_dia_de_semana = "dia_de_semana";
    var var_dia_de_semana = scAjaxGetFieldText(nomeCampo_dia_de_semana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_mob_validate_dia_de_semana(var_dia_de_semana, var_script_case_init, do_ajax_form_agenda_mob_validate_dia_de_semana_cb);
  } // do_ajax_form_agenda_mob_validate_dia_de_semana

  function do_ajax_form_agenda_mob_validate_dia_de_semana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_mob_validate_dia_de_semana_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_agenda_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_mob_submit_form(var_valor_total, var_fecha_inicial, var_hora_inicial, var_dia_de_semana, var_id_agenda, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agenda_mob_submit_form_cb);
