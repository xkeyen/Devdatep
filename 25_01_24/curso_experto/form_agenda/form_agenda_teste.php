<?php  
  ...
  session_start() ;
  class form_agenda_form_teste
  {
   function form_agenda_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_agenda/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_agenda</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_agenda"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_agenda_form_teste();
  $frm_teste->form_agenda_teste();
?>
