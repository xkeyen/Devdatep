...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']))
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['db_changed'])
           {
...
?>
   ...
   { 
       parent.del_aba_td('form_agenda_mob');
   } 
   else 
   { 
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['embutida_filho'] as $ind => $sc_init)
          {
