...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_agenda_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['form_agenda_mob']['session_timeout']['redir']))
    {
        ...
        if ('ajax_form_agenda_mob_validate_dia_de_semana' == $_POST['rs'])
        {
    ...
    $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['select_html']['hora_inicial'] = "class=\"sc-js-input scFormObjectOdd css_hora_inicial_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_hora_inicial\" name=\"hora_inicial\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    ...
    sajax_export("ajax_form_agenda_mob_validate_dia_de_semana");
...
//
    ...
    function ajax_form_agenda_mob_validate_dia_de_semana($dia_de_semana, $script_case_init)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_opcao         = 'validate_dia_de_semana';
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_agenda_mob_submit_form($valor_total, $fecha_inicial, $hora_inicial, $dia_de_semana, $id_agenda, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_agenda_mob;
        //register_shutdown_function("form_agenda_mob_pack_ajax_response");
        $inicial_form_agenda_mob->contr_form_agenda_mob->NM_ajax_flag          = true;
