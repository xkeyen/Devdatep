...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valor_total_line" id="hidden_field_data_valor_total" style="<?php echo $sStyleHidden_valor_total; ?>"><input type="hidden" name="valor_total" value="<?php echo $this->form_encode_input($valor_total); ?>"><span id="id_ajax_label_valor_total"><?php echo nl2br($valor_total); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dia_de_semana_label" id="hidden_field_label_dia_de_semana" style="<?php echo $sStyleHidden_dia_de_semana; ?>"><span id="id_label_dia_de_semana"><?php echo $this->nm_new_label['dia_de_semana']; ?></span></TD>
    <TD class="scFormDataOdd css_dia_de_semana_line" id="hidden_field_data_dia_de_semana" style="<?php echo $sStyleHidden_dia_de_semana; ?>">
