...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_agenda' + iSeqRow).bind('change', function() { sc_form_agenda_id_agenda_onchange(this, iSeqRow) });
  $('#id_sc_field_id_tecnico' + iSeqRow).bind('change', function() { sc_form_agenda_id_tecnico_onchange(this, iSeqRow) });
  $('#id_sc_field_id_cliente' + iSeqRow).bind('change', function() { sc_form_agenda_id_cliente_onchange(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('change', function() { sc_form_agenda_valor_onchange(this, iSeqRow) });
  $('#id_sc_field_costes_adicionales' + iSeqRow).bind('change', function() { sc_form_agenda_costes_adicionales_onchange(this, iSeqRow) });
  $('#id_sc_field_descuento' + iSeqRow).bind('change', function() { sc_form_agenda_descuento_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_fecha_final' + iSeqRow).bind('change', function() { sc_form_agenda_fecha_final_onchange(this, iSeqRow) });
  $('#id_sc_field_hora_final' + iSeqRow).bind('change', function() { sc_form_agenda_hora_final_onchange(this, iSeqRow) });
  $('#id_sc_field_estado_actual' + iSeqRow).bind('change', function() { sc_form_agenda_estado_actual_onchange(this, iSeqRow) });
  $('#id_sc_field_recurrencia' + iSeqRow).bind('change', function() { sc_form_agenda_recurrencia_onchange(this, iSeqRow) });
  $('#id_sc_field_periodo' + iSeqRow).bind('change', function() { sc_form_agenda_periodo_onchange(this, iSeqRow) });
  $('#id_sc_field_evaluacion' + iSeqRow).bind('change', function() { sc_form_agenda_evaluacion_onchange(this, iSeqRow) });
  $('#id_sc_field_dia_de_semana' + iSeqRow).bind('blur', function() { sc_form_agenda_dia_de_semana_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_agenda_dia_de_semana_onchange(this, iSeqRow) })
...
function sc_form_agenda_dia_de_semana_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
