<?php  
  ...
  session_start() ;
  class grid_nueva_peticion_servicios_form_teste
  {
  function grid_nueva_peticion_servicios_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_nueva_peticion_servicios</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
glo_cliente_id&nbsp;&nbsp;<input type=text name="glo_cliente_id" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_nueva_peticion_servicios"> 
</form> 
<script language=javascript> 
 document.FCons.glo_cliente_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_nueva_peticion_servicios_form_teste();
  $frm_teste->grid_nueva_peticion_servicios_teste();
?>
