...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_nueva_peticion_servicios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_nueva_peticion_servicios"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipos_agenda'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_nueva_peticion_servicios</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_nueva_peticion_servicios']['embutida_filho'] as $ind => $sc_init)
          {
