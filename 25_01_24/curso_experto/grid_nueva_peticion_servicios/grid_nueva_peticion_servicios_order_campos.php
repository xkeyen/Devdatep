...
<?php
   ...
   $Ord_Cmp = new grid_nueva_peticion_servicios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_nueva_peticion_servicios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["descripcion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_descripcion'] . "";
   $tab_ger_campos['duracion_mostrada'] = "on";
   $tab_def_campos['duracion_mostrada'] = "duracion_mostrada";
   $tab_labels["duracion_mostrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["duracion_mostrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["duracion_mostrada"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_duracion_mostrada'] . "";
   $tab_ger_campos['tipo_duracion'] = "on";
   $tab_def_campos['tipo_duracion'] = "tipo_duracion";
   $tab_labels["tipo_duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["tipo_duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["tipo_duracion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_tipo_duracion'] . "";
   $tab_ger_campos['duracion'] = "on";
   $tab_def_campos['duracion'] = "duracion";
   $tab_labels["duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["duracion"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_duracion'] . "";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['labels']["valor"] : "" . $this->Nm_lang['lang_tipos_agenda_fld_valor'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_nueva_peticion_servicios_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_nueva_peticion_servicios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
