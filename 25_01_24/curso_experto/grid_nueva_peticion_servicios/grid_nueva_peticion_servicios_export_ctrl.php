<?php
@session_start() ;
$_SESSION['scriptcase']['grid_nueva_peticion_servicios']['sc_process_barr'] = true;
require_once('../grid_nueva_peticion_servicios/index.php');
unset($_SESSION['scriptcase']['grid_nueva_peticion_servicios']['sc_process_barr']);
$ExportCtrl = new grid_nueva_peticion_servicios_export_control;
$ExportCtrl->Export_barr();

class grid_nueva_peticion_servicios_export_control
{
