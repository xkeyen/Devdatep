...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_cliente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_agenda_cliente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_agenda_cliente']['embutida_filho'] as $ind => $sc_init)
          {
