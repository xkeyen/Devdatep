<?php
@session_start() ;
$_SESSION['scriptcase']['grid_agenda_cliente']['sc_process_barr'] = true;
require_once('../grid_agenda_cliente/index.php');
unset($_SESSION['scriptcase']['grid_agenda_cliente']['sc_process_barr']);
$ExportCtrl = new grid_agenda_cliente_export_control;
$ExportCtrl->Export_barr();

class grid_agenda_cliente_export_control
{
