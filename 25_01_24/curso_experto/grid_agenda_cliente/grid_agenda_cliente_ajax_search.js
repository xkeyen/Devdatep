...
Table_sv_fil[0] = "id_tecnico";
Table_sv_fil[1] = "valor_total";
Table_sv_fil[2] = "fecha_final";
Table_sv_fil[3] = "estado_actual";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fecha_final_cond") && search_get_sel_txt("SC_fecha_final_cond").substring(0, 3) == "bi_") {
            formata_bi_fecha_final(search_get_sel_txt("SC_fecha_final_cond"), SC_fecha_final_bi_opc, SC_fecha_final_bi_dt);
        }
