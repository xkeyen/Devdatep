   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'] = 'ag_mes';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_mes' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'] = 'ag_mes';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['summarizing_fields_order'] ['ag_mes'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['summarizing_fields_display'] ['ag_mes'] [$metricIndex] ['display']) {
...
SCEOT;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['ag_mes']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['ag_mes'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['ag_mes'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['ag_mes'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['tot_geral'][4];
      ...
      if ($this->Tem_Res_Compara) {
          ...
          $this->array_total_geral[2][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['tot_geral'][4];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
