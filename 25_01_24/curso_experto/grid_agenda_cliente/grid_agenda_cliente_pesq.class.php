...
class grid_agenda_cliente_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_agenda_cliente_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_agenda_cliente_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_agenda_cliente_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_agenda_cliente/grid_agenda_cliente_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_agenda_cliente_ajax_search.js"></script>
 <script type="text/javascript" src="grid_agenda_cliente_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_agenda_cliente_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_agenda_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_agenda_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $id_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['id_tecnico']; 
          $id_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['id_tecnico_cond']; 
          $valor_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['valor_total']; 
          $valor_total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['valor_total_cond']; 
          $fecha_final_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_dia']; 
          $fecha_final_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_mes']; 
          $fecha_final_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_ano']; 
          $fecha_final_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_dia']; 
          $fecha_final_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_mes']; 
          $fecha_final_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_ano']; 
          $fecha_final_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_cond']; 
          $estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['estado_actual']; 
          $estado_actual_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['estado_actual_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['NM_operador']; 
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_agenda_cliente_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_cliente']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fecha_final_dia').bind('change', function() {sc_grid_agenda_cliente_valida_dia(this)});
    $('#SC_fecha_final_input_2_dia').bind('change', function() {sc_grid_agenda_cliente_valida_dia(this)});
    $('#SC_fecha_final_input_2_mes').bind('change', function() {sc_grid_agenda_cliente_valida_mes(this)});
    $('#SC_fecha_final_mes').bind('change', function() {sc_grid_agenda_cliente_valida_mes(this)});
 }
 function sc_grid_agenda_cliente_valida_dia(obj)
 {
 ...
 function sc_grid_agenda_cliente_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['psq_check_ret']['id_tecnico'])) {
      ...
      if (is_array($estado_actual)) {
          foreach ($estado_actual as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['psq_check_ret']['estado_actual'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['id_tecnico'] = $id_tecnico; 
      if (is_array($id_tecnico) && !empty($id_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0] = $id_tecnico;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $id_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['id_tecnico_cond'] = $id_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['cmp'] = "id_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['opc'] = $id_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['id_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['valor_total'] = $valor_total; 
      if (is_array($valor_total) && !empty($valor_total))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0] = $valor_total;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $valor_total;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['valor_total_cond'] = $valor_total_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['cmp'] = "valor_total"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['opc'] = $valor_total_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['valor_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_dia'] = $fecha_final_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_mes'] = $fecha_final_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_ano'] = $fecha_final_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_dia'] = $fecha_final_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_mes'] = $fecha_final_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2_ano'] = $fecha_final_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_final_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_final_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_final_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_final_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_final_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_final_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_cond'] = $fecha_final_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['cmp'] = "fecha_final"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['opc'] = $fecha_final_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['fecha_final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['estado_actual'] = $estado_actual; 
      if (is_array($estado_actual) && !empty($estado_actual))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0] = $estado_actual;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $estado_actual;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['estado_actual_cond'] = $estado_actual_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['cmp'] = "estado_actual"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid]['opc'] = $estado_actual_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['estado_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'] = $Temp_Busca;
      }
      ...
      $this->cmp_formatado['estado_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['estado_actual'];
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($fecha_final_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final'] = $val[0];
          ...
          if ($fecha_final_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']['fecha_final_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['fecha_final']['label'] = $nmgp_tab_label['fecha_final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['fecha_final']['descr'] = $nmgp_tab_label['fecha_final'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['fecha_final']['hint']  = $nmgp_tab_label['fecha_final'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (is_array($estado_actual) && count($estado_actual) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $nmgp_tab_label['estado_actual'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['estado_actual']['label'] = $nmgp_tab_label['estado_actual'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['estado_actual']['descr'] = $nmgp_tab_label['estado_actual'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['grid_pesq']['estado_actual']['hint'] = $nmgp_tab_label['estado_actual'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq'] = $this->comando;
       }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_dyn']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_dyn'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_dyn'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_dyn'];
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['cond_pesq'] .= $this->NM_operador;
