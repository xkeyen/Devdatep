   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            ...
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['pivot_order_direction'] [$dimensionIndex];
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_cliente'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
...
SCEOT;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                ...
                $this->array_line_fecha_inicial_scgb_19 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['fecha_inicial_scgb_19'];
                $this->array_line_valor_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['valor_total'];
                $this->array_line_estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['estado_actual'];
                $this->array_line_id_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['id_tecnico'];
            }
      ...
      else
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total']['fecha_inicial_scgb_19'] = $this->array_total_fecha_inicial_scgb_19;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total']['valor_total'] = $this->array_total_valor_total;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total']['estado_actual'] = $this->array_total_estado_actual;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total']['id_tecnico'] = $this->array_total_id_tecnico;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['fecha_inicial_scgb_19'] = $this->array_line_fecha_inicial_scgb_19;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['valor_total'] = $this->array_line_valor_total;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['estado_actual'] = $this->array_line_estado_actual;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['arr_total_line']['id_tecnico'] = $this->array_line_id_tecnico;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['labels']['fecha_inicial_scgb_19'] = $Lab_fecha_inicial_scgb_19; 
       $prep_field['valor_total'] = $Lab_valor_total;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['labels']['valor_total'] = $Lab_valor_total; 
       $prep_field['estado_actual'] = $Lab_estado_actual;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['labels']['estado_actual'] = $Lab_estado_actual; 
       $prep_field['id_tecnico'] = $Lab_id_tecnico;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['labels']['id_tecnico'] = $Lab_id_tecnico; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   function adiciona_registro($sum_valor_total, $quebra_fecha_inicial, $quebra_fecha_inicial_scgb_19, $quebra_valor_total, $quebra_estado_actual, $quebra_id_tecnico, $quebra_fecha_inicial_orig, $quebra_fecha_inicial_scgb_19_orig, $quebra_valor_total_orig, $quebra_estado_actual_orig, $quebra_id_tecnico_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_cliente']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
