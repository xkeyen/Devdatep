  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tecnicos_mob" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_tecnicos_mob_validate_nombre_tecnico()
  {
    var nomeCampo_nombre_tecnico = "nombre_tecnico";
    var var_nombre_tecnico = scAjaxGetFieldText(nomeCampo_nombre_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_nombre_tecnico(var_nombre_tecnico, var_script_case_init, do_ajax_form_tecnicos_mob_validate_nombre_tecnico_cb);
  } // do_ajax_form_tecnicos_mob_validate_nombre_tecnico

  function do_ajax_form_tecnicos_mob_validate_nombre_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_nombre_tecnico_cb

  // ---------- Validate email_tecnico
  function do_ajax_form_tecnicos_mob_validate_email_tecnico()
  {
    var nomeCampo_email_tecnico = "email_tecnico";
    var var_email_tecnico = scAjaxGetFieldText(nomeCampo_email_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_email_tecnico(var_email_tecnico, var_script_case_init, do_ajax_form_tecnicos_mob_validate_email_tecnico_cb);
  } // do_ajax_form_tecnicos_mob_validate_email_tecnico

  function do_ajax_form_tecnicos_mob_validate_email_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_email_tecnico_cb

  // ---------- Validate telefono_tecnico
  function do_ajax_form_tecnicos_mob_validate_telefono_tecnico()
  {
    var nomeCampo_telefono_tecnico = "telefono_tecnico";
    var var_telefono_tecnico = scAjaxGetFieldText(nomeCampo_telefono_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_telefono_tecnico(var_telefono_tecnico, var_script_case_init, do_ajax_form_tecnicos_mob_validate_telefono_tecnico_cb);
  } // do_ajax_form_tecnicos_mob_validate_telefono_tecnico

  function do_ajax_form_tecnicos_mob_validate_telefono_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_telefono_tecnico_cb
  ...
  function do_ajax_form_tecnicos_mob_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_tecnicos_mob_validate_fecha_nacimiento_cb);
  } // do_ajax_form_tecnicos_mob_validate_fecha_nacimiento

  function do_ajax_form_tecnicos_mob_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_fecha_nacimiento_cb

  // ---------- Validate md_dias
  function do_ajax_form_tecnicos_mob_validate_md_dias()
  {
    var nomeCampo_md_dias = "md_dias";
    var var_md_dias = scAjaxGetFieldText(nomeCampo_md_dias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_md_dias(var_md_dias, var_script_case_init, do_ajax_form_tecnicos_mob_validate_md_dias_cb);
  } // do_ajax_form_tecnicos_mob_validate_md_dias

  function do_ajax_form_tecnicos_mob_validate_md_dias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "md_dias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_md_dias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tecnicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tecnicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tecnicos_mob_submit_form(var_id_tecnico, var_nombre_tecnico, var_email_tecnico, var_telefono_tecnico, var_usuario_login, var_fecha_nacimiento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tecnicos_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tecnicos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tecnicos_mob_submit_form_cb
  function do_ajax_form_tecnicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tecnicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tecnicos_mob_navigate_form();
    }
  }

  function perform_ajax_form_tecnicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tecnicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  ...
  } // do_ajax_form_tecnicos_mob_navigate_form_cb
  function do_ajax_form_tecnicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tecnicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tecnicos_mob_navigate_form_cb_after_alert

  function sc_hide_form_tecnicos_mob_form()
  {
