<?php  
  ...
  session_start() ;
  class form_tecnicos_form_teste
  {
   function form_tecnicos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tecnicos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tecnicos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_tecnicos"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tecnicos_form_teste();
  $frm_teste->form_tecnicos_teste();
?>
