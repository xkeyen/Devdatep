...
//
   ...
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao']         = "conn_mysql";
   $NM_dir_atual = getcwd();
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['run_iframe'] = "";
      }
...
<?php
      ...
      $this->sc_lig_target["C_@scinf_md_dias"] = 'nmsc_iframe_liga_form_horario_trabajo_tecnicos_mob';
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['form_tecnicos_mob']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_tecnicos_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['form_tecnicos_mob']['session_timeout']['redir']))
    {
        ...
        if ('ajax_form_tecnicos_mob_validate_nombre_tecnico' == $_POST['rs'])
        {
        ...
        if ('ajax_form_tecnicos_mob_validate_telefono_tecnico' == $_POST['rs'])
        {
        ...
        if ('ajax_form_tecnicos_mob_validate_fecha_nacimiento' == $_POST['rs'])
        {
            $fecha_nacimiento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_tecnicos_mob_validate_md_dias' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['form_tecnicos_mob']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    sajax_export("ajax_form_tecnicos_mob_validate_nombre_tecnico");
    sajax_export("ajax_form_tecnicos_mob_validate_email_tecnico");
    sajax_export("ajax_form_tecnicos_mob_validate_telefono_tecnico");
    sajax_export("ajax_form_tecnicos_mob_validate_usuario_login");
    sajax_export("ajax_form_tecnicos_mob_validate_fecha_nacimiento");
    sajax_export("ajax_form_tecnicos_mob_validate_md_dias");
...
//
    ...
    function ajax_form_tecnicos_mob_validate_nombre_tecnico($nombre_tecnico, $script_case_init)
    {
        global $inicial_form_tecnicos_mob;
        //register_shutdown_function("form_tecnicos_mob_pack_ajax_response");
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_flag          = true;
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_opcao         = 'validate_nombre_tecnico';
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_tecnicos_mob_validate_telefono_tecnico($telefono_tecnico, $script_case_init)
    {
        global $inicial_form_tecnicos_mob;
        //register_shutdown_function("form_tecnicos_mob_pack_ajax_response");
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_flag          = true;
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_opcao         = 'validate_telefono_tecnico';
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_tecnicos_mob_validate_fecha_nacimiento($fecha_nacimiento, $script_case_init)
    {
        global $inicial_form_tecnicos_mob;
        //register_shutdown_function("form_tecnicos_mob_pack_ajax_response");
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_flag          = true;
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_opcao         = 'validate_fecha_nacimiento';
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_tecnicos_mob_validate_md_dias($md_dias, $script_case_init)
    {
        global $inicial_form_tecnicos_mob;
        //register_shutdown_function("form_tecnicos_mob_pack_ajax_response");
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_flag          = true;
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_opcao         = 'validate_md_dias';
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_tecnicos_mob_submit_form($id_tecnico, $nombre_tecnico, $email_tecnico, $telefono_tecnico, $usuario_login, $fecha_nacimiento, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_tecnicos_mob;
        //register_shutdown_function("form_tecnicos_mob_pack_ajax_response");
        $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_flag          = true;
...
//-----
      {
         ...
         {
/* mantis 0021191 */            $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['buttonDisplay'] = $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->nmgp_botoes;
...
//---
   ...
   function form_tecnicos_mob_pack_ajax_nav_Summary(&$aResp)
   {
      ...
      $aResp['navSummary']['summary_line'] = $inicial_form_tecnicos_mob->contr_form_tecnicos_mob->NM_ajax_info['summary_line'];
