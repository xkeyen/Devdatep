...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_ciudades_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_mob_submit_form(var_id, var_nombre, var_pais_iso, var_distrito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudades_mob_submit_form_cb);
