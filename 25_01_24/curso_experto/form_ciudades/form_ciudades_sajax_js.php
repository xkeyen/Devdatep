...
?>
  ...
  // ---------- Validate pais_iso
  function do_ajax_form_ciudades_validate_pais_iso()
  {
    var nomeCampo_pais_iso = "pais_iso";
    var var_pais_iso = scAjaxGetFieldText(nomeCampo_pais_iso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudades_validate_pais_iso(var_pais_iso, var_script_case_init, do_ajax_form_ciudades_validate_pais_iso_cb);
  } // do_ajax_form_ciudades_validate_pais_iso

  function do_ajax_form_ciudades_validate_pais_iso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudades_validate_pais_iso_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_ciudades_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ciudades_submit_form(var_id, var_nombre, var_pais_iso, var_distrito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudades_submit_form_cb);
