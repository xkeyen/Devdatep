...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_ciudades_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_ciudades_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_ciudades_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_ciudades_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['form_ciudades_mob']['session_timeout']['redir']))
    {
        ...
        if ('ajax_form_ciudades_mob_validate_pais_iso' == $_POST['rs'])
        {
    ...
    sajax_export("ajax_form_ciudades_mob_validate_pais_iso");
...
//
    ...
    function ajax_form_ciudades_mob_validate_pais_iso($pais_iso, $script_case_init)
    {
        global $inicial_form_ciudades_mob;
        //register_shutdown_function("form_ciudades_mob_pack_ajax_response");
        $inicial_form_ciudades_mob->contr_form_ciudades_mob->NM_ajax_flag          = true;
        $inicial_form_ciudades_mob->contr_form_ciudades_mob->NM_ajax_opcao         = 'validate_pais_iso';
        $inicial_form_ciudades_mob->contr_form_ciudades_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_ciudades_mob_submit_form($id, $nombre, $pais_iso, $distrito, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_ciudades_mob;
        //register_shutdown_function("form_ciudades_mob_pack_ajax_response");
        $inicial_form_ciudades_mob->contr_form_ciudades_mob->NM_ajax_flag          = true;
