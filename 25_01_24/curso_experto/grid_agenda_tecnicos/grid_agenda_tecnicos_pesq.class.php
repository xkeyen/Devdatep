...
class grid_agenda_tecnicos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_agenda_tecnicos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_agenda_tecnicos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_agenda_tecnicos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_agenda'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_agenda_tecnicos/grid_agenda_tecnicos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_agenda_tecnicos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_agenda_tecnicos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_agenda_tecnicos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fecha_final_cond#NMF#' + search_get_sel_txt('SC_fecha_final_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_fecha_final_cond');
  if (opc.substring(0, 3) != "bi_")
  {
      str_out += 'SC_fecha_final_dia#NMF#' + search_get_sel_txt('SC_fecha_final_dia') + '@NMF@';
      str_out += 'SC_fecha_final_mes#NMF#' + search_get_sel_txt('SC_fecha_final_mes') + '@NMF@';
      str_out += 'SC_fecha_final_ano#NMF#' + search_get_sel_txt('SC_fecha_final_ano') + '@NMF@';
      str_out += 'SC_fecha_final_input_2_dia#NMF#' + search_get_sel_txt('SC_fecha_final_input_2_dia') + '@NMF@';
      str_out += 'SC_fecha_final_input_2_mes#NMF#' + search_get_sel_txt('SC_fecha_final_input_2_mes') + '@NMF@';
      str_out += 'SC_fecha_final_input_2_ano#NMF#' + search_get_sel_txt('SC_fecha_final_input_2_ano') + '@NMF@';
  }
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_agenda'] ?></div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fecha_final_cond, $fecha_final, $fecha_final_dia, $fecha_final_mes, $fecha_final_ano, $fecha_final_input_2_dia, $fecha_final_input_2_mes, $fecha_final_input_2_ano,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $id_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['id_tecnico']; 
          $id_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['id_tecnico_cond']; 
          $valor_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['valor_total']; 
          $valor_total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['valor_total_cond']; 
          $fecha_final_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_dia']; 
          $fecha_final_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_mes']; 
          $fecha_final_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_ano']; 
          $fecha_final_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_dia']; 
          $fecha_final_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_mes']; 
          $fecha_final_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_ano']; 
          $fecha_final_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_cond']; 
          $estado_actual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['estado_actual']; 
          $estado_actual_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['estado_actual_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['NM_operador']; 
      ...
      if (!isset($id_tecnico_cond) || empty($id_tecnico_cond))
      {
         $id_tecnico_cond = "eq";
      }
      ...
      if (!isset($fecha_final_cond) || empty($fecha_final_cond))
      {
         $fecha_final_cond = "eq";
      }
      ...
      if (isset($fecha_final_cond) && substr($fecha_final_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $fecha_final_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $fecha_final_dia = substr($BI_data1, 0, 2);
         $fecha_final_mes = substr($BI_data1, 2, 2);
         $fecha_final_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $fecha_final_hor = substr($BI_data1, 8, 2);
             $fecha_final_min = substr($BI_data1, 10, 2);
             $fecha_final_seg = substr($BI_data1, 12, 2);
         }
         $fecha_final_input_2_dia = substr($BI_data2, 0, 2);
         $fecha_final_input_2_mes = substr($BI_data2, 2, 2);
         $fecha_final_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $fecha_final_input_2_hor = substr($BI_data2, 8, 2);
             $fecha_final_input_2_min = substr($BI_data2, 10, 2);
             $fecha_final_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_fecha_final('" . $fecha_final_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      ...
      $str_hide_fecha_final = (in_array($fecha_final_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_fecha_final = ('bw' == $fecha_final_cond || 'bi_' == substr($fecha_final_cond, 0, 3)) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fecha_final) || $fecha_final == "")
      {
          $fecha_final = "";
      }
      if (isset($fecha_final) && !empty($fecha_final))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_id_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_tecnico'])) ? $this->New_label['id_tecnico'] : "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_id_tecnico_cond" name="id_tecnico_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_tecnico" <?php echo $str_hide_id_tecnico?> valign="top">
...
?>
   <span id="idAjaxSelect_id_tecnico">
      <SELECT class="scFilterObjectOdd" id="SC_id_tecnico" name="id_tecnico"  size="1">
...
?>
      ...
      <TD id='SC_valor_total_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['valor_total'])) ? $this->New_label['valor_total'] : "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_valor_total_cond" name="valor_total_cond" onChange="nm_campos_between(document.getElementById('id_vis_valor_total'), this, 'valor_total')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_valor_total" <?php echo $str_hide_valor_total?> valign="top">
...
?>
<INPUT  type="text" id="SC_valor_total" name="valor_total" value="<?php echo NM_encode_input($valor_total) ?>" size=6 alt="{datatype: 'decimal', maxLength: 6, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_fecha_final_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha_final'])) ? $this->New_label['fecha_final'] : "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_final'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fecha_final_cond" name="fecha_final_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_final'), this, 'fecha_final')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="bi_U7" <?php if ("bi_U7" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="bi_last_30_dias" <?php if ("bi_last_30_dias" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_last_30_dias'] ?></OPTION>
       <OPTION value="bi_CY" <?php if ("bi_CY" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year_today'] ?></OPTION>
       <OPTION value="bi_LY" <?php if ("bi_LY" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="bi_MM" <?php if ("bi_MM" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_M3" <?php if ("bi_M3" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <OPTION value="bi_YY" <?php if ("bi_YY" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="bi_current_week_today" <?php if ("bi_current_week_today" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week_today'] ?></OPTION>
       <OPTION value="bi_current_week" <?php if ("bi_current_week" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week'] ?></OPTION>
       <OPTION value="bi_last_week" <?php if ("bi_last_week" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_last_week'] ?></OPTION>
       <OPTION value="bi_current_year" <?php if ("bi_current_year" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year'] ?></OPTION>
       <OPTION value="bi_next_year" <?php if ("bi_next_year" == $fecha_final_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_next_year'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_fecha_final" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_fecha_final"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha_final" <?php echo $str_hide_fecha_final?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha_final'])) ? $this->New_label['fecha_final'] : "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_final'] . "";
 $nmgp_tab_label .= "fecha_final?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_dia" name="fecha_final_dia" value="<?php echo NM_encode_input($fecha_final_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_mes" name="fecha_final_mes" value="<?php echo NM_encode_input($fecha_final_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_ano" name="fecha_final_ano" value="<?php echo NM_encode_input($fecha_final_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
        <SPAN id="id_css_fecha_final"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fecha_final"  <?php echo $str_display_fecha_final; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_input_2_dia" name="fecha_final_input_2_dia" value="<?php echo NM_encode_input($fecha_final_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_input_2_mes" name="fecha_final_input_2_mes" value="<?php echo NM_encode_input($fecha_final_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_final_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_final_input_2_ano" name="fecha_final_input_2_ano" value="<?php echo NM_encode_input($fecha_final_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
      ...
      <TD id='SC_estado_actual_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['estado_actual'])) ? $this->New_label['estado_actual'] : "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_estado_actual_cond" name="estado_actual_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_estado_actual" <?php echo $str_hide_estado_actual?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectEven\" type=\"checkbox\" id=\"SC_estado_actual\" name=\"estado_actual[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_agenda_tecnicos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_tecnico_cond.value = 'eq';
   ...
   document.F1.fecha_final_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fecha_final'), document.F1.fecha_final_cond, 'fecha_final');
   document.F1.fecha_final_dia.value = "";
   document.F1.fecha_final_mes.value = "";
   document.F1.fecha_final_ano.value = "";
   document.F1.fecha_final_input_2_dia.value = "";
   document.F1.fecha_final_input_2_mes.value = "";
   document.F1.fecha_final_input_2_ano.value = "";
 ...
 {
    $('#SC_fecha_final_dia').bind('change', function() {sc_grid_agenda_tecnicos_valida_dia(this)});
    $('#SC_fecha_final_input_2_dia').bind('change', function() {sc_grid_agenda_tecnicos_valida_dia(this)});
    $('#SC_fecha_final_input_2_mes').bind('change', function() {sc_grid_agenda_tecnicos_valida_mes(this)});
    $('#SC_fecha_final_mes').bind('change', function() {sc_grid_agenda_tecnicos_valida_mes(this)});
 }
 function sc_grid_agenda_tecnicos_valida_dia(obj)
 {
 ...
 function sc_grid_agenda_tecnicos_valida_mes(obj)
 {
...
function formata_bi_fecha_final(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_fecha_final').style.display = 'none';
       document.getElementById('opc_bi_TP_fecha_final').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_fecha_final').style.display = 'none';
       document.getElementById('opc_bi_TP_fecha_final').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fecha_final_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fecha_final_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fecha_final_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fecha_final_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fecha_final_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fecha_final_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
       saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_fecha_final').innerHTML = saida;
   document.getElementById('opc_bi_TP_fecha_final').style.display = 'none';
   document.getElementById('Nm_bi_dados_fecha_final').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_fecha_final_cond'] = 'cond';
      $tp_fields['SC_fecha_final_dia'] = 'text';
      $tp_fields['SC_fecha_final_mes'] = 'text';
      $tp_fields['SC_fecha_final_ano'] = 'text';
      $tp_fields['SC_fecha_final_input_2_dia'] = 'text';
      $tp_fields['SC_fecha_final_input_2_mes'] = 'text';
      $tp_fields['SC_fecha_final_input_2_ano'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_fecha_final_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   {
      global $id_tecnico_cond, $id_tecnico,
             $valor_total_cond, $valor_total,
             $fecha_final_cond, $fecha_final, $fecha_final_dia, $fecha_final_mes, $fecha_final_ano, $fecha_final_input_2_dia, $fecha_final_input_2_mes, $fecha_final_input_2_ano,
             $estado_actual_cond, $estado_actual, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $fecha_final_cond_salva = $fecha_final_cond; 
      if (!isset($fecha_final_input_2_dia) || $fecha_final_input_2_dia == "") {
          $fecha_final_input_2_dia = $fecha_final_dia;
      }
      if (!isset($fecha_final_input_2_mes) || $fecha_final_input_2_mes == "") {
          $fecha_final_input_2_mes = $fecha_final_mes;
      }
      if (!isset($fecha_final_input_2_ano) || $fecha_final_input_2_ano == "") {
          $fecha_final_input_2_ano = $fecha_final_ano;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['id_tecnico'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      ...
      if (is_array($estado_actual)) {
          foreach ($estado_actual as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret']['estado_actual'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['id_tecnico'] = $id_tecnico; 
      if (is_array($id_tecnico) && !empty($id_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $id_tecnico;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $id_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['id_tecnico_cond'] = $id_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "id_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['opc'] = $id_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['id_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['valor_total'] = $valor_total; 
      if (is_array($valor_total) && !empty($valor_total))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $valor_total;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $valor_total;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['valor_total_cond'] = $valor_total_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "valor_total"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['opc'] = $valor_total_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['valor_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_dia'] = $fecha_final_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_mes'] = $fecha_final_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_ano'] = $fecha_final_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_dia'] = $fecha_final_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_mes'] = $fecha_final_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2_ano'] = $fecha_final_input_2_ano; 
      if (!empty($fecha_final_dia) || !empty($fecha_final_mes) || !empty($fecha_final_ano) || $fecha_final_cond_salva == "nu" || $fecha_final_cond_salva == "nn" || $fecha_final_cond_salva == "ep" || $fecha_final_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_final_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_final_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_final_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_final_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_final_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_final_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_cond'] = $fecha_final_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "fecha_final"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['opc'] = $fecha_final_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['estado_actual'] = $estado_actual; 
      if (is_array($estado_actual) && !empty($estado_actual))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $estado_actual;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $estado_actual;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['estado_actual_cond'] = $estado_actual_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "estado_actual"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid]['opc'] = $estado_actual_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['estado_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'] = $Temp_Busca;
      }
      if ($valor_total_cond != "in" && $valor_total_cond != "bw" && !empty($valor_total) && !is_numeric($valor_total))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "";
      }
      ...
      $this->cmp_formatado['estado_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['estado_actual'];
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $fecha_final
      $this->Date_part = false;
      if ($fecha_final_cond != "bi_TP" && $Res_comp != 'calend')
      {
          $fecha_final_cond = strtoupper($fecha_final_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fecha_final_ano;
          $Dtxt .= $fecha_final_mes;
          $Dtxt .= $fecha_final_dia;
          $val[0]['ano'] = $fecha_final_ano;
          $val[0]['mes'] = $fecha_final_mes;
          $val[0]['dia'] = $fecha_final_dia;
          if ($fecha_final_cond == "BW")
          {
              $val[1]['ano'] = $fecha_final_input_2_ano;
              $val[1]['mes'] = $fecha_final_input_2_mes;
              $val[1]['dia'] = $fecha_final_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fecha_final_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fecha_final_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha_final = $val[0];
          $this->cmp_formatado['fecha_final'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha_final'], "YYYY-MM-DD");
          $this->cmp_formatado['fecha_final'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fecha_final_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fecha_final_input_2     = $val[1];
              $this->cmp_formatado['fecha_final_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']['fecha_final_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_final_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fecha_final_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fecha_final_cond == "NU" || $fecha_final_cond == "NN"|| $fecha_final_cond == "EP"|| $fecha_final_cond == "NE")
          {
              $this->monta_condicao("fecha_final", $fecha_final_cond, $fecha_final, $fecha_final_input_2, 'fecha_final', 'DATE');
          }
      }
      elseif ($Res_comp == 'pesq')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_final']['label'] = $nmgp_tab_label['fecha_final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_final']['descr'] = $nmgp_tab_label['fecha_final'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['fecha_final']['hint']  = $nmgp_tab_label['fecha_final'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (is_array($estado_actual) && count($estado_actual) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $nmgp_tab_label['estado_actual'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['estado_actual']['label'] = $nmgp_tab_label['estado_actual'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['estado_actual']['descr'] = $nmgp_tab_label['estado_actual'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']['estado_actual']['hint'] = $nmgp_tab_label['estado_actual'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $this->comando;
       }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'];
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_tecnico" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
