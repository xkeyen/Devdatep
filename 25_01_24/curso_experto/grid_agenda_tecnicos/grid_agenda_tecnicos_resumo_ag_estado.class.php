...
SCEOT;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                ...
                $this->array_line_fecha_inicial_scgb_41 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_41'];
            }
          $this->array_total_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial'];
          $this->array_total_fecha_inicial_scgb_41 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial_scgb_41'];
      ...
      else
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total']['fecha_inicial_scgb_41'] = $this->array_total_fecha_inicial_scgb_41;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial'] = $this->array_line_fecha_inicial;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['arr_total_line']['fecha_inicial_scgb_41'] = $this->array_line_fecha_inicial_scgb_41;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_41'] = $Lab_fecha_inicial_scgb_41; 
