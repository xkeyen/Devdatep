...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_tecnicos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_tecnicos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_agenda_2'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_agenda_tecnicos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_filho'] as $ind => $sc_init)
          {
