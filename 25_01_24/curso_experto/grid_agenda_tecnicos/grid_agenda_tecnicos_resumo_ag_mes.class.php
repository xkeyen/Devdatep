   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['fecha_inicial'],
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_mes';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('ag_mes' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['last_displayed_group_by'] = 'ag_mes';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_order'] ['ag_mes'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda_tecnicos'] ['summarizing_fields_display'] ['ag_mes'] [$metricIndex] ['display']) {
...
SCEOT;
   ...
   function completeMatrix()
   {
       ...
       $this->comp_sum = array(
           ...
           3 => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")",
           4 => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'] as $i_sum => $d_sum)
           {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_inicial',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_inicial)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $where_compara   = "";
      $this->Total->Calc_resumo_ag_mes("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'])) )
       {
          ...
          $this->Total->Calc_resumo_ag_mes("res", $this->NM_export, 2);
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $max_valor_total, $avg_valor_total, $quebra_fecha_inicial, $quebra_fecha_inicial_orig)
   {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('ag_mes', 'fecha_inicial');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('ag_mes', 'fecha_inicial');
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->valor_total, $this->valor_total, $this->fecha_inicial, $this->fecha_inicial_orig);
            }
   }
//
