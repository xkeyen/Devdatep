...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial'];
      }
      $this->label[1] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_41']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_41']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf']['fecha_inicial_scgb_41'];
      }
   }
