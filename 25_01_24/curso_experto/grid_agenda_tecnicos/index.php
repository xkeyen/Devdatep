<?php
   include_once('grid_agenda_tecnicos_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']         = "conn_mysql";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_agenda_tecnicos_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_form_agenda_2;
   var $link_grid_clientes_direcciones_cons;
   var $link_grid_agenda_detalle_cons_emb;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_agenda_tecnicos"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      $this->nm_grupo        = "curso_experto"; 
      ...
      $this->nm_dt_criacao   = "20240118"; 
      $this->nm_hr_criacao   = "181336"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240118"; 
      $this->nm_hr_ult_alt   = "191002"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_agenda_tecnicos']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_agenda_tecnicos']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_agenda_tecnicos';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      $this->Cmp_Sql_Time     = array('hora_inicial','hora_final');
      if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['actual_lang']) || $_SESSION['scriptcase']['grid_agenda_tecnicos']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_agenda_tecnicos']['actual_lang'] = $this->str_lang;
          setcookie('sc_actual_lang_curso_experto',$this->str_lang,'0','/');
      }
      ...
      {
          include_once("grid_agenda_tecnicos_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_add_grid_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_ch_bi_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']['cmp'] = $_POST['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dyn_search_ch_bi']['opc'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_agenda_2";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_agenda_2_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_agenda_2_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["form_agenda_2"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '';
      $this->sc_lig_target["A_@scinf__@scinf_form_agenda_2"] = '';
      $Tmp_apl_lig = "grid_agenda_detalle";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/grid_agenda_detalle_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/grid_agenda_detalle_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["grid_agenda_detalle"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_ga_detalle"] = '_self';
      $this->sc_lig_target["C_@scinf_ga_detalle_@scinf_grid_agenda_detalle"] = '_self';
      $Tmp_apl_lig = "grid_clientes_direcciones";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/grid_clientes_direcciones_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/grid_clientes_direcciones_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["grid_clientes_direcciones"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_id_cliente"] = '_self';
      $this->sc_lig_target["C_@scinf_id_cliente_@scinf_grid_clientes_direcciones"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_agenda_tecnicos"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_agenda_tecnicos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['link_info']['remove_border'] = true;
        }

      $this->link_form_agenda_2 =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_agenda_2') . "/" ; 
      $this->link_grid_clientes_direcciones_cons =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('grid_clientes_direcciones') . "/" ; 
      $this->link_grid_agenda_detalle_cons_emb =  $this->root . $this->path_link  . "" . SC_dir_app_name('grid_agenda_detalle') . "/index.php" ; 
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_agenda_tecnicos_erro.class.php"); 
      $this->Erro = new grid_agenda_tecnicos_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_agenda_tecnicos'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['ind_tree'] = 0;
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['emb_linha']))
      {
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['emb_linha'] = 0;
      }
   }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']))
      {
          ...
          db_conect_devel($con_devel, $this->root . $this->path_prod, 'curso_experto', 2, $this->force_db_utf8); 
      ...
      if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida_init']) 
      {
          if (!isset($_SESSION['glo_tecnico_id'])) 
          {
              $this->nm_falta_var .= "glo_tecnico_id; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class grid_agenda_tecnicos_sub_css
{
   function __construct()
   {
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_agenda_tecnicos_ini(); 
          $this->Ini->init("Path_sub");
      } 
      $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['SC_herda_css'] = "S"; 
      $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['embutida'] = true;
      include_once ($this->Ini->link_grid_agenda_detalle_cons_emb);
      $this->grid_agenda_detalle = new grid_agenda_detalle_sub_css ;
      $_SESSION['sc_session'][$script_case_init]['grid_agenda_detalle']['embutida'] = false;
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_agenda_tecnicos']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_agenda_tecnicos'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_agenda_tecnicos_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_agenda_tecnicos']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_agenda_tecnicos'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_agenda_tecnicos($cadapar[1]);
                       nm_protect_num_grid_agenda_tecnicos($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          if (isset($glo_tecnico_id)) 
          {
              ...
              nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_tecnico_id"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_pai'] = "";
      } 
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_agenda_tecnicos_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    if ($cadapar[0] == "fecha_inicial")
                    {
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('sc_free_group_by', 'fecha_inicial');
                    ...
                    elseif ($cadapar[0] == "fecha_inicial_scgb_19")
                    {
                        $cadapar[0] = str_replace("fecha_inicial_scgb_19", "fecha_inicial", $cadapar[0]);
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('sc_free_group_by', 'fecha_inicial_scgb_19');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
                    }
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                ...
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_estado")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    if ($cadapar[0] == "fecha_inicial")
                    {
                    ...
                    elseif ($cadapar[0] == "fecha_inicial_scgb_41")
                    {
                        $cadapar[0] = str_replace("fecha_inicial_scgb_41", "fecha_inicial", $cadapar[0]);
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                ...
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_mes")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    if ($cadapar[0] == "fecha_inicial")
                    {
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('ag_mes', 'fecha_inicial');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_agenda_tecnicos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_agenda_tecnicos'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda_tecnicos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda_tecnicos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_agenda_tecnicos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda_tecnicos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " " . $this->Ini->Nm_lang['lang_tbl_agenda'] . "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_erro.class.php"); 
      } 
      $this->Erro      = new grid_agenda_tecnicos_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_agenda_tecnicos_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_agenda_tecnicos_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['sc_free_group_by']['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['sc_free_group_by']['fecha_inicial'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['sc_free_group_by']['fecha_inicial'] = 'YYYYMM';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['sc_free_group_by']['fecha_inicial_scgb_19'] = "" . $this->Ini->Nm_lang['lang_othr_valueSEMIANNUAL'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['sc_free_group_by']['fecha_inicial_scgb_19'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['sc_free_group_by']['fecha_inicial_scgb_19'] = 'SEMIANNUAL';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['ag_estado']['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYY'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_estado']['fecha_inicial'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_estado']['fecha_inicial'] = 'YYYY';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_def_sql']['ag_estado']['fecha_inicial'] = 'fecha_inicial';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['ag_estado']['fecha_inicial_scgb_41'] = "" . $this->Ini->Nm_lang['lang_othr_valueSEMIANNUAL'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_estado']['fecha_inicial_scgb_41'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_estado']['fecha_inicial_scgb_41'] = 'SEMIANNUAL';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_def_sql']['ag_estado']['fecha_inicial_scgb_41'] = 'fecha_inicial';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_prefix_date_format']['ag_mes']['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mes']['fecha_inicial'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_date_format']['ag_mes']['fecha_inicial'] = 'YYYYMM';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_def_sql']['ag_mes']['fecha_inicial'] = 'fecha_inicial';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_All_Groupby'] = array('ag_estado' => 'all', 'sc_free_group_by' => 'all', 'ag_mes' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']['fecha_inicial'] = "fecha_inicial";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']['fecha_inicial']["fecha_inicial"] = 'asc';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']['fecha_inicial_scgb_19'] = "fecha_inicial";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']['fecha_inicial_scgb_19']["fecha_inicial"] = 'asc';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']['valor_total'] = "valor_total";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']['valor_total']["valor_total"] = 'asc';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']['estado_actual'] = "estado_actual";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']['estado_actual']["estado_actual"] = 'asc';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']['id_tecnico'] = "id_tecnico";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_sql']['id_tecnico']["id_tecnico"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['fecha_inicial'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "") . "";
          $Arr_free_labels['fecha_inicial_scgb_19'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "") . "";
          $Arr_free_labels['valor_total'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "";
          $Arr_free_labels['estado_actual'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "";
          $Arr_free_labels['id_tecnico'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_estado")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "");
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] == "ag_mes")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "");
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['sc_free_group_by'][] = 2;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "valor_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
                   'options' => array(
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_estado'][3] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_estado'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_estado']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_estado'] = array(
               array(
                   'cmp_res' => "valor_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
               ...
               array(
                   'cmp_res' => "estado_actual",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "",
                   'options' => array(
                       array('op' => 'C', 'index' => '3', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_count'] . "", 'abbrev' => "Count"),
                   ),
                   'select' => "<select class=\"sc-ui-select-estado_actual\" onChange=\"scSummChange($(this))\"><option value=\"3\" class=\"sc-ui-select-option-C\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_count'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][3] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']['ag_mes'][4] = array('label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']['ag_mes'][] = 4;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_mes']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']['ag_mes'] = array(
               array(
                   'cmp_res' => "valor_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
               ...
               array(
                   'cmp_res' => "valor_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_max'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
                   'options' => array(
                       array('op' => 'X', 'index' => '3', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_maxm'] . "", 'abbrev' => "Max"),
                   ),
                   'select' => "<select class=\"sc-ui-select-valor_total\" onChange=\"scSummChange($(this))\"><option value=\"3\" class=\"sc-ui-select-option-X\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_maxm'] . "</option></select>",
               ),
               array(
                   'cmp_res' => "valor_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
                   'options' => array(
                       array('op' => 'A', 'index' => '4', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . "", 'abbrev' => "Avg"),
                   ),
                   'select' => "<select class=\"sc-ui-select-valor_total\" onChange=\"scSummChange($(this))\"><option value=\"4\" class=\"sc-ui-select-option-A\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_agenda_tecnicos_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_agenda_tecnicos_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Ind_Groupby'] . ".class.php"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_orig']["fecha_inicial_scgb_19"] = 'fecha_inicial';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_agenda_tecnicos_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_agenda_tecnicos_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_larg']        = '1200';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "id_agenda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "id_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "valor_total";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "fecha_inicial";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "hora_inicial";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "estado_actual";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "evaluacion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "id_tecnico";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "valor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "costes_adicionales";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'][] = "descuento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel']['id_tecnico'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel']['valor'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel']['costes_adicionales'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel']['descuento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_tecnicos']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga']['inicial'];
              $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['orig_pesq'] = "grid";
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_agenda_tecnicos_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] = 'NAO';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = 'NAO';
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral']);
      }

      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] = "NAO";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral']  = "NAO";
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral']);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = 'grid';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_clear'] = true;
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_refresh'] = true;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] = 'res';
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_refresh'] = true;
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_agenda_tecnicos_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_refresh'] = true;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'] = " where (id_tecnico=" . $_SESSION['glo_tecnico_id'] . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search']        = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_ant'];  
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_agenda_tecnicos_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_agenda_tecnicos.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_agenda_tecnicos_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_agenda_tecnicos_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_agenda_tecnicos_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_xls.class.php"); 
          } 
          $this->xls  = new grid_agenda_tecnicos_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_res_xls.class.php"); 
          } 
          $this->xls  = new grid_agenda_tecnicos_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_xml.class.php"); 
          } 
          $this->xml  = new grid_agenda_tecnicos_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_res_xml.class.php"); 
          } 
          $this->xml  = new grid_agenda_tecnicos_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_json.class.php"); 
          } 
          $this->json  = new grid_agenda_tecnicos_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_res_json.class.php"); 
          } 
          $this->json  = new grid_agenda_tecnicos_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_csv.class.php"); 
          } 
          $this->csv  = new grid_agenda_tecnicos_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_res_csv.class.php"); 
          } 
          $this->csv  = new grid_agenda_tecnicos_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_rtf.class.php"); 
          } 
          $this->rtf  = new grid_agenda_tecnicos_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_agenda_tecnicos_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_agenda_tecnicos . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_agenda_tecnicos_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_pesq.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_agenda_tecnicos_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_agenda_tecnicos_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
              $this->Ini->nm_limite_lin_prt = 0;
              $GLOBALS['nmgp_tipo_pdf'] = $nmgp_cor_word;
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_det.class.php"); 
              } 
              $this->det  = new grid_agenda_tecnicos_det();
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_agenda_tecnicos/grid_agenda_tecnicos_grid.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_agenda_tecnicos_grid.class.php"); 
              } 
              $this->grid  = new grid_agenda_tecnicos_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_agenda_tecnicos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_agenda_tecnicos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_agenda_tecnicos_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pdf_det'])
{
    if ($this->pdf_zip == "S")
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_agenda'] ?> :: PDF</TITLE>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_agenda_tecnicos.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
$_SESSION['scriptcase']['grid_agenda_tecnicos']['contr_erro'] = 'on';
  
    echo "Hola, $par_quien";

$_SESSION['scriptcase']['grid_agenda_tecnicos']['contr_erro'] = 'off';
}
...
$_SESSION['scriptcase']['grid_agenda_tecnicos']['contr_erro'] = 'off';
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['fast_search']);
          return;
      }
      $comando = "";
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "id_agenda", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "id_cliente") 
          {
              ...
              {
                  $this->SC_monta_condicao($comando, "id_cliente", $arg_search, $data_lookup, "INT", false);
              }
          }
          ...
          {
              $data_lookup = $this->SC_lookup_estado_actual($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "estado_actual", $arg_search, $data_lookup, "INT", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "evaluacion") 
          {
              $this->SC_monta_condicao($comando, "evaluacion", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "id_tecnico") 
          {
              $data_lookup = $this->SC_lookup_id_tecnico($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "id_tecnico", $arg_search, $data_lookup, "INT", false);
              }
          }
          ...
          {
              $this->SC_monta_condicao($comando, "costes_adicionales", $arg_search, str_replace(",", ".", $data_search));
          }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] . ")";
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'] . ")";
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'];
      }
   ...
   function SC_lookup_id_cliente($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo      = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT nombre_cliente, id_cliente FROM clientes WHERE (#cmp_inombre_cliente#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_estado_actual($condicao, $campo)
   {
       $result     = array();
       $campo_orig = $campo;
       $campo      = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT descr_estado_agenda, id_estado_agenda FROM estado_agenda WHERE (#cmp_idescr_estado_agenda#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
       }
   ...
   function SC_lookup_id_tecnico($condicao, $campo)
   {
       $result     = array();
       $campo_orig = $campo;
       $campo      = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT nombre_tecnico, id_tecnico FROM tecnicos WHERE (#cmp_inombre_tecnico#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
       }
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $ix     = 0;
       $fields = array();
       $Cmps_check_return = array('id_tecnico');
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv, 'Res_chk' => $fields[$ix]['Res_chk']);
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$ind] = $dados;
      }
      $this->SC_processa_dyn_search($fields);
   }

   function SC_processa_dyn_search($fields, $Res_comp='dyn')
   {
       $this->NM_case_insensitive = false;
       $this->Dyn_Serarch_and_or = "and";
       $this->Cmd_Dyn_Search    = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "id_tecnico" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_label']['id_tecnico'];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "id_tecnico", 'N', 'INT', $Label_cmp, false);
           }
           if ($dados['field'] == "id_cliente" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_label']['id_cliente'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "id_cliente", 'N', 'INT', $Label_cmp, false);
           }
           if ($dados['field'] == "valor" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_label']['valor'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "valor", 'N', 'DECIMAL', $Label_cmp, false);
           }
           if ($dados['field'] == "fecha_inicial" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['dyn_search_label']['fecha_inicial'];
               if ($dados['cond'] != "BI_TP")
               {
                   ...
                   {
                       $this->nm_prep_date($val, "DT", "DATETIME", $dados['cond'], "", "data");
                   }
                   else
                   {
                   ...
                   $this->SC_proc_dyn_search_all($dados['cond'], $val, "fecha_inicial", 'DT', 'DATE', $Label_cmp, false);
               }
           }
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_dyn'] = $this->Cmd_Dyn_Search;
       if (empty($this->Cmd_Dyn_Search)) 
       {
           ...
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'] . ")";
               }
           }
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] . ")";
               }
           }
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'];
               }
           }
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_grid'];
               }
           }
           return;
       }
       if ($Res_comp == "compara") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_compara'] = (!empty($this->Cmd_Dyn_Search)) ? "(" . $this->Cmd_Dyn_Search . ")" : "";
       }
       if ($Res_comp == "calend") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_dyn_calend'] = (!empty($this->Cmd_Dyn_Search)) ? "(" . $this->Cmd_Dyn_Search . ")" : "";
       }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] .= $this->Dyn_Serarch_and_or;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'];
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_filtro'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
           ...
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $this->Cmd_Dyn_Search . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = " where (" . $this->Cmd_Dyn_Search . ")";
           }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] . ")";
       ...
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab, $tp_unaccent=false)
   {
       $nm_aspas  = "'";
       $nm_aspas1 = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
       if ($tp == "DT" || $tp == "DH" || $tp == "HH")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']))
           {
               $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date'];
               $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'];
           }
       ...
       $dados   = $vls[0];
           ...
           if ($cond != "NU" && $cond != "NN")
           {
               ...
               {
                   if (in_array($cond, array('II','QP','NP','IN','EP','NE'))) {
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['cond_dyn_search'] .= $nm_cond;
           }
   }
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $busca  = array();
       $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
       $Cmps_check_return = array('id_tecnico','estado_actual');
       if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($Parms))
       {
           $Parms = NM_conv_charset($Parms, $_SESSION['scriptcase']['charset'], "UTF-8");
       }
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               if ($dats[0] == "valor_total")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   nm_limpa_valor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0]], $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                       nm_limpa_valor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_input_2'], $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
                   }
               }
               elseif ($dats[0] == "fecha_final")
               {
                   $cond = $dats[1];
                   if (substr($cond, 0, 3) == "bi_")
                   {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               elseif ($dats[0] == "estado_actual")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0]] = $fields[$ix]['vls'][0];
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1];
                   }
               }
               else
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
   ...
   {
      if (in_array($cmp_del, array('fecha_final')))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['grid_pesq'][$cmp_del]);
   }
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmps_dt_hh = array();
       $cmps_dt_hh["fecha_inicial"] = 'YYYY-MM';
       $cmps_numeric = array();
       $cmps_numeric[] = "valor_total";
       $cmps_numeric[] = "estado_actual";
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'] = array();
       }
       else {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date']))
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           ...
           $this->Cmd_dth = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val'] = $this->Cmd_dth;
           }
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_fast'] . ")";
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo'])) 
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_agenda'] ?> :: Doc</TITLE>
...
<form name="Fdown" method="get" action="grid_agenda_tecnicos_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_agenda_tecnicos"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/");
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos'][$path_doc_md5][1] = "grid_agenda_tecnicos_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_agenda_tecnicos($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_agenda_tecnicos($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (isset($_COOKIE['sc_apl_default_curso_experto'])) {
           $apl_def = explode(",", $_COOKIE['sc_apl_default_curso_experto']);
       }
       elseif (is_file($root . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_agenda_tecnicos']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_agenda_tecnicos") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_curso_experto'])) {
               $_SESSION['scriptcase']['grid_agenda_tecnicos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_curso_experto'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_agenda_tecnicos']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_agenda_tecnicos']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_agenda_tecnicos']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']);
               $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_agenda_tecnicos']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_agenda_tecnicos']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_agenda_tecnicos']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_agenda_tecnicos']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_agenda_tecnicos']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_agenda_tecnicos']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_agenda_tecnicos";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_agenda_tecnicos' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_agenda_tecnicos/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_agenda_tecnicos')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_agenda_tecnicos_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = $nmgp_opcao ;  
       }   
       if ($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['Sc_seq_det'] = $Sc_seq_det;
       } 
       if (isset($_POST["glo_tecnico_id"])) 
       {
           $_SESSION["glo_tecnico_id"] = $_POST["glo_tecnico_id"];
           nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_tecnico_id"]);
       }
       if (isset($_GET["glo_tecnico_id"])) 
       {
           $_SESSION["glo_tecnico_id"] = $_GET["glo_tecnico_id"];
           nm_limpa_str_grid_agenda_tecnicos($_SESSION["glo_tecnico_id"]);
       }
       if (!isset($_SESSION["glo_tecnico_id"])) 
       {
           $_SESSION["glo_tecnico_id"] = "";
       }
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_agenda_tecnicos_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_agenda_tecnicos_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['mostra_edit'] = "N";   
           } 
       ...
       $contr_grid_agenda_tecnicos = new grid_agenda_tecnicos_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "busca";
          $contr_grid_agenda_tecnicos->NM_ajax_flag = true;
          $contr_grid_agenda_tecnicos->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "busca";
          $contr_grid_agenda_tecnicos->NM_ajax_flag = true;
          $contr_grid_agenda_tecnicos->NM_ajax_opcao = "ajax_ch_bi_search";
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "busca";
          $contr_grid_agenda_tecnicos->NM_ajax_flag = true;
          $contr_grid_agenda_tecnicos->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "busca";
          $contr_grid_agenda_tecnicos->NM_ajax_flag = true;
          $contr_grid_agenda_tecnicos->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] = "busca";
          $contr_grid_agenda_tecnicos->NM_ajax_flag = true;
          $contr_grid_agenda_tecnicos->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_fixed_columns_grid_save' == $nmgp_opcao) {
          _cdb43bf63563fc88bfebcb7e7660d86f_saveFixedColumnsGrid($_POST['fixed_index'], $_POST['fixed_action'], $_POST['script_case_init']);
      }
      if ('ajax_fixed_columns_grid_load' == $nmgp_opcao) {
          _cdb43bf63563fc88bfebcb7e7660d86f_loadFixedColumnsGrid($_POST['script_case_init']);
      }
       $contr_grid_agenda_tecnicos->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_agenda_tecnicos(&$str)
   {
   }
   function nm_protect_num_grid_agenda_tecnicos($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric = array();
       $Nm_numeric[] = "id_agenda";
       $Nm_numeric[] = "id_tecnico";
       $Nm_numeric[] = "id_cliente";
       $Nm_numeric[] = "valor";
       $Nm_numeric[] = "costes_adicionales";
       $Nm_numeric[] = "descuento";
       $Nm_numeric[] = "valor_total";
       $Nm_numeric[] = "estado_actual";
       $Nm_numeric[] = "evaluacion";
   ...
   function grid_agenda_tecnicos_pack_protect_string($sString)
   {
    ...
    function grid_agenda_tecnicos_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
    ...
    function _cdb43bf63563fc88bfebcb7e7660d86f_initializeFixedColumnsGrid($script_case_init)
    {
        if (!isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid'])) {
            $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid'] = '';
        }
    }

    function _cdb43bf63563fc88bfebcb7e7660d86f_saveFixedColumnsGrid($index, $action, $script_case_init)
    {
        _cdb43bf63563fc88bfebcb7e7660d86f_initializeFixedColumnsGrid($script_case_init);

        if ('on' == $action) {
            $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid'] = $index;
        } elseif (0 < $index) {
            $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid'] = $index - 1;
        } else {
            $_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid'] = '';
        }
    ...
    function _cdb43bf63563fc88bfebcb7e7660d86f_loadFixedColumnsGrid($script_case_init)
    {
        _cdb43bf63563fc88bfebcb7e7660d86f_initializeFixedColumnsGrid($script_case_init);
        ...
        echo json_encode(
            array(
                'status' => 'ok',
                'last_index' =>$_SESSION['sc_session'][$script_case_init]['grid_agenda_tecnicos']['fixed_columns_grid']
            )
        );
        exit;
    }
