...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_tecnico"  <?php echo $str_hide_id_tecnico?>>
<?php
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_valor_total_cond" name="valor_total_cond" onChange="nm_campos_between(document.getElementById('id_vis_valor_total'), this, 'valor_total')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fecha_final_cond" name="fecha_final_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_final'), this, 'fecha_final')">
      ...
      <br><span id="id_hide_fecha_final"  <?php echo $str_hide_fecha_final?>>
<SPAN id="Nm_bi_dados_fecha_final" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_fecha_final"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fecha_final"  <?php echo $str_display_fecha_final; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_estado_actual"  <?php echo $str_hide_estado_actual?>>
<?php
