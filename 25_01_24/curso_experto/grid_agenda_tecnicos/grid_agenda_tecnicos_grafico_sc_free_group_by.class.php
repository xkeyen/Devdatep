...
<?php
   ...
   function inicializa_vars()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
