   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'fecha_inicial' => [
                    'label' => sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . ""),
                    'datatype' => 'date',
                ...
                'valor_total' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "",
                    'datatype' => 'decimal',
                ...
                'estado_actual' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "",
                    'datatype' => 'int',
                ...
                'id_tecnico' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . "",
                    'datatype' => 'int',
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label']))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "id_tecnico?#?" . "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "valor_total?#?" . "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "fecha_final?#?" . "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_final'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['pesq_tab_label'] .= "estado_actual?#?" . "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "" . "?@?";
      }
   ...
   function completeMatrix()
   {
       ...
       $Lab_fecha_inicial_scgb_19 = "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . "";
       $Lab_fecha_inicial_scgb_19 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "", $Lab_fecha_inicial_scgb_19);
       $Lab_valor_total = "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . "";
       $Lab_estado_actual = "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . "";
       $Lab_id_tecnico = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . "";
       }
       $prep_field = array();
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_agenda'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_agenda'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_cliente'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor_total'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_inicial'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_hora_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['estado_actual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['estado_actual'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['evaluacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['evaluacion'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_evaluacion'] . ""; 
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['id_tecnico'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['valor'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['costes_adicionales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['costes_adicionales'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_costes_adicionales'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['descuento'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_19'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_41']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_inicial_scgb_41'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['fecha_final'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_fecha_final'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['hora_final'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_hora_final'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['recurrencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['recurrencia'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_recurrencia'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['labels']['periodo'] = "" . $this->Ini->Nm_lang['lang_agenda_fld_periodo'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['doc_word'])
{
      ...
      { 
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_agenda_tecnicos_jquery_5556.js\"></script>\r\n");
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_cliente = $rs_res->fields[1] ;  
...
//
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "curso_experto/grid_agenda_tecnicos";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_final_mes'] =  'sc_grid_agenda_tecnicos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_final_dia'] =  'sc_grid_agenda_tecnicos_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_final_v2__mes'] =  'sc_grid_agenda_tecnicos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_final_v2__dia'] =  'sc_grid_agenda_tecnicos_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda_tecnicos']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_final_mes']", 'value' => 'sc_grid_agenda_tecnicos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_final_dia']", 'value' => 'sc_grid_agenda_tecnicos_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_final_v2__mes']", 'value' => 'sc_grid_agenda_tecnicos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_final_v2__dia']", 'value' => 'sc_grid_agenda_tecnicos_valida_dia(this)');
       } 
