<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_agenda_cita']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_agenda_cita_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_agenda_cita_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_agenda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_agenda"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_agenda"] : "" . $this->Nm_lang['lang_agenda_fld_id_agenda'] . "";
   $tab_ger_campos['fecha_inicial'] = "on";
   $tab_def_campos['fecha_inicial'] = "fecha_inicial";
   $tab_labels["fecha_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["fecha_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["fecha_inicial"] : "" . $this->Nm_lang['lang_agenda_fld_fecha_inicial'] . "";
   $tab_ger_campos['hora_inicial'] = "on";
   $tab_def_campos['hora_inicial'] = "hora_inicial";
   $tab_labels["hora_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["hora_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["hora_inicial"] : "" . $this->Nm_lang['lang_agenda_fld_hora_inicial'] . "";
   $tab_ger_campos['estado_actual'] = "on";
   $tab_def_campos['estado_actual'] = "estado_actual";
   $tab_labels["estado_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["estado_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["estado_actual"] : "" . $this->Nm_lang['lang_agenda_fld_estado_actual'] . "";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_cliente"] : "" . $this->Nm_lang['lang_agenda_fld_id_cliente'] . "";
   $tab_ger_campos['evaluacion'] = "on";
   $tab_def_campos['evaluacion'] = "evaluacion";
   $tab_labels["evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["evaluacion"] : "" . $this->Nm_lang['lang_agenda_fld_evaluacion'] . "";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["valor"] : "" . $this->Nm_lang['lang_agenda_fld_valor'] . "";
   $tab_ger_campos['costes_adicionales'] = "on";
   $tab_def_campos['costes_adicionales'] = "costes_adicionales";
   $tab_labels["costes_adicionales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["costes_adicionales"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["costes_adicionales"] : "" . $this->Nm_lang['lang_agenda_fld_costes_adicionales'] . "";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["descuento"] : "" . $this->Nm_lang['lang_agenda_fld_descuento'] . "";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["valor_total"] : "" . $this->Nm_lang['lang_agenda_fld_valor_total'] . "";
   $tab_ger_campos['id_tecnico'] = "on";
   $tab_def_campos['id_tecnico'] = "id_tecnico";
   $tab_labels["id_tecnico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_tecnico"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['labels']["id_tecnico"] : "" . $this->Nm_lang['lang_agenda_fld_id_tecnico'] . "";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_cita']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_cita']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda_cita']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_agenda_cita_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_agenda_cita']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
