...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_cita"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_agenda_cita"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_agenda_3'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_agenda_cita']['embutida_filho'] as $ind => $sc_init)
          {
