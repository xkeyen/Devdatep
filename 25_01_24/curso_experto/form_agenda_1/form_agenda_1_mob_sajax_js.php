  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_agenda_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_agenda_1_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_agenda
  function do_ajax_form_agenda_1_mob_validate_id_agenda()
  {
    var nomeCampo_id_agenda = "id_agenda";
    var var_id_agenda = scAjaxGetFieldHidden(nomeCampo_id_agenda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_id_agenda(var_id_agenda, var_script_case_init, do_ajax_form_agenda_1_mob_validate_id_agenda_cb);
  } // do_ajax_form_agenda_1_mob_validate_id_agenda

  function do_ajax_form_agenda_1_mob_validate_id_agenda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_agenda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_id_agenda_cb

  // ---------- Validate id_tecnico
  function do_ajax_form_agenda_1_mob_validate_id_tecnico()
  {
    var nomeCampo_id_tecnico = "id_tecnico";
    var var_id_tecnico = scAjaxGetFieldText(nomeCampo_id_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_id_tecnico(var_id_tecnico, var_script_case_init, do_ajax_form_agenda_1_mob_validate_id_tecnico_cb);
  } // do_ajax_form_agenda_1_mob_validate_id_tecnico

  function do_ajax_form_agenda_1_mob_validate_id_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_id_tecnico_cb

  // ---------- Validate id_cliente
  function do_ajax_form_agenda_1_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldText(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_agenda_1_mob_validate_id_cliente_cb);
  } // do_ajax_form_agenda_1_mob_validate_id_cliente

  function do_ajax_form_agenda_1_mob_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_id_cliente_cb

  // ---------- Validate valor
  function do_ajax_form_agenda_1_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_agenda_1_mob_validate_valor_cb);
  } // do_ajax_form_agenda_1_mob_validate_valor

  function do_ajax_form_agenda_1_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_valor_cb

  // ---------- Validate costes_adicionales
  function do_ajax_form_agenda_1_mob_validate_costes_adicionales()
  {
    var nomeCampo_costes_adicionales = "costes_adicionales";
    var var_costes_adicionales = scAjaxGetFieldText(nomeCampo_costes_adicionales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_costes_adicionales(var_costes_adicionales, var_script_case_init, do_ajax_form_agenda_1_mob_validate_costes_adicionales_cb);
  } // do_ajax_form_agenda_1_mob_validate_costes_adicionales

  function do_ajax_form_agenda_1_mob_validate_costes_adicionales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costes_adicionales";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_costes_adicionales_cb

  // ---------- Validate descuento
  function do_ajax_form_agenda_1_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_form_agenda_1_mob_validate_descuento_cb);
  } // do_ajax_form_agenda_1_mob_validate_descuento

  function do_ajax_form_agenda_1_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_descuento_cb

  // ---------- Validate valor_total
  function do_ajax_form_agenda_1_mob_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_agenda_1_mob_validate_valor_total_cb);
  } // do_ajax_form_agenda_1_mob_validate_valor_total

  function do_ajax_form_agenda_1_mob_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_valor_total_cb

  // ---------- Validate fecha_inicial
  function do_ajax_form_agenda_1_mob_validate_fecha_inicial()
  {
    var nomeCampo_fecha_inicial = "fecha_inicial";
    var var_fecha_inicial = scAjaxGetFieldText(nomeCampo_fecha_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_fecha_inicial(var_fecha_inicial, var_script_case_init, do_ajax_form_agenda_1_mob_validate_fecha_inicial_cb);
  } // do_ajax_form_agenda_1_mob_validate_fecha_inicial

  function do_ajax_form_agenda_1_mob_validate_fecha_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_inicial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_fecha_inicial_cb

  // ---------- Validate hora_inicial
  function do_ajax_form_agenda_1_mob_validate_hora_inicial()
  {
    var nomeCampo_hora_inicial = "hora_inicial";
    var var_hora_inicial = scAjaxGetFieldText(nomeCampo_hora_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_hora_inicial(var_hora_inicial, var_script_case_init, do_ajax_form_agenda_1_mob_validate_hora_inicial_cb);
  } // do_ajax_form_agenda_1_mob_validate_hora_inicial

  function do_ajax_form_agenda_1_mob_validate_hora_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_inicial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_hora_inicial_cb

  // ---------- Validate fecha_final
  function do_ajax_form_agenda_1_mob_validate_fecha_final()
  {
    var nomeCampo_fecha_final = "fecha_final";
    var var_fecha_final = scAjaxGetFieldText(nomeCampo_fecha_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_fecha_final(var_fecha_final, var_script_case_init, do_ajax_form_agenda_1_mob_validate_fecha_final_cb);
  } // do_ajax_form_agenda_1_mob_validate_fecha_final

  function do_ajax_form_agenda_1_mob_validate_fecha_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_final";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_fecha_final_cb

  // ---------- Validate hora_final
  function do_ajax_form_agenda_1_mob_validate_hora_final()
  {
    var nomeCampo_hora_final = "hora_final";
    var var_hora_final = scAjaxGetFieldText(nomeCampo_hora_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_hora_final(var_hora_final, var_script_case_init, do_ajax_form_agenda_1_mob_validate_hora_final_cb);
  } // do_ajax_form_agenda_1_mob_validate_hora_final

  function do_ajax_form_agenda_1_mob_validate_hora_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_hora_final_cb

  // ---------- Validate estado_actual
  function do_ajax_form_agenda_1_mob_validate_estado_actual()
  {
    var nomeCampo_estado_actual = "estado_actual";
    var var_estado_actual = scAjaxGetFieldText(nomeCampo_estado_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_estado_actual(var_estado_actual, var_script_case_init, do_ajax_form_agenda_1_mob_validate_estado_actual_cb);
  } // do_ajax_form_agenda_1_mob_validate_estado_actual

  function do_ajax_form_agenda_1_mob_validate_estado_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado_actual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_estado_actual_cb

  // ---------- Validate recurrencia
  function do_ajax_form_agenda_1_mob_validate_recurrencia()
  {
    var nomeCampo_recurrencia = "recurrencia";
    var var_recurrencia = scAjaxGetFieldText(nomeCampo_recurrencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_recurrencia(var_recurrencia, var_script_case_init, do_ajax_form_agenda_1_mob_validate_recurrencia_cb);
  } // do_ajax_form_agenda_1_mob_validate_recurrencia

  function do_ajax_form_agenda_1_mob_validate_recurrencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recurrencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_recurrencia_cb

  // ---------- Validate periodo
  function do_ajax_form_agenda_1_mob_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_periodo(var_periodo, var_script_case_init, do_ajax_form_agenda_1_mob_validate_periodo_cb);
  } // do_ajax_form_agenda_1_mob_validate_periodo

  function do_ajax_form_agenda_1_mob_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_periodo_cb

  // ---------- Validate evaluacion
  function do_ajax_form_agenda_1_mob_validate_evaluacion()
  {
    var nomeCampo_evaluacion = "evaluacion";
    var var_evaluacion = scAjaxGetFieldText(nomeCampo_evaluacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_1_mob_validate_evaluacion(var_evaluacion, var_script_case_init, do_ajax_form_agenda_1_mob_validate_evaluacion_cb);
  } // do_ajax_form_agenda_1_mob_validate_evaluacion

  function do_ajax_form_agenda_1_mob_validate_evaluacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "evaluacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_1_mob_validate_evaluacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_agenda_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_agenda_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_agenda = scAjaxGetFieldHidden("id_agenda");
    var var_id_tecnico = scAjaxGetFieldText("id_tecnico");
    var var_id_cliente = scAjaxGetFieldText("id_cliente");
    var var_valor = scAjaxGetFieldText("valor");
    var var_costes_adicionales = scAjaxGetFieldText("costes_adicionales");
    var var_descuento = scAjaxGetFieldText("descuento");
    var var_valor_total = scAjaxGetFieldText("valor_total");
    var var_fecha_inicial = scAjaxGetFieldText("fecha_inicial");
    var var_hora_inicial = scAjaxGetFieldText("hora_inicial");
    var var_fecha_final = scAjaxGetFieldText("fecha_final");
    var var_hora_final = scAjaxGetFieldText("hora_final");
    var var_estado_actual = scAjaxGetFieldText("estado_actual");
    var var_recurrencia = scAjaxGetFieldText("recurrencia");
    var var_periodo = scAjaxGetFieldText("periodo");
    var var_evaluacion = scAjaxGetFieldText("evaluacion");
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_1_mob_submit_form(var_id_agenda, var_id_tecnico, var_id_cliente, var_valor, var_costes_adicionales, var_descuento, var_valor_total, var_fecha_inicial, var_hora_inicial, var_fecha_final, var_hora_final, var_estado_actual, var_recurrencia, var_periodo, var_evaluacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agenda_1_mob_submit_form_cb);
  } // do_ajax_form_agenda_1_mob_submit_form

  function do_ajax_form_agenda_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_agenda_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_agenda_1_mob_submit_form_cb
  function do_ajax_form_agenda_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_agenda_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_agenda_1_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_agenda_1_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_agenda_1_mob_navigate_form();
    }
  }

  function perform_ajax_form_agenda_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_agenda = document.F2.id_agenda.value;
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_1_mob_navigate_form(var_id_agenda, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agenda_1_mob_navigate_form_cb);
  } // do_ajax_form_agenda_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_agenda_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_agenda.value = scAjaxGetKeyValue("id_agenda");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_agenda_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_agenda_1_mob_navigate_form_cb
  function do_ajax_form_agenda_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_agenda_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_agenda_1_mob_navigate_form_cb_after_alert

  function sc_hide_form_agenda_1_mob_form()
  {
  ...
  ajax_field_list[0] = "id_agenda";
  ajax_field_list[1] = "id_tecnico";
  ajax_field_list[2] = "id_cliente";
  ajax_field_list[3] = "valor";
  ajax_field_list[4] = "costes_adicionales";
  ajax_field_list[5] = "descuento";
  ajax_field_list[6] = "valor_total";
  ajax_field_list[7] = "fecha_inicial";
  ajax_field_list[8] = "hora_inicial";
  ajax_field_list[9] = "fecha_final";
  ajax_field_list[10] = "hora_final";
  ajax_field_list[11] = "estado_actual";
  ajax_field_list[12] = "recurrencia";
  ajax_field_list[13] = "periodo";
  ajax_field_list[14] = "evaluacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_agenda": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_id_agenda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_tecnico": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_id_tecnico'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_id_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "valor": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "costes_adicionales": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_costes_adicionales'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descuento": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_descuento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "valor_total": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_valor_total'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_inicial": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_fecha_inicial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hora_inicial": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_hora_inicial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_final": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_fecha_final'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hora_final": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_hora_final'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "estado_actual": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_estado_actual'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recurrencia": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_recurrencia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "periodo": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_periodo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "evaluacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_agenda_fld_evaluacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "valor": new Array(),
    "costes_adicionales": new Array(),
    "descuento": new Array(),
    "valor_total": new Array(),
    "fecha_inicial": new Array(),
    "hora_inicial": new Array(),
    "fecha_final": new Array(),
    "hora_final": new Array(),
    "estado_actual": new Array(),
    "recurrencia": new Array(),
    "periodo": new Array(),
    "evaluacion": new Array()
  };
  ajax_field_mult["id_agenda"][1] = "id_agenda";
  ajax_field_mult["id_tecnico"][1] = "id_tecnico";
  ajax_field_mult["id_cliente"][1] = "id_cliente";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["costes_adicionales"][1] = "costes_adicionales";
  ajax_field_mult["descuento"][1] = "descuento";
  ajax_field_mult["valor_total"][1] = "valor_total";
  ajax_field_mult["fecha_inicial"][1] = "fecha_inicial";
  ajax_field_mult["hora_inicial"][1] = "hora_inicial";
  ajax_field_mult["fecha_final"][1] = "fecha_final";
  ajax_field_mult["hora_final"][1] = "hora_final";
  ajax_field_mult["estado_actual"][1] = "estado_actual";
  ajax_field_mult["recurrencia"][1] = "recurrencia";
  ajax_field_mult["periodo"][1] = "periodo";
  ajax_field_mult["evaluacion"][1] = "evaluacion";

  var ajax_field_id = {
    "id_agenda": new Array("hidden_field_label_id_agenda", "hidden_field_data_id_agenda"),
    ...
    "costes_adicionales": new Array("hidden_field_label_costes_adicionales", "hidden_field_data_costes_adicionales"),
    ...
    "fecha_inicial": new Array("hidden_field_label_fecha_inicial", "hidden_field_data_fecha_inicial"),
    "hora_inicial": new Array("hidden_field_label_hora_inicial", "hidden_field_data_hora_inicial"),
    "fecha_final": new Array("hidden_field_label_fecha_final", "hidden_field_data_fecha_final"),
    "hora_final": new Array("hidden_field_label_hora_final", "hidden_field_data_hora_final"),
    "estado_actual": new Array("hidden_field_label_estado_actual", "hidden_field_data_estado_actual"),
    "recurrencia": new Array("hidden_field_label_recurrencia", "hidden_field_data_recurrencia"),
    "periodo": new Array("hidden_field_label_periodo", "hidden_field_data_periodo"),
    "evaluacion": new Array("hidden_field_label_evaluacion", "hidden_field_data_evaluacion")
  };
