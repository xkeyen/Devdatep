   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_agenda_1_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_agenda_1_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " " . $this->Ini->Nm_lang['lang_tbl_agenda'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_agenda_1_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_agenda_1/form_agenda_1_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_agenda_1_mob_calendar.php');
          }
          exit;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['sc_max_reg']) == "all")
      {
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_agenda))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_agenda_1_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] > $qt_geral_reg_form_agenda_1_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] = $qt_geral_reg_form_agenda_1_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_agenda_1_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_1_mob']['total'] + 1; 
