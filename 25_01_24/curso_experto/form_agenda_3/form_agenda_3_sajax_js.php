  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_agenda_3" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_agenda
  function do_ajax_form_agenda_3_validate_id_agenda()
  {
    var nomeCampo_id_agenda = "id_agenda";
    var var_id_agenda = scAjaxGetFieldHidden(nomeCampo_id_agenda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_id_agenda(var_id_agenda, var_script_case_init, do_ajax_form_agenda_3_validate_id_agenda_cb);
  } // do_ajax_form_agenda_3_validate_id_agenda

  function do_ajax_form_agenda_3_validate_id_agenda_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_id_agenda_cb

  // ---------- Validate id_tecnico
  function do_ajax_form_agenda_3_validate_id_tecnico()
  {
    var nomeCampo_id_tecnico = "id_tecnico";
    var var_id_tecnico = scAjaxGetFieldText(nomeCampo_id_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_id_tecnico(var_id_tecnico, var_script_case_init, do_ajax_form_agenda_3_validate_id_tecnico_cb);
  } // do_ajax_form_agenda_3_validate_id_tecnico

  function do_ajax_form_agenda_3_validate_id_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_id_tecnico_cb

  // ---------- Validate id_cliente
  function do_ajax_form_agenda_3_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldText(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_agenda_3_validate_id_cliente_cb);
  } // do_ajax_form_agenda_3_validate_id_cliente

  function do_ajax_form_agenda_3_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_id_cliente_cb

  // ---------- Validate valor
  function do_ajax_form_agenda_3_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_valor(var_valor, var_script_case_init, do_ajax_form_agenda_3_validate_valor_cb);
  } // do_ajax_form_agenda_3_validate_valor

  function do_ajax_form_agenda_3_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_valor_cb

  // ---------- Validate costes_adicionales
  function do_ajax_form_agenda_3_validate_costes_adicionales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_costes_adicionales(var_costes_adicionales, var_script_case_init, do_ajax_form_agenda_3_validate_costes_adicionales_cb);
  } // do_ajax_form_agenda_3_validate_costes_adicionales

  function do_ajax_form_agenda_3_validate_costes_adicionales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_costes_adicionales_cb

  // ---------- Validate descuento
  function do_ajax_form_agenda_3_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_descuento(var_descuento, var_script_case_init, do_ajax_form_agenda_3_validate_descuento_cb);
  } // do_ajax_form_agenda_3_validate_descuento

  function do_ajax_form_agenda_3_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_descuento_cb

  // ---------- Validate valor_total
  function do_ajax_form_agenda_3_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_agenda_3_validate_valor_total_cb);
  } // do_ajax_form_agenda_3_validate_valor_total

  function do_ajax_form_agenda_3_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_valor_total_cb

  // ---------- Validate fecha_inicial
  function do_ajax_form_agenda_3_validate_fecha_inicial()
  {
    var nomeCampo_fecha_inicial = "fecha_inicial";
    var var_fecha_inicial = scAjaxGetFieldText(nomeCampo_fecha_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_fecha_inicial(var_fecha_inicial, var_script_case_init, do_ajax_form_agenda_3_validate_fecha_inicial_cb);
  } // do_ajax_form_agenda_3_validate_fecha_inicial

  function do_ajax_form_agenda_3_validate_fecha_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_fecha_inicial_cb

  // ---------- Validate hora_inicial
  function do_ajax_form_agenda_3_validate_hora_inicial()
  {
    var nomeCampo_hora_inicial = "hora_inicial";
    var var_hora_inicial = scAjaxGetFieldText(nomeCampo_hora_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_hora_inicial(var_hora_inicial, var_script_case_init, do_ajax_form_agenda_3_validate_hora_inicial_cb);
  } // do_ajax_form_agenda_3_validate_hora_inicial

  function do_ajax_form_agenda_3_validate_hora_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_hora_inicial_cb

  // ---------- Validate fecha_final
  function do_ajax_form_agenda_3_validate_fecha_final()
  {
    var nomeCampo_fecha_final = "fecha_final";
    var var_fecha_final = scAjaxGetFieldText(nomeCampo_fecha_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_fecha_final(var_fecha_final, var_script_case_init, do_ajax_form_agenda_3_validate_fecha_final_cb);
  } // do_ajax_form_agenda_3_validate_fecha_final

  function do_ajax_form_agenda_3_validate_fecha_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_fecha_final_cb

  // ---------- Validate hora_final
  function do_ajax_form_agenda_3_validate_hora_final()
  {
    var nomeCampo_hora_final = "hora_final";
    var var_hora_final = scAjaxGetFieldText(nomeCampo_hora_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_hora_final(var_hora_final, var_script_case_init, do_ajax_form_agenda_3_validate_hora_final_cb);
  } // do_ajax_form_agenda_3_validate_hora_final

  function do_ajax_form_agenda_3_validate_hora_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_hora_final_cb

  // ---------- Validate estado_actual
  function do_ajax_form_agenda_3_validate_estado_actual()
  {
    var nomeCampo_estado_actual = "estado_actual";
    var var_estado_actual = scAjaxGetFieldText(nomeCampo_estado_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_estado_actual(var_estado_actual, var_script_case_init, do_ajax_form_agenda_3_validate_estado_actual_cb);
  } // do_ajax_form_agenda_3_validate_estado_actual

  function do_ajax_form_agenda_3_validate_estado_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_estado_actual_cb

  // ---------- Validate recurrencia
  function do_ajax_form_agenda_3_validate_recurrencia()
  {
    var nomeCampo_recurrencia = "recurrencia";
    var var_recurrencia = scAjaxGetFieldText(nomeCampo_recurrencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_recurrencia(var_recurrencia, var_script_case_init, do_ajax_form_agenda_3_validate_recurrencia_cb);
  } // do_ajax_form_agenda_3_validate_recurrencia

  function do_ajax_form_agenda_3_validate_recurrencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_recurrencia_cb

  // ---------- Validate periodo
  function do_ajax_form_agenda_3_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_periodo(var_periodo, var_script_case_init, do_ajax_form_agenda_3_validate_periodo_cb);
  } // do_ajax_form_agenda_3_validate_periodo

  function do_ajax_form_agenda_3_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_periodo_cb

  // ---------- Validate evaluacion
  function do_ajax_form_agenda_3_validate_evaluacion()
  {
    var nomeCampo_evaluacion = "evaluacion";
    var var_evaluacion = scAjaxGetFieldText(nomeCampo_evaluacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agenda_3_validate_evaluacion(var_evaluacion, var_script_case_init, do_ajax_form_agenda_3_validate_evaluacion_cb);
  } // do_ajax_form_agenda_3_validate_evaluacion

  function do_ajax_form_agenda_3_validate_evaluacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agenda_3_validate_evaluacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_agenda_3_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_agenda_3_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_3_submit_form(var_id_agenda, var_id_tecnico, var_id_cliente, var_valor, var_costes_adicionales, var_descuento, var_valor_total, var_fecha_inicial, var_hora_inicial, var_fecha_final, var_hora_final, var_estado_actual, var_recurrencia, var_periodo, var_evaluacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agenda_3_submit_form_cb);
  } // do_ajax_form_agenda_3_submit_form

  function do_ajax_form_agenda_3_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_agenda_3_submit_form_cb_after_alert);
  } // do_ajax_form_agenda_3_submit_form_cb
  function do_ajax_form_agenda_3_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_agenda_3_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_agenda_3_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_agenda_3_navigate_form, function() {});
    } else {
      perform_ajax_form_agenda_3_navigate_form();
    }
  }

  function perform_ajax_form_agenda_3_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_agenda_3_navigate_form(var_id_agenda, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agenda_3_navigate_form_cb);
  } // do_ajax_form_agenda_3_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_3']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_agenda_3_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_agenda_3_navigate_form_cb_after_alert);
  } // do_ajax_form_agenda_3_navigate_form_cb
  function do_ajax_form_agenda_3_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_agenda_3_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_agenda_3_navigate_form_cb_after_alert

  function sc_hide_form_agenda_3_form()
  {
