<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao']         = "conn_mysql";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "131127"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240116"; 
      $this->nm_hr_ult_alt   = "131139"; 
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_usuarios']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_usuarios']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_usuarios']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['sub_cons_schema_filter'];
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_usuarios_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_usuarios_ini.php");
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['link_info']['remove_border'] = true;
        }

      $this->link_form_usuarios =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_usuarios') . "/" ; 
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao'], $this->root . $this->path_prod, 'curso_experto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['embutida'])
      {
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'])) {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " " . $this->Ini->Nm_lang['lang_tbl_usuarios'] . "";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pivot_x_axys'];
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_usuarios_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_usuarios_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['proc_pdf_vert'] = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "login";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "contrasena";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "codigo_activacion";
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['use_pass_pdf'] = "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opc_liga']['inicial']))
          {
              ...
              $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['orig_pesq'] = "grid";
          }
      }
      ...
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "res_print";
          }
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_usuarios_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
...
//
      ...
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf']);
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_lookup'] = "";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_usuarios.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_res_xls.class.php"); 
          } 
          $this->xls  = new grid_usuarios_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_res_xml.class.php"); 
          } 
          $this->xml  = new grid_usuarios_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_json.class.php"); 
          } 
          $this->json  = new grid_usuarios_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_res_json.class.php"); 
          } 
          $this->json  = new grid_usuarios_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_res_csv.class.php"); 
          } 
          $this->csv  = new grid_usuarios_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_usuarios_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_usuarios_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] = "grid";
              }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_usuarios/grid_usuarios_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_usuarios_det.class.php"); 
              } 
              $this->det  = new grid_usuarios_det();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_usuarios_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_name'], 1);
                }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['use_pass_pdf'];
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_usuarios_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_usuarios_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_usuarios.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'] . ")"; 
              }
          }
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp" || $field == "contrasena") 
          {
              $this->SC_monta_condicao($comando, "contrasena", $arg_search, $data_search, "VARCHAR", false);
          }
          ...
          {
              $this->SC_monta_condicao($comando, "activo", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp" || $field == "codigo_activacion") 
          {
              $this->SC_monta_condicao($comando, "codigo_activacion", $arg_search, $data_search, "VARCHAR", false);
          }
      }
      if (empty($comando)) 
      {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['fast_search'][0] = $in_fields;
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file'] = $Arq_zip;
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_usuarios'] ?> :: Doc</TITLE>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/");
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios'][$path_doc_md5][1] = "grid_usuarios_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_usuarios']['sc_process_barr'])) {
       return;
   }
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_usuarios") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
           ...
           if (isset($_COOKIE['sc_actual_lang_curso_experto'])) {
               $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_curso_experto'];
           }
       }
   }
   ...
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['contr_total_geral'] = "NAO";
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['Sc_seq_det'] = $Sc_seq_det;
       } 
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_modal'] = false;
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
      ...
      if ('ajax_fixed_columns_grid_save' == $nmgp_opcao) {
          _7db7fe0fad13864b6ca126a695343e3b_saveFixedColumnsGrid($_POST['fixed_index'], $_POST['fixed_action'], $_POST['script_case_init']);
      }
      if ('ajax_fixed_columns_grid_load' == $nmgp_opcao) {
          _7db7fe0fad13864b6ca126a695343e3b_loadFixedColumnsGrid($_POST['script_case_init']);
      }
...
//
   ...
   function grid_usuarios_pack_protect_string($sString)
   {
    ...
    function grid_usuarios_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
    ...
    function _7db7fe0fad13864b6ca126a695343e3b_initializeFixedColumnsGrid($script_case_init)
    {
        if (!isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid'])) {
            $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid'] = '';
        }
    }

    function _7db7fe0fad13864b6ca126a695343e3b_saveFixedColumnsGrid($index, $action, $script_case_init)
    {
        _7db7fe0fad13864b6ca126a695343e3b_initializeFixedColumnsGrid($script_case_init);

        if ('on' == $action) {
            $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid'] = $index;
        } elseif (0 < $index) {
            $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid'] = $index - 1;
        } else {
            $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid'] = '';
        }
    ...
    function _7db7fe0fad13864b6ca126a695343e3b_loadFixedColumnsGrid($script_case_init)
    {
        _7db7fe0fad13864b6ca126a695343e3b_initializeFixedColumnsGrid($script_case_init);
        ...
        echo json_encode(
            array(
                'status' => 'ok',
                'last_index' =>$_SESSION['sc_session'][$script_case_init]['grid_usuarios']['fixed_columns_grid']
            )
        );
        exit;
    }
