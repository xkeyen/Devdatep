...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_login_cond" name="login_cond" onChange="nm_campos_between(document.getElementById('id_vis_login'), this, 'login')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_contrasena_cond" name="contrasena_cond" onChange="nm_campos_between(document.getElementById('id_vis_contrasena'), this, 'contrasena')">
      ...
      <br><span id="id_hide_contrasena"  <?php echo $str_hide_contrasena?>><?php
      if ($contrasena != "")
      {
      $contrasena_look = (is_string($contrasena) ? substr($this->Db->qstr($contrasena), 1, -1) : $contrasena); 
      $nmgp_def_dados = array(); 
