          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_contrasena')
      {
          $contrasena = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_contrasena($contrasena);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_usuarios'] ?></TITLE>
...
<script type="text/javascript" src="grid_usuarios_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_contrasena_cond#NMF#' + search_get_sel_txt('SC_contrasena_cond') + '@NMF@';
  str_out += 'SC_contrasena#NMF#' + search_get_text('SC_contrasena') + '@NMF@';
  str_out += 'id_ac_contrasena#NMF#' + search_get_text('id_ac_contrasena') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_contrasena").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_contrasena").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_contrasena",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_contrasena").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_usuarios'] ?></div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $contrasena_cond, $contrasena, $contrasena_autocomp,
      ...
      { 
          ...
          $email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email']; 
          $email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_cond']; 
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['login_cond']; 
          $contrasena = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['contrasena']; 
          $contrasena_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['contrasena_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_cond']; 
      ...
      if (!isset($contrasena_cond) || empty($contrasena_cond))
      {
         $contrasena_cond = "qp";
      }
      ...
      $str_hide_contrasena = (in_array($contrasena_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($contrasena)) ? strpos($contrasena, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $contrasena = substr($contrasena, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_email_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['email'])) ? $this->New_label['email'] : "" . $this->Ini->Nm_lang['lang_usuarios_fld_email'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>"  size=50 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_email" name="email_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_login_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_usuarios_fld_login'] . ""; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_login" name="login_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_contrasena_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['contrasena'])) ? $this->New_label['contrasena'] : "" . $this->Ini->Nm_lang['lang_usuarios_fld_contrasena'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_contrasena_cond" name="contrasena_cond" onChange="nm_campos_between(document.getElementById('id_vis_contrasena'), this, 'contrasena')">
       <OPTION value="qp" <?php if ("qp" == $contrasena_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $contrasena_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $contrasena_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $contrasena_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_contrasena" <?php echo $str_hide_contrasena?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['contrasena'])) ? $this->New_label['contrasena'] : "" . $this->Ini->Nm_lang['lang_usuarios_fld_contrasena'] . "";
 $nmgp_tab_label .= "contrasena?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $contrasena;
      }
?>
<INPUT  type="text" id="SC_contrasena" name="contrasena" value="<?php echo NM_encode_input($contrasena) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_contrasena" name="contrasena_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : "" . $this->Ini->Nm_lang['lang_usuarios_fld_nombre'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.contrasena_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_contrasena'), document.F1.contrasena_cond, 'contrasena');
   document.F1.contrasena.value = "";
   document.F1.contrasena_autocomp.value = "";
...
<?php
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_contrasena_cond'] = 'cond';
      $tp_fields['SC_contrasena'] = 'text_aut';
      $tp_fields['id_ac_contrasena'] = 'text_aut';
   ...
   function trata_campos()
   {
      ...
      if (!empty($contrasena_autocomp) && empty($contrasena))
      {
          $contrasena = $contrasena_autocomp;
      }
      ...
      $contrasena_cond_salva = $contrasena_cond; 
      if (!isset($contrasena_input_2) || $contrasena_input_2 == "")
      {
          $contrasena_input_2 = $contrasena;
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email'] = $email; 
      if (is_array($email) && !empty($email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $email;
      }
      elseif ($email_cond_salva == "nu" || $email_cond_salva == "nn" || $email_cond_salva == "ep" || $email_cond_salva == "ne" || !empty($email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $email;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_cond'] = $email_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "email"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $email_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['login'] = $login; 
      if (is_array($login) && !empty($login))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $login;
      }
      elseif ($login_cond_salva == "nu" || $login_cond_salva == "nn" || $login_cond_salva == "ep" || $login_cond_salva == "ne" || !empty($login))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $login;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['login_cond'] = $login_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "login"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $login_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['login'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['contrasena'] = $contrasena; 
      if (is_array($contrasena) && !empty($contrasena))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $contrasena;
      }
      elseif ($contrasena_cond_salva == "nu" || $contrasena_cond_salva == "nn" || $contrasena_cond_salva == "ep" || $contrasena_cond_salva == "ne" || !empty($contrasena))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $contrasena;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['contrasena_cond'] = $contrasena_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "contrasena"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $contrasena_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['contrasena'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre'] = $nombre; 
      if (is_array($nombre) && !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $nombre;
      }
      elseif ($nombre_cond_salva == "nu" || $nombre_cond_salva == "nn" || $nombre_cond_salva == "ep" || $nombre_cond_salva == "ne" || !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
    ...
    if ($contrasena != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['contrasena'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['contrasena'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['contrasena'] = $contrasena;
      }
      $nmgp_def_dados = array();
    if ($nombre != '') {
      $nombre_look = (is_string($nombre) ? substr($this->Db->qstr($nombre), 1, -1) : $nombre); 
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $contrasena
      $this->Date_part = false;
      if (isset($contrasena) || $contrasena_cond == "nu" || $contrasena_cond == "nn" || $contrasena_cond == "ep" || $contrasena_cond == "ne")
      {
         $this->monta_condicao("contrasena", $contrasena_cond, $contrasena, "", "contrasena", "VARCHAR", false);
      }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
