...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_contrasena()
   {
         ...
         $this->contrasena = str_replace('<', '&lt;', $this->contrasena);
         $this->contrasena = str_replace('>', '&gt;', $this->contrasena);
         $this->Texto_tag .= "<td>" . $this->contrasena . "</td>\r\n";
   }
   //----- nombre
   ...
   function NM_export_codigo_activacion()
   {
         ...
         $this->codigo_activacion = str_replace('<', '&lt;', $this->codigo_activacion);
         $this->codigo_activacion = str_replace('>', '&gt;', $this->codigo_activacion);
         $this->Texto_tag .= "<td>" . $this->codigo_activacion . "</td>\r\n";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_usuarios'] ?> :: RTF</TITLE>
