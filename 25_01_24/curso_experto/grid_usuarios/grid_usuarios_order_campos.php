...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["login"] : "" . $this->Nm_lang['lang_usuarios_fld_login'] . "";
   $tab_ger_campos['contrasena'] = "on";
   $tab_def_campos['contrasena'] = "contrasena";
   $tab_labels["contrasena"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["contrasena"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["contrasena"] : "" . $this->Nm_lang['lang_usuarios_fld_contrasena'] . "";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre"] : "" . $this->Nm_lang['lang_usuarios_fld_nombre'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email"] : "" . $this->Nm_lang['lang_usuarios_fld_email'] . "";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["activo"] : "" . $this->Nm_lang['lang_usuarios_fld_activo'] . "";
   $tab_ger_campos['codigo_activacion'] = "on";
   $tab_def_campos['codigo_activacion'] = "codigo_activacion";
   $tab_labels["codigo_activacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["codigo_activacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["codigo_activacion"] : "" . $this->Nm_lang['lang_usuarios_fld_codigo_activacion'] . "";
