<?php  
  ...
  session_start() ;
  class grid_usuarios_form_teste
  {
  function grid_usuarios_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_usuarios</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_usuarios"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_usuarios_form_teste();
  $frm_teste->grid_usuarios_teste();
?>
