<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_pais']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["codigo"] : "" . $this->Nm_lang['lang_pais_fld_codigo'] . "";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["nombre"] : "" . $this->Nm_lang['lang_pais_fld_nombre'] . "";
   $tab_ger_campos['continente'] = "on";
   $tab_def_campos['continente'] = "continente";
   $tab_labels["continente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["continente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["continente"] : "" . $this->Nm_lang['lang_pais_fld_continente'] . "";
   $tab_ger_campos['region'] = "on";
   $tab_def_campos['region'] = "region";
   $tab_labels["region"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["region"])) ? $_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["region"] : "" . $this->Nm_lang['lang_pais_fld_region'] . "";
   $tab_ger_campos['codigo2'] = "on";
   $tab_def_campos['codigo2'] = "codigo2";
   $tab_labels["codigo2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["codigo2"])) ? $_SESSION['sc_session'][$sc_init]['grid_pais']['labels']["codigo2"] : "" . $this->Nm_lang['lang_pais_fld_codigo2'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> pais</TITLE>
