...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq'])) {
...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label']))
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label'] .= "region?#?" . "" . $this->Ini->Nm_lang['lang_pais_fld_region'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label'] .= "codigo?#?" . "" . $this->Ini->Nm_lang['lang_pais_fld_codigo'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label'] .= "nombre?#?" . "" . $this->Ini->Nm_lang['lang_pais_fld_nombre'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label'] .= "continente?#?" . "" . $this->Ini->Nm_lang['lang_pais_fld_continente'] . "" . "?@?";
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] || $this->Ini->Embutida_iframe)
   {
   ...
   $this->Cmps_ord_def['continente'] = " asc";
   $this->Cmps_ord_def['region'] = " asc";
   $this->Cmps_ord_def['codigo2'] = " asc";
   ...
   { 
       ...
       $this->region = (isset($Busca_temp['region'])) ? $Busca_temp['region'] : ""; 
       $tmp_pos = (is_string($this->region)) ? strpos($this->region, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->region))
       {
           $this->region = substr($this->region, 0, $tmp_pos);
       }
       ...
       $this->continente = (isset($Busca_temp['continente'])) ? $Busca_temp['continente'] : ""; 
       $tmp_pos = (is_string($this->continente)) ? strpos($this->continente, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->continente))
       {
           $this->continente = substr($this->continente, 0, $tmp_pos);
       }
   } 
   ...
   $this->New_label['codigo'] = "" . $this->Ini->Nm_lang['lang_pais_fld_codigo'] . "";
   $this->New_label['nombre'] = "" . $this->Ini->Nm_lang['lang_pais_fld_nombre'] . "";
   $this->New_label['continente'] = "" . $this->Ini->Nm_lang['lang_pais_fld_continente'] . "";
   $this->New_label['region'] = "" . $this->Ini->Nm_lang['lang_pais_fld_region'] . "";
   $this->New_label['codigo2'] = "" . $this->Ini->Nm_lang['lang_pais_fld_codigo2'] . "";
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['ordem_select']['nombre'] = 'asc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['ordem_select']['codigo'] = 'asc'; 
...
// 
   ...
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['qt_reg_grid'];
   }
//----- 
   ...
   { 
       ...
       $this->continente = $this->rs_grid->fields[2] ;  
       $this->region = $this->rs_grid->fields[3] ;  
       $this->codigo2 = $this->rs_grid->fields[4] ;  
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['initialize']) ? true : false;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> pais :: PDF</TITLE>
...
<?php
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " pais</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $this->NM_opcao != "pdf") {
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_pais_jquery_3596.js\"></script>\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida']) {  
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-grid_pais-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
...
$nm_saida->saida("}\r\n");
 ...
 { 
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_pais_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_pais_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
   ...
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'])
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['SC_Ind_Groupby'] == "sc_free_total")
           {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   $this->css_continente_label = $compl_css_emb . "css_continente_label";
   $this->css_continente_grid_line = $compl_css_emb . "css_continente_grid_line";
   $this->css_region_label = $compl_css_emb . "css_region_label";
   $this->css_region_grid_line = $compl_css_emb . "css_region_grid_line";
   $this->css_codigo2_label = $compl_css_emb . "css_codigo2_label";
   $this->css_codigo2_grid_line = $compl_css_emb . "css_codigo2_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " pais</div>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo2_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo2_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left  " . $classColFld . $classColTitle . $classColActions . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo2_label'] . "\" >\r\n");
   $nm_saida->saida("<style>\r\n");
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : "" . $this->Ini->Nm_lang['lang_pais_fld_codigo'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_codigo_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo_label'] . "\" >\r\n");
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : "" . $this->Ini->Nm_lang['lang_pais_fld_nombre'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 function NM_label_continente()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['continente'])) ? $this->New_label['continente'] : "" . $this->Ini->Nm_lang['lang_pais_fld_continente'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['continente']) || $this->NM_cmp_hidden['continente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_continente_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_continente_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('continente');
        $fieldSortIcon = $this->scGetColumnOrderIcon('continente', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_continente_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_continente_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('continente')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_region()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['region'])) ? $this->New_label['region'] : "" . $this->Ini->Nm_lang['lang_pais_fld_region'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['region']) || $this->NM_cmp_hidden['region'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_region_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_region_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('region');
        $fieldSortIcon = $this->scGetColumnOrderIcon('region', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_region_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_region_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('region')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_codigo2()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['codigo2'])) ? $this->New_label['codigo2'] : "" . $this->Ini->Nm_lang['lang_pais_fld_codigo2'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['codigo2']) || $this->NM_cmp_hidden['codigo2'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_codigo2_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_codigo2_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('codigo2');
        $fieldSortIcon = $this->scGetColumnOrderIcon('codigo2', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_codigo2_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_codigo2_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('codigo2')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['where_pesq_filtro'];
// 
   $SC_Label = (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['labels']['codigo'] = $SC_Label; 
   ...
   $SC_Label = (isset($this->New_label['continente'])) ? $this->New_label['continente'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['labels']['continente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['region'])) ? $this->New_label['region'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['labels']['region'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['codigo2'])) ? $this->New_label['codigo2'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['labels']['codigo2'] = $SC_Label; 
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_pais']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_pais";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != "print") 
...
// 
   ...
   {  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'])
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_codigo2_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_codigo2_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['mostra_edit'] != "N"){ 
              ...
              $linkTarget = isset($this->Ini->sc_lig_target['A_@scinf__@scinf_form_pais']) ? $this->Ini->sc_lig_target['A_@scinf__@scinf_form_pais'] : (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : null);
              if (isset($this->Ini->sc_lig_md5["form_pais"]) && $this->Ini->sc_lig_md5["form_pais"] == "S")
              {
                  $Parms_Edt  = "codigo*scin" . str_replace('"', "@aspasd@", $this->codigo) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
                  ...
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_pais@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "codigo*scin" . str_replace('"', "@aspasd@", $this->codigo) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_pais . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_pais', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_pais . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_pais', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_codigo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['codigo']) || $this->NM_cmp_hidden['codigo'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && !empty($conteudo)) 
          { 
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_codigo_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_codigo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_codigo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_continente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['continente']) || $this->NM_cmp_hidden['continente'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->continente));
              $conteudo_original = NM_encode_input(sc_strip_script($this->continente));
          }
          else {
              $conteudo = sc_strip_script($this->continente); 
              $conteudo_original = sc_strip_script($this->continente); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'continente', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'continente', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_continente_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_continente_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_continente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_region()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['region']) || $this->NM_cmp_hidden['region'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->region));
              $conteudo_original = NM_encode_input(sc_strip_script($this->region));
          }
          else {
              $conteudo = sc_strip_script($this->region); 
              $conteudo_original = sc_strip_script($this->region); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'region', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'region', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_region_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_region_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_region_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_codigo2()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['codigo2']) || $this->NM_cmp_hidden['codigo2'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->codigo2));
              $conteudo_original = NM_encode_input(sc_strip_script($this->codigo2));
          }
          else {
              $conteudo = sc_strip_script($this->codigo2); 
              $conteudo_original = sc_strip_script($this->codigo2); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'codigo2', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'codigo2', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_codigo2_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_codigo2_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_codigo2_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $SC_Label_atu['codigo'] = (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : '' . $this->Ini->Nm_lang['lang_pais_fld_codigo'] . ''; 
          $SC_Label_atu['nombre'] = (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : '' . $this->Ini->Nm_lang['lang_pais_fld_nombre'] . ''; 
          $SC_Label_atu['continente'] = (isset($this->New_label['continente'])) ? $this->New_label['continente'] : '' . $this->Ini->Nm_lang['lang_pais_fld_continente'] . ''; 
          $SC_Label_atu['region'] = (isset($this->New_label['region'])) ? $this->New_label['region'] : '' . $this->Ini->Nm_lang['lang_pais_fld_region'] . ''; 
          $SC_Label_atu['codigo2'] = (isset($this->New_label['codigo2'])) ? $this->New_label['codigo2'] : '' . $this->Ini->Nm_lang['lang_pais_fld_codigo2'] . ''; 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['field_order'] as $cada_field)
          { 
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_pais&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_form_pais . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_pais'); return false;;", "nm_gp_submit1('" .  $this->Ini->link_form_pais . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_pais'); return false;;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['SC_Ind_Groupby'] != "sc_free_total")
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['csv'][] = "csv_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pais/grid_pais_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "region")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "region";
                           $lin_obj = $this->grid_search_region($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "codigo")
                        {
                        ...
                        if ($cmp == "continente")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "continente";
                           $lin_obj = $this->grid_search_continente($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
   ...
   {
       global $nm_saida;
       $this->Cmps_required = array('codigo');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('region','codigo','nombre','continente');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['grid_pesq']) < 4)
       {
   ...
   function grid_search_region($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_region_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_region_cond_" . $ind . "' name='cond_grid_search_region_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"region\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_region_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $region = $val_cmp;
       if ($region != "")
       {
       $region_look = (is_string($region) ? substr($this->Db->qstr($region), 1, -1) : $region); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct region from " . $this->Ini->nm_tabela . " where region = '$region_look' order by region"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$region]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$region];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_region_val_" . $ind . "' name='val_grid_search_region_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=26 alt=\"{datatype: 'text', maxLength: 26, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_region" . $ind . "' name='val_grid_search_region_autocomp" . $ind . "' size='26' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 26, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_codigo_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_codigo_val_" . $ind . "' name='val_grid_search_codigo_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=3 alt=\"{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_codigo" . $ind . "' name='val_grid_search_codigo_autocomp" . $ind . "' size='3' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_nombre_val_" . $ind . "' name='val_grid_search_nombre_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=52 alt=\"{datatype: 'text', maxLength: 52, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_nombre" . $ind . "' name='val_grid_search_nombre_autocomp" . $ind . "' size='52' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 52, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_continente($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_continente_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_continente_cond_" . $ind . "' name='cond_grid_search_continente_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"continente\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_continente_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $continente = $val_cmp;
       if ($continente != "")
       {
       $continente_look = (is_string($continente) ? substr($this->Db->qstr($continente), 1, -1) : $continente); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct continente from " . $this->Ini->nm_tabela . " where continente = '$continente_look' order by continente"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
       ...
       if (isset($nmgp_def_dados[0][$continente]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$continente];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_continente_val_" . $ind . "' name='val_grid_search_continente_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=10 alt=\"{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_continente" . $ind . "' name='val_grid_search_continente_autocomp" . $ind . "' size='10' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function lookup_ajax_region($region)
   {
       $region = substr($this->Db->qstr($region), 1, -1);
       $this->NM_case_insensitive = false;
       $region_look = (is_string($region) ? substr($this->Db->qstr($region), 1, -1) : $region); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct region from " . $this->Ini->nm_tabela . " where  region like '%" . $region . "%' order by region"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_continente($continente)
   {
       $continente = substr($this->Db->qstr($continente), 1, -1);
       $this->NM_case_insensitive = false;
       $continente_look = (is_string($continente) ? substr($this->Db->qstr($continente), 1, -1) : $continente); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct continente from " . $this->Ini->nm_tabela . " where  continente like '%" . $continente . "%' order by continente"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "curso_experto/grid_pais";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'region')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_region = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_region\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_region_val_\" + x_region).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_region_val_\" + x_region).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'continente')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_continente = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_continente\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                             nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                             origem: \"grid\",\r\n");
       $nm_saida->saida("                             field: \"continente\",\r\n");
       $nm_saida->saida("                             max_itens: \"10\",\r\n");
       $nm_saida->saida("                             cod_desc: \"N\",\r\n");
       $nm_saida->saida("                             script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           },\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_continente_val_\" + x_continente).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_continente_val_\" + x_continente).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'region')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'continente')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('codigo', 'nombre', 'continente', 'region', 'codigo2'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pais']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_pais_iframe.php\";\r\n");
