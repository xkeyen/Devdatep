<?php  
  ...
  session_start() ;
  class grid_pais_form_teste
  {
  function grid_pais_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_pais</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_pais"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_pais_form_teste();
  $frm_teste->grid_pais_teste();
?>
