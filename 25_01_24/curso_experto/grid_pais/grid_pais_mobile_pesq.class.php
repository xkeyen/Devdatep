...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_region_cond" name="region_cond" onChange="nm_campos_between(document.getElementById('id_vis_region'), this, 'region')">
      ...
      <br><span id="id_hide_region"  <?php echo $str_hide_region?>><?php
      if ($region != "")
      {
      $region_look = (is_string($region) ? substr($this->Db->qstr($region), 1, -1) : $region); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_continente_cond" name="continente_cond" onChange="nm_campos_between(document.getElementById('id_vis_continente'), this, 'continente')">
      ...
      <br><span id="id_hide_continente"  <?php echo $str_hide_continente?>><?php
      if ($continente != "")
      {
      $continente_look = (is_string($continente) ? substr($this->Db->qstr($continente), 1, -1) : $continente); 
      $nmgp_def_dados = array(); 
