...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_pais"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_pais"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pais'] = array();
   $fecha_janela = false;
