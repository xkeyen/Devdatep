...
*/
    ...
    $SC_cod_proj = "curso_experto";
    $SC_apl_proc = "grid_clientes_direcciones";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","tem_res_cons,tem_res_res,cor_imp,papel,orientacao,bookmarks,page_break");
/* sc_apl_default */
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_clientes_direcciones']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_clientes_direcciones']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_clientes_direcciones']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_clientes_direcciones']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
