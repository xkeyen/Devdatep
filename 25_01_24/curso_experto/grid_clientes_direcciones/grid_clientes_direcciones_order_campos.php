<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_clientes_direcciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_curso_experto.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_clientes_direcciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_clientes_direcciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["id_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_id_cliente'] . "";
   $tab_ger_campos['nombre_cliente'] = "on";
   $tab_def_campos['nombre_cliente'] = "nombre_cliente";
   $tab_labels["nombre_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["nombre_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["nombre_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_nombre_cliente'] . "";
   $tab_ger_campos['email_cliente'] = "on";
   $tab_def_campos['email_cliente'] = "email_cliente";
   $tab_labels["email_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["email_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["email_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_email_cliente'] . "";
   $tab_ger_campos['telefono_cliente'] = "on";
   $tab_def_campos['telefono_cliente'] = "telefono_cliente";
   $tab_labels["telefono_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["telefono_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["telefono_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_telefono_cliente'] . "";
   $tab_ger_campos['direccion_cliente'] = "on";
   $tab_def_campos['direccion_cliente'] = "direccion_cliente";
   $tab_labels["direccion_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["direccion_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["direccion_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_direccion_cliente'] . "";
   $tab_ger_campos['postal_cliente'] = "on";
   $tab_def_campos['postal_cliente'] = "postal_cliente";
   $tab_labels["postal_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["postal_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["postal_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_postal_cliente'] . "";
   $tab_ger_campos['ciudad_cliente'] = "on";
   $tab_def_campos['ciudad_cliente'] = "ciudad_cliente";
   $tab_labels["ciudad_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["ciudad_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["ciudad_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_ciudad_cliente'] . "";
   $tab_ger_campos['pais_cliente'] = "on";
   $tab_def_campos['pais_cliente'] = "pais_cliente";
   $tab_labels["pais_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["pais_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["pais_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_pais_cliente'] . "";
   $tab_ger_campos['mapa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['mapa'] = "mapa";
   }
   else
   {
       $tab_def_campos['mapa'] = "";
   }
   $tab_labels["mapa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["mapa"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['labels']["mapa"] : "mapa";
   $tab_ger_campos['mapa'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_clientes_direcciones']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_clientes_direcciones']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_clientes_direcciones']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_clientes'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_clientes_direcciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_clientes_direcciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
