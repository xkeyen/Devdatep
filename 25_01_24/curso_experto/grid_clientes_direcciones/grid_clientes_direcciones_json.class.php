...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function NM_export_ciudad_cliente()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->ciudad_cliente;
   }
   //----- pais_cliente
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_clientes'] ?> :: JSON</TITLE>
