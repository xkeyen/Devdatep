<?php
@session_start() ;
$_SESSION['scriptcase']['grid_clientes_direcciones']['sc_process_barr'] = true;
require_once('../grid_clientes_direcciones/index.php');
unset($_SESSION['scriptcase']['grid_clientes_direcciones']['sc_process_barr']);
$ExportCtrl = new grid_clientes_direcciones_export_control;
$ExportCtrl->Export_barr();

class grid_clientes_direcciones_export_control
{
