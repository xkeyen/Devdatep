...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_clientes_direcciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["curso_experto_____grid_clientes_direcciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_clientes_1'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_clientes_direcciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_clientes_direcciones']['embutida_filho'] as $ind => $sc_init)
          {
