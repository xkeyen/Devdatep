...
?>
  ...
  // ---------- Validate codigo
  function do_ajax_form_pais_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_pais_validate_codigo_cb);
  } // do_ajax_form_pais_validate_codigo

  function do_ajax_form_pais_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_validate_codigo_cb
  ...
  // ---------- Validate continente
  function do_ajax_form_pais_validate_continente()
  {
    var nomeCampo_continente = "continente";
    var var_continente = scAjaxGetFieldText(nomeCampo_continente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_validate_continente(var_continente, var_script_case_init, do_ajax_form_pais_validate_continente_cb);
  } // do_ajax_form_pais_validate_continente

  function do_ajax_form_pais_validate_continente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_validate_continente_cb

  // ---------- Validate region
  function do_ajax_form_pais_validate_region()
  {
    var nomeCampo_region = "region";
    var var_region = scAjaxGetFieldText(nomeCampo_region);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_validate_region(var_region, var_script_case_init, do_ajax_form_pais_validate_region_cb);
  } // do_ajax_form_pais_validate_region

  function do_ajax_form_pais_validate_region_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "region";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_validate_region_cb

  // ---------- Validate codigo2
  function do_ajax_form_pais_validate_codigo2()
  {
    var nomeCampo_codigo2 = "codigo2";
    var var_codigo2 = scAjaxGetFieldText(nomeCampo_codigo2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_validate_codigo2(var_codigo2, var_script_case_init, do_ajax_form_pais_validate_codigo2_cb);
  } // do_ajax_form_pais_validate_codigo2

  function do_ajax_form_pais_validate_codigo2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_validate_codigo2_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_pais_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_pais_submit_form(var_codigo, var_nombre, var_continente, var_region, var_codigo2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pais_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pais_navigate_form, function() {});
    } else {
  ...
  function perform_ajax_form_pais_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_pais_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pais_navigate_form_cb);
