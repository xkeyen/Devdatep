<?php  
  ...
  session_start() ;
  class form_pais_form_teste
  {
   function form_pais_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_pais/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_pais</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_pais"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_pais_form_teste();
  $frm_teste->form_pais_teste();
?>
