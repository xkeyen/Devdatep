...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_practitioners_practitioner_id()
   {
         ...
         $this->practitioners_practitioner_id = NM_charset_to_utf8($this->practitioners_practitioner_id);
         $this->practitioners_practitioner_id = str_replace('<', '&lt;', $this->practitioners_practitioner_id);
         $this->practitioners_practitioner_id = str_replace('>', '&gt;', $this->practitioners_practitioner_id);
         $this->Texto_tag .= "<td>" . $this->practitioners_practitioner_id . "</td>\r\n";
   }
