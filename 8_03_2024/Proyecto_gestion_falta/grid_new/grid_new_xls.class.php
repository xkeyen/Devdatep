...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_new/grid_new_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['xls_name']))
      {
          ...
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['xls_name'] .= $this->Xls_tp;
          }
   ...
   function NM_export_practitioners_practitioner_id()
   {
         ...
         if (is_numeric($this->practitioners_practitioner_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->practitioners_practitioner_id);
         $this->Xls_col++;
   }
   //----- practitioners_practitioner_id
   ...
   {
         $this->practitioners_practitioner_id = NM_charset_to_utf8($this->practitioners_practitioner_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->practitioners_practitioner_id;
