<?php
   ...
   $_SESSION['scriptcase']['grid_new']['glo_nm_conexao']         = "u676589254_desarrollo";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "130716"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240308"; 
      $this->nm_hr_ult_alt   = "133610"; 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_new']['glo_nm_conexao'], $this->root . $this->path_prod, 'Proyecto_gestion_falta', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['field_order'][] = "practitioners_practitioner_id";
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "practitioners.practitioner_id", $arg_search, str_replace(",", ".", $data_search));
          }
      }
      if (empty($comando)) 
      {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new']['SC_sep_date']))
      {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_Proyecto_gestion_falta.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_Proyecto_gestion_falta.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Proyecto_gestion_falta'])) {
               $_SESSION['scriptcase']['grid_new']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Proyecto_gestion_falta'];
           }
       }
   }
...
//
   ...
   function nm_protect_num_grid_new($name, &$val)
   {
       ...
       $Nm_numeric[] = "faults_practitioners_fault_list_id";
       ...
       $Nm_numeric[] = "general_data_general_id";
