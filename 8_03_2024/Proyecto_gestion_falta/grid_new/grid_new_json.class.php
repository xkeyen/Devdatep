...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_practitioners_practitioner_id()
   {
         if ($this->Json_format)
         {
             nmgp_Form_Num_Val($this->practitioners_practitioner_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         }
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->practitioners_practitioner_id;
   }
