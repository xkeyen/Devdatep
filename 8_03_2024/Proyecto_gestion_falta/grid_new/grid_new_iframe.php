...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/sc_apl_default_Proyecto_gestion_falta.txt"))
    {
?>
<html>
 <body>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_new']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['grid_new']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['grid_new']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_new']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_new']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_grid_new.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_new'][$path_doc_md5][0] = $_SESSION['scriptcase']['grid_new']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
