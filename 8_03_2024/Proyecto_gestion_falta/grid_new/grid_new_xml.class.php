...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_practitioners_practitioner_id()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->practitioners_practitioner_id) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->practitioners_practitioner_id) . "\"";
         }
   }
