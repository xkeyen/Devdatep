...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["practitioners_practitioner_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new']['labels']["practitioners_practitioner_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new']['labels']["practitioners_practitioner_id"] : "Practitioner Id";
