<?php  
  ...
  session_start() ;
  class grid_new_1_form_teste
  {
  function grid_new_1_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_new_1</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_new_1"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_new_1_form_teste();
  $frm_teste->grid_new_1_teste();
?>
