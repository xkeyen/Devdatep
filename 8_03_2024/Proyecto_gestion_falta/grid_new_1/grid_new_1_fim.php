...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_falta_____grid_new_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_falta_____grid_new_1"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_new_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_new_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_new_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_new_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_new_1']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_new_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_new_1']['embutida_filho'] as $ind => $sc_init)
          {
