...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "faults_practitioners.fault_practitioner_date";$Nm_datas[] = "faults_practitioners_fault_practitioner_date";$Nm_datas[] = "faults_practitioners.fault_register_date";$Nm_datas[] = "faults_practitioners_fault_register_date";$Nm_datas[] = "faults_practitioners.sanction_date";$Nm_datas[] = "faults_practitioners_sanction_date";$Nm_numeric[] = "practitioners_area_id";$Nm_numeric[] = "practitioners_practitioner_id";$Nm_numeric[] = "faults_practitioners_fault_practitioner_id";$Nm_numeric[] = "faults_practitioners_practitioner_fault_id";$Nm_numeric[] = "faults_practitioners_practitioner_register_id";$Nm_numeric[] = "faults_practitioners_practitioner_execute_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_faults_practitioners_fault_practitioner_id_cond" name="faults_practitioners_fault_practitioner_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_fault_practitioner_id'), this, 'faults_practitioners_fault_practitioner_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_faults_practitioners_practitioner_fault_id_cond" name="faults_practitioners_practitioner_fault_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_fault_id'), this, 'faults_practitioners_practitioner_fault_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_faults_practitioners_practitioner_register_id_cond" name="faults_practitioners_practitioner_register_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_register_id'), this, 'faults_practitioners_practitioner_register_id')">
