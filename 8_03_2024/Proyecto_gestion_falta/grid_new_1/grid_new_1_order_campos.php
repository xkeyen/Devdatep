<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_new_1']['glo_nm_path_imag_temp'] . "/sc_apl_default_Proyecto_gestion_falta.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_new_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_new_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["practitioners_practitioner_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["practitioners_practitioner_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["practitioners_practitioner_id"] : "Practitioner Id";
   $tab_ger_campos['faults_practitioners_fault_practitioner_date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_fault_practitioner_date'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['faults_practitioners_fault_practitioner_date'] = "faults_practitioners.fault_practitioner_date";
   }
   $tab_labels["faults_practitioners_fault_practitioner_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_practitioner_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_practitioner_date"] : "Fault Practitioner Date";
   $tab_ger_campos['faults_practitioners_fault_practitioner_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_fault_practitioner_id'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['faults_practitioners_fault_practitioner_id'] = "faults_practitioners.fault_practitioner_id";
   }
   $tab_labels["faults_practitioners_fault_practitioner_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_practitioner_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_practitioner_id"] : "Fault Practitioner Id";
   $tab_ger_campos['faults_practitioners_practitioner_fault_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_practitioner_fault_id'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['faults_practitioners_practitioner_fault_id'] = "faults_practitioners.practitioner_fault_id";
   }
   $tab_labels["faults_practitioners_practitioner_fault_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_fault_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_fault_id"] : "Practitioner Fault Id";
   $tab_ger_campos['faults_practitioners_practitioner_register_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_practitioner_register_id'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['faults_practitioners_practitioner_register_id'] = "faults_practitioners.practitioner_register_id";
   }
   $tab_labels["faults_practitioners_practitioner_register_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_register_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_register_id"] : "Practitioner Register Id";
   $tab_ger_campos['faults_practitioners_fault_register_date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_fault_register_date'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['faults_practitioners_fault_register_date'] = "faults_practitioners.fault_register_date";
   }
   $tab_labels["faults_practitioners_fault_register_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_register_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_fault_register_date"] : "Fault Register Date";
   $tab_ger_campos['faults_practitioners_practitioner_execute_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_practitioner_execute_id'] = "cmp_maior_30_6";
   }
   else
   {
       $tab_def_campos['faults_practitioners_practitioner_execute_id'] = "faults_practitioners.practitioner_execute_id";
   }
   $tab_labels["faults_practitioners_practitioner_execute_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_execute_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_practitioner_execute_id"] : "Practitioner Execute Id";
   $tab_ger_campos['faults_practitioners_sanction_date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['faults_practitioners_sanction_date'] = "cmp_maior_30_7";
   }
   else
   {
       $tab_def_campos['faults_practitioners_sanction_date'] = "faults_practitioners.sanction_date";
   }
   $tab_labels["faults_practitioners_sanction_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_sanction_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['labels']["faults_practitioners_sanction_date"] : "Sanction Date";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_new_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_new_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_new_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_new_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
