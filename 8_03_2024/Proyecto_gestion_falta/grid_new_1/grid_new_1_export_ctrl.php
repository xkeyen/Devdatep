<?php
@session_start() ;
$_SESSION['scriptcase']['grid_new_1']['sc_process_barr'] = true;
require_once('../grid_new_1/index.php');
unset($_SESSION['scriptcase']['grid_new_1']['sc_process_barr']);
$ExportCtrl = new grid_new_1_export_control;
$ExportCtrl->Export_barr();

class grid_new_1_export_control
{
