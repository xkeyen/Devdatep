...
class grid_new_1_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_new_1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_new_1_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_new_1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_new_1/grid_new_1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_new_1_ajax_search.js"></script>
 <script type="text/javascript" src="grid_new_1_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_new_1_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_new_1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_new_1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_faults_practitioners_fault_practitioner_id_cond#NMF#' + search_get_sel_txt('SC_faults_practitioners_fault_practitioner_id_cond') + '@NMF@';
  str_out += 'SC_faults_practitioners_fault_practitioner_id#NMF#' + search_get_text('SC_faults_practitioners_fault_practitioner_id') + '@NMF@';
  str_out += 'SC_faults_practitioners_practitioner_fault_id_cond#NMF#' + search_get_sel_txt('SC_faults_practitioners_practitioner_fault_id_cond') + '@NMF@';
  str_out += 'SC_faults_practitioners_practitioner_fault_id#NMF#' + search_get_text('SC_faults_practitioners_practitioner_fault_id') + '@NMF@';
  str_out += 'SC_faults_practitioners_practitioner_register_id_cond#NMF#' + search_get_sel_txt('SC_faults_practitioners_practitioner_register_id_cond') + '@NMF@';
  str_out += 'SC_faults_practitioners_practitioner_register_id#NMF#' + search_get_text('SC_faults_practitioners_practitioner_register_id') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $faults_practitioners_fault_practitioner_id_cond, $faults_practitioners_fault_practitioner_id,
             $faults_practitioners_practitioner_fault_id_cond, $faults_practitioners_practitioner_fault_id,
             $faults_practitioners_practitioner_register_id_cond, $faults_practitioners_practitioner_register_id,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $faults_practitioners_fault_practitioner_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_fault_practitioner_id']; 
          $faults_practitioners_fault_practitioner_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_fault_practitioner_id_cond']; 
          $faults_practitioners_practitioner_fault_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_fault_id']; 
          $faults_practitioners_practitioner_fault_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_fault_id_cond']; 
          $faults_practitioners_practitioner_register_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_register_id']; 
          $faults_practitioners_practitioner_register_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_register_id_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['NM_operador']; 
          if (strtoupper($faults_practitioners_fault_practitioner_id_cond) != "II" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "QP" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "NP" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($faults_practitioners_fault_practitioner_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($faults_practitioners_practitioner_fault_id_cond) != "II" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "QP" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "NP" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($faults_practitioners_practitioner_fault_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($faults_practitioners_practitioner_register_id_cond) != "II" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "QP" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "NP" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($faults_practitioners_practitioner_register_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($faults_practitioners_fault_practitioner_id_cond) || empty($faults_practitioners_fault_practitioner_id_cond))
      {
         $faults_practitioners_fault_practitioner_id_cond = "gt";
      }
      if (!isset($faults_practitioners_practitioner_fault_id_cond) || empty($faults_practitioners_practitioner_fault_id_cond))
      {
         $faults_practitioners_practitioner_fault_id_cond = "gt";
      }
      if (!isset($faults_practitioners_practitioner_register_id_cond) || empty($faults_practitioners_practitioner_register_id_cond))
      {
         $faults_practitioners_practitioner_register_id_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_faults_practitioners_fault_practitioner_id = (in_array($faults_practitioners_fault_practitioner_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_faults_practitioners_practitioner_fault_id = (in_array($faults_practitioners_practitioner_fault_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_faults_practitioners_practitioner_register_id = (in_array($faults_practitioners_practitioner_register_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($faults_practitioners_fault_practitioner_id) || $faults_practitioners_fault_practitioner_id == "")
      {
          $faults_practitioners_fault_practitioner_id = "";
      }
      if (isset($faults_practitioners_fault_practitioner_id) && !empty($faults_practitioners_fault_practitioner_id))
      {
      ...
      if (!isset($faults_practitioners_practitioner_fault_id) || $faults_practitioners_practitioner_fault_id == "")
      {
          $faults_practitioners_practitioner_fault_id = "";
      }
      if (isset($faults_practitioners_practitioner_fault_id) && !empty($faults_practitioners_practitioner_fault_id))
      {
      ...
      if (!isset($faults_practitioners_practitioner_register_id) || $faults_practitioners_practitioner_register_id == "")
      {
          $faults_practitioners_practitioner_register_id = "";
      }
      if (isset($faults_practitioners_practitioner_register_id) && !empty($faults_practitioners_practitioner_register_id))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_faults_practitioners_fault_practitioner_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['faults_practitioners_fault_practitioner_id'])) ? $this->New_label['faults_practitioners_fault_practitioner_id'] : "Fault Practitioner Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_faults_practitioners_fault_practitioner_id_cond" name="faults_practitioners_fault_practitioner_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_fault_practitioner_id'), this, 'faults_practitioners_fault_practitioner_id')">
       <OPTION value="gt" <?php if ("gt" == $faults_practitioners_fault_practitioner_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $faults_practitioners_fault_practitioner_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $faults_practitioners_fault_practitioner_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_faults_practitioners_fault_practitioner_id" <?php echo $str_hide_faults_practitioners_fault_practitioner_id?> valign="top">
 ...
 $nmgp_tab_label .= "faults_practitioners_fault_practitioner_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_faults_practitioners_fault_practitioner_id" name="faults_practitioners_fault_practitioner_id" value="<?php echo NM_encode_input($faults_practitioners_fault_practitioner_id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_faults_practitioners_practitioner_fault_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['faults_practitioners_practitioner_fault_id'])) ? $this->New_label['faults_practitioners_practitioner_fault_id'] : "Practitioner Fault Id"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_faults_practitioners_practitioner_fault_id_cond" name="faults_practitioners_practitioner_fault_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_fault_id'), this, 'faults_practitioners_practitioner_fault_id')">
       <OPTION value="gt" <?php if ("gt" == $faults_practitioners_practitioner_fault_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $faults_practitioners_practitioner_fault_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $faults_practitioners_practitioner_fault_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_faults_practitioners_practitioner_fault_id" <?php echo $str_hide_faults_practitioners_practitioner_fault_id?> valign="top">
 ...
 $nmgp_tab_label .= "faults_practitioners_practitioner_fault_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_faults_practitioners_practitioner_fault_id" name="faults_practitioners_practitioner_fault_id" value="<?php echo NM_encode_input($faults_practitioners_practitioner_fault_id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_faults_practitioners_practitioner_register_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['faults_practitioners_practitioner_register_id'])) ? $this->New_label['faults_practitioners_practitioner_register_id'] : "Practitioner Register Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_faults_practitioners_practitioner_register_id_cond" name="faults_practitioners_practitioner_register_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_register_id'), this, 'faults_practitioners_practitioner_register_id')">
       <OPTION value="gt" <?php if ("gt" == $faults_practitioners_practitioner_register_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $faults_practitioners_practitioner_register_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $faults_practitioners_practitioner_register_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_faults_practitioners_practitioner_register_id" <?php echo $str_hide_faults_practitioners_practitioner_register_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "faults_practitioners_practitioner_register_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_faults_practitioners_practitioner_register_id" name="faults_practitioners_practitioner_register_id" value="<?php echo NM_encode_input($faults_practitioners_practitioner_register_id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_new_1_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_new_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_new_1']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.faults_practitioners_fault_practitioner_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_faults_practitioners_fault_practitioner_id'), document.F1.faults_practitioners_fault_practitioner_id_cond, 'faults_practitioners_fault_practitioner_id');
   document.F1.faults_practitioners_fault_practitioner_id.value = "";
   document.F1.faults_practitioners_practitioner_fault_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_fault_id'), document.F1.faults_practitioners_practitioner_fault_id_cond, 'faults_practitioners_practitioner_fault_id');
   document.F1.faults_practitioners_practitioner_fault_id.value = "";
   document.F1.faults_practitioners_practitioner_register_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_faults_practitioners_practitioner_register_id'), document.F1.faults_practitioners_practitioner_register_id_cond, 'faults_practitioners_practitioner_register_id');
   document.F1.faults_practitioners_practitioner_register_id.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_faults_practitioners_fault_practitioner_id_cond'] = 'cond';
      $tp_fields['SC_faults_practitioners_fault_practitioner_id'] = 'text';
      $tp_fields['SC_faults_practitioners_practitioner_fault_id_cond'] = 'cond';
      $tp_fields['SC_faults_practitioners_practitioner_fault_id'] = 'text';
      $tp_fields['SC_faults_practitioners_practitioner_register_id_cond'] = 'cond';
      $tp_fields['SC_faults_practitioners_practitioner_register_id'] = 'text';
   ...
   {
      global $faults_practitioners_fault_practitioner_id_cond, $faults_practitioners_fault_practitioner_id,
             $faults_practitioners_practitioner_fault_id_cond, $faults_practitioners_practitioner_fault_id,
             $faults_practitioners_practitioner_register_id_cond, $faults_practitioners_practitioner_register_id, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $faults_practitioners_fault_practitioner_id_cond_salva = $faults_practitioners_fault_practitioner_id_cond; 
      if (!isset($faults_practitioners_fault_practitioner_id_input_2) || $faults_practitioners_fault_practitioner_id_input_2 == "")
      {
          $faults_practitioners_fault_practitioner_id_input_2 = $faults_practitioners_fault_practitioner_id;
      }
      $faults_practitioners_practitioner_fault_id_cond_salva = $faults_practitioners_practitioner_fault_id_cond; 
      if (!isset($faults_practitioners_practitioner_fault_id_input_2) || $faults_practitioners_practitioner_fault_id_input_2 == "")
      {
          $faults_practitioners_practitioner_fault_id_input_2 = $faults_practitioners_practitioner_fault_id;
      }
      $faults_practitioners_practitioner_register_id_cond_salva = $faults_practitioners_practitioner_register_id_cond; 
      if (!isset($faults_practitioners_practitioner_register_id_input_2) || $faults_practitioners_practitioner_register_id_input_2 == "")
      {
          $faults_practitioners_practitioner_register_id_input_2 = $faults_practitioners_practitioner_register_id;
      }
      if ($faults_practitioners_fault_practitioner_id_cond != "in")
      {
          nm_limpa_numero($faults_practitioners_fault_practitioner_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($faults_practitioners_practitioner_fault_id_cond != "in")
      {
          nm_limpa_numero($faults_practitioners_practitioner_fault_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($faults_practitioners_practitioner_register_id_cond != "in")
      {
          nm_limpa_numero($faults_practitioners_practitioner_register_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_fault_practitioner_id'] = $faults_practitioners_fault_practitioner_id; 
      if (is_array($faults_practitioners_fault_practitioner_id) && !empty($faults_practitioners_fault_practitioner_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0] = $faults_practitioners_fault_practitioner_id;
      }
      elseif ($faults_practitioners_fault_practitioner_id_cond_salva == "nu" || $faults_practitioners_fault_practitioner_id_cond_salva == "nn" || $faults_practitioners_fault_practitioner_id_cond_salva == "ep" || $faults_practitioners_fault_practitioner_id_cond_salva == "ne" || !empty($faults_practitioners_fault_practitioner_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0][0] = $faults_practitioners_fault_practitioner_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_fault_practitioner_id_cond'] = $faults_practitioners_fault_practitioner_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['cmp'] = "faults_practitioners_fault_practitioner_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['opc'] = $faults_practitioners_fault_practitioner_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq']['faults_practitioners_fault_practitioner_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_fault_id'] = $faults_practitioners_practitioner_fault_id; 
      if (is_array($faults_practitioners_practitioner_fault_id) && !empty($faults_practitioners_practitioner_fault_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0] = $faults_practitioners_practitioner_fault_id;
      }
      elseif ($faults_practitioners_practitioner_fault_id_cond_salva == "nu" || $faults_practitioners_practitioner_fault_id_cond_salva == "nn" || $faults_practitioners_practitioner_fault_id_cond_salva == "ep" || $faults_practitioners_practitioner_fault_id_cond_salva == "ne" || !empty($faults_practitioners_practitioner_fault_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0][0] = $faults_practitioners_practitioner_fault_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_fault_id_cond'] = $faults_practitioners_practitioner_fault_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['cmp'] = "faults_practitioners_practitioner_fault_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['opc'] = $faults_practitioners_practitioner_fault_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq']['faults_practitioners_practitioner_fault_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_register_id'] = $faults_practitioners_practitioner_register_id; 
      if (is_array($faults_practitioners_practitioner_register_id) && !empty($faults_practitioners_practitioner_register_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0] = $faults_practitioners_practitioner_register_id;
      }
      elseif ($faults_practitioners_practitioner_register_id_cond_salva == "nu" || $faults_practitioners_practitioner_register_id_cond_salva == "nn" || $faults_practitioners_practitioner_register_id_cond_salva == "ep" || $faults_practitioners_practitioner_register_id_cond_salva == "ne" || !empty($faults_practitioners_practitioner_register_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['val'][0][0] = $faults_practitioners_practitioner_register_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['faults_practitioners_practitioner_register_id_cond'] = $faults_practitioners_practitioner_register_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['cmp'] = "faults_practitioners_practitioner_register_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid]['opc'] = $faults_practitioners_practitioner_register_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['grid_pesq']['faults_practitioners_practitioner_register_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $faults_practitioners_fault_practitioner_id;
      if (strtoupper($faults_practitioners_fault_practitioner_id_cond) != "II" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "QP" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "NP" && strtoupper($faults_practitioners_fault_practitioner_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['faults_practitioners_fault_practitioner_id'] = $Conteudo;
      $Conteudo = $faults_practitioners_practitioner_fault_id;
      if (strtoupper($faults_practitioners_practitioner_fault_id_cond) != "II" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "QP" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "NP" && strtoupper($faults_practitioners_practitioner_fault_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['faults_practitioners_practitioner_fault_id'] = $Conteudo;
      $Conteudo = $faults_practitioners_practitioner_register_id;
      if (strtoupper($faults_practitioners_practitioner_register_id_cond) != "II" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "QP" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "NP" && strtoupper($faults_practitioners_practitioner_register_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['faults_practitioners_practitioner_register_id'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($faults_practitioners_fault_practitioner_id) || $faults_practitioners_fault_practitioner_id_cond == "nu" || $faults_practitioners_fault_practitioner_id_cond == "nn" || $faults_practitioners_fault_practitioner_id_cond == "ep" || $faults_practitioners_fault_practitioner_id_cond == "ne")
      {
         $this->monta_condicao("faults_practitioners.fault_practitioner_id", $faults_practitioners_fault_practitioner_id_cond, $faults_practitioners_fault_practitioner_id, "", "faults_practitioners_fault_practitioner_id", "SMALLINT", false);
      }

      //----- $faults_practitioners_practitioner_fault_id
      $this->Date_part = false;
      if (isset($faults_practitioners_practitioner_fault_id) || $faults_practitioners_practitioner_fault_id_cond == "nu" || $faults_practitioners_practitioner_fault_id_cond == "nn" || $faults_practitioners_practitioner_fault_id_cond == "ep" || $faults_practitioners_practitioner_fault_id_cond == "ne")
      {
         $this->monta_condicao("faults_practitioners.practitioner_fault_id", $faults_practitioners_practitioner_fault_id_cond, $faults_practitioners_practitioner_fault_id, "", "faults_practitioners_practitioner_fault_id", "SMALLINT", false);
      }

      //----- $faults_practitioners_practitioner_register_id
      $this->Date_part = false;
      if (isset($faults_practitioners_practitioner_register_id) || $faults_practitioners_practitioner_register_id_cond == "nu" || $faults_practitioners_practitioner_register_id_cond == "nn" || $faults_practitioners_practitioner_register_id_cond == "ep" || $faults_practitioners_practitioner_register_id_cond == "ne")
      {
         $this->monta_condicao("faults_practitioners.practitioner_register_id", $faults_practitioners_practitioner_register_id_cond, $faults_practitioners_practitioner_register_id, "", "faults_practitioners_practitioner_register_id", "SMALLINT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_new_1']['cond_pesq'] .= $this->NM_operador;
