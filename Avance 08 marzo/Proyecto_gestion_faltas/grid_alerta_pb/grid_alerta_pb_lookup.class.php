...
{
//  
   function lookup_practitioners_practitioner_id(&$conteudo , $practitioners_practitioner_id) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $practitioners_practitioner_id; 
      ...
      if (trim($practitioners_practitioner_id) === "" || trim($practitioners_practitioner_id) == "&nbsp;")
      { 
          $conteudo = "&nbsp;";
          $save_conteudo  = ""; 
          $save_conteudo1 = ""; 
      ...
      $nm_comando = "select practitioner_id from practitioners where practitioner_id = $practitioners_practitioner_id order by practitioner_id" ; 
      $conteudo = "" ; 
...
//  
   function lookup_sc_field_0(&$conteudo , $sc_field_0, &$nm_array_retorno_lookup) 
   {
      ...
      $conteudo = "";
      $nm_comando = "SELECT benefit_id 
FROM benefits_practitioners 
WHERE benefit_id = '$sc_field_0' 
ORDER BY benefit_id" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
