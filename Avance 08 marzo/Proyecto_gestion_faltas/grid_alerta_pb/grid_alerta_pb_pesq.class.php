...
class grid_alerta_pb_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_alerta_pb_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_alerta_pb_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_alerta_pb_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_alerta_pb/grid_alerta_pb_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_alerta_pb_ajax_search.js"></script>
 <script type="text/javascript" src="grid_alerta_pb_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_alerta_pb_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_alerta_pb']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_alerta_pb']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_practitioners_area_id_cond#NMF#' + search_get_sel_txt('SC_practitioners_area_id_cond') + '@NMF@';
  str_out += 'SC_practitioners_area_id#NMF#' + search_get_text('SC_practitioners_area_id') + '@NMF@';
  str_out += 'SC_practitioners_division_id_cond#NMF#' + search_get_sel_txt('SC_practitioners_division_id_cond') + '@NMF@';
  str_out += 'SC_practitioners_division_id#NMF#' + search_get_text('SC_practitioners_division_id') + '@NMF@';
  str_out += 'SC_practitioners_general_id_cond#NMF#' + search_get_sel_txt('SC_practitioners_general_id_cond') + '@NMF@';
  str_out += 'SC_practitioners_general_id#NMF#' + search_get_text('SC_practitioners_general_id') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $practitioners_area_id_cond, $practitioners_area_id,
             $practitioners_division_id_cond, $practitioners_division_id,
             $practitioners_general_id_cond, $practitioners_general_id,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $practitioners_practitioner_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_practitioner_id']; 
          $practitioners_practitioner_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_practitioner_id_cond']; 
          $practitioners_area_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_area_id']; 
          $practitioners_area_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_area_id_cond']; 
          $practitioners_division_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_division_id']; 
          $practitioners_division_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_division_id_cond']; 
          $practitioners_general_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_general_id']; 
          $practitioners_general_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_general_id_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($practitioners_area_id_cond) != "II" && strtoupper($practitioners_area_id_cond) != "QP" && strtoupper($practitioners_area_id_cond) != "NP" && strtoupper($practitioners_area_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($practitioners_area_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($practitioners_division_id_cond) != "II" && strtoupper($practitioners_division_id_cond) != "QP" && strtoupper($practitioners_division_id_cond) != "NP" && strtoupper($practitioners_division_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($practitioners_division_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($practitioners_general_id_cond) != "II" && strtoupper($practitioners_general_id_cond) != "QP" && strtoupper($practitioners_general_id_cond) != "NP" && strtoupper($practitioners_general_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($practitioners_general_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($practitioners_area_id_cond) || empty($practitioners_area_id_cond))
      {
         $practitioners_area_id_cond = "gt";
      }
      if (!isset($practitioners_division_id_cond) || empty($practitioners_division_id_cond))
      {
         $practitioners_division_id_cond = "gt";
      }
      if (!isset($practitioners_general_id_cond) || empty($practitioners_general_id_cond))
      {
         $practitioners_general_id_cond = "gt";
      }
      ...
      $str_hide_practitioners_area_id = (in_array($practitioners_area_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_practitioners_division_id = (in_array($practitioners_division_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_practitioners_general_id = (in_array($practitioners_general_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($practitioners_area_id) || $practitioners_area_id == "")
      {
          $practitioners_area_id = "";
      }
      if (isset($practitioners_area_id) && !empty($practitioners_area_id))
      {
         $tmp_pos = (is_string($practitioners_area_id)) ? strpos($practitioners_area_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $practitioners_area_id = substr($practitioners_area_id, 0, $tmp_pos);
         }
      }
      if (!isset($practitioners_division_id) || $practitioners_division_id == "")
      {
          $practitioners_division_id = "";
      }
      if (isset($practitioners_division_id) && !empty($practitioners_division_id))
      {
         $tmp_pos = (is_string($practitioners_division_id)) ? strpos($practitioners_division_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $practitioners_division_id = substr($practitioners_division_id, 0, $tmp_pos);
         }
      }
      if (!isset($practitioners_general_id) || $practitioners_general_id == "")
      {
          $practitioners_general_id = "";
      }
      if (isset($practitioners_general_id) && !empty($practitioners_general_id))
      {
         $tmp_pos = (is_string($practitioners_general_id)) ? strpos($practitioners_general_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $practitioners_general_id = substr($practitioners_general_id, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_practitioners_practitioner_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['practitioners_practitioner_id'])) ? $this->New_label['practitioners_practitioner_id'] : "Nombre y apellido"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_practitioners_practitioner_id_cond" name="practitioners_practitioner_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_practitioners_practitioner_id'), this, 'practitioners_practitioner_id')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_practitioners_practitioner_id" <?php echo $str_hide_practitioners_practitioner_id?> valign="top">
...
<INPUT  type="text" id="SC_practitioners_practitioner_id" name="practitioners_practitioner_id" value="<?php echo NM_encode_input($practitioners_practitioner_id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_practitioners_area_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['practitioners_area_id'])) ? $this->New_label['practitioners_area_id'] : "Área"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_practitioners_area_id_cond" name="practitioners_area_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_practitioners_area_id'), this, 'practitioners_area_id')">
       <OPTION value="gt" <?php if ("gt" == $practitioners_area_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $practitioners_area_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $practitioners_area_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_practitioners_area_id" <?php echo $str_hide_practitioners_area_id?> valign="top">
 ...
 $nmgp_tab_label .= "practitioners_area_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_practitioners_area_id" name="practitioners_area_id" value="<?php echo NM_encode_input($practitioners_area_id) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_practitioners_division_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['practitioners_division_id'])) ? $this->New_label['practitioners_division_id'] : "Division Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_practitioners_division_id_cond" name="practitioners_division_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_practitioners_division_id'), this, 'practitioners_division_id')">
       <OPTION value="gt" <?php if ("gt" == $practitioners_division_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $practitioners_division_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $practitioners_division_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_practitioners_division_id" <?php echo $str_hide_practitioners_division_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['practitioners_division_id'])) ? $this->New_label['practitioners_division_id'] : "Division Id";
 $nmgp_tab_label .= "practitioners_division_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_practitioners_division_id" name="practitioners_division_id" value="<?php echo NM_encode_input($practitioners_division_id) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_practitioners_general_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['practitioners_general_id'])) ? $this->New_label['practitioners_general_id'] : "General Id"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_practitioners_general_id_cond" name="practitioners_general_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_practitioners_general_id'), this, 'practitioners_general_id')">
       <OPTION value="gt" <?php if ("gt" == $practitioners_general_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $practitioners_general_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $practitioners_general_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_practitioners_general_id" <?php echo $str_hide_practitioners_general_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['practitioners_general_id'])) ? $this->New_label['practitioners_general_id'] : "General Id";
 $nmgp_tab_label .= "practitioners_general_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_practitioners_general_id" name="practitioners_general_id" value="<?php echo NM_encode_input($practitioners_general_id) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_alerta_pb_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_alerta_pb']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_alerta_pb']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.practitioners_area_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_practitioners_area_id'), document.F1.practitioners_area_id_cond, 'practitioners_area_id');
   document.F1.practitioners_area_id.value = "";
   document.F1.practitioners_division_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_practitioners_division_id'), document.F1.practitioners_division_id_cond, 'practitioners_division_id');
   document.F1.practitioners_division_id.value = "";
   document.F1.practitioners_general_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_practitioners_general_id'), document.F1.practitioners_general_id_cond, 'practitioners_general_id');
   document.F1.practitioners_general_id.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_practitioners_area_id_cond'] = 'cond';
      $tp_fields['SC_practitioners_area_id'] = 'text';
      $tp_fields['SC_practitioners_division_id_cond'] = 'cond';
      $tp_fields['SC_practitioners_division_id'] = 'text';
      $tp_fields['SC_practitioners_general_id_cond'] = 'cond';
      $tp_fields['SC_practitioners_general_id'] = 'text';
   ...
   {
      global $practitioners_practitioner_id_cond, $practitioners_practitioner_id,
             $practitioners_area_id_cond, $practitioners_area_id,
             $practitioners_division_id_cond, $practitioners_division_id,
             $practitioners_general_id_cond, $practitioners_general_id, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $practitioners_area_id_cond_salva = $practitioners_area_id_cond; 
      if (!isset($practitioners_area_id_input_2) || $practitioners_area_id_input_2 == "")
      {
          $practitioners_area_id_input_2 = $practitioners_area_id;
      }
      $practitioners_division_id_cond_salva = $practitioners_division_id_cond; 
      if (!isset($practitioners_division_id_input_2) || $practitioners_division_id_input_2 == "")
      {
          $practitioners_division_id_input_2 = $practitioners_division_id;
      }
      $practitioners_general_id_cond_salva = $practitioners_general_id_cond; 
      if (!isset($practitioners_general_id_input_2) || $practitioners_general_id_input_2 == "")
      {
          $practitioners_general_id_input_2 = $practitioners_general_id;
      }
      ...
      if ($practitioners_area_id_cond != "in")
      {
          nm_limpa_numero($practitioners_area_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($practitioners_division_id_cond != "in")
      {
          nm_limpa_numero($practitioners_division_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($practitioners_general_id_cond != "in")
      {
          nm_limpa_numero($practitioners_general_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_practitioner_id'] = $practitioners_practitioner_id; 
      if (is_array($practitioners_practitioner_id) && !empty($practitioners_practitioner_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0] = $practitioners_practitioner_id;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0][0] = $practitioners_practitioner_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_practitioner_id_cond'] = $practitioners_practitioner_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['cmp'] = "practitioners_practitioner_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['opc'] = $practitioners_practitioner_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq']['practitioners_practitioner_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_area_id'] = $practitioners_area_id; 
      if (is_array($practitioners_area_id) && !empty($practitioners_area_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0] = $practitioners_area_id;
      }
      elseif ($practitioners_area_id_cond_salva == "nu" || $practitioners_area_id_cond_salva == "nn" || $practitioners_area_id_cond_salva == "ep" || $practitioners_area_id_cond_salva == "ne" || !empty($practitioners_area_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0][0] = $practitioners_area_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_area_id_cond'] = $practitioners_area_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['cmp'] = "practitioners_area_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['opc'] = $practitioners_area_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq']['practitioners_area_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_division_id'] = $practitioners_division_id; 
      if (is_array($practitioners_division_id) && !empty($practitioners_division_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0] = $practitioners_division_id;
      }
      elseif ($practitioners_division_id_cond_salva == "nu" || $practitioners_division_id_cond_salva == "nn" || $practitioners_division_id_cond_salva == "ep" || $practitioners_division_id_cond_salva == "ne" || !empty($practitioners_division_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0][0] = $practitioners_division_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_division_id_cond'] = $practitioners_division_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['cmp'] = "practitioners_division_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['opc'] = $practitioners_division_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq']['practitioners_division_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_general_id'] = $practitioners_general_id; 
      if (is_array($practitioners_general_id) && !empty($practitioners_general_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0] = $practitioners_general_id;
      }
      elseif ($practitioners_general_id_cond_salva == "nu" || $practitioners_general_id_cond_salva == "nn" || $practitioners_general_id_cond_salva == "ep" || $practitioners_general_id_cond_salva == "ne" || !empty($practitioners_general_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['val'][0][0] = $practitioners_general_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['practitioners_general_id_cond'] = $practitioners_general_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['cmp'] = "practitioners_general_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid]['opc'] = $practitioners_general_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['grid_pesq']['practitioners_general_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $practitioners_area_id;
      if (strtoupper($practitioners_area_id_cond) != "II" && strtoupper($practitioners_area_id_cond) != "QP" && strtoupper($practitioners_area_id_cond) != "NP" && strtoupper($practitioners_area_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['practitioners_area_id'] = $Conteudo;
      $Conteudo = $practitioners_division_id;
      if (strtoupper($practitioners_division_id_cond) != "II" && strtoupper($practitioners_division_id_cond) != "QP" && strtoupper($practitioners_division_id_cond) != "NP" && strtoupper($practitioners_division_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['practitioners_division_id'] = $Conteudo;
      $Conteudo = $practitioners_general_id;
      if (strtoupper($practitioners_general_id_cond) != "II" && strtoupper($practitioners_general_id_cond) != "QP" && strtoupper($practitioners_general_id_cond) != "NP" && strtoupper($practitioners_general_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['practitioners_general_id'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $practitioners_area_id
      $this->Date_part = false;
      if (isset($practitioners_area_id) || $practitioners_area_id_cond == "nu" || $practitioners_area_id_cond == "nn" || $practitioners_area_id_cond == "ep" || $practitioners_area_id_cond == "ne")
      {
         $this->monta_condicao("practitioners.area_id", $practitioners_area_id_cond, $practitioners_area_id, "", "practitioners_area_id", "TINYINT", false);
      }

      //----- $practitioners_division_id
      $this->Date_part = false;
      if (isset($practitioners_division_id) || $practitioners_division_id_cond == "nu" || $practitioners_division_id_cond == "nn" || $practitioners_division_id_cond == "ep" || $practitioners_division_id_cond == "ne")
      {
         $this->monta_condicao("practitioners.division_id", $practitioners_division_id_cond, $practitioners_division_id, "", "practitioners_division_id", "TINYINT", false);
      }

      //----- $practitioners_general_id
      $this->Date_part = false;
      if (isset($practitioners_general_id) || $practitioners_general_id_cond == "nu" || $practitioners_general_id_cond == "nn" || $practitioners_general_id_cond == "ep" || $practitioners_general_id_cond == "ne")
      {
         $this->monta_condicao("practitioners.general_id", $practitioners_general_id_cond, $practitioners_general_id, "", "practitioners_general_id", "SMALLINT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alerta_pb']['cond_pesq'] .= $this->NM_operador;
