<?php
@session_start() ;
$_SESSION['scriptcase']['grid_alerta_pb']['sc_process_barr'] = true;
require_once('../grid_alerta_pb/index.php');
unset($_SESSION['scriptcase']['grid_alerta_pb']['sc_process_barr']);
$ExportCtrl = new grid_alerta_pb_export_control;
$ExportCtrl->Export_barr();

class grid_alerta_pb_export_control
{
