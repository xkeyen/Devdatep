...
<?php
   ...
   $Ord_Cmp = new Grid_faltas_en_cola_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Grid_faltas_en_cola_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['nombre_apellido'] = "nombre_apellido";
   }
   else
   {
       $tab_def_campos['nombre_apellido'] = "g1.general_name";
   }
   $tab_labels["nombre_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["nombre_apellido"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["nombre_apellido"] : "Nombre Apellido";
   ...
   $tab_labels["desc_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["desc_falta"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["desc_falta"] : "Desc Falta";
   $tab_ger_campos['tipo_de_falta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipo_de_falta'] = "tipo_de_falta";
   }
   else
   {
       $tab_def_campos['tipo_de_falta'] = "ft.fault_type_description";
   }
   $tab_labels["tipo_de_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["tipo_de_falta"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["tipo_de_falta"] : "Tipo De Falta";
   $tab_ger_campos['fecha_f'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fecha_f'] = "fecha_f";
   }
   else
   {
       $tab_def_campos['fecha_f'] = "f.sanction_date";
   }
   $tab_labels["fecha_f"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["fecha_f"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["fecha_f"] : "Fecha F";
   ...
   {
       $tab_def_campos['sc_field_0'] = "st.sanction_type_name";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["sc_field_0"] : "Sanción";
   ...
   {
       $tab_def_campos['estado'] = "ss.sanction_description";
   }
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['labels']["estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Grid_faltas_en_cola_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Grid_faltas_en_cola']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
