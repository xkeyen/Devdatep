<?php
@session_start() ;
$_SESSION['scriptcase']['Grid_faltas_en_cola']['sc_process_barr'] = true;
require_once('../Grid_faltas_en_cola/index.php');
unset($_SESSION['scriptcase']['Grid_faltas_en_cola']['sc_process_barr']);
$ExportCtrl = new Grid_faltas_en_cola_export_control;
$ExportCtrl->Export_barr();

class Grid_faltas_en_cola_export_control
{
