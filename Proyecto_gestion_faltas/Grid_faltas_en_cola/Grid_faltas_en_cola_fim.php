...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____Grid_faltas_en_cola"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____Grid_faltas_en_cola"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Grid_faltas_en_cola</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Grid_faltas_en_cola']['embutida_filho'] as $ind => $sc_init)
          {
