<?php  
  ...
  session_start() ;
  class Grid_faltas_en_cola_form_teste
  {
  function Grid_faltas_en_cola_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">Grid_faltas_en_cola</FONT></B> 
<br> 
<br> 
...
<input type=submit value="Grid_faltas_en_cola"> 
</form> 
...
<?php
  ...
  $frm_teste = new Grid_faltas_en_cola_form_teste();
  $frm_teste->Grid_faltas_en_cola_teste();
?>
