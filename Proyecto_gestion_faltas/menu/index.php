...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_faults_practitioners_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_faults_practitioners_ini.php");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_faults_practitioners']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_faults_practitioners'] = "on";
        }
    }
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Grid_faltas_en_cola_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Grid_faltas_en_cola_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Grid_faltas_en_cola']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['Grid_faltas_en_cola'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_faults_practitioners']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_faults_practitioners']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menu_menuData['data']['itens']['item_1']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_faults_practitioners&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-plus",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Grid_faltas_en_cola']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Grid_faltas_en_cola']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menu_menuData['data']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=Grid_faltas_en_cola&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
function menu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"dark-rhino","layout":"V","header_string":"Consulta de faltas","header_string_pos":"H","check_split":"S","check_toolbar":"S","check_show_search_path":"S","check_shortcut_label":"S","check_start_expanded":"S","check_use_loader":"N","should_reload":"S","layout_usr_pos":"out","usercheck":"S","username":"","userimage":"","userdesc":"","logo":"..\/_lib\/img\/grp__NM__bg__NM__Logo-046c5013.png","logo_compact":"..\/_lib\/img\/grp__NM__bg__NM__Logo-046c5013.png","pick_themes":["dark-cobalt","dark-coffee","dark-sunset","dark-rhino","dark-pink","dark-hyper-space","dark-midnight","light-gray"],"shortcuts":[],"items":[{"text":"Consulta de faltas","app":"","icon":"fas fa-info-circle","icon_check":"S","id":"item_1","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Registro de faltas","app":"grid_faults_practitioners","icon":"fas fa-plus","icon_check":"S","id":"item_2","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Resumen","app":"","icon":"fas fa-chart-bar","icon_check":"S","id":"item_3","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"},{"text":"Faltas en cola","app":"Grid_faltas_en_cola","icon":"fab fa-stripe-s","icon_check":"S","id":"item_4","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Alerta acumulaci\u00f3n de faltas","app":"","icon":"fas fa-bell","icon_check":"S","id":"item_5","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Actividad","app":"","icon":"fas fa-pen-square","icon_check":"S","id":"item_6","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"user_items":[{"text":"Perfil","app":"","icon":"far fa-user","icon_check":"S","id":"item_user_1","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"},{"text":"Ajustes","app":"","icon":"fas fa-cog","icon_check":"S","id":"item_user_2","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"},{"text":"FAQ","app":"","icon":"far fa-question-circle","icon_check":"S","id":"item_user_3","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"},{"text":"Salir","app":"","icon":"fas fa-power-off","icon_check":"S","id":"item_user_4","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"}],"tb_items":[{"text":"B\u00fasqueda","app":"search","icon":"fas fa-search","icon_check":"S","display":"S","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"S","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"S","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Atajos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"S","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"}]}', true);
      ...
      <section class="ae-menubar menubar" role="toolbar" aria-orientation="vertical" tabindex="0" data-aetheme="dark-rhino">
        <div class="wrapper-header">
          <div class="logo"><a id="sc-menu-link-home" href="./"><span class="only-sr">Scriptcase menubar home </span><img
                class="d-block" src="<?php echo "../_lib/img/grp__NM__bg__NM__Logo-046c5013.png"; ?>" aria-hidden="true" /><img
                class="d-none" src="<?php echo "../_lib/img/grp__NM__bg__NM__Logo-046c5013.png"; ?>" aria-hidden="true" /></a></div>
