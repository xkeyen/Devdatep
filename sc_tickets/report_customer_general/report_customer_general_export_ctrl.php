<?php
@session_start() ;
$_SESSION['scriptcase']['report_customer_general']['sc_process_barr'] = true;
require_once('../report_customer_general/index.php');
unset($_SESSION['scriptcase']['report_customer_general']['sc_process_barr']);
$ExportCtrl = new report_customer_general_export_control;
$ExportCtrl->Export_barr();

class report_customer_general_export_control
{
