   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_customer_general.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_customer_general"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_customer_general"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_customer_general']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_customer_general']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_customer_general']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_customer_general']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_customer_general']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_customer_general</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_customer_general']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_customer_general']['embutida_filho'] as $ind => $sc_init)
          {
