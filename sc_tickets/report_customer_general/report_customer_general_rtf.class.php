...
class report_customer_general_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "report_customer_general.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_name']);
      }
   ...
   function NM_export_customerpassword()
   {
         ...
         $this->customerpassword = str_replace('<', '&lt;', $this->customerpassword);
         $this->customerpassword = str_replace('>', '&gt;', $this->customerpassword);
         $this->Texto_tag .= "<td>" . $this->customerpassword . "</td>\r\n";
   }
   //----- customertype
   function NM_export_customertype()
   {
         ...
         $this->customertype = str_replace('<', '&lt;', $this->customertype);
         $this->customertype = str_replace('>', '&gt;', $this->customertype);
         $this->Texto_tag .= "<td>" . $this->customertype . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_customer_general'] ?> :: RTF</TITLE>
