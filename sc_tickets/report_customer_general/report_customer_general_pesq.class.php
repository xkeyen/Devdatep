...
class report_customer_general_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . report_customer_general_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . report_customer_general_pack_protect_string($Tipo_filter[0]) . "\">.." . report_customer_general_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "report_customer_general.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_customer_general'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>report_customer_general/report_customer_general_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="report_customer_general_ajax_search.js"></script>
 <script type="text/javascript" src="report_customer_general_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="report_customer_general_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_customer_general']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_customer_general']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_customername_cond#NMF#' + search_get_sel_txt('SC_customername_cond') + '@NMF@';
  str_out += 'SC_customername#NMF#' + search_get_text('SC_customername') + '@NMF@';
  ...
  str_out += 'SC_customertype_cond#NMF#' + search_get_sel_txt('SC_customertype_cond') + '@NMF@';
  str_out += 'SC_customertype#NMF#' + search_get_text('SC_customertype') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="report_customer_general.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="nmgp_opcao" value="busca"> 
 <div id="idJSSpecChar" style="display:none;"></div>
 <div id="id_div_process" style="display: none; position: absolute"><table class="scFilterTable"><tr><td class="scFilterLabelOdd"><?php echo $this->Ini->Nm_lang['lang_othr_prcs']; ?>...</td></tr></table></div>
 <div id="id_fatal_error" class="scFilterFieldOdd" style="display:none; position: absolute"></div>
<TABLE id="main_table" align="center" valign="top" width="600px">
<tr>
<td>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $customername_cond, $customername,
             $customeremail_cond, $customeremail,
             $customertype_cond, $customertype,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $customerid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customerid']; 
          $customerid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customerid_cond']; 
          $customername = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customername']; 
          $customername_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customername_cond']; 
          $customeremail = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customeremail']; 
          $customeremail_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customeremail_cond']; 
          $customertype = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customertype']; 
          $customertype_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customertype_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['NM_operador']; 
      ...
      if (!isset($customername_cond) || empty($customername_cond))
      {
         $customername_cond = "qp";
      }
      if (!isset($customeremail_cond) || empty($customeremail_cond))
      {
         $customeremail_cond = "qp";
      }
      if (!isset($customertype_cond) || empty($customertype_cond))
      {
         $customertype_cond = "eq";
      }
      ...
      $str_hide_customername = (in_array($customername_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customeremail = (in_array($customeremail_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customertype = (in_array($customertype_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($customerid)) ? strpos($customerid, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($customername)) ? strpos($customername, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $customername = substr($customername, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($customertype) || $customertype == "")
      {
          $customertype = "";
      }
      if (isset($customertype) && !empty($customertype))
      {
         $tmp_pos = (is_string($customertype)) ? strpos($customertype, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $customertype = substr($customertype, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_customerid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['customerid'])) ? $this->New_label['customerid'] : "" . $this->Ini->Nm_lang['lang_customer_fild_customerid'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_customerid" name="customerid" value="<?php echo NM_encode_input($customerid) ?>" size=4 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_customername_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['customername'])) ? $this->New_label['customername'] : "" . $this->Ini->Nm_lang['lang_customer_fild_customername'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_customername_cond" name="customername_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customername" <?php echo $str_hide_customername?> valign="top">
 ...
 $nmgp_tab_label .= "customername?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_customername" name="customername" value="<?php echo NM_encode_input($customername) ?>"  size=35 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_customeremail_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['customeremail'])) ? $this->New_label['customeremail'] : "" . $this->Ini->Nm_lang['lang_customer_fild_customeremail'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_customeremail_cond" name="customeremail_cond" value="qp">
...
?>
<INPUT  type="text" id="SC_customeremail" name="customeremail" value="<?php echo NM_encode_input($customeremail) ?>"  size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_customertype_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['customertype'])) ? $this->New_label['customertype'] : "CustomerType"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customertype_cond" name="customertype_cond" onChange="nm_campos_between(document.getElementById('id_vis_customertype'), this, 'customertype')">
       <OPTION value="eq" <?php if ("eq" == $customertype_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $customertype_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $customertype_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $customertype_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customertype" <?php echo $str_hide_customertype?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['customertype'])) ? $this->New_label['customertype'] : "CustomerType";
 $nmgp_tab_label .= "customertype?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_customertype" name="customertype" value="<?php echo NM_encode_input($customertype) ?>"  size=7 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("report_customer_general_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_customer_general']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['report_customer_general']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="report_customer_general.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['orig_pesq'] == "grid")
   {
...
?>
 function nm_move()
 {
     ...
     document.form_cancel.action = "report_customer_general.php"; 
 ...
 function limpa_form()
 {
   ...
   document.F1.customerid_cond.value = 'eq';
   ...
   document.F1.customername_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_customername'), document.F1.customername_cond, 'customername');
   document.F1.customername.value = "";
   document.F1.customeremail_cond.value = 'qp';
   ...
   document.F1.customertype_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_customertype'), document.F1.customertype_cond, 'customertype');
   document.F1.customertype.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "sc_tickets/report_customer_general";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "report_customer_general/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_customername_cond'] = 'cond';
      $tp_fields['SC_customername'] = 'text';
      $tp_fields['SC_customeremail_cond'] = 'cond';
      $tp_fields['SC_customeremail'] = 'text';
      $tp_fields['SC_customertype_cond'] = 'cond';
      $tp_fields['SC_customertype'] = 'text';
   ...
   {
      global $customerid_cond, $customerid,
             $customername_cond, $customername,
             $customeremail_cond, $customeremail,
             $customertype_cond, $customertype, $nmgp_tab_label;
      ...
      $customername_cond_salva = $customername_cond; 
      if (!isset($customername_input_2) || $customername_input_2 == "")
      {
          $customername_input_2 = $customername;
      }
      ...
      $customertype_cond_salva = $customertype_cond; 
      if (!isset($customertype_input_2) || $customertype_input_2 == "")
      {
          $customertype_input_2 = $customertype;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customerid'] = $customerid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customerid_cond'] = $customerid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customername'] = $customername; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customername_cond'] = $customername_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customeremail'] = $customeremail; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customeremail_cond'] = $customeremail_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customertype'] = $customertype; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['customertype_cond'] = $customertype_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $customername;
      $this->cmp_formatado['customername'] = $Conteudo;
      $Conteudo = $customeremail;
      $this->cmp_formatado['customeremail'] = $Conteudo;
      $Conteudo = $customertype;
      $this->cmp_formatado['customertype'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      {
         $this->monta_condicao("customerid", $customerid_cond, $customerid, "", "customerid", "INT", false);
      }

      //----- $customername
      $this->Date_part = false;
      if (isset($customername) || $customername_cond == "nu" || $customername_cond == "nn" || $customername_cond == "ep" || $customername_cond == "ne")
      {
         $this->monta_condicao("customername", $customername_cond, $customername, "", "customername", "VARCHAR", false);
      }
      ...
      //----- $customertype
      $this->Date_part = false;
      if (isset($customertype) || $customertype_cond == "nu" || $customertype_cond == "nn" || $customertype_cond == "ep" || $customertype_cond == "ne")
      {
         $this->monta_condicao("customertype", $customertype_cond, $customertype, "", "customertype", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_customer_general']['where_pesq'];
