<?php  
  ...
  session_start() ;
  class grid_customer_ticket_flow_form_teste
  {
  function grid_customer_ticket_flow_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_customer_ticket_flow</FONT></B> 
<br> 
<br> 
...
v_trackingid&nbsp;&nbsp;<input type=text name="v_trackingid" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_customer_ticket_flow"> 
</form> 
<script language=javascript> 
 document.FCons.v_ticketid.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_customer_ticket_flow_form_teste();
  $frm_teste->grid_customer_ticket_flow_teste();
?>
