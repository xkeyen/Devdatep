<?php
@session_start() ;
$_SESSION['scriptcase']['grid_canned_message']['sc_process_barr'] = true;
require_once('../grid_canned_message/index.php');
unset($_SESSION['scriptcase']['grid_canned_message']['sc_process_barr']);
$ExportCtrl = new grid_canned_message_export_control;
$ExportCtrl->Export_barr();

class grid_canned_message_export_control
{
