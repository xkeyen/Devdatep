   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_tickets_unassigned.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_tickets_unassigned"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_tickets_unassigned"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tickets_unassigned</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tickets_unassigned']['embutida_filho'] as $ind => $sc_init)
          {
