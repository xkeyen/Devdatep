...
class grid_kb_articles_search_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_kb_articles_search_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_kb_articles_search_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_kb_articles_search_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "articlesid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "articleview";$Nm_numeric[] = "votesqty";$Nm_numeric[] = "votestotal";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_kb_articles_search.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tble_kb_articles'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_kb_articles_search/grid_kb_articles_search_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_kb_articles_search_ajax_search.js"></script>
 <script type="text/javascript" src="grid_kb_articles_search_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_kb_articles_search_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kb_articles_search']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kb_articles_search']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_articlesubject_cond#NMF#' + search_get_sel_txt('SC_articlesubject_cond') + '@NMF@';
  str_out += 'SC_articlesubject#NMF#' + search_get_text('SC_articlesubject') + '@NMF@';
  str_out += 'SC_articlecontent_cond#NMF#' + search_get_sel_txt('SC_articlecontent_cond') + '@NMF@';
  str_out += 'SC_articlecontent#NMF#' + search_get_text('SC_articlecontent') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_kb_articles_search.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_tble_kb_articles'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $articlesubject_cond, $articlesubject,
             $articlecontent_cond, $articlecontent,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['categoryid']; 
          $categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['categoryid_cond']; 
          $articlesubject = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlesubject']; 
          $articlesubject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlesubject_cond']; 
          $articlecontent = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlecontent']; 
          $articlecontent_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlecontent_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['NM_operador']; 
      } 
      if (!isset($categoryid_cond) || empty($categoryid_cond))
      {
         $categoryid_cond = "eq";
      }
      if (!isset($articlesubject_cond) || empty($articlesubject_cond))
      {
         $articlesubject_cond = "qp";
      }
      if (!isset($articlecontent_cond) || empty($articlecontent_cond))
      {
         $articlecontent_cond = "qp";
      }
      ...
      $str_hide_articlesubject = (in_array($articlesubject_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_articlecontent = (in_array($articlecontent_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($articlesubject) || $articlesubject == "")
      {
          $articlesubject = "";
      }
      if (isset($articlesubject) && !empty($articlesubject))
      {
         $tmp_pos = (is_string($articlesubject)) ? strpos($articlesubject, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $articlesubject = substr($articlesubject, 0, $tmp_pos);
         }
      }
      if (!isset($articlecontent) || $articlecontent == "")
      {
          $articlecontent = "";
      }
      if (isset($articlecontent) && !empty($articlecontent))
      {
         $tmp_pos = (is_string($articlecontent)) ? strpos($articlecontent, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $articlecontent = substr($articlecontent, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_categoryid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "" . $this->Ini->Nm_lang['lang_kb_articles_fild_categoryid'] . ""; ?></TD>
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['psq_check_ret']['categoryid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['psq_check_ret']['categoryid'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_articlesubject_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['articlesubject'])) ? $this->New_label['articlesubject'] : "" . $this->Ini->Nm_lang['lang_kb_articles_fild_articlesubject'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_articlesubject_cond" name="articlesubject_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_articlesubject" <?php echo $str_hide_articlesubject?> valign="top">
 ...
 $nmgp_tab_label .= "articlesubject?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_articlesubject" name="articlesubject" value="<?php echo NM_encode_input($articlesubject) ?>"  size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_articlecontent_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['articlecontent'])) ? $this->New_label['articlecontent'] : "" . $this->Ini->Nm_lang['lang_kb_articles_fild_articlecontent'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_articlecontent_cond" name="articlecontent_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_articlecontent" <?php echo $str_hide_articlecontent?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['articlecontent'])) ? $this->New_label['articlecontent'] : "" . $this->Ini->Nm_lang['lang_kb_articles_fild_articlecontent'] . "";
 $nmgp_tab_label .= "articlecontent?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_articlecontent" name="articlecontent" value="<?php echo NM_encode_input($articlecontent) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
...
?>
<?php
   if (is_file("grid_kb_articles_search_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['orig_pesq'] == "grid")
   {
...
?>
 function nm_move()
 {
     ...
     document.form_cancel.action = "grid_kb_articles_search.php"; 
 ...
 function limpa_form()
 {
   ...
   document.F1.articlesubject_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_articlesubject'), document.F1.articlesubject_cond, 'articlesubject');
   document.F1.articlesubject.value = "";
   document.F1.articlecontent_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_articlecontent'), document.F1.articlecontent_cond, 'articlecontent');
   document.F1.articlecontent.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "sc_tickets/grid_kb_articles_search";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_kb_articles_search/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_articlesubject_cond'] = 'cond';
      $tp_fields['SC_articlesubject'] = 'text';
      $tp_fields['SC_articlecontent_cond'] = 'cond';
      $tp_fields['SC_articlecontent'] = 'text';
   ...
   function trata_campos()
   {
      global $categoryid_cond, $categoryid,
             $articlesubject_cond, $articlesubject,
             $articlecontent_cond, $articlecontent, $nmgp_tab_label;
      ...
      $articlesubject_cond_salva = $articlesubject_cond; 
      if (!isset($articlesubject_input_2) || $articlesubject_input_2 == "")
      {
          $articlesubject_input_2 = $articlesubject;
      }
      $articlecontent_cond_salva = $articlecontent_cond; 
      if (!isset($articlecontent_input_2) || $articlecontent_input_2 == "")
      {
          $articlecontent_input_2 = $articlecontent;
      }
      $tmp_pos = (is_string($categoryid)) ? strpos($categoryid, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $categoryid;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['psq_check_ret']['categoryid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_kb_articles_fild_categoryid'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['categoryid'] = $categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['categoryid_cond'] = $categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlesubject'] = $articlesubject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlesubject_cond'] = $articlesubject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlecontent'] = $articlecontent; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['articlecontent_cond'] = $articlecontent_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $articlesubject;
      $this->cmp_formatado['articlesubject'] = $Conteudo;
      $Conteudo = $articlecontent;
      $this->cmp_formatado['articlecontent'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $articlesubject
      $this->Date_part = false;
      if (isset($articlesubject) || $articlesubject_cond == "nu" || $articlesubject_cond == "nn" || $articlesubject_cond == "ep" || $articlesubject_cond == "ne")
      {
         $this->monta_condicao("articlesubject", $articlesubject_cond, $articlesubject, "", "articlesubject", "VARCHAR", false);
      }

      //----- $articlecontent
      $this->Date_part = false;
      if (isset($articlecontent) || $articlecontent_cond == "nu" || $articlecontent_cond == "nn" || $articlecontent_cond == "ep" || $articlecontent_cond == "ne")
      {
         $this->monta_condicao("articlecontent", $articlecontent_cond, $articlecontent, "", "articlecontent", "TEXT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kb_articles_search']['where_pesq'];
	...
	$sSql = "SELECT categoryid,
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $ds_cat[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
