...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_search"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_search"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kb_articles_search</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_search']['embutida_filho'] as $ind => $sc_init)
          {
