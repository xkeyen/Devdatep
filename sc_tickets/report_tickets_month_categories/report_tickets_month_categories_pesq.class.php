...
class report_tickets_month_categories_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "ticketdate";$Nm_datas[] = "ticketlastupdate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "report_tickets_month_categories.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tickets_month_categories_title'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>report_tickets_month_categories/report_tickets_month_categories_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="report_tickets_month_categories_ajax_search.js"></script>
 <script type="text/javascript" src="report_tickets_month_categories_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="report_tickets_month_categories_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_month_categories']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_month_categories']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_ticketdate_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_ticketdate_dia').value + '/';
          var_dt_ini += document.getElementById('SC_ticketdate_mes').value + '/';
          var_dt_ini += document.getElementById('SC_ticketdate_ano').value;
          document.getElementById('sc_ticketdate_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_ticketdate_dia').value = aParts[0];
          document.getElementById('SC_ticketdate_mes').value = aParts[1];
          document.getElementById('SC_ticketdate_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_ticketdate_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_ticketdate_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_ticketdate_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_ticketdate_input_2_ano').value;
          document.getElementById('sc_ticketdate_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_ticketdate_input_2_dia').value = aParts[0];
          document.getElementById('SC_ticketdate_input_2_mes').value = aParts[1];
          document.getElementById('SC_ticketdate_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="report_tickets_month_categories.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_tickets_month_categories_title'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticketdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_dia']; 
          $ticketdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_mes']; 
          $ticketdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_ano']; 
          $ticketdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_dia']; 
          $ticketdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_mes']; 
          $ticketdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_ano']; 
          $ticketdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_cond']; 
          $categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['categoryid']; 
          $categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['categoryid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("report_tickets_month_categories_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['sc_modal'])
       {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_ticketdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ticketdate'])) ? $this->New_label['ticketdate'] : "Month Year"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ticketdate_cond" name="ticketdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticketdate'), this, 'ticketdate')">
       ...
       <OPTION value="bi_YY" <?php if ("bi_YY" == $ticketdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="bi_M6" <?php if ("bi_M6" == $ticketdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="bi_M3" <?php if ("bi_M3" == $ticketdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       ...
       <OPTION value="bw" <?php if ("bw" == $ticketdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
      ...
      <TABLE  id="opc_bi_TP_ticketdate"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticketdate" <?php echo $str_hide_ticketdate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ticketdate'])) ? $this->New_label['ticketdate'] : "Month Year";
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ticketdate_ano" name="ticketdate_ano" value="<?php echo NM_encode_input($ticketdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_ticketdate_jq">
<br />
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ticketdate_input_2_ano" name="ticketdate_input_2_ano" value="<?php echo NM_encode_input($ticketdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_ticketdate_jq2">
<br />
<?php echo $this->Ini->Nm_lang['lang_othr_date_year'] ?></span>
        </SPAN>
      ...
      <TD id='SC_categoryid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "" . $this->Ini->Nm_lang['lang_tble_categories'] . ""; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoryid" <?php echo $str_hide_categoryid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "" . $this->Ini->Nm_lang['lang_tble_categories'] . "";
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['psq_check_ret']['categoryid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['psq_check_ret']['categoryid'][] = trim($rs->fields[0]);
...
{
?>
<iframe id="nmsc_iframe_report_tickets_month_categories" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="650px" name="nm_iframe_report_tickets_month_categories" scrolling="auto" src="report_tickets_month_categories.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_report_tickets_month_categories_pesq"  name="nm_iframe_report_tickets_month_categories_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "report_tickets_month_categories.php"; 
     document.form_cancel.submit(); 
 }
 function nm_submit_form()
 {
    document.F1.target = "nm_iframe_report_tickets_month_categories";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_report_tickets_month_categories').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_ticketdate_dia').bind('change', function() {sc_report_tickets_month_categories_valida_dia(this)});
    $('#SC_ticketdate_input_2_dia').bind('change', function() {sc_report_tickets_month_categories_valida_dia(this)});
    $('#SC_ticketdate_input_2_mes').bind('change', function() {sc_report_tickets_month_categories_valida_mes(this)});
    $('#SC_ticketdate_mes').bind('change', function() {sc_report_tickets_month_categories_valida_mes(this)});
 }
 function sc_report_tickets_month_categories_valida_mes(obj)
 {
 ...
 function sc_report_tickets_month_categories_valida_dia(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function trata_campos()
   {
      global $ticketdate_cond, $ticketdate, $ticketdate_dia, $ticketdate_mes, $ticketdate_ano, $ticketdate_input_2_dia, $ticketdate_input_2_mes, $ticketdate_input_2_ano,
             $categoryid_cond, $categoryid, $nmgp_tab_label;
      ...
      if (is_array($categoryid)) {
          foreach ($categoryid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['psq_check_ret']['categoryid'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_tble_categories'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_dia'] = $ticketdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_mes'] = $ticketdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_ano'] = $ticketdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_dia'] = $ticketdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_mes'] = $ticketdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2_ano'] = $ticketdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_cond'] = $ticketdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['categoryid'] = $categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['categoryid_cond'] = $categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['categoryid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['categoryid'];
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($ticketdate_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate'] = $val[0];
          ...
          if ($ticketdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']['ticketdate_input_2'] = $val[1];
      ...
      if (is_array($categoryid) && count($categoryid) != 0)
      {
         ...
         if ($categoryid_cond == "df" || $categoryid_cond == "np")
         {
             ...
             $this->comando_sum    .= " .categoryid not in (";
             $this->comando_filtro .= " categoryid not in (";
         }
         else
         {
             $this->comando        .= " categoryid in (";
             $this->comando_sum    .= " .categoryid in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $nmgp_tab_label['categoryid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($categoryid) && ($categoryid_cond == "nu" || $categoryid_cond == "nn" || $categoryid_cond == "ep" || $categoryid_cond == "ne"))
      {
         $this->monta_condicao("categoryid", $categoryid_cond, "", "", "categoryid", "INTEGER", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_month_categories']['cond_pesq'] .= $this->NM_operador;
