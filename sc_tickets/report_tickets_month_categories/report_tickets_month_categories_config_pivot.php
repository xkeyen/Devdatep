...
{
    if (isset($_SESSION['sc_session'][$sc_page][$nome_apl]['using_summary_cache'])) {
        unset($_SESSION['sc_session'][$sc_page][$nome_apl]['using_summary_cache']);
    }
    $a_x_axys = array();
    $a_y_axys = array();
...
<body>
<script language="javascript">
    if (self.parent.document.refresh_config.reload_summary_data) {
        self.parent.document.refresh_config.reload_summary_data.value = "Y";
    }
    self.parent.document.refresh_config.submit();
    if (self.parent.document.refresh_config.reload_summary_data) {
        self.parent.document.refresh_config.reload_summary_data.value = "";
    }
...
<tr>
     ...
     <tr>
      <td class="scGridFieldOdd scGridFieldOddFont">
       <table style="border-collapse: collapse; border-width: 0; width: 100%">
        <tr>
         <td class="scGridFieldOddFont" style="padding: 8px"><?php echo $tradutor[$language]['smry_ppup_fild']; ?></td>
         <td class="scGridFieldOddFont" style="padding: 8px"><?php echo $tradutor[$language]['smry_ppup_posi']; ?></td>
         <td class="scGridFieldOddFont" style="padding: 8px"><?php echo $tradutor[$language]['smry_ppup_sort']; ?></td>
        </tr>
    <?php
    ...
    ?>
        <tr>
         <td class="scGridFieldOddFont" style="padding: 8px"><?php echo $l_group; ?></td>
    <?php
        if (0 && sizeof($_SESSION['sc_session'][$sc_page][$nome_apl]['pivot_group_by']) - 1 == $i_group)
        {
    ?>
         <td class="scGridFieldOddFont" style="padding: 8px">
          &nbsp;
    ...
    ?>
         <td class="scGridFieldOddFont" style="padding: 8px">
          <select class="css_toolbar_obj" name="order_<?php echo $i_group; ?>">
