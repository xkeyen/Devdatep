<?php  
  ...
  session_start() ;
  class report_monitor_category_form_teste
  {
  function report_monitor_category_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_monitor_category</FONT></B> 
<br> 
<br> 
...
<input type=submit value="report_monitor_category"> 
</form> 
...
<?php
  ...
  $frm_teste = new report_monitor_category_form_teste();
  $frm_teste->report_monitor_category_teste();
?>
