<?php
@session_start() ;
$_SESSION['scriptcase']['report_monitor_category']['sc_process_barr'] = true;
require_once('../report_monitor_category/index.php');
unset($_SESSION['scriptcase']['report_monitor_category']['sc_process_barr']);
$ExportCtrl = new report_monitor_category_export_control;
$ExportCtrl->Export_barr();

class report_monitor_category_export_control
{
