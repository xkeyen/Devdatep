  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_systemsettings_restore_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_systemsettings_restore_mob_form();
	}
...
?>
  ...
  function do_ajax_form_systemsettings_restore_mob_validate_companyname()
  {
    var nomeCampo_companyname = "companyname";
    var var_companyname = scAjaxGetFieldText(nomeCampo_companyname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_companyname(var_companyname, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_companyname_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_companyname

  function do_ajax_form_systemsettings_restore_mob_validate_companyname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_companyname_cb

  // ---------- Validate assigmentmode
  function do_ajax_form_systemsettings_restore_mob_validate_assigmentmode()
  {
    var nomeCampo_assigmentmode = "assigmentmode";
    var var_assigmentmode = scAjaxGetFieldSelect(nomeCampo_assigmentmode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_assigmentmode(var_assigmentmode, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_assigmentmode_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_assigmentmode

  function do_ajax_form_systemsettings_restore_mob_validate_assigmentmode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "assigmentmode";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_assigmentmode_cb

  // ---------- Validate publicticketsopening
  function do_ajax_form_systemsettings_restore_mob_validate_publicticketsopening()
  {
    var nomeCampo_publicticketsopening = "publicticketsopening";
    var var_publicticketsopening = scAjaxGetFieldRadio(nomeCampo_publicticketsopening);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_publicticketsopening(var_publicticketsopening, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_publicticketsopening_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_publicticketsopening

  function do_ajax_form_systemsettings_restore_mob_validate_publicticketsopening_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "publicticketsopening";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_publicticketsopening_cb

  // ---------- Validate defaultpriority
  function do_ajax_form_systemsettings_restore_mob_validate_defaultpriority()
  {
    var nomeCampo_defaultpriority = "defaultpriority";
    var var_defaultpriority = scAjaxGetFieldSelect(nomeCampo_defaultpriority);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_defaultpriority(var_defaultpriority, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_defaultpriority_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_defaultpriority

  function do_ajax_form_systemsettings_restore_mob_validate_defaultpriority_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "defaultpriority";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_defaultpriority_cb

  // ---------- Validate urltrackingscreen
  function do_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen()
  {
    var nomeCampo_urltrackingscreen = "urltrackingscreen";
    var var_urltrackingscreen = scAjaxGetFieldText(nomeCampo_urltrackingscreen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen(var_urltrackingscreen, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen

  function do_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urltrackingscreen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_urltrackingscreen_cb

  // ---------- Validate urlconfirmationscreen
  function do_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen()
  {
    var nomeCampo_urlconfirmationscreen = "urlconfirmationscreen";
    var var_urlconfirmationscreen = scAjaxGetFieldText(nomeCampo_urlconfirmationscreen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen(var_urlconfirmationscreen, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen

  function do_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urlconfirmationscreen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_urlconfirmationscreen_cb

  // ---------- Validate broadcastmessages
  function do_ajax_form_systemsettings_restore_mob_validate_broadcastmessages()
  {
    var nomeCampo_broadcastmessages = "broadcastmessages";
    var var_broadcastmessages = scAjaxGetFieldRadio(nomeCampo_broadcastmessages);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_broadcastmessages(var_broadcastmessages, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_broadcastmessages_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_broadcastmessages

  function do_ajax_form_systemsettings_restore_mob_validate_broadcastmessages_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "broadcastmessages";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_broadcastmessages_cb

  // ---------- Validate defaultlanguage
  function do_ajax_form_systemsettings_restore_mob_validate_defaultlanguage()
  {
    var nomeCampo_defaultlanguage = "defaultlanguage";
    var var_defaultlanguage = scAjaxGetFieldText(nomeCampo_defaultlanguage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_defaultlanguage(var_defaultlanguage, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_defaultlanguage_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_defaultlanguage

  function do_ajax_form_systemsettings_restore_mob_validate_defaultlanguage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "defaultlanguage";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_defaultlanguage_cb

  // ---------- Validate emailaccount
  function do_ajax_form_systemsettings_restore_mob_validate_emailaccount()
  {
    var nomeCampo_emailaccount = "emailaccount";
    var var_emailaccount = scAjaxGetFieldText(nomeCampo_emailaccount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_emailaccount(var_emailaccount, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_emailaccount_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_emailaccount

  function do_ajax_form_systemsettings_restore_mob_validate_emailaccount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emailaccount";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_emailaccount_cb

  // ---------- Validate smtpserver
  function do_ajax_form_systemsettings_restore_mob_validate_smtpserver()
  {
    var nomeCampo_smtpserver = "smtpserver";
    var var_smtpserver = scAjaxGetFieldText(nomeCampo_smtpserver);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_smtpserver(var_smtpserver, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_smtpserver_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpserver

  function do_ajax_form_systemsettings_restore_mob_validate_smtpserver_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtpserver";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpserver_cb

  // ---------- Validate smtpuser
  function do_ajax_form_systemsettings_restore_mob_validate_smtpuser()
  {
    var nomeCampo_smtpuser = "smtpuser";
    var var_smtpuser = scAjaxGetFieldText(nomeCampo_smtpuser);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_smtpuser(var_smtpuser, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_smtpuser_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpuser

  function do_ajax_form_systemsettings_restore_mob_validate_smtpuser_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtpuser";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpuser_cb

  // ---------- Validate smtppassword
  function do_ajax_form_systemsettings_restore_mob_validate_smtppassword()
  {
    var nomeCampo_smtppassword = "smtppassword";
    var var_smtppassword = scAjaxGetFieldText(nomeCampo_smtppassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_smtppassword(var_smtppassword, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_smtppassword_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_smtppassword

  function do_ajax_form_systemsettings_restore_mob_validate_smtppassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtppassword";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_smtppassword_cb

  // ---------- Validate smtpsecurityflag
  function do_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag()
  {
    var nomeCampo_smtpsecurityflag = "smtpsecurityflag";
    var var_smtpsecurityflag = scAjaxGetFieldCheckbox(nomeCampo_smtpsecurityflag, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag(var_smtpsecurityflag, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag

  function do_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtpsecurityflag";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpsecurityflag_cb

  // ---------- Validate smtpport
  function do_ajax_form_systemsettings_restore_mob_validate_smtpport()
  {
    var nomeCampo_smtpport = "smtpport";
    var var_smtpport = scAjaxGetFieldText(nomeCampo_smtpport);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_smtpport(var_smtpport, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_smtpport_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpport

  function do_ajax_form_systemsettings_restore_mob_validate_smtpport_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtpport";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_smtpport_cb

  // ---------- Validate id
  function do_ajax_form_systemsettings_restore_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_restore_mob_validate_id(var_id, var_script_case_init, do_ajax_form_systemsettings_restore_mob_validate_id_cb);
  } // do_ajax_form_systemsettings_restore_mob_validate_id

  function do_ajax_form_systemsettings_restore_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_restore_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_systemsettings_restore_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_systemsettings_restore_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_companyname = scAjaxGetFieldText("companyname");
    var var_assigmentmode = scAjaxGetFieldSelect("assigmentmode");
    var var_publicticketsopening = scAjaxGetFieldRadio("publicticketsopening");
    var var_defaultpriority = scAjaxGetFieldSelect("defaultpriority");
    var var_urltrackingscreen = scAjaxGetFieldText("urltrackingscreen");
    var var_urlconfirmationscreen = scAjaxGetFieldText("urlconfirmationscreen");
    var var_broadcastmessages = scAjaxGetFieldRadio("broadcastmessages");
    var var_defaultlanguage = scAjaxGetFieldText("defaultlanguage");
    var var_emailaccount = scAjaxGetFieldText("emailaccount");
    var var_smtpserver = scAjaxGetFieldText("smtpserver");
    var var_smtpuser = scAjaxGetFieldText("smtpuser");
    var var_smtppassword = scAjaxGetFieldText("smtppassword");
    var var_smtpsecurityflag = scAjaxGetFieldCheckbox("smtpsecurityflag", ";");
    var var_smtpport = scAjaxGetFieldText("smtpport");
    ...
    scAjaxProcOn();
    x_ajax_form_systemsettings_restore_mob_submit_form(var_companyname, var_assigmentmode, var_publicticketsopening, var_defaultpriority, var_urltrackingscreen, var_urlconfirmationscreen, var_broadcastmessages, var_defaultlanguage, var_emailaccount, var_smtpserver, var_smtpuser, var_smtppassword, var_smtpsecurityflag, var_smtpport, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_systemsettings_restore_mob_submit_form_cb);
  } // do_ajax_form_systemsettings_restore_mob_submit_form

  function do_ajax_form_systemsettings_restore_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_systemsettings_restore_mob_submit_form_cb_after_alert);
  } // do_ajax_form_systemsettings_restore_mob_submit_form_cb
  function do_ajax_form_systemsettings_restore_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_systemsettings_restore_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_systemsettings_restore_mob_navigate_form()
  {
    perform_ajax_form_systemsettings_restore_mob_navigate_form();
  }

  function perform_ajax_form_systemsettings_restore_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_systemsettings_restore_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_systemsettings_restore_mob_navigate_form_cb);
  } // do_ajax_form_systemsettings_restore_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_restore_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_systemsettings_restore_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_systemsettings_restore_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_systemsettings_restore_mob_navigate_form_cb
  function do_ajax_form_systemsettings_restore_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_systemsettings_restore_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_systemsettings_restore_mob_navigate_form_cb_after_alert

  function sc_hide_form_systemsettings_restore_mob_form()
  {
  ...
  ajax_field_list[0] = "companyname";
  ajax_field_list[1] = "assigmentmode";
  ajax_field_list[2] = "publicticketsopening";
  ajax_field_list[3] = "defaultpriority";
  ajax_field_list[4] = "urltrackingscreen";
  ajax_field_list[5] = "urlconfirmationscreen";
  ajax_field_list[6] = "broadcastmessages";
  ajax_field_list[7] = "defaultlanguage";
  ajax_field_list[8] = "emailaccount";
  ajax_field_list[9] = "smtpserver";
  ajax_field_list[10] = "smtpuser";
  ajax_field_list[11] = "smtppassword";
  ajax_field_list[12] = "smtpsecurityflag";
  ajax_field_list[13] = "smtpport";
  ajax_field_list[14] = "id";
  ...
  var ajax_error_list = {
    "companyname": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_companyname'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "assigmentmode": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_assigmentmode'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "publicticketsopening": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_publicticketsopening'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "defaultpriority": {"label": "<?php echo $this->Ini->Nm_lang['lang_fld_systemsetings_def_pri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "urltrackingscreen": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_urltrackingscreen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "urlconfirmationscreen": {"label": "<?php echo $this->Ini->Nm_lang['lang_fld_confim_account'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "broadcastmessages": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_broadcastmessages'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "defaultlanguage": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_defaultlanguage'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "emailaccount": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_emailaccount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "smtpserver": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_smtpserver'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "smtpuser": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_smtpuser'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "smtppassword": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_smtppassword'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "smtpsecurityflag": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_smtpsecurityflag'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "smtpport": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_smtpport'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    ...
    "assigmentmode": new Array(),
    "publicticketsopening": new Array(),
    "defaultpriority": new Array(),
    "urltrackingscreen": new Array(),
    "urlconfirmationscreen": new Array(),
    "broadcastmessages": new Array(),
    "defaultlanguage": new Array(),
    "emailaccount": new Array(),
    "smtpserver": new Array(),
    "smtpuser": new Array(),
    "smtppassword": new Array(),
    "smtpsecurityflag": new Array(),
    "smtpport": new Array(),
    "id": new Array()
  };
  ajax_field_mult["companyname"][1] = "companyname";
  ajax_field_mult["assigmentmode"][1] = "assigmentmode";
  ajax_field_mult["publicticketsopening"][1] = "publicticketsopening";
  ajax_field_mult["defaultpriority"][1] = "defaultpriority";
  ajax_field_mult["urltrackingscreen"][1] = "urltrackingscreen";
  ajax_field_mult["urlconfirmationscreen"][1] = "urlconfirmationscreen";
  ajax_field_mult["broadcastmessages"][1] = "broadcastmessages";
  ajax_field_mult["defaultlanguage"][1] = "defaultlanguage";
  ajax_field_mult["emailaccount"][1] = "emailaccount";
  ajax_field_mult["smtpserver"][1] = "smtpserver";
  ajax_field_mult["smtpuser"][1] = "smtpuser";
  ajax_field_mult["smtppassword"][1] = "smtppassword";
  ajax_field_mult["smtpsecurityflag"][1] = "smtpsecurityflag";
  ajax_field_mult["smtpport"][1] = "smtpport";
  ajax_field_mult["id"][1] = "id";

  var ajax_field_id = {
    "companyname": new Array("hidden_field_label_companyname", "hidden_field_data_companyname"),
    "assigmentmode": new Array("hidden_field_label_assigmentmode", "hidden_field_data_assigmentmode"),
    "publicticketsopening": new Array("hidden_field_label_publicticketsopening", "hidden_field_data_publicticketsopening"),
    "defaultpriority": new Array("hidden_field_label_defaultpriority", "hidden_field_data_defaultpriority"),
    "urltrackingscreen": new Array("hidden_field_label_urltrackingscreen", "hidden_field_data_urltrackingscreen"),
    "urlconfirmationscreen": new Array("hidden_field_label_urlconfirmationscreen", "hidden_field_data_urlconfirmationscreen"),
    "broadcastmessages": new Array("hidden_field_label_broadcastmessages", "hidden_field_data_broadcastmessages"),
    "defaultlanguage": new Array("hidden_field_label_defaultlanguage", "hidden_field_data_defaultlanguage"),
    "emailaccount": new Array("hidden_field_label_emailaccount", "hidden_field_data_emailaccount"),
    "smtpserver": new Array("hidden_field_label_smtpserver", "hidden_field_data_smtpserver"),
    "smtpuser": new Array("hidden_field_label_smtpuser", "hidden_field_data_smtpuser"),
    "smtppassword": new Array("hidden_field_label_smtppassword", "hidden_field_data_smtppassword"),
    "smtpsecurityflag": new Array("hidden_field_label_smtpsecurityflag", "hidden_field_data_smtpsecurityflag"),
    "smtpport": new Array("hidden_field_label_smtpport", "hidden_field_data_smtpport"),
  ...
  var ajax_read_only = {
    "companyname": "off",
    "assigmentmode": "off",
    "publicticketsopening": "off",
    "defaultpriority": "off",
    "urltrackingscreen": "off",
    "urlconfirmationscreen": "off",
    "broadcastmessages": "off",
    "defaultlanguage": "off",
    "emailaccount": "off",
    "smtpserver": "off",
    "smtpuser": "off",
    "smtppassword": "off",
    "smtpsecurityflag": "off",
    "smtpport": "off",
    "id": "on"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("publicticketsopening" == sIndex)
    {
    ...
    if ("urlconfirmationscreen" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
