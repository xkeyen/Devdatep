<?php  
  ...
  session_start() ;
  class form_systemsettings_restore_form_teste
  {
   function form_systemsettings_restore_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_systemsettings_restore/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_systemsettings_restore</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_systemsettings_restore"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_systemsettings_restore_form_teste();
  $frm_teste->form_systemsettings_restore_teste();
?>
