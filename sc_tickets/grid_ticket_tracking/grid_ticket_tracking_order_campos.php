<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_ticket_tracking']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_ticket_tracking_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ticket_tracking_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ticketmessage_ticketdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_ticketdate'] = "ticketmessage_ticketdate";
   }
   else
   {
       $tab_def_campos['ticketmessage_ticketdate'] = "ticketmessage.ticketdate";
   }
   $tab_labels["ticketmessage_ticketdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketdate"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketdate'] . "";
   $tab_ger_campos['messagestatus'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['messagestatus'] = "messagestatus";
   }
   else
   {
       $tab_def_campos['messagestatus'] = "ticketmessage.statusid";
   }
   $tab_labels["messagestatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["messagestatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["messagestatus"] : "" . $this->Nm_lang['lang_ticketmessage_fild_statusid'] . "";
   $tab_ger_campos['ticketmessage_operatorid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_operatorid'] = "ticketmessage_operatorid";
   }
   else
   {
       $tab_def_campos['ticketmessage_operatorid'] = "ticketmessage.operatorid";
   }
   $tab_labels["ticketmessage_operatorid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_operatorid"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_operatorid"] : "" . $this->Nm_lang['lang_ticketmessage_fild_operatorid'] . "";
   $tab_ger_campos['ticketmessage_ticketcontent'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_ticketcontent'] = "ticketmessage_ticketcontent";
   }
   else
   {
       $tab_def_campos['ticketmessage_ticketcontent'] = "ticketmessage.ticketcontent";
   }
   $tab_labels["ticketmessage_ticketcontent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketcontent"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketcontent"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketcontent'] . "";
   $tab_ger_campos['ticketmessage_ticketfile1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_ticketfile1'] = "ticketmessage_ticketfile1";
   }
   else
   {
       $tab_def_campos['ticketmessage_ticketfile1'] = "ticketmessage.ticketfile1";
   }
   $tab_labels["ticketmessage_ticketfile1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile1"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile1"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketfile1'] . "";
   $tab_ger_campos['ticketmessage_ticketfile2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_ticketfile2'] = "ticketmessage_ticketfile2";
   }
   else
   {
       $tab_def_campos['ticketmessage_ticketfile2'] = "ticketmessage.ticketfile2";
   }
   $tab_labels["ticketmessage_ticketfile2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile2"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile2"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketfile2'] . "";
   $tab_ger_campos['ticketmessage_ticketfile3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketmessage_ticketfile3'] = "ticketmessage_ticketfile3";
   }
   else
   {
       $tab_def_campos['ticketmessage_ticketfile3'] = "ticketmessage.ticketfile3";
   }
   $tab_labels["ticketmessage_ticketfile3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile3"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['labels']["ticketmessage_ticketfile3"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketfile3'] . "";
   $tab_ger_campos['ticketmessage_ticketfile1'] = "none";
   $tab_ger_campos['ticketmessage_ticketfile2'] = "none";
   $tab_ger_campos['ticketmessage_ticketfile3'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ticket_tracking']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ticket_tracking']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_ticket_tracking']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ticket_tracking_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ticket_tracking']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
