   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_ticket_tracking.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_ticket_tracking"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_ticket_tracking"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ticket_tracking</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ticket_tracking']['embutida_filho'] as $ind => $sc_init)
          {
