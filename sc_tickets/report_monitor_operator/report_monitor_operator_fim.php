   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_monitor_operator.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_operator"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_operator"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_monitor_operator</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_monitor_operator']['embutida_filho'] as $ind => $sc_init)
          {
