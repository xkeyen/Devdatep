<?php  
  ...
  session_start() ;
  class form_languages_form_teste
  {
   function form_languages_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_languages/img";
...
<?php
  ...
  $frm_teste = new form_languages_form_teste();
  $frm_teste->form_languages_teste();
?>
