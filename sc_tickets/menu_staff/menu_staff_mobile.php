...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_staff"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_staff"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_staff"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($menu_staff_menuData["data"]) && is_array($menu_staff_menuData["data"]) && !empty($menu_staff_menuData["data"]))
    {
        foreach($menu_staff_menuData["data"] as $arr_item)
        {
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <?php
        escreveMenuMobile($menu_staff_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
