...
class report_tickets_time_answer_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . report_tickets_time_answer_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . report_tickets_time_answer_pack_protect_string($Tipo_filter[0]) . "\">.." . report_tickets_time_answer_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "report_tickets_time_answer.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vw_time_answer</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>report_tickets_time_answer/report_tickets_time_answer_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="report_tickets_time_answer_ajax_search.js"></script>
 <script type="text/javascript" src="report_tickets_time_answer_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="report_tickets_time_answer_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ticketid_cond#NMF#' + search_get_sel_txt('SC_ticketid_cond') + '@NMF@';
  str_out += 'SC_ticketid#NMF#' + search_get_text('SC_ticketid') + '@NMF@';
  str_out += 'SC_ownerid_cond#NMF#' + search_get_sel_txt('SC_ownerid_cond') + '@NMF@';
  str_out += 'SC_ownerid#NMF#' + search_get_text('SC_ownerid') + '@NMF@';
  str_out += 'SC_categoryid_cond#NMF#' + search_get_sel_txt('SC_categoryid_cond') + '@NMF@';
  str_out += 'SC_categoryid#NMF#' + search_get_text('SC_categoryid') + '@NMF@';
  str_out += 'SC_customeremail_cond#NMF#' + search_get_sel_txt('SC_customeremail_cond') + '@NMF@';
  str_out += 'SC_customeremail#NMF#' + search_get_text('SC_customeremail') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="report_tickets_time_answer.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vw_time_answer
        </TD>
       </TR>
...
<?php
   ...
   {
      global 
             $ticketid_cond, $ticketid,
             $ownerid_cond, $ownerid,
             $categoryid_cond, $categoryid,
             $customeremail_cond, $customeremail,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticketid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ticketid']; 
          $ticketid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ticketid_cond']; 
          $ownerid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ownerid']; 
          $ownerid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ownerid_cond']; 
          $categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['categoryid']; 
          $categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['categoryid_cond']; 
          $customeremail = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['customeremail']; 
          $customeremail_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['customeremail_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['NM_operador']; 
          if (strtoupper($ticketid_cond) != "II" && strtoupper($ticketid_cond) != "QP" && strtoupper($ticketid_cond) != "NP" && strtoupper($ticketid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ticketid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($ownerid_cond) != "II" && strtoupper($ownerid_cond) != "QP" && strtoupper($ownerid_cond) != "NP" && strtoupper($ownerid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ownerid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($categoryid_cond) != "II" && strtoupper($categoryid_cond) != "QP" && strtoupper($categoryid_cond) != "NP" && strtoupper($categoryid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($categoryid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($ticketid_cond) || empty($ticketid_cond))
      {
         $ticketid_cond = "eq";
      }
      if (!isset($ownerid_cond) || empty($ownerid_cond))
      {
         $ownerid_cond = "eq";
      }
      ...
      if (!isset($customeremail_cond) || empty($customeremail_cond))
      {
         $customeremail_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_ticketid = (in_array($ticketid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ownerid = (in_array($ownerid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_categoryid = (in_array($categoryid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customeremail = (in_array($customeremail_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_ticketid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ticketid'])) ? $this->New_label['ticketid'] : "Ticket ID"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ticketid_cond" name="ticketid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticketid'), this, 'ticketid')">
       <OPTION value="eq" <?php if ("eq" == $ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticketid" <?php echo $str_hide_ticketid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ticketid'])) ? $this->New_label['ticketid'] : "Ticket ID";
 $nmgp_tab_label .= "ticketid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<INPUT  type="text" id="SC_ticketid" name="ticketid" value="<?php echo NM_encode_input($ticketid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_ownerid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ownerid'])) ? $this->New_label['ownerid'] : "Owner ID"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ownerid_cond" name="ownerid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ownerid'), this, 'ownerid')">
       <OPTION value="eq" <?php if ("eq" == $ownerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $ownerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $ownerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $ownerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ownerid" <?php echo $str_hide_ownerid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ownerid'])) ? $this->New_label['ownerid'] : "Owner ID";
 $nmgp_tab_label .= "ownerid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_ownerid" name="ownerid" value="<?php echo NM_encode_input($ownerid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_categoryid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "Category ID"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_categoryid_cond" name="categoryid_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoryid'), this, 'categoryid')">
       <OPTION value="eq" <?php if ("eq" == $categoryid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $categoryid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $categoryid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $categoryid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_categoryid" name="categoryid" value="<?php echo NM_encode_input($categoryid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_customeremail_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['customeremail'])) ? $this->New_label['customeremail'] : "Customer Email"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customeremail_cond" name="customeremail_cond" onChange="nm_campos_between(document.getElementById('id_vis_customeremail'), this, 'customeremail')">
       <OPTION value="eq" <?php if ("eq" == $customeremail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $customeremail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $customeremail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $customeremail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customeremail" <?php echo $str_hide_customeremail?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['customeremail'])) ? $this->New_label['customeremail'] : "Customer Email";
 $nmgp_tab_label .= "customeremail?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_customeremail" name="customeremail" value="<?php echo NM_encode_input($customeremail) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("report_tickets_time_answer_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_tickets_time_answer']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['report_tickets_time_answer']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="report_tickets_time_answer.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['orig_pesq'] == "grid")
   {
...
?>
 function nm_move()
 {
     ...
     document.form_cancel.action = "report_tickets_time_answer.php"; 
 ...
 function limpa_form()
 {
   ...
   document.F1.ticketid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ticketid'), document.F1.ticketid_cond, 'ticketid');
   document.F1.ticketid.value = "";
   document.F1.ownerid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ownerid'), document.F1.ownerid_cond, 'ownerid');
   document.F1.ownerid.value = "";
   document.F1.categoryid_cond.value = 'eq';
   ...
   document.F1.customeremail_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_customeremail'), document.F1.customeremail_cond, 'customeremail');
   document.F1.customeremail.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "sc_tickets/report_tickets_time_answer";
             ...
             if (@is_file($this->NM_path_filter . $NM_patch . "/" . $NM_arq))
             {
                 ...
                 if (substr($NMcmp_filter[0], 0, 6) == "SC_V6_" || substr($NMcmp_filter[0], 0, 6) == "SC_V8_")
                 {
                     ...
                     if (!empty($Name_filter))
                     {
                         ...
                         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                         {
                             $this->NM_fil_ant[$NM_arq][1] = sc_convert_encoding("Público", $_SESSION['scriptcase']['charset'], "UTF-8");
                         }
                         else
                         {
                             $this->NM_fil_ant[$NM_arq][1] = "Público";
                         }
                         $Sc_v6 = true;
                     }
                 }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "report_tickets_time_answer/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_ticketid_cond'] = 'cond';
      $tp_fields['SC_ticketid'] = 'text';
      $tp_fields['SC_ownerid_cond'] = 'cond';
      $tp_fields['SC_ownerid'] = 'text';
      $tp_fields['SC_categoryid_cond'] = 'cond';
      $tp_fields['SC_categoryid'] = 'text';
      $tp_fields['SC_customeremail_cond'] = 'cond';
      $tp_fields['SC_customeremail'] = 'text';
   ...
   {
      global $ticketid_cond, $ticketid,
             $ownerid_cond, $ownerid,
             $categoryid_cond, $categoryid,
             $customeremail_cond, $customeremail, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $ticketid_cond_salva = $ticketid_cond; 
      if (!isset($ticketid_input_2) || $ticketid_input_2 == "")
      {
          $ticketid_input_2 = $ticketid;
      }
      $ownerid_cond_salva = $ownerid_cond; 
      if (!isset($ownerid_input_2) || $ownerid_input_2 == "")
      {
          $ownerid_input_2 = $ownerid;
      }
      ...
      $customeremail_cond_salva = $customeremail_cond; 
      if (!isset($customeremail_input_2) || $customeremail_input_2 == "")
      {
          $customeremail_input_2 = $customeremail;
      }
      if ($ticketid_cond != "in")
      {
          nm_limpa_numero($ticketid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($ownerid_cond != "in")
      {
          nm_limpa_numero($ownerid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($categoryid_cond != "in")
      {
          nm_limpa_numero($categoryid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ticketid'] = $ticketid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ticketid_cond'] = $ticketid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ownerid'] = $ownerid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['ownerid_cond'] = $ownerid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['categoryid'] = $categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['categoryid_cond'] = $categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['customeremail'] = $customeremail; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['customeremail_cond'] = $customeremail_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['ticketid'] = $Conteudo;
      $Conteudo = $ownerid;
      if (strtoupper($ownerid_cond) != "II" && strtoupper($ownerid_cond) != "QP" && strtoupper($ownerid_cond) != "NP" && strtoupper($ownerid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['ownerid'] = $Conteudo;
      $Conteudo = $categoryid;
      if (strtoupper($categoryid_cond) != "II" && strtoupper($categoryid_cond) != "QP" && strtoupper($categoryid_cond) != "NP" && strtoupper($categoryid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      ...
      $Conteudo = $customeremail;
      $this->cmp_formatado['customeremail'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($ticketid) || $ticketid_cond == "nu" || $ticketid_cond == "nn" || $ticketid_cond == "ep" || $ticketid_cond == "ne")
      {
         $this->monta_condicao("ticketid", $ticketid_cond, $ticketid, "", "ticketid", "INTEGER", false);
      }

      //----- $ownerid
      $this->Date_part = false;
      if (isset($ownerid) || $ownerid_cond == "nu" || $ownerid_cond == "nn" || $ownerid_cond == "ep" || $ownerid_cond == "ne")
      {
         $this->monta_condicao("ownerid", $ownerid_cond, $ownerid, "", "ownerid", "INTEGER", false);
      }

      //----- $categoryid
      $this->Date_part = false;
      if (isset($categoryid) || $categoryid_cond == "nu" || $categoryid_cond == "nn" || $categoryid_cond == "ep" || $categoryid_cond == "ne")
      {
         $this->monta_condicao("categoryid", $categoryid_cond, $categoryid, "", "categoryid", "INTEGER", false);
      }

      //----- $customeremail
      $this->Date_part = false;
      if (isset($customeremail) || $customeremail_cond == "nu" || $customeremail_cond == "nn" || $customeremail_cond == "ep" || $customeremail_cond == "ne")
      {
         $this->monta_condicao("customeremail", $customeremail_cond, $customeremail, "", "customeremail", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['cond_pesq'] .= $this->NM_operador;
