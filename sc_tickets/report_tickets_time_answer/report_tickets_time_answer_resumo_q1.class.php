...
class report_tickets_time_answer_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'timeelapsedanswer' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_time_answer'] . "",
                    'datatype' => '',
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['timeelapsedanswer'],
    ...
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['last_displayed_group_by'] = 'q1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('q1' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['last_displayed_group_by'] = 'q1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_x_axys'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_group_by'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_order'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_x_axys'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_y_axys'] = [];

            $dimensionCount = 0;

            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_x_axys'] [] = $dimensionCount;
            ...
            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_y_axys'] [] = $dimensionCount;

                $dimensionCount++;
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['dimension_order'] = [];
            foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
            }
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
            $dimensionName = $this->SC_APP_info['group_by'] ['dimension'] ['order'] [$dimensionIndex];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summarizing_fields_order'] ['q1'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summarizing_fields_display'] ['q1'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['summary_cache']);
        }
    }
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}report_tickets_time_answer/report_tickets_time_answer.php";
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                report_tickets_time_answer_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            report_tickets_time_answer_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@report_tickets_time_answer@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['report_tickets_time_answer'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['report_tickets_time_answer'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['report_tickets_time_answer'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_time_answer'] ['opcao']) {
            return true;
        }
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_timeelapsedanswer = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total_line']['timeelapsedanswer'];
            }
          $this->array_total_timeelapsedanswer = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total']['timeelapsedanswer'];
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_timeelapsedanswer = array();
                $this->totaliza();
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_clear_total'] = true;
            }
          $this->array_total_timeelapsedanswer = array();
          $this->totaliza();
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total']['timeelapsedanswer'] = $this->array_total_timeelapsedanswer;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total_line']['timeelapsedanswer'] = $this->array_line_timeelapsedanswer;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_array_resumo'] = "OK";
      }
      ...
      if ('out' == $this->NM_tipo && !isset($_GET['flash_graf']) && !$this->NM_export)
      {
          $nm_saida->saida("<TR>\r\n");
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary() && !$this->aux_isExport()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['json_use_label'])
       {
          $Lab_timeelapsedanswer = "timeelapsedanswer";
       }
       else
       {
       $Lab_timeelapsedanswer = "" . $this->Ini->Nm_lang['lang_time_answer'] . "";
       }
       $this->comp_field = array(
           $Lab_timeelapsedanswer,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['ticketid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['ticketid'] = "Ticket ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['timeelapsedanswer']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['timeelapsedanswer'] = "Time Elapsed Answer"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['ownerid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['ownerid'] = "Owner ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['categoryid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['categoryid'] = "Category ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customeremail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customeremail'] = "Customer Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customername']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customername'] = "Customer Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customerphone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['labels']['customerphone'] = "Customer Phone"; 
       }
       //-----
       $this->comp_field_nm = array(
           'timeelapsedanswer' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_order']['q1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_order']['q1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_order']['q1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['summarizing_fields_display']['q1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_timeelapsedanswer as $i_timeelapsedanswer => $d_timeelapsedanswer) {
           if (!isset($i_timeelapsedanswer, $this->comp_label[0]) || !in_array($i_timeelapsedanswer, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_timeelapsedanswer[3] ] = $d_timeelapsedanswer[2];
               $this->comp_label[0][ $d_timeelapsedanswer[3] ] = $d_timeelapsedanswer[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'timeelapsedanswer', 'prot' => '@aspass@'),
       );
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_timeelapsedanswer => $l_timeelapsedanswer) {
           if (isset($this->array_total_timeelapsedanswer[$i_timeelapsedanswer])) {
               $this->comp_group[$i_timeelapsedanswer] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_timeelapsedanswer;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_tickets_time_answer@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_report_tickets_time_answer_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_report_tickets_time_answer_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['embutida'])
                   {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf_vert']) { 
       ...
       $apl_cab_resumo = "" . $this->Ini->Nm_lang['lang_tickets_by_time_close_title'] . "";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['ajax_nav'])
      {
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "report_tickets_time_answer_total.class.php"); 
      }
      ...
      $this->Total   = new report_tickets_time_answer_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_q1("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_filtro'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_fast'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_fast'] . ")";
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq_fast'] . ")";
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_q1("res", $this->NM_export, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_timeelapsedanswer)) {
          ksort($this->array_total_timeelapsedanswer);
      }
      $this->NM_res_sem_reg = true;
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_tickets_time_answer'] . "</TITLE>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_time_answer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_report_tickets_time_answer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_time_answer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "report_tickets_time_answer/report_tickets_time_answer_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['responsive_chart']['active']) {
          ...
          {
              $summary_width = "width=\"600px\"";
          }
      }
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_time_answer/report_tickets_time_answer_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=report_tickets_time_answer&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_time_answer/report_tickets_time_answer_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_time_answer/report_tickets_time_answer_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("report_tickets_time_answer_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['report_tickets_time_answer']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'report_tickets_time_answer_config_pivot.php?nome_apl=report_tickets_time_answer&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"report_tickets_time_answer.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"report_tickets_time_answer.php\"\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"report_tickets_time_answer_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" {\r\n");
      $nm_saida->saida("     document.FRES.action = \"report_tickets_time_answer.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_time_answer_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "report_tickets_time_answer/report_tickets_time_answer_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
           $tp_quebra .= "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_tickets_by_time_close_title'] . "</H1></div>";
       }
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new report_tickets_time_answer_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TABLE id=\"res_chart_table\" border=\"0px\" cellpadding=\"0px\" cellspacing=\"0px\" align=\"center\" valign=\"top\" " . $summary_width . ">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           report_tickets_time_answer_pdf_progress_call("\n", $this->Ini->Nm_lang);
           report_tickets_time_answer_pdf_progress_call("\n", $this->Ini->Nm_lang);
           report_tickets_time_answer_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   report_tickets_time_answer_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $ticketid = (isset($Busca_temp['ticketid'])) ? $Busca_temp['ticketid'] : ""; 
          $tmp_pos = (is_string($ticketid)) ? strpos($ticketid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticketid))
          {
              $ticketid = substr($ticketid, 0, $tmp_pos);
          }
          $ownerid = (isset($Busca_temp['ownerid'])) ? $Busca_temp['ownerid'] : ""; 
          $tmp_pos = (is_string($ownerid)) ? strpos($ownerid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ownerid))
          {
              $ownerid = substr($ownerid, 0, $tmp_pos);
          }
          $categoryid = (isset($Busca_temp['categoryid'])) ? $Busca_temp['categoryid'] : ""; 
          $tmp_pos = (is_string($categoryid)) ? strpos($categoryid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($categoryid))
          {
              $categoryid = substr($categoryid, 0, $tmp_pos);
          }
          $customeremail = (isset($Busca_temp['customeremail'])) ? $Busca_temp['customeremail'] : ""; 
          $tmp_pos = (is_string($customeremail)) ? strpos($customeremail, "##@@") : false;
          if ($tmp_pos !== false && !is_array($customeremail))
          {
              $customeremail = substr($customeremail, 0, $tmp_pos);
          }
      } 
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_time_answer']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_tickets_time_answer'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
   ...
   {
      //----- Time Elapsed Answer
      if (!isset($this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig]))
      {
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][0] = 1;
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][1] = 1;
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][2] = $quebra_timeelapsedanswer;
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][3] = $quebra_timeelapsedanswer_orig;
      }
      else
      {
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][0]++;
         $this->array_total_timeelapsedanswer[$quebra_timeelapsedanswer_orig][2]++;
      }
   }
   ...
   {
      if (isset($this->array_total_timeelapsedanswer))
      {
         $arr_temp_0 = $this->array_total_timeelapsedanswer;
         foreach ($this->array_total_timeelapsedanswer as $campo_timeelapsedanswer => $dados_timeelapsedanswer)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_timeelapsedanswer[$campo_timeelapsedanswer][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_timeelapsedanswer[$campo_timeelapsedanswer][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_timeelapsedanswer][$ind_missing][0] = 0;
                $arr_temp_0[$campo_timeelapsedanswer][$ind_missing][1] = 0;
                $arr_temp_0[$campo_timeelapsedanswer][$ind_missing][2] = $dados_timeelapsedanswer[$ind_exists][2];
                $arr_temp_0[$campo_timeelapsedanswer][$ind_missing][3] = $dados_timeelapsedanswer[$ind_exists][3];
            }
            ksort($arr_temp_0[$campo_timeelapsedanswer]);
            $this->array_total_timeelapsedanswer[$campo_timeelapsedanswer] = $arr_temp_0[$campo_timeelapsedanswer];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->ticketid = $Busca_temp['ticketid']; 
       $this->ticketid = (isset($Busca_temp['ticketid'])) ? $Busca_temp['ticketid'] : ""; 
       $tmp_pos = (is_string($this->ticketid)) ? strpos($this->ticketid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticketid))
       {
       ...
       $this->ownerid = $Busca_temp['ownerid']; 
       $this->ownerid = (isset($Busca_temp['ownerid'])) ? $Busca_temp['ownerid'] : ""; 
       $tmp_pos = (is_string($this->ownerid)) ? strpos($this->ownerid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ownerid))
       {
       ...
       $this->customeremail = $Busca_temp['customeremail']; 
       $this->customeremail = (isset($Busca_temp['customeremail'])) ? $Busca_temp['customeremail'] : ""; 
       $tmp_pos = (is_string($this->customeremail)) ? strpos($this->customeremail, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->customeremail))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('q1', 'timeelapsedanswer');
     $campos_order = $this->Ini->Get_date_order_groupby("timeelapsedanswer", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->timeelapsedanswer = $rs_res->fields[1] ;  
            $this->ownerid = $rs_res->fields[2] ;  
