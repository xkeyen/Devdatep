<?php  
  ...
  session_start() ;
  class form_ticketpriority_form_teste
  {
   function form_ticketpriority_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_ticketpriority/img";
...
<?php
  ...
  $frm_teste = new form_ticketpriority_form_teste();
  $frm_teste->form_ticketpriority_teste();
?>
