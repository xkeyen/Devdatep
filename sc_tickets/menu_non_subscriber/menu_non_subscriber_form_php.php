...
class menu_non_subscriber_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_non_subscriber']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_non_subscriber']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_non_subscriber']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      ...
      $this->nm_location .= "menu_non_subscriber.php"; 
      $this->menu_sc_init = 1;
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_non_subscriber']['sc_apl_link'];
...
';
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_non_subscriber")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_knowledge") . "/menu_knowledge.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_non_subscriber']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_non_subscriber'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_not_customer_open_ticket") . "/form_not_customer_open_ticket.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ctrl_tracking_tickets") . "/ctrl_tracking_tickets.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_knowledge") . "/menu_knowledge.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_knowledge_start") . "/menu_knowledge_start.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_kb_articles_search") . "/grid_kb_articles_search.php?nm_run_menu=1&nm_apl_menu=menu_non_subscriber&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_non_subscriber"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_non_subscriber")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_non_subscriber', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new menu_non_subscriber_form_php();
$controle->init();
?>
