<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tickets_admin']['sc_process_barr'] = true;
require_once('../grid_tickets_admin/index.php');
unset($_SESSION['scriptcase']['grid_tickets_admin']['sc_process_barr']);
$ExportCtrl = new grid_tickets_admin_export_control;
$ExportCtrl->Export_barr();

class grid_tickets_admin_export_control
{
