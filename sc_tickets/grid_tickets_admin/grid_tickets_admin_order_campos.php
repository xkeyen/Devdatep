<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tickets_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tickets_admin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tickets_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ticket_tickettrack'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_tickettrack'] = "ticket_tickettrack";
   }
   else
   {
       $tab_def_campos['ticket_tickettrack'] = "ticket.tickettrack";
   }
   $tab_labels["ticket_tickettrack"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_tickettrack"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_tickettrack"] : "" . $this->Nm_lang['lang_ticket_fild_tickettrack'] . "";
   $tab_ger_campos['ticket_ticketlastupdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_ticketlastupdate'] = "ticket_ticketlastupdate";
   }
   else
   {
       $tab_def_campos['ticket_ticketlastupdate'] = "ticket.ticketlastupdate";
   }
   $tab_labels["ticket_ticketlastupdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_ticketlastupdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_ticketlastupdate"] : "" . $this->Nm_lang['lang_ticket_fild_ticketlastupdate'] . "";
   $tab_ger_campos['customer_customername'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_customername'] = "customer_customername";
   }
   else
   {
       $tab_def_campos['customer_customername'] = "customer.customername";
   }
   $tab_labels["customer_customername"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["customer_customername"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["customer_customername"] : "" . $this->Nm_lang['lang_ticket_fild_customerid'] . "";
   $tab_ger_campos['staff_staffname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['staff_staffname'] = "staff_staffname";
   }
   else
   {
       $tab_def_campos['staff_staffname'] = "staff.staffname";
   }
   $tab_labels["staff_staffname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["staff_staffname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["staff_staffname"] : "" . $this->Nm_lang['lang_staff_fild_staffname'] . "";
   $tab_ger_campos['ticket_categoryid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_categoryid'] = "ticket_categoryid";
   }
   else
   {
       $tab_def_campos['ticket_categoryid'] = "ticket.categoryid";
   }
   $tab_labels["ticket_categoryid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_categoryid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_categoryid"] : "" . $this->Nm_lang['lang_ticket_fild_categoryid'] . "";
   $tab_ger_campos['ticket_subject'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_subject'] = "ticket_subject";
   }
   else
   {
       $tab_def_campos['ticket_subject'] = "ticket.subject";
   }
   $tab_labels["ticket_subject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_subject"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticket_subject"] : "" . $this->Nm_lang['lang_ticket_fild_subject'] . "";
   $tab_ger_campos['ticketpriority_priorityicon'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketpriority_priorityicon'] = "ticketpriority_priorityicon";
   }
   else
   {
       $tab_def_campos['ticketpriority_priorityicon'] = "ticketpriority.priorityicon";
   }
   $tab_labels["ticketpriority_priorityicon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketpriority_priorityicon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketpriority_priorityicon"] : "";
   $tab_ger_campos['ticketpriority_priorityname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketpriority_priorityname'] = "ticketpriority_priorityname";
   }
   else
   {
       $tab_def_campos['ticketpriority_priorityname'] = "ticketpriority.priorityname";
   }
   $tab_labels["ticketpriority_priorityname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketpriority_priorityname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketpriority_priorityname"] : "" . $this->Nm_lang['lang_ticketpriority_fild_priorityname'] . "";
   $tab_ger_campos['ticketstatus_statusicon'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketstatus_statusicon'] = "ticketstatus_statusicon";
   }
   else
   {
       $tab_def_campos['ticketstatus_statusicon'] = "ticketstatus.statusicon";
   }
   $tab_labels["ticketstatus_statusicon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketstatus_statusicon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketstatus_statusicon"] : "";
   $tab_ger_campos['ticketstatus_statusname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketstatus_statusname'] = "ticketstatus_statusname";
   }
   else
   {
       $tab_def_campos['ticketstatus_statusname'] = "ticketstatus.statusname";
   }
   $tab_labels["ticketstatus_statusname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketstatus_statusname"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["ticketstatus_statusname"] : "" . $this->Nm_lang['lang_ticketstatus_fild_statusname'] . "";
   $tab_ger_campos['link'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['link'] = "link";
   }
   else
   {
       $tab_def_campos['link'] = "";
   }
   $tab_labels["link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["link"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['labels']["link"] : " ";
   $tab_ger_campos['ticketpriority_priorityicon'] = "none";
   $tab_ger_campos['ticketstatus_statusicon'] = "none";
   $tab_ger_campos['link'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_admin_all_tickets'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tickets_admin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tickets_admin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
