<?php  
  ...
  session_start() ;
  class form_customer_edit_profile_form_teste
  {
   function form_customer_edit_profile_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customer_edit_profile/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customer_edit_profile</FONT></B> 
<br> 
<br> 
...
customerid&nbsp;&nbsp;<input type=text name=customerid size=20><br> 
<input type="submit" value="form_customer_edit_profile"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_customer_edit_profile_form_teste();
  $frm_teste->form_customer_edit_profile_teste();
?>
