  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_edit_profile" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_edit_profile_form();
	}
...
?>
  ...
  function do_ajax_form_customer_edit_profile_validate_customername()
  {
    var nomeCampo_customername = "customername";
    var var_customername = scAjaxGetFieldText(nomeCampo_customername);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_customername(var_customername, var_script_case_init, do_ajax_form_customer_edit_profile_validate_customername_cb);
  } // do_ajax_form_customer_edit_profile_validate_customername

  function do_ajax_form_customer_edit_profile_validate_customername_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customername";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_customername_cb

  // ---------- Validate customeremail
  function do_ajax_form_customer_edit_profile_validate_customeremail()
  {
    var nomeCampo_customeremail = "customeremail";
    var var_customeremail = scAjaxGetFieldText(nomeCampo_customeremail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_customeremail(var_customeremail, var_script_case_init, do_ajax_form_customer_edit_profile_validate_customeremail_cb);
  } // do_ajax_form_customer_edit_profile_validate_customeremail

  function do_ajax_form_customer_edit_profile_validate_customeremail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customeremail";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_customeremail_cb

  // ---------- Validate customerphone
  function do_ajax_form_customer_edit_profile_validate_customerphone()
  {
    var nomeCampo_customerphone = "customerphone";
    var var_customerphone = scAjaxGetFieldText(nomeCampo_customerphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_customerphone(var_customerphone, var_script_case_init, do_ajax_form_customer_edit_profile_validate_customerphone_cb);
  } // do_ajax_form_customer_edit_profile_validate_customerphone

  function do_ajax_form_customer_edit_profile_validate_customerphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customerphone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_customerphone_cb

  // ---------- Validate fld_new_password
  function do_ajax_form_customer_edit_profile_validate_fld_new_password()
  {
    var nomeCampo_fld_new_password = "fld_new_password";
    var var_fld_new_password = scAjaxGetFieldText(nomeCampo_fld_new_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_fld_new_password(var_fld_new_password, var_script_case_init, do_ajax_form_customer_edit_profile_validate_fld_new_password_cb);
  } // do_ajax_form_customer_edit_profile_validate_fld_new_password

  function do_ajax_form_customer_edit_profile_validate_fld_new_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_new_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_fld_new_password_cb

  // ---------- Validate fld_confirm_password
  function do_ajax_form_customer_edit_profile_validate_fld_confirm_password()
  {
    var nomeCampo_fld_confirm_password = "fld_confirm_password";
    var var_fld_confirm_password = scAjaxGetFieldText(nomeCampo_fld_confirm_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_fld_confirm_password(var_fld_confirm_password, var_script_case_init, do_ajax_form_customer_edit_profile_validate_fld_confirm_password_cb);
  } // do_ajax_form_customer_edit_profile_validate_fld_confirm_password

  function do_ajax_form_customer_edit_profile_validate_fld_confirm_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_confirm_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_fld_confirm_password_cb

  // ---------- Validate fld_to_change_password
  function do_ajax_form_customer_edit_profile_validate_fld_to_change_password()
  {
    var nomeCampo_fld_to_change_password = "fld_to_change_password";
    var var_fld_to_change_password = scAjaxGetFieldCheckbox(nomeCampo_fld_to_change_password, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_validate_fld_to_change_password(var_fld_to_change_password, var_script_case_init, do_ajax_form_customer_edit_profile_validate_fld_to_change_password_cb);
  } // do_ajax_form_customer_edit_profile_validate_fld_to_change_password

  function do_ajax_form_customer_edit_profile_validate_fld_to_change_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_to_change_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_validate_fld_to_change_password_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_edit_profile_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_edit_profile_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_customername = scAjaxGetFieldText("customername");
    var var_customeremail = scAjaxGetFieldText("customeremail");
    var var_customerphone = scAjaxGetFieldText("customerphone");
    var var_fld_new_password = scAjaxGetFieldText("fld_new_password");
    var var_fld_confirm_password = scAjaxGetFieldText("fld_confirm_password");
    var var_fld_to_change_password = scAjaxGetFieldCheckbox("fld_to_change_password", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_customer_edit_profile_submit_form(var_customername, var_customeremail, var_customerphone, var_fld_new_password, var_fld_confirm_password, var_fld_to_change_password, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_edit_profile_submit_form_cb);
  } // do_ajax_form_customer_edit_profile_submit_form

  function do_ajax_form_customer_edit_profile_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_edit_profile_submit_form_cb_after_alert);
  } // do_ajax_form_customer_edit_profile_submit_form_cb
  function do_ajax_form_customer_edit_profile_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_edit_profile_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_edit_profile_navigate_form()
  {
    perform_ajax_form_customer_edit_profile_navigate_form();
  }

  function perform_ajax_form_customer_edit_profile_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_customerid = document.F2.customerid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_edit_profile_navigate_form(var_customerid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_edit_profile_navigate_form_cb);
  } // do_ajax_form_customer_edit_profile_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_edit_profile']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_edit_profile_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.customerid.value = scAjaxGetKeyValue("customerid");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_edit_profile_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_edit_profile_navigate_form_cb
  function do_ajax_form_customer_edit_profile_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_customer_edit_profile_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_edit_profile_navigate_form_cb_after_alert

  function sc_hide_form_customer_edit_profile_form()
  {
  ...
  ajax_field_list[0] = "customername";
  ajax_field_list[1] = "customeremail";
  ajax_field_list[2] = "customerphone";
  ajax_field_list[3] = "fld_new_password";
  ajax_field_list[4] = "fld_confirm_password";
  ajax_field_list[5] = "fld_to_change_password";
  ...
  var ajax_error_list = {
    "customername": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customername'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customeremail": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customeremail'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customerphone": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customerphone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_new_password": {"label": "<?php echo $this->Ini->Nm_lang['lang_fld_new_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_confirm_password": {"label": "Confirm password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_to_change_password": {"label": "<?php echo $this->Ini->Nm_lang['lang_alert_to_change_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "customeremail": new Array(),
    "customerphone": new Array(),
    "fld_new_password": new Array(),
    "fld_confirm_password": new Array(),
    "fld_to_change_password": new Array()
  };
  ajax_field_mult["customername"][1] = "customername";
  ajax_field_mult["customeremail"][1] = "customeremail";
  ajax_field_mult["customerphone"][1] = "customerphone";
  ajax_field_mult["fld_new_password"][1] = "fld_new_password";
  ajax_field_mult["fld_confirm_password"][1] = "fld_confirm_password";
  ajax_field_mult["fld_to_change_password"][1] = "fld_to_change_password";

  var ajax_field_id = {
    "customername": new Array("hidden_field_label_customername", "hidden_field_data_customername"),
    "customeremail": new Array("hidden_field_label_customeremail", "hidden_field_data_customeremail"),
    "customerphone": new Array("hidden_field_label_customerphone", "hidden_field_data_customerphone"),
    "fld_new_password": new Array("hidden_field_label_fld_new_password", "hidden_field_data_fld_new_password"),
    "fld_confirm_password": new Array("hidden_field_label_fld_confirm_password", "hidden_field_data_fld_confirm_password"),
    "fld_to_change_password": new Array("hidden_field_label_fld_to_change_password", "hidden_field_data_fld_to_change_password")
  };
  ...
  var ajax_read_only = {
    ...
    "customeremail": "off",
    "customerphone": "off",
    "fld_new_password": "off",
    "fld_confirm_password": "off",
    "fld_to_change_password": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("fld_confirm_password" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("fld_to_change_password" == sIndex)
    {
