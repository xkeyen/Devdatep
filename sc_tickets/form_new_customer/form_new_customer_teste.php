<?php  
  ...
  session_start() ;
  class form_new_customer_form_teste
  {
   function form_new_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_new_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_new_customer</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_new_customer"> 
</form> 
<script language=javascript> 
 document.Fedit.customerid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_new_customer_form_teste();
  $frm_teste->form_new_customer_teste();
?>
