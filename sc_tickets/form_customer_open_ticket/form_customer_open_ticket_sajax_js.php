  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_open_ticket" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_open_ticket_form();
	}
...
?>
  ...
  function do_ajax_form_customer_open_ticket_validate_fld_category()
  {
    var nomeCampo_fld_category = "fld_category";
    var var_fld_category = scAjaxGetFieldSelect(nomeCampo_fld_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_fld_category(var_fld_category, var_script_case_init, do_ajax_form_customer_open_ticket_validate_fld_category_cb);
  } // do_ajax_form_customer_open_ticket_validate_fld_category

  function do_ajax_form_customer_open_ticket_validate_fld_category_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_fld_category_cb

  // ---------- Validate fld_subject
  function do_ajax_form_customer_open_ticket_validate_fld_subject()
  {
    var nomeCampo_fld_subject = "fld_subject";
    var var_fld_subject = scAjaxGetFieldText(nomeCampo_fld_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_fld_subject(var_fld_subject, var_script_case_init, do_ajax_form_customer_open_ticket_validate_fld_subject_cb);
  } // do_ajax_form_customer_open_ticket_validate_fld_subject

  function do_ajax_form_customer_open_ticket_validate_fld_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_fld_subject_cb

  // ---------- Validate ticketcontent
  function do_ajax_form_customer_open_ticket_validate_ticketcontent()
  {
    var nomeCampo_ticketcontent = "ticketcontent";
    var var_ticketcontent = scAjaxGetFieldEditorHtml(nomeCampo_ticketcontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_ticketcontent(var_ticketcontent, var_script_case_init, do_ajax_form_customer_open_ticket_validate_ticketcontent_cb);
  } // do_ajax_form_customer_open_ticket_validate_ticketcontent

  function do_ajax_form_customer_open_ticket_validate_ticketcontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_ticketcontent_cb

  // ---------- Validate fld_priority
  function do_ajax_form_customer_open_ticket_validate_fld_priority()
  {
    var nomeCampo_fld_priority = "fld_priority";
    var var_fld_priority = scAjaxGetFieldSelect(nomeCampo_fld_priority);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_fld_priority(var_fld_priority, var_script_case_init, do_ajax_form_customer_open_ticket_validate_fld_priority_cb);
  } // do_ajax_form_customer_open_ticket_validate_fld_priority

  function do_ajax_form_customer_open_ticket_validate_fld_priority_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_fld_priority_cb

  // ---------- Validate ticketfile1
  function do_ajax_form_customer_open_ticket_validate_ticketfile1()
  {
    var nomeCampo_ticketfile1 = "ticketfile1";
    var var_ticketfile1 = scAjaxGetFieldText(nomeCampo_ticketfile1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_ticketfile1(var_ticketfile1, var_script_case_init, do_ajax_form_customer_open_ticket_validate_ticketfile1_cb);
  } // do_ajax_form_customer_open_ticket_validate_ticketfile1

  function do_ajax_form_customer_open_ticket_validate_ticketfile1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_ticketfile1_cb

  // ---------- Validate ticketfile2
  function do_ajax_form_customer_open_ticket_validate_ticketfile2()
  {
    var nomeCampo_ticketfile2 = "ticketfile2";
    var var_ticketfile2 = scAjaxGetFieldText(nomeCampo_ticketfile2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_ticketfile2(var_ticketfile2, var_script_case_init, do_ajax_form_customer_open_ticket_validate_ticketfile2_cb);
  } // do_ajax_form_customer_open_ticket_validate_ticketfile2

  function do_ajax_form_customer_open_ticket_validate_ticketfile2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_ticketfile2_cb

  // ---------- Validate ticketfile3
  function do_ajax_form_customer_open_ticket_validate_ticketfile3()
  {
    var nomeCampo_ticketfile3 = "ticketfile3";
    var var_ticketfile3 = scAjaxGetFieldText(nomeCampo_ticketfile3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_open_ticket_validate_ticketfile3(var_ticketfile3, var_script_case_init, do_ajax_form_customer_open_ticket_validate_ticketfile3_cb);
  } // do_ajax_form_customer_open_ticket_validate_ticketfile3

  function do_ajax_form_customer_open_ticket_validate_ticketfile3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_open_ticket_validate_ticketfile3_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_open_ticket_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_open_ticket_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_customer_open_ticket_submit_form(var_fld_category, var_fld_subject, var_ticketcontent, var_fld_priority, var_ticketfile1, var_ticketfile2, var_ticketfile3, var_ticketfile1_ul_name, var_ticketfile1_ul_type, var_ticketfile2_ul_name, var_ticketfile2_ul_type, var_ticketfile3_ul_name, var_ticketfile3_ul_type, var_ticketfile1_limpa, var_ticketfile2_limpa, var_ticketfile3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_open_ticket_submit_form_cb);
  } // do_ajax_form_customer_open_ticket_submit_form

  function do_ajax_form_customer_open_ticket_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_open_ticket_submit_form_cb_after_alert);
  } // do_ajax_form_customer_open_ticket_submit_form_cb
  function do_ajax_form_customer_open_ticket_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_open_ticket_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_open_ticket_navigate_form()
  {
    perform_ajax_form_customer_open_ticket_navigate_form();
  }

  function perform_ajax_form_customer_open_ticket_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_open_ticket_navigate_form(var_ticketmessageid, var_ticketid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_open_ticket_navigate_form_cb);
  } // do_ajax_form_customer_open_ticket_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_open_ticket_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_open_ticket_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_open_ticket_navigate_form_cb
  function do_ajax_form_customer_open_ticket_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_customer_open_ticket_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_open_ticket_navigate_form_cb_after_alert

  function sc_hide_form_customer_open_ticket_form()
  {
