<?php  
  ...
  session_start() ;
  class form_customer_ticket_send_message_form_teste
  {
   function form_customer_ticket_send_message_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customer_ticket_send_message/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customer_ticket_send_message</FONT></B> 
<br> 
<br> 
...
v_ticketid&nbsp;&nbsp;<input type="text" name="v_ticketid" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
ticketmessageid&nbsp;&nbsp;<input type=text name=ticketmessageid size=20><br> 
ticketid&nbsp;&nbsp;<input type=text name=ticketid size=20><br> 
<input type="submit" value="form_customer_ticket_send_message"> 
</form> 
<script language=javascript> 
 document.Fedit.v_ticketid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_customer_ticket_send_message_form_teste();
  $frm_teste->form_customer_ticket_send_message_teste();
?>
