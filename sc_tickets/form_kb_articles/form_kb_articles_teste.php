<?php  
  ...
  session_start() ;
  class form_kb_articles_form_teste
  {
   function form_kb_articles_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_kb_articles/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_kb_articles</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_kb_articles"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_kb_articles_form_teste();
  $frm_teste->form_kb_articles_teste();
?>
