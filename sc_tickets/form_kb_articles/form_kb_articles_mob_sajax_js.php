  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kb_articles_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_kb_articles_mob_form();
	}
...
?>
  ...
  // ---------- Validate categoryid
  function do_ajax_form_kb_articles_mob_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldSelect(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articles_mob_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_kb_articles_mob_validate_categoryid_cb);
  } // do_ajax_form_kb_articles_mob_validate_categoryid

  function do_ajax_form_kb_articles_mob_validate_categoryid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articles_mob_validate_categoryid_cb

  // ---------- Validate articletypeid
  function do_ajax_form_kb_articles_mob_validate_articletypeid()
  {
    var nomeCampo_articletypeid = "articletypeid";
    var var_articletypeid = scAjaxGetFieldRadio(nomeCampo_articletypeid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articles_mob_validate_articletypeid(var_articletypeid, var_script_case_init, do_ajax_form_kb_articles_mob_validate_articletypeid_cb);
  } // do_ajax_form_kb_articles_mob_validate_articletypeid

  function do_ajax_form_kb_articles_mob_validate_articletypeid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "articletypeid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articles_mob_validate_articletypeid_cb

  // ---------- Validate articlesubject
  function do_ajax_form_kb_articles_mob_validate_articlesubject()
  {
    var nomeCampo_articlesubject = "articlesubject";
    var var_articlesubject = scAjaxGetFieldText(nomeCampo_articlesubject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articles_mob_validate_articlesubject(var_articlesubject, var_script_case_init, do_ajax_form_kb_articles_mob_validate_articlesubject_cb);
  } // do_ajax_form_kb_articles_mob_validate_articlesubject

  function do_ajax_form_kb_articles_mob_validate_articlesubject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "articlesubject";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articles_mob_validate_articlesubject_cb

  // ---------- Validate articlecontent
  function do_ajax_form_kb_articles_mob_validate_articlecontent()
  {
    var nomeCampo_articlecontent = "articlecontent";
    var var_articlecontent = scAjaxGetFieldEditorHtml(nomeCampo_articlecontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articles_mob_validate_articlecontent(var_articlecontent, var_script_case_init, do_ajax_form_kb_articles_mob_validate_articlecontent_cb);
  } // do_ajax_form_kb_articles_mob_validate_articlecontent

  function do_ajax_form_kb_articles_mob_validate_articlecontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "articlecontent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articles_mob_validate_articlecontent_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_kb_articles_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_kb_articles_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_categoryid = scAjaxGetFieldSelect("categoryid");
    var var_articletypeid = scAjaxGetFieldRadio("articletypeid");
    var var_articlesubject = scAjaxGetFieldText("articlesubject");
    var var_articlecontent = scAjaxGetFieldEditorHtml("articlecontent");
    var var_articlesid = scAjaxGetFieldText("articlesid");
    ...
    scAjaxProcOn();
    x_ajax_form_kb_articles_mob_submit_form(var_categoryid, var_articletypeid, var_articlesubject, var_articlecontent, var_articlesid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_kb_articles_mob_submit_form_cb);
  } // do_ajax_form_kb_articles_mob_submit_form

  function do_ajax_form_kb_articles_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_kb_articles_mob_submit_form_cb_after_alert);
  } // do_ajax_form_kb_articles_mob_submit_form_cb
  function do_ajax_form_kb_articles_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kb_articles_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kb_articles_mob_navigate_form()
  {
    perform_ajax_form_kb_articles_mob_navigate_form();
  }

  function perform_ajax_form_kb_articles_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_articlesid = document.F2.articlesid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_kb_articles_mob_navigate_form(var_articlesid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kb_articles_mob_navigate_form_cb);
  } // do_ajax_form_kb_articles_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kb_articles_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kb_articles_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.articlesid.value = scAjaxGetKeyValue("articlesid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kb_articles_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_kb_articles_mob_navigate_form_cb
  function do_ajax_form_kb_articles_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_kb_articles_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_kb_articles_mob_navigate_form_cb_after_alert

  function sc_hide_form_kb_articles_mob_form()
  {
  ...
  ajax_field_list[1] = "articletypeid";
  ajax_field_list[2] = "articlesubject";
  ajax_field_list[3] = "articlecontent";
  ...
  var ajax_error_list = {
    "categoryid": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articles_fild_categoryid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "articletypeid": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articles_fild_articletypeid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "articlesubject": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articles_fild_articlesubject'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "articlecontent": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articles_fild_articlecontent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "articletypeid": new Array(),
    "articlesubject": new Array(),
    "articlecontent": new Array()
  };
  ajax_field_mult["categoryid"][1] = "categoryid";
  ajax_field_mult["articletypeid"][1] = "articletypeid";
  ajax_field_mult["articlesubject"][1] = "articlesubject";
  ajax_field_mult["articlecontent"][1] = "articlecontent";

  var ajax_field_id = {
    "categoryid": new Array("hidden_field_label_categoryid", "hidden_field_data_categoryid"),
    "articletypeid": new Array("hidden_field_label_articletypeid", "hidden_field_data_articletypeid"),
    "articlesubject": new Array("hidden_field_label_articlesubject", "hidden_field_data_articlesubject"),
    "articlecontent": new Array("hidden_field_label_articlecontent", "hidden_field_data_articlecontent")
  };
