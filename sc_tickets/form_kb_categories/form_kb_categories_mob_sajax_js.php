  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kb_categories_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_kb_categories_mob_form();
	}
...
?>
  ...
  // ---------- Validate categoryid
  function do_ajax_form_kb_categories_mob_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldHidden(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_mob_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_kb_categories_mob_validate_categoryid_cb);
  } // do_ajax_form_kb_categories_mob_validate_categoryid

  function do_ajax_form_kb_categories_mob_validate_categoryid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_mob_validate_categoryid_cb

  // ---------- Validate categoryname
  function do_ajax_form_kb_categories_mob_validate_categoryname()
  {
    var nomeCampo_categoryname = "categoryname";
    var var_categoryname = scAjaxGetFieldText(nomeCampo_categoryname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_mob_validate_categoryname(var_categoryname, var_script_case_init, do_ajax_form_kb_categories_mob_validate_categoryname_cb);
  } // do_ajax_form_kb_categories_mob_validate_categoryname

  function do_ajax_form_kb_categories_mob_validate_categoryname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoryname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_mob_validate_categoryname_cb

  // ---------- Validate categoryparent
  function do_ajax_form_kb_categories_mob_validate_categoryparent()
  {
    var nomeCampo_categoryparent = "categoryparent";
    var var_categoryparent = scAjaxGetFieldSelect(nomeCampo_categoryparent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_mob_validate_categoryparent(var_categoryparent, var_script_case_init, do_ajax_form_kb_categories_mob_validate_categoryparent_cb);
  } // do_ajax_form_kb_categories_mob_validate_categoryparent

  function do_ajax_form_kb_categories_mob_validate_categoryparent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoryparent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_mob_validate_categoryparent_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_kb_categories_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_kb_categories_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_categoryid = scAjaxGetFieldHidden("categoryid");
    var var_categoryname = scAjaxGetFieldText("categoryname");
    var var_categoryparent = scAjaxGetFieldSelect("categoryparent");
    ...
    scAjaxProcOn();
    x_ajax_form_kb_categories_mob_submit_form(var_categoryid, var_categoryname, var_categoryparent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_kb_categories_mob_submit_form_cb);
  } // do_ajax_form_kb_categories_mob_submit_form

  function do_ajax_form_kb_categories_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_kb_categories_mob_submit_form_cb_after_alert);
  } // do_ajax_form_kb_categories_mob_submit_form_cb
  function do_ajax_form_kb_categories_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kb_categories_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kb_categories_mob_navigate_form()
  {
    perform_ajax_form_kb_categories_mob_navigate_form();
  }

  function perform_ajax_form_kb_categories_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_kb_categories_mob_navigate_form(var_categoryid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kb_categories_mob_navigate_form_cb);
  } // do_ajax_form_kb_categories_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kb_categories_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kb_categories_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kb_categories_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_kb_categories_mob_navigate_form_cb
  function do_ajax_form_kb_categories_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_kb_categories_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_kb_categories_mob_navigate_form_cb_after_alert

  function sc_hide_form_kb_categories_mob_form()
  {
  ...
  ajax_field_list[1] = "categoryname";
  ajax_field_list[2] = "categoryparent";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "categoryid": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_categories_fild_categoryid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categoryname": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_categories_fild_categoryname'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categoryparent": {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_categories_fild_categoryparent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "categoryparent": new Array()
  };
  ajax_field_mult["categoryid"][1] = "categoryid";
  ajax_field_mult["categoryname"][1] = "categoryname";
  ajax_field_mult["categoryparent"][1] = "categoryparent";

  var ajax_field_id = {
    "categoryid": new Array("hidden_field_label_categoryid", "hidden_field_data_categoryid"),
    "categoryname": new Array("hidden_field_label_categoryname", "hidden_field_data_categoryname"),
    "categoryparent": new Array("hidden_field_label_categoryparent", "hidden_field_data_categoryparent")
  };
