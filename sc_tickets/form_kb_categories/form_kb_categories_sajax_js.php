  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kb_categories" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_kb_categories_form();
	}
...
?>
  ...
  // ---------- Validate categoryid
  function do_ajax_form_kb_categories_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldHidden(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_kb_categories_validate_categoryid_cb);
  } // do_ajax_form_kb_categories_validate_categoryid

  function do_ajax_form_kb_categories_validate_categoryid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_validate_categoryid_cb

  // ---------- Validate categoryname
  function do_ajax_form_kb_categories_validate_categoryname()
  {
    var nomeCampo_categoryname = "categoryname";
    var var_categoryname = scAjaxGetFieldText(nomeCampo_categoryname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_validate_categoryname(var_categoryname, var_script_case_init, do_ajax_form_kb_categories_validate_categoryname_cb);
  } // do_ajax_form_kb_categories_validate_categoryname

  function do_ajax_form_kb_categories_validate_categoryname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_validate_categoryname_cb

  // ---------- Validate categoryparent
  function do_ajax_form_kb_categories_validate_categoryparent()
  {
    var nomeCampo_categoryparent = "categoryparent";
    var var_categoryparent = scAjaxGetFieldSelect(nomeCampo_categoryparent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_categories_validate_categoryparent(var_categoryparent, var_script_case_init, do_ajax_form_kb_categories_validate_categoryparent_cb);
  } // do_ajax_form_kb_categories_validate_categoryparent

  function do_ajax_form_kb_categories_validate_categoryparent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_categories_validate_categoryparent_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_kb_categories_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_kb_categories_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_kb_categories_submit_form(var_categoryid, var_categoryname, var_categoryparent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_kb_categories_submit_form_cb);
  } // do_ajax_form_kb_categories_submit_form

  function do_ajax_form_kb_categories_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_kb_categories_submit_form_cb_after_alert);
  } // do_ajax_form_kb_categories_submit_form_cb
  function do_ajax_form_kb_categories_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kb_categories_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kb_categories_navigate_form()
  {
    perform_ajax_form_kb_categories_navigate_form();
  }

  function perform_ajax_form_kb_categories_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_kb_categories_navigate_form(var_categoryid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kb_categories_navigate_form_cb);
  } // do_ajax_form_kb_categories_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kb_categories']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kb_categories_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kb_categories_navigate_form_cb_after_alert);
  } // do_ajax_form_kb_categories_navigate_form_cb
  function do_ajax_form_kb_categories_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_kb_categories_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_kb_categories_navigate_form_cb_after_alert

  function sc_hide_form_kb_categories_form()
  {
