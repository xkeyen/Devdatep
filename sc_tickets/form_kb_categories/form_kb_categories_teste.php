<?php  
  ...
  session_start() ;
  class form_kb_categories_form_teste
  {
   function form_kb_categories_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_kb_categories/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_kb_categories</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_kb_categories"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_kb_categories_form_teste();
  $frm_teste->form_kb_categories_teste();
?>
