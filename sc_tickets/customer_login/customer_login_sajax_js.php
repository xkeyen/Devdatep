  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_customer_login" == sTestField)
        {
...
?>
  ...
  // ---------- Validate password
  function do_ajax_customer_login_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_customer_login_validate_password(var_password, var_script_case_init, do_ajax_customer_login_validate_password_cb);
  } // do_ajax_customer_login_validate_password

  function do_ajax_customer_login_validate_password_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_customer_login_validate_password_cb

  // ---------- Validate user
  function do_ajax_customer_login_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_customer_login_validate_user(var_user, var_script_case_init, do_ajax_customer_login_validate_user_cb);
  } // do_ajax_customer_login_validate_user

  function do_ajax_customer_login_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_customer_login_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_customer_login_submit_form()
  {
    scAjaxHideMessage();
    ...
    x_ajax_customer_login_submit_form(var_password, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_customer_login_submit_form_cb);
  } // do_ajax_customer_login_submit_form

  function do_ajax_customer_login_submit_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_customer_login_submit_form_cb_after_alert);
  } // do_ajax_customer_login_submit_form_cb
  function do_ajax_customer_login_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_customer_login_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_customer_login_navigate_form()
  {
    perform_ajax_customer_login_navigate_form();
  }

  function perform_ajax_customer_login_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_customer_login_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_customer_login_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_customer_login_navigate_form_cb_after_alert);
  } // do_ajax_customer_login_navigate_form_cb
  function do_ajax_customer_login_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_customer_login_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_customer_login_navigate_form_cb_after_alert

  function sc_hide_customer_login_form()
  {
  ...
  var ajax_error_list = {
    "password": {"label": "Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "user": {"label": "User", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
