<?php  
  ...
  session_start() ;
  class customer_login_form_teste
  {
   function customer_login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "customer_login/img";
...
?> 
<br> 
<B><FONT SIZE="4">customer_login</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="customer_login"> 
</form> 
...
<?php
  ...
  $frm_teste = new customer_login_form_teste();
  $frm_teste->customer_login_teste();
?>
