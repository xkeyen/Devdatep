...
$old_error_handler = set_error_handler("customer_login_scriptcase_error_handler");

function customer_login_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['customer_login']['contr_erro']) && $_SESSION['scriptcase']['customer_login']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_customer_login->contr_customer_login->Apl_com_erro = true;
            if ($inicial_customer_login->contr_customer_login->NM_ajax_flag)
            {
                $inicial_customer_login->contr_customer_login->NM_ajax_info['errList']['geral_customer_login'][] = $msg;
                return;
            }
            customer_login_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function customer_login_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['customer_login'])  && '' != $_SESSION['scriptcase']['error_icon']['customer_login'])  ? $_SESSION['scriptcase']['error_icon']['customer_login']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['customer_login']) && '' != $_SESSION['scriptcase']['error_span_title']['customer_login']) ? $_SESSION['scriptcase']['error_span_title']['customer_login'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['customer_login']) && '' != $_SESSION['scriptcase']['error_icon_title']['customer_login']) ? $_SESSION['scriptcase']['error_icon_title']['customer_login'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['customer_login']['error_buffer'] .= ob_get_flush();
}
