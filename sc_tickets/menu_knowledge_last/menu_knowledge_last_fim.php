   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="menu_knowledge_last.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____menu_knowledge_last"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____menu_knowledge_last"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>menu_knowledge_last</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['menu_knowledge_last']['embutida_filho'] as $ind => $sc_init)
          {
