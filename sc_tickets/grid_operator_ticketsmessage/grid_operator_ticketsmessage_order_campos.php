<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_operator_ticketsmessage']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_operator_ticketsmessage_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_operator_ticketsmessage_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ticketdate'] = "on";
   $tab_def_campos['ticketdate'] = "ticketdate";
   $tab_labels["ticketdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketdate"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketdate'] . "";
   $tab_ger_campos['messagetype'] = "on";
   $tab_def_campos['messagetype'] = "messagetype";
   $tab_labels["messagetype"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagetype"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagetype"] : "" . $this->Nm_lang['lang_ticketmessage_fild_messagetype'] . "";
   ...
   {
       $tab_def_campos['messagestatus'] = "statusid";
   }
   $tab_labels["messagestatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagestatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagestatus"] : "" . $this->Nm_lang['lang_ticket_fild_statusid'] . "";
   $tab_ger_campos['operatorid'] = "on";
   $tab_def_campos['operatorid'] = "operatorid";
   $tab_labels["operatorid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["operatorid"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["operatorid"] : "" . $this->Nm_lang['lang_ticketmessage_fild_operatorid'] . "";
   $tab_ger_campos['ticketcontent'] = "on";
   $tab_def_campos['ticketcontent'] = "ticketcontent";
   $tab_labels["ticketcontent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketcontent"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketcontent"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketcontent'] . "";
   $tab_ger_campos['messagenote'] = "on";
   $tab_def_campos['messagenote'] = "messagenote";
   $tab_labels["messagenote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagenote"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["messagenote"] : "MessageNote";
   $tab_ger_campos['ticketfile1'] = "on";
   $tab_def_campos['ticketfile1'] = "ticketfile1";
   $tab_labels["ticketfile1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile1"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile1"] : "";
   $tab_ger_campos['ticketfile2'] = "on";
   $tab_def_campos['ticketfile2'] = "ticketfile2";
   $tab_labels["ticketfile2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile2"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile2"] : "";
   $tab_ger_campos['ticketfile3'] = "on";
   $tab_def_campos['ticketfile3'] = "ticketfile3";
   $tab_labels["ticketfile3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile3"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['labels']["ticketfile3"] : "";
   $tab_ger_campos['ticketcontent'] = "none";
   $tab_ger_campos['ticketfile1'] = "none";
   $tab_ger_campos['ticketfile2'] = "none";
   $tab_ger_campos['ticketfile3'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsmessage']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsmessage']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsmessage']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tble_ticketmessage'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_operator_ticketsmessage_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsmessage']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
