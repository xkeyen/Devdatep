<?php
@session_start() ;
$_SESSION['scriptcase']['grid_operator_ticketsmessage']['sc_process_barr'] = true;
require_once('../grid_operator_ticketsmessage/index.php');
unset($_SESSION['scriptcase']['grid_operator_ticketsmessage']['sc_process_barr']);
$ExportCtrl = new grid_operator_ticketsmessage_export_control;
$ExportCtrl->Export_barr();

class grid_operator_ticketsmessage_export_control
{
