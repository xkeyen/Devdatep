<?php  
  ...
  session_start() ;
  class grid_operator_ticketsmessage_form_teste
  {
  function grid_operator_ticketsmessage_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_operator_ticketsmessage</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_operator_ticketsmessage"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_operator_ticketsmessage_form_teste();
  $frm_teste->grid_operator_ticketsmessage_teste();
?>
