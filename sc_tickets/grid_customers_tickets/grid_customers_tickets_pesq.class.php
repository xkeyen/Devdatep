...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_customer_mytickets'] ?></TITLE>
...
<INPUT  type="text" id="SC_ticket_tickettrack" name="ticket_tickettrack" value="<?php echo NM_encode_input($ticket_tickettrack) ?>"  size=7 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_ticket_ticketpriorityid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ticket_ticketpriorityid'])) ? $this->New_label['ticket_ticketpriorityid'] : "" . $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityname'] . ""; ?></TD>
...
?>
      ...
      <TD id='SC_ticketstatus_statusid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ticketstatus_statusid'])) ? $this->New_label['ticketstatus_statusid'] : "" . $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] . ""; ?></TD>
     ...
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticketstatus_statusid" <?php echo $str_hide_ticketstatus_statusid?> valign="top">
