<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_customers_tickets']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_customers_tickets_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_customers_tickets_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ticket_ticketid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_ticketid'] = "ticket_ticketid";
   }
   else
   {
       $tab_def_campos['ticket_ticketid'] = "ticket.ticketid";
   }
   $tab_labels["ticket_ticketid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketid"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketid"] : "" . $this->Nm_lang['lang_ticket_fild_ticketid'] . "";
   ...
   $tab_labels["ticket_tickettrack"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_tickettrack"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_tickettrack"] : "" . $this->Nm_lang['lang_ticket_fild_tickettrack'] . "";
   $tab_ger_campos['ticket_ticketdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_ticketdate'] = "ticket_ticketdate";
   }
   else
   {
       $tab_def_campos['ticket_ticketdate'] = "ticket.ticketdate";
   }
   $tab_labels["ticket_ticketdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketdate"] : "" . $this->Nm_lang['lang_ticket_fild_ticketdate'] . "";
   ...
   $tab_labels["ticket_subject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_subject"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_subject"] : "" . $this->Nm_lang['lang_ticket_fild_subject'] . "";
   ...
   $tab_labels["staff_staffname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["staff_staffname"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["staff_staffname"] : "" . $this->Nm_lang['lang_staff_fild_staffname'] . "";
   ...
   $tab_labels["ticket_ticketlastupdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketlastupdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketlastupdate"] : "" . $this->Nm_lang['lang_ticket_fild_ticketlastupdate'] . "";
   ...
   $tab_labels["ticketpriority_priorityicon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketpriority_priorityicon"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketpriority_priorityicon"] : "";
   $tab_ger_campos['ticket_ticketpriorityid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_ticketpriorityid'] = "ticket_ticketpriorityid";
   }
   else
   {
       $tab_def_campos['ticket_ticketpriorityid'] = "ticket.ticketpriorityid";
   }
   $tab_labels["ticket_ticketpriorityid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketpriorityid"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticket_ticketpriorityid"] : "" . $this->Nm_lang['lang_ticketpriority_fild_priorityname'] . "";
   ...
   $tab_labels["ticketstatus_statusicon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketstatus_statusicon"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketstatus_statusicon"] : "";
   ...
   $tab_labels["ticketstatus_statusname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketstatus_statusname"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['labels']["ticketstatus_statusname"] : "" . $this->Nm_lang['lang_ticketstatus_fild_statusname'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_customer_mytickets'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_customers_tickets_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customers_tickets']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
