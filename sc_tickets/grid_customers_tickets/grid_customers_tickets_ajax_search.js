...
function ajax_delete_filter(parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "grid_customers_tickets.php",
...
Table_sv_fil[0] = "ticket_tickettrack";
Table_sv_fil[1] = "ticket_ticketpriorityid";
Table_sv_fil[2] = "ticketstatus_statusid";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_ticket_ticketdate_cond") && search_get_sel_txt("SC_ticket_ticketdate_cond").substring(0, 3) == "bi_") {
            formata_bi_ticket_ticketdate(search_get_sel_txt("SC_ticket_ticketdate_cond"), SC_ticket_ticketdate_bi_opc, SC_ticket_ticketdate_bi_dt);
        }
