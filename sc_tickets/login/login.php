...
//
   ...
   $_SESSION['scriptcase']['login']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['login']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['login']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
...
';
      ...
      {
          $inicial_login->contr_login->NM_ajax_info['redir']['action']  = "login.php";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'sc_tickets', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'sc_tickets', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"));
        }
        if (isset($apl_def)) {
            if ($apl_def[0] != "login") {
            ...
            if (isset($_COOKIE['sc_actual_lang_sc_tickets'])) {
                $_SESSION['scriptcase']['login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_sc_tickets'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_login_validate_email' == $_POST['rs'])
        {
    ...
    sajax_export("ajax_login_validate_email");
...
//
    ...
    function ajax_login_validate_email($email, $script_case_init)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
        $inicial_login->contr_login->NM_ajax_opcao         = 'validate_email';
        $inicial_login->contr_login->NM_ajax_info['param'] = array(
    ...
    function ajax_login_submit_form($password, $email, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
...
//---
   ...
   function login_pack_ajax_nav_Summary(&$aResp)
   {
      ...
      $aResp['navSummary']['summary_line'] = $inicial_login->contr_login->NM_ajax_info['summary_line'];
