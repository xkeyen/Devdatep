...
?>
  ...
  // ---------- Validate email
  function do_ajax_login_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_email(var_email, var_script_case_init, do_ajax_login_validate_email_cb);
  } // do_ajax_login_validate_email

  function do_ajax_login_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_email_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_login_submit_form()
  {
    ...
    x_ajax_login_submit_form(var_password, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_submit_form_cb);
