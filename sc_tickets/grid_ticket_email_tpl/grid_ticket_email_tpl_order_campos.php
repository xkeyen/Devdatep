...
<?php
   ...
   $Ord_Cmp = new grid_ticket_email_tpl_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ticket_email_tpl_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ticketlanguage'] = "ticketlanguage";
   $tab_labels["ticketlanguage"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["ticketlanguage"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["ticketlanguage"] : "Ticketlanguage";
   $tab_ger_campos['usertype'] = "on";
   $tab_def_campos['usertype'] = "usertype";
   $tab_labels["usertype"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["usertype"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["usertype"] : "" . $this->Nm_lang['lang_ticket_email_tpl_fild_usertype'] . "";
   $tab_ger_campos['statusid'] = "on";
   $tab_def_campos['statusid'] = "statusid";
   $tab_labels["statusid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["statusid"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["statusid"] : "" . $this->Nm_lang['lang_ticket_email_tpl_fild_statusid'] . "";
   $tab_ger_campos['title'] = "on";
   $tab_def_campos['title'] = "title";
   $tab_labels["title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["title"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["title"] : "" . $this->Nm_lang['lang_ticket_email_tpl_fild_title'] . "";
   $tab_ger_campos['enabled'] = "on";
   $tab_def_campos['enabled'] = "enabled";
   $tab_labels["enabled"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["enabled"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['labels']["enabled"] : "" . $this->Nm_lang['lang_ticket_email_tpl_fild_enabled'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ticket_email_tpl_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ticket_email_tpl']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
