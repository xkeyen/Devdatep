<?php  
  ...
  session_start() ;
  class ctrl_confirm_acount_creation_form_teste
  {
   function ctrl_confirm_acount_creation_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ctrl_confirm_acount_creation/img";
...
?> 
<br> 
<B><FONT SIZE="4">ctrl_confirm_acount_creation</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="ctrl_confirm_acount_creation"> 
</form> 
...
<?php
  ...
  $frm_teste = new ctrl_confirm_acount_creation_form_teste();
  $frm_teste->ctrl_confirm_acount_creation_teste();
?>
