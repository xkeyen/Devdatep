...
$old_error_handler = set_error_handler("ctrl_confirm_acount_creation_scriptcase_error_handler");

function ctrl_confirm_acount_creation_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['ctrl_confirm_acount_creation']['contr_erro']) && $_SESSION['scriptcase']['ctrl_confirm_acount_creation']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ctrl_confirm_acount_creation->contr_ctrl_confirm_acount_creation->Apl_com_erro = true;
            if ($inicial_ctrl_confirm_acount_creation->contr_ctrl_confirm_acount_creation->NM_ajax_flag)
            {
                $inicial_ctrl_confirm_acount_creation->contr_ctrl_confirm_acount_creation->NM_ajax_info['errList']['geral_ctrl_confirm_acount_creation'][] = $msg;
                return;
            }
            ctrl_confirm_acount_creation_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ctrl_confirm_acount_creation_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation'])  && '' != $_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation'])  ? $_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ctrl_confirm_acount_creation']) && '' != $_SESSION['scriptcase']['error_close']['ctrl_confirm_acount_creation']) ? $_SESSION['scriptcase']['error_close']['ctrl_confirm_acount_creation'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation']) && '' != $_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation']) ? $_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation']) && '' != $_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation']) ? $_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['ctrl_confirm_acount_creation']['error_buffer'] .= ob_get_flush();
}
