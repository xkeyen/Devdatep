<?php
@session_start() ;
$_SESSION['scriptcase']['menu_knowledge_start']['sc_process_barr'] = true;
require_once('../menu_knowledge_start/index.php');
unset($_SESSION['scriptcase']['menu_knowledge_start']['sc_process_barr']);
$ExportCtrl = new menu_knowledge_start_export_control;
$ExportCtrl->Export_barr();

class menu_knowledge_start_export_control
{
