  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ticket_email_tpl" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ticket_email_tpl_form();
	}
...
?>
  ...
  // ---------- Validate usertype
  function do_ajax_form_ticket_email_tpl_validate_usertype()
  {
    var nomeCampo_usertype = "usertype";
    var var_usertype = scAjaxGetFieldRadio(nomeCampo_usertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_validate_usertype(var_usertype, var_script_case_init, do_ajax_form_ticket_email_tpl_validate_usertype_cb);
  } // do_ajax_form_ticket_email_tpl_validate_usertype

  function do_ajax_form_ticket_email_tpl_validate_usertype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usertype";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_validate_usertype_cb

  // ---------- Validate statusid
  function do_ajax_form_ticket_email_tpl_validate_statusid()
  {
    var nomeCampo_statusid = "statusid";
    var var_statusid = scAjaxGetFieldSelect(nomeCampo_statusid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_validate_statusid(var_statusid, var_script_case_init, do_ajax_form_ticket_email_tpl_validate_statusid_cb);
  } // do_ajax_form_ticket_email_tpl_validate_statusid

  function do_ajax_form_ticket_email_tpl_validate_statusid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_validate_statusid_cb

  // ---------- Validate enabled
  function do_ajax_form_ticket_email_tpl_validate_enabled()
  {
    var nomeCampo_enabled = "enabled";
    var var_enabled = scAjaxGetFieldRadio(nomeCampo_enabled);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_validate_enabled(var_enabled, var_script_case_init, do_ajax_form_ticket_email_tpl_validate_enabled_cb);
  } // do_ajax_form_ticket_email_tpl_validate_enabled

  function do_ajax_form_ticket_email_tpl_validate_enabled_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enabled";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_validate_enabled_cb

  // ---------- Validate title
  function do_ajax_form_ticket_email_tpl_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_validate_title(var_title, var_script_case_init, do_ajax_form_ticket_email_tpl_validate_title_cb);
  } // do_ajax_form_ticket_email_tpl_validate_title

  function do_ajax_form_ticket_email_tpl_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_validate_title_cb

  // ---------- Validate content
  function do_ajax_form_ticket_email_tpl_validate_content()
  {
    var nomeCampo_content = "content";
    var var_content = scAjaxGetFieldText(nomeCampo_content);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_validate_content(var_content, var_script_case_init, do_ajax_form_ticket_email_tpl_validate_content_cb);
  } // do_ajax_form_ticket_email_tpl_validate_content

  function do_ajax_form_ticket_email_tpl_validate_content_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "content";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_validate_content_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ticket_email_tpl_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ticket_email_tpl_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usertype = scAjaxGetFieldRadio("usertype");
    var var_statusid = scAjaxGetFieldSelect("statusid");
    var var_enabled = scAjaxGetFieldRadio("enabled");
    ...
    scAjaxProcOn();
    x_ajax_form_ticket_email_tpl_submit_form(var_usertype, var_statusid, var_enabled, var_title, var_content, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ticket_email_tpl_submit_form_cb);
  } // do_ajax_form_ticket_email_tpl_submit_form

  function do_ajax_form_ticket_email_tpl_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ticket_email_tpl_submit_form_cb_after_alert);
  } // do_ajax_form_ticket_email_tpl_submit_form_cb
  function do_ajax_form_ticket_email_tpl_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ticket_email_tpl_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ticket_email_tpl_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ticket_email_tpl_navigate_form, function() {});
    } else {
      perform_ajax_form_ticket_email_tpl_navigate_form();
    }
  }

  function perform_ajax_form_ticket_email_tpl_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_ticketlanguage = document.F2.ticketlanguage.value;
    ...
    scAjaxProcOn();
    x_ajax_form_ticket_email_tpl_navigate_form(var_ticketlanguage, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticket_email_tpl_navigate_form_cb);
  } // do_ajax_form_ticket_email_tpl_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ticket_email_tpl']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ticket_email_tpl_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.ticketlanguage.value = scAjaxGetKeyValue("ticketlanguage");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ticket_email_tpl_navigate_form_cb_after_alert);
  } // do_ajax_form_ticket_email_tpl_navigate_form_cb
  function do_ajax_form_ticket_email_tpl_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ticket_email_tpl_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ticket_email_tpl_navigate_form_cb_after_alert

  function sc_hide_form_ticket_email_tpl_form()
  {
  ...
  ajax_field_list[0] = "usertype";
  ajax_field_list[1] = "statusid";
  ajax_field_list[2] = "enabled";
  ajax_field_list[3] = "title";
  ajax_field_list[4] = "content";
  ...
  var ajax_error_list = {
    "usertype": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_email_tpl_fild_usertype'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "statusid": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_email_tpl_fild_statusid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "enabled": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_email_tpl_fild_enabled'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "title": {"label": "Title", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "content": {"label": "Content", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["usertype"][1] = "usertype";
  ajax_field_mult["statusid"][1] = "statusid";
  ajax_field_mult["enabled"][1] = "enabled";
  ajax_field_mult["title"][1] = "title";
  ajax_field_mult["content"][1] = "content";

  var ajax_field_id = {
    "usertype": new Array("hidden_field_label_usertype", "hidden_field_data_usertype"),
    "statusid": new Array("hidden_field_label_statusid", "hidden_field_data_statusid"),
    "enabled": new Array("hidden_field_label_enabled", "hidden_field_data_enabled"),
