...
$old_error_handler = set_error_handler("form_ticket_email_tpl_scriptcase_error_handler");

function form_ticket_email_tpl_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_ticket_email_tpl']['contr_erro']) && $_SESSION['scriptcase']['form_ticket_email_tpl']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_ticket_email_tpl->contr_form_ticket_email_tpl->Apl_com_erro = true;
            if ($inicial_form_ticket_email_tpl->contr_form_ticket_email_tpl->NM_ajax_flag)
            {
                $inicial_form_ticket_email_tpl->contr_form_ticket_email_tpl->NM_ajax_info['errList']['geral_form_ticket_email_tpl'][] = $msg;
                return;
            }
            form_ticket_email_tpl_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_ticket_email_tpl_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_ticket_email_tpl'])  && '' != $_SESSION['scriptcase']['error_icon']['form_ticket_email_tpl'])  ? $_SESSION['scriptcase']['error_icon']['form_ticket_email_tpl']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_ticket_email_tpl']) && '' != $_SESSION['scriptcase']['error_span_title']['form_ticket_email_tpl']) ? $_SESSION['scriptcase']['error_span_title']['form_ticket_email_tpl'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_ticket_email_tpl']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_ticket_email_tpl']) ? $_SESSION['scriptcase']['error_icon_title']['form_ticket_email_tpl'] : '';
?>
