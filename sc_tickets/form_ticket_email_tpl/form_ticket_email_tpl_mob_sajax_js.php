  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ticket_email_tpl_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ticket_email_tpl_mob_form();
	}
...
?>
  ...
  // ---------- Validate usertype
  function do_ajax_form_ticket_email_tpl_mob_validate_usertype()
  {
    var nomeCampo_usertype = "usertype";
    var var_usertype = scAjaxGetFieldRadio(nomeCampo_usertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_mob_validate_usertype(var_usertype, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_validate_usertype_cb);
  } // do_ajax_form_ticket_email_tpl_mob_validate_usertype

  function do_ajax_form_ticket_email_tpl_mob_validate_usertype_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_mob_validate_usertype_cb

  // ---------- Validate statusid
  function do_ajax_form_ticket_email_tpl_mob_validate_statusid()
  {
    var nomeCampo_statusid = "statusid";
    var var_statusid = scAjaxGetFieldSelect(nomeCampo_statusid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_mob_validate_statusid(var_statusid, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_validate_statusid_cb);
  } // do_ajax_form_ticket_email_tpl_mob_validate_statusid

  function do_ajax_form_ticket_email_tpl_mob_validate_statusid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_mob_validate_statusid_cb

  // ---------- Validate enabled
  function do_ajax_form_ticket_email_tpl_mob_validate_enabled()
  {
    var nomeCampo_enabled = "enabled";
    var var_enabled = scAjaxGetFieldRadio(nomeCampo_enabled);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_mob_validate_enabled(var_enabled, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_validate_enabled_cb);
  } // do_ajax_form_ticket_email_tpl_mob_validate_enabled

  function do_ajax_form_ticket_email_tpl_mob_validate_enabled_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enabled";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_mob_validate_enabled_cb

  // ---------- Validate title
  function do_ajax_form_ticket_email_tpl_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_mob_validate_title(var_title, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_validate_title_cb);
  } // do_ajax_form_ticket_email_tpl_mob_validate_title

  function do_ajax_form_ticket_email_tpl_mob_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_mob_validate_title_cb

  // ---------- Validate content
  function do_ajax_form_ticket_email_tpl_mob_validate_content()
  {
    var nomeCampo_content = "content";
    var var_content = scAjaxGetFieldText(nomeCampo_content);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticket_email_tpl_mob_validate_content(var_content, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_validate_content_cb);
  } // do_ajax_form_ticket_email_tpl_mob_validate_content

  function do_ajax_form_ticket_email_tpl_mob_validate_content_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "content";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticket_email_tpl_mob_validate_content_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ticket_email_tpl_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ticket_email_tpl_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_ticketlanguage = scAjaxGetFieldText("ticketlanguage");
    ...
    scAjaxProcOn();
    x_ajax_form_ticket_email_tpl_mob_submit_form(var_usertype, var_statusid, var_enabled, var_title, var_content, var_ticketlanguage, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ticket_email_tpl_mob_submit_form_cb);
  } // do_ajax_form_ticket_email_tpl_mob_submit_form

  function do_ajax_form_ticket_email_tpl_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ticket_email_tpl_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ticket_email_tpl_mob_submit_form_cb
  function do_ajax_form_ticket_email_tpl_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ticket_email_tpl_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ticket_email_tpl_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ticket_email_tpl_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_ticket_email_tpl_mob_navigate_form();
    }
  }

  function perform_ajax_form_ticket_email_tpl_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ticket_email_tpl_mob_navigate_form(var_ticketlanguage, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticket_email_tpl_mob_navigate_form_cb);
  } // do_ajax_form_ticket_email_tpl_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ticket_email_tpl_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ticket_email_tpl_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ticket_email_tpl_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ticket_email_tpl_mob_navigate_form_cb
  function do_ajax_form_ticket_email_tpl_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ticket_email_tpl_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ticket_email_tpl_mob_navigate_form_cb_after_alert

  function sc_hide_form_ticket_email_tpl_mob_form()
  {
