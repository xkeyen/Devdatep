<?php  
  ...
  session_start() ;
  class form_ticket_email_tpl_form_teste
  {
   function form_ticket_email_tpl_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_ticket_email_tpl/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_ticket_email_tpl</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_ticket_email_tpl"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_ticket_email_tpl_form_teste();
  $frm_teste->form_ticket_email_tpl_teste();
?>
