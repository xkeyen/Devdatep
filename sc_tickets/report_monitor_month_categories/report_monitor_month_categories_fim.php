   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_monitor_month_categories.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_month_categories"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_month_categories"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_monitor_month_categories</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_monitor_month_categories']['embutida_filho'] as $ind => $sc_init)
          {
