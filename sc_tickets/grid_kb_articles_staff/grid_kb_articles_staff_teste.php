<?php  
  ...
  session_start() ;
  class grid_kb_articles_staff_form_teste
  {
  function grid_kb_articles_staff_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_kb_articles_staff</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_kb_articles_staff.php" 
               target="_self"> 
var_cat_id&nbsp;&nbsp;<input type=text name="var_cat_id" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_kb_articles_staff"> 
</form> 
<script language=javascript> 
 document.FCons.var_cat_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_kb_articles_staff_form_teste();
  $frm_teste->grid_kb_articles_staff_teste();
?>
