<?php
@session_start() ;
$_SESSION['scriptcase']['report_tickets_by_category']['sc_process_barr'] = true;
require_once('../report_tickets_by_category/index.php');
unset($_SESSION['scriptcase']['report_tickets_by_category']['sc_process_barr']);
$ExportCtrl = new report_tickets_by_category_export_control;
$ExportCtrl->Export_barr();

class report_tickets_by_category_export_control
{
