...
class report_tickets_by_category_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "report_tickets_by_category.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tickets_by_category_title'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>report_tickets_by_category/report_tickets_by_category_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="report_tickets_by_category_ajax_search.js"></script>
 <script type="text/javascript" src="report_tickets_by_category_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="report_tickets_by_category_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="report_tickets_by_category.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<TABLE align="center" valign="top" width="590px" cellpadding=0 cellspacing=0>
<tr>
<td>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_tickets_by_category_title'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticketdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_dia']; 
          $ticketdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_mes']; 
          $ticketdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_ano']; 
          $ticketdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_dia']; 
          $ticketdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_mes']; 
          $ticketdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_ano']; 
          $ticketdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_cond']; 
          $categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['categoryid']; 
          $categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['categoryid_cond']; 
          $statusid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['statusid']; 
          $statusid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['statusid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("report_tickets_by_category_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sc_modal'])
       {
?>
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['categoryid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['categoryid'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['statusid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['statusid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
{
?>
<iframe id="nmsc_iframe_report_tickets_by_category" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_report_tickets_by_category" scrolling="auto" src="report_tickets_by_category.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_report_tickets_by_category_pesq"  name="nm_iframe_report_tickets_by_category_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "report_tickets_by_category.php"; 
     document.form_cancel.submit(); 
 }
 function nm_submit_form()
 {
    document.F1.target = "nm_iframe_report_tickets_by_category";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_report_tickets_by_category').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_ticketdate_dia').bind('change', function() {sc_report_tickets_by_category_valida_dia(this)});
    $('#SC_ticketdate_input_2_dia').bind('change', function() {sc_report_tickets_by_category_valida_dia(this)});
    $('#SC_ticketdate_input_2_mes').bind('change', function() {sc_report_tickets_by_category_valida_mes(this)});
    $('#SC_ticketdate_mes').bind('change', function() {sc_report_tickets_by_category_valida_mes(this)});
 }
 function sc_report_tickets_by_category_valida_mes(obj)
 {
 ...
 function sc_report_tickets_by_category_valida_dia(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($categoryid)) {
          foreach ($categoryid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['categoryid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['psq_check_ret']['statusid'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_dia'] = $ticketdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_mes'] = $ticketdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_ano'] = $ticketdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_dia'] = $ticketdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_mes'] = $ticketdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2_ano'] = $ticketdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_cond'] = $ticketdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['categoryid'] = $categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['categoryid_cond'] = $categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['statusid'] = $statusid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['statusid_cond'] = $statusid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['categoryid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['categoryid'];
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($ticketdate_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate'] = $val[0];
          ...
          if ($ticketdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']['ticketdate_input_2'] = $val[1];
      ...
      if (is_array($categoryid) && count($categoryid) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $nmgp_tab_label['categoryid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['cond_pesq'] .= $this->NM_operador;
