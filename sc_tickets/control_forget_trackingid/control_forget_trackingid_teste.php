<?php  
  ...
  session_start() ;
  class control_forget_trackingid_form_teste
  {
   function control_forget_trackingid_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_forget_trackingid/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_forget_trackingid</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="control_forget_trackingid"> 
</form> 
...
<?php
  ...
  $frm_teste = new control_forget_trackingid_form_teste();
  $frm_teste->control_forget_trackingid_teste();
?>
