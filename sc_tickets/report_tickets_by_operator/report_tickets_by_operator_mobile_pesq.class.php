...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "ticketdate";$Nm_numeric[] = "ticketid";$Nm_numeric[] = "ticketpriorityid";$Nm_numeric[] = "ownerid";$Nm_numeric[] = "customerid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "customerrating";
...
<TABLE id="main_table" align="center" valign="top" width="560px">
<tr>
<td>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ticketdate_cond" name="ticketdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticketdate'), this, 'ticketdate')">
      ...
      <br><span id="id_hide_ticketdate"  <?php echo $str_hide_ticketdate?>>
<SPAN id="Nm_bi_dados_ticketdate" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_ticketdate"  style="display:''">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_categoryid"  <?php echo $str_hide_categoryid?>>
<?php
