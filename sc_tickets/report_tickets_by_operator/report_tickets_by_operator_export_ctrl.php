<?php
@session_start() ;
$_SESSION['scriptcase']['report_tickets_by_operator']['sc_process_barr'] = true;
require_once('../report_tickets_by_operator/index.php');
unset($_SESSION['scriptcase']['report_tickets_by_operator']['sc_process_barr']);
$ExportCtrl = new report_tickets_by_operator_export_control;
$ExportCtrl->Export_barr();

class report_tickets_by_operator_export_control
{
