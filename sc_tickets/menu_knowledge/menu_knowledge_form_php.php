...
class menu_knowledge_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_knowledge']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_knowledge']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_knowledge']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      ...
      $this->nm_location .= "menu_knowledge.php"; 
      $this->menu_sc_init = 1;
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_knowledge']['sc_apl_link'];
...
';
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_knowledge")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_knowledge_start") . "/menu_knowledge_start.php?nm_run_menu=1&nm_apl_menu=menu_knowledge&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_knowledge']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_knowledge'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_knowledge"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_knowledge")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_knowledge', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new menu_knowledge_form_php();
$controle->init();
?>
