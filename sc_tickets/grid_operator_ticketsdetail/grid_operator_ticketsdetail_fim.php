   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_operator_ticketsdetail.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_operator_ticketsdetail"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_operator_ticketsdetail"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_operator_ticketsdetail</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_filho'] as $ind => $sc_init)
          {
