<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_operator_ticketsdetail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_operator_ticketsdetail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ticket_tickettrack"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_tickettrack"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_tickettrack"] : "" . $this->Nm_lang['lang_fld_tracking_id'] . "";
   ...
   $tab_labels["ticket_ticketlastupdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_ticketlastupdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_ticketlastupdate"] : "" . $this->Nm_lang['lang_ticket_fild_ticketlastupdate'] . "";
   ...
   $tab_labels["customer_customername"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["customer_customername"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["customer_customername"] : "" . $this->Nm_lang['lang_ticket_fild_customerid'] . "";
   ...
   $tab_labels["ticket_categoryid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_categoryid"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_categoryid"] : "" . $this->Nm_lang['lang_ticket_fild_categoryid'] . "";
   ...
   $tab_labels["ticket_subject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_subject"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticket_subject"] : "" . $this->Nm_lang['lang_ticket_fild_subject'] . "";
   ...
   $tab_labels["ticketpriority_priorityname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticketpriority_priorityname"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticketpriority_priorityname"] : "" . $this->Nm_lang['lang_ticketpriority_fild_priorityname'] . "";
   ...
   $tab_labels["ticketstatus_statusname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticketstatus_statusname"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["ticketstatus_statusname"] : "" . $this->Nm_lang['lang_ticketstatus_fild_statusname'] . "";
   $tab_ger_campos['message'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['message'] = "message";
   }
   else
   {
       $tab_def_campos['message'] = "";
   }
   $tab_labels["message"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["message"])) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['labels']["message"] : "message";
   $tab_ger_campos['message'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_header_ticket_history'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_operator_ticketsdetail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_operator_ticketsdetail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
