<?php  
  ...
  session_start() ;
  class grid_kb_articles_form_teste
  {
  function grid_kb_articles_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_kb_articles</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_kb_articles"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_kb_articles_form_teste();
  $frm_teste->grid_kb_articles_teste();
?>
