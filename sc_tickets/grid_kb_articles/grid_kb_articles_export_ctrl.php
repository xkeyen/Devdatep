<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kb_articles']['sc_process_barr'] = true;
require_once('../grid_kb_articles/index.php');
unset($_SESSION['scriptcase']['grid_kb_articles']['sc_process_barr']);
$ExportCtrl = new grid_kb_articles_export_control;
$ExportCtrl->Export_barr();

class grid_kb_articles_export_control
{
