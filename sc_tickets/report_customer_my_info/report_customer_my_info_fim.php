   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_customer_my_info.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_customer_my_info"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_customer_my_info"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_customer_my_info</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_customer_my_info']['embutida_filho'] as $ind => $sc_init)
          {
