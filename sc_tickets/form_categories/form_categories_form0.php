...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_categories'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_categories'] . ""); } ?></TITLE>
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="<?php echo '' ?>scFormLabelOddMult sc-col-title"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if ((!isset($this->nmgp_cmp_hidden['categoryid_']) || $this->nmgp_cmp_hidden['categoryid_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
      if (!isset($this->nm_new_label['categoryid_'])) {
...
<?php
        ...
        // label
        $label_labelContent = $this->nm_new_label['categoryid_'];
...
?>
    ...
    <TD class="<?php echo '' ?>scFormLabelOddMult css_categoryid__label sc-col-title" id="hidden_field_label_categoryid_" style="<?php echo $sStyleHidden_categoryid_; ?>" > <?php echo $label_final ?> </TD>
   <?php $this->form_fixed_column_no++;}?>

   <?php
    $sStyleHidden_categoryname_ = '';
    if (isset($this->nmgp_cmp_hidden['categoryname_']) && $this->nmgp_cmp_hidden['categoryname_'] == 'off') {
        $sStyleHidden_categoryname_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['categoryname_']) || $this->nmgp_cmp_hidden['categoryname_'] == 'on') {
        if (!isset($this->nm_new_label['categoryname_'])) {
            $this->nm_new_label['categoryname_'] = "" . $this->Ini->Nm_lang['lang_categories_fild_categoryname'] . "";
        }
        $SC_Label = "" . $this->nm_new_label['categoryname_']  . "";
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo '' ?>scFormLabelOddMult css_categoryname__label sc-col-title" id="hidden_field_label_categoryname_" style="<?php echo $sStyleHidden_categoryname_; ?>" > <?php echo $label_final ?> </TD>
   <?php
...
{ 
   ...
   if ($this->Embutida_form && empty($this->form_vert_form_categories))
   {
       $sc_seq_vert = 0;
           ...
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['categoryid_']))
           {
               $this->nmgp_cmp_readonly['categoryid_'] = 'on';
           }
   foreach ($this->form_vert_form_categories as $sc_seq_vert => $sc_lixo)
   {
       ...
       {
           $this->nmgp_cmp_readonly['categoryid_'] = true;
           $this->nmgp_cmp_readonly['categoryname_'] = true;
       }
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['categoryid_']) || $this->nmgp_cmp_readonly['categoryid_'] != "on") {$this->nmgp_cmp_readonly['categoryid_'] = false;}
           if (!isset($this->nmgp_cmp_readonly['categoryname_']) || $this->nmgp_cmp_readonly['categoryname_'] != "on") {$this->nmgp_cmp_readonly['categoryname_'] = false;}
       }
        ...
        $this->categoryid_ = $this->form_vert_form_categories[$sc_seq_vert]['categoryid_']; 
       $categoryid_ = $this->categoryid_; 
       $sStyleHidden_categoryid_ = '';
       if (isset($sCheckRead_categoryid_))
       {
           unset($sCheckRead_categoryid_);
       }
       if (isset($this->nmgp_cmp_readonly['categoryid_']))
       {
           $sCheckRead_categoryid_ = $this->nmgp_cmp_readonly['categoryid_'];
       }
       if (isset($this->nmgp_cmp_hidden['categoryid_']) && $this->nmgp_cmp_hidden['categoryid_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['categoryid_']);
           $sStyleHidden_categoryid_ = 'display: none;';
       }
       $bTestReadOnly_categoryid_ = true;
       $sStyleReadLab_categoryid_ = 'display: none;';
       $sStyleReadInp_categoryid_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["categoryid_"]) &&  $this->nmgp_cmp_readonly["categoryid_"] == "on"))
       {
           $bTestReadOnly_categoryid_ = false;
           unset($this->nmgp_cmp_readonly['categoryid_']);
           $sStyleReadLab_categoryid_ = '';
           $sStyleReadInp_categoryid_ = 'display: none;';
       }
       $this->categoryname_ = $this->form_vert_form_categories[$sc_seq_vert]['categoryname_']; 
       $categoryname_ = $this->categoryname_; 
       $sStyleHidden_categoryname_ = '';
       if (isset($sCheckRead_categoryname_))
       {
           unset($sCheckRead_categoryname_);
       }
       if (isset($this->nmgp_cmp_readonly['categoryname_']))
       {
           $sCheckRead_categoryname_ = $this->nmgp_cmp_readonly['categoryname_'];
       }
       if (isset($this->nmgp_cmp_hidden['categoryname_']) && $this->nmgp_cmp_hidden['categoryname_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['categoryname_']);
           $sStyleHidden_categoryname_ = 'display: none;';
       }
       $bTestReadOnly_categoryname_ = true;
       $sStyleReadLab_categoryname_ = 'display: none;';
       $sStyleReadInp_categoryname_ = '';
       if (isset($this->nmgp_cmp_readonly['categoryname_']) && $this->nmgp_cmp_readonly['categoryname_'] == 'on')
       {
           $bTestReadOnly_categoryname_ = false;
           unset($this->nmgp_cmp_readonly['categoryname_']);
           $sStyleReadLab_categoryname_ = '';
           $sStyleReadInp_categoryname_ = 'display: none;';
       }
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_categories_add_new_line('S', " . $sc_seq_vert . ")", "do_ajax_form_categories_add_new_line('S', " . $sc_seq_vert . ")", "sc_clone_line_" . $sc_seq_vert . "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_categories_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_categories_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
   ...
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['categoryid_']) && $this->nmgp_cmp_hidden['categoryid_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="categoryid_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($categoryid_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormDataOddMult css_categoryid__line" id="hidden_field_data_categoryid_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_categoryid_; ?>"> <span id="id_read_on_categoryid_<?php echo $sc_seq_vert ?>" class="css_categoryid__line" style="<?php echo $sStyleReadLab_categoryid_; ?>"><?php echo $this->form_format_readonly("categoryid_", $this->form_encode_input($this->categoryid_)); ?></span><span id="id_read_off_categoryid_<?php echo $sc_seq_vert ?>" class="css_read_off_categoryid_" style="<?php echo $sStyleReadInp_categoryid_; ?>"><input type="hidden" id="id_sc_field_categoryid_<?php echo $sc_seq_vert ?>" name="categoryid_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($categoryid_) . "\">"?>
<span id="id_ajax_label_categoryid_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($categoryid_); ?></span>
</span></span> </TD>
   <?php }?>
<?php }?>

   <?php if (isset($this->nmgp_cmp_hidden['categoryname_']) && $this->nmgp_cmp_hidden['categoryname_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="categoryname_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($categoryname_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_categoryname__line" id="hidden_field_data_categoryname_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_categoryname_; ?>"> 
<?php if ($bTestReadOnly_categoryname_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["categoryname_"]) &&  $this->nmgp_cmp_readonly["categoryname_"] == "on") { 

 ?>
<input type="hidden" name="categoryname_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($categoryname_) . "\">" . $categoryname_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_categoryname_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-categoryname_<?php echo $sc_seq_vert ?> css_categoryname__line" style="<?php echo $sStyleReadLab_categoryname_; ?>"><?php echo $this->form_format_readonly("categoryname_", $this->form_encode_input($this->categoryname_)); ?></span><span id="id_read_off_categoryname_<?php echo $sc_seq_vert ?>" class="css_read_off_categoryname_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_categoryname_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_categoryname__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_categoryname_<?php echo $sc_seq_vert ?>" type=text name="categoryname_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($categoryname_) ?>"
...
<?php   
        if (isset($sCheckRead_categoryid_))
       {
           $this->nmgp_cmp_readonly['categoryid_'] = $sCheckRead_categoryid_;
       }
       if ('display: none;' == $sStyleHidden_categoryid_)
       {
           $this->nmgp_cmp_hidden['categoryid_'] = 'off';
       }
       if (isset($sCheckRead_categoryname_))
       {
           $this->nmgp_cmp_readonly['categoryname_'] = $sCheckRead_categoryname_;
       }
       if ('display: none;' == $sStyleHidden_categoryname_)
       {
           $this->nmgp_cmp_hidden['categoryname_'] = 'off';
       }
