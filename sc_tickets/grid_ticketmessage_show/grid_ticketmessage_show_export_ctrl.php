<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ticketmessage_show']['sc_process_barr'] = true;
require_once('../grid_ticketmessage_show/index.php');
unset($_SESSION['scriptcase']['grid_ticketmessage_show']['sc_process_barr']);
$ExportCtrl = new grid_ticketmessage_show_export_control;
$ExportCtrl->Export_barr();

class grid_ticketmessage_show_export_control
{
