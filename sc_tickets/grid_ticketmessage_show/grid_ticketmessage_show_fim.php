   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_ticketmessage_show.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_ticketmessage_show"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_ticketmessage_show"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ticketmessage_show</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ticketmessage_show']['embutida_filho'] as $ind => $sc_init)
          {
