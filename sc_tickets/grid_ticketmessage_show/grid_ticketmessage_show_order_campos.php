...
<?php
   ...
   $Ord_Cmp = new grid_ticketmessage_show_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ticketmessage_show_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ticketdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["ticketdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["ticketdate"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketdate'] . "";
   $tab_ger_campos['ticketcontent'] = "on";
   $tab_def_campos['ticketcontent'] = "ticketcontent";
   $tab_labels["ticketcontent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["ticketcontent"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["ticketcontent"] : "" . $this->Nm_lang['lang_ticketmessage_fild_ticketcontent'] . "";
   $tab_ger_campos['messagetype'] = "on";
   $tab_def_campos['messagetype'] = "messagetype";
   $tab_labels["messagetype"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["messagetype"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["messagetype"] : "" . $this->Nm_lang['lang_ticketmessage_fild_messagetype'] . "";
   $tab_ger_campos['operatorid'] = "on";
   $tab_def_campos['operatorid'] = "operatorid";
   $tab_labels["operatorid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["operatorid"])) ? $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['labels']["operatorid"] : "" . $this->Nm_lang['lang_ticketmessage_fild_operatorid'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ticketmessage_show_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ticketmessage_show']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
