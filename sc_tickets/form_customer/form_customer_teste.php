<?php  
  ...
  session_start() ;
  class form_customer_form_teste
  {
   function form_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customer</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_customer_form_teste();
  $frm_teste->form_customer_teste();
?>
