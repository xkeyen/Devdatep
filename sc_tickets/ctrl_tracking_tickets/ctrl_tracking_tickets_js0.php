...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_tracking_tickets']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_tracking_tickets']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="ctrl_tracking_tickets"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_btn_forget_ticket_id()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_forget_ticket_id(); }, 500);
      return;
    }
    sc_btn_btn_forget_ticket_id_ok();
}
function sc_btn_btn_forget_ticket_id_cancel()
{
}
function sc_btn_btn_forget_ticket_id_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_control_forget_trackingid_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout"; ?>', '', '_self', '0', '0', 'control_forget_trackingid');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_tracking_tickets']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "ctrl_tracking_tickets_fim.php";
  document.F4.submit();
}
