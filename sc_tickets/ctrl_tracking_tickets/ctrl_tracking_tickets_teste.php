<?php  
  ...
  session_start() ;
  class ctrl_tracking_tickets_form_teste
  {
   function ctrl_tracking_tickets_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ctrl_tracking_tickets/img";
...
?> 
<br> 
<B><FONT SIZE="4">ctrl_tracking_tickets</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="ctrl_tracking_tickets"> 
</form> 
...
<?php
  ...
  $frm_teste = new ctrl_tracking_tickets_form_teste();
  $frm_teste->ctrl_tracking_tickets_teste();
?>
