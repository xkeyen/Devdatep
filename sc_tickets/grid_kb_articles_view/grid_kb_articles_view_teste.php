<?php  
  ...
  session_start() ;
  class grid_kb_articles_view_form_teste
  {
  function grid_kb_articles_view_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_kb_articles_view</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_kb_articles_view.php" 
               target="_self"> 
v_articlesid&nbsp;&nbsp;<input type=text name="v_articlesid" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_kb_articles_view"> 
</form> 
<script language=javascript> 
 document.FCons.v_articlesid.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_kb_articles_view_form_teste();
  $frm_teste->grid_kb_articles_view_teste();
?>
