<?php  
  ...
  session_start() ;
  class control_ticket_rating_form_teste
  {
   function control_ticket_rating_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_ticket_rating/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_ticket_rating</FONT></B> 
<br> 
<br> 
...
v_module&nbsp;&nbsp;<input type="text" name="v_module" size=20><br> 
v_ticketid&nbsp;&nbsp;<input type="text" name="v_ticketid" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="control_ticket_rating"> 
</form> 
<script language=javascript> 
 document.Fedit.v_module.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new control_ticket_rating_form_teste();
  $frm_teste->control_ticket_rating_teste();
?>
