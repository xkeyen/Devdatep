<?php
@session_start() ;
$_SESSION['scriptcase']['report_customer_general_categories']['sc_process_barr'] = true;
require_once('../report_customer_general_categories/index.php');
unset($_SESSION['scriptcase']['report_customer_general_categories']['sc_process_barr']);
$ExportCtrl = new report_customer_general_categories_export_control;
$ExportCtrl->Export_barr();

class report_customer_general_categories_export_control
{
...
?>
 ...
 <link rel="stylesheet" href="<?php echo $this->path_prod ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
 <?php
