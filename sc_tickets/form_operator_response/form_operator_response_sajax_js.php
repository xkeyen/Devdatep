  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_operator_response" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_operator_response_form();
	}
...
?>
  ...
  function do_ajax_form_operator_response_validate_ticketpriorityid()
  {
    ...
    x_ajax_form_operator_response_validate_ticketpriorityid(var_ticketpriorityid, var_script_case_init, do_ajax_form_operator_response_validate_ticketpriorityid_cb);
  } // do_ajax_form_operator_response_validate_ticketpriorityid

  function do_ajax_form_operator_response_validate_ticketpriorityid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_ticketpriorityid_cb

  // ---------- Validate categoryid
  function do_ajax_form_operator_response_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldSelect(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_operator_response_validate_categoryid_cb);
  } // do_ajax_form_operator_response_validate_categoryid

  function do_ajax_form_operator_response_validate_categoryid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_categoryid_cb

  // ---------- Validate templateid
  function do_ajax_form_operator_response_validate_templateid()
  {
    var nomeCampo_templateid = "templateid";
    var var_templateid = scAjaxGetFieldSelect(nomeCampo_templateid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_templateid(var_templateid, var_script_case_init, do_ajax_form_operator_response_validate_templateid_cb);
  } // do_ajax_form_operator_response_validate_templateid

  function do_ajax_form_operator_response_validate_templateid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_templateid_cb

  // ---------- Validate ticketcontent
  function do_ajax_form_operator_response_validate_ticketcontent()
  {
    var nomeCampo_ticketcontent = "ticketcontent";
    var var_ticketcontent = scAjaxGetFieldEditorHtml(nomeCampo_ticketcontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_ticketcontent(var_ticketcontent, var_script_case_init, do_ajax_form_operator_response_validate_ticketcontent_cb);
  } // do_ajax_form_operator_response_validate_ticketcontent

  function do_ajax_form_operator_response_validate_ticketcontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_ticketcontent_cb

  // ---------- Validate closeticket
  function do_ajax_form_operator_response_validate_closeticket()
  {
    var nomeCampo_closeticket = "closeticket";
    var var_closeticket = scAjaxGetFieldCheckbox(nomeCampo_closeticket, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_closeticket(var_closeticket, var_script_case_init, do_ajax_form_operator_response_validate_closeticket_cb);
  } // do_ajax_form_operator_response_validate_closeticket

  function do_ajax_form_operator_response_validate_closeticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_closeticket_cb

  // ---------- Validate transferticket
  function do_ajax_form_operator_response_validate_transferticket()
  {
    var nomeCampo_transferticket = "transferticket";
    var var_transferticket = scAjaxGetFieldSelect(nomeCampo_transferticket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_transferticket(var_transferticket, var_script_case_init, do_ajax_form_operator_response_validate_transferticket_cb);
  } // do_ajax_form_operator_response_validate_transferticket

  function do_ajax_form_operator_response_validate_transferticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_transferticket_cb

  // ---------- Validate ticketfile1
  function do_ajax_form_operator_response_validate_ticketfile1()
  {
    var nomeCampo_ticketfile1 = "ticketfile1";
    var var_ticketfile1 = scAjaxGetFieldText(nomeCampo_ticketfile1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_ticketfile1(var_ticketfile1, var_script_case_init, do_ajax_form_operator_response_validate_ticketfile1_cb);
  } // do_ajax_form_operator_response_validate_ticketfile1

  function do_ajax_form_operator_response_validate_ticketfile1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_ticketfile1_cb

  // ---------- Validate ticketfile2
  function do_ajax_form_operator_response_validate_ticketfile2()
  {
    var nomeCampo_ticketfile2 = "ticketfile2";
    var var_ticketfile2 = scAjaxGetFieldText(nomeCampo_ticketfile2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_ticketfile2(var_ticketfile2, var_script_case_init, do_ajax_form_operator_response_validate_ticketfile2_cb);
  } // do_ajax_form_operator_response_validate_ticketfile2

  function do_ajax_form_operator_response_validate_ticketfile2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_ticketfile2_cb

  // ---------- Validate ticketfile3
  function do_ajax_form_operator_response_validate_ticketfile3()
  {
    var nomeCampo_ticketfile3 = "ticketfile3";
    var var_ticketfile3 = scAjaxGetFieldText(nomeCampo_ticketfile3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_ticketfile3(var_ticketfile3, var_script_case_init, do_ajax_form_operator_response_validate_ticketfile3_cb);
  } // do_ajax_form_operator_response_validate_ticketfile3

  function do_ajax_form_operator_response_validate_ticketfile3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_ticketfile3_cb

  // ---------- Validate messagenote
  function do_ajax_form_operator_response_validate_messagenote()
  {
    var nomeCampo_messagenote = "messagenote";
    var var_messagenote = scAjaxGetFieldEditorHtml(nomeCampo_messagenote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_validate_messagenote(var_messagenote, var_script_case_init, do_ajax_form_operator_response_validate_messagenote_cb);
  } // do_ajax_form_operator_response_validate_messagenote

  function do_ajax_form_operator_response_validate_messagenote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_validate_messagenote_cb

  // ---------- Event onclick closeticket
  function do_ajax_form_operator_response_event_closeticket_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_operator_response_event_closeticket_onclick(var_closeticket, var_transferticket, var_script_case_init, do_ajax_form_operator_response_event_closeticket_onclick_cb);
  } // do_ajax_form_operator_response_event_closeticket_onclick

  function do_ajax_form_operator_response_event_closeticket_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "closeticket";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_event_closeticket_onclick_cb_after_alert);
  } // do_ajax_form_operator_response_event_closeticket_onclick_cb
  function do_ajax_form_operator_response_event_closeticket_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_event_closeticket_onclick_cb_after_alert

  // ---------- Event onchange templateid
  function do_ajax_form_operator_response_event_templateid_onchange()
  {
    var var_templateid = scAjaxGetFieldSelect("templateid");
    var var_ticketcontent = scAjaxGetFieldEditorHtml("ticketcontent");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_operator_response_event_templateid_onchange(var_templateid, var_ticketcontent, var_script_case_init, do_ajax_form_operator_response_event_templateid_onchange_cb);
  } // do_ajax_form_operator_response_event_templateid_onchange

  function do_ajax_form_operator_response_event_templateid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "templateid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_event_templateid_onchange_cb_after_alert);
  } // do_ajax_form_operator_response_event_templateid_onchange_cb
  function do_ajax_form_operator_response_event_templateid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_event_templateid_onchange_cb_after_alert

  // ---------- Event onchange transferticket
  function do_ajax_form_operator_response_event_transferticket_onchange()
  {
    var var_transferticket = scAjaxGetFieldSelect("transferticket");
    var var_closeticket = scAjaxGetFieldCheckbox("closeticket", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_operator_response_event_transferticket_onchange(var_transferticket, var_closeticket, var_script_case_init, do_ajax_form_operator_response_event_transferticket_onchange_cb);
  } // do_ajax_form_operator_response_event_transferticket_onchange

  function do_ajax_form_operator_response_event_transferticket_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "transferticket";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_event_transferticket_onchange_cb_after_alert);
  } // do_ajax_form_operator_response_event_transferticket_onchange_cb
  function do_ajax_form_operator_response_event_transferticket_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_event_transferticket_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_operator_response_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_operator_response_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_operator_response_submit_form(var_ticketpriorityid, var_categoryid, var_templateid, var_ticketcontent, var_closeticket, var_transferticket, var_ticketfile1, var_ticketfile2, var_ticketfile3, var_messagenote, var_ticketfile1_ul_name, var_ticketfile1_ul_type, var_ticketfile2_ul_name, var_ticketfile2_ul_type, var_ticketfile3_ul_name, var_ticketfile3_ul_type, var_ticketfile1_limpa, var_ticketfile2_limpa, var_ticketfile3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_operator_response_submit_form_cb);
  } // do_ajax_form_operator_response_submit_form

  function do_ajax_form_operator_response_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_operator_response_submit_form_cb_after_alert);
  } // do_ajax_form_operator_response_submit_form_cb
  function do_ajax_form_operator_response_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_operator_response_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_operator_response_navigate_form()
  {
    perform_ajax_form_operator_response_navigate_form();
  }

  function perform_ajax_form_operator_response_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_operator_response_navigate_form(var_ticketmessageid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_operator_response_navigate_form_cb);
  } // do_ajax_form_operator_response_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_operator_response']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_operator_response_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_operator_response_navigate_form_cb_after_alert);
  } // do_ajax_form_operator_response_navigate_form_cb
  function do_ajax_form_operator_response_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_operator_response_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_operator_response_navigate_form_cb_after_alert

  function sc_hide_form_operator_response_form()
  {
