...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_ticketmessageid' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketmessageid_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketid' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketid_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketdate' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketdate_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketdate_hora' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketdate_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketcontent' + iSeqRow).bind('blur', function() { sc_form_operator_response_ticketcontent_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_operator_response_ticketcontent_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ticketfile1' + iSeqRow).bind('blur', function() { sc_form_operator_response_ticketfile1_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_operator_response_ticketfile1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ticketfile2' + iSeqRow).bind('blur', function() { sc_form_operator_response_ticketfile2_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_operator_response_ticketfile2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ticketfile3' + iSeqRow).bind('blur', function() { sc_form_operator_response_ticketfile3_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_operator_response_ticketfile3_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_operator_response_ticketfile3_onfocus(this, iSeqRow) });
  $('#id_sc_field_operatorid' + iSeqRow).bind('change', function() { sc_form_operator_response_operatorid_onchange(this, iSeqRow) });
  $('#id_sc_field_messagetype' + iSeqRow).bind('change', function() { sc_form_operator_response_messagetype_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketfilename1' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketfilename1_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketfilename2' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketfilename2_onchange(this, iSeqRow) });
  $('#id_sc_field_ticketfilename3' + iSeqRow).bind('change', function() { sc_form_operator_response_ticketfilename3_onchange(this, iSeqRow) });
  $('#id_sc_field_statusid' + iSeqRow).bind('change', function() { sc_form_operator_response_statusid_onchange(this, iSeqRow) });
  $('#id_sc_field_messagenote' + iSeqRow).bind('blur', function() { sc_form_operator_response_messagenote_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_operator_response_messagenote_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_closeticket' + iSeqRow).bind('blur', function() { sc_form_operator_response_closeticket_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_operator_response_closeticket_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_categoryid' + iSeqRow).bind('blur', function() { sc_form_operator_response_categoryid_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_operator_response_categoryid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ticketpriorityid' + iSeqRow).bind('blur', function() { sc_form_operator_response_ticketpriorityid_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_operator_response_ticketpriorityid_onchange(this, iSeqRow) })
...
function sc_form_operator_response_ticketmessageid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketdate_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketdate_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_ticketcontent_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_ticketfile1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_ticketfile2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_ticketfile3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_operatorid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_messagetype_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketfilename1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketfilename2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_ticketfilename3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_operator_response_statusid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_messagenote_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_closeticket_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_categoryid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_operator_response_ticketpriorityid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_operator_response_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_ticketfile1" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_operator_response_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_operator_response')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
