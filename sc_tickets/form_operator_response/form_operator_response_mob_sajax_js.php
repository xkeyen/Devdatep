  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_operator_response_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_operator_response_mob_form();
	}
...
?>
  ...
  // ---------- Validate ticketpriorityid
  function do_ajax_form_operator_response_mob_validate_ticketpriorityid()
  {
    var nomeCampo_ticketpriorityid = "ticketpriorityid";
    var var_ticketpriorityid = scAjaxGetFieldSelect(nomeCampo_ticketpriorityid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_ticketpriorityid(var_ticketpriorityid, var_script_case_init, do_ajax_form_operator_response_mob_validate_ticketpriorityid_cb);
  } // do_ajax_form_operator_response_mob_validate_ticketpriorityid

  function do_ajax_form_operator_response_mob_validate_ticketpriorityid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticketpriorityid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_ticketpriorityid_cb

  // ---------- Validate categoryid
  function do_ajax_form_operator_response_mob_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldSelect(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_operator_response_mob_validate_categoryid_cb);
  } // do_ajax_form_operator_response_mob_validate_categoryid

  function do_ajax_form_operator_response_mob_validate_categoryid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_categoryid_cb

  // ---------- Validate templateid
  function do_ajax_form_operator_response_mob_validate_templateid()
  {
    var nomeCampo_templateid = "templateid";
    var var_templateid = scAjaxGetFieldSelect(nomeCampo_templateid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_templateid(var_templateid, var_script_case_init, do_ajax_form_operator_response_mob_validate_templateid_cb);
  } // do_ajax_form_operator_response_mob_validate_templateid

  function do_ajax_form_operator_response_mob_validate_templateid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "templateid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_templateid_cb

  // ---------- Validate ticketcontent
  function do_ajax_form_operator_response_mob_validate_ticketcontent()
  {
    var nomeCampo_ticketcontent = "ticketcontent";
    var var_ticketcontent = scAjaxGetFieldEditorHtml(nomeCampo_ticketcontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_ticketcontent(var_ticketcontent, var_script_case_init, do_ajax_form_operator_response_mob_validate_ticketcontent_cb);
  } // do_ajax_form_operator_response_mob_validate_ticketcontent

  function do_ajax_form_operator_response_mob_validate_ticketcontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticketcontent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_ticketcontent_cb

  // ---------- Validate closeticket
  function do_ajax_form_operator_response_mob_validate_closeticket()
  {
    var nomeCampo_closeticket = "closeticket";
    var var_closeticket = scAjaxGetFieldCheckbox(nomeCampo_closeticket, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_closeticket(var_closeticket, var_script_case_init, do_ajax_form_operator_response_mob_validate_closeticket_cb);
  } // do_ajax_form_operator_response_mob_validate_closeticket

  function do_ajax_form_operator_response_mob_validate_closeticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "closeticket";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_closeticket_cb

  // ---------- Validate transferticket
  function do_ajax_form_operator_response_mob_validate_transferticket()
  {
    var nomeCampo_transferticket = "transferticket";
    var var_transferticket = scAjaxGetFieldSelect(nomeCampo_transferticket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_transferticket(var_transferticket, var_script_case_init, do_ajax_form_operator_response_mob_validate_transferticket_cb);
  } // do_ajax_form_operator_response_mob_validate_transferticket

  function do_ajax_form_operator_response_mob_validate_transferticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "transferticket";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_transferticket_cb

  // ---------- Validate ticketfile1
  function do_ajax_form_operator_response_mob_validate_ticketfile1()
  {
    var nomeCampo_ticketfile1 = "ticketfile1";
    var var_ticketfile1 = scAjaxGetFieldText(nomeCampo_ticketfile1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_ticketfile1(var_ticketfile1, var_script_case_init, do_ajax_form_operator_response_mob_validate_ticketfile1_cb);
  } // do_ajax_form_operator_response_mob_validate_ticketfile1

  function do_ajax_form_operator_response_mob_validate_ticketfile1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticketfile1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_ticketfile1_cb

  // ---------- Validate ticketfile2
  function do_ajax_form_operator_response_mob_validate_ticketfile2()
  {
    var nomeCampo_ticketfile2 = "ticketfile2";
    var var_ticketfile2 = scAjaxGetFieldText(nomeCampo_ticketfile2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_ticketfile2(var_ticketfile2, var_script_case_init, do_ajax_form_operator_response_mob_validate_ticketfile2_cb);
  } // do_ajax_form_operator_response_mob_validate_ticketfile2

  function do_ajax_form_operator_response_mob_validate_ticketfile2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticketfile2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_ticketfile2_cb

  // ---------- Validate ticketfile3
  function do_ajax_form_operator_response_mob_validate_ticketfile3()
  {
    var nomeCampo_ticketfile3 = "ticketfile3";
    var var_ticketfile3 = scAjaxGetFieldText(nomeCampo_ticketfile3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_ticketfile3(var_ticketfile3, var_script_case_init, do_ajax_form_operator_response_mob_validate_ticketfile3_cb);
  } // do_ajax_form_operator_response_mob_validate_ticketfile3

  function do_ajax_form_operator_response_mob_validate_ticketfile3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticketfile3";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_ticketfile3_cb

  // ---------- Validate messagenote
  function do_ajax_form_operator_response_mob_validate_messagenote()
  {
    var nomeCampo_messagenote = "messagenote";
    var var_messagenote = scAjaxGetFieldEditorHtml(nomeCampo_messagenote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operator_response_mob_validate_messagenote(var_messagenote, var_script_case_init, do_ajax_form_operator_response_mob_validate_messagenote_cb);
  } // do_ajax_form_operator_response_mob_validate_messagenote

  function do_ajax_form_operator_response_mob_validate_messagenote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "messagenote";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operator_response_mob_validate_messagenote_cb

  // ---------- Event onclick closeticket
  function do_ajax_form_operator_response_mob_event_closeticket_onclick()
  {
    var var_closeticket = scAjaxGetFieldCheckbox("closeticket", ";");
    var var_transferticket = scAjaxGetFieldSelect("transferticket");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_operator_response_mob_event_closeticket_onclick(var_closeticket, var_transferticket, var_script_case_init, do_ajax_form_operator_response_mob_event_closeticket_onclick_cb);
  } // do_ajax_form_operator_response_mob_event_closeticket_onclick

  function do_ajax_form_operator_response_mob_event_closeticket_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "closeticket";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_mob_event_closeticket_onclick_cb_after_alert);
  } // do_ajax_form_operator_response_mob_event_closeticket_onclick_cb
  function do_ajax_form_operator_response_mob_event_closeticket_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_mob_event_closeticket_onclick_cb_after_alert

  // ---------- Event onchange templateid
  function do_ajax_form_operator_response_mob_event_templateid_onchange()
  {
    var var_templateid = scAjaxGetFieldSelect("templateid");
    var var_ticketcontent = scAjaxGetFieldEditorHtml("ticketcontent");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_operator_response_mob_event_templateid_onchange(var_templateid, var_ticketcontent, var_script_case_init, do_ajax_form_operator_response_mob_event_templateid_onchange_cb);
  } // do_ajax_form_operator_response_mob_event_templateid_onchange

  function do_ajax_form_operator_response_mob_event_templateid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "templateid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_mob_event_templateid_onchange_cb_after_alert);
  } // do_ajax_form_operator_response_mob_event_templateid_onchange_cb
  function do_ajax_form_operator_response_mob_event_templateid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_mob_event_templateid_onchange_cb_after_alert

  // ---------- Event onchange transferticket
  function do_ajax_form_operator_response_mob_event_transferticket_onchange()
  {
    var var_transferticket = scAjaxGetFieldSelect("transferticket");
    var var_closeticket = scAjaxGetFieldCheckbox("closeticket", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_operator_response_mob_event_transferticket_onchange(var_transferticket, var_closeticket, var_script_case_init, do_ajax_form_operator_response_mob_event_transferticket_onchange_cb);
  } // do_ajax_form_operator_response_mob_event_transferticket_onchange

  function do_ajax_form_operator_response_mob_event_transferticket_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "transferticket";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_operator_response_mob_event_transferticket_onchange_cb_after_alert);
  } // do_ajax_form_operator_response_mob_event_transferticket_onchange_cb
  function do_ajax_form_operator_response_mob_event_transferticket_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_operator_response_mob_event_transferticket_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_operator_response_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_operator_response_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ticketpriorityid = scAjaxGetFieldSelect("ticketpriorityid");
    var var_categoryid = scAjaxGetFieldSelect("categoryid");
    var var_templateid = scAjaxGetFieldSelect("templateid");
    var var_ticketcontent = scAjaxGetFieldEditorHtml("ticketcontent");
    var var_closeticket = scAjaxGetFieldCheckbox("closeticket", ";");
    var var_transferticket = scAjaxGetFieldSelect("transferticket");
    var var_ticketfile1 = scAjaxGetFieldText("ticketfile1");
    var var_ticketfile2 = scAjaxGetFieldText("ticketfile2");
    var var_ticketfile3 = scAjaxGetFieldText("ticketfile3");
    var var_messagenote = scAjaxGetFieldEditorHtml("messagenote");
    var var_ticketmessageid = scAjaxGetFieldText("ticketmessageid");
    var var_ticketid = scAjaxGetFieldText("ticketid");
    var var_ticketfile1_ul_name = scAjaxSpecCharProtect(document.F1.ticketfile1_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_ticketfile1_ul_type = document.F1.ticketfile1_ul_type.value;
    var var_ticketfile2_ul_name = scAjaxSpecCharProtect(document.F1.ticketfile2_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_ticketfile2_ul_type = document.F1.ticketfile2_ul_type.value;
    var var_ticketfile3_ul_name = scAjaxSpecCharProtect(document.F1.ticketfile3_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_ticketfile3_ul_type = document.F1.ticketfile3_ul_type.value;
    var var_ticketfile1_limpa = document.F1.ticketfile1_limpa.checked ? "S" : "N";
    var var_ticketfile2_limpa = document.F1.ticketfile2_limpa.checked ? "S" : "N";
    var var_ticketfile3_limpa = document.F1.ticketfile3_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_operator_response_mob_submit_form(var_ticketpriorityid, var_categoryid, var_templateid, var_ticketcontent, var_closeticket, var_transferticket, var_ticketfile1, var_ticketfile2, var_ticketfile3, var_messagenote, var_ticketmessageid, var_ticketid, var_ticketfile1_ul_name, var_ticketfile1_ul_type, var_ticketfile2_ul_name, var_ticketfile2_ul_type, var_ticketfile3_ul_name, var_ticketfile3_ul_type, var_ticketfile1_limpa, var_ticketfile2_limpa, var_ticketfile3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_operator_response_mob_submit_form_cb);
  } // do_ajax_form_operator_response_mob_submit_form

  function do_ajax_form_operator_response_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.ticketfile1_limpa && document.F1.ticketfile1_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("ticketfile1", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_ticketfile1") && "" != document.getElementById("id_ajax_doc_ticketfile1").innerHTML)
      {
        document.getElementById("id_ajax_doc_ticketfile1").style.display = "";
      }
      if (document.F1.ticketfile2_limpa && document.F1.ticketfile2_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("ticketfile2", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_ticketfile2") && "" != document.getElementById("id_ajax_doc_ticketfile2").innerHTML)
      {
        document.getElementById("id_ajax_doc_ticketfile2").style.display = "";
      }
      if (document.F1.ticketfile3_limpa && document.F1.ticketfile3_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("ticketfile3", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_ticketfile3") && "" != document.getElementById("id_ajax_doc_ticketfile3").innerHTML)
      {
        document.getElementById("id_ajax_doc_ticketfile3").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_operator_response_mob_submit_form_cb_after_alert);
  } // do_ajax_form_operator_response_mob_submit_form_cb
  function do_ajax_form_operator_response_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_operator_response_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_operator_response_mob_navigate_form()
  {
    perform_ajax_form_operator_response_mob_navigate_form();
  }

  function perform_ajax_form_operator_response_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_ticketmessageid = document.F2.ticketmessageid.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_operator_response_mob_navigate_form(var_ticketmessageid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_operator_response_mob_navigate_form_cb);
  } // do_ajax_form_operator_response_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_operator_response_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_operator_response_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.ticketmessageid.value = scAjaxGetKeyValue("ticketmessageid");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_operator_response_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_operator_response_mob_navigate_form_cb
  function do_ajax_form_operator_response_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_operator_response_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_operator_response_mob_navigate_form_cb_after_alert

  function sc_hide_form_operator_response_mob_form()
  {
  ...
  ajax_field_list[0] = "ticketpriorityid";
  ajax_field_list[1] = "categoryid";
  ajax_field_list[2] = "templateid";
  ajax_field_list[3] = "ticketcontent";
  ajax_field_list[4] = "closeticket";
  ajax_field_list[5] = "transferticket";
  ajax_field_list[6] = "ticketfile1";
  ajax_field_list[7] = "ticketfile2";
  ajax_field_list[8] = "ticketfile3";
  ajax_field_list[9] = "messagenote";
  ...
  var ajax_error_list = {
    "ticketpriorityid": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_fild_ticketpriorityid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categoryid": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "templateid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tble_message_templates'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ticketcontent": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketmessage_fild_ticketcontent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "closeticket": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_close'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "transferticket": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_transfer'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ticketfile1": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketmessage_fild_ticketfile1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ticketfile2": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketmessage_fild_ticketfile2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ticketfile3": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketmessage_fild_ticketfile3'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "messagenote": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketmessage_fild_messagenote'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "ticketpriorityid": new Array(),
    "categoryid": new Array(),
    "templateid": new Array(),
    "ticketcontent": new Array(),
    "closeticket": new Array(),
    "transferticket": new Array(),
    "ticketfile1": new Array(),
    "ticketfile2": new Array(),
    "ticketfile3": new Array(),
    "messagenote": new Array()
  };
  ajax_field_mult["ticketpriorityid"][1] = "ticketpriorityid";
  ajax_field_mult["categoryid"][1] = "categoryid";
  ajax_field_mult["templateid"][1] = "templateid";
  ajax_field_mult["ticketcontent"][1] = "ticketcontent";
  ajax_field_mult["closeticket"][1] = "closeticket";
  ajax_field_mult["transferticket"][1] = "transferticket";
  ajax_field_mult["ticketfile1"][1] = "ticketfile1";
  ajax_field_mult["ticketfile2"][1] = "ticketfile2";
  ajax_field_mult["ticketfile3"][1] = "ticketfile3";
  ajax_field_mult["messagenote"][1] = "messagenote";

  var ajax_field_id = {
    "ticketpriorityid": new Array("hidden_field_label_ticketpriorityid", "hidden_field_data_ticketpriorityid"),
    "categoryid": new Array("hidden_field_label_categoryid", "hidden_field_data_categoryid"),
    "templateid": new Array("hidden_field_label_templateid", "hidden_field_data_templateid"),
    "ticketcontent": new Array("hidden_field_label_ticketcontent", "hidden_field_data_ticketcontent"),
    "closeticket": new Array("hidden_field_label_closeticket", "hidden_field_data_closeticket"),
    "transferticket": new Array("hidden_field_label_transferticket", "hidden_field_data_transferticket"),
    "ticketfile1": new Array("hidden_field_label_ticketfile1", "hidden_field_data_ticketfile1"),
    "ticketfile2": new Array("hidden_field_label_ticketfile2", "hidden_field_data_ticketfile2"),
    "ticketfile3": new Array("hidden_field_label_ticketfile3", "hidden_field_data_ticketfile3"),
    "messagenote": new Array("hidden_field_label_messagenote", "hidden_field_data_messagenote")
  };

  var ajax_read_only = {
    "ticketpriorityid": "off",
    "categoryid": "off",
    "templateid": "off",
    "ticketcontent": "off",
    "closeticket": "off",
