  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_systemsettings_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_systemsettings_mob_form();
	}
...
?>
  ...
  function do_ajax_form_systemsettings_mob_validate_companyname()
  {
    var nomeCampo_companyname = "companyname";
    var var_companyname = scAjaxGetFieldText(nomeCampo_companyname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_companyname(var_companyname, var_script_case_init, do_ajax_form_systemsettings_mob_validate_companyname_cb);
  } // do_ajax_form_systemsettings_mob_validate_companyname

  function do_ajax_form_systemsettings_mob_validate_companyname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_companyname_cb

  // ---------- Validate assigmentmode
  function do_ajax_form_systemsettings_mob_validate_assigmentmode()
  {
    var nomeCampo_assigmentmode = "assigmentmode";
    var var_assigmentmode = scAjaxGetFieldSelect(nomeCampo_assigmentmode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_assigmentmode(var_assigmentmode, var_script_case_init, do_ajax_form_systemsettings_mob_validate_assigmentmode_cb);
  } // do_ajax_form_systemsettings_mob_validate_assigmentmode

  function do_ajax_form_systemsettings_mob_validate_assigmentmode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_assigmentmode_cb

  // ---------- Validate publicticketsopening
  function do_ajax_form_systemsettings_mob_validate_publicticketsopening()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_publicticketsopening(var_publicticketsopening, var_script_case_init, do_ajax_form_systemsettings_mob_validate_publicticketsopening_cb);
  } // do_ajax_form_systemsettings_mob_validate_publicticketsopening

  function do_ajax_form_systemsettings_mob_validate_publicticketsopening_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_publicticketsopening_cb

  // ---------- Validate defaultpriority
  function do_ajax_form_systemsettings_mob_validate_defaultpriority()
  {
    var nomeCampo_defaultpriority = "defaultpriority";
    var var_defaultpriority = scAjaxGetFieldText(nomeCampo_defaultpriority);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_defaultpriority(var_defaultpriority, var_script_case_init, do_ajax_form_systemsettings_mob_validate_defaultpriority_cb);
  } // do_ajax_form_systemsettings_mob_validate_defaultpriority

  function do_ajax_form_systemsettings_mob_validate_defaultpriority_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_defaultpriority_cb

  // ---------- Validate urltrackingscreen
  function do_ajax_form_systemsettings_mob_validate_urltrackingscreen()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_urltrackingscreen(var_urltrackingscreen, var_script_case_init, do_ajax_form_systemsettings_mob_validate_urltrackingscreen_cb);
  } // do_ajax_form_systemsettings_mob_validate_urltrackingscreen

  function do_ajax_form_systemsettings_mob_validate_urltrackingscreen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_urltrackingscreen_cb

  // ---------- Validate urlconfirmationscreen
  function do_ajax_form_systemsettings_mob_validate_urlconfirmationscreen()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_urlconfirmationscreen(var_urlconfirmationscreen, var_script_case_init, do_ajax_form_systemsettings_mob_validate_urlconfirmationscreen_cb);
  } // do_ajax_form_systemsettings_mob_validate_urlconfirmationscreen

  function do_ajax_form_systemsettings_mob_validate_urlconfirmationscreen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_urlconfirmationscreen_cb

  // ---------- Validate broadcastmessages
  function do_ajax_form_systemsettings_mob_validate_broadcastmessages()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_broadcastmessages(var_broadcastmessages, var_script_case_init, do_ajax_form_systemsettings_mob_validate_broadcastmessages_cb);
  } // do_ajax_form_systemsettings_mob_validate_broadcastmessages

  function do_ajax_form_systemsettings_mob_validate_broadcastmessages_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_broadcastmessages_cb

  // ---------- Validate defaultlanguage
  function do_ajax_form_systemsettings_mob_validate_defaultlanguage()
  {
    var nomeCampo_defaultlanguage = "defaultlanguage";
    var var_defaultlanguage = scAjaxGetFieldText(nomeCampo_defaultlanguage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_defaultlanguage(var_defaultlanguage, var_script_case_init, do_ajax_form_systemsettings_mob_validate_defaultlanguage_cb);
  } // do_ajax_form_systemsettings_mob_validate_defaultlanguage

  function do_ajax_form_systemsettings_mob_validate_defaultlanguage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_defaultlanguage_cb

  // ---------- Validate emailaccount
  function do_ajax_form_systemsettings_mob_validate_emailaccount()
  {
    var nomeCampo_emailaccount = "emailaccount";
    var var_emailaccount = scAjaxGetFieldText(nomeCampo_emailaccount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_emailaccount(var_emailaccount, var_script_case_init, do_ajax_form_systemsettings_mob_validate_emailaccount_cb);
  } // do_ajax_form_systemsettings_mob_validate_emailaccount

  function do_ajax_form_systemsettings_mob_validate_emailaccount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_emailaccount_cb

  // ---------- Validate smtpserver
  function do_ajax_form_systemsettings_mob_validate_smtpserver()
  {
    var nomeCampo_smtpserver = "smtpserver";
    var var_smtpserver = scAjaxGetFieldText(nomeCampo_smtpserver);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_smtpserver(var_smtpserver, var_script_case_init, do_ajax_form_systemsettings_mob_validate_smtpserver_cb);
  } // do_ajax_form_systemsettings_mob_validate_smtpserver

  function do_ajax_form_systemsettings_mob_validate_smtpserver_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_smtpserver_cb

  // ---------- Validate smtpuser
  function do_ajax_form_systemsettings_mob_validate_smtpuser()
  {
    var nomeCampo_smtpuser = "smtpuser";
    var var_smtpuser = scAjaxGetFieldText(nomeCampo_smtpuser);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_smtpuser(var_smtpuser, var_script_case_init, do_ajax_form_systemsettings_mob_validate_smtpuser_cb);
  } // do_ajax_form_systemsettings_mob_validate_smtpuser

  function do_ajax_form_systemsettings_mob_validate_smtpuser_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_smtpuser_cb

  // ---------- Validate smtppassword
  function do_ajax_form_systemsettings_mob_validate_smtppassword()
  {
    var nomeCampo_smtppassword = "smtppassword";
    var var_smtppassword = scAjaxGetFieldText(nomeCampo_smtppassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_smtppassword(var_smtppassword, var_script_case_init, do_ajax_form_systemsettings_mob_validate_smtppassword_cb);
  } // do_ajax_form_systemsettings_mob_validate_smtppassword

  function do_ajax_form_systemsettings_mob_validate_smtppassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_smtppassword_cb

  // ---------- Validate smtpsecurityflag
  function do_ajax_form_systemsettings_mob_validate_smtpsecurityflag()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_smtpsecurityflag(var_smtpsecurityflag, var_script_case_init, do_ajax_form_systemsettings_mob_validate_smtpsecurityflag_cb);
  } // do_ajax_form_systemsettings_mob_validate_smtpsecurityflag

  function do_ajax_form_systemsettings_mob_validate_smtpsecurityflag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_smtpsecurityflag_cb

  // ---------- Validate smtpport
  function do_ajax_form_systemsettings_mob_validate_smtpport()
  {
    var nomeCampo_smtpport = "smtpport";
    var var_smtpport = scAjaxGetFieldText(nomeCampo_smtpport);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_smtpport(var_smtpport, var_script_case_init, do_ajax_form_systemsettings_mob_validate_smtpport_cb);
  } // do_ajax_form_systemsettings_mob_validate_smtpport

  function do_ajax_form_systemsettings_mob_validate_smtpport_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_smtpport_cb

  // ---------- Validate id
  function do_ajax_form_systemsettings_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemsettings_mob_validate_id(var_id, var_script_case_init, do_ajax_form_systemsettings_mob_validate_id_cb);
  } // do_ajax_form_systemsettings_mob_validate_id

  function do_ajax_form_systemsettings_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemsettings_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_systemsettings_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_systemsettings_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_defaultpriority = scAjaxGetFieldText("defaultpriority");
    ...
    scAjaxProcOn();
    x_ajax_form_systemsettings_mob_submit_form(var_companyname, var_assigmentmode, var_publicticketsopening, var_defaultpriority, var_urltrackingscreen, var_urlconfirmationscreen, var_broadcastmessages, var_defaultlanguage, var_emailaccount, var_smtpserver, var_smtpuser, var_smtppassword, var_smtpsecurityflag, var_smtpport, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_systemsettings_mob_submit_form_cb);
  } // do_ajax_form_systemsettings_mob_submit_form

  function do_ajax_form_systemsettings_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_systemsettings_mob_submit_form_cb_after_alert);
  } // do_ajax_form_systemsettings_mob_submit_form_cb
  function do_ajax_form_systemsettings_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_systemsettings_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_systemsettings_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_systemsettings_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_systemsettings_mob_navigate_form();
    }
  }

  function perform_ajax_form_systemsettings_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_systemsettings_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_systemsettings_mob_navigate_form_cb);
  } // do_ajax_form_systemsettings_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_systemsettings_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_systemsettings_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_systemsettings_mob_navigate_form_cb
  function do_ajax_form_systemsettings_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_systemsettings_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_systemsettings_mob_navigate_form_cb_after_alert

  function sc_hide_form_systemsettings_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "defaultpriority": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fild_defaultpriority'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "urlconfirmationscreen": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemsettings_fld_urlconfirmationscreen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
