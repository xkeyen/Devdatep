  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_canned_message" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_canned_message_form();
	}
...
?>
  ...
  // ---------- Validate templateid
  function do_ajax_form_canned_message_validate_templateid()
  {
    var nomeCampo_templateid = "templateid";
    var var_templateid = scAjaxGetFieldHidden(nomeCampo_templateid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_validate_templateid(var_templateid, var_script_case_init, do_ajax_form_canned_message_validate_templateid_cb);
  } // do_ajax_form_canned_message_validate_templateid

  function do_ajax_form_canned_message_validate_templateid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_validate_templateid_cb

  // ---------- Validate categoryid
  function do_ajax_form_canned_message_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldSelect(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_canned_message_validate_categoryid_cb);
  } // do_ajax_form_canned_message_validate_categoryid

  function do_ajax_form_canned_message_validate_categoryid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_validate_categoryid_cb

  // ---------- Validate templatedescription
  function do_ajax_form_canned_message_validate_templatedescription()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_validate_templatedescription(var_templatedescription, var_script_case_init, do_ajax_form_canned_message_validate_templatedescription_cb);
  } // do_ajax_form_canned_message_validate_templatedescription

  function do_ajax_form_canned_message_validate_templatedescription_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_validate_templatedescription_cb

  // ---------- Validate templatecontent
  function do_ajax_form_canned_message_validate_templatecontent()
  {
    var nomeCampo_templatecontent = "templatecontent";
    var var_templatecontent = scAjaxGetFieldText(nomeCampo_templatecontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_validate_templatecontent(var_templatecontent, var_script_case_init, do_ajax_form_canned_message_validate_templatecontent_cb);
  } // do_ajax_form_canned_message_validate_templatecontent

  function do_ajax_form_canned_message_validate_templatecontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_validate_templatecontent_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_canned_message_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_canned_message_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_canned_message_submit_form(var_templateid, var_categoryid, var_templatedescription, var_templatecontent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_canned_message_submit_form_cb);
  } // do_ajax_form_canned_message_submit_form

  function do_ajax_form_canned_message_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_canned_message_submit_form_cb_after_alert);
  } // do_ajax_form_canned_message_submit_form_cb
  function do_ajax_form_canned_message_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_canned_message_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_canned_message_navigate_form()
  {
    perform_ajax_form_canned_message_navigate_form();
  }

  function perform_ajax_form_canned_message_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_canned_message_navigate_form(var_templateid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_canned_message_navigate_form_cb);
  } // do_ajax_form_canned_message_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_canned_message']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_canned_message_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_canned_message_navigate_form_cb_after_alert);
  } // do_ajax_form_canned_message_navigate_form_cb
  function do_ajax_form_canned_message_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_canned_message_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_canned_message_navigate_form_cb_after_alert

  function sc_hide_form_canned_message_form()
  {
