...
<?php
   ...
   $Ord_Cmp = new grid_customer_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_customer_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["customerid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customerid"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customerid"] : "" . $this->Nm_lang['lang_customer_fild_customerid'] . "";
   $tab_ger_campos['customername'] = "on";
   $tab_def_campos['customername'] = "customername";
   $tab_labels["customername"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customername"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customername"] : "" . $this->Nm_lang['lang_customer_fild_customername'] . "";
   $tab_ger_campos['customeremail'] = "on";
   $tab_def_campos['customeremail'] = "customeremail";
   $tab_labels["customeremail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customeremail"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customeremail"] : "" . $this->Nm_lang['lang_customer_fild_customeremail'] . "";
   $tab_ger_campos['customerphone'] = "on";
   $tab_def_campos['customerphone'] = "customerphone";
   $tab_labels["customerphone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customerphone"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer']['labels']["customerphone"] : "" . $this->Nm_lang['lang_customer_fild_customerphone'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customer']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customer']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_customer_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customer']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
