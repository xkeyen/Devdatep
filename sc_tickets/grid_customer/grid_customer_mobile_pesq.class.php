...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_customerid_cond" name="customerid_cond" onChange="nm_campos_between(document.getElementById('id_vis_customerid'), this, 'customerid')">
      ...
      <br><span id="id_hide_customerid"  <?php echo $str_hide_customerid?>><INPUT  type="text" id="SC_customerid" name="customerid" value="<?php echo NM_encode_input($customerid) ?>" size=4 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
