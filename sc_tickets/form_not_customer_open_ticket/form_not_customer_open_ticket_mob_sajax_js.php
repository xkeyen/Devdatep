  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_not_customer_open_ticket_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_not_customer_open_ticket_mob_form();
	}
...
?>
  ...
  // ---------- Validate fld_customer_name
  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name()
  {
    var nomeCampo_fld_customer_name = "fld_customer_name";
    var var_fld_customer_name = scAjaxGetFieldText(nomeCampo_fld_customer_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name(var_fld_customer_name, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name

  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_customer_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_name_cb

  // ---------- Validate fld_customer_email
  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email()
  {
    var nomeCampo_fld_customer_email = "fld_customer_email";
    var var_fld_customer_email = scAjaxGetFieldText(nomeCampo_fld_customer_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email(var_fld_customer_email, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email

  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_customer_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_customer_email_cb

  // ---------- Validate fld_language
  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_language()
  {
    var nomeCampo_fld_language = "fld_language";
    var var_fld_language = scAjaxGetFieldText(nomeCampo_fld_language);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_fld_language(var_fld_language, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_fld_language_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_language

  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_language";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_language_cb

  // ---------- Validate fld_category
  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_category()
  {
    var nomeCampo_fld_category = "fld_category";
    var var_fld_category = scAjaxGetFieldSelect(nomeCampo_fld_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_fld_category(var_fld_category, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_fld_category_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_category

  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_category";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_category_cb

  // ---------- Validate fld_subject
  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_subject()
  {
    var nomeCampo_fld_subject = "fld_subject";
    var var_fld_subject = scAjaxGetFieldText(nomeCampo_fld_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_fld_subject(var_fld_subject, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_fld_subject_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_subject

  function do_ajax_form_not_customer_open_ticket_mob_validate_fld_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fld_subject";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_fld_subject_cb

  // ---------- Validate ticketcontent
  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent()
  {
    var nomeCampo_ticketcontent = "ticketcontent";
    var var_ticketcontent = scAjaxGetFieldEditorHtml(nomeCampo_ticketcontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent(var_ticketcontent, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent

  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketcontent_cb

  // ---------- Validate ticketfile1
  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1()
  {
    var nomeCampo_ticketfile1 = "ticketfile1";
    var var_ticketfile1 = scAjaxGetFieldText(nomeCampo_ticketfile1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1(var_ticketfile1, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1

  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile1_cb

  // ---------- Validate ticketfile2
  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2()
  {
    var nomeCampo_ticketfile2 = "ticketfile2";
    var var_ticketfile2 = scAjaxGetFieldText(nomeCampo_ticketfile2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2(var_ticketfile2, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2

  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile2_cb

  // ---------- Validate ticketfile3
  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3()
  {
    var nomeCampo_ticketfile3 = "ticketfile3";
    var var_ticketfile3 = scAjaxGetFieldText(nomeCampo_ticketfile3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3(var_ticketfile3, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3

  function do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_not_customer_open_ticket_mob_validate_ticketfile3_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_not_customer_open_ticket_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_not_customer_open_ticket_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fld_customer_name = scAjaxGetFieldText("fld_customer_name");
    var var_fld_customer_email = scAjaxGetFieldText("fld_customer_email");
    var var_fld_language = scAjaxGetFieldText("fld_language");
    var var_fld_category = scAjaxGetFieldSelect("fld_category");
    var var_fld_subject = scAjaxGetFieldText("fld_subject");
    ...
    scAjaxProcOn();
    x_ajax_form_not_customer_open_ticket_mob_submit_form(var_fld_customer_name, var_fld_customer_email, var_fld_language, var_fld_category, var_fld_subject, var_ticketcontent, var_ticketfile1, var_ticketfile2, var_ticketfile3, var_ticketmessageid, var_ticketid, var_ticketfile1_ul_name, var_ticketfile1_ul_type, var_ticketfile2_ul_name, var_ticketfile2_ul_type, var_ticketfile3_ul_name, var_ticketfile3_ul_type, var_ticketfile1_limpa, var_ticketfile2_limpa, var_ticketfile3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_captcha_sent, var_csrf_token, do_ajax_form_not_customer_open_ticket_mob_submit_form_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_submit_form

  function do_ajax_form_not_customer_open_ticket_mob_submit_form_cb(sResp)
  {
    captchaReloadImage();
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_not_customer_open_ticket_mob_submit_form_cb_after_alert);
  } // do_ajax_form_not_customer_open_ticket_mob_submit_form_cb
  function do_ajax_form_not_customer_open_ticket_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_not_customer_open_ticket_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_not_customer_open_ticket_mob_navigate_form()
  {
    perform_ajax_form_not_customer_open_ticket_mob_navigate_form();
  }

  function perform_ajax_form_not_customer_open_ticket_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_ticketid = document.F2.ticketid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_not_customer_open_ticket_mob_navigate_form(var_ticketmessageid, var_ticketid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb);
  } // do_ajax_form_not_customer_open_ticket_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb(sResp)
  {
    captchaReloadImage();
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.ticketid.value = scAjaxGetKeyValue("ticketid");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb
  function do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_not_customer_open_ticket_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_not_customer_open_ticket_mob_navigate_form_cb_after_alert

  function sc_hide_form_not_customer_open_ticket_mob_form()
  {
  ...
  ajax_field_list[0] = "fld_customer_name";
  ajax_field_list[1] = "fld_customer_email";
  ajax_field_list[2] = "fld_language";
  ajax_field_list[3] = "fld_category";
  ajax_field_list[4] = "fld_subject";
  ajax_field_list[5] = "ticketcontent";
  ...
  var ajax_error_list = {
    "fld_customer_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customername'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_customer_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customeremail'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_language": {"label": "<?php echo $this->Ini->Nm_lang['lang_fld_language'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_category": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fld_subject": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_fild_subject'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    "fld_customer_name": new Array(),
    "fld_customer_email": new Array(),
    "fld_language": new Array(),
    "fld_category": new Array(),
    "fld_subject": new Array(),
    "ticketcontent": new Array(),
    "ticketfile1": new Array(),
    "ticketfile2": new Array(),
    "ticketfile3": new Array()
  };
  ajax_field_mult["fld_customer_name"][1] = "fld_customer_name";
  ajax_field_mult["fld_customer_email"][1] = "fld_customer_email";
  ajax_field_mult["fld_language"][1] = "fld_language";
  ajax_field_mult["fld_category"][1] = "fld_category";
  ajax_field_mult["fld_subject"][1] = "fld_subject";
  ...
  var ajax_field_id = {
    "fld_customer_name": new Array("hidden_field_label_fld_customer_name", "hidden_field_data_fld_customer_name"),
    "fld_customer_email": new Array("hidden_field_label_fld_customer_email", "hidden_field_data_fld_customer_email"),
    "fld_language": new Array("hidden_field_label_fld_language", "hidden_field_data_fld_language"),
    "fld_category": new Array("hidden_field_label_fld_category", "hidden_field_data_fld_category"),
    "fld_subject": new Array("hidden_field_label_fld_subject", "hidden_field_data_fld_subject"),
  ...
  var ajax_read_only = {
    "fld_customer_name": "off",
    "fld_customer_email": "off",
    "fld_language": "off",
    "fld_category": "off",
    "fld_subject": "off",
    "ticketcontent": "off",
