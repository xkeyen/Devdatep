<?php  
  include_once('borrador_session.php');
  session_start() ;
  class borrador_form_teste
  {
  function borrador_teste()
  {
...
<?php  
  ...
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'borrador')
  {
...
<?php
  ...
  $frm_teste = new borrador_form_teste();
  $frm_teste->borrador_teste();
?>
