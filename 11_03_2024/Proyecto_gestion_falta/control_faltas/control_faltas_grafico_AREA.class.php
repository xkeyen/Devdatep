...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->NM_tit_val[1]     = strip_tags("AREA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")");
      $this->NM_ind_val[1]     = 1;
      ...
      $this->label    = array();
      $this->label[0] = "AREA";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_faltas']['contr_label_graf']['area']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_faltas']['contr_label_graf']['area']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_faltas']['contr_label_graf']['area'];
      }
   }
