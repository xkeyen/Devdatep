<?php
@session_start() ;
$_SESSION['scriptcase']['control_faltas']['sc_process_barr'] = true;
require_once('../control_faltas/index.php');
unset($_SESSION['scriptcase']['control_faltas']['sc_process_barr']);
$ExportCtrl = new control_faltas_export_control;
$ExportCtrl->Export_barr();

class control_faltas_export_control
{
