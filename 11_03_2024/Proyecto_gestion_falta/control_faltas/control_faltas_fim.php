...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_falta_____control_faltas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_falta_____control_faltas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_faltas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['control_faltas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_faltas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['control_faltas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['control_faltas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['control_faltas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['control_faltas']['embutida_filho'] as $ind => $sc_init)
          {
