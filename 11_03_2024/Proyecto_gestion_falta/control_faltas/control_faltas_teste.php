<?php  
  ...
  session_start() ;
  class control_faltas_form_teste
  {
  function control_faltas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">control_faltas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="control_faltas"> 
</form> 
...
<?php
  ...
  $frm_teste = new control_faltas_form_teste();
  $frm_teste->control_faltas_teste();
?>
