...
?>
  ...
  var ajax_error_list = {
    "session_expire": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_session_expire'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "remember_me": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_remember_me'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cookie_expiration_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_cookie_exp_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "retrieve_password": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_retrieve_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "new_users": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_new_users'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "brute_force": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_brute_force'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "brute_force_time_block": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_bf_time_bl'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "brute_force_attempts": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_bf_attempts'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "enable_2fa": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_2fa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "enable_2fa_expiration_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_set_2fa_exp_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
