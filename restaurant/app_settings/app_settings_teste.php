<?php  
  ...
  session_start() ;
  class app_settings_form_teste
  {
   function app_settings_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_settings/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_settings</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_settings"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_settings_form_teste();
  $frm_teste->app_settings_teste();
?>
