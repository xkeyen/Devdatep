...
//
   ...
   $_SESSION['scriptcase']['app_settings']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['app_settings']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['app_settings']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['app_settings']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['app_settings']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['app_settings']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php73/wwwrootC:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['app_settings']['glo_nm_conexao']         = "conn_example";
   $NM_dir_atual = getcwd();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'restaurant', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_settings']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'restaurant', 1, $this->force_db_utf8);
    }
    else {
...
//---
   ...
   function app_settings_pack_ajax_nav_Summary(&$aResp)
   {
      ...
      $aResp['navSummary']['summary_line'] = $inicial_app_settings->contr_app_settings->NM_ajax_info['summary_line'];
