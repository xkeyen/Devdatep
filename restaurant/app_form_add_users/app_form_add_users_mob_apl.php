...
//
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
//
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Field_no_validate'] = array();
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['total'] + 1,
            ],
            $summaryLine
        );
