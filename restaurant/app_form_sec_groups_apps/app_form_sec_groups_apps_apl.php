...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_sec_groups_apps']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_sec_groups_apps']['label'] = "" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['app_form_sec_groups_apps']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
   ...
   function controle()
   {
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                'total' == $this->form_paginacao ? 1 : $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['reg_start'] + $this->summary_record_count,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['total'] + 1,
            ],
            $summaryLine
        );
