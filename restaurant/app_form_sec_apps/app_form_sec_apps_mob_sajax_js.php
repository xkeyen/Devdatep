...
?>
  ...
  function perform_ajax_app_form_sec_apps_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_apps_mob_navigate_form(var_app_name, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_apps_mob_navigate_form_cb);
...
?>
  ...
  var ajax_error_list = {
    "app_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
