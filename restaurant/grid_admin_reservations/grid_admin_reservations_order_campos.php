...
<?php
   ...
   $Ord_Cmp = new grid_admin_reservations_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_reservations_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['r_reservation_date'] = "r_reservation_date";
   }
   else
   {
       $tab_def_campos['r_reservation_date'] = "r.reservation_date";
   }
   $tab_labels["r_reservation_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_reservation_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_reservation_date"] : "" . $this->Nm_lang['lang_tb_reservations_fld_reservation_date'] . "";
   $tab_ger_campos['r_reservation_time'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r_reservation_time'] = "r_reservation_time";
   }
   else
   {
       $tab_def_campos['r_reservation_time'] = "r.reservation_time";
   }
   $tab_labels["r_reservation_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_reservation_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_reservation_time"] : "" . $this->Nm_lang['lang_tb_reservations_fld_reservation_time'] . "";
   $tab_ger_campos['r_number_hours'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r_number_hours'] = "r_number_hours";
   }
   else
   {
       $tab_def_campos['r_number_hours'] = "r.number_hours";
   }
   $tab_labels["r_number_hours"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_number_hours"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_number_hours"] : "" . $this->Nm_lang['lang_tb_reservations_fld_number_hours'] . "";
   $tab_ger_campos['r_people'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r_people'] = "r_people";
   }
   else
   {
       $tab_def_campos['r_people'] = "r.people";
   }
   $tab_labels["r_people"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_people"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["r_people"] : "" . $this->Nm_lang['lang_tb_reservations_fld_people'] . "";
   $tab_ger_campos['s_stage_info'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['s_stage_info'] = "s_stage_info";
   }
   else
   {
       $tab_def_campos['s_stage_info'] = "s.stage_info";
   }
   $tab_labels["s_stage_info"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["s_stage_info"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['labels']["s_stage_info"] : "" . $this->Nm_lang['lang_tb_stages_fld_stage_info'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_reservations_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_reservations']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
