<?php
@session_start() ;
$_SESSION['scriptcase']['grid_admin_reservations']['sc_process_barr'] = true;
require_once('../grid_admin_reservations/index.php');
unset($_SESSION['scriptcase']['grid_admin_reservations']['sc_process_barr']);
$ExportCtrl = new grid_admin_reservations_export_control;
$ExportCtrl->Export_barr();

class grid_admin_reservations_export_control
{
