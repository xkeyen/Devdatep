<?php
@session_start() ;
$_SESSION['scriptcase']['grid_receipt']['sc_process_barr'] = true;
require_once('../grid_receipt/index.php');
unset($_SESSION['scriptcase']['grid_receipt']['sc_process_barr']);
$ExportCtrl = new grid_receipt_export_control;
$ExportCtrl->Export_barr();

class grid_receipt_export_control
{
