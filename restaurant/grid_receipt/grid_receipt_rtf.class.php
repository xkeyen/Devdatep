...
$_SESSION['scriptcase']['grid_receipt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_name']);
      }
   ...
   function NM_export_tb_orders_dt_order_start()
   {
         ...
         $this->tb_orders_dt_order_start = str_replace('<', '&lt;', $this->tb_orders_dt_order_start);
         $this->tb_orders_dt_order_start = str_replace('>', '&gt;', $this->tb_orders_dt_order_start);
         $this->Texto_tag .= "<td>" . $this->tb_orders_dt_order_start . "</td>\r\n";
   }
   ...
   function NM_export_tb_orders_dt_order_end()
   {
         ...
         $this->tb_orders_dt_order_end = str_replace('<', '&lt;', $this->tb_orders_dt_order_end);
         $this->tb_orders_dt_order_end = str_replace('>', '&gt;', $this->tb_orders_dt_order_end);
         $this->Texto_tag .= "<td>" . $this->tb_orders_dt_order_end . "</td>\r\n";
   }
   ...
   function NM_export_tb_orders_order_value()
   {
         ...
         $this->tb_orders_order_value = str_replace('<', '&lt;', $this->tb_orders_order_value);
         $this->tb_orders_order_value = str_replace('>', '&gt;', $this->tb_orders_order_value);
         $this->Texto_tag .= "<td>" . $this->tb_orders_order_value . "</td>\r\n";
   }
   ...
   function NM_export_tb_orders_people()
   {
         ...
         $this->tb_orders_people = str_replace('<', '&lt;', $this->tb_orders_people);
         $this->tb_orders_people = str_replace('>', '&gt;', $this->tb_orders_people);
         $this->Texto_tag .= "<td>" . $this->tb_orders_people . "</td>\r\n";
   }
   ...
   function NM_export_tb_order_table_id_order()
   {
         ...
         $this->tb_order_table_id_order = str_replace('<', '&lt;', $this->tb_order_table_id_order);
         $this->tb_order_table_id_order = str_replace('>', '&gt;', $this->tb_order_table_id_order);
         $this->Texto_tag .= "<td>" . $this->tb_order_table_id_order . "</td>\r\n";
   }
   ...
   function NM_export_tb_order_table_main_table()
   {
         ...
         $this->tb_order_table_main_table = str_replace('<', '&lt;', $this->tb_order_table_main_table);
         $this->tb_order_table_main_table = str_replace('>', '&gt;', $this->tb_order_table_main_table);
         $this->Texto_tag .= "<td>" . $this->tb_order_table_main_table . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
