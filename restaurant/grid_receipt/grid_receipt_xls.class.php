...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_receipt/grid_receipt_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_receipt_res_xls.class.php");
              $this->Res_xls = new grid_receipt_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_receipt.zip";
          $this->Arquivo   .= "_grid_receipt" . $this->Xls_tp;
          $this->Tit_doc    = "grid_receipt" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_receipt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "tb_orders_dt_order_start" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "tb_orders_dt_order_end" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "tb_orders_order_value" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "tb_orders_people" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "tb_order_table_id_order" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "tb_order_table_main_table" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_tb_orders_id_order()
   {
         ...
         if (is_numeric($this->tb_orders_id_order))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_orders_id_order);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_orders_dt_order_start()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->tb_orders_dt_order_start))
      {
         ...
         $this->tb_orders_dt_order_start = NM_charset_to_utf8($this->tb_orders_dt_order_start);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_dt_order_start, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_dt_order_start, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_orders_dt_order_end()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->tb_orders_dt_order_end))
      {
         ...
         $this->tb_orders_dt_order_end = NM_charset_to_utf8($this->tb_orders_dt_order_end);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_dt_order_end, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_dt_order_end, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_orders_order_status()
   {
         ...
         if (is_numeric($this->tb_orders_order_status))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_orders_order_status);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_orders_order_value()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->tb_orders_order_value = NM_charset_to_utf8($this->tb_orders_order_value);
         if (is_numeric($this->tb_orders_order_value))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_orders_order_value);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_orders_user_login()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_user_login, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_orders_user_login, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tb_orders_people
   function NM_export_tb_orders_people()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->tb_orders_people = NM_charset_to_utf8($this->tb_orders_people);
         if (is_numeric($this->tb_orders_people))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_orders_people);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_order_table_id_order()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->tb_order_table_id_order = NM_charset_to_utf8($this->tb_order_table_id_order);
         if (is_numeric($this->tb_order_table_id_order))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_order_table_id_order);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_order_table_id_table()
   {
         ...
         if (is_numeric($this->tb_order_table_id_table))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_order_table_id_table);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_order_table_main_table()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->tb_order_table_main_table = NM_charset_to_utf8($this->tb_order_table_main_table);
         if (is_numeric($this->tb_order_table_main_table))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_order_table_main_table);
         $this->Xls_col++;
   }
   //----- tb_orders_id_order
   function NM_sub_cons_tb_orders_id_order()
   {
         $this->tb_orders_id_order = NM_charset_to_utf8($this->tb_orders_id_order);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_id_order;
   ...
   //----- tb_orders_dt_order_start
   function NM_sub_cons_tb_orders_dt_order_start()
   {
      if (!empty($this->tb_orders_dt_order_start))
      {
         if (substr($this->tb_orders_dt_order_start, 10, 1) == "-") 
         ...
         $this->tb_orders_dt_order_start = NM_charset_to_utf8($this->tb_orders_dt_order_start);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_dt_order_start;
   ...
   //----- tb_orders_dt_order_end
   function NM_sub_cons_tb_orders_dt_order_end()
   {
      if (!empty($this->tb_orders_dt_order_end))
      {
         if (substr($this->tb_orders_dt_order_end, 10, 1) == "-") 
         ...
         $this->tb_orders_dt_order_end = NM_charset_to_utf8($this->tb_orders_dt_order_end);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_dt_order_end;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tb_orders_order_status
   function NM_sub_cons_tb_orders_order_status()
   {
         $this->tb_orders_order_status = NM_charset_to_utf8($this->tb_orders_order_status);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_order_status;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_orders_order_value
   function NM_sub_cons_tb_orders_order_value()
   {
         $this->tb_orders_order_value = NM_charset_to_utf8($this->tb_orders_order_value);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_order_value;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- tb_orders_user_login
   function NM_sub_cons_tb_orders_user_login()
   {
         $this->tb_orders_user_login = html_entity_decode($this->tb_orders_user_login, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tb_orders_user_login = strip_tags($this->tb_orders_user_login);
         $this->tb_orders_user_login = NM_charset_to_utf8($this->tb_orders_user_login);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_user_login;
   ...
   //----- tb_orders_people
   function NM_sub_cons_tb_orders_people()
   {
         $this->tb_orders_people = NM_charset_to_utf8($this->tb_orders_people);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_orders_people;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_order_table_id_order
   function NM_sub_cons_tb_order_table_id_order()
   {
         $this->tb_order_table_id_order = NM_charset_to_utf8($this->tb_order_table_id_order);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_order_table_id_order;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_order_table_id_table
   function NM_sub_cons_tb_order_table_id_table()
   {
         $this->tb_order_table_id_table = NM_charset_to_utf8($this->tb_order_table_id_table);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_order_table_id_table;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_order_table_main_table
   function NM_sub_cons_tb_order_table_main_table()
   {
         $this->tb_order_table_main_table = NM_charset_to_utf8($this->tb_order_table_main_table);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_order_table_main_table;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_receipt']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
