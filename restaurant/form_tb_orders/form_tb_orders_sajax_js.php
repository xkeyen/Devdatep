  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_orders" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_order
  function do_ajax_form_tb_orders_validate_id_order()
  {
    var nomeCampo_id_order = "id_order";
    var var_id_order = scAjaxGetFieldHidden(nomeCampo_id_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_id_order(var_id_order, var_script_case_init, do_ajax_form_tb_orders_validate_id_order_cb);
  } // do_ajax_form_tb_orders_validate_id_order

  function do_ajax_form_tb_orders_validate_id_order_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_id_order_cb

  // ---------- Validate id_table
  function do_ajax_form_tb_orders_validate_id_table()
  {
    var nomeCampo_id_table = "id_table";
    var var_id_table = scAjaxGetFieldHidden(nomeCampo_id_table);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_id_table(var_id_table, var_script_case_init, do_ajax_form_tb_orders_validate_id_table_cb);
  } // do_ajax_form_tb_orders_validate_id_table

  function do_ajax_form_tb_orders_validate_id_table_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_id_table_cb

  // ---------- Validate people
  function do_ajax_form_tb_orders_validate_people()
  {
    var nomeCampo_people = "people";
    var var_people = scAjaxGetFieldText(nomeCampo_people);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_people(var_people, var_script_case_init, do_ajax_form_tb_orders_validate_people_cb);
  } // do_ajax_form_tb_orders_validate_people

  function do_ajax_form_tb_orders_validate_people_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "people";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_people_cb

  // ---------- Validate order_status
  function do_ajax_form_tb_orders_validate_order_status()
  {
    var nomeCampo_order_status = "order_status";
    var var_order_status = scAjaxGetFieldSelect(nomeCampo_order_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_order_status(var_order_status, var_script_case_init, do_ajax_form_tb_orders_validate_order_status_cb);
  } // do_ajax_form_tb_orders_validate_order_status

  function do_ajax_form_tb_orders_validate_order_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_order_status_cb

  // ---------- Validate dt_order_start
  function do_ajax_form_tb_orders_validate_dt_order_start()
  {
    var nomeCampo_dt_order_start = "dt_order_start";
    var var_dt_order_start = scAjaxGetFieldText(nomeCampo_dt_order_start);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_dt_order_start(var_dt_order_start, var_script_case_init, do_ajax_form_tb_orders_validate_dt_order_start_cb);
  } // do_ajax_form_tb_orders_validate_dt_order_start

  function do_ajax_form_tb_orders_validate_dt_order_start_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_dt_order_start_cb

  // ---------- Validate user_login
  function do_ajax_form_tb_orders_validate_user_login()
  {
    var nomeCampo_user_login = "user_login";
    var var_user_login = scAjaxGetFieldSelect(nomeCampo_user_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_user_login(var_user_login, var_script_case_init, do_ajax_form_tb_orders_validate_user_login_cb);
  } // do_ajax_form_tb_orders_validate_user_login

  function do_ajax_form_tb_orders_validate_user_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_user_login_cb

  // ---------- Validate items
  function do_ajax_form_tb_orders_validate_items()
  {
    var nomeCampo_items = "items";
    var var_items = scAjaxGetFieldText(nomeCampo_items);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_validate_items(var_items, var_script_case_init, do_ajax_form_tb_orders_validate_items_cb);
  } // do_ajax_form_tb_orders_validate_items

  function do_ajax_form_tb_orders_validate_items_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "items";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_validate_items_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_orders_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_orders_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_orders_submit_form(var_id_order, var_id_table, var_people, var_order_status, var_dt_order_start, var_user_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_orders_submit_form_cb);
  } // do_ajax_form_tb_orders_submit_form

  function do_ajax_form_tb_orders_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_orders_submit_form_cb_after_alert);
  } // do_ajax_form_tb_orders_submit_form_cb
  function do_ajax_form_tb_orders_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_orders_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tb_order_items"] = "off";

  function do_ajax_form_tb_orders_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_orders_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_orders_navigate_form();
    }
  }

  function perform_ajax_form_tb_orders_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tb_order_items"] = "on";
    x_ajax_form_tb_orders_navigate_form(var_id_order, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_orders_navigate_form_cb);
  } // do_ajax_form_tb_orders_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_orders']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_orders_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items"] && "nmsc_iframe_liga_form_tb_order_items" != scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tb_order_items').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_tb_order_items').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_tb_order_items').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_orders_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_orders_navigate_form_cb
  function do_ajax_form_tb_orders_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tb_orders_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_orders_navigate_form_cb_after_alert

  function sc_hide_form_tb_orders_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tb_order_items"])
    {
      return true;
    }
    return false;
