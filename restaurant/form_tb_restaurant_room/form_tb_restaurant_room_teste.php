<?php  
  ...
  session_start() ;
  class form_tb_restaurant_room_form_teste
  {
   function form_tb_restaurant_room_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_restaurant_room/img";
...
<?php
  ...
  $frm_teste = new form_tb_restaurant_room_form_teste();
  $frm_teste->form_tb_restaurant_room_teste();
?>
