...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_tb_customers"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_tb_customers"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_customers'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_customers']['embutida_filho'] as $ind => $sc_init)
          {
