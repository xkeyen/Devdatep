...
<?php
   ...
   $Ord_Cmp = new grid_tb_customers_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_customers_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_customer'] = "id_customer";
   $tab_labels["id_customer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["id_customer"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["id_customer"] : "" . $this->Nm_lang['lang_tb_customers_fld_id_customer'] . "";
   $tab_ger_campos['customer_name'] = "on";
   $tab_def_campos['customer_name'] = "customer_name";
   $tab_labels["customer_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_name"] : "" . $this->Nm_lang['lang_tb_customers_fld_customer_name'] . "";
   $tab_ger_campos['customer_birthday'] = "on";
   $tab_def_campos['customer_birthday'] = "customer_birthday";
   $tab_labels["customer_birthday"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_birthday"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_birthday"] : "" . $this->Nm_lang['lang_tb_customers_fld_customer_birthday'] . "";
   $tab_ger_campos['customer_phone1'] = "on";
   $tab_def_campos['customer_phone1'] = "customer_phone1";
   $tab_labels["customer_phone1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_phone1"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["customer_phone1"] : "" . $this->Nm_lang['lang_tb_customers_fld_customer_phone1'] . "";
   $tab_ger_campos['id_country'] = "on";
   $tab_def_campos['id_country'] = "id_country";
   $tab_labels["id_country"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["id_country"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['labels']["id_country"] : "" . $this->Nm_lang['lang_tb_customers_fld_id_country'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_customers_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_customers']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
