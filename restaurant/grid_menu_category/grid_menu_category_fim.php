...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_menu_category"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_menu_category"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_category']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_category']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_category']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_category']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_menu_category']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_menu_category</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_menu_category']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_menu_category']['embutida_filho'] as $ind => $sc_init)
          {
