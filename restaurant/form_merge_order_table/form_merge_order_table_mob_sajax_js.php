  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_merge_order_table_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_merge_order_table_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_order
  function do_ajax_form_merge_order_table_mob_validate_id_order()
  {
    var nomeCampo_id_order = "id_order";
    var var_id_order = scAjaxGetFieldHidden(nomeCampo_id_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_merge_order_table_mob_validate_id_order(var_id_order, var_script_case_init, do_ajax_form_merge_order_table_mob_validate_id_order_cb);
  } // do_ajax_form_merge_order_table_mob_validate_id_order

  function do_ajax_form_merge_order_table_mob_validate_id_order_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_merge_order_table_mob_validate_id_order_cb

  // ---------- Validate main_table
  function do_ajax_form_merge_order_table_mob_validate_main_table()
  {
    var nomeCampo_main_table = "main_table";
    var var_main_table = scAjaxGetFieldHidden(nomeCampo_main_table);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_merge_order_table_mob_validate_main_table(var_main_table, var_script_case_init, do_ajax_form_merge_order_table_mob_validate_main_table_cb);
  } // do_ajax_form_merge_order_table_mob_validate_main_table

  function do_ajax_form_merge_order_table_mob_validate_main_table_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "main_table";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_merge_order_table_mob_validate_main_table_cb

  // ---------- Validate merged_table
  function do_ajax_form_merge_order_table_mob_validate_merged_table()
  {
    var nomeCampo_merged_table = "merged_table";
    nm_pack(nomeCampo_merged_table + '_dest', nomeCampo_merged_table);
    var var_merged_table = scAjaxGetFieldText(nomeCampo_merged_table);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_merge_order_table_mob_validate_merged_table(var_merged_table, var_script_case_init, do_ajax_form_merge_order_table_mob_validate_merged_table_cb);
  } // do_ajax_form_merge_order_table_mob_validate_merged_table

  function do_ajax_form_merge_order_table_mob_validate_merged_table_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "merged_table";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_merge_order_table_mob_validate_merged_table_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_merge_order_table_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_merge_order_table_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_order = scAjaxGetFieldHidden("id_order");
    var var_main_table = scAjaxGetFieldHidden("main_table");
    nm_pack("merged_table_dest", "merged_table");
    var var_merged_table = scAjaxGetFieldText("merged_table", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_merge_order_table_mob_submit_form(var_id_order, var_main_table, var_merged_table, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_merge_order_table_mob_submit_form_cb);
  } // do_ajax_form_merge_order_table_mob_submit_form

  function do_ajax_form_merge_order_table_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_merge_order_table_mob_submit_form_cb_after_alert);
  } // do_ajax_form_merge_order_table_mob_submit_form_cb
  function do_ajax_form_merge_order_table_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_merge_order_table_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_merge_order_table_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_merge_order_table_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_merge_order_table_mob_navigate_form();
    }
  }

  function perform_ajax_form_merge_order_table_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_merge_order_table_mob_navigate_form(var_id_order, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_merge_order_table_mob_navigate_form_cb);
  } // do_ajax_form_merge_order_table_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_merge_order_table_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_merge_order_table_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_merge_order_table_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_merge_order_table_mob_navigate_form_cb
  function do_ajax_form_merge_order_table_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_merge_order_table_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_merge_order_table_mob_navigate_form_cb_after_alert

  function sc_hide_form_merge_order_table_mob_form()
  {
  ...
  ajax_field_list[1] = "main_table";
  ajax_field_list[2] = "merged_table";
  ...
  var ajax_error_list = {
    ...
    "main_table": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_table_fld_main_table'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "merged_table": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_tb_restaurant_tables'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_order": new Array(),
    "main_table": new Array(),
    "merged_table": new Array()
  };
  ajax_field_mult["id_order"][1] = "id_order";
  ajax_field_mult["main_table"][1] = "main_table";
  ajax_field_mult["merged_table"][1] = "merged_table";

  var ajax_field_id = {
    "id_order": new Array("hidden_field_label_id_order", "hidden_field_data_id_order"),
    "main_table": new Array("hidden_field_label_main_table", "hidden_field_data_main_table"),
    "merged_table": new Array("hidden_field_label_merged_table", "hidden_field_data_merged_table")
  };
