...
$_SESSION['scriptcase']['app_retrieve_pswd']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['total'] + 1,
            ],
            $summaryLine
        );
