...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"app_grid_sec_users_jquery_6610.js\"></script>\r\n");
 ...
 function NM_grid_picture()
 {
      ...
      if (!isset($this->NM_cmp_hidden['picture']) || $this->NM_cmp_hidden['picture'] != "off") { 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['doc_word'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_opcao'] == "doc_word" || $this->Ini->sc_export_ajax_img) 
              { 
                  $reg_picture = "";
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['doc_word'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_opcao'] == "doc_word" || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
