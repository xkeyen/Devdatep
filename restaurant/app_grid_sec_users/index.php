<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php73/wwwrootC:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao']         = "conn_example";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'restaurant', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----------------------------------->
      ...
      { 
          ...
          { 
              if (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_refresh_after_chart'])) {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_restaurant.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_restaurant.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_restaurant'])) {
               $_SESSION['scriptcase']['app_grid_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_restaurant'];
           }
       }
   }
