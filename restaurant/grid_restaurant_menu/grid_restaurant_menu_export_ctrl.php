<?php
@session_start() ;
$_SESSION['scriptcase']['grid_restaurant_menu']['sc_process_barr'] = true;
require_once('../grid_restaurant_menu/index.php');
unset($_SESSION['scriptcase']['grid_restaurant_menu']['sc_process_barr']);
$ExportCtrl = new grid_restaurant_menu_export_control;
$ExportCtrl->Export_barr();

class grid_restaurant_menu_export_control
{
