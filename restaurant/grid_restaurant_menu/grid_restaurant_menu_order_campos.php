...
<?php
   ...
   $Ord_Cmp = new grid_restaurant_menu_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_restaurant_menu_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_menu_header'] = "tb_restaurant_menu_header";
   }
   else
   {
       $tab_def_campos['tb_restaurant_menu_header'] = "tb_restaurant_menu.header";
   }
   $tab_labels["tb_restaurant_menu_header"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_header"])) ? $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_header"] : "" . $this->Nm_lang['lang_tb_restaurant_menu_fld_header'] . "";
   $tab_ger_campos['tb_restaurant_menu_description'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_menu_description'] = "tb_restaurant_menu_description";
   }
   else
   {
       $tab_def_campos['tb_restaurant_menu_description'] = "tb_restaurant_menu.description";
   }
   $tab_labels["tb_restaurant_menu_description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_description"])) ? $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_description"] : "" . $this->Nm_lang['lang_tb_restaurant_menu_fld_description'] . "";
   $tab_ger_campos['tb_restaurant_menu_price'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_menu_price'] = "tb_restaurant_menu_price";
   }
   else
   {
       $tab_def_campos['tb_restaurant_menu_price'] = "tb_restaurant_menu.price";
   }
   $tab_labels["tb_restaurant_menu_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_price"] : "" . $this->Nm_lang['lang_tb_restaurant_menu_fld_price'] . "";
   $tab_ger_campos['tb_restaurant_menu_active_menu'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_menu_active_menu'] = "tb_restaurant_menu_active_menu";
   }
   else
   {
       $tab_def_campos['tb_restaurant_menu_active_menu'] = "tb_restaurant_menu.active_menu";
   }
   $tab_labels["tb_restaurant_menu_active_menu"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_active_menu"])) ? $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['labels']["tb_restaurant_menu_active_menu"] : "" . $this->Nm_lang['lang_tb_restaurant_menu_fld_active_menu'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_restaurant_menu_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_restaurant_menu']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
