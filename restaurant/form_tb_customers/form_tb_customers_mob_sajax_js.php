  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_customers_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_customers_mob_form();
	}
...
?>
  ...
  function do_ajax_form_tb_customers_mob_validate_id_customer()
  {
    var nomeCampo_id_customer = "id_customer";
    var var_id_customer = scAjaxGetFieldHidden(nomeCampo_id_customer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_id_customer(var_id_customer, var_script_case_init, do_ajax_form_tb_customers_mob_validate_id_customer_cb);
  } // do_ajax_form_tb_customers_mob_validate_id_customer

  function do_ajax_form_tb_customers_mob_validate_id_customer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_customer";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_id_customer_cb

  // ---------- Validate customer_name
  function do_ajax_form_tb_customers_mob_validate_customer_name()
  {
    var nomeCampo_customer_name = "customer_name";
    var var_customer_name = scAjaxGetFieldText(nomeCampo_customer_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_name(var_customer_name, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_name_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_name

  function do_ajax_form_tb_customers_mob_validate_customer_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_name_cb

  // ---------- Validate customer_gender
  function do_ajax_form_tb_customers_mob_validate_customer_gender()
  {
    var nomeCampo_customer_gender = "customer_gender";
    var var_customer_gender = scAjaxGetFieldRadio(nomeCampo_customer_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_gender(var_customer_gender, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_gender_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_gender

  function do_ajax_form_tb_customers_mob_validate_customer_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_gender";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_gender_cb

  // ---------- Validate customer_birthday
  function do_ajax_form_tb_customers_mob_validate_customer_birthday()
  {
    var nomeCampo_customer_birthday = "customer_birthday";
    var var_customer_birthday = scAjaxGetFieldText(nomeCampo_customer_birthday);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_birthday(var_customer_birthday, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_birthday_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_birthday

  function do_ajax_form_tb_customers_mob_validate_customer_birthday_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_birthday";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_birthday_cb

  // ---------- Validate customer_num_doc
  function do_ajax_form_tb_customers_mob_validate_customer_num_doc()
  {
    var nomeCampo_customer_num_doc = "customer_num_doc";
    var var_customer_num_doc = scAjaxGetFieldText(nomeCampo_customer_num_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_num_doc(var_customer_num_doc, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_num_doc_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_num_doc

  function do_ajax_form_tb_customers_mob_validate_customer_num_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_num_doc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_num_doc_cb

  // ---------- Validate doctype
  function do_ajax_form_tb_customers_mob_validate_doctype()
  {
    var nomeCampo_doctype = "doctype";
    var var_doctype = scAjaxGetFieldText(nomeCampo_doctype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_doctype(var_doctype, var_script_case_init, do_ajax_form_tb_customers_mob_validate_doctype_cb);
  } // do_ajax_form_tb_customers_mob_validate_doctype

  function do_ajax_form_tb_customers_mob_validate_doctype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doctype";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_doctype_cb

  // ---------- Validate id_country
  function do_ajax_form_tb_customers_mob_validate_id_country()
  {
    var nomeCampo_id_country = "id_country";
    var var_id_country = scAjaxGetFieldSelect(nomeCampo_id_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_id_country(var_id_country, var_script_case_init, do_ajax_form_tb_customers_mob_validate_id_country_cb);
  } // do_ajax_form_tb_customers_mob_validate_id_country

  function do_ajax_form_tb_customers_mob_validate_id_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_country";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_id_country_cb

  // ---------- Validate customer_address
  function do_ajax_form_tb_customers_mob_validate_customer_address()
  {
    var nomeCampo_customer_address = "customer_address";
    var var_customer_address = scAjaxGetFieldText(nomeCampo_customer_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_address(var_customer_address, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_address_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_address

  function do_ajax_form_tb_customers_mob_validate_customer_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_address";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_address_cb

  // ---------- Validate customer_phone1
  function do_ajax_form_tb_customers_mob_validate_customer_phone1()
  {
    var nomeCampo_customer_phone1 = "customer_phone1";
    var var_customer_phone1 = scAjaxGetFieldText(nomeCampo_customer_phone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_phone1(var_customer_phone1, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_phone1_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_phone1

  function do_ajax_form_tb_customers_mob_validate_customer_phone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_phone1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_phone1_cb

  // ---------- Validate customer_phone2
  function do_ajax_form_tb_customers_mob_validate_customer_phone2()
  {
    var nomeCampo_customer_phone2 = "customer_phone2";
    var var_customer_phone2 = scAjaxGetFieldText(nomeCampo_customer_phone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_mob_validate_customer_phone2(var_customer_phone2, var_script_case_init, do_ajax_form_tb_customers_mob_validate_customer_phone2_cb);
  } // do_ajax_form_tb_customers_mob_validate_customer_phone2

  function do_ajax_form_tb_customers_mob_validate_customer_phone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customer_phone2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_mob_validate_customer_phone2_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_customers_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_customers_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_customer = scAjaxGetFieldHidden("id_customer");
    var var_customer_name = scAjaxGetFieldText("customer_name");
    var var_customer_gender = scAjaxGetFieldRadio("customer_gender");
    var var_customer_birthday = scAjaxGetFieldText("customer_birthday");
    var var_customer_num_doc = scAjaxGetFieldText("customer_num_doc");
    var var_doctype = scAjaxGetFieldText("doctype");
    var var_id_country = scAjaxGetFieldSelect("id_country");
    var var_customer_address = scAjaxGetFieldText("customer_address");
    var var_customer_phone1 = scAjaxGetFieldText("customer_phone1");
    var var_customer_phone2 = scAjaxGetFieldText("customer_phone2");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_customers_mob_submit_form(var_id_customer, var_customer_name, var_customer_gender, var_customer_birthday, var_customer_num_doc, var_doctype, var_id_country, var_customer_address, var_customer_phone1, var_customer_phone2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_customers_mob_submit_form_cb);
  } // do_ajax_form_tb_customers_mob_submit_form

  function do_ajax_form_tb_customers_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_customers_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_customers_mob_submit_form_cb
  function do_ajax_form_tb_customers_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_customers_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_customers_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_customers_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_customers_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_customers_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_customer = document.F2.id_customer.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_customers_mob_navigate_form(var_id_customer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_customers_mob_navigate_form_cb);
  } // do_ajax_form_tb_customers_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_customers_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_customer.value = scAjaxGetKeyValue("id_customer");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_customers_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_customers_mob_navigate_form_cb
  function do_ajax_form_tb_customers_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_customers_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_customers_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_customers_mob_form()
  {
  ...
  ajax_field_list[0] = "id_customer";
  ajax_field_list[1] = "customer_name";
  ajax_field_list[2] = "customer_gender";
  ajax_field_list[3] = "customer_birthday";
  ajax_field_list[4] = "customer_num_doc";
  ajax_field_list[5] = "doctype";
  ajax_field_list[6] = "id_country";
  ajax_field_list[7] = "customer_address";
  ajax_field_list[8] = "customer_phone1";
  ajax_field_list[9] = "customer_phone2";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_customer": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_id_customer'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_gender": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_gender'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_birthday": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_birthday'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_num_doc": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_num_doc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "doctype": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_doctype'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_country": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_id_country'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_address": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_address'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_phone1": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_phone1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customer_phone2": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_customers_fld_customer_phone2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_customer": new Array(),
    "customer_name": new Array(),
    "customer_gender": new Array(),
    "customer_birthday": new Array(),
    "customer_num_doc": new Array(),
    "doctype": new Array(),
    "id_country": new Array(),
    "customer_address": new Array(),
    "customer_phone1": new Array(),
    "customer_phone2": new Array()
  };
  ajax_field_mult["id_customer"][1] = "id_customer";
  ajax_field_mult["customer_name"][1] = "customer_name";
  ajax_field_mult["customer_gender"][1] = "customer_gender";
  ajax_field_mult["customer_birthday"][1] = "customer_birthday";
  ajax_field_mult["customer_num_doc"][1] = "customer_num_doc";
  ajax_field_mult["doctype"][1] = "doctype";
  ajax_field_mult["id_country"][1] = "id_country";
  ajax_field_mult["customer_address"][1] = "customer_address";
  ajax_field_mult["customer_phone1"][1] = "customer_phone1";
  ajax_field_mult["customer_phone2"][1] = "customer_phone2";

  var ajax_field_id = {
    "id_customer": new Array("hidden_field_label_id_customer", "hidden_field_data_id_customer"),
    "customer_name": new Array("hidden_field_label_customer_name", "hidden_field_data_customer_name"),
    "customer_gender": new Array("hidden_field_label_customer_gender", "hidden_field_data_customer_gender"),
    "customer_birthday": new Array("hidden_field_label_customer_birthday", "hidden_field_data_customer_birthday"),
    "customer_num_doc": new Array("hidden_field_label_customer_num_doc", "hidden_field_data_customer_num_doc"),
    "doctype": new Array("hidden_field_label_doctype", "hidden_field_data_doctype"),
    "id_country": new Array("hidden_field_label_id_country", "hidden_field_data_id_country"),
    "customer_address": new Array("hidden_field_label_customer_address", "hidden_field_data_customer_address"),
    "customer_phone1": new Array("hidden_field_label_customer_phone1", "hidden_field_data_customer_phone1"),
    "customer_phone2": new Array("hidden_field_label_customer_phone2", "hidden_field_data_customer_phone2")
  };
  ...
  var ajax_read_only = {
    ...
    "customer_name": "off",
    "customer_gender": "off",
    "customer_birthday": "off",
    "customer_num_doc": "off",
    "doctype": "off",
    "id_country": "off",
    "customer_address": "off",
    "customer_phone1": "off",
    "customer_phone2": "off"
  };
