<?php  
  ...
  session_start() ;
  class form_tb_customers_form_teste
  {
   function form_tb_customers_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_customers/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tb_customers</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_tb_customers"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tb_customers_form_teste();
  $frm_teste->form_tb_customers_teste();
?>
