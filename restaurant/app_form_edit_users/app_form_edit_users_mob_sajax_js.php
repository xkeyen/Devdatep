...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_mob_submit_form_cb);
...
?>
  ...
  var ajax_error_list = {
    "picture": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_picture'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_pswd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "confirm_pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_pswd_confirm'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "active": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_active'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "groups": {"label": "<?php echo $this->Ini->Nm_lang['lang_list_groups'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
