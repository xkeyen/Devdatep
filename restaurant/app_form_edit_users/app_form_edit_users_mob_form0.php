...
?> 
    ...
    <TD class="scFormDataOdd css_groups_line" id="hidden_field_data_groups" style="<?php echo $sStyleHidden_groups; ?>"> <span class="scFormLabelOddFormat css_groups_label" style=""><span id="id_label_groups"><?php echo $this->nm_new_label['groups']; ?></span></span><br> 
<?php  
$nmgp_def_dados = "" ; 
