<?php  
  ...
  session_start() ;
  class app_form_sec_groups_form_teste
  {
   function app_form_sec_groups_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_form_sec_groups/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_form_sec_groups</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_form_sec_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_form_sec_groups_form_teste();
  $frm_teste->app_form_sec_groups_teste();
?>
