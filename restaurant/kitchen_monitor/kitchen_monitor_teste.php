<?php  
  ...
  session_start() ;
  class kitchen_monitor_form_teste
  {
  function kitchen_monitor_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">kitchen_monitor</FONT></B> 
<br> 
<br> 
...
<input type=submit value="kitchen_monitor"> 
</form> 
...
<?php
  ...
  $frm_teste = new kitchen_monitor_form_teste();
  $frm_teste->kitchen_monitor_teste();
?>
