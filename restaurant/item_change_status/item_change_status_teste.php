<?php  
  ...
  session_start() ;
  class item_change_status_form_teste
  {
   function item_change_status_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "item_change_status/img";
...
?> 
<br> 
<B><FONT SIZE="4">item_change_status</FONT></B> 
<br> 
<br> 
...
id_order_item&nbsp;&nbsp;<input type=text name=id_order_item size=20><br> 
<input type="submit" value="item_change_status"> 
</form> 
<script language=javascript> 
 document.Fedit.id_order_item.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new item_change_status_form_teste();
  $frm_teste->item_change_status_teste();
?>
