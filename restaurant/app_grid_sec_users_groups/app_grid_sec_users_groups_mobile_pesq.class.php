...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "restaurant/app_grid_sec_users_groups";
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
