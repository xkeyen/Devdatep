...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____app_grid_sec_users_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____app_grid_sec_users_groups"]);
   }
