...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_room_now/grid_room_now_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_room_now_res_xls.class.php");
              $this->Res_xls = new grid_room_now_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_room_now.zip";
          $this->Arquivo   .= "_grid_room_now" . $this->Xls_tp;
          $this->Tit_doc    = "grid_room_now" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_room_now']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_room_now']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_tb_restaurant_tables_id_table()
   {
         ...
         if (is_numeric($this->tb_restaurant_tables_id_table))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_restaurant_tables_id_table);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_restaurant_tables_seats()
   {
         ...
         if (is_numeric($this->tb_restaurant_tables_seats))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_restaurant_tables_seats);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_restaurant_room_id_room()
   {
         ...
         if (is_numeric($this->tb_restaurant_room_id_room))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_restaurant_room_id_room);
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_restaurant_room_room_descr()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_restaurant_room_room_descr, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tb_restaurant_room_room_descr, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tb_restaurant_room_room_active()
   {
         ...
         if (is_numeric($this->tb_restaurant_room_room_active))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tb_restaurant_room_room_active);
         $this->Xls_col++;
   }
   //----- css_color
   function NM_export_css_color()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->css_color, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->css_color, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- dt_order_start
   function NM_export_dt_order_start()
   {
      ...
      if (!empty($this->dt_order_start))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dt_order_start, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dt_order_start, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- id_card
   function NM_export_id_card()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->id_card, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->id_card, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- id_order
   function NM_export_id_order()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->id_order);
         $this->Xls_col++;
   }
   //----- main_table
   function NM_export_main_table()
   {
         ...
         if (is_numeric($this->main_table))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->main_table);
         $this->Xls_col++;
   }
   //----- occupied
   function NM_export_occupied()
   {
         ...
         if (is_numeric($this->occupied))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->occupied);
         $this->Xls_col++;
   }
   //----- order_status
   function NM_export_order_status()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->order_status);
         $this->Xls_col++;
   }
   //----- people
   function NM_export_people()
   {
         ...
         if (is_numeric($this->people))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->people);
         $this->Xls_col++;
   }
   //----- tb_restaurant_tables_id_table
   function NM_sub_cons_tb_restaurant_tables_id_table()
   {
         $this->tb_restaurant_tables_id_table = NM_charset_to_utf8($this->tb_restaurant_tables_id_table);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_restaurant_tables_id_table;
   ...
   //----- tb_restaurant_tables_seats
   function NM_sub_cons_tb_restaurant_tables_seats()
   {
         $this->tb_restaurant_tables_seats = NM_charset_to_utf8($this->tb_restaurant_tables_seats);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_restaurant_tables_seats;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_restaurant_room_id_room
   function NM_sub_cons_tb_restaurant_room_id_room()
   {
         $this->tb_restaurant_room_id_room = NM_charset_to_utf8($this->tb_restaurant_room_id_room);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_restaurant_room_id_room;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tb_restaurant_room_room_descr
   function NM_sub_cons_tb_restaurant_room_room_descr()
   {
         $this->tb_restaurant_room_room_descr = html_entity_decode($this->tb_restaurant_room_room_descr, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tb_restaurant_room_room_descr = strip_tags($this->tb_restaurant_room_room_descr);
         $this->tb_restaurant_room_room_descr = NM_charset_to_utf8($this->tb_restaurant_room_room_descr);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_restaurant_room_room_descr;
   ...
   //----- tb_restaurant_room_room_active
   function NM_sub_cons_tb_restaurant_room_room_active()
   {
         $this->tb_restaurant_room_room_active = NM_charset_to_utf8($this->tb_restaurant_room_room_active);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tb_restaurant_room_room_active;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- css_color
   function NM_sub_cons_css_color()
   {
         $this->css_color = html_entity_decode($this->css_color, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->css_color = strip_tags($this->css_color);
         $this->css_color = NM_charset_to_utf8($this->css_color);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->css_color;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- dt_order_start
   function NM_sub_cons_dt_order_start()
   {
      if (!empty($this->dt_order_start))
      {
         $this->dt_order_start = substr($this->dt_order_start, 11) ;  
         ...
         $this->dt_order_start = NM_charset_to_utf8($this->dt_order_start);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dt_order_start;
   ...
   //----- id_card
   function NM_sub_cons_id_card()
   {
         $this->id_card = html_entity_decode($this->id_card, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->id_card = strip_tags($this->id_card);
         $this->id_card = NM_charset_to_utf8($this->id_card);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->id_card;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- id_order
   function NM_sub_cons_id_order()
   {
         $this->id_order = NM_charset_to_utf8($this->id_order);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->id_order;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- main_table
   function NM_sub_cons_main_table()
   {
         $this->main_table = NM_charset_to_utf8($this->main_table);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->main_table;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- occupied
   function NM_sub_cons_occupied()
   {
         $this->occupied = NM_charset_to_utf8($this->occupied);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->occupied;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- order_status
   function NM_sub_cons_order_status()
   {
         $this->order_status = NM_charset_to_utf8($this->order_status);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->order_status;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- people
   function NM_sub_cons_people()
   {
         $this->people = NM_charset_to_utf8($this->people);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->people;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_main_room'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_room_now']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
