<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_room_now']['glo_nm_path_imag_temp'] . "/sc_apl_default_restaurant.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_room_now_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_room_now_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['tb_restaurant_tables_id_table'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_tables_id_table'] = "tb_restaurant_tables_id_table";
   }
   else
   {
       $tab_def_campos['tb_restaurant_tables_id_table'] = "tb_restaurant_tables.id_table";
   }
   $tab_labels["tb_restaurant_tables_id_table"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_tables_id_table"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_tables_id_table"] : "" . $this->Nm_lang['lang_tb_restaurant_tables_fld_id_table'] . "";
   $tab_ger_campos['tb_restaurant_tables_seats'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_tables_seats'] = "tb_restaurant_tables_seats";
   }
   else
   {
       $tab_def_campos['tb_restaurant_tables_seats'] = "tb_restaurant_tables.seats";
   }
   $tab_labels["tb_restaurant_tables_seats"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_tables_seats"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_tables_seats"] : "" . $this->Nm_lang['lang_tb_restaurant_tables_fld_seats'] . "";
   $tab_ger_campos['tb_restaurant_room_id_room'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_room_id_room'] = "tb_restaurant_room_id_room";
   }
   else
   {
       $tab_def_campos['tb_restaurant_room_id_room'] = "tb_restaurant_room.id_room";
   }
   $tab_labels["tb_restaurant_room_id_room"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_id_room"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_id_room"] : "" . $this->Nm_lang['lang_tb_restaurant_tables_fld_id_room'] . "";
   $tab_ger_campos['tb_restaurant_room_room_descr'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_room_room_descr'] = "tb_restaurant_room_room_descr";
   }
   else
   {
       $tab_def_campos['tb_restaurant_room_room_descr'] = "tb_restaurant_room.room_descr";
   }
   $tab_labels["tb_restaurant_room_room_descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_room_descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_room_descr"] : "" . $this->Nm_lang['lang_tb_restaurant_room_fld_room_descr'] . "";
   $tab_ger_campos['tb_restaurant_room_room_active'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_restaurant_room_room_active'] = "tb_restaurant_room_room_active";
   }
   else
   {
       $tab_def_campos['tb_restaurant_room_room_active'] = "tb_restaurant_room.room_active";
   }
   $tab_labels["tb_restaurant_room_room_active"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_room_active"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["tb_restaurant_room_room_active"] : "" . $this->Nm_lang['lang_tb_restaurant_room_fld_room_active'] . "";
   $tab_ger_campos['css_color'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['css_color'] = "css_color";
   }
   else
   {
       $tab_def_campos['css_color'] = "";
   }
   $tab_labels["css_color"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["css_color"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["css_color"] : "css_color";
   $tab_ger_campos['dt_order_start'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dt_order_start'] = "dt_order_start";
   }
   else
   {
       $tab_def_campos['dt_order_start'] = "";
   }
   $tab_labels["dt_order_start"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["dt_order_start"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["dt_order_start"] : "dt_order_start";
   $tab_ger_campos['id_card'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['id_card'] = "id_card";
   }
   else
   {
       $tab_def_campos['id_card'] = "";
   }
   $tab_labels["id_card"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["id_card"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["id_card"] : "id_card";
   $tab_ger_campos['id_order'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['id_order'] = "id_order";
   }
   else
   {
       $tab_def_campos['id_order'] = "";
   }
   $tab_labels["id_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["id_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["id_order"] : "id_order";
   $tab_ger_campos['main_table'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['main_table'] = "main_table";
   }
   else
   {
       $tab_def_campos['main_table'] = "";
   }
   $tab_labels["main_table"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["main_table"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["main_table"] : "main_table";
   $tab_ger_campos['occupied'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['occupied'] = "occupied";
   }
   else
   {
       $tab_def_campos['occupied'] = "";
   }
   $tab_labels["occupied"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["occupied"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["occupied"] : "occupied";
   $tab_ger_campos['order_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['order_status'] = "order_status";
   }
   else
   {
       $tab_def_campos['order_status'] = "";
   }
   $tab_labels["order_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["order_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["order_status"] : "order_status";
   $tab_ger_campos['people'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['people'] = "people";
   }
   else
   {
       $tab_def_campos['people'] = "";
   }
   $tab_labels["people"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["people"])) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['labels']["people"] : "people";
   $tab_ger_campos['css_color'] = "none";
   $tab_ger_campos['dt_order_start'] = "none";
   $tab_ger_campos['id_card'] = "none";
   $tab_ger_campos['id_order'] = "none";
   $tab_ger_campos['main_table'] = "none";
   $tab_ger_campos['occupied'] = "none";
   $tab_ger_campos['order_status'] = "none";
   $tab_ger_campos['people'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_room_now']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_room_now']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_room_now']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_room_now']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_room_now']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_main_room'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_room_now_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_room_now']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
