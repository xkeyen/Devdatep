<?php  
  ...
  session_start() ;
  class grid_room_now_form_teste
  {
  function grid_room_now_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_room_now</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_room_now"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_room_now_form_teste();
  $frm_teste->grid_room_now_teste();
?>
