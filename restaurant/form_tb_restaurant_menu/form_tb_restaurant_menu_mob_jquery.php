...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'description':
      case 'price':
        sc_exib_ocult_pag('form_tb_restaurant_menu_mob_form0');
        break;
      case 'image_bin':
        sc_exib_ocult_pag('form_tb_restaurant_menu_mob_form1');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_form_tb_restaurant_menu_mob_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_image_bin" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_tb_restaurant_menu_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tb_restaurant_menu_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
