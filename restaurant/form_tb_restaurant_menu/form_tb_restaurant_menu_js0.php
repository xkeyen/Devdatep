<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_menu" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_menu']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tb_restaurant_menu"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_tb_restaurant_menu_form0').style.width='1px';
    document.getElementById('form_tb_restaurant_menu_form0').style.height='0px';
    document.getElementById('form_tb_restaurant_menu_form0').style.display='none';
    document.getElementById('form_tb_restaurant_menu_form0').style.overflow='scroll';
    document.getElementById('form_tb_restaurant_menu_form1').style.width='1px';
    document.getElementById('form_tb_restaurant_menu_form1').style.height='0px';
    document.getElementById('form_tb_restaurant_menu_form1').style.display='none';
    document.getElementById('form_tb_restaurant_menu_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu']['pdf_view']) {
?>
