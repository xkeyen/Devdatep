<?php  
  ...
  session_start() ;
  class blankbg_form_teste
  {
  function blankbg_teste()
  {
...
<input type=submit value="blankbg"> 
</form> 
...
<?php
  ...
  $frm_teste = new blankbg_form_teste();
  $frm_teste->blankbg_teste();
?>
