...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_menu_food"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_menu_food"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_food']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_food']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_food']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_food']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_menu_food']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_menu_food']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_menu_food']['embutida_filho'] as $ind => $sc_init)
          {
