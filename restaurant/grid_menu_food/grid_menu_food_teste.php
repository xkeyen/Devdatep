<?php  
  ...
  session_start() ;
  class grid_menu_food_form_teste
  {
  function grid_menu_food_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_menu_food</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
var_id_category&nbsp;&nbsp;<input type=text name="var_id_category" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_menu_food"> 
</form> 
<script language=javascript> 
 document.FCons.var_id_category.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_menu_food_form_teste();
  $frm_teste->grid_menu_food_teste();
?>
