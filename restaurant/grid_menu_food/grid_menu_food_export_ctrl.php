<?php
@session_start() ;
$_SESSION['scriptcase']['grid_menu_food']['sc_process_barr'] = true;
require_once('../grid_menu_food/index.php');
unset($_SESSION['scriptcase']['grid_menu_food']['sc_process_barr']);
$ExportCtrl = new grid_menu_food_export_control;
$ExportCtrl->Export_barr();

class grid_menu_food_export_control
{
...
<HEAD>
 <TITLE><?php echo $_SESSION['categ_descr'] ?></TITLE>
