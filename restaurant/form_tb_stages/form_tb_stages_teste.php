<?php  
  ...
  session_start() ;
  class form_tb_stages_form_teste
  {
   function form_tb_stages_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_stages/img";
...
<?php
  ...
  $frm_teste = new form_tb_stages_form_teste();
  $frm_teste->form_tb_stages_teste();
?>
