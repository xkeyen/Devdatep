<?php  
  ...
  session_start() ;
  class app_change_pswd_form_teste
  {
   function app_change_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_change_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_change_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_change_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_change_pswd_form_teste();
  $frm_teste->app_change_pswd_teste();
?>
