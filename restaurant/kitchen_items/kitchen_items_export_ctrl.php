<?php
@session_start() ;
$_SESSION['scriptcase']['kitchen_items']['sc_process_barr'] = true;
require_once('../kitchen_items/index.php');
unset($_SESSION['scriptcase']['kitchen_items']['sc_process_barr']);
$ExportCtrl = new kitchen_items_export_control;
$ExportCtrl->Export_barr();

class kitchen_items_export_control
{
