...
<?php
   ...
   $Ord_Cmp = new kitchen_items_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kitchen_items_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tb_restaurant_menu_header"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_restaurant_menu_header"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_restaurant_menu_header"] : "" . $this->Nm_lang['lang_tb_restaurant_menu_fld_header'] . "";
   $tab_ger_campos['tb_kitchen_status_kitchen_status_descr'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_kitchen_status_kitchen_status_descr'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['tb_kitchen_status_kitchen_status_descr'] = "tb_kitchen_status.kitchen_status_descr";
   }
   $tab_labels["tb_kitchen_status_kitchen_status_descr"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_kitchen_status_kitchen_status_descr"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_kitchen_status_kitchen_status_descr"] : "" . $this->Nm_lang['lang_tb_kitchen_status_fld_kitchen_status_descr'] . "";
   $tab_ger_campos['tb_order_items_inserted_date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_order_items_inserted_date'] = "tb_order_items_inserted_date";
   }
   else
   {
       $tab_def_campos['tb_order_items_inserted_date'] = "tb_order_items.inserted_date";
   }
   $tab_labels["tb_order_items_inserted_date"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_order_items_inserted_date"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_items']['labels']["tb_order_items_inserted_date"] : "" . $this->Nm_lang['lang_tb_order_items_fld_inserted_date'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kitchen_items']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kitchen_items']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kitchen_items_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kitchen_items']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
