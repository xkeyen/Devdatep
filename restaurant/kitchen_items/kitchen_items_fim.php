...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____kitchen_items"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____kitchen_items"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kitchen_items']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kitchen_items']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kitchen_items']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kitchen_items']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kitchen_items']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kitchen_items']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kitchen_items']['embutida_filho'] as $ind => $sc_init)
          {
