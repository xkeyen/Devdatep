<?php  
  ...
  session_start() ;
  class form_not_customer_open_ticket_form_teste
  {
   function form_not_customer_open_ticket_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_not_customer_open_ticket/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_not_customer_open_ticket</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_not_customer_open_ticket"> 
</form> 
<script language=javascript> 
 document.Fedit.ticketmessageid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_not_customer_open_ticket_form_teste();
  $frm_teste->form_not_customer_open_ticket_teste();
?>
