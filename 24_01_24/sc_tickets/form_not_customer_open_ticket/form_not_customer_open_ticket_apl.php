<?php
//
class form_not_customer_open_ticket_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_customerid)) 
          {
              $_SESSION['v_customerid'] = $this->v_customerid;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_not_customer_open_ticket_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['upload_field_info']['ticketfile1'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_not_customer_open_ticket',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['upload_field_info']['ticketfile2'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_not_customer_open_ticket',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_not_customer_open_ticket']['upload_field_info']['ticketfile3'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_not_customer_open_ticket',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_not_customer_open_ticket']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_not_customer_open_ticket'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_not_customer_open_ticket']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_not_customer_open_ticket']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_not_customer_open_ticket') . "/form_not_customer_open_ticket.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_not_customer_open_ticket']['label'] = "" . $this->Ini->Nm_lang['lang_header_open_ticket'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_not_customer_open_ticket")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_not_customer_open_ticket']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_not_customer_open_ticket'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_not_customer_open_ticket.php"; 
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile1_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      elseif (isset($this->ticketfile1_ul_name) && '' != $this->ticketfile1_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->ticketfile1_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile2_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      elseif (isset($this->ticketfile2_ul_name) && '' != $this->ticketfile2_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->ticketfile2_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile3_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      elseif (isset($this->ticketfile3_ul_name) && '' != $this->ticketfile3_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->ticketfile3_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_not_customer_open_ticket']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_not_customer_open_ticket'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_not_customer_open_ticket'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_not_customer_open_ticket", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_not_customer_open_ticket_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_not_customer_open_ticket_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_not_customer_open_ticket/form_not_customer_open_ticket_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_not_customer_open_ticket_erro.class.php"); 
      }
      $this->Erro      = new form_not_customer_open_ticket_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao']))
         { 
             if ($this->ticketmessageid != "" || $this->ticketid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_not_customer_open_ticket']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_not_customer_open_ticket']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_not_customer_open_ticket']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_not_customer_open_ticket']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_not_customer_open_ticket']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_not_customer_open_ticket.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_not_customer_open_ticket.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_not_customer_open_ticket_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_not_customer_open_ticket"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_not_customer_open_ticket.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (true && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['captcha_display']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['captcha_display'] != 'none')) {
         ...
         if (!$valid)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                 if (!isset($this->NM_ajax_info['errList']['geral_form_not_customer_open_ticket']) || !is_array($this->NM_ajax_info['errList']['geral_form_not_customer_open_ticket']))
                 {
                     $this->NM_ajax_info['errList']['geral_form_not_customer_open_ticket'] = array();
                 }
                 $this->NM_ajax_info['errList']['geral_form_not_customer_open_ticket'][] = "CAPTCHA: " . $this->Ini->Nm_lang['lang_othr_cptc_errm'] . "";
             }
         }
     }
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_not_customer_open_ticket'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_fld_customer_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_name'] == "on")) 
      { 
    ...
    function ValidateField_fld_customer_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_email'] == "on")) 
      { 
...
;
    ...
    function ValidateField_fld_language(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_language']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_language'] == "on") 
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fld_category'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_category']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_category'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_ticketcontent(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['ticketcontent']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['ticketcontent'] == "on") 
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->ticketfile1 && "S" != $this->ticketfile1_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_not_customer_open_ticket_doc_name.php';
                }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['ticketmessageid']['keyVal'] = form_not_customer_open_ticket_pack_protect_string($this->nmgp_dados_form['ticketmessageid']);
              $this->NM_ajax_info['fldList']['ticketid']['keyVal'] = form_not_customer_open_ticket_pack_protect_string($this->nmgp_dados_form['ticketid']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category'] = array(); 
}
$aLookup[] = array(form_not_customer_open_ticket_pack_protect_string('') => str_replace('<', '&lt;',form_not_customer_open_ticket_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_not_customer_open_ticket_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_not_customer_open_ticket_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Lookup_fld_category'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fld_category']['valList'][$i] = form_not_customer_open_ticket_pack_protect_string($v);
          }
   ...
   { 
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->ticketmessageid && '' != $this->ticketid)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = '';
...
$_SESSION['scriptcase']['form_not_customer_open_ticket']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['ticketfile1_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['form_not_customer_open_ticket']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['parms'] = "ticketmessageid?#?$this->ticketmessageid?@?ticketid?#?$this->ticketid?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dados_select'] = $this->nmgp_dados_select;
...
$_SESSION['scriptcase']['form_not_customer_open_ticket']['contr_erro'] = 'on';
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_not_customer_open_ticket';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
        ...
        $this->initFormPages();
    include_once("form_not_customer_open_ticket_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_not_customer_open_ticket_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_not_customer_open_ticket_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['ordem_ord'] == " desc") {
