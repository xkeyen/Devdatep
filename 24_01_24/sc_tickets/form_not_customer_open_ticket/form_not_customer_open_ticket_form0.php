...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_not_customer_open_ticket/form_not_customer_open_ticket_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_not_customer_open_ticket_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_not_customer_open_ticket_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['link_info']['remove_border']) {
...
<?php
 include_once("form_not_customer_open_ticket_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_not_customer_open_ticket.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_not_customer_open_ticket'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_not_customer_open_ticket'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php $sc_hidden_no = 1; $sc_hidden_yes = 0; ?>
   <a name="bloco_0"></a>
<?php
   if (!isset($this->nmgp_cmp_hidden['ticketfile3']))
   {
       $this->nmgp_cmp_hidden['ticketfile3'] = 'off';
   }
?>
<script type="text/javascript">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['fld_customer_name']))
    {
...
<?php
   ...
   $fld_customer_name = $this->fld_customer_name;
   $sStyleHidden_fld_customer_name = '';
   if (isset($this->nmgp_cmp_hidden['fld_customer_name']) && $this->nmgp_cmp_hidden['fld_customer_name'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['fld_customer_name']);
       $sStyleHidden_fld_customer_name = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_fld_customer_name = 'display: none;';
   $sStyleReadInp_fld_customer_name = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['fld_customer_name']) && $this->nmgp_cmp_readonly['fld_customer_name'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['fld_customer_name']);
       $sStyleReadLab_fld_customer_name = '';
       $sStyleReadInp_fld_customer_name = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['fld_customer_name']) && $this->nmgp_cmp_hidden['fld_customer_name'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="fld_customer_name" value="<?php echo $this->form_encode_input($fld_customer_name) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_fld_customer_name_line" id="hidden_field_data_fld_customer_name" style="<?php echo $sStyleHidden_fld_customer_name; ?>"> <span class="scFormLabelOddFormat css_fld_customer_name_label" style=""><span id="id_label_fld_customer_name"><?php echo $this->nm_new_label['fld_customer_name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fld_customer_name"]) &&  $this->nmgp_cmp_readonly["fld_customer_name"] == "on") { 

 ?>
<input type="hidden" name="fld_customer_name" value="<?php echo $this->form_encode_input($fld_customer_name) . "\">" . $fld_customer_name . ""; ?>
<?php } else { ?>
<span id="id_read_on_fld_customer_name" class="sc-ui-readonly-fld_customer_name css_fld_customer_name_line" style="<?php echo $sStyleReadLab_fld_customer_name; ?>"><?php echo $this->form_format_readonly("fld_customer_name", $this->form_encode_input($this->fld_customer_name)); ?></span><span id="id_read_off_fld_customer_name" class="css_read_off_fld_customer_name<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_fld_customer_name; ?>">
 <input class="sc-js-input scFormObjectOdd css_fld_customer_name_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_fld_customer_name" type=text name="fld_customer_name" value="<?php echo $this->form_encode_input($fld_customer_name) ?>"
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['fld_customer_email']))
    {
...
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $fld_customer_email = $this->fld_customer_email;
   $sStyleHidden_fld_customer_email = '';
   if (isset($this->nmgp_cmp_hidden['fld_customer_email']) && $this->nmgp_cmp_hidden['fld_customer_email'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['fld_customer_email']);
       $sStyleHidden_fld_customer_email = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_fld_customer_email = 'display: none;';
   $sStyleReadInp_fld_customer_email = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['fld_customer_email']) && $this->nmgp_cmp_readonly['fld_customer_email'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['fld_customer_email']);
       $sStyleReadLab_fld_customer_email = '';
       $sStyleReadInp_fld_customer_email = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['fld_customer_email']) && $this->nmgp_cmp_hidden['fld_customer_email'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="fld_customer_email" value="<?php echo $this->form_encode_input($fld_customer_email) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_fld_customer_email_line" id="hidden_field_data_fld_customer_email" style="<?php echo $sStyleHidden_fld_customer_email; ?>"> <span class="scFormLabelOddFormat css_fld_customer_email_label" style=""><span id="id_label_fld_customer_email"><?php echo $this->nm_new_label['fld_customer_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_customer_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fld_customer_email"]) &&  $this->nmgp_cmp_readonly["fld_customer_email"] == "on") { 

 ?>
<input type="hidden" name="fld_customer_email" value="<?php echo $this->form_encode_input($fld_customer_email) . "\">" . $fld_customer_email . ""; ?>
<?php } else { ?>
<span id="id_read_on_fld_customer_email" class="sc-ui-readonly-fld_customer_email css_fld_customer_email_line" style="<?php echo $sStyleReadLab_fld_customer_email; ?>"><?php echo $this->form_format_readonly("fld_customer_email", $this->form_encode_input($this->fld_customer_email)); ?></span><span id="id_read_off_fld_customer_email" class="css_read_off_fld_customer_email<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_fld_customer_email; ?>">
 <input class="sc-js-input scFormObjectOdd css_fld_customer_email_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_fld_customer_email" type=text name="fld_customer_email" value="<?php echo $this->form_encode_input($fld_customer_email) ?>"
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['fld_language']))
   {
       $this->nm_new_label['fld_language'] = "" . $this->Ini->Nm_lang['lang_fld_language'] . "";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $fld_language = $this->fld_language;
   $tst_conf_reg = $fld_language;
   $sStyleHidden_fld_language = '';
   if (isset($this->nmgp_cmp_hidden['fld_language']) && $this->nmgp_cmp_hidden['fld_language'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['fld_language']);
       $sStyleHidden_fld_language = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_fld_language = 'display: none;';
   $sStyleReadInp_fld_language = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['fld_language']) && $this->nmgp_cmp_readonly['fld_language'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['fld_language']);
       $sStyleReadLab_fld_language = '';
       $sStyleReadInp_fld_language = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['fld_language']) && $this->nmgp_cmp_hidden['fld_language'] == 'off') { $sc_hidden_yes++; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_fld_language_line" id="hidden_field_data_fld_language" style="<?php echo $sStyleHidden_fld_language; ?>"> <span class="scFormLabelOddFormat css_fld_language_label" style=""><span id="id_label_fld_language"><?php echo $this->nm_new_label['fld_language']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_language']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_language'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fld_language"]) &&  $this->nmgp_cmp_readonly["fld_language"] == "on") { 

 ?>
<?php echo $this->Ini->Nm_lang_conf_region[$tst_conf_reg]; ?>
<?php } else { ?>
<span id="id_read_on_fld_language" class="css_fld_language_line" style="<?php echo $sStyleReadLab_fld_language; ?>"><?php echo $this->Ini->Nm_lang_conf_region[$tst_conf_reg]; ?></span><span id="id_read_off_fld_language" class="css_read_off_fld_language" style="<?php echo $sStyleReadInp_fld_language; ?>">
 <span id="idAjaxSelect_fld_language"><select class="sc-js-input scFormObjectOdd css_fld_language_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" name="fld_language" size=1 onChange="document.F1.nmgp_opcao.value='change_lang_f'; setLocale(this); document.F1.submit(); return false">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fld_category_line" id="hidden_field_data_fld_category" style="<?php echo $sStyleHidden_fld_category; ?>"> <span class="scFormLabelOddFormat css_fld_category_label" style=""><span id="id_label_fld_category"><?php echo $this->nm_new_label['fld_category']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_category']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['fld_category'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ticketcontent_line" id="hidden_field_data_ticketcontent" style="<?php echo $sStyleHidden_ticketcontent; ?>"> <span class="scFormLabelOddFormat css_ticketcontent_label" style=""><span id="id_label_ticketcontent"><?php echo $this->nm_new_label['ticketcontent']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['ticketcontent']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['php_cmp_required']['ticketcontent'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><span id="id_read_on_ticketcontent" style="<?php echo $sStyleReadLab_ticketcontent; ?>"><?php echo $this->form_format_readonly("ticketcontent", sc_strip_script($this->ticketcontent)); ?></span><span id="id_read_off_ticketcontent" class="css_read_off_ticketcontent" style="<?php echo $sStyleReadInp_ticketcontent; ?>"><textarea id="ticketcontent" name="ticketcontent" cols="50" rows="10" class="mceEditor_ticketcontent" style="width: 100%; height:300px;"><?php echo $this->form_encode_input($this->ticketcontent); ?></textarea>
</span> </TD>
   <?php }?>
...
<?php $sStyleHidden_ticketcontent_dumb = ('' == $sStyleHidden_ticketcontent) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ticketcontent_dumb" style="<?php echo $sStyleHidden_ticketcontent_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   <a name="bloco_1"></a>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ticketfile1"]) &&  $this->nmgp_cmp_readonly["ticketfile1"] == "on") { 
 ...
 ?>
<input type="hidden" name="ticketfile1" value=""><img id=\"ticketfile1_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_ticketfile1\"><a href=\"javascript:nm_mostra_doc('documento_db', '" . str_replace("'", "\'", trim($ticketfilename1)) . "', 'form_not_customer_open_ticket')\">" . $ticketfilename1"</a></span>"; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ticketfile2"]) &&  $this->nmgp_cmp_readonly["ticketfile2"] == "on") { 
 ...
 ?>
<input type="hidden" name="ticketfile2" value=""><img id=\"ticketfile2_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_ticketfile2\"><a href=\"javascript:nm_mostra_doc('documento_db', '" . str_replace("'", "\'", trim($ticketfilename2)) . "', 'form_not_customer_open_ticket')\">" . $ticketfilename2"</a></span>"; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ticketfile3"]) &&  $this->nmgp_cmp_readonly["ticketfile3"] == "on") { 
 ...
 ?>
<input type="hidden" name="ticketfile3" value=""><img id=\"ticketfile3_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_ticketfile3\"><a href=\"javascript:nm_mostra_doc('documento_db', '" . str_replace("'", "\'", trim($ticketfilename3)) . "', 'form_not_customer_open_ticket')\">" . $ticketfilename3"</a></span>"; ?>
<?php } else { ?>
...
function captchaReloadImage() {
 ...
 document.getElementById("id_captcha_img").src = "form_not_customer_open_ticket_captcha_show.php?sid=" + sRand;
}
</script>
<?php
if (true) {
...
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="form_not_customer_open_ticket_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_not_customer_open_ticket");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_not_customer_open_ticket");
 parent.scAjaxDetailHeight("form_not_customer_open_ticket", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_not_customer_open_ticket']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
