...
<html lang="en">
	<head>
		<title><?php echo $this->Ini->Nm_lang['lang_tble_staff']; ?></title>
...
?>
	...
	<body class="page-background" style="background-image:url('../_lib/libraries/grp/tickets/img/helpdesk-staff-bg.jpg');">
		<div class="page">
			<div class="container-small container-alpha">
				<div class="background">
					<div class="content">
						<h1>
							<?php echo $this->Ini->Nm_lang['lang_tble_staff']; ?>
						</h1>
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
					...
					<div class="control">
						...
						<input class="input  sc-js-input " type="text" placeholder="<?php echo $this->Ini->Nm_lang['lang_email']; ?>"  name="email" id="id_sc_field_email" value="<?php echo $this->form_encode_input($email) ?>"  alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >
					</div>
					...
					<div class="control">
						...
						<span id="id_pwd_show_hide_password" class="sc-ui-pwd-toggle-icon"><i class="fa fa-eye sc-ui-pwd-eye" aria-hidden="true" id="id_pwd_fa_password"></i></span></div>
					</div>
					...
					<!-- Idiomas -->
					<div class="flag-lang">
						<a class="flags" href="../login/login.php?lang=en"><img src="../_lib/libraries/grp/tickets/img/en_us.png"></a>
						<a class="flags" href="../login/login.php?lang=pt"><img src="../_lib/libraries/grp/tickets/img/pt_br.png"></a>
						<a class="flags" href="../login/login.php?lang=es"><img src="../_lib/libraries/grp/tickets/img/es_es.png"></a>
					</div>
					...
					<div id='message'>
						...
						<p style="color:#333;font-size:12px;"><b><?php echo $this->Ini->Nm_lang['lang_staff_fild_adminflag']; ?>:</b></p>
						<p style="color:#333;font-size:12px;"><?php echo $this->Ini->Nm_lang['lang_fld_email']; ?>: <?php echo $this->Ini->Nm_lang['lang_login_admin']; ?></p>
						<p style="color:#333;font-size:12px;"><?php echo $this->Ini->Nm_lang['lang_fld_password']; ?>: admin</p>
						<p style="color:#333;font-size:12px;"><b><?php echo $this->Ini->Nm_lang['lang_staff_fild_staffname']; ?>:</b></p>
						<p style="color:#333;font-size:12px;"><?php echo $this->Ini->Nm_lang['lang_fld_email']; ?>: <?php echo $this->Ini->Nm_lang['lang_login_operator']; ?></p>
						<p style="color:#333;font-size:12px;"><?php echo $this->Ini->Nm_lang['lang_fld_password']; ?>: staff</p>
					</div>
				</form>
			</div>
		</div>
