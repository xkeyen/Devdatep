...
$_SESSION['scriptcase']['login']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['login']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "login.php"; 
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $password = $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][0]; 
                  $email = $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][1]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][0] = $this->password; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][1] = $this->email; 
...
;
	...
	$arr_staff = $this->LoadStaff($this->email );
	...
	unset($_SESSION['scriptcase']['sc_apl_seg']);unset($_SESSION['scriptcase']['pass']);$str_redir = '';

	if(trim($arr_staff['adminflag']) == 'Y'){
		$this->enable_admin_module();
		$this->enable_staff_module();
 ...
 {
$this->nmgp_redireciona_form($str_redir, $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['login']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['login']['total'] + 1,
            ],
            $summaryLine
        );
