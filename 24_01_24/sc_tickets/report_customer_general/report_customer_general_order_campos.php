<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['report_customer_general']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new report_customer_general_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class report_customer_general_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['customerid'] = "customerid";
   $tab_labels["customerid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerid"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerid"] : "" . $this->Nm_lang['lang_customer_fild_customerid'] . "";
   $tab_ger_campos['customername'] = "on";
   $tab_def_campos['customername'] = "customername";
   $tab_labels["customername"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customername"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customername"] : "" . $this->Nm_lang['lang_customer_fild_customername'] . "";
   $tab_ger_campos['customeremail'] = "on";
   $tab_def_campos['customeremail'] = "customeremail";
   $tab_labels["customeremail"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customeremail"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customeremail"] : "" . $this->Nm_lang['lang_customer_fild_customeremail'] . "";
   $tab_ger_campos['customerphone'] = "on";
   $tab_def_campos['customerphone'] = "customerphone";
   $tab_labels["customerphone"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerphone"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerphone"] : "" . $this->Nm_lang['lang_customer_fild_customerphone'] . "";
   $tab_ger_campos['customerpassword'] = "on";
   $tab_def_campos['customerpassword'] = "customerpassword";
   $tab_labels["customerpassword"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerpassword"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customerpassword"] : "" . $this->Nm_lang['lang_customer_fild_customerpassword'] . "";
   $tab_ger_campos['customertype'] = "on";
   $tab_def_campos['customertype'] = "customertype";
   $tab_labels["customertype"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customertype"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["customertype"] : "CustomerType";
   $tab_ger_campos['subgrid_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['subgrid_status'] = "subgrid_status";
   }
   else
   {
       $tab_def_campos['subgrid_status'] = "";
   }
   $tab_labels["subgrid_status"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["subgrid_status"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["subgrid_status"] : " ";
   $tab_ger_campos['subgrid_categories'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['subgrid_categories'] = "subgrid_categories";
   }
   else
   {
       $tab_def_campos['subgrid_categories'] = "";
   }
   $tab_labels["subgrid_categories"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["subgrid_categories"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['labels']["subgrid_categories"] : "";
   $tab_ger_campos['subgrid_status'] = "none";
   $tab_ger_campos['subgrid_categories'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_customer_general']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['report_customer_general']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['report_customer_general']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['report_customer_general']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['report_customer_general']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_customer_general'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "report_customer_general_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['report_customer_general']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
