...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
      type: "POST",
      url: "report_customer_general.php",
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_report_customer_general').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_report_customer_general').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_report_customer_general').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_report_customer_general').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_report_customer_general').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_report_customer_general').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_report_customer_general').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_report_customer_general').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_report_customer_general').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_report_customer_general').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_report_customer_general').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_report_customer_general').style.width  = '0px';
        }
        if (oResp["setValue"]) {
