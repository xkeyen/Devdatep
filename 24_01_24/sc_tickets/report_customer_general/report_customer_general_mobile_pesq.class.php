...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "customerid";$Nm_numeric[] = "customerid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_customerid"  <?php echo $str_hide_customerid?>><INPUT  type="text" id="SC_customerid" name="customerid" value="<?php echo NM_encode_input($customerid) ?>" size=4 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_customername"  <?php echo $str_hide_customername?>><INPUT  type="text" id="SC_customername" name="customername" value="<?php echo NM_encode_input($customername) ?>"  size=35 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_customeremail"  <?php echo $str_hide_customeremail?>><INPUT  type="text" id="SC_customeremail" name="customeremail" value="<?php echo NM_encode_input($customeremail) ?>"  size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_customertype_cond" name="customertype_cond" onChange="nm_campos_between(document.getElementById('id_vis_customertype'), this, 'customertype')">
      ...
      <br><span id="id_hide_customertype"  <?php echo $str_hide_customertype?>><INPUT  type="text" id="SC_customertype" name="customertype" value="<?php echo NM_encode_input($customertype) ?>"  size=7 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
