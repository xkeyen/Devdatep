...
<?php
   ...
   $Ord_Cmp = new report_tickets_by_operator_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class report_tickets_by_operator_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ticketid'] = "ticketid";
   $tab_labels["ticketid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ticketid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ticketid"] : "" . $this->Nm_lang['lang_ticket_fild_ticketid'] . "";
   $tab_ger_campos['ticketpriorityid'] = "on";
   $tab_def_campos['ticketpriorityid'] = "ticketpriorityid";
   $tab_labels["ticketpriorityid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ticketpriorityid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ticketpriorityid"] : "" . $this->Nm_lang['lang_ticket_fild_ticketpriorityid'] . "";
   $tab_ger_campos['statusid'] = "on";
   $tab_def_campos['statusid'] = "statusid";
   $tab_labels["statusid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["statusid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["statusid"] : "" . $this->Nm_lang['lang_ticket_fild_statusid'] . "";
   $tab_ger_campos['ownerid'] = "on";
   $tab_def_campos['ownerid'] = "ownerid";
   $tab_labels["ownerid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ownerid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["ownerid"] : "" . $this->Nm_lang['lang_tble_staff'] . "";
   $tab_ger_campos['customerid'] = "on";
   $tab_def_campos['customerid'] = "customerid";
   $tab_labels["customerid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["customerid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["customerid"] : "" . $this->Nm_lang['lang_ticket_fild_customerid'] . "";
   $tab_ger_campos['categoryid'] = "on";
   $tab_def_campos['categoryid'] = "categoryid";
   $tab_labels["categoryid"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["categoryid"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["categoryid"] : "" . $this->Nm_lang['lang_ticket_fild_categoryid'] . "";
   $tab_ger_campos['subject'] = "on";
   $tab_def_campos['subject'] = "subject";
   $tab_labels["subject"]   = (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["subject"])) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['labels']["subject"] : "" . $this->Nm_lang['lang_ticket_fild_subject'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "report_tickets_by_operator_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['report_tickets_by_operator']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
