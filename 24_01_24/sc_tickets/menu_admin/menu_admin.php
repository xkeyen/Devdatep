...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_admin']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['menu_admin']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_admin']['glo_nm_conexao']        = "conn_example";
    $_SESSION['scriptcase']['menu_admin']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo']      = "S";
...
$_SESSION['scriptcase']['menu_admin']['sc_apl_link'] = $menu_admin_menuData['url']['link'];
...
$this->str_schema_all = $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetCoral/Sc9_SweetCoral";
...
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_monitor_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_monitor_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_operator_tickets_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_operator_tickets_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_tickets']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_tickets_unassigned_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_tickets_unassigned_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_tickets_admin_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_tickets_admin_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_admin']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_staff_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_staff_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_customer_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_customer_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_canned_message_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_canned_message_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_canned_message']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_ticket_email_tpl_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_ticket_email_tpl_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ticket_email_tpl']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_languages_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_languages_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_languages']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_staff_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_staff_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_systemsettings_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_systemsettings_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_systemsettings']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_ticketpriority_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_ticketpriority_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketpriority']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_ticketstatus_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_ticketstatus_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketstatus']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_kb_articles_edit_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_kb_articles_edit_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_kb_categories_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_kb_categories_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_categories']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_kb_articletype_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_kb_articletype_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_articletype']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_tickets_by_operator_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/report_tickets_by_operator_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_tickets_by_category_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/report_tickets_by_category_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_category']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_tickets_month_categories_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/report_tickets_month_categories_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_month_categories']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_tickets_time_answer_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/report_tickets_time_answer_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_time_answer']))
        {
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']) == "on")
{
    $menu_admin_menuData['data'] .= "item_35|.|" . $this->Nm_lang['lang_admin_home'] . "|menu_admin_form_php.php?sc_item_menu=item_35&sc_apl_menu=report_monitor&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_35|.|" . $this->Nm_lang['lang_admin_home'] . "||||_self|disabled\n";
}
$menu_admin_menuData['data'] .= "item_12|.|" . $this->Nm_lang['lang_staff'] . "||" . $nm_var_hint[1] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_tickets']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_tickets']) == "on")
{
    $menu_admin_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_staff_mytickets'] . "|menu_admin_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_operator_tickets&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_staff_mytickets'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) == "on")
{
    $menu_admin_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_staff_ticketsunassigned'] . "|menu_admin_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_staff_ticketsunassigned'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_admin']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_admin']) == "on")
{
    $menu_admin_menuData['data'] .= "item_33|..|" . $this->Nm_lang['lang_admin_all_tickets'] . "|menu_admin_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_tickets_admin&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_33|..|" . $this->Nm_lang['lang_admin_all_tickets'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_staff']) == "on")
{
    $menu_admin_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_staff_editprofile'] . "|menu_admin_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_staff&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_staff_editprofile'] . "||||_self|disabled\n";
}
$menu_admin_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_admin'] . "||" . $nm_var_hint[6] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_categories']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categories']) == "on")
{
    $menu_admin_menuData['data'] .= "item_2|..|" . $this->Nm_lang['lang_admin_categories'] . "|menu_admin_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_2|..|" . $this->Nm_lang['lang_admin_categories'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customer']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customer']) == "on")
{
    $menu_admin_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_admin_customer'] . "|menu_admin_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_customer&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_admin_customer'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_canned_message']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_canned_message']) == "on")
{
    $menu_admin_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_tble_message_templates'] . "|menu_admin_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_canned_message&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_tble_message_templates'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ticket_email_tpl']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ticket_email_tpl']) == "on")
{
    $menu_admin_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_tble_emailtemplatemessages'] . "|menu_admin_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_ticket_email_tpl&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_tble_emailtemplatemessages'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_languages']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_languages']) == "on")
{
    $menu_admin_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_admin_languages'] . "|menu_admin_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_languages&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_admin_languages'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) == "on")
{
    $menu_admin_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_admin_staff'] . "|menu_admin_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_staff&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_admin_staff'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_systemsettings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_systemsettings']) == "on")
{
    $menu_admin_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_admin_systemsettings'] . "|menu_admin_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_systemsettings&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_admin_systemsettings'] . "||||_self|disabled\n";
}
$menu_admin_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_admin_tickets'] . "||" . $nm_var_hint[14] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketpriority']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ticketpriority']) == "on")
{
    $menu_admin_menuData['data'] .= "item_9|...|" . $this->Nm_lang['lang_admin_ticket_priority'] . "|menu_admin_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_ticketpriority&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_9|...|" . $this->Nm_lang['lang_admin_ticket_priority'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketstatus']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ticketstatus']) == "on")
{
    $menu_admin_menuData['data'] .= "item_10|...|" . $this->Nm_lang['lang_admin_tickets_status'] . "|menu_admin_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_ticketstatus&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_10|...|" . $this->Nm_lang['lang_admin_tickets_status'] . "||||_self|disabled\n";
}
$menu_admin_menuData['data'] .= "item_29|.|" . $this->Nm_lang['lang_admin_kb'] . "||" . $nm_var_hint[17] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['menu_knowledge']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['menu_knowledge']) == "on")
{
    $menu_admin_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_admin_kb_show_articles'] . "|menu_admin_form_php.php?sc_item_menu=item_32&sc_apl_menu=menu_knowledge&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_admin_kb_show_articles'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit']) == "on")
{
    $menu_admin_menuData['data'] .= "item_34|..|" . $this->Nm_lang['lang_admin_kb_articles_new'] . "|menu_admin_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_kb_articles_edit&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_34|..|" . $this->Nm_lang['lang_admin_kb_articles_new'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_categories']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_kb_categories']) == "on")
{
    $menu_admin_menuData['data'] .= "item_30|..|" . $this->Nm_lang['lang_admin_kb_categories'] . "|menu_admin_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_kb_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[20] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_30|..|" . $this->Nm_lang['lang_admin_kb_categories'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_articletype']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_kb_articletype']) == "on")
{
    $menu_admin_menuData['data'] .= "item_31|..|" . $this->Nm_lang['lang_admin_kb_articletype'] . "|menu_admin_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_kb_articletype&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[21] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_31|..|" . $this->Nm_lang['lang_admin_kb_articletype'] . "||||_self|disabled\n";
}
$menu_admin_menuData['data'] .= "item_24|.|" . $this->Nm_lang['lang_admin_report'] . "||" . $nm_var_hint[22] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) == "on")
{
    $menu_admin_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_tickets_by_operator_title'] . "|menu_admin_form_php.php?sc_item_menu=item_25&sc_apl_menu=report_tickets_by_operator&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[23] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_tickets_by_operator_title'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_category']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_category']) == "on")
{
    $menu_admin_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_tickets_by_category_title'] . "|menu_admin_form_php.php?sc_item_menu=item_26&sc_apl_menu=report_tickets_by_category&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[24] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_tickets_by_category_title'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_month_categories']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_month_categories']) == "on")
{
    $menu_admin_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_tickets_month_categories_title'] . "|menu_admin_form_php.php?sc_item_menu=item_27&sc_apl_menu=report_tickets_month_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[25] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_tickets_month_categories_title'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_time_answer']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_time_answer']) == "on")
{
    $menu_admin_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_tickets_time_answer'] . "|menu_admin_form_php.php?sc_item_menu=item_28&sc_apl_menu=report_tickets_time_answer&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[26] . "||" . $this->menu_admin_target('_self') . "|" . "\n";
}
else
{
    $menu_admin_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_tickets_time_answer'] . "||||_self|disabled\n";
}
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_admin'];
$menu_admin_menuData['data'] .= "item_22|.|" . $this->Nm_lang['lang_admin_exit'] . "|$saida_apl|" . $nm_var_hint[27] . "||_parent|\n";
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_35&sc_apl_menu=report_monitor&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_home'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_35",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_operator_tickets&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_tickets']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_tickets']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_staff_mytickets'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_14",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_staff_ticketsunassigned'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_13",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_tickets_admin&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_admin']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_admin']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_all_tickets'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_33",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_staff&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_staff']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_staff_editprofile'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_15",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_categories']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categories']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_categories'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_2",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_customer&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customer']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customer']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_customer'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[8] . "",
        'id'       => "item_3",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_canned_message&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_canned_message']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_canned_message']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tble_message_templates'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[9] . "",
        'id'       => "item_4",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_ticket_email_tpl&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ticket_email_tpl']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ticket_email_tpl']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tble_emailtemplatemessages'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[10] . "",
        'id'       => "item_23",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_languages&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_languages']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_languages']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_languages'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[11] . "",
        'id'       => "item_6",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_staff&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_staff'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[12] . "",
        'id'       => "item_7",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_systemsettings&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_systemsettings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_systemsettings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_systemsettings'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[13] . "",
        'id'       => "item_8",
...
$menu_admin_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_admin_tickets'] . "",
    'level'    => "1",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[14] . "",
    'id'       => "item_11",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_ticketpriority&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketpriority']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ticketpriority']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_ticket_priority'] . "",
        'level'    => "2",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[15] . "",
        'id'       => "item_9",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_ticketstatus&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ticketstatus']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ticketstatus']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_tickets_status'] . "",
        'level'    => "2",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[16] . "",
        'id'       => "item_10",
...
$menu_admin_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_admin_kb'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[17] . "",
    'id'       => "item_29",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_32&sc_apl_menu=menu_knowledge&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_knowledge']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['menu_knowledge']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_kb_show_articles'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[18] . "",
        'id'       => "item_32",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_kb_articles_edit&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_kb_articles_edit']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_kb_articles_new'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[19] . "",
        'id'       => "item_34",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_kb_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_categories']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_kb_categories']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_kb_categories'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[20] . "",
        'id'       => "item_30",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_kb_articletype&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_kb_articletype']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_kb_articletype']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_admin_kb_articletype'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[21] . "",
        'id'       => "item_31",
...
$menu_admin_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_admin_report'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[22] . "",
    'id'       => "item_24",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_25&sc_apl_menu=report_tickets_by_operator&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tickets_by_operator_title'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[23] . "",
        'id'       => "item_25",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_26&sc_apl_menu=report_tickets_by_category&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_category']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_category']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tickets_by_category_title'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[24] . "",
        'id'       => "item_26",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_27&sc_apl_menu=report_tickets_month_categories&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_month_categories']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_month_categories']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tickets_month_categories_title'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[25] . "",
        'id'       => "item_27",
...
$str_disabled = "N";
$str_link = "menu_admin_form_php.php?sc_item_menu=item_28&sc_apl_menu=report_tickets_time_answer&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_time_answer']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_time_answer']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tickets_time_answer'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[26] . "",
        'id'       => "item_28",
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_admin']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
        ...
        }function openMenuItem(str_id)
{
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_menu_admin').length)
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuHHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "ScriptCase Ticket System" ?></div>
    <div class="scMenuHHeaderFont" style="float: right;"><?php echo "" . $this->Nm_lang['lang_header_logged_user'] . " : <b>" . $_SESSION['v_staffname'] . "</b>" ?></div>
</div>    </td>
  </tr>
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_admin_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_monitor']) && $_SESSION['scriptcase']['sc_apl_seg']['report_monitor'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_admin');\" item-href=\"menu_admin_form_php.php?sc_item_menu=menu_admin&sc_apl_menu=report_monitor&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_admin_iframe\"";
} 
else
{ 
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_admin_menuData, $path_imag_cab)
{
   ...
   {
        $_SESSION['scriptcase']['menu_admin']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_sc_tickets'])) {
            $_SESSION['scriptcase']['menu_admin']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_sc_tickets'];
        }
    }
}
