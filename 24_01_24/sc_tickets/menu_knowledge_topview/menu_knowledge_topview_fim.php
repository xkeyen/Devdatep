   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="menu_knowledge_topview.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____menu_knowledge_topview"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____menu_knowledge_topview"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>menu_knowledge_topview</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['menu_knowledge_topview']['embutida_filho'] as $ind => $sc_init)
          {
