...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
      type: "POST",
      url: "menu_knowledge_topview.php",
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_menu_knowledge_topview').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_menu_knowledge_topview').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_menu_knowledge_topview').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_menu_knowledge_topview').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_menu_knowledge_topview').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_menu_knowledge_topview').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_menu_knowledge_topview').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_menu_knowledge_topview').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_menu_knowledge_topview').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_menu_knowledge_topview').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_menu_knowledge_topview').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_menu_knowledge_topview').style.width  = '0px';
        }
        if (oResp["setValue"]) {
