...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>customer_login/customer_login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['last'] : 'off'); ?>";
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['link_info']['remove_border']) {
...
<?php
$_SESSION['scriptcase']['error_span_title']['customer_login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['customer_login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_password_line" id="hidden_field_data_password" style="<?php echo $sStyleHidden_password; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("customer_login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("customer_login");
 parent.scAjaxDetailHeight("customer_login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['customer_login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
