<?php  
  ...
  session_start() ;
  class grid_staff_form_teste
  {
  function grid_staff_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_staff</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_staff"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_staff_form_teste();
  $frm_teste->grid_staff_teste();
?>
