<?php
@session_start() ;
$_SESSION['scriptcase']['grid_staff']['sc_process_barr'] = true;
require_once('../grid_staff/index.php');
unset($_SESSION['scriptcase']['grid_staff']['sc_process_barr']);
$ExportCtrl = new grid_staff_export_control;
$ExportCtrl->Export_barr();

class grid_staff_export_control
{
