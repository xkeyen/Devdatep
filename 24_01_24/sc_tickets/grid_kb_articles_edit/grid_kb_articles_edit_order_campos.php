...
<?php
   ...
   $Ord_Cmp = new grid_kb_articles_edit_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kb_articles_edit_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['articlesid'] = "articlesid";
   $tab_labels["articlesid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articlesid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articlesid"] : "" . $this->Nm_lang['lang_kb_articles_fild_articlesid'] . "";
   $tab_ger_campos['categoryid'] = "on";
   $tab_def_campos['categoryid'] = "categoryid";
   $tab_labels["categoryid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["categoryid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["categoryid"] : "" . $this->Nm_lang['lang_kb_articles_fild_categoryid'] . "";
   $tab_ger_campos['articlesubject'] = "on";
   $tab_def_campos['articlesubject'] = "articlesubject";
   $tab_labels["articlesubject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articlesubject"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articlesubject"] : "" . $this->Nm_lang['lang_kb_articles_fild_articlesubject'] . "";
   $tab_ger_campos['articletypeid'] = "on";
   $tab_def_campos['articletypeid'] = "articletypeid";
   $tab_labels["articletypeid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articletypeid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articletypeid"] : "" . $this->Nm_lang['lang_kb_articles_fild_articletypeid'] . "";
   $tab_ger_campos['articledate'] = "on";
   $tab_def_campos['articledate'] = "articledate";
   $tab_labels["articledate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articledate"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articledate"] : "ArticleDate";
   $tab_ger_campos['articleview'] = "on";
   $tab_def_campos['articleview'] = "articleview";
   $tab_labels["articleview"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articleview"])) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['labels']["articleview"] : "" . $this->Nm_lang['lang_kb_articles_fild_articleview'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kb_articles_edit_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kb_articles_edit']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
