   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_kb_articles_edit.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_edit"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_edit"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_kb_articles'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kb_articles_edit</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_edit']['embutida_filho'] as $ind => $sc_init)
          {
