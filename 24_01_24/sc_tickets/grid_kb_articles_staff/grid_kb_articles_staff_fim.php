   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_kb_articles_staff.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_staff"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles_staff"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kb_articles_staff</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kb_articles_staff']['embutida_filho'] as $ind => $sc_init)
          {
