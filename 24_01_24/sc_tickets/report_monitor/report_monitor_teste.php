<?php  
  ...
  session_start() ;
  class report_monitor_form_teste
  {
   function report_monitor_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "report_monitor/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'report_monitor')
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_monitor</FONT></B> 
<br> 
<br> 
<form name="Fedit" method="post" 
               action="report_monitor.php" 
               target="_self"> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="report_monitor"> 
</form> 
...
<?php
  ...
  $frm_teste = new report_monitor_form_teste();
  $frm_teste->report_monitor_teste();
?>
