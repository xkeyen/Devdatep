  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_canned_message_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_canned_message_mob_form();
	}
...
?>
  ...
  // ---------- Validate templateid
  function do_ajax_form_canned_message_mob_validate_templateid()
  {
    var nomeCampo_templateid = "templateid";
    var var_templateid = scAjaxGetFieldHidden(nomeCampo_templateid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_mob_validate_templateid(var_templateid, var_script_case_init, do_ajax_form_canned_message_mob_validate_templateid_cb);
  } // do_ajax_form_canned_message_mob_validate_templateid

  function do_ajax_form_canned_message_mob_validate_templateid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_mob_validate_templateid_cb

  // ---------- Validate categoryid
  function do_ajax_form_canned_message_mob_validate_categoryid()
  {
    var nomeCampo_categoryid = "categoryid";
    var var_categoryid = scAjaxGetFieldSelect(nomeCampo_categoryid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_mob_validate_categoryid(var_categoryid, var_script_case_init, do_ajax_form_canned_message_mob_validate_categoryid_cb);
  } // do_ajax_form_canned_message_mob_validate_categoryid

  function do_ajax_form_canned_message_mob_validate_categoryid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_mob_validate_categoryid_cb

  // ---------- Validate templatedescription
  function do_ajax_form_canned_message_mob_validate_templatedescription()
  {
    var nomeCampo_templatedescription = "templatedescription";
    var var_templatedescription = scAjaxGetFieldText(nomeCampo_templatedescription);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_mob_validate_templatedescription(var_templatedescription, var_script_case_init, do_ajax_form_canned_message_mob_validate_templatedescription_cb);
  } // do_ajax_form_canned_message_mob_validate_templatedescription

  function do_ajax_form_canned_message_mob_validate_templatedescription_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "templatedescription";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_mob_validate_templatedescription_cb

  // ---------- Validate templatecontent
  function do_ajax_form_canned_message_mob_validate_templatecontent()
  {
    var nomeCampo_templatecontent = "templatecontent";
    var var_templatecontent = scAjaxGetFieldText(nomeCampo_templatecontent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_canned_message_mob_validate_templatecontent(var_templatecontent, var_script_case_init, do_ajax_form_canned_message_mob_validate_templatecontent_cb);
  } // do_ajax_form_canned_message_mob_validate_templatecontent

  function do_ajax_form_canned_message_mob_validate_templatecontent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "templatecontent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_canned_message_mob_validate_templatecontent_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_canned_message_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_canned_message_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_templateid = scAjaxGetFieldHidden("templateid");
    var var_categoryid = scAjaxGetFieldSelect("categoryid");
    var var_templatedescription = scAjaxGetFieldText("templatedescription");
    var var_templatecontent = scAjaxGetFieldText("templatecontent");
    ...
    scAjaxProcOn();
    x_ajax_form_canned_message_mob_submit_form(var_templateid, var_categoryid, var_templatedescription, var_templatecontent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_canned_message_mob_submit_form_cb);
  } // do_ajax_form_canned_message_mob_submit_form

  function do_ajax_form_canned_message_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_canned_message_mob_submit_form_cb_after_alert);
  } // do_ajax_form_canned_message_mob_submit_form_cb
  function do_ajax_form_canned_message_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_canned_message_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_canned_message_mob_navigate_form()
  {
    perform_ajax_form_canned_message_mob_navigate_form();
  }

  function perform_ajax_form_canned_message_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_templateid = document.F2.templateid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_canned_message_mob_navigate_form(var_templateid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_canned_message_mob_navigate_form_cb);
  } // do_ajax_form_canned_message_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_canned_message_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_canned_message_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.templateid.value = scAjaxGetKeyValue("templateid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_canned_message_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_canned_message_mob_navigate_form_cb
  function do_ajax_form_canned_message_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_canned_message_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_canned_message_mob_navigate_form_cb_after_alert

  function sc_hide_form_canned_message_mob_form()
  {
  ...
  ajax_field_list[0] = "templateid";
  ajax_field_list[1] = "categoryid";
  ajax_field_list[2] = "templatedescription";
  ajax_field_list[3] = "templatecontent";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "templateid": {"label": "<?php echo $this->Ini->Nm_lang['lang_message_templates_fild_templateid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categoryid": {"label": "<?php echo $this->Ini->Nm_lang['lang_message_templates_fild_categoryid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "templatedescription": {"label": "<?php echo $this->Ini->Nm_lang['lang_message_templates_fild_templatedescription'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "templatecontent": {"label": "<?php echo $this->Ini->Nm_lang['lang_message_templates_fild_templatecontent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "templatedescription": new Array(),
    "templatecontent": new Array()
  };
  ajax_field_mult["templateid"][1] = "templateid";
  ajax_field_mult["categoryid"][1] = "categoryid";
  ajax_field_mult["templatedescription"][1] = "templatedescription";
  ajax_field_mult["templatecontent"][1] = "templatecontent";
  ...
  var ajax_field_id = {
    ...
    "templatedescription": new Array("hidden_field_label_templatedescription", "hidden_field_data_templatedescription"),
    "templatecontent": new Array("hidden_field_label_templatecontent", "hidden_field_data_templatecontent")
  };

  var ajax_read_only = {
    "templateid": "on",
    "categoryid": "off",
    "templatedescription": "off",
    "templatecontent": "off"
  };
