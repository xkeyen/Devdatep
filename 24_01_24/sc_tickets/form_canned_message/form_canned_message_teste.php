<?php  
  ...
  session_start() ;
  class form_canned_message_form_teste
  {
   function form_canned_message_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_canned_message/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_canned_message</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_canned_message"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_canned_message_form_teste();
  $frm_teste->form_canned_message_teste();
?>
