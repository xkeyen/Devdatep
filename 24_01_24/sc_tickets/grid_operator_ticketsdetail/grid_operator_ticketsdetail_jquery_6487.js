...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
      type: "POST",
      url: "grid_operator_ticketsdetail.php",
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_grid_operator_ticketsdetail').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_grid_operator_ticketsdetail').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_grid_operator_ticketsdetail').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_grid_operator_ticketsdetail').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_grid_operator_ticketsdetail').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_operator_ticketsdetail').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_operator_ticketsdetail').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_operator_ticketsdetail').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_grid_operator_ticketsdetail').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_operator_ticketsdetail').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_operator_ticketsdetail').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_operator_ticketsdetail').style.width  = '0px';
        }
        if (oResp["setValue"]) {
