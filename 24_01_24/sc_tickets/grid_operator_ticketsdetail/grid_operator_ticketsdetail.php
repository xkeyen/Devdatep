<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imagens']    = "/scriptcase9/file/img";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_doc']        = "/nm/www/scriptcase4_en/file/doc";
   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']         = "conn_example";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_operator_ticketsdetail_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_form_operator_response;
   var $link_grid_operator_ticketsmessage_cons_emb;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_operator_ticketsdetail"; 
      $this->nm_nome_apl     = "Staff :: Ticktes detail"; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_operator_ticketsdetail']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_operator_ticketsdetail']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_operator_ticketsdetail';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['actual_lang']) || $_SESSION['scriptcase']['grid_operator_ticketsdetail']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_operator_ticketsdetail']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_operator_ticketsdetail_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "grid_operator_ticketsmessage";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/grid_operator_ticketsmessage_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/grid_operator_ticketsmessage_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["grid_operator_ticketsmessage"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_message"] = '';
      $this->sc_lig_target["C_@scinf_message_@scinf_grid_operator_ticketsmessage"] = '';
      $Tmp_apl_lig = "form_operator_response";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_operator_response_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_operator_response_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["form_operator_response"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = 'nm_iframe_liga_B_grid_operator_ticketsdetail';
      $this->sc_lig_target["A_@scinf__@scinf_form_operator_response"] = 'nm_iframe_liga_B_grid_operator_ticketsdetail';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_operator_ticketsdetail"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_operator_ticketsdetail"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['link_info']['remove_border'] = true;
        }

      $this->link_form_operator_response =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_operator_response') . "/form_operator_response.php" ; 
      $this->link_grid_operator_ticketsmessage_cons_emb =  $this->root . $this->path_link  . "" . SC_dir_app_name('grid_operator_ticketsmessage') . "/grid_operator_ticketsmessage.php" ; 
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_operator_ticketsdetail_erro.class.php"); 
      $this->Erro = new grid_operator_ticketsdetail_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_operator_ticketsdetail'); 
// 
      ...
      $this->arr_buttons_usr['Back']['hint']             = "Back";
      $this->arr_buttons_usr['Back']['type']             = "button";
      $this->arr_buttons_usr['Back']['value']            = "Back";
      $this->arr_buttons_usr['Back']['display']          = "only_text";
      $this->arr_buttons_usr['Back']['display_position'] = "text_right";
      $this->arr_buttons_usr['Back']['style']            = "default";
      $this->arr_buttons_usr['Back']['image']            = "";
      ...
      if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsmessage']['ind_tree'] = 0;
   }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_conexao'], $this->root . $this->path_prod, 'sc_tickets', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_operator_ticketsdetail']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class grid_operator_ticketsdetail_sub_css
{
   function __construct()
   {
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_operator_ticketsdetail_ini(); 
          $this->Ini->init("Path_sub");
      } 
      $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsmessage']['SC_herda_css'] = "S"; 
      $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsmessage']['embutida'] = true;
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsmessage']['embutida'] = false;
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_operator_ticketsdetail']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_operator_ticketsdetail'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_operator_ticketsdetail_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_operator_ticketsdetail']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_operator_ticketsdetail'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'] || $Parms_form_pdf)
      { 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_pai'] = "";
      } 
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_operator_ticketsdetail_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "";
      }
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_operator_ticketsdetail']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_operator_ticketsdetail'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_operator_ticketsdetail']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_operator_ticketsdetail']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_operator_ticketsdetail') . "/grid_operator_ticketsdetail.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_operator_ticketsdetail']['label'] = "" . $this->Ini->Nm_lang['lang_header_ticket_history'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "grid_operator_ticketsdetail")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("en_us");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_erro.class.php"); 
      } 
      $this->Erro      = new grid_operator_ticketsdetail_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_operator_ticketsdetail_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_operator_ticketsdetail_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pivot_tabular']);
              }
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_operator_ticketsdetail_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_operator_ticketsdetail_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['proc_pdf_vert'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['proc_pdf_vert']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['proc_pdf'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticket_tickettrack";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticket_ticketlastupdate";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "customer_customername";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticket_categoryid";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticket_subject";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticketpriority_priorityname";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "ticketstatus_statusname";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['field_order'][] = "message";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_operator_ticketsdetail']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['contr_array_resumo'] = 'NAO';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['contr_total_geral'] = "NAO";
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_operator_ticketsdetail_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_operator_ticketsdetail.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_operator_ticketsdetail_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_operator_ticketsdetail_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_operator_ticketsdetail_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_xls.class.php"); 
          } 
          $this->xls  = new grid_operator_ticketsdetail_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_xml.class.php"); 
          } 
          $this->xml  = new grid_operator_ticketsdetail_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_json.class.php"); 
          } 
          $this->json  = new grid_operator_ticketsdetail_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_csv.class.php"); 
          } 
          $this->csv  = new grid_operator_ticketsdetail_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_rtf.class.php"); 
          } 
          $this->rtf  = new grid_operator_ticketsdetail_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_operator_ticketsdetail . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_operator_ticketsdetail_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_operator_ticketsdetail_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_operator_ticketsdetail_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_operator_ticketsdetail/grid_operator_ticketsdetail_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_operator_ticketsdetail_grid.class.php"); 
          } 
          $this->grid  = new grid_operator_ticketsdetail_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['embutida'])
      {
         ...
         {
             $Temp = ob_get_clean();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['opcao'] != "ajax_detalhe")  
             {
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_operator_ticketsdetail_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_operator_ticketsdetail_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_operator_ticketsdetail_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_operator_ticketsdetail.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
?>
<FORM name="F0" method=post action="grid_operator_ticketsdetail.php" target="<?php echo $NM_target; ?>"> 
...
<?php
   ...
   function Back() 
   {
      ...
      $nm_f_saida = "grid_operator_ticketsdetail.php";
?>
     <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
      <html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
...
<?php
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_operator_tickets') . "/grid_operator_tickets.php", $this->nm_location, "","_self", 440, 630);
 };
...
?>
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_header_ticket_history'] ?> :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_ticketsdetail'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_operator_ticketsdetail($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_operator_ticketsdetail($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_operator_ticketsdetail']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_operator_ticketsdetail") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_sc_tickets'])) {
               $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_sc_tickets'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_operator_ticketsdetail']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_operator_ticketsdetail']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_operator_ticketsdetail']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']);
               $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_operator_ticketsdetail']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_operator_ticketsdetail']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_operator_ticketsdetail']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_operator_ticketsdetail']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_operator_ticketsdetail";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_operator_ticketsdetail' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('grid_operator_ticketsdetail' == $sReferer || 'grid_operator_ticketsdetail_' == substr($sReferer, 0, 28))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['initialize'] = false;
       }
       else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "en_us";
   if (isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetCoral/Sc9_SweetCoral";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_operator_ticketsdetail')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_operator_ticketsdetail_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_operator_ticketsdetail_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_operator_ticketsdetail_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['mostra_edit'] = "N";   
           } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operator_ticketsdetail']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_operator_ticketsdetail'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_grid_operator_ticketsdetail = new grid_operator_ticketsdetail_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] = "busca";
          $contr_grid_operator_ticketsdetail->NM_ajax_flag = true;
          $contr_grid_operator_ticketsdetail->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] = "busca";
          $contr_grid_operator_ticketsdetail->NM_ajax_flag = true;
          $contr_grid_operator_ticketsdetail->NM_ajax_opcao = "ajax_ch_bi_search";
      }
       $contr_grid_operator_ticketsdetail->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_operator_ticketsdetail(&$str)
   {
   }
   function nm_protect_num_grid_operator_ticketsdetail($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_operator_ticketsdetail_pack_protect_string($sString)
   {
    ...
    function grid_operator_ticketsdetail_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_operator_ticketsdetail']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
