<?php
@session_start() ;
$_SESSION['scriptcase']['grid_operator_ticketsdetail']['sc_process_barr'] = true;
require_once('../grid_operator_ticketsdetail/index.php');
unset($_SESSION['scriptcase']['grid_operator_ticketsdetail']['sc_process_barr']);
$ExportCtrl = new grid_operator_ticketsdetail_export_control;
$ExportCtrl->Export_barr();

class grid_operator_ticketsdetail_export_control
{
