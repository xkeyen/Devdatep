  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_mob_form();
	}
...
?>
  ...
  // ---------- Validate customerid
  function do_ajax_form_customer_mob_validate_customerid()
  {
    var nomeCampo_customerid = "customerid";
    var var_customerid = scAjaxGetFieldHidden(nomeCampo_customerid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_mob_validate_customerid(var_customerid, var_script_case_init, do_ajax_form_customer_mob_validate_customerid_cb);
  } // do_ajax_form_customer_mob_validate_customerid

  function do_ajax_form_customer_mob_validate_customerid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_mob_validate_customerid_cb

  // ---------- Validate customername
  function do_ajax_form_customer_mob_validate_customername()
  {
    var nomeCampo_customername = "customername";
    var var_customername = scAjaxGetFieldText(nomeCampo_customername);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_mob_validate_customername(var_customername, var_script_case_init, do_ajax_form_customer_mob_validate_customername_cb);
  } // do_ajax_form_customer_mob_validate_customername

  function do_ajax_form_customer_mob_validate_customername_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_mob_validate_customername_cb

  // ---------- Validate customeremail
  function do_ajax_form_customer_mob_validate_customeremail()
  {
    var nomeCampo_customeremail = "customeremail";
    var var_customeremail = scAjaxGetFieldText(nomeCampo_customeremail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_mob_validate_customeremail(var_customeremail, var_script_case_init, do_ajax_form_customer_mob_validate_customeremail_cb);
  } // do_ajax_form_customer_mob_validate_customeremail

  function do_ajax_form_customer_mob_validate_customeremail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_mob_validate_customeremail_cb

  // ---------- Validate customerphone
  function do_ajax_form_customer_mob_validate_customerphone()
  {
    var nomeCampo_customerphone = "customerphone";
    var var_customerphone = scAjaxGetFieldText(nomeCampo_customerphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_mob_validate_customerphone(var_customerphone, var_script_case_init, do_ajax_form_customer_mob_validate_customerphone_cb);
  } // do_ajax_form_customer_mob_validate_customerphone

  function do_ajax_form_customer_mob_validate_customerphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_mob_validate_customerphone_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_customerid = scAjaxGetFieldHidden("customerid");
    ...
    scAjaxProcOn();
    x_ajax_form_customer_mob_submit_form(var_customerid, var_customername, var_customeremail, var_customerphone, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_mob_submit_form_cb);
  } // do_ajax_form_customer_mob_submit_form

  function do_ajax_form_customer_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_mob_submit_form_cb_after_alert);
  } // do_ajax_form_customer_mob_submit_form_cb
  function do_ajax_form_customer_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_mob_navigate_form()
  {
    perform_ajax_form_customer_mob_navigate_form();
  }

  function perform_ajax_form_customer_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_mob_navigate_form(var_customerid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_mob_navigate_form_cb);
  } // do_ajax_form_customer_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_mob_navigate_form_cb
  function do_ajax_form_customer_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_customer_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_mob_navigate_form_cb_after_alert

  function sc_hide_form_customer_mob_form()
  {
  ...
  ajax_field_list[1] = "customername";
  ajax_field_list[2] = "customeremail";
  ajax_field_list[3] = "customerphone";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "customerid": {"label": "<?php echo $this->Ini->Nm_lang['lang_customer_fild_customerid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
