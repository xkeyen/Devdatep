  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_show_messages_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_show_messages_mob_form();
	}
...
?>
  ...
  // ---------- Validate lb_message
  function do_ajax_control_show_messages_mob_validate_lb_message()
  {
  } // do_ajax_control_show_messages_mob_validate_lb_message

  function do_ajax_control_show_messages_mob_validate_lb_message_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lb_message";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_show_messages_mob_validate_lb_message_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_show_messages_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_show_messages_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lb_message = scAjaxGetFieldHidden("lb_message");
    ...
    scAjaxProcOn();
    x_ajax_control_show_messages_mob_submit_form(var_lb_message, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_show_messages_mob_submit_form_cb);
  } // do_ajax_control_show_messages_mob_submit_form

  function do_ajax_control_show_messages_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_show_messages_mob_submit_form_cb_after_alert);
  } // do_ajax_control_show_messages_mob_submit_form_cb
  function do_ajax_control_show_messages_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_show_messages_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_show_messages_mob_navigate_form()
  {
    perform_ajax_control_show_messages_mob_navigate_form();
  }

  function perform_ajax_control_show_messages_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_show_messages_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_show_messages_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_show_messages_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_show_messages_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_show_messages_mob_navigate_form_cb
  function do_ajax_control_show_messages_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_show_messages_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_show_messages_mob_navigate_form_cb_after_alert

  function sc_hide_control_show_messages_mob_form()
  {
  ...
  ajax_field_list[0] = "lb_message";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lb_message": {"label": "lb_message", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "lb_message": new Array()
  };
  ajax_field_mult["lb_message"][1] = "lb_message";

  var ajax_field_id = {
    "lb_message": new Array("hidden_field_label_lb_message", "hidden_field_data_lb_message")
  };
