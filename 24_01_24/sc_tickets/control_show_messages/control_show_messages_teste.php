<?php  
  ...
  session_start() ;
  class control_show_messages_form_teste
  {
   function control_show_messages_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_show_messages/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_show_messages</FONT></B> 
<br> 
<br> 
...
v_message_content&nbsp;&nbsp;<input type="text" name="v_message_content" size=20><br> 
v_message_title&nbsp;&nbsp;<input type="text" name="v_message_title" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="control_show_messages"> 
</form> 
<script language=javascript> 
 document.Fedit.v_message_content.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new control_show_messages_form_teste();
  $frm_teste->control_show_messages_teste();
?>
