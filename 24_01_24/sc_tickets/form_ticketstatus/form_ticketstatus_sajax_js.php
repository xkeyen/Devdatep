  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ticketstatus" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ticketstatus_form();
	}
...
?>
  ...
  // ---------- Validate statusid_
  function do_ajax_form_ticketstatus_validate_statusid_(iNumLinha)
  {
    var nomeCampo_statusid_ = "statusid_" + iNumLinha;
    var var_statusid_ = scAjaxGetFieldText(nomeCampo_statusid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketstatus_validate_statusid_(var_statusid_, iNumLinha, var_script_case_init, do_ajax_form_ticketstatus_validate_statusid__cb);
  } // do_ajax_form_ticketstatus_validate_statusid_

  function do_ajax_form_ticketstatus_validate_statusid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketstatus_validate_statusid__cb

  // ---------- Validate statusname_
  function do_ajax_form_ticketstatus_validate_statusname_(iNumLinha)
  {
    var nomeCampo_statusname_ = "statusname_" + iNumLinha;
    var var_statusname_ = scAjaxGetFieldText(nomeCampo_statusname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketstatus_validate_statusname_(var_statusname_, iNumLinha, var_script_case_init, do_ajax_form_ticketstatus_validate_statusname__cb);
  } // do_ajax_form_ticketstatus_validate_statusname_

  function do_ajax_form_ticketstatus_validate_statusname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketstatus_validate_statusname__cb

  // ---------- Validate statusicon_
  function do_ajax_form_ticketstatus_validate_statusicon_(iNumLinha)
  {
    var nomeCampo_statusicon_ = "statusicon_" + iNumLinha;
    var var_statusicon_ = scAjaxGetFieldText(nomeCampo_statusicon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketstatus_validate_statusicon_(var_statusicon_, iNumLinha, var_script_case_init, do_ajax_form_ticketstatus_validate_statusicon__cb);
  } // do_ajax_form_ticketstatus_validate_statusicon_

  function do_ajax_form_ticketstatus_validate_statusicon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "statusicon_" + iLineNumber;
    }
    else
    {
      sFieldValid = "statusicon_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketstatus_validate_statusicon__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_ticketstatus_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_ticketstatus_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ticketstatus_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_ticketstatus_add_new_line_cb);
  } // do_ajax_form_ticketstatus_add_new_line

  function do_ajax_form_ticketstatus_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_statusicon_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_ticketstatus_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_ticketstatus_backup_line(iNumLinha)
  {
    var var_statusid_ = scAjaxGetFieldText("statusid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketstatus_backup_line(var_statusid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_ticketstatus_backup_line_cb);
  } // do_ajax_form_ticketstatus_backup_line

  function do_ajax_form_ticketstatus_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_ticketstatus_backup_line_cb

  function do_ajax_form_ticketstatus_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_ticketstatus_cancel_insert

  function do_ajax_form_ticketstatus_cancel_update(iSeqVert)
  {
    do_ajax_form_ticketstatus_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_ticketstatus_cancel_update

  function do_ajax_form_ticketstatus_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_ticketstatus_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_ticketstatus_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ticketstatus_table_refresh(var_statusid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticketstatus_table_refresh_cb);
  } //  do_ajax_form_ticketstatus_table_refresh

  function do_ajax_form_ticketstatus_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_ticketstatus_table_refresh_cb_after_alert);
  } // do_ajax_form_ticketstatus_table_refresh_cb
  function do_ajax_form_ticketstatus_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_ticketstatus_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_ticketstatus_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_ticketstatus_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_statusicon_ = scAjaxGetFieldText("statusicon_" + iNumLinha);
    var var_statusicon__ul_name = scAjaxSpecCharProtect(eval('document.F1.statusicon__ul_name' + iNumLinha + '.value'));
    var var_statusicon__ul_type = eval('document.F1.statusicon__ul_type' + iNumLinha + '.value');
    var var_statusicon__limpa = eval('document.F1.statusicon__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_ticketstatus_submit_form(var_statusid_, var_statusname_, var_statusicon_, var_statusicon__ul_name, var_statusicon__ul_type, var_statusicon__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ticketstatus_submit_form_cb);
  } // do_ajax_form_ticketstatus_submit_form

  function do_ajax_form_ticketstatus_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
<?php
        ...
        {
?>
          if (document.F1.elements["statusicon__limpa" + sc_num_ult_line] && document.F1.elements["statusicon__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("statusicon_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["statusicon__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.statusicon__ul_name" + sc_num_ult_line + ") document.F1.statusicon__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.statusicon__ul_type" + sc_num_ult_line + ") document.F1.statusicon__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ticketstatus_submit_form_cb_after_alert);
  } // do_ajax_form_ticketstatus_submit_form_cb
  function do_ajax_form_ticketstatus_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ticketstatus_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ticketstatus_navigate_form()
  {
    perform_ajax_form_ticketstatus_navigate_form();
  }

  function perform_ajax_form_ticketstatus_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_ticketstatus_cancel_insert(sc_form_ticketstatus_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ticketstatus_navigate_form(var_statusid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticketstatus_navigate_form_cb);
  } // do_ajax_form_ticketstatus_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ticketstatus']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ticketstatus_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    {
      eval("if (document.F1.statusicon__ul_name" + iImg + ") document.F1.statusicon__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.statusicon__ul_type" + iImg + ") document.F1.statusicon__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ticketstatus_navigate_form_cb_after_alert);
  } // do_ajax_form_ticketstatus_navigate_form_cb
  function do_ajax_form_ticketstatus_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_ticketstatus_navigate_form_cb_after_alert

    function sc_form_ticketstatus_get_last_line_number()
    {
    ...
    } //sc_form_ticketstatus_get_last_line_number

  function sc_hide_form_ticketstatus_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "statusicon_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["statusid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketstatus_fild_statusid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["statusname_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["statusicon_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketstatus_fild_statusicon'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["statusid_"][iNumLinha] = "statusid_" + iNumLinha;
    ajax_field_mult["statusname_"][iNumLinha] = "statusname_" + iNumLinha;
    ajax_field_mult["statusicon_"][iNumLinha] = "statusicon_" + iNumLinha;
    ...
    ajax_field_id["statusicon_" + iNumLinha] = new Array("hidden_field_label_statusicon_", "hidden_field_data_statusicon_" + iNumLinha);
    ajax_error_count["statusid_" + iNumLinha] = "off";
    ajax_error_count["statusname_" + iNumLinha] = "off";
    ajax_error_count["statusicon_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["statusicon_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["statusicon_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["statusicon_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["statusicon_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["statusicon_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["statusicon_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["statusicon_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["statusicon_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['statusicon_'])) ? $this->nmgp_cmp_readonly['statusicon_'] : 'off';
?>
    scAjaxFieldRead("statusicon_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("statusicon_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["statusid_" + iRow] || "on" == ajax_error_count["statusname_" + iRow] || "on" == ajax_error_count["statusicon_" + iRow]))
    {
      ...
      $("#hidden_field_data_statusicon_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["statusid_" + iRow] && "off" == ajax_error_count["statusname_" + iRow] && "off" == ajax_error_count["statusicon_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["statusid_" + iRow] = "off";
        ajax_error_count["statusname_" + iRow] = "off";
        ajax_error_count["statusicon_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_statusicon_" + iRow).removeClass("scFormErrorLine");
    }
  }
