<?php  
  ...
  session_start() ;
  class form_ticketstatus_form_teste
  {
   function form_ticketstatus_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_ticketstatus/img";
...
<?php
  ...
  $frm_teste = new form_ticketstatus_form_teste();
  $frm_teste->form_ticketstatus_teste();
?>
