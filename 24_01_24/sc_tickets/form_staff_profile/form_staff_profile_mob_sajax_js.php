  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_staff_profile_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_staff_profile_mob_form();
	}
...
?>
  ...
  // ---------- Validate staffid
  function do_ajax_form_staff_profile_mob_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldHidden(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_profile_mob_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_staff_profile_mob_validate_staffid_cb);
  } // do_ajax_form_staff_profile_mob_validate_staffid

  function do_ajax_form_staff_profile_mob_validate_staffid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_profile_mob_validate_staffid_cb

  // ---------- Validate staffname
  function do_ajax_form_staff_profile_mob_validate_staffname()
  {
    var nomeCampo_staffname = "staffname";
    var var_staffname = scAjaxGetFieldText(nomeCampo_staffname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_profile_mob_validate_staffname(var_staffname, var_script_case_init, do_ajax_form_staff_profile_mob_validate_staffname_cb);
  } // do_ajax_form_staff_profile_mob_validate_staffname

  function do_ajax_form_staff_profile_mob_validate_staffname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_profile_mob_validate_staffname_cb

  // ---------- Validate staffemail
  function do_ajax_form_staff_profile_mob_validate_staffemail()
  {
    var nomeCampo_staffemail = "staffemail";
    var var_staffemail = scAjaxGetFieldText(nomeCampo_staffemail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_profile_mob_validate_staffemail(var_staffemail, var_script_case_init, do_ajax_form_staff_profile_mob_validate_staffemail_cb);
  } // do_ajax_form_staff_profile_mob_validate_staffemail

  function do_ajax_form_staff_profile_mob_validate_staffemail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_profile_mob_validate_staffemail_cb

  // ---------- Validate changepassword
  function do_ajax_form_staff_profile_mob_validate_changepassword()
  {
    var nomeCampo_changepassword = "changepassword";
    var var_changepassword = scAjaxGetFieldCheckbox(nomeCampo_changepassword, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_profile_mob_validate_changepassword(var_changepassword, var_script_case_init, do_ajax_form_staff_profile_mob_validate_changepassword_cb);
  } // do_ajax_form_staff_profile_mob_validate_changepassword

  function do_ajax_form_staff_profile_mob_validate_changepassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "changepassword";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_profile_mob_validate_changepassword_cb

  // ---------- Validate newpassword
  function do_ajax_form_staff_profile_mob_validate_newpassword()
  {
    var nomeCampo_newpassword = "newpassword";
    var var_newpassword = scAjaxGetFieldText(nomeCampo_newpassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_profile_mob_validate_newpassword(var_newpassword, var_script_case_init, do_ajax_form_staff_profile_mob_validate_newpassword_cb);
  } // do_ajax_form_staff_profile_mob_validate_newpassword

  function do_ajax_form_staff_profile_mob_validate_newpassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "newpassword";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_profile_mob_validate_newpassword_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_staff_profile_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_staff_profile_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_changepassword = scAjaxGetFieldCheckbox("changepassword", ";");
    var var_newpassword = scAjaxGetFieldText("newpassword");
    ...
    scAjaxProcOn();
    x_ajax_form_staff_profile_mob_submit_form(var_staffid, var_staffname, var_staffemail, var_changepassword, var_newpassword, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_profile_mob_submit_form_cb);
  } // do_ajax_form_staff_profile_mob_submit_form

  function do_ajax_form_staff_profile_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_staff_profile_mob_submit_form_cb_after_alert);
  } // do_ajax_form_staff_profile_mob_submit_form_cb
  function do_ajax_form_staff_profile_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_staff_profile_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_staff_profile_mob_navigate_form()
  {
    perform_ajax_form_staff_profile_mob_navigate_form();
  }

  function perform_ajax_form_staff_profile_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_staff_profile_mob_navigate_form(var_staffid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_profile_mob_navigate_form_cb);
  } // do_ajax_form_staff_profile_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff_profile_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_staff_profile_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_staff_profile_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_staff_profile_mob_navigate_form_cb
  function do_ajax_form_staff_profile_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_staff_profile_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_staff_profile_mob_navigate_form_cb_after_alert

  function sc_hide_form_staff_profile_mob_form()
  {
  ...
  ajax_field_list[3] = "changepassword";
  ajax_field_list[4] = "newpassword";
  ...
  var ajax_error_list = {
    ...
    "changepassword": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fild_changepassword'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "newpassword": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fild_newpassword'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["changepassword"][1] = "changepassword";
  ajax_field_mult["newpassword"][1] = "newpassword";
  ...
  var ajax_field_id = {
    ...
    "changepassword": new Array("hidden_field_label_changepassword", "hidden_field_data_changepassword"),
    "newpassword": new Array("hidden_field_label_newpassword", "hidden_field_data_newpassword")
  };
