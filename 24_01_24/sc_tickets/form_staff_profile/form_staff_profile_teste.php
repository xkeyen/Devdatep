<?php  
  ...
  session_start() ;
  class form_staff_profile_form_teste
  {
   function form_staff_profile_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_staff_profile/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_staff_profile</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_staff_profile"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_staff_profile_form_teste();
  $frm_teste->form_staff_profile_teste();
?>
