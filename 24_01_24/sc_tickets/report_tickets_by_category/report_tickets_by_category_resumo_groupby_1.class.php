...
class report_tickets_by_category_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['report_tickets_by_category'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['report_tickets_by_category'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_tickets_by_category']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['report_tickets_by_category']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['report_tickets_by_category']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['categoryid'],
    ...
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('groupby_1' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_x_axys'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_group_by'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_order'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_x_axys'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_y_axys'] = [];

            $dimensionCount = 0;

            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_x_axys'] [] = $dimensionCount;
            ...
            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_y_axys'] [] = $dimensionCount;

                $dimensionCount++;
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['dimension_order'] = [];
            foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
            }
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
            $dimensionName = $this->SC_APP_info['group_by'] ['dimension'] ['order'] [$dimensionIndex];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summarizing_fields_order'] ['groupby_1'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['summary_cache']);
        }
    }
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}report_tickets_by_category/report_tickets_by_category.php";
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                report_tickets_by_category_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            report_tickets_by_category_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@report_tickets_by_category@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['report_tickets_by_category'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['report_tickets_by_category'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['report_tickets_by_category'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['report_tickets_by_category'] ['opcao']) {
            return true;
        }
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "report_tickets_by_category.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total_line']['categoryid'];
            }
          $this->array_total_categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total']['categoryid'];
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_categoryid = array();
                $this->totaliza();
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_clear_total'] = true;
            }
          $this->array_total_categoryid = array();
          $this->totaliza();
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total']['categoryid'] = $this->array_total_categoryid;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total_line']['categoryid'] = $this->array_line_categoryid;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary() && !$this->aux_isExport()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['json_use_label'])
       {
          $Lab_categoryid = "categoryid";
       }
       else
       {
       $Lab_categoryid = "" . $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] . "";
       }
       $this->comp_field = array(
           $Lab_categoryid,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketpriorityid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketpriorityid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketpriorityid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['statusid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['statusid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_statusid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ownerid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ownerid'] = "" . $this->Ini->Nm_lang['lang_tble_staff'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customerid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customerid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_customerid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['categoryid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['categoryid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['subject']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['subject'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_subject'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['ticketdate'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketdate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customerrating']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customerrating'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_customerrating'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customercomments']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['labels']['customercomments'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_customercomments'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'categoryid' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_categoryid as $i_categoryid => $d_categoryid) {
           if (!isset($i_categoryid, $this->comp_label[0]) || !in_array($i_categoryid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_categoryid[3] ] = $d_categoryid[2];
               $this->comp_label[0][ $d_categoryid[3] ] = $d_categoryid[2];
           }
       }
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_tickets_by_category@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_report_tickets_by_category_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_report_tickets_by_category_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['embutida'])
                   {
   ...
   function drawMatrixLabels()
   {
       ...
       $apl_cab_resumo = "" . $this->Ini->Nm_lang['lang_tickets_by_category_title'] . "";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['report_tickets_by_category']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['report_tickets_by_category']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['report_tickets_by_category']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['report_tickets_by_category']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "report_tickets_by_category_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new report_tickets_by_category_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_groupby_1("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig'])) {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_orig']; 
          }
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_filtro'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq_filtro'] . ")"; 
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_groupby_1("res", $this->NM_export, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_categoryid)) {
          ksort($this->array_total_categoryid);
      }
      $this->NM_res_sem_reg = true;
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq']        = $save_where_pesq;
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tble_ticket'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"report_tickets_by_category_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"report_tickets_by_category_jquery_1549.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"report_tickets_by_category_message.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_by_category_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_report_tickets_by_category_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_by_category_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_tickets_by_category_title'] . "</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['embutida'])
      {
         ...
         $NM_btn  = false;
         $NM_Gbtn = false;
         if (is_file("report_tickets_by_category_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("report_tickets_by_category_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=chart,resume&password=n&summary_export_columns=N&pdf_zip=N&origem=res&language=en_us&conf_socor=S&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=report_tickets_by_category&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['report_tickets_by_category']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'report_tickets_by_category_config_pivot.php?nome_apl=report_tickets_by_category&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"report_tickets_by_category.php\" style=\"display: none\">\r\n");
       ...
       $nm_saida->saida("</form>\r\n");
          ...
          $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"report_tickets_by_category.php\"\r\n");
          ...
          $nm_saida->saida("                    action=\"report_tickets_by_category.php\" \r\n");
          $nm_saida->saida("                    target=\"_self\" style=\"display: none\"> \r\n");
   ...
   $nm_saida->saida("                  action=\"report_tickets_by_category_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("               document.Fdoc_word.action = \"report_tickets_by_category_export_ctrl.php\";\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"report_tickets_by_category_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("               document.Fexport.action = \"report_tickets_by_category_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['report_tickets_by_category_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_tickets_by_category@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          ...
          $nm_saida->saida("          document.Fres_pdf.action = \"report_tickets_by_category_iframe.php\";\r\n");
          ...
          $nm_saida->saida("    document.F3.action = \"report_tickets_by_category.php\";\r\n");
          $nm_saida->saida(" } \r\n");
          ...
          $nm_saida->saida(" {\r\n");
          $nm_saida->saida("     document.FRES.action = \"report_tickets_by_category.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_tickets_by_category_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "report_tickets_by_category/report_tickets_by_category_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               report_tickets_by_category_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           report_tickets_by_category_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new report_tickets_by_category_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           report_tickets_by_category_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           report_tickets_by_category_pdf_progress_call("\n", $this->Ini->Nm_lang);
           report_tickets_by_category_pdf_progress_call("\n", $this->Ini->Nm_lang);
           report_tickets_by_category_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   report_tickets_by_category_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function adiciona_registro($quebra_categoryid, $quebra_categoryid_orig)
   {
      ...
      if (!isset($this->array_total_categoryid[$quebra_categoryid_orig]))
      {
         ...
         $this->array_total_categoryid[$quebra_categoryid_orig][1] = 1;
         $this->array_total_categoryid[$quebra_categoryid_orig][2] = $quebra_categoryid;
         $this->array_total_categoryid[$quebra_categoryid_orig][3] = $quebra_categoryid_orig;
      }
      else
      {
         $this->array_total_categoryid[$quebra_categoryid_orig][0]++;
         $this->array_total_categoryid[$quebra_categoryid_orig][2]++;
      }
   }
   ...
   {
      if (isset($this->array_total_categoryid))
      {
         $arr_temp_0 = $this->array_total_categoryid;
         foreach ($this->array_total_categoryid as $campo_categoryid => $dados_categoryid)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_categoryid[$campo_categoryid][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_categoryid[$campo_categoryid][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_categoryid][$ind_missing][0] = 0;
                $arr_temp_0[$campo_categoryid][$ind_missing][1] = 0;
                $arr_temp_0[$campo_categoryid][$ind_missing][2] = $dados_categoryid[$ind_exists][2];
                $arr_temp_0[$campo_categoryid][$ind_missing][3] = $dados_categoryid[$ind_exists][3];
            }
            ksort($arr_temp_0[$campo_categoryid]);
            $this->array_total_categoryid[$campo_categoryid] = $arr_temp_0[$campo_categoryid];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT ticketid, ticketpriorityid, statusid, ownerid, customerid, categoryid, subject from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'categoryid');
     $campos_order = $this->Ini->Get_date_order_groupby("categoryid", 'asc', $format, $campos_order);
