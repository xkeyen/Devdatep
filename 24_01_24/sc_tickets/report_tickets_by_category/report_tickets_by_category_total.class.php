...
class report_tickets_by_category_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['report_tickets_by_category']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_tickets_by_category']['campos_busca']))
      { 
   ...
   function Calc_resumo_groupby_1($destino_resumo, $res_export=false, $ind_compara="")
   {
      global $nm_lang;
      $this->nm_data = new nm_data("en_us");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('categoryid' => "categoryid");
      $cmps_quebra_atual = array("categoryid");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb']))
      {
          $cmps_quebra_atual = $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_force_fiels_gb'];
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_clear_total']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_clear_total']) {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['SC_clear_total']);
      $ind_cmps  = 1;
      $ind_alias = "1";
      $cmp_dim   = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_groupby_1($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['categoryid']['reg'] = "S";
      $format_dimensions['categoryid']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "categoryid") {
                  $this->Lookup->lookup_groupby_1_categoryid($$Cada_dim,  $categoryid);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   {
      global $nada, $nm_lang , $ownerid, $categoryid;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_tickets_by_category']['contr_total_geral'] = "OK";
   } 

   //-----  categoryid
   function quebra_categoryid_groupby_1($categoryid, $arg_sum_categoryid) 
   {
      global $tot_categoryid, $ownerid, $categoryid;
