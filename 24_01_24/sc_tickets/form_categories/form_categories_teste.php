<?php  
  ...
  session_start() ;
  class form_categories_form_teste
  {
   function form_categories_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_categories/img";
...
<?php
  ...
  $frm_teste = new form_categories_form_teste();
  $frm_teste->form_categories_teste();
?>
