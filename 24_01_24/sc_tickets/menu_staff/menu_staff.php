<?php
include_once('menu_staff_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['menu_staff']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_staff']['glo_nm_conexao']        = "conn_example";
    $_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_staff_class
{
  var $Db;
 ...
 function menu_staff_menu()
 {
    global $menu_staff_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_staff']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_staff/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_staff');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_staff_erro.php");
}
include_once(dirname(__FILE__) . "/menu_staff_erro.class.php"); 
$this->Erro = new menu_staff_erro();
$str_path = substr($_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_staff']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_staff_menuData         = array();
$menu_staff_menuData['path'] = array();
$menu_staff_menuData['url']  = array();
$menu_staff_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_staff_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_staff_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_staff_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_staff_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_staff_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_staff_menuData['url']['web']   = str_replace("\\", '/', $menu_staff_menuData['url']['web']);
$menu_staff_menuData['path']['root'] = substr($menu_staff_menuData['path']['sys'],  0, -1 * strlen($menu_staff_menuData['url']['web']));
$menu_staff_menuData['path']['app']  = substr($menu_staff_menuData['path']['sys'],  0, strrpos($menu_staff_menuData['path']['sys'],  '/'));
$menu_staff_menuData['path']['link'] = substr($menu_staff_menuData['path']['app'],  0, strrpos($menu_staff_menuData['path']['app'],  '/'));
$menu_staff_menuData['path']['link'] = substr($menu_staff_menuData['path']['link'], 0, strrpos($menu_staff_menuData['path']['link'], '/')) . '/';
$menu_staff_menuData['path']['app'] .= '/';
$menu_staff_menuData['url']['app']   = substr($menu_staff_menuData['url']['web'],  0, strrpos($menu_staff_menuData['url']['web'],  '/'));
$menu_staff_menuData['url']['link']  = substr($menu_staff_menuData['url']['app'],  0, strrpos($menu_staff_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] == "S")
{
    $menu_staff_menuData['url']['link']  = substr($menu_staff_menuData['url']['link'], 0, strrpos($menu_staff_menuData['url']['link'], '/'));
}
$menu_staff_menuData['url']['link']  .= '/';
$menu_staff_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_staff']['sc_apl_link'] = $menu_staff_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_staff']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_staff']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_staff']['actual_lang']) || $_SESSION['scriptcase']['menu_staff']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_staff']['actual_lang'] = $this->str_lang;
...
include_once("menu_staff_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_staff";
     $_SESSION['scriptcase']['menu_apls']['menu_staff'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_staff']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_staff']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_staff']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_staff']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_staff']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_staff']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_staff']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_staff']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_staff']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_staff']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_staff']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_staff']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_staff']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_staff']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_staff']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_staff']['init']))
{
    $_SESSION['sc_session'][1]['menu_staff']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_staff']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_staff']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_staff'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_staff'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_staff'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_staff'))
{
    $_SESSION['sc_session'][1]['menu_staff']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_staff'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_staff_menuData['iframe'] = TRUE;
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_staff_profile_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_staff_profile_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff_profile']))
        {
...
/* Elementos de menú */
$_SESSION['scriptcase']['menu_staff']['contr_erro'] = 'on';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_staff'];
...
{
    $menu_staff_menuData['data'] .= "item_25|.|" . $this->Nm_lang['lang_staff_home'] . "|menu_staff_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_staff_target('_self') . "|" . "\n";
}
else
{
    $menu_staff_menuData['data'] .= "item_25|.|" . $this->Nm_lang['lang_staff_home'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) == "on")
{
    $menu_staff_menuData['data'] .= "item_13|.|" . $this->Nm_lang['lang_staff_ticketsunassigned'] . "|menu_staff_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_staff_target('_self') . "|" . "\n";
}
else
{
    $menu_staff_menuData['data'] .= "item_13|.|" . $this->Nm_lang['lang_staff_ticketsunassigned'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff_profile']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_staff_profile']) == "on")
{
    $menu_staff_menuData['data'] .= "item_15|.|" . $this->Nm_lang['lang_staff_editprofile'] . "|menu_staff_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_staff_profile&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_staff_target('_self') . "|" . "\n";
}
else
{
    $menu_staff_menuData['data'] .= "item_15|.|" . $this->Nm_lang['lang_staff_editprofile'] . "||||_self|disabled\n";
}
$menu_staff_menuData['data'] .= "item_23|.|" . $this->Nm_lang['lang_staff_report'] . "||" . $nm_var_hint[3] . "||_self|\n";
...
{
    $menu_staff_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_tickets_by_operator_title'] . "|menu_staff_form_php.php?sc_item_menu=item_24&sc_apl_menu=report_tickets_by_operator&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_staff_target('_self') . "|" . "\n";
}
else
{
    $menu_staff_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_tickets_by_operator_title'] . "||||_self|disabled\n";
}
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_staff'];
$menu_staff_menuData['data'] .= "item_22|.|" . $this->Nm_lang['lang_staff_exit'] . "|$saida_apl|" . $nm_var_hint[5] . "||_parent|\n";
...
$menu_staff_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_staff_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_staff_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_staff_home'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_25",
        ...
        'target'   => " item-target=\"" . $this->menu_staff_target('_self') . "\"",
        'sc_id'    => "item_25",
...
$str_disabled = "N";
$str_link = "menu_staff_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tickets_unassigned']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_staff_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_staff_profile&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_staff_profile']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_staff_profile']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_staff_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_staff_report'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[3] . "",
    'id'       => "item_23",
...
$str_disabled = "N";
$str_link = "menu_staff_form_php.php?sc_item_menu=item_24&sc_apl_menu=report_tickets_by_operator&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_tickets_by_operator']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_staff_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_staff_exit'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[5] . "",
    'id'       => "item_22",
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->menu_staff_target('_parent') . "\"",
    'sc_id'    => "item_22",
    'disabled' => $str_disabled,
    'display'     => "",
    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_staff']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_staff']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_staff');
    $menu_staff_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_staff_help.txt"))
{
    $Arq_WebHelp = file("menu_staff_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_staff_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_staff_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_staff']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_staff']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_staff_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_staff']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_staff_menuData['data'][$i_menu]);
       }
    ...
    $menu_staff_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_staff']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_staff']))
{
    $disable_menu = false;
    foreach ($menu_staff_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_staff']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_staff_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
if($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']))
{
    $_SESSION['scriptcase']['menu_mobile'] = "menu_staff";
    include('menu_staff_mobile.php');
    exit;
}
/* Cabecera HTML */
if ($menu_staff_menuData['iframe'])
{
    $menu_staff_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
...
{
    $menu_staff_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_staff']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_staff_message.js"></script>
...
Iframe_atual = "menu_staff_iframe";
...
{
  if (str_id != "iframe_menu_staff")
  {
      str_id        = str_id.replace("menu_staff_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_staff', 'menu_staff');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_menu_staff').length)
        $('#iframe_menu_staff')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_staff_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_staff_escreveMenu($menu_staff_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_staff_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_staff');\" item-href=\"menu_staff_form_php.php?sc_item_menu=menu_staff&sc_apl_menu=grid_tickets_unassigned&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_staff_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_staff_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_staff" name="menu_staff_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_staff').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_staff_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_staff_target($str_target)
{
    global $menu_staff_menuData;
    ...
    elseif ($menu_staff_menuData['iframe'])
    {
        return 'menu_staff_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_staff_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_staff_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_staff_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_staff_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_staff']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_staff_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_staff']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_staff") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_staff']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_staff']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_staff']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_sc_tickets'])) {
            $_SESSION['scriptcase']['menu_staff']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_sc_tickets'];
        }
    }
}
...
$contr_menu_staff = new menu_staff_class;
$contr_menu_staff->menu_staff_menu();
