<?php  
  ...
  session_start() ;
  class form_customer_open_ticket_form_teste
  {
   function form_customer_open_ticket_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customer_open_ticket/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customer_open_ticket</FONT></B> 
<br> 
<br> 
...
v_customerid&nbsp;&nbsp;<input type="text" name="v_customerid" size=20><br> 
...
<input type="submit" value="form_customer_open_ticket"> 
</form> 
<script language=javascript> 
 document.Fedit.v_customerid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_customer_open_ticket_form_teste();
  $frm_teste->form_customer_open_ticket_teste();
?>
