<?php
//
class form_customer_open_ticket_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['fld_priority']))
          {
              $this->fld_priority = $this->NM_ajax_info['param']['fld_priority'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_customerid)) 
          {
              $_SESSION['v_customerid'] = $this->v_customerid;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_customer_open_ticket_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['upload_field_info']['ticketfile1'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_open_ticket_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['upload_field_info']['ticketfile2'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_open_ticket_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_open_ticket_mob']['upload_field_info']['ticketfile3'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_open_ticket_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_open_ticket_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_open_ticket_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_open_ticket_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_open_ticket_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_customer_open_ticket_mob') . "/form_customer_open_ticket_mob.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_open_ticket_mob']['label'] = "" . $this->Ini->Nm_lang['lang_header_open_ticket'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_customer_open_ticket_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_customer_open_ticket_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_customer_open_ticket_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_customer_open_ticket_mob.php"; 
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile1_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      elseif (isset($this->ticketfile1_ul_name) && '' != $this->ticketfile1_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->ticketfile1_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile2_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      elseif (isset($this->ticketfile2_ul_name) && '' != $this->ticketfile2_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->ticketfile2_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile3_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      elseif (isset($this->ticketfile3_ul_name) && '' != $this->ticketfile3_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->ticketfile3_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_open_ticket_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_open_ticket_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_open_ticket_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_customer_open_ticket_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_customer_open_ticket_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_customer_open_ticket_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_customer_open_ticket/form_customer_open_ticket_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_customer_open_ticket_mob_erro.class.php"); 
      }
      $this->Erro      = new form_customer_open_ticket_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao']))
         { 
             if ($this->ticketmessageid != "" || $this->ticketid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_open_ticket_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_customer_open_ticket_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_customer_open_ticket_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_customer_open_ticket_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_customer_open_ticket_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_customer_open_ticket_mob.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_fld_priority' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fld_priority');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['recarga'] = $this->nmgp_opcao;
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_customer_open_ticket_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_customer_open_ticket_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_customer_open_ticket_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_customer_open_ticket_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_customer_open_ticket_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_customer_open_ticket_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_customer_open_ticket_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_customer_open_ticket_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fld_priority' == $filtro)) || (is_array($filtro) && in_array('fld_priority', $filtro)))
        $this->ValidateField_fld_priority($Campos_Crit, $Campos_Falta, $Campos_Erros);
   ...
   if (isset($this->Field_no_validate['fld_category'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['fld_category']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['fld_category'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_ticketcontent(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['ticketcontent']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['ticketcontent'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_fld_priority(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fld_priority'])) {
       return;
   }
      if ($this->fld_priority == "" && $this->nmgp_opcao != "excluir")
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['fld_priority']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['php_cmp_required']['fld_priority'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketpriorityid'] . "" ;
          if (!isset($Campos_Erros['fld_priority']))
          {
              $Campos_Erros['fld_priority'] = array();
          }
          $Campos_Erros['fld_priority'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fld_priority']) || !is_array($this->NM_ajax_info['errList']['fld_priority']))
                  {
                      $this->NM_ajax_info['errList']['fld_priority'] = array();
                  }
                  $this->NM_ajax_info['errList']['fld_priority'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
        } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fld_priority';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fld_priority
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->ticketfile1 && "S" != $this->ticketfile1_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_customer_open_ticket_mob_doc_name.php';
                }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_fld_priority();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['ticketmessageid']['keyVal'] = form_customer_open_ticket_mob_pack_protect_string($this->nmgp_dados_form['ticketmessageid']);
              $this->NM_ajax_info['fldList']['ticketid']['keyVal'] = form_customer_open_ticket_mob_pack_protect_string($this->nmgp_dados_form['ticketid']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category'] = array(); 
}
$aLookup[] = array(form_customer_open_ticket_mob_pack_protect_string('') => str_replace('<', '&lt;',form_customer_open_ticket_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_customer_open_ticket_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_customer_open_ticket_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_category'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fld_category']['valList'][$i] = form_customer_open_ticket_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_ticketcontent($bForce = false)
   {
          ...
          //----- fld_priority
   function ajax_return_values_fld_priority($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fld_priority", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fld_priority);
              $aLookup = array();
              $this->_tmp_lookup_fld_priority = $this->fld_priority;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority'] = array(); 
}
$aLookup[] = array(form_customer_open_ticket_mob_pack_protect_string('') => str_replace('<', '&lt;',form_customer_open_ticket_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fld_priority\"";
          if (isset($this->NM_ajax_info['select_html']['fld_priority']) && !empty($this->NM_ajax_info['select_html']['fld_priority']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fld_priority']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fld_priority == $sValue)
                  {
                      $this->_tmp_lookup_fld_priority = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fld_priority'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fld_priority']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fld_priority']['valList'][$i] = form_customer_open_ticket_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fld_priority']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fld_priority']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fld_priority']['labList'] = $aLabel;
          }
   }
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
           if ($this->NM_size_docs[$ticketfilename3] != filesize($this->Ini->root . $out_ticketfile1))
           {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile] = $this->ticketfilename1;
          ...
          $this->NM_ajax_info['fldList']['ticketfile1'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_customer_open_ticket')\">" . $tmp_file_ticketfile1 . "</a>",
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
           if ($this->NM_size_docs[$ticketfilename3] != filesize($this->Ini->root . $out_ticketfile2))
           {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile] = $this->ticketfilename2;
          ...
          $this->NM_ajax_info['fldList']['ticketfile2'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_customer_open_ticket')\">" . $tmp_file_ticketfile2 . "</a>",
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
           if ($this->NM_size_docs[$ticketfilename3] != filesize($this->Ini->root . $out_ticketfile3))
           {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile] = $this->ticketfilename3;
          ...
          $this->NM_ajax_info['fldList']['ticketfile3'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_customer_open_ticket')\">" . $tmp_file_ticketfile3 . "</a>",
   ...
   function ajax_return_values_ticketid($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->ticketmessageid && '' != $this->ticketid)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = '';
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_fld_priority = $this->fld_priority;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_fld_priority != $this->fld_priority || (isset($bFlagRead_fld_priority) && $bFlagRead_fld_priority)))
    {
        $this->ajax_return_values_fld_priority(true);
    }
...
$_SESSION['scriptcase']['form_customer_open_ticket_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['ticketfile1_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('fld_category', 'fld_subject', 'ticketcontent', 'fld_priority', 'ticketfile1', 'ticketfile2', 'ticketfile3'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$str_content =  $this->Ini->Nm_lang['lang_alert_ticket_submited']  .'<br />'. $this->Ini->Nm_lang['lang_track_ticket'] . "<b> ". $trackno . "</b><br /><br />";
...
$_SESSION['scriptcase']['form_customer_open_ticket_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['parms'] = "ticketmessageid?#?$this->ticketmessageid?@?ticketid?#?$this->ticketid?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$_SESSION['scriptcase']['form_customer_open_ticket_mob']['contr_erro'] = 'on';
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_customer_open_ticket_mob';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile_ticketfilename1] = $this->ticketfilename1;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile_ticketfilename2] = $this->ticketfilename2;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['download_filenames'][$sTmpFile_ticketfilename3] = $this->ticketfilename3;
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
        ...
        $this->initFormPages();
    include_once("form_customer_open_ticket_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_fld_priority()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['Lookup_fld_priority']))
{
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_customer_open_ticket_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_customer_open_ticket_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_open_ticket_mob']['ordem_ord'] == " desc") {
