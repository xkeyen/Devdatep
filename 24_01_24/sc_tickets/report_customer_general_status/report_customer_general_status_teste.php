<?php  
  ...
  session_start() ;
  class report_customer_general_status_form_teste
  {
  function report_customer_general_status_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_customer_general_status</FONT></B> 
<br> 
<br> 
...
<input type=submit value="report_customer_general_status"> 
</form> 
...
<?php
  ...
  $frm_teste = new report_customer_general_status_form_teste();
  $frm_teste->report_customer_general_status_teste();
?>
