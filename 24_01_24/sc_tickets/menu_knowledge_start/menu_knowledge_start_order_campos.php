...
<?php
   ...
   $Ord_Cmp = new menu_knowledge_start_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class menu_knowledge_start_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['topview'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['topview'] = "topview";
   }
   else
   {
       $tab_def_campos['topview'] = "";
   }
   $tab_labels["topview"]   = (isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['labels']["topview"])) ? $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['labels']["topview"] : "topview";
   $tab_ger_campos['lastarticles'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['lastarticles'] = "lastarticles";
   }
   else
   {
       $tab_def_campos['lastarticles'] = "";
   }
   $tab_labels["lastarticles"]   = (isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['labels']["lastarticles"])) ? $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['labels']["lastarticles"] : "lastarticles";
   $tab_ger_campos['topview'] = "none";
   $tab_ger_campos['lastarticles'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['menu_knowledge_start']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['menu_knowledge_start']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['menu_knowledge_start']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "menu_knowledge_start_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['menu_knowledge_start']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
