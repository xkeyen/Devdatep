...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_systemsettings/form_systemsettings_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_systemsettings_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_systemsettings_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_systemsettings']['error_buffer']) && '' != $_SESSION['scriptcase']['form_systemsettings']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_systemsettings']['error_buffer'];
}
...
<?php
 include_once("form_systemsettings_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_systemsettings_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_systemsettings_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_systemsettings_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_companyname_line" id="hidden_field_data_companyname" style="<?php echo $sStyleHidden_companyname; ?>"> <span class="scFormLabelOddFormat css_companyname_label" style=""><span id="id_label_companyname"><?php echo $this->nm_new_label['companyname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_assigmentmode_line" id="hidden_field_data_assigmentmode" style="<?php echo $sStyleHidden_assigmentmode; ?>"> <span class="scFormLabelOddFormat css_assigmentmode_label" style=""><span id="id_label_assigmentmode"><?php echo $this->nm_new_label['assigmentmode']; ?></span></span><br>
...
$assigmentmode_look = "";
 if ($this->assigmentmode == "Direct") { $assigmentmode_look .= "Direct" ;} 
 if ($this->assigmentmode == "Undirect") { $assigmentmode_look .= "Undirect" ;} 
 if (empty($assigmentmode_look)) { $assigmentmode_look = $this->assigmentmode; }
?>
...
$assigmentmode_look = "";
 ...
 if (empty($assigmentmode_look)) { $assigmentmode_look = $this->assigmentmode; }
?>
<span id="id_read_on_assigmentmode" class="css_assigmentmode_line"  style="<?php echo $sStyleReadLab_assigmentmode; ?>"><?php echo $this->form_format_readonly("assigmentmode", $this->form_encode_input($assigmentmode_look)); ?></span><span id="id_read_off_assigmentmode" class="css_read_off_assigmentmode<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_assigmentmode; ?>">
 <span id="idAjaxSelect_assigmentmode" class="<?php echo $this->classes_100perc_fields['span_select'] ?>"><select class="sc-js-input scFormObjectOdd css_assigmentmode_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_assigmentmode" name="assigmentmode" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="Direct" <?php  if ($this->assigmentmode == "Direct") { echo " selected" ;} ?>>Direct</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_assigmentmode'][] = 'Direct'; ?>
 <option  value="Undirect" <?php  if ($this->assigmentmode == "Undirect") { echo " selected" ;} ?>>Undirect</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_assigmentmode'][] = 'Undirect'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_publicticketsopening_line" id="hidden_field_data_publicticketsopening" style="<?php echo $sStyleHidden_publicticketsopening; ?>"> <span class="scFormLabelOddFormat css_publicticketsopening_label" style=""><span id="id_label_publicticketsopening"><?php echo $this->nm_new_label['publicticketsopening']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["publicticketsopening"]) &&  $this->nmgp_cmp_readonly["publicticketsopening"] == "on") { 
 ...
 if ("Y" == $this->publicticketsopening) { $publicticketsopening_look = "Yes";} 
 if ("N" == $this->publicticketsopening) { $publicticketsopening_look = "No";} 
?>
...
<?php
 ...
 if ("N" == $this->publicticketsopening) { $publicticketsopening_look = "No";} 
?>
<span id="id_read_on_publicticketsopening"  class="css_publicticketsopening_line" style="<?php echo $sStyleReadLab_publicticketsopening; ?>"><?php echo $this->form_format_readonly("publicticketsopening", $this->form_encode_input($publicticketsopening_look)); ?></span><span id="id_read_off_publicticketsopening" class="css_read_off_publicticketsopening css_publicticketsopening_line" style="<?php echo $sStyleReadInp_publicticketsopening; ?>"><div id="idAjaxRadio_publicticketsopening" style="display: inline-block"  class="css_publicticketsopening_line">
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_publicticketsopening_line"><?php $tempOptionId = "id-opt-publicticketsopening" . $sc_seq_vert . "-1"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-publicticketsopening sc-ui-radio-publicticketsopening" type=radio name="publicticketsopening" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_publicticketsopening'][] = 'Y'; ?>
<?php  if ("Y" == $this->publicticketsopening)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">Yes</label></TD>
</TR>
<TR>
  <TD class="scFormDataFontOdd css_publicticketsopening_line"><?php $tempOptionId = "id-opt-publicticketsopening" . $sc_seq_vert . "-2"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-publicticketsopening sc-ui-radio-publicticketsopening" type=radio name="publicticketsopening" value="N"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_publicticketsopening'][] = 'N'; ?>
<?php  if ("N" == $this->publicticketsopening)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">No</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
 </TD>
...
<input type="hidden" name="defaultpriority" value="<?php echo $this->form_encode_input($defaultpriority) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_defaultpriority_line" id="hidden_field_data_defaultpriority" style="<?php echo $sStyleHidden_defaultpriority; ?>"> <span class="scFormLabelOddFormat css_defaultpriority_label" style=""><span id="id_label_defaultpriority"><?php echo $this->nm_new_label['defaultpriority']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["defaultpriority"]) &&  $this->nmgp_cmp_readonly["defaultpriority"] == "on") { 
 ...
 ?>
<input type="hidden" name="defaultpriority" value="<?php echo $this->form_encode_input($defaultpriority) . "\">" . $defaultpriority . ""; ?>
<?php } else { ?>
<span id="id_read_on_defaultpriority" class="sc-ui-readonly-defaultpriority css_defaultpriority_line" style="<?php echo $sStyleReadLab_defaultpriority; ?>"><?php echo $this->form_format_readonly("defaultpriority", $this->form_encode_input($this->defaultpriority)); ?></span><span id="id_read_off_defaultpriority" class="css_read_off_defaultpriority<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_defaultpriority; ?>">
 <input class="sc-js-input scFormObjectOdd css_defaultpriority_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_defaultpriority" type=text name="defaultpriority" value="<?php echo $this->form_encode_input($defaultpriority) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=1"; } ?> alt="{datatype: 'integer', maxLength: 1, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['defaultpriority']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['defaultpriority']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['defaultpriority']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_urltrackingscreen_line" id="hidden_field_data_urltrackingscreen" style="<?php echo $sStyleHidden_urltrackingscreen; ?>"> <span class="scFormLabelOddFormat css_urltrackingscreen_label" style=""><span id="id_label_urltrackingscreen"><?php echo $this->nm_new_label['urltrackingscreen']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_urlconfirmationscreen_line" id="hidden_field_data_urlconfirmationscreen" style="<?php echo $sStyleHidden_urlconfirmationscreen; ?>"> <span class="scFormLabelOddFormat css_urlconfirmationscreen_label" style=""><span id="id_label_urlconfirmationscreen"><?php echo $this->nm_new_label['urlconfirmationscreen']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_broadcastmessages_line" id="hidden_field_data_broadcastmessages" style="<?php echo $sStyleHidden_broadcastmessages; ?>"> <span class="scFormLabelOddFormat css_broadcastmessages_label" style=""><span id="id_label_broadcastmessages"><?php echo $this->nm_new_label['broadcastmessages']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["broadcastmessages"]) &&  $this->nmgp_cmp_readonly["broadcastmessages"] == "on") { 
 ...
 if ("Y" == $this->broadcastmessages) { $broadcastmessages_look = "Yes";} 
?>
...
<?php
 ...
 if ("Y" == $this->broadcastmessages) { $broadcastmessages_look = "Yes";} 
?>
<span id="id_read_on_broadcastmessages"  class="css_broadcastmessages_line" style="<?php echo $sStyleReadLab_broadcastmessages; ?>"><?php echo $this->form_format_readonly("broadcastmessages", $this->form_encode_input($broadcastmessages_look)); ?></span><span id="id_read_off_broadcastmessages" class="css_read_off_broadcastmessages css_broadcastmessages_line" style="<?php echo $sStyleReadInp_broadcastmessages; ?>"><div id="idAjaxRadio_broadcastmessages" style="display: inline-block"  class="css_broadcastmessages_line">
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_broadcastmessages_line"><?php $tempOptionId = "id-opt-broadcastmessages" . $sc_seq_vert . "-1"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-broadcastmessages sc-ui-radio-broadcastmessages" type=radio name="broadcastmessages" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_broadcastmessages'][] = 'Y'; ?>
<?php  if ("Y" == $this->broadcastmessages)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">Yes</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
 </TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_defaultlanguage_line" id="hidden_field_data_defaultlanguage" style="<?php echo $sStyleHidden_defaultlanguage; ?>"> <span class="scFormLabelOddFormat css_defaultlanguage_label" style=""><span id="id_label_defaultlanguage"><?php echo $this->nm_new_label['defaultlanguage']; ?></span></span><br>
...
<?php $sStyleHidden_defaultlanguage_dumb = ('' == $sStyleHidden_defaultlanguage) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_defaultlanguage_dumb" style="<?php echo $sStyleHidden_defaultlanguage_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emailaccount_line" id="hidden_field_data_emailaccount" style="<?php echo $sStyleHidden_emailaccount; ?>"> <span class="scFormLabelOddFormat css_emailaccount_label" style=""><span id="id_label_emailaccount"><?php echo $this->nm_new_label['emailaccount']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtpserver_line" id="hidden_field_data_smtpserver" style="<?php echo $sStyleHidden_smtpserver; ?>"> <span class="scFormLabelOddFormat css_smtpserver_label" style=""><span id="id_label_smtpserver"><?php echo $this->nm_new_label['smtpserver']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtpuser_line" id="hidden_field_data_smtpuser" style="<?php echo $sStyleHidden_smtpuser; ?>"> <span class="scFormLabelOddFormat css_smtpuser_label" style=""><span id="id_label_smtpuser"><?php echo $this->nm_new_label['smtpuser']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtppassword_line" id="hidden_field_data_smtppassword" style="<?php echo $sStyleHidden_smtppassword; ?>"> <span class="scFormLabelOddFormat css_smtppassword_label" style=""><span id="id_label_smtppassword"><?php echo $this->nm_new_label['smtppassword']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_smtpsecurityflag_line" id="hidden_field_data_smtpsecurityflag" style="<?php echo $sStyleHidden_smtpsecurityflag; ?>"> <span class="scFormLabelOddFormat css_smtpsecurityflag_label" style=""><span id="id_label_smtpsecurityflag"><?php echo $this->nm_new_label['smtpsecurityflag']; ?></span></span><br>
...
$smtpsecurityflag_look = "";
 if ($this->smtpsecurityflag == "Y") { $smtpsecurityflag_look .= "" ;} 
 if (empty($smtpsecurityflag_look)) { $smtpsecurityflag_look = $this->smtpsecurityflag; }
?>
...
$smtpsecurityflag_look = "";
 ...
 if (empty($smtpsecurityflag_look)) { $smtpsecurityflag_look = $this->smtpsecurityflag; }
?>
<span id="id_read_on_smtpsecurityflag" class="css_smtpsecurityflag_line" style="<?php echo $sStyleReadLab_smtpsecurityflag; ?>"><?php echo $this->form_format_readonly("smtpsecurityflag", $this->form_encode_input($smtpsecurityflag_look)); ?></span><span id="id_read_off_smtpsecurityflag" class="css_read_off_smtpsecurityflag css_smtpsecurityflag_line" style="<?php echo $sStyleReadInp_smtpsecurityflag; ?>"><?php echo "<div id=\"idAjaxCheckbox_smtpsecurityflag\" style=\"display: inline-block\" class=\"css_smtpsecurityflag_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_smtpsecurityflag_line"><?php $tempOptionId = "id-opt-smtpsecurityflag" . $sc_seq_vert . "-1"; ?>
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-smtpsecurityflag sc-ui-checkbox-smtpsecurityflag" name="smtpsecurityflag[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['Lookup_smtpsecurityflag'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->smtpsecurityflag_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>"></label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtpport_line" id="hidden_field_data_smtpport" style="<?php echo $sStyleHidden_smtpport; ?>"> <span class="scFormLabelOddFormat css_smtpport_label" style=""><span id="id_label_smtpport"><?php echo $this->nm_new_label['smtpport']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_line" id="hidden_field_data_id" style="<?php echo $sStyleHidden_id; ?>"> <span class="scFormLabelOddFormat css_id_label" style=""><span id="id_label_id"><?php echo $this->nm_new_label['id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['php_cmp_required']['id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['php_cmp_required']['id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_systemsettings_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_systemsettings_mob");
 parent.scAjaxDetailHeight("form_systemsettings_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_systemsettings_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
