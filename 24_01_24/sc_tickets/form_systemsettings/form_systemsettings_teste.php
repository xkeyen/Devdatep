<?php  
  ...
  session_start() ;
  class form_systemsettings_form_teste
  {
   function form_systemsettings_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_systemsettings/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_systemsettings</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_systemsettings"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_systemsettings_form_teste();
  $frm_teste->form_systemsettings_teste();
?>
