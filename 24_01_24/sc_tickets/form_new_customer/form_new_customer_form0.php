...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_new_customer/form_new_customer_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_new_customer_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_new_customer_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['link_info']['remove_border']) {
...
<?php
 include_once("form_new_customer_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_new_customer.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_new_customer'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_new_customer'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_customername_label" id="hidden_field_label_customername" style="<?php echo $sStyleHidden_customername; ?>"><span id="id_label_customername"><?php echo $this->nm_new_label['customername']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customername']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customername'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_customeremail_label" id="hidden_field_label_customeremail" style="<?php echo $sStyleHidden_customeremail; ?>"><span id="id_label_customeremail"><?php echo $this->nm_new_label['customeremail']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customeremail']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customeremail'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_customerpassword_label" id="hidden_field_label_customerpassword" style="<?php echo $sStyleHidden_customerpassword; ?>"><span id="id_label_customerpassword"><?php echo $this->nm_new_label['customerpassword']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customerpassword']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['customerpassword'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_customerpassword_line" id="hidden_field_data_customerpassword" style="<?php echo $sStyleHidden_customerpassword; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fld_confirm_password_label" id="hidden_field_label_fld_confirm_password" style="<?php echo $sStyleHidden_fld_confirm_password; ?>"><span id="id_label_fld_confirm_password"><?php echo $this->nm_new_label['fld_confirm_password']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['fld_confirm_password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['php_cmp_required']['fld_confirm_password'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
function captchaReloadImage() {
 ...
 document.getElementById("id_captcha_img").src = "form_new_customer_captcha_show.php?sid=" + sRand;
}
</script>
<?php
if (true) {
...
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="form_new_customer_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_new_customer");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_new_customer");
 parent.scAjaxDetailHeight("form_new_customer", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_new_customer']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
