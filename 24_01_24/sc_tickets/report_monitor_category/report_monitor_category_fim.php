   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_monitor_category.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_category"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_monitor_category"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_category']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_category']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_monitor_category']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_monitor_category']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_monitor_category']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_monitor_category</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_monitor_category']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_monitor_category']['embutida_filho'] as $ind => $sc_init)
          {
