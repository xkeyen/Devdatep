...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_customer"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_customer"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_customer'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customer']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_customer']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customer']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_customer']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_customer']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_customer']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_customer']['embutida_filho'] as $ind => $sc_init)
          {
