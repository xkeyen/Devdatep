<?php
@session_start() ;
$_SESSION['scriptcase']['grid_customer']['sc_process_barr'] = true;
require_once('../grid_customer/index.php');
unset($_SESSION['scriptcase']['grid_customer']['sc_process_barr']);
$ExportCtrl = new grid_customer_export_control;
$ExportCtrl->Export_barr();

class grid_customer_export_control
{
