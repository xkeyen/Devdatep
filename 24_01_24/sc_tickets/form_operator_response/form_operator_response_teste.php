<?php  
  ...
  session_start() ;
  class form_operator_response_form_teste
  {
   function form_operator_response_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_operator_response/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_operator_response</FONT></B> 
<br> 
<br> 
...
v_staffid&nbsp;&nbsp;<input type="text" name="v_staffid" size=20><br> 
...
<input type="submit" value="form_operator_response"> 
</form> 
<script language=javascript> 
 document.Fedit.v_staffid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_operator_response_form_teste();
  $frm_teste->form_operator_response_teste();
?>
