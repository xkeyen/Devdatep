  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_ticket_rating_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_ticket_rating_mob_form();
	}
...
?>
  ...
  function do_ajax_control_ticket_rating_mob_validate_customerrating()
  {
    var nomeCampo_customerrating = "customerrating";
    var var_customerrating = scAjaxGetFieldText(nomeCampo_customerrating);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_ticket_rating_mob_validate_customerrating(var_customerrating, var_script_case_init, do_ajax_control_ticket_rating_mob_validate_customerrating_cb);
  } // do_ajax_control_ticket_rating_mob_validate_customerrating

  function do_ajax_control_ticket_rating_mob_validate_customerrating_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customerrating";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_ticket_rating_mob_validate_customerrating_cb

  // ---------- Validate customercomments
  function do_ajax_control_ticket_rating_mob_validate_customercomments()
  {
    var nomeCampo_customercomments = "customercomments";
    var var_customercomments = scAjaxGetFieldEditorHtml(nomeCampo_customercomments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_ticket_rating_mob_validate_customercomments(var_customercomments, var_script_case_init, do_ajax_control_ticket_rating_mob_validate_customercomments_cb);
  } // do_ajax_control_ticket_rating_mob_validate_customercomments

  function do_ajax_control_ticket_rating_mob_validate_customercomments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customercomments";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_ticket_rating_mob_validate_customercomments_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_ticket_rating_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_ticket_rating_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_customerrating = scAjaxGetFieldText("customerrating");
    var var_customercomments = scAjaxGetFieldEditorHtml("customercomments");
    ...
    scAjaxProcOn();
    x_ajax_control_ticket_rating_mob_submit_form(var_customerrating, var_customercomments, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_ticket_rating_mob_submit_form_cb);
  } // do_ajax_control_ticket_rating_mob_submit_form

  function do_ajax_control_ticket_rating_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_ticket_rating_mob_submit_form_cb_after_alert);
  } // do_ajax_control_ticket_rating_mob_submit_form_cb
  function do_ajax_control_ticket_rating_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_ticket_rating_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_ticket_rating_mob_navigate_form()
  {
    perform_ajax_control_ticket_rating_mob_navigate_form();
  }

  function perform_ajax_control_ticket_rating_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_ticket_rating_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_ticket_rating_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_ticket_rating_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_ticket_rating_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_ticket_rating_mob_navigate_form_cb
  function do_ajax_control_ticket_rating_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_ticket_rating_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_ticket_rating_mob_navigate_form_cb_after_alert

  function sc_hide_control_ticket_rating_mob_form()
  {
  ...
  ajax_field_list[0] = "customerrating";
  ajax_field_list[1] = "customercomments";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "customerrating": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "customercomments": {"label": "<?php echo $this->Ini->Nm_lang['lang_ticket_fild_customercomments'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "customerrating": new Array(),
    "customercomments": new Array()
  };
  ajax_field_mult["customerrating"][1] = "customerrating";
  ajax_field_mult["customercomments"][1] = "customercomments";

  var ajax_field_id = {
    "customerrating": new Array("hidden_field_label_customerrating", "hidden_field_data_customerrating"),
    "customercomments": new Array("hidden_field_label_customercomments", "hidden_field_data_customercomments")
  };

  var ajax_read_only = {
    "customerrating": "off",
    "customercomments": "off"
  };
