<?php
include_once('customer_menu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['customer_menu']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['customer_menu']['glo_nm_conexao']        = "conn_example";
    $_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class customer_menu_class
{
  var $Db;
 ...
 function customer_menu_menu()
 {
    global $customer_menu_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['customer_menu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "customer_menu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('customer_menu');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/customer_menu_erro.php");
}
include_once(dirname(__FILE__) . "/customer_menu_erro.class.php"); 
$this->Erro = new customer_menu_erro();
$str_path = substr($_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['customer_menu']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$customer_menu_menuData         = array();
$customer_menu_menuData['path'] = array();
$customer_menu_menuData['url']  = array();
$customer_menu_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $customer_menu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $customer_menu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $customer_menu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $customer_menu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$customer_menu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$customer_menu_menuData['url']['web']   = str_replace("\\", '/', $customer_menu_menuData['url']['web']);
$customer_menu_menuData['path']['root'] = substr($customer_menu_menuData['path']['sys'],  0, -1 * strlen($customer_menu_menuData['url']['web']));
$customer_menu_menuData['path']['app']  = substr($customer_menu_menuData['path']['sys'],  0, strrpos($customer_menu_menuData['path']['sys'],  '/'));
$customer_menu_menuData['path']['link'] = substr($customer_menu_menuData['path']['app'],  0, strrpos($customer_menu_menuData['path']['app'],  '/'));
$customer_menu_menuData['path']['link'] = substr($customer_menu_menuData['path']['link'], 0, strrpos($customer_menu_menuData['path']['link'], '/')) . '/';
$customer_menu_menuData['path']['app'] .= '/';
$customer_menu_menuData['url']['app']   = substr($customer_menu_menuData['url']['web'],  0, strrpos($customer_menu_menuData['url']['web'],  '/'));
$customer_menu_menuData['url']['link']  = substr($customer_menu_menuData['url']['app'],  0, strrpos($customer_menu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] == "S")
{
    $customer_menu_menuData['url']['link']  = substr($customer_menu_menuData['url']['link'], 0, strrpos($customer_menu_menuData['url']['link'], '/'));
}
$customer_menu_menuData['url']['link']  .= '/';
$customer_menu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['customer_menu']['sc_apl_link'] = $customer_menu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['customer_menu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['customer_menu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['customer_menu']['actual_lang']) || $_SESSION['scriptcase']['customer_menu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['customer_menu']['actual_lang'] = $this->str_lang;
...
include_once("customer_menu_toolbar.php");
...
if ($_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "customer_menu";
     $_SESSION['scriptcase']['menu_apls']['customer_menu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['customer_menu']['glo_nm_conexao']) && $_SESSION['scriptcase']['customer_menu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['customer_menu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['customer_menu']['glo_nm_perfil']) && $_SESSION['scriptcase']['customer_menu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['customer_menu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['customer_menu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['customer_menu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['customer_menu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['customer_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['customer_menu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['customer_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['customer_menu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['customer_menu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['customer_menu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['customer_menu']['init']))
{
    $_SESSION['sc_session'][1]['customer_menu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['customer_menu']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['customer_menu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_customer_menu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_customer_menu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_customer_menu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'customer_menu'))
{
    $_SESSION['sc_session'][1]['customer_menu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_customer_menu'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$customer_menu_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_customer_my_info_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/report_customer_my_info_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_customers_tickets_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_customers_tickets_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers_tickets']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_customer_open_ticket_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_customer_open_ticket_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_open_ticket']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_customer_edit_profile_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_customer_edit_profile_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_edit_profile']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/customer_login_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/customer_login_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['customer_login']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['customer_login'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
/* Elementos de menú */
$_SESSION['scriptcase']['customer_menu']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_v_module)) {$this->sc_temp_v_module = (isset($_SESSION['v_module'])) ? $_SESSION['v_module'] : "";}
 $this->sc_temp_v_module = 'subscriber';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_customer_menu'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']) == "on")
{
    $customer_menu_menuData['data'] .= "item_8|.|" . $this->Nm_lang['lang_customer_home'] . "|customer_menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=report_customer_my_info&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->customer_menu_target('_self') . "|" . "\n";
}
else
{
    $customer_menu_menuData['data'] .= "item_8|.|" . $this->Nm_lang['lang_customer_home'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers_tickets']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customers_tickets']) == "on")
{
    $customer_menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_customer_mytickets'] . "|customer_menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_customers_tickets&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->customer_menu_target('_self') . "|" . "\n";
}
else
{
    $customer_menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_customer_mytickets'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_open_ticket']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_customer_open_ticket']) == "on")
{
    $customer_menu_menuData['data'] .= "item_2|.|" . $this->Nm_lang['lang_customer_opentickets'] . "|customer_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_customer_open_ticket&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->customer_menu_target('_self') . "|" . "\n";
}
else
{
    $customer_menu_menuData['data'] .= "item_2|.|" . $this->Nm_lang['lang_customer_opentickets'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_edit_profile']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_customer_edit_profile']) == "on")
{
    $customer_menu_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_customer_editprofile'] . "|customer_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_customer_edit_profile&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->customer_menu_target('_self') . "|" . "\n";
}
else
{
    $customer_menu_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_customer_editprofile'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['customer_login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['customer_login']) == "on")
{
    $customer_menu_menuData['data'] .= "item_4|.|" . $this->Nm_lang['lang_customer_exit'] . "|customer_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=customer_login&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->customer_menu_target('_parent') . "|" . "\n";
}
else
{
    $customer_menu_menuData['data'] .= "item_4|.|" . $this->Nm_lang['lang_customer_exit'] . "||||_parent|disabled\n";
}
...
$customer_menu_menuData['data'] = array();
$str_disabled = "N";
$str_link = "customer_menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=report_customer_my_info&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $customer_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customer_home'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_8",
        ...
        'target'   => " item-target=\"" . $this->customer_menu_target('_self') . "\"",
        'sc_id'    => "item_8",
...
$str_disabled = "N";
$str_link = "customer_menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_customers_tickets&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers_tickets']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customers_tickets']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $customer_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customer_mytickets'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_1",
...
$str_disabled = "N";
$str_link = "customer_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_customer_open_ticket&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_open_ticket']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_customer_open_ticket']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $customer_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customer_opentickets'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_2",
...
$str_disabled = "N";
$str_link = "customer_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_customer_edit_profile&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_customer_edit_profile']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_customer_edit_profile']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $customer_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customer_editprofile'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_3",
...
$str_disabled = "N";
$str_link = "customer_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=customer_login&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['customer_login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['customer_login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $customer_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customer_exit'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_4",
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->customer_menu_target('_parent') . "\"",
        'sc_id'    => "item_4",
        'disabled' => $str_disabled,
        'display'     => "",
        'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['customer_menu']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['customer_menu']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'customer_menu');
    $customer_menu_menuData['data'] = $str_menu_usu;
}
if (is_file("customer_menu_help.txt"))
{
    $Arq_WebHelp = file("customer_menu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $customer_menu_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->customer_menu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['customer_menu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['customer_menu']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($customer_menu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['customer_menu']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($customer_menu_menuData['data'][$i_menu]);
       }
    ...
    $customer_menu_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['customer_menu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['customer_menu']))
{
    $disable_menu = false;
    foreach ($customer_menu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['customer_menu']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $customer_menu_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
{
    $_SESSION['scriptcase']['menu_mobile'] = "customer_menu";
    include('customer_menu_mobile.php');
    exit;
}
/* Cabecera HTML */
if ($customer_menu_menuData['iframe'])
{
    $customer_menu_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
...
{
    $customer_menu_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['customer_menu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="customer_menu_message.js"></script>
...
Iframe_atual = "customer_menu_iframe";
...
{
  if (str_id != "iframe_customer_menu")
  {
      str_id        = str_id.replace("customer_menu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_customer_menu', 'customer_menu');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_customer_menu').length)
        $('#iframe_customer_menu')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <div class="scMenuHHeaderFont" style="float: right;"><?php echo "" . $this->Nm_lang['lang_header_logged_user'] . " : <b>" . $_SESSION['v_customername'] . "</b>" ?></div>
</div>    </td>
  </tr>
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $customer_menu_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->customer_menu_escreveMenu($customer_menu_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $customer_menu_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info']) && $_SESSION['scriptcase']['sc_apl_seg']['report_customer_my_info'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_customer_menu');\" item-href=\"customer_menu_form_php.php?sc_item_menu=customer_menu&sc_apl_menu=report_customer_my_info&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . "\"  item-target=\"customer_menu_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "customer_menu_pag_ini.php");
} 
?>
      <iframe id="iframe_customer_menu" name="customer_menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_customer_menu').click()";
    echo "</script>";
}
...
/* Control de Target */
function customer_menu_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function customer_menu_target($str_target)
{
    global $customer_menu_menuData;
    ...
    elseif ($customer_menu_menuData['iframe'])
    {
        return 'customer_menu_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $customer_menu_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "customer_menu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "customer_menu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($customer_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['customer_menu']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->customer_menu_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['customer_menu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['customer_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "customer_menu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['customer_menu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['customer_menu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['customer_menu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_sc_tickets'])) {
            $_SESSION['scriptcase']['customer_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_sc_tickets'];
        }
    }
}
...
$contr_customer_menu = new customer_menu_class;
$contr_customer_menu->customer_menu_menu();
