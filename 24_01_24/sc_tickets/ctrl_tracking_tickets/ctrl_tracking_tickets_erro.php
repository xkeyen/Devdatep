...
$old_error_handler = set_error_handler("ctrl_tracking_tickets_scriptcase_error_handler");

function ctrl_tracking_tickets_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['ctrl_tracking_tickets']['contr_erro']) && $_SESSION['scriptcase']['ctrl_tracking_tickets']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ctrl_tracking_tickets->contr_ctrl_tracking_tickets->Apl_com_erro = true;
            if ($inicial_ctrl_tracking_tickets->contr_ctrl_tracking_tickets->NM_ajax_flag)
            {
                $inicial_ctrl_tracking_tickets->contr_ctrl_tracking_tickets->NM_ajax_info['errList']['geral_ctrl_tracking_tickets'][] = $msg;
                return;
            }
            ctrl_tracking_tickets_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ctrl_tracking_tickets_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ctrl_tracking_tickets'])  && '' != $_SESSION['scriptcase']['error_icon']['ctrl_tracking_tickets'])  ? $_SESSION['scriptcase']['error_icon']['ctrl_tracking_tickets']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ctrl_tracking_tickets']) && '' != $_SESSION['scriptcase']['error_span_title']['ctrl_tracking_tickets']) ? $_SESSION['scriptcase']['error_span_title']['ctrl_tracking_tickets'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ctrl_tracking_tickets']) && '' != $_SESSION['scriptcase']['error_icon_title']['ctrl_tracking_tickets']) ? $_SESSION['scriptcase']['error_icon_title']['ctrl_tracking_tickets'] : '';
?>
