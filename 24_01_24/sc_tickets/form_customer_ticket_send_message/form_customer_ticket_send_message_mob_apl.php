<?php
//
class form_customer_ticket_send_message_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_ticketid)) 
          {
              $_SESSION['v_ticketid'] = $this->v_ticketid;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_customer_ticket_send_message_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['upload_field_info']['ticketfile1'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_ticket_send_message_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['upload_field_info']['ticketfile2'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_ticket_send_message_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_customer_ticket_send_message_mob']['upload_field_info']['ticketfile3'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_customer_ticket_send_message_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_ticket_send_message_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_ticket_send_message_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_ticket_send_message_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_ticket_send_message_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_customer_ticket_send_message_mob') . "/form_customer_ticket_send_message_mob.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_ticket_send_message_mob']['label'] = "" . $this->Ini->Nm_lang['lang_header_open_ticket'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_customer_ticket_send_message_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_customer_ticket_send_message_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_customer_ticket_send_message_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_customer_ticket_send_message_mob.php"; 
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile1_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      elseif (isset($this->ticketfile1_ul_name) && '' != $this->ticketfile1_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name]))
          {
              $this->ticketfile1_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile1_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile2_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      elseif (isset($this->ticketfile2_ul_name) && '' != $this->ticketfile2_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name]))
          {
              $this->ticketfile2_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile2_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->NM_ajax_info['param']['ticketfile3_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      elseif (isset($this->ticketfile3_ul_name) && '' != $this->ticketfile3_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name]))
          {
              $this->ticketfile3_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_field_ul_name'][$this->ticketfile3_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_orig'] = " where (ticketID = " . $_SESSION['v_ticketid'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_pesq'] = " where (ticketID = " . $_SESSION['v_ticketid'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_ticket_send_message_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_ticket_send_message_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_ticket_send_message_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_customer_ticket_send_message_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_customer_ticket_send_message_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_customer_ticket_send_message_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_customer_ticket_send_message/form_customer_ticket_send_message_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_customer_ticket_send_message_mob_erro.class.php"); 
      }
      $this->Erro      = new form_customer_ticket_send_message_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao']))
         { 
             if ($this->ticketmessageid != "" || $this->ticketid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_ticket_send_message_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_customer_ticket_send_message_mob.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_customer_ticket_send_message_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_customer_ticket_send_message_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_customer_ticket_send_message_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_customer_ticket_send_message_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_customer_ticket_send_message_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_customer_ticket_send_message_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_customer_ticket_send_message_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_customer_ticket_send_message_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_ticketcontent(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['php_cmp_required']['ticketcontent']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['php_cmp_required']['ticketcontent'] == "on") 
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->ticketfile1 && "S" != $this->ticketfile1_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_customer_ticket_send_message_mob_doc_name.php';
                }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['ticketmessageid']['keyVal'] = form_customer_ticket_send_message_mob_pack_protect_string($this->nmgp_dados_form['ticketmessageid']);
              $this->NM_ajax_info['fldList']['ticketid']['keyVal'] = form_customer_ticket_send_message_mob_pack_protect_string($this->nmgp_dados_form['ticketid']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_customer_ticket_send_message_mob_pack_protect_string('Y') => str_replace('<', '&lt;',form_customer_ticket_send_message_mob_pack_protect_string(" ")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['Lookup_fld_close_ticket'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['fld_close_ticket']['valList'][$i] = form_customer_ticket_send_message_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_ticketid($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['contr_erro'] = 'on';
  $this->LoadSettings();
$this->LoadTicket();
$_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['contr_erro'] = 'off'; 
      }
...
$_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['ticketfile1_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['parms'] = "ticketmessageid?#?$this->ticketmessageid?@?ticketid?#?$this->ticketid?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] < $qt_geral_reg_form_customer_ticket_send_message_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao']   = '';
          }
      } 
...
$_SESSION['scriptcase']['form_customer_ticket_send_message_mob']['contr_erro'] = 'on';
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_customer_ticket_send_message_mob';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$ticketfilename3]))
       {
        ...
        $this->initFormPages();
    include_once("form_customer_ticket_send_message_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_customer_ticket_send_message_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_customer_ticket_send_message_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_ticket_send_message_mob']['ordem_ord'] == " desc") {
