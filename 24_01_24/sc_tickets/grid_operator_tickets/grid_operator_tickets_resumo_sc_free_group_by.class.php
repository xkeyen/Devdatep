...
class grid_operator_tickets_resumo
{
   ...
   var $array_total_ticketstatus_statusname;
   var $array_total_ticketpriority_priorityname;
   var $array_total_ticket_categoryid;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_ticketstatus_statusname     = array();
      $this->array_total_ticketpriority_priorityname = array();
      $this->array_total_ticket_categoryid           = array();
   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'ticketstatus.statusname' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] . "",
                    'datatype' => 'varchar',
                    'lowercase' => 'ticketstatus_statusname',
                    'summary_values_array' => 'array_total_ticketstatus_statusname',
                    'summary_line_values_array' => 'array_line_ticketstatus_statusname',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'ticketstatus_statusname',
                    'link_protect_string' => '@aspass@',
                    'has_order' => false,
                    'limit_chart_items' => '0',
                ],
                'ticketpriority.priorityname' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityname'] . "",
                    'datatype' => 'varchar',
                    'lowercase' => 'ticketpriority_priorityname',
                    'summary_values_array' => 'array_total_ticketpriority_priorityname',
                    'summary_line_values_array' => 'array_line_ticketpriority_priorityname',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'ticketpriority_priorityname',
                    'link_protect_string' => '@aspass@',
                    'has_order' => false,
                    'limit_chart_items' => '0',
                ],
                'ticket.categoryid' => [
                    'label' => "" . $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] . "",
                    'datatype' => 'int',
                    'lowercase' => 'ticket_categoryid',
                    'summary_values_array' => 'array_total_ticket_categoryid',
                    'summary_line_values_array' => 'array_line_ticket_categoryid',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'ticket_categoryid',
                    'link_protect_string' => '',
                    'has_order' => false,
                    'limit_chart_items' => '0',
                ],
            ...
            'dimension_by_lowercase' => [
                'ticketstatus_statusname' => 'ticketstatus.statusname',
                'ticketpriority_priorityname' => 'ticketpriority.priorityname',
                'ticket_categoryid' => 'ticket.categoryid',
            ],
            'metric_by_index' => [
            ],
            'chart' => [
    ...
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_x_axys'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_group_by'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_x_axys'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_y_axys'] = [];

            $dimensionCount = 0;

            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_x_axys'] [] = $dimensionCount;
            ...
            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_y_axys'] [] = $dimensionCount;

                $dimensionCount++;
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['dimension_order'] = [];
            foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
            }
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            $dimensionName = $this->SC_APP_info['dimension_by_lowercase'] [$dimensionNameLower];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_order_direction'] [$dimensionIndex];

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['summary_cache']);
        }
    }
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_operator_tickets/grid_operator_tickets.php";
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                grid_operator_tickets_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_operator_tickets_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_operator_tickets@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_operator_tickets'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_operator_tickets'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_operator_tickets'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_operator_tickets'] ['opcao']) {
            return true;
        }
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_operator_tickets']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_operator_tickets']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_ticketstatus_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticketstatus_statusname'];
                $this->array_line_ticketpriority_priorityname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticketpriority_priorityname'];
                $this->array_line_ticket_categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticket_categoryid'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_ticketstatus_statusname = array();
                $this->array_total_ticketpriority_priorityname = array();
                $this->array_total_ticket_categoryid = array();
                $this->totaliza();
                ...
                $this->array_line_ticketstatus_statusname = $this->array_total_ticketstatus_statusname;
                $this->array_line_ticketpriority_priorityname = $this->array_total_ticketpriority_priorityname;
                $this->array_line_ticket_categoryid = $this->array_total_ticket_categoryid;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_clear_total'] = true;
            }
          $this->array_total_ticketstatus_statusname = array();
          $this->array_total_ticketpriority_priorityname = array();
          $this->array_total_ticket_categoryid = array();
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total']['ticketstatus_statusname'] = $this->array_total_ticketstatus_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total']['ticketpriority_priorityname'] = $this->array_total_ticketpriority_priorityname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total']['ticket_categoryid'] = $this->array_total_ticket_categoryid;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticketstatus_statusname'] = $this->array_line_ticketstatus_statusname;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticketpriority_priorityname'] = $this->array_line_ticketpriority_priorityname;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total_line']['ticket_categoryid'] = $this->array_line_ticket_categoryid;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary() && !$this->aux_isExport()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['json_use_label'])
       {
          $Lab_ticketstatus_statusname = "ticketstatus.statusname";
          $Lab_ticketpriority_priorityname = "ticketpriority.priorityname";
          $Lab_ticket_categoryid = "ticket.categoryid";
       }
       else
       {
       $Lab_ticketstatus_statusname = "" . $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] . "";
       $Lab_ticketpriority_priorityname = "" . $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityname'] . "";
       $Lab_ticket_categoryid = "" . $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] . "";
       }
       $prep_field = array();
       $prep_field['ticketstatus_statusname'] = $Lab_ticketstatus_statusname;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketstatus_statusname'] = $Lab_ticketstatus_statusname; 
       $prep_field['ticketpriority_priorityname'] = $Lab_ticketpriority_priorityname;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketpriority_priorityname'] = $Lab_ticketpriority_priorityname; 
       $prep_field['ticket_categoryid'] = $Lab_ticket_categoryid;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_categoryid'] = $Lab_ticket_categoryid; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_tickettrack']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_tickettrack'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_tickettrack'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketlastupdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketlastupdate'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketlastupdate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customername']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customername'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_customerid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_categoryid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_categoryid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_categoryid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_subject']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_subject'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_subject'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketpriority_priorityicon']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketpriority_priorityicon'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketpriority_priorityname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketpriority_priorityname'] = "" . $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketstatus_statusicon']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketstatus_statusicon'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketstatus_statusname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticketstatus_statusname'] = "" . $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['link']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['link'] = " "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketid'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customeremail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customeremail'] = "" . $this->Ini->Nm_lang['lang_customer_fild_customeremail'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customerphone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['customer_customerphone'] = "" . $this->Ini->Nm_lang['lang_customer_fild_customerphone'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['staff_staffname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['staff_staffname'] = "" . $this->Ini->Nm_lang['lang_staff_fild_staffname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['staff_staffemail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['staff_staffemail'] = "" . $this->Ini->Nm_lang['lang_staff_fild_staffemail'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketdate'] = "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketdate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_statusid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_statusid'] = "StatusID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketpriorityid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ticketpriorityid'] = "TicketPriorityID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ownerid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['labels']['ticket_ownerid'] = "OwnerID"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['ticketstatus_statusname']['alin'] = "''";
       $Arr_parms['ticketstatus_statusname']['link'] = "S";
       $Arr_parms['ticketpriority_priorityname']['alin'] = "''";
       $Arr_parms['ticketpriority_priorityname']['link'] = "S";
       $Arr_parms['ticket_categoryid']['alin'] = "''";
       $Arr_parms['ticket_categoryid']['link'] = "S";
       $Arr_parms['ticketstatus_statusname']['fill'] = "true";
       $Arr_parms['ticketstatus_statusname']['order'] = "label";
       $Arr_parms['ticketstatus_statusname']['order_start'] = 'asc';
       $Arr_parms['ticketstatus_statusname']['order_invert'] = 'false';
       $Arr_parms['ticketstatus_statusname']['order_enabled'] = 'false';
       $Arr_parms['ticketstatus_statusname']['order_datatype'] = 'varchar';
       $Arr_parms['ticketstatus_statusname']['rating_function'] = '';
       $Arr_parms['ticketpriority_priorityname']['fill'] = "true";
       $Arr_parms['ticketpriority_priorityname']['order'] = "label";
       $Arr_parms['ticketpriority_priorityname']['order_start'] = 'asc';
       $Arr_parms['ticketpriority_priorityname']['order_invert'] = 'false';
       $Arr_parms['ticketpriority_priorityname']['order_enabled'] = 'false';
       $Arr_parms['ticketpriority_priorityname']['order_datatype'] = 'varchar';
       $Arr_parms['ticketpriority_priorityname']['rating_function'] = '';
       $Arr_parms['ticket_categoryid']['fill'] = "true";
       $Arr_parms['ticket_categoryid']['order'] = "label";
       $Arr_parms['ticket_categoryid']['order_start'] = 'asc';
       $Arr_parms['ticket_categoryid']['order_invert'] = 'false';
       $Arr_parms['ticket_categoryid']['order_enabled'] = 'false';
       $Arr_parms['ticket_categoryid']['order_datatype'] = 'int';
       $Arr_parms['ticket_categoryid']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['ticketstatus_statusname'] = array(0 => 'ticketstatus_statusname', 1 => '@aspass@');
       $prep_links_fl['ticketpriority_priorityname'] = array(0 => 'ticketpriority_priorityname', 1 => '@aspass@');
       $prep_links_fl['ticket_categoryid'] = array(0 => 'ticket_categoryid', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_operator_tickets@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'ticketstatus_statusname' => array(
           ),
           'ticketpriority_priorityname' => array(
           ),
           'ticket_categoryid' => array(
           ),
       );
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_operator_tickets_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_operator_tickets_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   {
      global $nm_saida;
      $res_sem_reg = "" . $this->Ini->Nm_lang['lang_error_no_tickets_operator'] . ""; 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_operator_tickets_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_orig'])) {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_orig']; 
          }
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_filtro'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq_filtro'] . ")"; 
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operator_tickets_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_operator_tickets_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operator_tickets_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['doc_word']) 
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,chart,resume&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_operator_tickets&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         if (is_file("grid_operator_tickets_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "", "", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          }
              $NM_btn = true;
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,chart,resume&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_operator_tickets&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_operator_tickets']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_operator_tickets']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_operator_tickets_config_pivot.php?nome_apl=grid_operator_tickets&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"grid_operator_tickets.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"grid_operator_tickets.php\"\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_operator_tickets_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" {\r\n");
      $nm_saida->saida("     document.FRES.action = \"grid_operator_tickets.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_operator_tickets_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_operator_tickets/grid_operator_tickets_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $ticket_tickettrack = (isset($Busca_temp['ticket_tickettrack'])) ? $Busca_temp['ticket_tickettrack'] : ""; 
          $tmp_pos = (is_string($ticket_tickettrack)) ? strpos($ticket_tickettrack, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticket_tickettrack))
          {
              $ticket_tickettrack = substr($ticket_tickettrack, 0, $tmp_pos);
          }
          $ticket_ticketpriorityid = (isset($Busca_temp['ticket_ticketpriorityid'])) ? $Busca_temp['ticket_ticketpriorityid'] : ""; 
          $tmp_pos = (is_string($ticket_ticketpriorityid)) ? strpos($ticket_ticketpriorityid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticket_ticketpriorityid))
          {
              $ticket_ticketpriorityid = substr($ticket_ticketpriorityid, 0, $tmp_pos);
          }
          $customer_customername = (isset($Busca_temp['customer_customername'])) ? $Busca_temp['customer_customername'] : ""; 
          $tmp_pos = (is_string($customer_customername)) ? strpos($customer_customername, "##@@") : false;
          if ($tmp_pos !== false && !is_array($customer_customername))
          {
              $customer_customername = substr($customer_customername, 0, $tmp_pos);
          }
          $ticket_categoryid = (isset($Busca_temp['ticket_categoryid'])) ? $Busca_temp['ticket_categoryid'] : ""; 
          $tmp_pos = (is_string($ticket_categoryid)) ? strpos($ticket_categoryid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticket_categoryid))
          {
              $ticket_categoryid = substr($ticket_categoryid, 0, $tmp_pos);
          }
          $ticket_ticketlastupdate = (isset($Busca_temp['ticket_ticketlastupdate'])) ? $Busca_temp['ticket_ticketlastupdate'] : ""; 
          $tmp_pos = (is_string($ticket_ticketlastupdate)) ? strpos($ticket_ticketlastupdate, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticket_ticketlastupdate))
          {
              $ticket_ticketlastupdate = substr($ticket_ticketlastupdate, 0, $tmp_pos);
          }
          $ticket_ticketlastupdate_2 = (isset($Busca_temp['ticket_ticketlastupdate_input_2'])) ? $Busca_temp['ticket_ticketlastupdate_input_2'] : ""; 
          $ticket_statusid = (isset($Busca_temp['ticket_statusid'])) ? $Busca_temp['ticket_statusid'] : ""; 
          $tmp_pos = (is_string($ticket_statusid)) ? strpos($ticket_statusid, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ticket_statusid))
          {
              $ticket_statusid = substr($ticket_statusid, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_ticketstatus_statusname, $quebra_ticketpriority_priorityname, $quebra_ticket_categoryid, $quebra_ticketstatus_statusname_orig, $quebra_ticketpriority_priorityname_orig, $quebra_ticket_categoryid_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_operator_tickets']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
            ...
            if (isset($contr_cmp_gb[1]))
            {
               ...
               foreach ($arr_name_1 as $cmp_name_1  => $dados_gb)
               {
                  ...
                  if (!empty($ind_missing)) {
                      ...
                      $arr_name_1[$cmp_name_1][$ind_missing][4] = $dados_gb[$ind_exists][4];
                  ...
                  if (isset($contr_cmp_gb[2]))
                  {
                     ...
                     foreach ($arr_name_2 as $cmp_name_2  => $dados_gb)
                     {
                        ...
                        if (!empty($ind_missing)) {
                            ...
                            $arr_name_2[$cmp_name_2][$ind_missing][5] = $dados_gb[$ind_exists][5];
                            $arr_name_2[$cmp_name_2][$ind_missing][6] = $dados_gb[$ind_exists][6];
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->ticket_tickettrack = $Busca_temp['ticket_tickettrack']; 
       $this->ticket_tickettrack = (isset($Busca_temp['ticket_tickettrack'])) ? $Busca_temp['ticket_tickettrack'] : ""; 
       $tmp_pos = (is_string($this->ticket_tickettrack)) ? strpos($this->ticket_tickettrack, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticket_tickettrack))
       {
       ...
       $this->ticket_ticketpriorityid = $Busca_temp['ticket_ticketpriorityid']; 
       $this->ticket_ticketpriorityid = (isset($Busca_temp['ticket_ticketpriorityid'])) ? $Busca_temp['ticket_ticketpriorityid'] : ""; 
       $tmp_pos = (is_string($this->ticket_ticketpriorityid)) ? strpos($this->ticket_ticketpriorityid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticket_ticketpriorityid))
       {
       ...
       $this->customer_customername = $Busca_temp['customer_customername']; 
       $this->customer_customername = (isset($Busca_temp['customer_customername'])) ? $Busca_temp['customer_customername'] : ""; 
       $tmp_pos = (is_string($this->customer_customername)) ? strpos($this->customer_customername, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->customer_customername))
       {
       ...
       $this->ticket_categoryid = $Busca_temp['ticket_categoryid']; 
       $this->ticket_categoryid = (isset($Busca_temp['ticket_categoryid'])) ? $Busca_temp['ticket_categoryid'] : ""; 
       $tmp_pos = (is_string($this->ticket_categoryid)) ? strpos($this->ticket_categoryid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticket_categoryid))
       {
       ...
       $this->ticket_ticketlastupdate = $Busca_temp['ticket_ticketlastupdate']; 
       $this->ticket_ticketlastupdate = (isset($Busca_temp['ticket_ticketlastupdate'])) ? $Busca_temp['ticket_ticketlastupdate'] : ""; 
       $tmp_pos = (is_string($this->ticket_ticketlastupdate)) ? strpos($this->ticket_ticketlastupdate, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticket_ticketlastupdate))
       {
       ...
       $ticket_ticketlastupdate_2 = (isset($Busca_temp['ticket_ticketlastupdate_input_2'])) ? $Busca_temp['ticket_ticketlastupdate_input_2'] : ""; 
       $this->ticket_ticketlastupdate_2 = $ticket_ticketlastupdate_2; 
       $this->ticket_statusid = $Busca_temp['ticket_statusid']; 
       $this->ticket_statusid = (isset($Busca_temp['ticket_statusid'])) ? $Busca_temp['ticket_statusid'] : ""; 
       $tmp_pos = (is_string($this->ticket_statusid)) ? strpos($this->ticket_statusid, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ticket_statusid))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ticket_tickettrack = $rs_res->fields[0] ;  
            $this->ticket_ticketlastupdate = $rs_res->fields[1] ;  
            $this->customer_customername = $rs_res->fields[2] ;  
            $this->ticket_categoryid = $rs_res->fields[3] ;  
            $this->ticket_subject = $rs_res->fields[4] ;  
            $this->ticketpriority_priorityicon = $rs_res->fields[5] ;  
            $this->ticketpriority_priorityname = $rs_res->fields[6] ;  
            $this->ticketstatus_statusicon = $rs_res->fields[7] ;  
            $this->ticketstatus_statusname = $rs_res->fields[8] ;  
            $this->ticket_ticketid = $rs_res->fields[9] ;  
            $this->ticketstatus_statusname_orig = $this->ticketstatus_statusname;
            $this->ticketpriority_priorityname_orig = $this->ticketpriority_priorityname;
            $this->ticket_categoryid_orig = $this->ticket_categoryid;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ticketstatus_statusname, $this->ticketpriority_priorityname, $this->ticket_categoryid, $this->ticketstatus_statusname_orig,  $this->ticketpriority_priorityname_orig,  $this->ticket_categoryid_orig);
            }
   }
//
