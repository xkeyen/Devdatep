...
function ajax_delete_filter(parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "grid_ticketmessage_show.php",
...
Table_sv_fil[0] = "ticketmessageid";
Table_sv_fil[1] = "ticketid";
Table_sv_fil[2] = "ticketdate";
Table_sv_fil[3] = "ticketcontent";
Table_sv_fil[4] = "ticketfile1";
Table_sv_fil[5] = "ticketfile2";
Table_sv_fil[6] = "ticketfile3";
