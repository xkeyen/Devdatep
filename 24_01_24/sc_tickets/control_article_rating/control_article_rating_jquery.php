...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_votes' + iSeqRow).bind('blur', function() { sc_control_article_rating_votes_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_control_article_rating_votes_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_thanks' + iSeqRow).bind('blur', function() { sc_control_article_rating_thanks_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_control_article_rating_thanks_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_subject' + iSeqRow).bind('blur', function() { sc_control_article_rating_subject_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_control_article_rating_subject_onchange(this, iSeqRow) })
...
function sc_control_article_rating_votes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_article_rating_thanks_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_article_rating_subject_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_control_article_rating_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_article_rating')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
