<?php  
  ...
  session_start() ;
  class control_article_rating_form_teste
  {
   function control_article_rating_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_article_rating/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_article_rating</FONT></B> 
<br> 
<br> 
...
v_articleid&nbsp;&nbsp;<input type="text" name="v_articleid" size=20><br> 
v_articlesubject&nbsp;&nbsp;<input type="text" name="v_articlesubject" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="control_article_rating"> 
</form> 
<script language=javascript> 
 document.Fedit.v_articleid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new control_article_rating_form_teste();
  $frm_teste->control_article_rating_teste();
?>
