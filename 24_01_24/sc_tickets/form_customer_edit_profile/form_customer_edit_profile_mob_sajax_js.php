  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_edit_profile_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_edit_profile_mob_form();
	}
...
?>
  ...
  function do_ajax_form_customer_edit_profile_mob_validate_customername()
  {
    var nomeCampo_customername = "customername";
    var var_customername = scAjaxGetFieldText(nomeCampo_customername);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_customername(var_customername, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_customername_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_customername

  function do_ajax_form_customer_edit_profile_mob_validate_customername_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_customername_cb

  // ---------- Validate customeremail
  function do_ajax_form_customer_edit_profile_mob_validate_customeremail()
  {
    var nomeCampo_customeremail = "customeremail";
    var var_customeremail = scAjaxGetFieldText(nomeCampo_customeremail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_customeremail(var_customeremail, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_customeremail_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_customeremail

  function do_ajax_form_customer_edit_profile_mob_validate_customeremail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_customeremail_cb

  // ---------- Validate customerphone
  function do_ajax_form_customer_edit_profile_mob_validate_customerphone()
  {
    var nomeCampo_customerphone = "customerphone";
    var var_customerphone = scAjaxGetFieldText(nomeCampo_customerphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_customerphone(var_customerphone, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_customerphone_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_customerphone

  function do_ajax_form_customer_edit_profile_mob_validate_customerphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_customerphone_cb

  // ---------- Validate fld_new_password
  function do_ajax_form_customer_edit_profile_mob_validate_fld_new_password()
  {
    var nomeCampo_fld_new_password = "fld_new_password";
    var var_fld_new_password = scAjaxGetFieldText(nomeCampo_fld_new_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_fld_new_password(var_fld_new_password, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_fld_new_password_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_new_password

  function do_ajax_form_customer_edit_profile_mob_validate_fld_new_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_new_password_cb

  // ---------- Validate fld_confirm_password
  function do_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password(var_fld_confirm_password, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password

  function do_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_confirm_password_cb

  // ---------- Validate fld_to_change_password
  function do_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password(var_fld_to_change_password, var_script_case_init, do_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password_cb);
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password

  function do_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_edit_profile_mob_validate_fld_to_change_password_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_edit_profile_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_edit_profile_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_customerid = scAjaxGetFieldText("customerid");
    ...
    scAjaxProcOn();
    x_ajax_form_customer_edit_profile_mob_submit_form(var_customername, var_customeremail, var_customerphone, var_fld_new_password, var_fld_confirm_password, var_fld_to_change_password, var_customerid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_edit_profile_mob_submit_form_cb);
  } // do_ajax_form_customer_edit_profile_mob_submit_form

  function do_ajax_form_customer_edit_profile_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_edit_profile_mob_submit_form_cb_after_alert);
  } // do_ajax_form_customer_edit_profile_mob_submit_form_cb
  function do_ajax_form_customer_edit_profile_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_edit_profile_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_edit_profile_mob_navigate_form()
  {
    perform_ajax_form_customer_edit_profile_mob_navigate_form();
  }

  function perform_ajax_form_customer_edit_profile_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_edit_profile_mob_navigate_form(var_customerid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_edit_profile_mob_navigate_form_cb);
  } // do_ajax_form_customer_edit_profile_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_edit_profile_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_edit_profile_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_edit_profile_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_edit_profile_mob_navigate_form_cb
  function do_ajax_form_customer_edit_profile_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_customer_edit_profile_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_edit_profile_mob_navigate_form_cb_after_alert

  function sc_hide_form_customer_edit_profile_mob_form()
  {
