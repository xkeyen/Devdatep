  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_staff" == sTestField)
        {
...
?>
  ...
  // ---------- Validate staffid
  function do_ajax_form_staff_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldHidden(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_staff_validate_staffid_cb);
  } // do_ajax_form_staff_validate_staffid

  function do_ajax_form_staff_validate_staffid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staffid_cb

  // ---------- Validate staffname
  function do_ajax_form_staff_validate_staffname()
  {
    var nomeCampo_staffname = "staffname";
    var var_staffname = scAjaxGetFieldText(nomeCampo_staffname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staffname(var_staffname, var_script_case_init, do_ajax_form_staff_validate_staffname_cb);
  } // do_ajax_form_staff_validate_staffname

  function do_ajax_form_staff_validate_staffname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staffname_cb

  // ---------- Validate staffemail
  function do_ajax_form_staff_validate_staffemail()
  {
    var nomeCampo_staffemail = "staffemail";
    var var_staffemail = scAjaxGetFieldText(nomeCampo_staffemail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staffemail(var_staffemail, var_script_case_init, do_ajax_form_staff_validate_staffemail_cb);
  } // do_ajax_form_staff_validate_staffemail

  function do_ajax_form_staff_validate_staffemail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staffemail_cb

  // ---------- Validate adminflag
  function do_ajax_form_staff_validate_adminflag()
  {
    var nomeCampo_adminflag = "adminflag";
    var var_adminflag = scAjaxGetFieldRadio(nomeCampo_adminflag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_adminflag(var_adminflag, var_script_case_init, do_ajax_form_staff_validate_adminflag_cb);
  } // do_ajax_form_staff_validate_adminflag

  function do_ajax_form_staff_validate_adminflag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_adminflag_cb

  // ---------- Validate categories
  function do_ajax_form_staff_validate_categories()
  {
    var nomeCampo_categories = "categories";
    var var_categories = scAjaxGetFieldCheckbox(nomeCampo_categories, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_categories(var_categories, var_script_case_init, do_ajax_form_staff_validate_categories_cb);
  } // do_ajax_form_staff_validate_categories

  function do_ajax_form_staff_validate_categories_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_categories_cb

  // ---------- Validate signature
  function do_ajax_form_staff_validate_signature()
  {
    var nomeCampo_signature = "signature";
    var var_signature = scAjaxGetFieldEditorHtml(nomeCampo_signature);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_signature(var_signature, var_script_case_init, do_ajax_form_staff_validate_signature_cb);
  } // do_ajax_form_staff_validate_signature

  function do_ajax_form_staff_validate_signature_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_signature_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_staff_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_staff_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_staff_submit_form(var_staffid, var_staffname, var_staffemail, var_adminflag, var_categories, var_signature, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_submit_form_cb);
  } // do_ajax_form_staff_submit_form

  function do_ajax_form_staff_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_staff_submit_form_cb_after_alert);
  } // do_ajax_form_staff_submit_form_cb
  function do_ajax_form_staff_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_staff_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_staff_navigate_form()
  {
    perform_ajax_form_staff_navigate_form();
  }

  function perform_ajax_form_staff_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_staff_navigate_form(var_staffid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_navigate_form_cb);
  } // do_ajax_form_staff_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_staff_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_staff_navigate_form_cb_after_alert);
  } // do_ajax_form_staff_navigate_form_cb
  function do_ajax_form_staff_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_staff_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_staff_navigate_form_cb_after_alert

  function sc_hide_form_staff_form()
  {
