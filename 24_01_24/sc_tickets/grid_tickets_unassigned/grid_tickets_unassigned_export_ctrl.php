<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tickets_unassigned']['sc_process_barr'] = true;
require_once('../grid_tickets_unassigned/index.php');
unset($_SESSION['scriptcase']['grid_tickets_unassigned']['sc_process_barr']);
$ExportCtrl = new grid_tickets_unassigned_export_control;
$ExportCtrl->Export_barr();

class grid_tickets_unassigned_export_control
{
