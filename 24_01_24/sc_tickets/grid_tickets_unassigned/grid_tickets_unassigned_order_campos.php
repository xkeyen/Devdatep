<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tickets_unassigned']['glo_nm_path_imag_temp'] . "/sc_apl_default_sc_tickets.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tickets_unassigned_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tickets_unassigned_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ticket_tickettrack"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_tickettrack"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_tickettrack"] : "" . $this->Nm_lang['lang_ticket_fild_tickettrack'] . "";
   ...
   $tab_labels["ticket_ticketdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_ticketdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_ticketdate"] : "" . $this->Nm_lang['lang_ticket_fild_ticketdate'] . "";
   $tab_ger_campos['ticket_customerid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_customerid'] = "ticket_customerid";
   }
   else
   {
       $tab_def_campos['ticket_customerid'] = "ticket.customerid";
   }
   $tab_labels["ticket_customerid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_customerid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_customerid"] : "" . $this->Nm_lang['lang_ticket_fild_customerid'] . "";
   ...
   $tab_labels["ticket_categoryid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_categoryid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_categoryid"] : "" . $this->Nm_lang['lang_ticket_fild_categoryid'] . "";
   ...
   $tab_labels["ticket_subject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_subject"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_subject"] : "" . $this->Nm_lang['lang_ticket_fild_subject'] . "";
   ...
   $tab_labels["ticketpriority_priorityicon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticketpriority_priorityicon"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticketpriority_priorityicon"] : "";
   $tab_ger_campos['ticketpriority_ticketpriorityid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticketpriority_ticketpriorityid'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['ticketpriority_ticketpriorityid'] = "ticketpriority.ticketpriorityid";
   }
   $tab_labels["ticketpriority_ticketpriorityid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticketpriority_ticketpriorityid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticketpriority_ticketpriorityid"] : "" . $this->Nm_lang['lang_ticket_fild_ticketpriorityid'] . "";
   $tab_ger_campos['ticket_assign'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ticket_assign'] = "ticket_assign";
   }
   else
   {
       $tab_def_campos['ticket_assign'] = "";
   }
   $tab_labels["ticket_assign"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_assign"])) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['labels']["ticket_assign"] : " ";
   $tab_ger_campos['ticketpriority_priorityicon'] = "none";
   $tab_ger_campos['ticket_assign'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_staff_ticketsunassigned'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tickets_unassigned_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tickets_unassigned']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
