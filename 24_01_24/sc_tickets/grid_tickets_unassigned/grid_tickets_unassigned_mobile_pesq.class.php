...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticketpriority_ticketpriorityid"  <?php echo $str_hide_ticketpriority_ticketpriorityid?>>
<?php
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ticket_ticketid_cond" name="ticket_ticketid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticket_ticketid'), this, 'ticket_ticketid')">
      ...
      <br><span id="id_hide_ticket_ticketid"  <?php echo $str_hide_ticket_ticketid?>><INPUT  type="text" id="SC_ticket_ticketid" name="ticket_ticketid" value="<?php echo NM_encode_input($ticket_ticketid) ?>" size=4 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
