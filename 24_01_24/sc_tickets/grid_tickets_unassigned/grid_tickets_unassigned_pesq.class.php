...
class grid_tickets_unassigned_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_tickets_unassigned.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_staff_ticketsunassigned'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tickets_unassigned/grid_tickets_unassigned_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_tickets_unassigned_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tickets_unassigned_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tickets_unassigned_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tickets_unassigned']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tickets_unassigned']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_tickets_unassigned.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $ticketpriority_ticketpriorityid_cond, $ticketpriority_ticketpriorityid,
             $ticket_ticketid_cond, $ticket_ticketid,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticketpriority_ticketpriorityid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticketpriority_ticketpriorityid']; 
          $ticketpriority_ticketpriorityid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticketpriority_ticketpriorityid_cond']; 
          $ticket_ticketid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticket_ticketid']; 
          $ticket_ticketid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticket_ticketid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['NM_operador']; 
          if (strtoupper($ticket_ticketid_cond) != "II" && strtoupper($ticket_ticketid_cond) != "QP" && strtoupper($ticket_ticketid_cond) != "NP" && strtoupper($ticket_ticketid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ticket_ticketid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      if (!isset($ticketpriority_ticketpriorityid_cond) || empty($ticketpriority_ticketpriorityid_cond))
      {
         $ticketpriority_ticketpriorityid_cond = "eq";
      }
      if (!isset($ticket_ticketid_cond) || empty($ticket_ticketid_cond))
      {
         $ticket_ticketid_cond = "eq";
      }
      if (!isset($ticket_ticketdate_cond) || empty($ticket_ticketdate_cond))
      {
         $ticket_ticketdate_cond = "bi_TP";
      }
      ...
      $str_hide_ticketpriority_ticketpriorityid = (in_array($ticketpriority_ticketpriorityid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ticket_ticketid = (in_array($ticket_ticketid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($ticketpriority_ticketpriorityid) || $ticketpriority_ticketpriorityid == "")
      {
          $ticketpriority_ticketpriorityid = "";
      }
      if (isset($ticketpriority_ticketpriorityid) && !empty($ticketpriority_ticketpriorityid))
      {
         $tmp_pos = (is_string($ticketpriority_ticketpriorityid)) ? strpos($ticketpriority_ticketpriorityid, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ticketpriority_ticketpriorityid = substr($ticketpriority_ticketpriorityid, 0, $tmp_pos);
         }
      }
      if (!isset($ticket_ticketid) || $ticket_ticketid == "")
      {
          $ticket_ticketid = "";
      }
      if (isset($ticket_ticketid) && !empty($ticket_ticketid))
      {
         $tmp_pos = (is_string($ticket_ticketid)) ? strpos($ticket_ticketid, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ticket_ticketid = substr($ticket_ticketid, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_ticketpriority_ticketpriorityid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ticketpriority_ticketpriorityid'])) ? $this->New_label['ticketpriority_ticketpriorityid'] : "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketpriorityid'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_ticketpriority_ticketpriorityid_cond" name="ticketpriority_ticketpriorityid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticketpriority_ticketpriorityid" <?php echo $str_hide_ticketpriority_ticketpriorityid?> valign="top">
 ...
 $nmgp_tab_label .= "ticketpriority_ticketpriorityid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      $ticketpriority_ticketpriorityid_look = (is_string($ticketpriority_ticketpriorityid) ? substr($this->Db->qstr($ticketpriority_ticketpriorityid), 1, -1) : $ticketpriority_ticketpriorityid); 
      $nmgp_def_dados = "" ; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['psq_check_ret']['ticketpriority_ticketpriorityid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['psq_check_ret']['ticketpriority_ticketpriorityid'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_ticketpriority_ticketpriorityid">
      <SELECT class="scFilterObjectOdd" id="SC_ticketpriority_ticketpriorityid" name="ticketpriority_ticketpriorityid"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $ticketpriority_ticketpriorityid)
            {
                    $ticketpriority_ticketpriorityid_sel = ($nm_opc_cod === $ticketpriority_ticketpriorityid) ? "selected" : "";
            }
            else
            {
               $ticketpriority_ticketpriorityid_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $ticketpriority_ticketpriorityid_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_ticket_ticketid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ticket_ticketid'])) ? $this->New_label['ticket_ticketid'] : "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ticket_ticketid_cond" name="ticket_ticketid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticket_ticketid'), this, 'ticket_ticketid')">
       <OPTION value="eq" <?php if ("eq" == $ticket_ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $ticket_ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $ticket_ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $ticket_ticketid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticket_ticketid" <?php echo $str_hide_ticket_ticketid?> valign="top">
 ...
 $nmgp_tab_label .= "ticket_ticketid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_ticket_ticketid" name="ticket_ticketid" value="<?php echo NM_encode_input($ticket_ticketid) ?>" size=4 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("grid_tickets_unassigned_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tickets_unassigned']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tickets_unassigned']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_tickets_unassigned.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "grid_tickets_unassigned.php"; 
 ...
 {
   document.F1.reset();
   document.F1.ticketpriority_ticketpriorityid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ticketpriority_ticketpriorityid'), document.F1.ticketpriority_ticketpriorityid_cond, 'ticketpriority_ticketpriorityid');
   document.F1.ticketpriority_ticketpriorityid.value = "";
   document.F1.ticket_ticketid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ticket_ticketid'), document.F1.ticket_ticketid_cond, 'ticket_ticketid');
   document.F1.ticket_ticketid.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   {
      global $ticketpriority_ticketpriorityid_cond, $ticketpriority_ticketpriorityid,
             $ticket_ticketid_cond, $ticket_ticketid, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $ticketpriority_ticketpriorityid_cond_salva = $ticketpriority_ticketpriorityid_cond; 
      if (!isset($ticketpriority_ticketpriorityid_input_2) || $ticketpriority_ticketpriorityid_input_2 == "")
      {
          $ticketpriority_ticketpriorityid_input_2 = $ticketpriority_ticketpriorityid;
      }
      $ticket_ticketid_cond_salva = $ticket_ticketid_cond; 
      if (!isset($ticket_ticketid_input_2) || $ticket_ticketid_input_2 == "")
      {
          $ticket_ticketid_input_2 = $ticket_ticketid;
      }
      $tmp_pos = (is_string($ticketpriority_ticketpriorityid)) ? strpos($ticketpriority_ticketpriorityid, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $ticketpriority_ticketpriorityid;
      }
      else {
          $L_lookup = substr($ticketpriority_ticketpriorityid, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['psq_check_ret']['ticketpriority_ticketpriorityid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_ticket_fild_ticketpriorityid'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if ($ticket_ticketid_cond != "in")
      {
          nm_limpa_numero($ticket_ticketid, ".") ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticketpriority_ticketpriorityid'] = $ticketpriority_ticketpriorityid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticketpriority_ticketpriorityid_cond'] = $ticketpriority_ticketpriorityid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticket_ticketid'] = $ticket_ticketid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['ticket_ticketid_cond'] = $ticket_ticketid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $ticketpriority_ticketpriorityid;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['ticketpriority_ticketpriorityid'] = $Conteudo;
      $Conteudo = $ticket_ticketid;
      if (strtoupper($ticket_ticketid_cond) != "II" && strtoupper($ticket_ticketid_cond) != "QP" && strtoupper($ticket_ticketid_cond) != "NP" && strtoupper($ticket_ticketid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['ticket_ticketid'] = $Conteudo;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($ticketpriority_ticketpriorityid))
      {
         $this->monta_condicao("ticketpriority.ticketpriorityid", $ticketpriority_ticketpriorityid_cond, $ticketpriority_ticketpriorityid, "", "ticketpriority_ticketpriorityid", "VARCHAR", false);
      }

      //----- $ticket_ticketid
      $this->Date_part = false;
      if (isset($ticket_ticketid) || $ticket_ticketid_cond == "nu" || $ticket_ticketid_cond == "nn" || $ticket_ticketid_cond == "ep" || $ticket_ticketid_cond == "ne")
      {
         $this->monta_condicao("ticket.ticketid", $ticket_ticketid_cond, $ticket_ticketid, "", "ticket_ticketid", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_unassigned']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "ticketpriority_ticketpriorityid" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
