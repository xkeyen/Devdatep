<?php  
  ...
  session_start() ;
  class report_customer_general_categories_form_teste
  {
  function report_customer_general_categories_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_customer_general_categories</FONT></B> 
<br> 
<br> 
...
<input type=submit value="report_customer_general_categories"> 
</form> 
<script language=javascript> 
 document.FCons.v_customerid.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new report_customer_general_categories_form_teste();
  $frm_teste->report_customer_general_categories_teste();
?>
