...
$old_error_handler = set_error_handler("ctrl_confirm_acount_creation_mob_scriptcase_error_handler");

function ctrl_confirm_acount_creation_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['ctrl_confirm_acount_creation_mob']['contr_erro']) && $_SESSION['scriptcase']['ctrl_confirm_acount_creation_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ctrl_confirm_acount_creation_mob->contr_ctrl_confirm_acount_creation_mob->Apl_com_erro = true;
            if ($inicial_ctrl_confirm_acount_creation_mob->contr_ctrl_confirm_acount_creation_mob->NM_ajax_flag)
            {
                $inicial_ctrl_confirm_acount_creation_mob->contr_ctrl_confirm_acount_creation_mob->NM_ajax_info['errList']['geral_ctrl_confirm_acount_creation_mob'][] = $msg;
                return;
            }
            ctrl_confirm_acount_creation_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ctrl_confirm_acount_creation_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation_mob'])  ? $_SESSION['scriptcase']['error_icon']['ctrl_confirm_acount_creation_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation_mob']) ? $_SESSION['scriptcase']['error_span_title']['ctrl_confirm_acount_creation_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation_mob']) ? $_SESSION['scriptcase']['error_icon_title']['ctrl_confirm_acount_creation_mob'] : '';
?>
