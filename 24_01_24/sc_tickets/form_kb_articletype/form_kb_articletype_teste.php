<?php  
  ...
  session_start() ;
  class form_kb_articletype_form_teste
  {
   function form_kb_articletype_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_kb_articletype/img";
...
<?php
  ...
  $frm_teste = new form_kb_articletype_form_teste();
  $frm_teste->form_kb_articletype_teste();
?>
