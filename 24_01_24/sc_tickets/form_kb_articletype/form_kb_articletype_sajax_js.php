  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kb_articletype" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_kb_articletype_form();
	}
...
?>
  ...
  // ---------- Validate articletypeid_
  function do_ajax_form_kb_articletype_validate_articletypeid_(iNumLinha)
  {
    var nomeCampo_articletypeid_ = "articletypeid_" + iNumLinha;
    var var_articletypeid_ = scAjaxGetFieldText(nomeCampo_articletypeid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articletype_validate_articletypeid_(var_articletypeid_, iNumLinha, var_script_case_init, do_ajax_form_kb_articletype_validate_articletypeid__cb);
  } // do_ajax_form_kb_articletype_validate_articletypeid_

  function do_ajax_form_kb_articletype_validate_articletypeid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "articletypeid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "articletypeid_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articletype_validate_articletypeid__cb

  // ---------- Validate articletypename_
  function do_ajax_form_kb_articletype_validate_articletypename_(iNumLinha)
  {
    var nomeCampo_articletypename_ = "articletypename_" + iNumLinha;
    var var_articletypename_ = scAjaxGetFieldText(nomeCampo_articletypename_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articletype_validate_articletypename_(var_articletypename_, iNumLinha, var_script_case_init, do_ajax_form_kb_articletype_validate_articletypename__cb);
  } // do_ajax_form_kb_articletype_validate_articletypename_

  function do_ajax_form_kb_articletype_validate_articletypename__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "articletypename_" + iLineNumber;
    }
    else
    {
      sFieldValid = "articletypename_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kb_articletype_validate_articletypename__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_kb_articletype_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_kb_articletype_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_kb_articletype_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_kb_articletype_add_new_line_cb);
  } // do_ajax_form_kb_articletype_add_new_line

  function do_ajax_form_kb_articletype_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_kb_articletype_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_kb_articletype_backup_line(iNumLinha)
  {
    var var_articletypeid_ = scAjaxGetFieldText("articletypeid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kb_articletype_backup_line(var_articletypeid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_kb_articletype_backup_line_cb);
  } // do_ajax_form_kb_articletype_backup_line

  function do_ajax_form_kb_articletype_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_kb_articletype_backup_line_cb

  function do_ajax_form_kb_articletype_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_kb_articletype_cancel_insert

  function do_ajax_form_kb_articletype_cancel_update(iSeqVert)
  {
    do_ajax_form_kb_articletype_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_kb_articletype_cancel_update

  function do_ajax_form_kb_articletype_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_kb_articletype_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_kb_articletype_table_refresh()
  {
    var var_articletypeid_ = document.F2.articletypeid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_kb_articletype_table_refresh(var_articletypeid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kb_articletype_table_refresh_cb);
  } //  do_ajax_form_kb_articletype_table_refresh

  function do_ajax_form_kb_articletype_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.articletypeid_.value = scAjaxGetKeyValue("articletypeid_");
    ...
    scAjaxAlert(do_ajax_form_kb_articletype_table_refresh_cb_after_alert);
  } // do_ajax_form_kb_articletype_table_refresh_cb
  function do_ajax_form_kb_articletype_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_kb_articletype_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_kb_articletype_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_kb_articletype_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_articletypeid_ = scAjaxGetFieldText("articletypeid_" + iNumLinha);
    var var_articletypename_ = scAjaxGetFieldText("articletypename_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_kb_articletype_submit_form(var_articletypeid_, var_articletypename_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_kb_articletype_submit_form_cb);
  } // do_ajax_form_kb_articletype_submit_form

  function do_ajax_form_kb_articletype_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_kb_articletype_submit_form_cb_after_alert);
  } // do_ajax_form_kb_articletype_submit_form_cb
  function do_ajax_form_kb_articletype_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kb_articletype_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kb_articletype_navigate_form()
  {
    perform_ajax_form_kb_articletype_navigate_form();
  }

  function perform_ajax_form_kb_articletype_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_kb_articletype_cancel_insert(sc_form_kb_articletype_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_kb_articletype_navigate_form(var_articletypeid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kb_articletype_navigate_form_cb);
  } // do_ajax_form_kb_articletype_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kb_articletype']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kb_articletype_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.articletypeid_.value = scAjaxGetKeyValue("articletypeid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kb_articletype_navigate_form_cb_after_alert);
  } // do_ajax_form_kb_articletype_navigate_form_cb
  function do_ajax_form_kb_articletype_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_kb_articletype_navigate_form_cb_after_alert

    function sc_form_kb_articletype_get_last_line_number()
    {
    ...
    } //sc_form_kb_articletype_get_last_line_number

  function sc_hide_form_kb_articletype_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "articletypeid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "articletypename_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["articletypeid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articletype_fild_articletypeid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["articletypename_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_kb_articletype_fild_articletypename'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["articletypeid_"][iNumLinha] = "articletypeid_" + iNumLinha;
    ajax_field_mult["articletypename_"][iNumLinha] = "articletypename_" + iNumLinha;
    ajax_field_id["articletypeid_" + iNumLinha] = new Array("hidden_field_label_articletypeid_", "hidden_field_data_articletypeid_" + iNumLinha);
    ajax_field_id["articletypename_" + iNumLinha] = new Array("hidden_field_label_articletypename_", "hidden_field_data_articletypename_" + iNumLinha);
    ajax_error_count["articletypeid_" + iNumLinha] = "off";
    ajax_error_count["articletypename_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["articletypeid_" + iNumLinha] = "on";
    ajax_read_only["articletypename_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["articletypeid_" + iNumLinha] = "on";
    ajax_read_only["articletypename_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["articletypeid_" + iNumLinha] = null;
    ajax_error_list["articletypename_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "articletypeid_": new Array(),
    "articletypename_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["articletypeid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["articletypeid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["articletypeid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["articletypeid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["articletypeid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["articletypename_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["articletypename_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["articletypename_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["articletypename_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["articletypename_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['articletypeid_'])) ? $this->nmgp_cmp_readonly['articletypeid_'] : 'on';
?>
    scAjaxFieldRead("articletypeid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['articletypename_'])) ? $this->nmgp_cmp_readonly['articletypename_'] : 'off';
?>
    scAjaxFieldRead("articletypename_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("articletypeid_" + iSeq, "on");
    scAjaxFieldRead("articletypename_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["articletypeid_" + iRow] || "on" == ajax_error_count["articletypename_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_articletypeid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_articletypename_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["articletypeid_" + iRow] && "off" == ajax_error_count["articletypename_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["articletypeid_" + iRow] = "off";
        ajax_error_count["articletypename_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_articletypeid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_articletypename_" + iRow).removeClass("scFormErrorLine");
    }
  }
