...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "articlesid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "articleview";$Nm_numeric[] = "votesqty";$Nm_numeric[] = "votestotal";$Nm_numeric[] = "articlesid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "articleview";$Nm_numeric[] = "votesqty";$Nm_numeric[] = "votestotal";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_articlesubject"  <?php echo $str_hide_articlesubject?>><INPUT  type="text" id="SC_articlesubject" name="articlesubject" value="<?php echo NM_encode_input($articlesubject) ?>"  size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_articlecontent"  <?php echo $str_hide_articlecontent?>><INPUT  type="text" id="SC_articlecontent" name="articlecontent" value="<?php echo NM_encode_input($articlecontent) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
