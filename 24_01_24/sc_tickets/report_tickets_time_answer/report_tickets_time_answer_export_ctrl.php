<?php
@session_start() ;
$_SESSION['scriptcase']['report_tickets_time_answer']['sc_process_barr'] = true;
require_once('../report_tickets_time_answer/index.php');
unset($_SESSION['scriptcase']['report_tickets_time_answer']['sc_process_barr']);
$ExportCtrl = new report_tickets_time_answer_export_control;
$ExportCtrl->Export_barr();

class report_tickets_time_answer_export_control
{
