   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="report_tickets_time_answer.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_tickets_time_answer"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____report_tickets_time_answer"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_tickets_time_answer</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_tickets_time_answer']['embutida_filho'] as $ind => $sc_init)
          {
