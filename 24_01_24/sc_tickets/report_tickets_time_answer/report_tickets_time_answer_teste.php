<?php  
  ...
  session_start() ;
  class report_tickets_time_answer_form_teste
  {
  function report_tickets_time_answer_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_tickets_time_answer</FONT></B> 
<br> 
<br> 
...
<input type=submit value="report_tickets_time_answer"> 
</form> 
...
<?php
  ...
  $frm_teste = new report_tickets_time_answer_form_teste();
  $frm_teste->report_tickets_time_answer_teste();
?>
