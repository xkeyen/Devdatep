...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "ticketid";$Nm_numeric[] = "ownerid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "ticketid";$Nm_numeric[] = "ownerid";$Nm_numeric[] = "categoryid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ticketid_cond" name="ticketid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticketid'), this, 'ticketid')">
      ...
      <br><span id="id_hide_ticketid"  <?php echo $str_hide_ticketid?>><INPUT  type="text" id="SC_ticketid" name="ticketid" value="<?php echo NM_encode_input($ticketid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ownerid_cond" name="ownerid_cond" onChange="nm_campos_between(document.getElementById('id_vis_ownerid'), this, 'ownerid')">
      ...
      <br><span id="id_hide_ownerid"  <?php echo $str_hide_ownerid?>><INPUT  type="text" id="SC_ownerid" name="ownerid" value="<?php echo NM_encode_input($ownerid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_categoryid_cond" name="categoryid_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoryid'), this, 'categoryid')">
      ...
      <br><span id="id_hide_categoryid"  <?php echo $str_hide_categoryid?>><INPUT  type="text" id="SC_categoryid" name="categoryid" value="<?php echo NM_encode_input($categoryid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_customeremail_cond" name="customeremail_cond" onChange="nm_campos_between(document.getElementById('id_vis_customeremail'), this, 'customeremail')">
      ...
      <br><span id="id_hide_customeremail"  <?php echo $str_hide_customeremail?>><INPUT  type="text" id="SC_customeremail" name="customeremail" value="<?php echo NM_encode_input($customeremail) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
