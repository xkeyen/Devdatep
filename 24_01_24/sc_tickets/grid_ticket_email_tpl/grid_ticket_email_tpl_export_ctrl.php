<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ticket_email_tpl']['sc_process_barr'] = true;
require_once('../grid_ticket_email_tpl/index.php');
unset($_SESSION['scriptcase']['grid_ticket_email_tpl']['sc_process_barr']);
$ExportCtrl = new grid_ticket_email_tpl_export_control;
$ExportCtrl->Export_barr();

class grid_ticket_email_tpl_export_control
{
