...
$old_error_handler = set_error_handler("control_forget_password_mob_scriptcase_error_handler");

function control_forget_password_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_forget_password_mob']['contr_erro']) && $_SESSION['scriptcase']['control_forget_password_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_forget_password_mob->contr_control_forget_password_mob->Apl_com_erro = true;
            if ($inicial_control_forget_password_mob->contr_control_forget_password_mob->NM_ajax_flag)
            {
                $inicial_control_forget_password_mob->contr_control_forget_password_mob->NM_ajax_info['errList']['geral_control_forget_password_mob'][] = $msg;
                return;
            }
            control_forget_password_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_forget_password_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_forget_password_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['control_forget_password_mob'])  ? $_SESSION['scriptcase']['error_icon']['control_forget_password_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_forget_password_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['control_forget_password_mob']) ? $_SESSION['scriptcase']['error_span_title']['control_forget_password_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_forget_password_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_forget_password_mob']) ? $_SESSION['scriptcase']['error_icon_title']['control_forget_password_mob'] : '';
?>
