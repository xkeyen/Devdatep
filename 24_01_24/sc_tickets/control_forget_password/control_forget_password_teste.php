<?php  
  ...
  session_start() ;
  class control_forget_password_form_teste
  {
   function control_forget_password_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_forget_password/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_forget_password</FONT></B> 
<br> 
<br> 
...
v_typeuser&nbsp;&nbsp;<input type="text" name="v_typeuser" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="control_forget_password"> 
</form> 
<script language=javascript> 
 document.Fedit.v_typeuser.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new control_forget_password_form_teste();
  $frm_teste->control_forget_password_teste();
?>
