...
<?php
   ...
   $Ord_Cmp = new report_customer_my_info_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class report_customer_my_info_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["subgrid_status"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['labels']["subgrid_status"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['labels']["subgrid_status"] : " ";
   ...
   $tab_labels["subgrid_categories"]   = (isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['labels']["subgrid_categories"])) ? $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['labels']["subgrid_categories"] : "";
   $tab_ger_campos['subgrid_status'] = "none";
   $tab_ger_campos['subgrid_categories'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['report_customer_my_info']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['report_customer_my_info']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['report_customer_my_info']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_header_my_summary'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "report_customer_my_info_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['report_customer_my_info']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
