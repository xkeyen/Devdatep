<?php  
  ...
  session_start() ;
  class report_customer_my_info_form_teste
  {
  function report_customer_my_info_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">report_customer_my_info</FONT></B> 
<br> 
<br> 
...
<input type=submit value="report_customer_my_info"> 
</form> 
...
<?php
  ...
  $frm_teste = new report_customer_my_info_form_teste();
  $frm_teste->report_customer_my_info_teste();
?>
