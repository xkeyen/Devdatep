<?php  
  ...
  session_start() ;
  class start_up_screen_form_teste
  {
  function start_up_screen_teste()
  {
...
<?php
  ...
  $frm_teste = new start_up_screen_form_teste();
  $frm_teste->start_up_screen_teste();
?>
