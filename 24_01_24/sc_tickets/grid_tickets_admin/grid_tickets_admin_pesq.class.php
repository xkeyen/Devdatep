...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_admin_all_tickets'] ?></TITLE>
...
?>
      ...
      <TD id='SC_ticket_ownerid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ticket_ownerid'])) ? $this->New_label['ticket_ownerid'] : "" . $this->Ini->Nm_lang['lang_staff_fild_staffname'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_ticket_ownerid_cond" name="ticket_ownerid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ticket_ownerid" <?php echo $str_hide_ticket_ownerid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
