...
class grid_tickets_admin_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "ticket.ticketdate";$Nm_datas[] = "ticket_ticketdate";$Nm_datas[] = "ticket.ticketlastupdate";$Nm_datas[] = "ticket_ticketlastupdate";$Nm_numeric[] = "ticket_ticketid";$Nm_numeric[] = "ticket_categoryid";$Nm_numeric[] = "ticket_ticketpriorityid";$Nm_numeric[] = "ticket_ownerid";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_tickets_admin.php";
?>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tickets_admin/grid_tickets_admin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_tickets_admin_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tickets_admin_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tickets_admin_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tickets_admin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tickets_admin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_tickets_admin.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $ticket_ownerid_cond, $ticket_ownerid,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticket_tickettrack = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_tickettrack']; 
          $ticket_tickettrack_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_tickettrack_cond']; 
          $ticket_ticketpriorityid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketpriorityid']; 
          $ticket_ticketpriorityid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketpriorityid_cond']; 
          $customer_customername = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['customer_customername']; 
          $customer_customername_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['customer_customername_cond']; 
          $ticket_categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_categoryid']; 
          $ticket_categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_categoryid_cond']; 
          $ticket_ownerid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ownerid']; 
          $ticket_ownerid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ownerid_cond']; 
          $ticket_ticketlastupdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_dia']; 
          $ticket_ticketlastupdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_mes']; 
          $ticket_ticketlastupdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_ano']; 
          $ticket_ticketlastupdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_dia']; 
          $ticket_ticketlastupdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_mes']; 
          $ticket_ticketlastupdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_ano']; 
          $ticket_ticketlastupdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_cond']; 
          $ticket_statusid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_statusid']; 
          $ticket_statusid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_statusid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($ticket_ownerid_cond) || empty($ticket_ownerid_cond))
      {
         $ticket_ownerid_cond = "eq";
      }
      ...
      $str_hide_ticket_ownerid = (in_array($ticket_ownerid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_ticket_ownerid = ('bw' == $ticket_ownerid_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($ticket_ownerid) || $ticket_ownerid == "")
      {
          $ticket_ownerid = "";
      }
      if (isset($ticket_ownerid) && !empty($ticket_ownerid))
      {
         $tmp_pos = (is_string($ticket_ownerid)) ? strpos($ticket_ownerid, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ticket_ownerid = substr($ticket_ownerid, 0, $tmp_pos);
         }
      }
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticket_tickettrack"  <?php echo $str_hide_ticket_tickettrack?>><INPUT  type="text" id="SC_ticket_tickettrack" name="ticket_tickettrack" value="<?php echo NM_encode_input($ticket_tickettrack) ?>"  size=7 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticket_ticketpriorityid"  <?php echo $str_hide_ticket_ticketpriorityid?>>
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ticketpriorityid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ticketpriorityid'][] = trim($rs->fields[0]);
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_customer_customername"  <?php echo $str_hide_customer_customername?>><INPUT  type="text" id="SC_customer_customername" name="customer_customername" value="<?php echo NM_encode_input($customer_customername) ?>"  size=35 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd css_customer_customername_fil_obj">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticket_categoryid"  <?php echo $str_hide_ticket_categoryid?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_categoryid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_categoryid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <INPUT type="hidden" id="SC_ticket_ownerid_cond" name="ticket_ownerid_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['ticket_ownerid'])) ? $this->New_label['ticket_ownerid'] : "" . $this->Ini->Nm_lang['lang_staff_fild_staffname'] . "";
 $nmgp_tab_label .= "ticket_ownerid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticket_ownerid"  <?php echo $str_hide_ticket_ownerid?>>
<?php
      $ticket_ownerid_look = (is_string($ticket_ownerid) ? substr($this->Db->qstr($ticket_ownerid), 1, -1) : $ticket_ownerid); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "select staffid, staffname  from staff  order by staffname"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ownerid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ownerid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_ticket_ownerid">
      <SELECT class="scFilterObjectOdd" id="SC_ticket_ownerid" name="ticket_ownerid"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $ticket_ownerid)
            {
                    $ticket_ownerid_sel = ($nm_opc_cod === $ticket_ownerid) ? "selected" : "";
            }
            else
            {
               $ticket_ownerid_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $ticket_ownerid_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ticket_ticketlastupdate_cond" name="ticket_ticketlastupdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticket_ticketlastupdate'), this, 'ticket_ticketlastupdate')">
      ...
      <br><span id="id_hide_ticket_ticketlastupdate"  <?php echo $str_hide_ticket_ticketlastupdate?>>
<SPAN id="Nm_bi_dados_ticket_ticketlastupdate" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_ticket_ticketlastupdate"  style="display:''">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticket_statusid"  <?php echo $str_hide_ticket_statusid?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_statusid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_statusid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
<?php
   if (is_file("grid_tickets_admin_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tickets_admin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tickets_admin']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_tickets_admin.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "grid_tickets_admin.php"; 
 ...
 function limpa_form()
 {
   ...
   document.F1.ticket_ownerid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ticket_ownerid'), document.F1.ticket_ownerid_cond, 'ticket_ownerid');
   document.F1.ticket_ownerid.value = "";
 ...
 {
    $('#SC_ticket_ticketlastupdate_dia').bind('change', function() {sc_grid_tickets_admin_valida_dia(this)});
    $('#SC_ticket_ticketlastupdate_input_2_dia').bind('change', function() {sc_grid_tickets_admin_valida_dia(this)});
    $('#SC_ticket_ticketlastupdate_input_2_mes').bind('change', function() {sc_grid_tickets_admin_valida_mes(this)});
    $('#SC_ticket_ticketlastupdate_mes').bind('change', function() {sc_grid_tickets_admin_valida_mes(this)});
 }
 function sc_grid_tickets_admin_valida_mes(obj)
 {
 ...
 function sc_grid_tickets_admin_valida_dia(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function trata_campos()
   {
      ...
      $ticket_ownerid_cond_salva = $ticket_ownerid_cond; 
      if (!isset($ticket_ownerid_input_2) || $ticket_ownerid_input_2 == "")
      {
          $ticket_ownerid_input_2 = $ticket_ownerid;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ticketpriorityid'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_categoryid'])) {
      ...
      $tmp_pos = (is_string($ticket_ownerid)) ? strpos($ticket_ownerid, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $ticket_ownerid;
      }
      else {
          $L_lookup = substr($ticket_ownerid, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_ownerid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_staff_fild_staffname'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($ticket_statusid)) {
          foreach ($ticket_statusid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['psq_check_ret']['ticket_statusid'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_tickettrack'] = $ticket_tickettrack; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_tickettrack_cond'] = $ticket_tickettrack_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketpriorityid'] = $ticket_ticketpriorityid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketpriorityid_cond'] = $ticket_ticketpriorityid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['customer_customername'] = $customer_customername; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['customer_customername_cond'] = $customer_customername_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_categoryid'] = $ticket_categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_categoryid_cond'] = $ticket_categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ownerid'] = $ticket_ownerid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ownerid_cond'] = $ticket_ownerid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_dia'] = $ticket_ticketlastupdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_mes'] = $ticket_ticketlastupdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_ano'] = $ticket_ticketlastupdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_dia'] = $ticket_ticketlastupdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_mes'] = $ticket_ticketlastupdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2_ano'] = $ticket_ticketlastupdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_cond'] = $ticket_ticketlastupdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_statusid'] = $ticket_statusid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_statusid_cond'] = $ticket_statusid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $ticket_ownerid;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['ticket_ownerid'] = $Conteudo;
      $this->cmp_formatado['ticket_statusid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_statusid'];
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $ticket_ownerid
      $this->Date_part = false;
      if (isset($ticket_ownerid))
      {
         $this->monta_condicao("ticket.ownerid", $ticket_ownerid_cond, $ticket_ownerid, "", "ticket_ownerid", "INT", false);
      }
      ...
      if ($ticket_ticketlastupdate_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate'] = $val[0];
          ...
          if ($ticket_ticketlastupdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']['ticket_ticketlastupdate_input_2'] = $val[1];
      ...
      if (is_array($ticket_statusid) && count($ticket_statusid) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $nmgp_tab_label['ticket_statusid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tickets_admin']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "ticket_ownerid" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
