...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_kb_articles"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kb_articles']['embutida_filho'] as $ind => $sc_init)
          {
