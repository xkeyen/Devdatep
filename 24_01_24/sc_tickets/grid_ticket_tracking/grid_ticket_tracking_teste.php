<?php  
  ...
  session_start() ;
  class grid_ticket_tracking_form_teste
  {
  function grid_ticket_tracking_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_ticket_tracking</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_ticket_tracking"> 
</form> 
<script language=javascript> 
 document.FCons.v_trackingid.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_ticket_tracking_form_teste();
  $frm_teste->grid_ticket_tracking_teste();
?>
