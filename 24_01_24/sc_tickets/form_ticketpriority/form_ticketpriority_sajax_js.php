  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ticketpriority" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ticketpriority_form();
	}
...
?>
  ...
  // ---------- Validate ticketpriorityid_
  function do_ajax_form_ticketpriority_validate_ticketpriorityid_(iNumLinha)
  {
    var nomeCampo_ticketpriorityid_ = "ticketpriorityid_" + iNumLinha;
    var var_ticketpriorityid_ = scAjaxGetFieldHidden(nomeCampo_ticketpriorityid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketpriority_validate_ticketpriorityid_(var_ticketpriorityid_, iNumLinha, var_script_case_init, do_ajax_form_ticketpriority_validate_ticketpriorityid__cb);
  } // do_ajax_form_ticketpriority_validate_ticketpriorityid_

  function do_ajax_form_ticketpriority_validate_ticketpriorityid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ticketpriorityid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ticketpriorityid_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketpriority_validate_ticketpriorityid__cb

  // ---------- Validate priorityname_
  function do_ajax_form_ticketpriority_validate_priorityname_(iNumLinha)
  {
    var nomeCampo_priorityname_ = "priorityname_" + iNumLinha;
    var var_priorityname_ = scAjaxGetFieldText(nomeCampo_priorityname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketpriority_validate_priorityname_(var_priorityname_, iNumLinha, var_script_case_init, do_ajax_form_ticketpriority_validate_priorityname__cb);
  } // do_ajax_form_ticketpriority_validate_priorityname_

  function do_ajax_form_ticketpriority_validate_priorityname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priorityname_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priorityname_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketpriority_validate_priorityname__cb

  // ---------- Validate priorityicon_
  function do_ajax_form_ticketpriority_validate_priorityicon_(iNumLinha)
  {
    var nomeCampo_priorityicon_ = "priorityicon_" + iNumLinha;
    var var_priorityicon_ = scAjaxGetFieldText(nomeCampo_priorityicon_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketpriority_validate_priorityicon_(var_priorityicon_, iNumLinha, var_script_case_init, do_ajax_form_ticketpriority_validate_priorityicon__cb);
  } // do_ajax_form_ticketpriority_validate_priorityicon_

  function do_ajax_form_ticketpriority_validate_priorityicon__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priorityicon_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priorityicon_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ticketpriority_validate_priorityicon__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_ticketpriority_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_ticketpriority_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ticketpriority_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_ticketpriority_add_new_line_cb);
  } // do_ajax_form_ticketpriority_add_new_line

  function do_ajax_form_ticketpriority_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_priorityicon_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_ticketpriority_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_ticketpriority_backup_line(iNumLinha)
  {
    var var_ticketpriorityid_ = scAjaxGetFieldHidden("ticketpriorityid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ticketpriority_backup_line(var_ticketpriorityid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_ticketpriority_backup_line_cb);
  } // do_ajax_form_ticketpriority_backup_line

  function do_ajax_form_ticketpriority_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_ticketpriority_backup_line_cb

  function do_ajax_form_ticketpriority_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_ticketpriority_cancel_insert

  function do_ajax_form_ticketpriority_cancel_update(iSeqVert)
  {
    do_ajax_form_ticketpriority_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_ticketpriority_cancel_update

  function do_ajax_form_ticketpriority_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_ticketpriority_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_ticketpriority_table_refresh()
  {
    var var_ticketpriorityid_ = document.F2.ticketpriorityid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_ticketpriority_table_refresh(var_ticketpriorityid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticketpriority_table_refresh_cb);
  } //  do_ajax_form_ticketpriority_table_refresh

  function do_ajax_form_ticketpriority_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ticketpriorityid_.value = scAjaxGetKeyValue("ticketpriorityid_");
    ...
    scAjaxAlert(do_ajax_form_ticketpriority_table_refresh_cb_after_alert);
  } // do_ajax_form_ticketpriority_table_refresh_cb
  function do_ajax_form_ticketpriority_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_ticketpriority_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_ticketpriority_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_ticketpriority_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ticketpriorityid_ = scAjaxGetFieldHidden("ticketpriorityid_" + iNumLinha);
    var var_priorityname_ = scAjaxGetFieldText("priorityname_" + iNumLinha);
    var var_priorityicon_ = scAjaxGetFieldText("priorityicon_" + iNumLinha);
    var var_priorityicon__ul_name = scAjaxSpecCharProtect(eval('document.F1.priorityicon__ul_name' + iNumLinha + '.value'));
    var var_priorityicon__ul_type = eval('document.F1.priorityicon__ul_type' + iNumLinha + '.value');
    var var_priorityicon__limpa = eval('document.F1.priorityicon__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_ticketpriority_submit_form(var_ticketpriorityid_, var_priorityname_, var_priorityicon_, var_priorityicon__ul_name, var_priorityicon__ul_type, var_priorityicon__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ticketpriority_submit_form_cb);
  } // do_ajax_form_ticketpriority_submit_form

  function do_ajax_form_ticketpriority_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
<?php
        ...
        {
?>
          if (document.F1.elements["priorityicon__limpa" + sc_num_ult_line] && document.F1.elements["priorityicon__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("priorityicon_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["priorityicon__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.priorityicon__ul_name" + sc_num_ult_line + ") document.F1.priorityicon__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.priorityicon__ul_type" + sc_num_ult_line + ") document.F1.priorityicon__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ticketpriority_submit_form_cb_after_alert);
  } // do_ajax_form_ticketpriority_submit_form_cb
  function do_ajax_form_ticketpriority_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ticketpriority_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ticketpriority_navigate_form()
  {
    perform_ajax_form_ticketpriority_navigate_form();
  }

  function perform_ajax_form_ticketpriority_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_ticketpriority_cancel_insert(sc_form_ticketpriority_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ticketpriority_navigate_form(var_ticketpriorityid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ticketpriority_navigate_form_cb);
  } // do_ajax_form_ticketpriority_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ticketpriority']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ticketpriority_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.ticketpriorityid_.value = scAjaxGetKeyValue("ticketpriorityid_" + var_last_index);
    ...
    {
      eval("if (document.F1.priorityicon__ul_name" + iImg + ") document.F1.priorityicon__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.priorityicon__ul_type" + iImg + ") document.F1.priorityicon__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ticketpriority_navigate_form_cb_after_alert);
  } // do_ajax_form_ticketpriority_navigate_form_cb
  function do_ajax_form_ticketpriority_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_ticketpriority_navigate_form_cb_after_alert

    function sc_form_ticketpriority_get_last_line_number()
    {
    ...
    } //sc_form_ticketpriority_get_last_line_number

  function sc_hide_form_ticketpriority_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ticketpriorityid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priorityname_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priorityicon_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ticketpriorityid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketpriority_fild_ticketpriorityid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priorityname_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityname'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priorityicon_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ticketpriority_fild_priorityicon'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["ticketpriorityid_"][iNumLinha] = "ticketpriorityid_" + iNumLinha;
    ajax_field_mult["priorityname_"][iNumLinha] = "priorityname_" + iNumLinha;
    ajax_field_mult["priorityicon_"][iNumLinha] = "priorityicon_" + iNumLinha;
    ajax_field_id["ticketpriorityid_" + iNumLinha] = new Array("hidden_field_label_ticketpriorityid_", "hidden_field_data_ticketpriorityid_" + iNumLinha);
    ajax_field_id["priorityname_" + iNumLinha] = new Array("hidden_field_label_priorityname_", "hidden_field_data_priorityname_" + iNumLinha);
    ajax_field_id["priorityicon_" + iNumLinha] = new Array("hidden_field_label_priorityicon_", "hidden_field_data_priorityicon_" + iNumLinha);
    ajax_error_count["ticketpriorityid_" + iNumLinha] = "off";
    ajax_error_count["priorityname_" + iNumLinha] = "off";
    ajax_error_count["priorityicon_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ticketpriorityid_" + iNumLinha] = "on";
    ajax_read_only["priorityname_" + iNumLinha] = "off";
    ajax_read_only["priorityicon_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ticketpriorityid_" + iNumLinha] = "on";
    ajax_read_only["priorityname_" + iNumLinha] = "on";
    ajax_read_only["priorityicon_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ticketpriorityid_" + iNumLinha] = null;
    ajax_error_list["priorityname_" + iNumLinha] = null;
    ajax_error_list["priorityicon_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ticketpriorityid_": new Array(),
    "priorityname_": new Array(),
    "priorityicon_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ticketpriorityid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ticketpriorityid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ticketpriorityid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ticketpriorityid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ticketpriorityid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priorityname_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priorityname_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priorityname_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priorityname_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priorityname_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priorityicon_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priorityicon_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priorityicon_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priorityicon_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priorityicon_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ticketpriorityid_'])) ? $this->nmgp_cmp_readonly['ticketpriorityid_'] : 'on';
?>
    scAjaxFieldRead("ticketpriorityid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priorityname_'])) ? $this->nmgp_cmp_readonly['priorityname_'] : 'off';
?>
    scAjaxFieldRead("priorityname_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priorityicon_'])) ? $this->nmgp_cmp_readonly['priorityicon_'] : 'off';
?>
    scAjaxFieldRead("priorityicon_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ticketpriorityid_" + iSeq, "on");
    scAjaxFieldRead("priorityname_" + iSeq, "on");
    scAjaxFieldRead("priorityicon_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ticketpriorityid_" + iRow] || "on" == ajax_error_count["priorityname_" + iRow] || "on" == ajax_error_count["priorityicon_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ticketpriorityid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priorityname_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priorityicon_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ticketpriorityid_" + iRow] && "off" == ajax_error_count["priorityname_" + iRow] && "off" == ajax_error_count["priorityicon_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ticketpriorityid_" + iRow] = "off";
        ajax_error_count["priorityname_" + iRow] = "off";
        ajax_error_count["priorityicon_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ticketpriorityid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priorityname_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priorityicon_" + iRow).removeClass("scFormErrorLine");
    }
  }
