<?php  
  ...
  session_start() ;
  class grid_canned_message_form_teste
  {
  function grid_canned_message_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_canned_message</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_canned_message"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_canned_message_form_teste();
  $frm_teste->grid_canned_message_teste();
?>
