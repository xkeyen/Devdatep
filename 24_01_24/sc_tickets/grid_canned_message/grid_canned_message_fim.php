   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_canned_message.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_canned_message"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_canned_message"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_canned_message'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_canned_message']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_canned_message']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_canned_message']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_canned_message']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_canned_message']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_canned_message</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_canned_message']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_canned_message']['embutida_filho'] as $ind => $sc_init)
          {
