<?php
@session_start() ;
$_SESSION['scriptcase']['grid_customers_tickets']['sc_process_barr'] = true;
require_once('../grid_customers_tickets/index.php');
unset($_SESSION['scriptcase']['grid_customers_tickets']['sc_process_barr']);
$ExportCtrl = new grid_customers_tickets_export_control;
$ExportCtrl->Export_barr();

class grid_customers_tickets_export_control
{
