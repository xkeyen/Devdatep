...
class grid_customers_tickets_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_customers_tickets_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_customers_tickets_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_customers_tickets_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "ticket_ticketpriorityid";$Nm_numeric[] = "ticket_ticketpriorityid";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_customers_tickets.php";
?>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_customers_tickets/grid_customers_tickets_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_customers_tickets_ajax_search.js"></script>
 <script type="text/javascript" src="grid_customers_tickets_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_customers_tickets_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customers_tickets']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customers_tickets']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_campos_between(nm_campo, nm_cond, nm_nome_obj)
 {
  ...
  {
      if (nm_nome_obj == "ticket_ticketdate")
      {
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ticket_tickettrack_cond#NMF#' + search_get_sel_txt('SC_ticket_tickettrack_cond') + '@NMF@';
  str_out += 'SC_ticket_tickettrack#NMF#' + search_get_text('SC_ticket_tickettrack') + '@NMF@';
  str_out += 'SC_ticket_ticketpriorityid_cond#NMF#' + search_get_sel_txt('SC_ticket_ticketpriorityid_cond') + '@NMF@';
  str_out += 'SC_ticket_ticketpriorityid#NMF#' + search_get_checkbox('SC_ticket_ticketpriorityid') + '@NMF@';
  str_out += 'SC_ticketstatus_statusid_cond#NMF#' + search_get_sel_txt('SC_ticketstatus_statusid_cond') + '@NMF@';
  str_out += 'SC_ticketstatus_statusid#NMF#' + search_get_checkbox('SC_ticketstatus_statusid') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_customers_tickets.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_customer_mytickets'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $ticketstatus_statusid_cond, $ticketstatus_statusid,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ticket_tickettrack = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_tickettrack']; 
          $ticket_tickettrack_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_tickettrack_cond']; 
          $ticket_ticketpriorityid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_ticketpriorityid']; 
          $ticket_ticketpriorityid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_ticketpriorityid_cond']; 
          $ticketstatus_statusid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticketstatus_statusid']; 
          $ticketstatus_statusid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticketstatus_statusid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['NM_operador']; 
      } 
      ...
      {
         $ticket_ticketpriorityid_cond = "eq";
      }
      if (!isset($ticketstatus_statusid_cond) || empty($ticketstatus_statusid_cond))
      {
         $ticketstatus_statusid_cond = "eq";
      }
      ...
      $str_hide_ticketstatus_statusid = (in_array($ticketstatus_statusid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // ticket_ticketpriorityid
      if (is_array($ticket_ticketpriorityid) && !empty($ticket_ticketpriorityid))
      {
         $tmp_array = array();
         $ticket_ticketpriorityid_val_str = "";
         foreach ($ticket_ticketpriorityid as $tmp_val_cmp)
         {
            if ("" != $ticket_ticketpriorityid_val_str)
            {
               $ticket_ticketpriorityid_val_str .= ",";
            }
            ...
            $ticket_ticketpriorityid_val_str .= "'$tmp_val_cmp'";
         }
         $ticket_ticketpriorityid = $tmp_array;
      }
      else
      {
         $ticket_ticketpriorityid_val_str = "";
      }
      // ticketstatus_statusid
      if (is_array($ticketstatus_statusid) && !empty($ticketstatus_statusid))
      {
         $tmp_array = array();
         $ticketstatus_statusid_val_str = "";
         foreach ($ticketstatus_statusid as $tmp_val_cmp)
         {
            if ("" != $ticketstatus_statusid_val_str)
            {
               $ticketstatus_statusid_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
            ...
            $ticketstatus_statusid_val_str .= "'$tmp_val_cmp'";
         }
         $ticketstatus_statusid = $tmp_array;
      }
      else
      {
         $ticketstatus_statusid_val_str = "''";
      ...
      {
          $ticket_ticketpriorityid = array();
      }
      if (!isset($ticketstatus_statusid) || $ticketstatus_statusid == "")
      {
          $ticketstatus_statusid = array();
      }
?>
 <TR align="center">
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticket_ticketpriorityid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticket_ticketpriorityid'][] = trim($rs->fields[0]);
      ...
      echo "<span id=\"idAjaxCheckbox_ticket_ticketpriorityid\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($ticket_ticketpriorityid) || !is_array($ticket_ticketpriorityid))
      {
         $ticket_ticketpriorityid = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            $tmp_cmp_click = "";
            $tmp_cmp_sel = "";
            foreach ($ticket_ticketpriorityid as $Dados)
            {
                if ($Dados === $nm_opc_cod)
                {
                    $tmp_cmp_sel = "checked";
            ...
            echo "           <INPUT class=\"scFilterObjectOdd\" type=\"checkbox\" id=\"SC_ticket_ticketpriorityid\" name=\"ticket_ticketpriorityid[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
...
?>
      ...
      <INPUT type="hidden" id="SC_ticketstatus_statusid_cond" name="ticketstatus_statusid_cond" value="eq">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['ticketstatus_statusid'])) ? $this->New_label['ticketstatus_statusid'] : "" . $this->Ini->Nm_lang['lang_ticketstatus_fild_statusname'] . "";
 $nmgp_tab_label .= "ticketstatus_statusid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ticketstatus_statusid"  <?php echo $str_hide_ticketstatus_statusid?>>
<?php
      $ticketstatus_statusid_look = (is_string($ticketstatus_statusid) ? substr($this->Db->qstr($ticketstatus_statusid), 1, -1) : $ticketstatus_statusid); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticketstatus_statusid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticketstatus_statusid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
      ...
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      echo "<span id=\"idAjaxCheckbox_ticketstatus_statusid\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($ticketstatus_statusid) || !is_array($ticketstatus_statusid))
      {
         $ticketstatus_statusid = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            $tmp_cmp_click = "";
            $tmp_cmp_sel = "";
            foreach ($ticketstatus_statusid as $Dados)
            {
                if ($Dados === $nm_opc_cod)
                {
                    $tmp_cmp_sel = "checked";
            ...
            echo "           <INPUT class=\"scFilterObjectEven\" type=\"checkbox\" id=\"SC_ticketstatus_statusid\" name=\"ticketstatus_statusid[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
...
?>
<?php
   if (is_file("grid_customers_tickets_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_tickets']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_customers_tickets']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_customers_tickets.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['orig_pesq'] == "grid")
   {
...
?>
 function nm_move()
 {
     ...
     document.form_cancel.action = "grid_customers_tickets.php"; 
 ...
 function limpa_form()
 {
   ...
   document.F1.ticket_ticketpriorityid_cond.value = 'eq';
   ...
   {
      if (document.F1.elements[i].name == 'ticket_ticketpriorityid[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   document.F1.ticketstatus_statusid_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ticketstatus_statusid'), document.F1.ticketstatus_statusid_cond, 'ticketstatus_statusid');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'ticketstatus_statusid[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
...
function formata_bi_ticket_ticketdate(opc, opc_bi, dt_fmt)
{
   ...
   saida = document.F1.ticket_ticketdate_dia.value + '/' + document.F1.ticket_ticketdate_mes.value + '/' + document.F1.ticket_ticketdate_ano.value;
   if (opc_bi == "bw")
   {
       saida += " ";
       saida += document.F1.ticket_ticketdate_input_2_dia.value + '/' + document.F1.ticket_ticketdate_input_2_mes.value + '/' + document.F1.ticket_ticketdate_input_2_ano.value;
   }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "sc_tickets/grid_customers_tickets";
             ...
             if (@is_file($this->NM_path_filter . $NM_patch . "/" . $NM_arq))
             {
                 ...
                 if (substr($NMcmp_filter[0], 0, 6) == "SC_V6_" || substr($NMcmp_filter[0], 0, 6) == "SC_V8_")
                 {
                     ...
                     if (!empty($Name_filter))
                     {
                         ...
                         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                         {
                             $this->NM_fil_ant[$NM_arq][1] = sc_convert_encoding("Public", $_SESSION['scriptcase']['charset'], "UTF-8");
                         }
                         else
                         {
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_customers_tickets/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_ticket_tickettrack_cond'] = 'cond';
      $tp_fields['SC_ticket_tickettrack'] = 'text';
      $tp_fields['SC_ticket_ticketpriorityid_cond'] = 'cond';
      $tp_fields['SC_ticket_ticketpriorityid'] = 'checkbox';
      $tp_fields['SC_ticketstatus_statusid_cond'] = 'cond';
      $tp_fields['SC_ticketstatus_statusid'] = 'checkbox';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_ticket_ticketdate_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   function trata_campos()
   {
      global $ticket_tickettrack_cond, $ticket_tickettrack,
             $ticket_ticketpriorityid_cond, $ticket_ticketpriorityid,
             $ticketstatus_statusid_cond, $ticketstatus_statusid, $nmgp_tab_label;
      ...
      $ticketstatus_statusid_cond_salva = $ticketstatus_statusid_cond; 
      if (!isset($ticketstatus_statusid_input_2) || $ticketstatus_statusid_input_2 == "")
      {
          $ticketstatus_statusid_input_2 = $ticketstatus_statusid;
      }
      if (is_array($ticket_ticketpriorityid)) {
          foreach ($ticket_ticketpriorityid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticket_ticketpriorityid'])) {
      ...
      if (is_array($ticketstatus_statusid)) {
          foreach ($ticketstatus_statusid as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['psq_check_ret']['ticketstatus_statusid'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_tickettrack'] = $ticket_tickettrack; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_tickettrack_cond'] = $ticket_tickettrack_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_ticketpriorityid'] = $ticket_ticketpriorityid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_ticketpriorityid_cond'] = $ticket_ticketpriorityid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticketstatus_statusid'] = $ticketstatus_statusid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticketstatus_statusid_cond'] = $ticketstatus_statusid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['ticket_ticketpriorityid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticket_ticketpriorityid'];
      $this->cmp_formatado['ticket_ticketpriorityid_input_2'] = $ticket_ticketpriorityid_input_2;
      $this->cmp_formatado['ticketstatus_statusid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']['ticketstatus_statusid'];
      $this->cmp_formatado['ticketstatus_statusid_input_2'] = $ticketstatus_statusid_input_2;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $ticket_ticketpriorityid
      $this->Date_part = false;
      $ticket_ticketpriorityid = $ticket_ticketpriorityid; 
      $nm_aspas = "";
      if ($ticket_ticketpriorityid_cond == "nu" || $ticket_ticketpriorityid_cond == "nn" || $ticket_ticketpriorityid_cond == "ep" || $ticket_ticketpriorityid_cond == "ne")
      {
          $ticket_ticketpriorityid = array();
      }
      if (is_array($ticket_ticketpriorityid) && count($ticket_ticketpriorityid) != 0)
      {
         foreach ($ticket_ticketpriorityid as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($ticket_ticketpriorityid[$i]);
            }
         }
      }
      if (is_array($ticket_ticketpriorityid) && count($ticket_ticketpriorityid) != 0)
      {
         $this->and_or();
         if ($ticket_ticketpriorityid_cond == "df" || $ticket_ticketpriorityid_cond == "np")
         {
             $this->comando        .= " ticket.ticketpriorityid not in (";
             $this->comando_sum    .= " ticket.ticketpriorityid not in (";
             $this->comando_filtro .= " ticket.ticketpriorityid not in (";
         }
         else
         {
             $this->comando        .= " ticket.ticketpriorityid in (";
             $this->comando_sum    .= " ticket.ticketpriorityid in (";
             $this->comando_filtro .= " ticket.ticketpriorityid in (";
         }
         $x                     = count($ticket_ticketpriorityid);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($ticket_ticketpriorityid as $i => $dados)
         {
         ...
         $Lang_descr_final = isset($Lang_descr[$ticket_ticketpriorityid_cond]) ? $Lang_descr[$ticket_ticketpriorityid_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label['ticket_ticketpriorityid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($ticket_ticketpriorityid) && ($ticket_ticketpriorityid_cond == "nu" || $ticket_ticketpriorityid_cond == "nn" || $ticket_ticketpriorityid_cond == "ep" || $ticket_ticketpriorityid_cond == "ne"))
      {
         $this->monta_condicao("ticket.ticketpriorityid", $ticket_ticketpriorityid_cond, "", "", "ticket_ticketpriorityid", "INT", false);
      }

      //----- $ticketstatus_statusid
      $this->Date_part = false;
      $ticketstatus_statusid = $ticketstatus_statusid; 
      $nm_aspas = "'";
      if ($ticketstatus_statusid_cond == "nu" || $ticketstatus_statusid_cond == "nn" || $ticketstatus_statusid_cond == "ep" || $ticketstatus_statusid_cond == "ne")
      {
          $ticketstatus_statusid = array();
      }
      if (is_array($ticketstatus_statusid) && count($ticketstatus_statusid) != 0)
      {
         foreach ($ticketstatus_statusid as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($ticketstatus_statusid[$i]);
            }
         }
      }
      if (is_array($ticketstatus_statusid) && count($ticketstatus_statusid) != 0)
      {
         $this->and_or();
         if ($ticketstatus_statusid_cond == "df" || $ticketstatus_statusid_cond == "np")
         {
             $this->comando        .= " ticketstatus.statusid not in (";
             $this->comando_sum    .= " ticketstatus.statusid not in (";
             $this->comando_filtro .= " ticketstatus.statusid not in (";
         }
         else
         {
             $this->comando        .= " ticketstatus.statusid in (";
             $this->comando_sum    .= " ticketstatus.statusid in (";
             $this->comando_filtro .= " ticketstatus.statusid in (";
         }
         $x                     = count($ticketstatus_statusid);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($ticketstatus_statusid as $i => $dados)
         {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$ticketstatus_statusid_cond]) ? $Lang_descr[$ticketstatus_statusid_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $nmgp_tab_label['ticketstatus_statusid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($ticketstatus_statusid) && ($ticketstatus_statusid_cond == "nu" || $ticketstatus_statusid_cond == "nn" || $ticketstatus_statusid_cond == "ep" || $ticketstatus_statusid_cond == "ne"))
      {
         $this->monta_condicao("ticketstatus.statusid", $ticketstatus_statusid_cond, "", "", "ticketstatus_statusid", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers_tickets']['where_pesq'];
