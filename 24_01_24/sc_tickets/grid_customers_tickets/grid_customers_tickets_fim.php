   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="grid_customers_tickets.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_customers_tickets"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sc_tickets_____grid_customers_tickets"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_customers_tickets</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_customers_tickets']['embutida_filho'] as $ind => $sc_init)
          {
