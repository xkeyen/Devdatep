  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_languages" == sTestField)
        {
...
?>
  ...
  // ---------- Validate languageid_
  function do_ajax_form_languages_validate_languageid_(iNumLinha)
  {
    var nomeCampo_languageid_ = "languageid_" + iNumLinha;
    var var_languageid_ = scAjaxGetFieldText(nomeCampo_languageid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_languages_validate_languageid_(var_languageid_, iNumLinha, var_script_case_init, do_ajax_form_languages_validate_languageid__cb);
  } // do_ajax_form_languages_validate_languageid_

  function do_ajax_form_languages_validate_languageid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "languageid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "languageid_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_languages_validate_languageid__cb

  // ---------- Validate languagename_
  function do_ajax_form_languages_validate_languagename_(iNumLinha)
  {
    var nomeCampo_languagename_ = "languagename_" + iNumLinha;
    var var_languagename_ = scAjaxGetFieldText(nomeCampo_languagename_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_languages_validate_languagename_(var_languagename_, iNumLinha, var_script_case_init, do_ajax_form_languages_validate_languagename__cb);
  } // do_ajax_form_languages_validate_languagename_

  function do_ajax_form_languages_validate_languagename__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "languagename_" + iLineNumber;
    }
    else
    {
      sFieldValid = "languagename_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_languages_validate_languagename__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_languages_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_languages_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_languages_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_languages_add_new_line_cb);
  } // do_ajax_form_languages_add_new_line

  function do_ajax_form_languages_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_languages_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_languages_backup_line(iNumLinha)
  {
    var var_serial_ = scAjaxGetFieldText("serial_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_languages_backup_line(var_serial_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_languages_backup_line_cb);
  } // do_ajax_form_languages_backup_line

  function do_ajax_form_languages_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_languages_backup_line_cb

  function do_ajax_form_languages_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_languages_cancel_insert

  function do_ajax_form_languages_cancel_update(iSeqVert)
  {
    do_ajax_form_languages_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_languages_cancel_update

  function do_ajax_form_languages_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_languages_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_languages_table_refresh()
  {
    var var_serial_ = document.F2.serial_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_languages_table_refresh(var_serial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_languages_table_refresh_cb);
  } //  do_ajax_form_languages_table_refresh

  function do_ajax_form_languages_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.serial_.value = scAjaxGetKeyValue("serial_");
    ...
    scAjaxAlert(do_ajax_form_languages_table_refresh_cb_after_alert);
  } // do_ajax_form_languages_table_refresh_cb
  function do_ajax_form_languages_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_languages_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_languages_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_languages_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_languageid_ = scAjaxGetFieldText("languageid_" + iNumLinha);
    var var_languagename_ = scAjaxGetFieldText("languagename_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_languages_submit_form(var_languageid_, var_languagename_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_languages_submit_form_cb);
  } // do_ajax_form_languages_submit_form

  function do_ajax_form_languages_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_languages_submit_form_cb_after_alert);
  } // do_ajax_form_languages_submit_form_cb
  function do_ajax_form_languages_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_languages_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_languages_navigate_form()
  {
    perform_ajax_form_languages_navigate_form();
  }

  function perform_ajax_form_languages_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_languages_cancel_insert(sc_form_languages_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_languages_navigate_form(var_serial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_languages_navigate_form_cb);
  } // do_ajax_form_languages_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_languages']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_languages_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.serial_.value = scAjaxGetKeyValue("serial_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_languages_navigate_form_cb_after_alert);
  } // do_ajax_form_languages_navigate_form_cb
  function do_ajax_form_languages_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_languages_navigate_form_cb_after_alert

    function sc_form_languages_get_last_line_number()
    {
    ...
    } //sc_form_languages_get_last_line_number

  function sc_hide_form_languages_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "languageid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "languagename_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["languageid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_languages_fild_languageid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["languagename_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_languages_fild_languagename'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["languageid_"][iNumLinha] = "languageid_" + iNumLinha;
    ajax_field_mult["languagename_"][iNumLinha] = "languagename_" + iNumLinha;
    ajax_field_id["languageid_" + iNumLinha] = new Array("hidden_field_label_languageid_", "hidden_field_data_languageid_" + iNumLinha);
    ajax_field_id["languagename_" + iNumLinha] = new Array("hidden_field_label_languagename_", "hidden_field_data_languagename_" + iNumLinha);
    ajax_error_count["languageid_" + iNumLinha] = "off";
    ajax_error_count["languagename_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["languageid_" + iNumLinha] = "on";
    ajax_read_only["languagename_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["languageid_" + iNumLinha] = "on";
    ajax_read_only["languagename_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["languageid_" + iNumLinha] = null;
    ajax_error_list["languagename_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "languageid_": new Array(),
    "languagename_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["languageid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["languageid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["languageid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["languageid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["languageid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["languagename_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["languagename_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["languagename_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["languagename_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["languagename_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['languageid_'])) ? $this->nmgp_cmp_readonly['languageid_'] : 'on';
?>
    scAjaxFieldRead("languageid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['languagename_'])) ? $this->nmgp_cmp_readonly['languagename_'] : 'off';
?>
    scAjaxFieldRead("languagename_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("languageid_" + iSeq, "on");
    scAjaxFieldRead("languagename_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["languageid_" + iRow] || "on" == ajax_error_count["languagename_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_languageid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_languagename_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["languageid_" + iRow] && "off" == ajax_error_count["languagename_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["languageid_" + iRow] = "off";
        ajax_error_count["languagename_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_languageid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_languagename_" + iRow).removeClass("scFormErrorLine");
    }
  }
