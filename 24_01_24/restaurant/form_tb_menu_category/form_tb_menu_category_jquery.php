...
function scEventControl_init(iSeqRow) {
  scEventControl_data["category_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["id_category_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["category_" + iSeqRow] && scEventControl_data["category_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["category_" + iSeqRow] && scEventControl_data["category_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["id_category_" + iSeqRow] && scEventControl_data["id_category_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["id_category_" + iSeqRow] && scEventControl_data["id_category_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_category_' + iSeqRow).bind('blur', function() { sc_form_tb_menu_category_id_category__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tb_menu_category_id_category__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tb_menu_category_id_category__onfocus(this, iSeqRow) });
  $('#id_sc_field_category_' + iSeqRow).bind('blur', function() { sc_form_tb_menu_category_category__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_tb_menu_category_category__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_tb_menu_category_category__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tb_menu_category_id_category__onblur(oThis, iSeqRow) {
  do_ajax_form_tb_menu_category_validate_id_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tb_menu_category_id_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tb_menu_category_id_category__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tb_menu_category_category__onblur(oThis, iSeqRow) {
  do_ajax_form_tb_menu_category_validate_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tb_menu_category_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tb_menu_category_category__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	displayChange_field("category_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_category_(row, status);
...
function displayChange_field_category_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_tb_menu_category_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tb_menu_category')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
