<?php  
  ...
  session_start() ;
  class kitchen_change_status_form_teste
  {
   function kitchen_change_status_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "kitchen_change_status/img";
...
?> 
<br> 
<B><FONT SIZE="4">kitchen_change_status</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="kitchen_change_status"> 
</form> 
...
<?php
  ...
  $frm_teste = new kitchen_change_status_form_teste();
  $frm_teste->kitchen_change_status_teste();
?>
