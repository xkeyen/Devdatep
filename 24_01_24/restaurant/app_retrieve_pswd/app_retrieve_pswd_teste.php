<?php  
  ...
  session_start() ;
  class app_retrieve_pswd_form_teste
  {
   function app_retrieve_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_retrieve_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_retrieve_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_retrieve_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_retrieve_pswd_form_teste();
  $frm_teste->app_retrieve_pswd_teste();
?>
