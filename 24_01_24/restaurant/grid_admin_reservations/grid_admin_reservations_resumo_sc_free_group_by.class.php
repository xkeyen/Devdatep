...
class grid_admin_reservations_resumo
{
   ...
   var $array_total_c_customer_name;
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_c_customer_name;
   var $count_c_customer_name;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_c_customer_name = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_admin_reservations'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_admin_reservations'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_admin_reservations']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_admin_reservations']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_admin_reservations']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'c.customer_name' => [
                    'label' => "Customer Name",
                    'datatype' => 'varchar',
                    'lowercase' => 'c_customer_name',
                    'summary_values_array' => 'array_total_c_customer_name',
                    'summary_line_values_array' => 'array_line_c_customer_name',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'c_customer_name',
            ...
            'dimension_by_lowercase' => [
                'c_customer_name' => 'c.customer_name',
            ],
            'metric_by_index' => [
            ],
            'chart' => [
    ...
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_x_axys'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_group_by'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_x_axys'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_y_axys'] = [];

            $dimensionCount = 0;

            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_x_axys'] [] = $dimensionCount;
            ...
            foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_y_axys'] [] = $dimensionCount;

                $dimensionCount++;
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['dimension_order'] = [];
            foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
            }
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            $dimensionName = $this->SC_APP_info['dimension_by_lowercase'] [$dimensionNameLower];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_order_direction'] [$dimensionIndex];

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['summary_cache']);
        }
    }
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_admin_reservations/index.php";
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                grid_admin_reservations_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_admin_reservations_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_admin_reservations@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_admin_reservations'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_admin_reservations'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_admin_reservations'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_admin_reservations'] ['opcao']) {
            return true;
        }
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_admin_reservations']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_admin_reservations']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['campos_busca'];
         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
         {
             $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
         }
       $this->r_reservation_date = (isset($Busca_temp['r_reservation_date'])) ? $Busca_temp['r_reservation_date'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_date)) ? strpos($this->r_reservation_date, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_date))
       {
           $this->r_reservation_date = substr($this->r_reservation_date, 0, $tmp_pos);
       }
       $r_reservation_date_2 = (isset($Busca_temp['r_reservation_date_input_2'])) ? $Busca_temp['r_reservation_date_input_2'] : ""; 
       $this->r_reservation_date_2 = $r_reservation_date_2; 
       $this->r_reservation_time = (isset($Busca_temp['r_reservation_time'])) ? $Busca_temp['r_reservation_time'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_time)) ? strpos($this->r_reservation_time, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_time))
       {
           $this->r_reservation_time = substr($this->r_reservation_time, 0, $tmp_pos);
       }
       $this->r_number_hours = (isset($Busca_temp['r_number_hours'])) ? $Busca_temp['r_number_hours'] : ""; 
       $tmp_pos = (is_string($this->r_number_hours)) ? strpos($this->r_number_hours, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_number_hours))
       {
           $this->r_number_hours = substr($this->r_number_hours, 0, $tmp_pos);
       }
       $this->r_reservation_endtime = (isset($Busca_temp['r_reservation_endtime'])) ? $Busca_temp['r_reservation_endtime'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_endtime)) ? strpos($this->r_reservation_endtime, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_endtime))
       {
           $this->r_reservation_endtime = substr($this->r_reservation_endtime, 0, $tmp_pos);
       }
     } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'] .= "r_reservation_date?#?" . "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_date'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'] .= "r_reservation_time?#?" . "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_time'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'] .= "r_number_hours?#?" . "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_number_hours'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'] .= "r_reservation_endtime?#?" . "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_endtime'] . "" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_search_add']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_c_customer_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total_line']['c_customer_name'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_c_customer_name = array();
                $this->totaliza();
                ...
                $this->array_line_c_customer_name = $this->array_total_c_customer_name;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_clear_total'] = true;
            }
          $this->array_total_c_customer_name = array();
          $this->totaliza();
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total']['c_customer_name'] = $this->array_total_c_customer_name;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total_line']['c_customer_name'] = $this->array_line_c_customer_name;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary() && !$this->aux_isExport()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['json_use_label'])
       {
          $Lab_c_customer_name = "c.customer_name";
       }
       else
       {
       $Lab_c_customer_name = "Customer Name";
       }
       $prep_field = array();
       $prep_field['c_customer_name'] = $Lab_c_customer_name;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['c_customer_name'] = $Lab_c_customer_name; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_date'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_time'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_number_hours']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_number_hours'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_number_hours'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_people']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_people'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_people'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['s_stage_info']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['s_stage_info'] = "" . $this->Ini->Nm_lang['lang_tb_stages_fld_stage_info'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_endtime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_reservation_endtime'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_endtime'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_customer']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_customer'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_id_customer'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_stage']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_stage'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_id_stage'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['c_customer_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['c_customer_name'] = "" . $this->Ini->Nm_lang['lang_tb_customers_fld_customer_name'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_reservation']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_id_reservation'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_id_reservation'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_confirmation_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['labels']['r_confirmation_date'] = "" . $this->Ini->Nm_lang['lang_tb_reservations_fld_confirmation_date'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['c_customer_name']['alin'] = "''";
       $Arr_parms['c_customer_name']['link'] = "S";
       $Arr_parms['c_customer_name']['fill'] = "true";
       $Arr_parms['c_customer_name']['order'] = "label";
       $Arr_parms['c_customer_name']['order_start'] = 'asc';
       $Arr_parms['c_customer_name']['order_invert'] = 'false';
       $Arr_parms['c_customer_name']['order_enabled'] = 'true';
       $Arr_parms['c_customer_name']['order_datatype'] = 'varchar';
       $Arr_parms['c_customer_name']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['c_customer_name'] = array(0 => 'c_customer_name', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_admin_reservations@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_admin_reservations']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_admin_reservations']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_admin_reservations']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_admin_reservations']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_admin_reservations_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_fast'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_fast'] . ")";
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq_fast'] . ")";
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_resumo_search'] . ")"; 
               }
          }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq']        = $save_where_pesq;
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_tbl_tb_reservations'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_admin_reservations_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_admin_reservations_jquery_544.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_admin_reservations_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_admin_reservations_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_admin_reservations_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_admin_reservations_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_admin_reservations&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid&nm_all_modules=grid&nm_json_format=N&nm_json_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_admin_reservations_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_admin_reservations_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_admin_reservations']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_admin_reservations']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_admin_reservations_config_pivot.php?nome_apl=grid_admin_reservations&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_admin_reservations_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_admin_reservations_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_admin_reservations_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_admin_reservations_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_admin_reservations_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_admin_reservations@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_admin_reservations_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_admin_reservations_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_admin_reservations/grid_admin_reservations_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $r_reservation_date = (isset($Busca_temp['r_reservation_date'])) ? $Busca_temp['r_reservation_date'] : ""; 
          $tmp_pos = (is_string($r_reservation_date)) ? strpos($r_reservation_date, "##@@") : false;
          if ($tmp_pos !== false && !is_array($r_reservation_date))
          {
              $r_reservation_date = substr($r_reservation_date, 0, $tmp_pos);
          }
          $r_reservation_date_2 = (isset($Busca_temp['r_reservation_date_input_2'])) ? $Busca_temp['r_reservation_date_input_2'] : ""; 
          $r_reservation_time = (isset($Busca_temp['r_reservation_time'])) ? $Busca_temp['r_reservation_time'] : ""; 
          $tmp_pos = (is_string($r_reservation_time)) ? strpos($r_reservation_time, "##@@") : false;
          if ($tmp_pos !== false && !is_array($r_reservation_time))
          {
              $r_reservation_time = substr($r_reservation_time, 0, $tmp_pos);
          }
          $r_number_hours = (isset($Busca_temp['r_number_hours'])) ? $Busca_temp['r_number_hours'] : ""; 
          $tmp_pos = (is_string($r_number_hours)) ? strpos($r_number_hours, "##@@") : false;
          if ($tmp_pos !== false && !is_array($r_number_hours))
          {
              $r_number_hours = substr($r_number_hours, 0, $tmp_pos);
          }
          $r_reservation_endtime = (isset($Busca_temp['r_reservation_endtime'])) ? $Busca_temp['r_reservation_endtime'] : ""; 
          $tmp_pos = (is_string($r_reservation_endtime)) ? strpos($r_reservation_endtime, "##@@") : false;
          if ($tmp_pos !== false && !is_array($r_reservation_endtime))
          {
              $r_reservation_endtime = substr($r_reservation_endtime, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_c_customer_name, $quebra_c_customer_name_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->r_reservation_date = $Busca_temp['r_reservation_date']; 
       $this->r_reservation_date = (isset($Busca_temp['r_reservation_date'])) ? $Busca_temp['r_reservation_date'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_date)) ? strpos($this->r_reservation_date, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_date))
       {
       ...
       $r_reservation_date_2 = (isset($Busca_temp['r_reservation_date_input_2'])) ? $Busca_temp['r_reservation_date_input_2'] : ""; 
       $this->r_reservation_date_2 = $r_reservation_date_2; 
       $this->r_reservation_time = $Busca_temp['r_reservation_time']; 
       $this->r_reservation_time = (isset($Busca_temp['r_reservation_time'])) ? $Busca_temp['r_reservation_time'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_time)) ? strpos($this->r_reservation_time, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_time))
       {
       ...
       $this->r_number_hours = $Busca_temp['r_number_hours']; 
       $this->r_number_hours = (isset($Busca_temp['r_number_hours'])) ? $Busca_temp['r_number_hours'] : ""; 
       $tmp_pos = (is_string($this->r_number_hours)) ? strpos($this->r_number_hours, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_number_hours))
       {
       ...
       $this->r_reservation_endtime = $Busca_temp['r_reservation_endtime']; 
       $this->r_reservation_endtime = (isset($Busca_temp['r_reservation_endtime'])) ? $Busca_temp['r_reservation_endtime'] : ""; 
       $tmp_pos = (is_string($this->r_reservation_endtime)) ? strpos($this->r_reservation_endtime, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->r_reservation_endtime))
       {
     ...
     { 
         $nmgp_select = "SELECT str_replace (convert(char(10),r.reservation_date,102), '.', '-') + ' ' + convert(char(8),r.reservation_date,20) as r_reservation_date, str_replace (convert(char(10),r.reservation_time,102), '.', '-') + ' ' + convert(char(8),r.reservation_time,20) as r_reservation_time, r.number_hours as r_number_hours, r.people as r_people, s.stage_info as s_stage_info, str_replace (convert(char(10),r.reservation_endtime,102), '.', '-') + ' ' + convert(char(8),r.reservation_endtime,20) as r_reservation_endtime, r.id_stage as r_id_stage, c.customer_name as c_customer_name, r.id_reservation as r_id_reservation from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT r.reservation_date as r_reservation_date, r.reservation_time as r_reservation_time, r.number_hours as r_number_hours, r.people as r_people, s.stage_info as s_stage_info, r.reservation_endtime as r_reservation_endtime, r.id_stage as r_id_stage, c.customer_name as c_customer_name, r.id_reservation as r_id_reservation from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT convert(char(23),r.reservation_date,121) as r_reservation_date, convert(char(23),r.reservation_time,121) as r_reservation_time, r.number_hours as r_number_hours, r.people as r_people, s.stage_info as s_stage_info, convert(char(23),r.reservation_endtime,121) as r_reservation_endtime, r.id_stage as r_id_stage, c.customer_name as c_customer_name, r.id_reservation as r_id_reservation from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT r.reservation_date as r_reservation_date, r.reservation_time as r_reservation_time, r.number_hours as r_number_hours, r.people as r_people, s.stage_info as s_stage_info, r.reservation_endtime as r_reservation_endtime, r.id_stage as r_id_stage, c.customer_name as c_customer_name, r.id_reservation as r_id_reservation from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->r_reservation_date = $rs_res->fields[0] ;  
            $this->r_reservation_time = $rs_res->fields[1] ;  
            $this->r_number_hours = $rs_res->fields[2] ;  
            $this->r_people = $rs_res->fields[3] ;  
            $this->s_stage_info = $rs_res->fields[4] ;  
            $this->r_reservation_endtime = $rs_res->fields[5] ;  
            $this->r_id_stage = $rs_res->fields[6] ;  
            $this->c_customer_name = $rs_res->fields[7] ;  
            $this->r_id_reservation = $rs_res->fields[8] ;  
            $this->c_customer_name_orig = $this->c_customer_name;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->c_customer_name, $this->c_customer_name_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq'])?'none':'';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['ajax_nav'])
       {
       ...
       else
       {
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['save_grid']))
           {
               $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'NM_Grid_Search', 'value' => $str_display);
           }
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "r_reservation_date")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "r_reservation_date";
                           $lin_obj = $this->grid_search_r_reservation_date($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "r_reservation_time")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "r_reservation_time";
                           $lin_obj = $this->grid_search_r_reservation_time($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "r_number_hours")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "r_number_hours";
                           $lin_obj = $this->grid_search_r_number_hours($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "r_reservation_endtime")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "r_reservation_endtime";
                           $lin_obj = $this->grid_search_r_reservation_endtime($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('r_reservation_date','r_reservation_time','r_number_hours','r_reservation_endtime');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_r_reservation_date($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_r_reservation_date_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_r_reservation_date_cond_" . $ind . "' name='cond_grid_search_r_reservation_date_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_change_bw(\"r_reservation_date\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_r_reservation_date_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $Form_base          = "ddmmyyyy";
       $date_format_show   = "";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_ano_val_" . $ind . "' name='val_grid_search_r_reservation_date_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_mes_val_" . $ind . "' name='val_grid_search_r_reservation_date_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_dia_val_" . $ind . "' name='val_grid_search_r_reservation_date_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "<br />";
       ...
       $lin_obj .= "       <span id=\"grid_r_reservation_date_in_2_" . $ind . "\" style=\"display:" . $display_in_2 . "\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_v2__ano_val_" . $ind . "' name='val_grid_search_r_reservation_date_v2__ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_v2__mes_val_" . $ind . "' name='val_grid_search_r_reservation_date_v2__mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_date_v2__dia_val_" . $ind . "' name='val_grid_search_r_reservation_date_v2__dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "<br />";
       $lin_obj .= "" . $date_format_show . "";
   ...
   function grid_search_r_reservation_time($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_r_reservation_time_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_r_reservation_time_cond_" . $ind . "' name='cond_grid_search_r_reservation_time_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"r_reservation_time\", $ind)'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_r_reservation_time_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $Form_base          = "hhiiss";
       $date_format_show   = "";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "h")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_time_hor_val_" . $ind . "' name='val_grid_search_r_reservation_time_hor_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "i")
           {
               $val_cmp = (isset($val_r['min'])) ? $val_r['min'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_time_min_val_" . $ind . "' name='val_grid_search_r_reservation_time_min_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "s")
           {
               $val_cmp = (isset($val_r['seg'])) ? $val_r['seg'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_time_seg_val_" . $ind . "' name='val_grid_search_r_reservation_time_seg_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "<br />";
       $lin_obj .= "" . $date_format_show . "";
   ...
   function grid_search_r_number_hours($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_r_number_hours_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_r_number_hours_cond_" . $ind . "' name='cond_grid_search_r_number_hours_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"r_number_hours\", $ind)'>";
       $selected = ($opc == "gt") ? " selected" : "";
       $lin_obj .= "        <option value='gt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_grtr'] . "</option>";
       $selected = ($opc == "lt") ? " selected" : "";
       $lin_obj .= "        <option value='lt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_less'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_r_number_hours_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       ...
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_number_hours_val_" . $ind . "' name='val_grid_search_r_number_hours_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=11 alt=\"{datatype: 'decimal', maxLength: 11, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search_res')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search_res')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_r_reservation_endtime($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_r_reservation_endtime_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_r_reservation_endtime_cond_" . $ind . "' name='cond_grid_search_r_reservation_endtime_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"r_reservation_endtime\", $ind)'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $selected = ($opc == "ii") ? " selected" : "";
       $lin_obj .= "        <option value='ii'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_stts_with'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_r_reservation_endtime_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $Form_base          = "hhiiss";
       $date_format_show   = "";
       $Str_time = strtolower($_SESSION['scriptcase']['reg_conf']['time_format']);
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['hor'])) ? $val_r['hor'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_endtime_hor_val_" . $ind . "' name='val_grid_search_r_reservation_endtime_hor_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "i")
           {
               $val_cmp = (isset($val_r['min'])) ? $val_r['min'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_endtime_min_val_" . $ind . "' name='val_grid_search_r_reservation_endtime_min_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "s")
           {
               $val_cmp = (isset($val_r['seg'])) ? $val_r['seg'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_r_reservation_endtime_seg_val_" . $ind . "' name='val_grid_search_r_reservation_endtime_seg_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "<br />";
       $lin_obj .= "" . $date_format_show . "";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "restaurant/grid_admin_reservations";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_admin_reservations_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_admin_reservations_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_admin_reservations_valida_hora(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_admin_reservations_valida_min(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_admin_reservations_valida_seg(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       $nm_saida->saida("     if (obj.value != \"\" && (obj.value < 0 || obj.value > 59))\r\n");
       $nm_saida->saida("     {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_date_mes'] =  'sc_grid_admin_reservations_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_date_dia'] =  'sc_grid_admin_reservations_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_date_v2__mes'] =  'sc_grid_admin_reservations_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_date_v2__dia'] =  'sc_grid_admin_reservations_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_time_hor'] =  'sc_grid_admin_reservations_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_time_min'] =  'sc_grid_admin_reservations_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_time_seg'] =  'sc_grid_admin_reservations_valida_seg(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_endtime_hor'] =  'sc_grid_admin_reservations_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_endtime_min'] =  'sc_grid_admin_reservations_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['r_reservation_endtime_seg'] =  'sc_grid_admin_reservations_valida_seg(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_reservations']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_date_mes']", 'value' => 'sc_grid_admin_reservations_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_date_dia']", 'value' => 'sc_grid_admin_reservations_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_date_v2__mes']", 'value' => 'sc_grid_admin_reservations_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_date_v2__dia']", 'value' => 'sc_grid_admin_reservations_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_time_hor']", 'value' => 'sc_grid_admin_reservations_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_time_min']", 'value' => 'sc_grid_admin_reservations_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_time_seg']", 'value' => 'sc_grid_admin_reservations_valida_seg(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_endtime_hor']", 'value' => 'sc_grid_admin_reservations_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_endtime_min']", 'value' => 'sc_grid_admin_reservations_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['r_reservation_endtime_seg']", 'value' => 'sc_grid_admin_reservations_valida_seg(this)');
       } 
       ...
       $nm_saida->saida("                 if (tmp == 'r_reservation_date')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_date_dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_date_mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_date_v2__dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_date_v2__mes';\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'r_reservation_time')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_time_hor';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_time_min';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_time_seg';\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'r_reservation_endtime')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_endtime_hor';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_endtime_min';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'r_reservation_endtime_seg';\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("         {\r\n");
       $nm_saida->saida("             $('#NM_Grid_Search').css('display','none');\r\n");
       $nm_saida->saida("         }\r\n");
       $nm_saida->saida("     }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'r_reservation_date')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'r_reservation_time')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_dyn = 'grid_search_' + Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                     result  = grid_search_get_dt_h(obj_dyn, i, 'HH');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'r_number_hours')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'r_reservation_endtime')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_dyn = 'grid_search_' + Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                     result  = grid_search_get_dt_h(obj_dyn, i, 'HH');\r\n");
       $nm_saida->saida("                 }\r\n");
