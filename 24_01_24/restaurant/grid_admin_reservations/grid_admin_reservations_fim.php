...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_admin_reservations"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_admin_reservations"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_reservations'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_admin_reservations</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_admin_reservations']['embutida_filho'] as $ind => $sc_init)
          {
