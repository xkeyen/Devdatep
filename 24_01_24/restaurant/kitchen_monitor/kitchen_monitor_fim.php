...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____kitchen_monitor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____kitchen_monitor"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['kitchen_monitor']['embutida_filho'] as $ind => $sc_init)
          {
