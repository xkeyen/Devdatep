<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['kitchen_monitor']['glo_nm_path_imag_temp'] . "/sc_apl_default_restaurant.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new kitchen_monitor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class kitchen_monitor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tb_orders_id_order"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_id_order"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_id_order"] : "" . $this->Nm_lang['lang_tb_orders_fld_id_order'] . "";
   ...
   $tab_labels["tb_order_table_id_table"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_order_table_id_table"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_order_table_id_table"] : "" . $this->Nm_lang['lang_tb_order_table_fld_id_table'] . "";
   ...
   $tab_labels["tb_orders_user_login"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_user_login"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_user_login"] : "" . $this->Nm_lang['lang_tb_orders_fld_user_login'] . "";
   ...
   $tab_labels["tb_orders_order_status"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_order_status"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["tb_orders_order_status"] : "" . $this->Nm_lang['lang_tb_orders_fld_order_status'] . "";
   $tab_ger_campos['items'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['items'] = "items";
   }
   else
   {
       $tab_def_campos['items'] = "";
   }
   $tab_labels["items"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["items"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["items"] : "items";
   $tab_ger_campos['fl_header'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_header'] = "fl_header";
   }
   else
   {
       $tab_def_campos['fl_header'] = "";
   }
   $tab_labels["fl_header"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["fl_header"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["fl_header"] : "fl_header";
   $tab_ger_campos['act'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['act'] = "act";
   }
   else
   {
       $tab_def_campos['act'] = "";
   }
   $tab_labels["act"]   = (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["act"])) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['labels']["act"] : "act";
   $tab_ger_campos['items'] = "none";
   $tab_ger_campos['fl_header'] = "none";
   $tab_ger_campos['act'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['kitchen_monitor']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['kitchen_monitor']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['kitchen_monitor']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_kitchen'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "kitchen_monitor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['kitchen_monitor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
