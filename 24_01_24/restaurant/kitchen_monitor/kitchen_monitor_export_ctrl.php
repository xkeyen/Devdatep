<?php
@session_start() ;
$_SESSION['scriptcase']['kitchen_monitor']['sc_process_barr'] = true;
require_once('../kitchen_monitor/index.php');
unset($_SESSION['scriptcase']['kitchen_monitor']['sc_process_barr']);
$ExportCtrl = new kitchen_monitor_export_control;
$ExportCtrl->Export_barr();

class kitchen_monitor_export_control
{
