...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "kitchen_monitor/kitchen_monitor_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_label'];
          $this->New_Format    = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arq_zip      = $this->Arquivo . "_kitchen_monitor.zip";
      $this->Arquivo     .= "_kitchen_monitor";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "kitchen_monitor.xml";
      $this->Tit_zip      = "kitchen_monitor.zip";
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_kitchen_items_cons_emb, '/');
      $link_xml = substr($this->Ini->link_kitchen_items_cons_emb, 0, $pos) . "/kitchen_items_xml.class.php";
      if (!is_file($this->Ini->link_kitchen_items_cons_emb) || !is_file($link_xml))
      {
          $this->NM_cmp_hidden['items'] = "off";
      }
      else
      {
...
$_SESSION['scriptcase']['kitchen_monitor']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<kitchen_monitor>\r\n";
         }
         else
         {
             $this->xml_registro = "<kitchen_monitor";
...
$_SESSION['scriptcase']['kitchen_monitor']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "kitchen_monitor_res_xml.class.php");
              $this->Res = new kitchen_monitor_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_res_grid']);
          } 
      }
   ...
   function NM_export_tb_orders_id_order()
   {
         ...
         {
             $SC_Label = (isset($this->New_label['tb_orders_id_order'])) ? $this->New_label['tb_orders_id_order'] : "" . $this->Ini->Nm_lang['lang_tb_orders_fld_id_order'] . ""; 
         }
         else
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->tb_orders_id_order) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->tb_orders_id_order) . "\"";
         }
   }
   ...
   function NM_export_tb_order_table_id_table()
   {
         ...
         if ($this->Xml_tag_label)
         {
             $SC_Label = (isset($this->New_label['tb_order_table_id_table'])) ? $this->New_label['tb_order_table_id_table'] : "" . $this->Ini->Nm_lang['lang_tb_order_table_fld_id_table'] . ""; 
         }
         else
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->tb_order_table_id_table) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->tb_order_table_id_table) . "\"";
         }
   }
   //----- tb_orders_user_login
   function NM_export_tb_orders_user_login()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->tb_orders_user_login))
         {
             $this->tb_orders_user_login = sc_convert_encoding($this->tb_orders_user_login, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
             $SC_Label = (isset($this->New_label['tb_orders_user_login'])) ? $this->New_label['tb_orders_user_login'] : "" . $this->Ini->Nm_lang['lang_tb_orders_fld_user_login'] . ""; 
         }
         else
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->tb_orders_user_login) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->tb_orders_user_login) . "\"";
         }
   }
   ...
   function NM_export_tb_orders_order_status()
   {
         ...
         if ($this->Xml_tag_label)
         {
             $SC_Label = (isset($this->New_label['tb_orders_order_status'])) ? $this->New_label['tb_orders_order_status'] : "" . $this->Ini->Nm_lang['lang_tb_orders_fld_order_status'] . ""; 
         }
         else
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->tb_orders_order_status) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->tb_orders_order_status) . "\"";
         }
   }
   //----- items
   function NM_export_items()
   {
              if ($this->New_Format)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida']  = true;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['xml_label'] = $this->Xml_tag_label;
                  $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xml?@?";
                  $detailParameters = array();
                  $detailParameters[] = "var_id_order?#?" . str_replace("'", "@aspass@", $this->Orig_tb_orders_id_order);
                  $GLOBALS["nmgp_parms"] .= implode('?@?', $detailParameters) . '?@?';
                  if ($this->Xml_tag_label)
                  {
                      $SC_Label = (isset($this->New_label['items'])) ? $this->New_label['items'] : "items"; 
                  }
                  else
                  {
                      $SC_Label = "items"; 
                  ...
                  $this->clear_tag($SC_Label); 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida_tit'] = "items";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida_xml_format'] = $this->New_Format;
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fl_header))
         {
             $this->fl_header = sc_convert_encoding($this->fl_header, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fl_header) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fl_header) . "\"";
         }
   }
   //----- act
   function NM_export_act()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->act))
         {
             $this->act = sc_convert_encoding($this->act, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->act) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->act) . "\"";
         }
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_kitchen'] ?> :: XML</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
