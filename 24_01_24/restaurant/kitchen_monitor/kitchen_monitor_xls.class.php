...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "kitchen_monitor/kitchen_monitor_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "kitchen_monitor_res_xls.class.php");
              $this->Res_xls = new kitchen_monitor_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_kitchen_monitor.zip";
          $this->Arquivo   .= "_kitchen_monitor" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $link_xls = substr($this->Ini->link_kitchen_items_cons_emb, 0, $pos) . "/kitchen_items_xls.class.php";
      if (!is_file($this->Ini->link_kitchen_items_cons_emb) || !is_file($link_xls))
      {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['kitchen_monitor']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['kitchen_monitor']['contr_erro'] = 'off'; 
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['field_order'] as $Cada_col)
         { 
            if ($Cada_col == "items" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
            { 
                $xls_row_base = $this->Xls_row;
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'])
                { 
                    foreach ($this->Rows_sub_items as $line => $cols)
                    {
                        $this->Xls_row++;
                        $this->arr_export['lines'][$this->Xls_row] = $cols;
                    }
                    if (!empty($this->Rows_sub_items['lines']))
                    {
                ...
                { 
                    foreach ($this->Rows_sub_items as $lines)
                    {
                        $this->Xls_col = 0;
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      $rs->Close();
      if (isset($this->kitchen_items) && method_exists($this->kitchen_items, "close_emb")) 
      {
          $this->kitchen_items->close_emb();
      }
   }
   function proc_label()
   { 
      ...
      { 
          ...
          if ($Cada_col == "items" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['items'] = $this->count_span;
              $this->Emb_label_cols_items = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_items += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_items += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_items++;
                         }
                     }
                  }
                  $this->count_span += $this->Emb_label_cols_items;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida'] = false;
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['embutida'])
              { 
                  $this->arr_export['label'][$this->Xls_col]['col_span_f'] = $this->Emb_label_cols_items;
                  $this->Xls_col++;
              }
              else
              { 
                  $this->Xls_col += $this->Emb_label_cols_items;
              } 
          }
   ...
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?var_id_order?#?" . str_replace("'", "@aspass@", $this->Orig_tb_orders_id_order) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_items']['nolabel'] = false;
         if (method_exists($this->kitchen_items, "controle"))
         {
             $this->kitchen_items->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_items = array();
                 if (isset($_SESSION['scriptcase']['export_return']['label']))
                 {
                     $_SESSION['scriptcase']['export_return']['label'][0]['col_span_i'] = $this->arr_span['items'];
                     $this->Xls_col += $this->Emb_label_cols_items;
                 }
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         {
                             $this->Rows_sub_items[$line][$icol] = $dados;
                             if ($prim_col)
                             {
                                 if (isset($this->Rows_sub_items[$line][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_items[$line][$icol]['col_span_i'] += $this->arr_span['items'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_items[$line][$icol]['col_span_i'] = $this->arr_span['items'];
   ...
   function NM_export_fl_header()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fl_header, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fl_header, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- act
   function NM_export_act()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->act, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->act, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tb_orders_id_order
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 ...
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     ...
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         foreach ($cols as $icol => $dados)
                         {
                             $this->Rows_sub_items[$this->row_sub][$icol] = $dados;
                             if ($prim_col && $this->row_sub > 1)
                             {
                                 if (isset($this->Rows_sub_items[$this->row_sub][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_items[$this->row_sub][$icol]['col_span_i'] += $this->arr_span['items'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_items[$this->row_sub][$icol]['col_span_i'] = $this->arr_span['items'];
   ...
   //----- fl_header
   function NM_sub_cons_fl_header()
   {
         $this->fl_header = html_entity_decode($this->fl_header, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fl_header = strip_tags($this->fl_header);
         $this->fl_header = NM_charset_to_utf8($this->fl_header);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fl_header;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- act
   function NM_sub_cons_act()
   {
         $this->act = html_entity_decode($this->act, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->act = strip_tags($this->act);
         $this->act = NM_charset_to_utf8($this->act);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->act;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['kitchen_monitor']['nolabel'])
       {
