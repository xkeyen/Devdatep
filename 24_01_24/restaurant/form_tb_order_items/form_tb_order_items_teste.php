<?php  
  ...
  session_start() ;
  class form_tb_order_items_form_teste
  {
   function form_tb_order_items_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_order_items/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tb_order_items</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_tb_order_items"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tb_order_items_form_teste();
  $frm_teste->form_tb_order_items_teste();
?>
