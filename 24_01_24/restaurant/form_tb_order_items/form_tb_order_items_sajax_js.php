  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_order_items" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_order_items_form();
	}
...
?>
  ...
  // ---------- Validate id_menu_
  function do_ajax_form_tb_order_items_validate_id_menu_(iNumLinha)
  {
    var nomeCampo_id_menu_ = "id_menu_" + iNumLinha;
    var var_id_menu_ = scAjaxGetFieldSelect(nomeCampo_id_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_items_validate_id_menu_(var_id_menu_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_items_validate_id_menu__cb);
  } // do_ajax_form_tb_order_items_validate_id_menu_

  function do_ajax_form_tb_order_items_validate_id_menu__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_menu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_menu_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_items_validate_id_menu__cb

  // ---------- Validate unit_value_
  function do_ajax_form_tb_order_items_validate_unit_value_(iNumLinha)
  {
    var nomeCampo_unit_value_ = "unit_value_" + iNumLinha;
    var var_unit_value_ = scAjaxGetFieldHidden(nomeCampo_unit_value_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_items_validate_unit_value_(var_unit_value_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_items_validate_unit_value__cb);
  } // do_ajax_form_tb_order_items_validate_unit_value_

  function do_ajax_form_tb_order_items_validate_unit_value__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unit_value_" + iLineNumber;
    }
    else
    {
      sFieldValid = "unit_value_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_items_validate_unit_value__cb

  // ---------- Validate quantity_
  function do_ajax_form_tb_order_items_validate_quantity_(iNumLinha)
  {
    var nomeCampo_quantity_ = "quantity_" + iNumLinha;
    var var_quantity_ = scAjaxGetFieldText(nomeCampo_quantity_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_items_validate_quantity_(var_quantity_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_items_validate_quantity__cb);
  } // do_ajax_form_tb_order_items_validate_quantity_

  function do_ajax_form_tb_order_items_validate_quantity__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_items_validate_quantity__cb

  // ---------- Validate total_value_
  function do_ajax_form_tb_order_items_validate_total_value_(iNumLinha)
  {
    var nomeCampo_total_value_ = "total_value_" + iNumLinha;
    var var_total_value_ = scAjaxGetFieldHidden(nomeCampo_total_value_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_items_validate_total_value_(var_total_value_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_items_validate_total_value__cb);
  } // do_ajax_form_tb_order_items_validate_total_value_

  function do_ajax_form_tb_order_items_validate_total_value__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "total_value_" + iLineNumber;
    }
    else
    {
      sFieldValid = "total_value_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_items_validate_total_value__cb

  // ---------- Event onchange id_menu_
  function do_ajax_form_tb_order_items_event_id_menu__onchange(iSeqForm)
  {
    var var_id_menu_ = scAjaxGetFieldSelect("id_menu_" + iSeqForm);
    var var_unit_value_ = scAjaxGetFieldHidden("unit_value_" + iSeqForm);
    var var_total_value_ = scAjaxGetFieldHidden("total_value_" + iSeqForm);
    var var_quantity_ = scAjaxGetFieldText("quantity_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tb_order_items_event_id_menu__onchange(var_id_menu_, var_unit_value_, var_total_value_, var_quantity_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tb_order_items_event_id_menu__onchange_cb);
  } // do_ajax_form_tb_order_items_event_id_menu__onchange

  function do_ajax_form_tb_order_items_event_id_menu__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_order_items_event_id_menu__onchange_cb_after_alert);
  } // do_ajax_form_tb_order_items_event_id_menu__onchange_cb
  function do_ajax_form_tb_order_items_event_id_menu__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_order_items_event_id_menu__onchange_cb_after_alert

  // ---------- Event onchange quantity_
  function do_ajax_form_tb_order_items_event_quantity__onchange(iSeqForm)
  {
    var var_id_menu_ = scAjaxGetFieldSelect("id_menu_" + iSeqForm);
    var var_unit_value_ = scAjaxGetFieldHidden("unit_value_" + iSeqForm);
    var var_total_value_ = scAjaxGetFieldHidden("total_value_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_tb_order_items_event_quantity__onchange(var_id_menu_, var_unit_value_, var_total_value_, var_quantity_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_tb_order_items_event_quantity__onchange_cb);
  } // do_ajax_form_tb_order_items_event_quantity__onchange

  function do_ajax_form_tb_order_items_event_quantity__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_order_items_event_quantity__onchange_cb_after_alert);
  } // do_ajax_form_tb_order_items_event_quantity__onchange_cb
  function do_ajax_form_tb_order_items_event_quantity__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_order_items_event_quantity__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tb_order_items_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tb_order_items_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_order_items_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tb_order_items_add_new_line_cb);
  } // do_ajax_form_tb_order_items_add_new_line

  function do_ajax_form_tb_order_items_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tb_order_items_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tb_order_items_backup_line(iNumLinha)
  {
    var var_id_order_item_ = scAjaxGetFieldText("id_order_item_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_items_backup_line(var_id_order_item_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tb_order_items_backup_line_cb);
  } // do_ajax_form_tb_order_items_backup_line

  function do_ajax_form_tb_order_items_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tb_order_items_backup_line_cb

  function do_ajax_form_tb_order_items_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tb_order_items_cancel_insert

  function do_ajax_form_tb_order_items_cancel_update(iSeqVert)
  {
    do_ajax_form_tb_order_items_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tb_order_items_cancel_update

  function do_ajax_form_tb_order_items_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tb_order_items_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tb_order_items_table_refresh()
  {
    var var_id_order_item_ = document.F2.id_order_item_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_order_items_table_refresh(var_id_order_item_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_order_items_table_refresh_cb);
  } //  do_ajax_form_tb_order_items_table_refresh

  function do_ajax_form_tb_order_items_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_order_item_.value = scAjaxGetKeyValue("id_order_item_");
    ...
    scAjaxAlert(do_ajax_form_tb_order_items_table_refresh_cb_after_alert);
  } // do_ajax_form_tb_order_items_table_refresh_cb
  function do_ajax_form_tb_order_items_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_tb_order_items_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tb_order_items_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tb_order_items_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_menu_ = scAjaxGetFieldSelect("id_menu_" + iNumLinha);
    var var_unit_value_ = scAjaxGetFieldHidden("unit_value_" + iNumLinha);
    var var_quantity_ = scAjaxGetFieldText("quantity_" + iNumLinha);
    var var_total_value_ = scAjaxGetFieldHidden("total_value_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tb_order_items_submit_form(var_id_menu_, var_unit_value_, var_quantity_, var_total_value_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_order_items_submit_form_cb);
  } // do_ajax_form_tb_order_items_submit_form

  function do_ajax_form_tb_order_items_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_order_items_submit_form_cb_after_alert);
  } // do_ajax_form_tb_order_items_submit_form_cb
  function do_ajax_form_tb_order_items_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_order_items_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_order_items_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_order_items_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_order_items_navigate_form();
    }
  }

  function perform_ajax_form_tb_order_items_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tb_order_items_cancel_insert(sc_form_tb_order_items_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_order_items_navigate_form(var_id_order_item_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_order_items_navigate_form_cb);
  } // do_ajax_form_tb_order_items_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_order_items']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_order_items_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_order_item_.value = scAjaxGetKeyValue("id_order_item_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_order_items_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_order_items_navigate_form_cb
  function do_ajax_form_tb_order_items_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tb_order_items_navigate_form_cb_after_alert

    function sc_form_tb_order_items_get_last_line_number()
    {
    ...
    } //sc_form_tb_order_items_get_last_line_number

  function sc_hide_form_tb_order_items_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_menu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unit_value_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantity_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "total_value_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_menu_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_id_menu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["unit_value_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_price'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["quantity_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_quantity'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["total_value_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_total_value'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_menu_"][iNumLinha] = "id_menu_" + iNumLinha;
    ajax_field_mult["unit_value_"][iNumLinha] = "unit_value_" + iNumLinha;
    ajax_field_mult["quantity_"][iNumLinha] = "quantity_" + iNumLinha;
    ajax_field_mult["total_value_"][iNumLinha] = "total_value_" + iNumLinha;
    ajax_field_id["id_menu_" + iNumLinha] = new Array("hidden_field_label_id_menu_", "hidden_field_data_id_menu_" + iNumLinha);
    ajax_field_id["unit_value_" + iNumLinha] = new Array("hidden_field_label_unit_value_", "hidden_field_data_unit_value_" + iNumLinha);
    ajax_field_id["quantity_" + iNumLinha] = new Array("hidden_field_label_quantity_", "hidden_field_data_quantity_" + iNumLinha);
    ajax_field_id["total_value_" + iNumLinha] = new Array("hidden_field_label_total_value_", "hidden_field_data_total_value_" + iNumLinha);
    ajax_error_count["id_menu_" + iNumLinha] = "off";
    ajax_error_count["unit_value_" + iNumLinha] = "off";
    ajax_error_count["quantity_" + iNumLinha] = "off";
    ajax_error_count["total_value_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_menu_" + iNumLinha] = "off";
    ajax_read_only["unit_value_" + iNumLinha] = "off";
    ajax_read_only["quantity_" + iNumLinha] = "off";
    ajax_read_only["total_value_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_menu_" + iNumLinha] = "on";
    ajax_read_only["unit_value_" + iNumLinha] = "on";
    ajax_read_only["quantity_" + iNumLinha] = "on";
    ajax_read_only["total_value_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_menu_" + iNumLinha] = null;
    ajax_error_list["unit_value_" + iNumLinha] = null;
    ajax_error_list["quantity_" + iNumLinha] = null;
    ajax_error_list["total_value_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_menu_": new Array(),
    "unit_value_": new Array(),
    "quantity_": new Array(),
    "total_value_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_menu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_menu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_menu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_menu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_menu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["unit_value_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unit_value_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unit_value_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unit_value_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unit_value_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["total_value_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["total_value_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["total_value_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["total_value_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["total_value_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_menu_'])) ? $this->nmgp_cmp_readonly['id_menu_'] : 'off';
?>
    scAjaxFieldRead("id_menu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unit_value_'])) ? $this->nmgp_cmp_readonly['unit_value_'] : 'off';
?>
    scAjaxFieldRead("unit_value_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['total_value_'])) ? $this->nmgp_cmp_readonly['total_value_'] : 'off';
?>
    scAjaxFieldRead("total_value_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_menu_" + iSeq, "on");
    scAjaxFieldRead("unit_value_" + iSeq, "on");
    scAjaxFieldRead("quantity_" + iSeq, "on");
    scAjaxFieldRead("total_value_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_menu_" + iRow] || "on" == ajax_error_count["unit_value_" + iRow] || "on" == ajax_error_count["quantity_" + iRow] || "on" == ajax_error_count["total_value_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_menu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unit_value_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantity_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_total_value_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_menu_" + iRow] && "off" == ajax_error_count["unit_value_" + iRow] && "off" == ajax_error_count["quantity_" + iRow] && "off" == ajax_error_count["total_value_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_menu_" + iRow] = "off";
        ajax_error_count["unit_value_" + iRow] = "off";
        ajax_error_count["quantity_" + iRow] = "off";
        ajax_error_count["total_value_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_menu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unit_value_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quantity_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_total_value_" + iRow).removeClass("scFormErrorLine");
    }
  }
