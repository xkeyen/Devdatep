...
//
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
<?php 
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = 0;
               }
               $rsc->Close(); 
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['opcao'] = '';
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] + 1,
            ],
            $summaryLine
        );
