<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_receipt']['glo_nm_path_imag_temp'] . "/sc_apl_default_restaurant.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_receipt_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_receipt_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['tb_orders_id_order'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_id_order'] = "tb_orders_id_order";
   }
   else
   {
       $tab_def_campos['tb_orders_id_order'] = "tb_orders.id_order";
   }
   $tab_labels["tb_orders_id_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_id_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_id_order"] : "Id Order";
   $tab_ger_campos['tb_orders_dt_order_start'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_dt_order_start'] = "tb_orders_dt_order_start";
   }
   else
   {
       $tab_def_campos['tb_orders_dt_order_start'] = "tb_orders.dt_order_start";
   }
   $tab_labels["tb_orders_dt_order_start"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_dt_order_start"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_dt_order_start"] : "Dt Order Start";
   $tab_ger_campos['tb_orders_dt_order_end'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_dt_order_end'] = "tb_orders_dt_order_end";
   }
   else
   {
       $tab_def_campos['tb_orders_dt_order_end'] = "tb_orders.dt_order_end";
   }
   $tab_labels["tb_orders_dt_order_end"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_dt_order_end"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_dt_order_end"] : "Dt Order End";
   $tab_ger_campos['tb_orders_order_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_order_status'] = "tb_orders_order_status";
   }
   else
   {
       $tab_def_campos['tb_orders_order_status'] = "tb_orders.order_status";
   }
   $tab_labels["tb_orders_order_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_order_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_order_status"] : "Order Status";
   $tab_ger_campos['tb_orders_order_value'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_order_value'] = "tb_orders_order_value";
   }
   else
   {
       $tab_def_campos['tb_orders_order_value'] = "tb_orders.order_value";
   }
   $tab_labels["tb_orders_order_value"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_order_value"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_order_value"] : "Order Value";
   $tab_ger_campos['tb_orders_user_login'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_user_login'] = "tb_orders_user_login";
   }
   else
   {
       $tab_def_campos['tb_orders_user_login'] = "tb_orders.user_login";
   }
   $tab_labels["tb_orders_user_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_user_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_user_login"] : "User Login";
   $tab_ger_campos['tb_orders_people'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_orders_people'] = "tb_orders_people";
   }
   else
   {
       $tab_def_campos['tb_orders_people'] = "tb_orders.people";
   }
   $tab_labels["tb_orders_people"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_people"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_orders_people"] : "People";
   $tab_ger_campos['tb_order_table_id_order'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_order_table_id_order'] = "tb_order_table_id_order";
   }
   else
   {
       $tab_def_campos['tb_order_table_id_order'] = "tb_order_table.id_order";
   }
   $tab_labels["tb_order_table_id_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_id_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_id_order"] : "Id Order";
   $tab_ger_campos['tb_order_table_id_table'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_order_table_id_table'] = "tb_order_table_id_table";
   }
   else
   {
       $tab_def_campos['tb_order_table_id_table'] = "tb_order_table.id_table";
   }
   $tab_labels["tb_order_table_id_table"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_id_table"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_id_table"] : "Id Table";
   $tab_ger_campos['tb_order_table_main_table'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_order_table_main_table'] = "tb_order_table_main_table";
   }
   else
   {
       $tab_def_campos['tb_order_table_main_table'] = "tb_order_table.main_table";
   }
   $tab_labels["tb_order_table_main_table"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_main_table"])) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['labels']["tb_order_table_main_table"] : "Main Table";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_receipt']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_receipt']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_receipt']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_receipt']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_receipt']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_receipt_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_receipt']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
