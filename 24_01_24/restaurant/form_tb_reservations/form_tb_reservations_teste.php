<?php  
  ...
  session_start() ;
  class form_tb_reservations_form_teste
  {
   function form_tb_reservations_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_reservations/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tb_reservations</FONT></B> 
<br> 
<br> 
...
Id_reservation&nbsp;&nbsp;<input type=text name=id_reservation size=20><br> 
<input type="submit" value="form_tb_reservations"> 
</form> 
<script language=javascript> 
 document.Fedit.id_reservation.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_tb_reservations_form_teste();
  $frm_teste->form_tb_reservations_teste();
?>
