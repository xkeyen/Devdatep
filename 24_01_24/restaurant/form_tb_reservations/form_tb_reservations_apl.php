<?php
//
class form_tb_reservations_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_tb_reservations_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_tb_reservations']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tb_reservations']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_tb_reservations'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tb_reservations']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tb_reservations']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_tb_reservations') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_tb_reservations']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " " . $this->Ini->Nm_lang['lang_tbl_tb_reservations'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_tb_reservations']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_tb_reservations'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_tb_reservations']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tb_reservations'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_tb_reservations'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_tb_reservations/form_tb_reservations_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_tb_reservations_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_tb_reservations_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_tb_reservations_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_tb_reservations/form_tb_reservations_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_tb_reservations_erro.class.php"); 
      }
      $this->Erro      = new form_tb_reservations_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao']))
         { 
             if ($this->id_reservation != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_tb_reservations']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_tb_reservations']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_tb_reservations']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_tb_reservations.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_tb_reservations_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_tb_reservations"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_tb_reservations']) || !is_array($this->NM_ajax_info['errList']['geral_form_tb_reservations']))
              {
                  $this->NM_ajax_info['errList']['geral_form_tb_reservations'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_tb_reservations'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
      ...
      {
      $_SESSION['scriptcase']['form_tb_reservations']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_tb_reservations']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['id_stage'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage']) && !in_array($this->id_stage, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage']))
          {
              $hasError = true;
 ...
 nm_limpa_hora($this->reservation_time, $this->field_config['reservation_time']['time_sep']) ; 
   ...
   if (isset($this->Field_no_validate['id_customer'])) {
       return;
               ...
               if (!empty($this->id_customer) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer']) && !in_array($this->id_customer, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_reservation']['keyVal'] = form_tb_reservations_pack_protect_string($this->nmgp_dados_form['id_reservation']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_tb_reservations_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_tb_reservations_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_stage'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_stage']['valList'][$i] = form_tb_reservations_pack_protect_string($v);
          }
...
$aLookup[] = array(form_tb_reservations_pack_protect_string('09:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("09:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('10:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("10:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('11:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("11:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('12:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("12:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('16:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("16:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('17:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("17:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('18:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("18:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('19:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("19:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('20:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("20:00")));
$aLookup[] = array(form_tb_reservations_pack_protect_string('21:00') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string("21:00")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '09:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '10:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '11:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '12:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '16:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '17:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '18:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '19:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '20:00';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_reservation_time'][] = '21:00';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['reservation_time']['valList'][$i] = form_tb_reservations_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer'] = array(); 
}
$aLookup[] = array(form_tb_reservations_pack_protect_string('') => str_replace('<', '&lt;',form_tb_reservations_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Lookup_id_customer'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_customer']['valList'][$i] = form_tb_reservations_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_confirmation_date($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['Field_no_validate'] = array();
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_reservation)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['form_tb_reservations']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['parms'] = "id_reservation?#?$this->id_reservation?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_tb_reservations_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_tb_reservations = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] = $qt_geral_reg_form_tb_reservations;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_tb_reservations_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_tb_reservations_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_tb_reservations_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations']['ordem_ord'] == " desc") {
