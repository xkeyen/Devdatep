  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_reservations_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_reservations_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_stage
  function do_ajax_form_tb_reservations_mob_validate_id_stage()
  {
    var nomeCampo_id_stage = "id_stage";
    var var_id_stage = scAjaxGetFieldRadio(nomeCampo_id_stage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_id_stage(var_id_stage, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_id_stage_cb);
  } // do_ajax_form_tb_reservations_mob_validate_id_stage

  function do_ajax_form_tb_reservations_mob_validate_id_stage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_stage";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_id_stage_cb

  // ---------- Validate reservation_date
  function do_ajax_form_tb_reservations_mob_validate_reservation_date()
  {
    var nomeCampo_reservation_date = "reservation_date";
    var var_reservation_date = scAjaxGetFieldText(nomeCampo_reservation_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_reservation_date(var_reservation_date, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_reservation_date_cb);
  } // do_ajax_form_tb_reservations_mob_validate_reservation_date

  function do_ajax_form_tb_reservations_mob_validate_reservation_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reservation_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_reservation_date_cb

  // ---------- Validate reservation_time
  function do_ajax_form_tb_reservations_mob_validate_reservation_time()
  {
    var nomeCampo_reservation_time = "reservation_time";
    var var_reservation_time = scAjaxGetFieldSelect(nomeCampo_reservation_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_reservation_time(var_reservation_time, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_reservation_time_cb);
  } // do_ajax_form_tb_reservations_mob_validate_reservation_time

  function do_ajax_form_tb_reservations_mob_validate_reservation_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reservation_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_reservation_time_cb

  // ---------- Validate number_hours
  function do_ajax_form_tb_reservations_mob_validate_number_hours()
  {
    var nomeCampo_number_hours = "number_hours";
    var var_number_hours = scAjaxGetFieldText(nomeCampo_number_hours);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_number_hours(var_number_hours, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_number_hours_cb);
  } // do_ajax_form_tb_reservations_mob_validate_number_hours

  function do_ajax_form_tb_reservations_mob_validate_number_hours_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "number_hours";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_number_hours_cb

  // ---------- Validate id_customer
  function do_ajax_form_tb_reservations_mob_validate_id_customer()
  {
    var nomeCampo_id_customer = "id_customer";
    var var_id_customer = scAjaxGetFieldSelect(nomeCampo_id_customer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_id_customer(var_id_customer, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_id_customer_cb);
  } // do_ajax_form_tb_reservations_mob_validate_id_customer

  function do_ajax_form_tb_reservations_mob_validate_id_customer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_id_customer_cb

  // ---------- Validate people
  function do_ajax_form_tb_reservations_mob_validate_people()
  {
    var nomeCampo_people = "people";
    var var_people = scAjaxGetFieldText(nomeCampo_people);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_people(var_people, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_people_cb);
  } // do_ajax_form_tb_reservations_mob_validate_people

  function do_ajax_form_tb_reservations_mob_validate_people_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "people";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_people_cb

  // ---------- Validate confirmation_date
  function do_ajax_form_tb_reservations_mob_validate_confirmation_date()
  {
    var nomeCampo_confirmation_date = "confirmation_date";
    var var_confirmation_date = scAjaxGetFieldText(nomeCampo_confirmation_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_reservations_mob_validate_confirmation_date(var_confirmation_date, var_script_case_init, do_ajax_form_tb_reservations_mob_validate_confirmation_date_cb);
  } // do_ajax_form_tb_reservations_mob_validate_confirmation_date

  function do_ajax_form_tb_reservations_mob_validate_confirmation_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "confirmation_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_reservations_mob_validate_confirmation_date_cb

  // ---------- Event onclick id_stage
  function do_ajax_form_tb_reservations_mob_event_id_stage_onclick()
  {
    var var_id_stage = scAjaxGetFieldRadio("id_stage");
    var var_confirmation_date = scAjaxGetFieldText("confirmation_date");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_reservations_mob_event_id_stage_onclick(var_id_stage, var_confirmation_date, var_script_case_init, do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb);
  } // do_ajax_form_tb_reservations_mob_event_id_stage_onclick

  function do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_stage";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb
  function do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_reservations_mob_event_id_stage_onclick_cb_after_alert

  // ---------- Event onchange number_hours
  function do_ajax_form_tb_reservations_mob_event_number_hours_onchange()
  {
    var var_number_hours = scAjaxGetFieldText("number_hours");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_reservations_mob_event_number_hours_onchange(var_number_hours, var_script_case_init, do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb);
  } // do_ajax_form_tb_reservations_mob_event_number_hours_onchange

  function do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "number_hours";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb
  function do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_reservations_mob_event_number_hours_onchange_cb_after_alert

  // ---------- Event onchange people
  function do_ajax_form_tb_reservations_mob_event_people_onchange()
  {
    var var_people = scAjaxGetFieldText("people");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_reservations_mob_event_people_onchange(var_people, var_script_case_init, do_ajax_form_tb_reservations_mob_event_people_onchange_cb);
  } // do_ajax_form_tb_reservations_mob_event_people_onchange

  function do_ajax_form_tb_reservations_mob_event_people_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "people";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_reservations_mob_event_people_onchange_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_event_people_onchange_cb
  function do_ajax_form_tb_reservations_mob_event_people_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_reservations_mob_event_people_onchange_cb_after_alert

  // ---------- Event onchange reservation_date
  function do_ajax_form_tb_reservations_mob_event_reservation_date_onchange()
  {
    var var_reservation_date = scAjaxGetFieldText("reservation_date");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_reservations_mob_event_reservation_date_onchange(var_reservation_date, var_script_case_init, do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb);
  } // do_ajax_form_tb_reservations_mob_event_reservation_date_onchange

  function do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "reservation_date";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb
  function do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_reservations_mob_event_reservation_date_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_reservations_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_reservations_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_stage = scAjaxGetFieldRadio("id_stage");
    var var_reservation_date = scAjaxGetFieldText("reservation_date");
    var var_reservation_time = scAjaxGetFieldSelect("reservation_time");
    var var_number_hours = scAjaxGetFieldText("number_hours");
    var var_id_customer = scAjaxGetFieldSelect("id_customer");
    var var_people = scAjaxGetFieldText("people");
    var var_confirmation_date = scAjaxGetFieldText("confirmation_date");
    var var_id_reservation = scAjaxGetFieldText("id_reservation");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_reservations_mob_submit_form(var_id_stage, var_reservation_date, var_reservation_time, var_number_hours, var_id_customer, var_people, var_confirmation_date, var_id_reservation, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_reservations_mob_submit_form_cb);
  } // do_ajax_form_tb_reservations_mob_submit_form

  function do_ajax_form_tb_reservations_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_reservations_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_submit_form_cb
  function do_ajax_form_tb_reservations_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_reservations_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_reservations_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_reservations_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_reservations_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_reservations_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_reservation = document.F2.id_reservation.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_reservations_mob_navigate_form(var_id_reservation, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_reservations_mob_navigate_form_cb);
  } // do_ajax_form_tb_reservations_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_reservations_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_reservations_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_reservation.value = scAjaxGetKeyValue("id_reservation");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_reservations_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_reservations_mob_navigate_form_cb
  function do_ajax_form_tb_reservations_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tb_reservations_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_reservations_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_reservations_mob_form()
  {
  ...
  ajax_field_list[0] = "id_stage";
  ajax_field_list[1] = "reservation_date";
  ajax_field_list[2] = "reservation_time";
  ajax_field_list[3] = "number_hours";
  ajax_field_list[4] = "id_customer";
  ajax_field_list[5] = "people";
  ajax_field_list[6] = "confirmation_date";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_stage": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_id_stage'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "reservation_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "reservation_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_reservation_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "number_hours": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_number_hours'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_customer": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_id_customer'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "people": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_people'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "confirmation_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_reservations_fld_confirmation_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_stage": new Array(),
    "reservation_date": new Array(),
    "reservation_time": new Array(),
    "number_hours": new Array(),
    "id_customer": new Array(),
    "people": new Array(),
    "confirmation_date": new Array()
  };
  ajax_field_mult["id_stage"][1] = "id_stage";
  ajax_field_mult["reservation_date"][1] = "reservation_date";
  ajax_field_mult["reservation_time"][1] = "reservation_time";
  ajax_field_mult["number_hours"][1] = "number_hours";
  ajax_field_mult["id_customer"][1] = "id_customer";
  ajax_field_mult["people"][1] = "people";
  ajax_field_mult["confirmation_date"][1] = "confirmation_date";

  var ajax_field_id = {
    "id_stage": new Array("hidden_field_label_id_stage", "hidden_field_data_id_stage"),
    "reservation_date": new Array("hidden_field_label_reservation_date", "hidden_field_data_reservation_date"),
    "reservation_time": new Array("hidden_field_label_reservation_time", "hidden_field_data_reservation_time"),
    "number_hours": new Array("hidden_field_label_number_hours", "hidden_field_data_number_hours"),
    "id_customer": new Array("hidden_field_label_id_customer", "hidden_field_data_id_customer"),
    "people": new Array("hidden_field_label_people", "hidden_field_data_people"),
    "confirmation_date": new Array("hidden_field_label_confirmation_date", "hidden_field_data_confirmation_date")
  };

  var ajax_read_only = {
    "id_stage": "off",
    "reservation_date": "off",
    "reservation_time": "off",
    "number_hours": "off",
    "id_customer": "off",
    "people": "off",
    "confirmation_date": "on"
  };
