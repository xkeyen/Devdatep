<?php  
  ...
  session_start() ;
  class form_merge_order_table_form_teste
  {
   function form_merge_order_table_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_merge_order_table/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_merge_order_table</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_merge_order_table"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_merge_order_table_form_teste();
  $frm_teste->form_merge_order_table_teste();
?>
