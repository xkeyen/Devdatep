<?php  
  ...
  session_start() ;
  class app_sync_apps_form_teste
  {
   function app_sync_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_sync_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_sync_apps</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_sync_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_sync_apps_form_teste();
  $frm_teste->app_sync_apps_teste();
?>
