...
?>
  ...
  var ajax_error_list = {
    "sync": {"label": "<?php echo $this->Ini->Nm_lang['lang_sync_apps'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "check_deleted": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
