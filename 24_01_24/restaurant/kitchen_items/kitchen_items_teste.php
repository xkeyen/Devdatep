<?php  
  ...
  session_start() ;
  class kitchen_items_form_teste
  {
  function kitchen_items_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">kitchen_items</FONT></B> 
<br> 
<br> 
...
<input type=submit value="kitchen_items"> 
</form> 
<script language=javascript> 
 document.FCons.var_id_order.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new kitchen_items_form_teste();
  $frm_teste->kitchen_items_teste();
?>
