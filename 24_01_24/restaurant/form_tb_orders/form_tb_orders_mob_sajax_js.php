  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_orders_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_orders_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_order
  function do_ajax_form_tb_orders_mob_validate_id_order()
  {
    var nomeCampo_id_order = "id_order";
    var var_id_order = scAjaxGetFieldHidden(nomeCampo_id_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_id_order(var_id_order, var_script_case_init, do_ajax_form_tb_orders_mob_validate_id_order_cb);
  } // do_ajax_form_tb_orders_mob_validate_id_order

  function do_ajax_form_tb_orders_mob_validate_id_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_order";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_id_order_cb

  // ---------- Validate id_table
  function do_ajax_form_tb_orders_mob_validate_id_table()
  {
    var nomeCampo_id_table = "id_table";
    var var_id_table = scAjaxGetFieldHidden(nomeCampo_id_table);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_id_table(var_id_table, var_script_case_init, do_ajax_form_tb_orders_mob_validate_id_table_cb);
  } // do_ajax_form_tb_orders_mob_validate_id_table

  function do_ajax_form_tb_orders_mob_validate_id_table_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_table";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_id_table_cb

  // ---------- Validate people
  function do_ajax_form_tb_orders_mob_validate_people()
  {
    var nomeCampo_people = "people";
    var var_people = scAjaxGetFieldText(nomeCampo_people);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_people(var_people, var_script_case_init, do_ajax_form_tb_orders_mob_validate_people_cb);
  } // do_ajax_form_tb_orders_mob_validate_people

  function do_ajax_form_tb_orders_mob_validate_people_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "people";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_people_cb

  // ---------- Validate order_status
  function do_ajax_form_tb_orders_mob_validate_order_status()
  {
    var nomeCampo_order_status = "order_status";
    var var_order_status = scAjaxGetFieldSelect(nomeCampo_order_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_order_status(var_order_status, var_script_case_init, do_ajax_form_tb_orders_mob_validate_order_status_cb);
  } // do_ajax_form_tb_orders_mob_validate_order_status

  function do_ajax_form_tb_orders_mob_validate_order_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "order_status";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_order_status_cb

  // ---------- Validate dt_order_start
  function do_ajax_form_tb_orders_mob_validate_dt_order_start()
  {
    var nomeCampo_dt_order_start = "dt_order_start";
    var var_dt_order_start = scAjaxGetFieldText(nomeCampo_dt_order_start);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_dt_order_start(var_dt_order_start, var_script_case_init, do_ajax_form_tb_orders_mob_validate_dt_order_start_cb);
  } // do_ajax_form_tb_orders_mob_validate_dt_order_start

  function do_ajax_form_tb_orders_mob_validate_dt_order_start_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dt_order_start";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_dt_order_start_cb

  // ---------- Validate user_login
  function do_ajax_form_tb_orders_mob_validate_user_login()
  {
    var nomeCampo_user_login = "user_login";
    var var_user_login = scAjaxGetFieldSelect(nomeCampo_user_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_user_login(var_user_login, var_script_case_init, do_ajax_form_tb_orders_mob_validate_user_login_cb);
  } // do_ajax_form_tb_orders_mob_validate_user_login

  function do_ajax_form_tb_orders_mob_validate_user_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_login";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_user_login_cb

  // ---------- Validate items
  function do_ajax_form_tb_orders_mob_validate_items()
  {
    var nomeCampo_items = "items";
    var var_items = scAjaxGetFieldText(nomeCampo_items);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_orders_mob_validate_items(var_items, var_script_case_init, do_ajax_form_tb_orders_mob_validate_items_cb);
  } // do_ajax_form_tb_orders_mob_validate_items

  function do_ajax_form_tb_orders_mob_validate_items_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "items";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_orders_mob_validate_items_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_orders_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_orders_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_order = scAjaxGetFieldHidden("id_order");
    var var_id_table = scAjaxGetFieldHidden("id_table");
    var var_people = scAjaxGetFieldText("people");
    var var_order_status = scAjaxGetFieldSelect("order_status");
    var var_dt_order_start = scAjaxGetFieldText("dt_order_start");
    var var_user_login = scAjaxGetFieldSelect("user_login");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_orders_mob_submit_form(var_id_order, var_id_table, var_people, var_order_status, var_dt_order_start, var_user_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_orders_mob_submit_form_cb);
  } // do_ajax_form_tb_orders_mob_submit_form

  function do_ajax_form_tb_orders_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_orders_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_orders_mob_submit_form_cb
  function do_ajax_form_tb_orders_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_orders_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tb_order_items_mob"] = "off";

  function do_ajax_form_tb_orders_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_orders_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_orders_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_orders_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_order = document.F2.id_order.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tb_order_items_mob"] = "on";
    x_ajax_form_tb_orders_mob_navigate_form(var_id_order, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_orders_mob_navigate_form_cb);
  } // do_ajax_form_tb_orders_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_orders_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_orders_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_order.value = scAjaxGetKeyValue("id_order");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items_mob"] && "nmsc_iframe_liga_form_tb_order_items_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tb_order_items_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tb_order_items_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_tb_order_items_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_tb_order_items_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_orders_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_orders_mob_navigate_form_cb
  function do_ajax_form_tb_orders_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tb_orders_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_orders_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_orders_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tb_order_items_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_order";
  ajax_field_list[1] = "id_table";
  ajax_field_list[2] = "people";
  ajax_field_list[3] = "order_status";
  ajax_field_list[4] = "dt_order_start";
  ajax_field_list[5] = "user_login";
  ajax_field_list[6] = "items";
  ...
  var ajax_error_list = {
    "id_order": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_orders_fld_id_order'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_table": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_tables_fld_id_table'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "people": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_orders_fld_people'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "order_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_orders_fld_order_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dt_order_start": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_orders_fld_dt_order_start'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "user_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_orders_fld_user_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "items": {"label": "Items", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "id_table": new Array(),
    "people": new Array(),
    "order_status": new Array(),
    "dt_order_start": new Array(),
    "user_login": new Array(),
    "items": new Array()
  };
  ajax_field_mult["id_order"][1] = "id_order";
  ajax_field_mult["id_table"][1] = "id_table";
  ajax_field_mult["people"][1] = "people";
  ajax_field_mult["order_status"][1] = "order_status";
  ajax_field_mult["dt_order_start"][1] = "dt_order_start";
  ajax_field_mult["user_login"][1] = "user_login";
  ajax_field_mult["items"][1] = "items";

  var ajax_field_id = {
    "id_order": new Array("hidden_field_label_id_order", "hidden_field_data_id_order"),
    "id_table": new Array("hidden_field_label_id_table", "hidden_field_data_id_table"),
    "people": new Array("hidden_field_label_people", "hidden_field_data_people"),
    "order_status": new Array("hidden_field_label_order_status", "hidden_field_data_order_status"),
    "dt_order_start": new Array("hidden_field_label_dt_order_start", "hidden_field_data_dt_order_start"),
    "user_login": new Array("hidden_field_label_user_login", "hidden_field_data_user_login"),
    "items": new Array("hidden_field_label_items", "hidden_field_data_items")
  };
