<?php  
  ...
  session_start() ;
  class form_tb_orders_form_teste
  {
   function form_tb_orders_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_orders/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tb_orders</FONT></B> 
<br> 
<br> 
...
var_id_order&nbsp;&nbsp;<input type="text" name="var_id_order" size=20><br> 
usr_login&nbsp;&nbsp;<input type="text" name="usr_login" size=20><br> 
var_id_table&nbsp;&nbsp;<input type="text" name="var_id_table" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
id_order&nbsp;&nbsp;<input type=text name=id_order size=20><br> 
<input type="submit" value="form_tb_orders"> 
</form> 
<script language=javascript> 
 document.Fedit.var_id_order.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_tb_orders_form_teste();
  $frm_teste->form_tb_orders_teste();
?>
