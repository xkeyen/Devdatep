  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_item_change_status_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_item_change_status_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_order
  function do_ajax_item_change_status_mob_validate_id_order()
  {
    var nomeCampo_id_order = "id_order";
    var var_id_order = scAjaxGetFieldSelect(nomeCampo_id_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_item_change_status_mob_validate_id_order(var_id_order, var_script_case_init, do_ajax_item_change_status_mob_validate_id_order_cb);
  } // do_ajax_item_change_status_mob_validate_id_order

  function do_ajax_item_change_status_mob_validate_id_order_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_item_change_status_mob_validate_id_order_cb

  // ---------- Validate id_menu
  function do_ajax_item_change_status_mob_validate_id_menu()
  {
    var nomeCampo_id_menu = "id_menu";
    var var_id_menu = scAjaxGetFieldSelect(nomeCampo_id_menu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_item_change_status_mob_validate_id_menu(var_id_menu, var_script_case_init, do_ajax_item_change_status_mob_validate_id_menu_cb);
  } // do_ajax_item_change_status_mob_validate_id_menu

  function do_ajax_item_change_status_mob_validate_id_menu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_menu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_item_change_status_mob_validate_id_menu_cb

  // ---------- Validate quantity
  function do_ajax_item_change_status_mob_validate_quantity()
  {
    var nomeCampo_quantity = "quantity";
    var var_quantity = scAjaxGetFieldText(nomeCampo_quantity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_item_change_status_mob_validate_quantity(var_quantity, var_script_case_init, do_ajax_item_change_status_mob_validate_quantity_cb);
  } // do_ajax_item_change_status_mob_validate_quantity

  function do_ajax_item_change_status_mob_validate_quantity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "quantity";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_item_change_status_mob_validate_quantity_cb

  // ---------- Validate id_kitchen_status
  function do_ajax_item_change_status_mob_validate_id_kitchen_status()
  {
    var nomeCampo_id_kitchen_status = "id_kitchen_status";
    var var_id_kitchen_status = scAjaxGetFieldRadio(nomeCampo_id_kitchen_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_item_change_status_mob_validate_id_kitchen_status(var_id_kitchen_status, var_script_case_init, do_ajax_item_change_status_mob_validate_id_kitchen_status_cb);
  } // do_ajax_item_change_status_mob_validate_id_kitchen_status

  function do_ajax_item_change_status_mob_validate_id_kitchen_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_kitchen_status";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_item_change_status_mob_validate_id_kitchen_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_item_change_status_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_item_change_status_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_order = scAjaxGetFieldSelect("id_order");
    var var_id_menu = scAjaxGetFieldSelect("id_menu");
    var var_quantity = scAjaxGetFieldText("quantity");
    var var_id_kitchen_status = scAjaxGetFieldRadio("id_kitchen_status");
    var var_id_order_item = scAjaxGetFieldText("id_order_item");
    ...
    scAjaxProcOn();
    x_ajax_item_change_status_mob_submit_form(var_id_order, var_id_menu, var_quantity, var_id_kitchen_status, var_id_order_item, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_item_change_status_mob_submit_form_cb);
  } // do_ajax_item_change_status_mob_submit_form

  function do_ajax_item_change_status_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_item_change_status_mob_submit_form_cb_after_alert);
  } // do_ajax_item_change_status_mob_submit_form_cb
  function do_ajax_item_change_status_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_item_change_status_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_item_change_status_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_item_change_status_mob_navigate_form, function() {});
    } else {
      perform_ajax_item_change_status_mob_navigate_form();
    }
  }

  function perform_ajax_item_change_status_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_order_item = document.F2.id_order_item.value;
    ...
    scAjaxProcOn();
    x_ajax_item_change_status_mob_navigate_form(var_id_order_item, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_item_change_status_mob_navigate_form_cb);
  } // do_ajax_item_change_status_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['item_change_status_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_item_change_status_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_order_item.value = scAjaxGetKeyValue("id_order_item");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_item_change_status_mob_navigate_form_cb_after_alert);
  } // do_ajax_item_change_status_mob_navigate_form_cb
  function do_ajax_item_change_status_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_item_change_status_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_item_change_status_mob_navigate_form_cb_after_alert

  function sc_hide_item_change_status_mob_form()
  {
  ...
  ajax_field_list[1] = "id_menu";
  ajax_field_list[2] = "quantity";
  ajax_field_list[3] = "id_kitchen_status";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_order": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_id_order'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_menu": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_id_menu'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "quantity": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_quantity'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_kitchen_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_items_fld_id_kitchen_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "id_menu": new Array(),
    "quantity": new Array(),
    "id_kitchen_status": new Array()
  };
  ajax_field_mult["id_order"][1] = "id_order";
  ajax_field_mult["id_menu"][1] = "id_menu";
  ajax_field_mult["quantity"][1] = "quantity";
  ajax_field_mult["id_kitchen_status"][1] = "id_kitchen_status";

  var ajax_field_id = {
    "id_order": new Array("hidden_field_label_id_order", "hidden_field_data_id_order"),
    "id_menu": new Array("hidden_field_label_id_menu", "hidden_field_data_id_menu"),
    "quantity": new Array("hidden_field_label_quantity", "hidden_field_data_quantity"),
    "id_kitchen_status": new Array("hidden_field_label_id_kitchen_status", "hidden_field_data_id_kitchen_status")
  };
