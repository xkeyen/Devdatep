<?php
@session_start() ;
$_SESSION['scriptcase']['grid_room_now']['sc_process_barr'] = true;
require_once('../grid_room_now/index.php');
unset($_SESSION['scriptcase']['grid_room_now']['sc_process_barr']);
$ExportCtrl = new grid_room_now_export_control;
$ExportCtrl->Export_barr();

class grid_room_now_export_control
{
