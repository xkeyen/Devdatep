...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_room_now"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_room_now"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_room_now']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_room_now']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_room_now']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_room_now']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_room_now']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_room_now']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_room_now']['embutida_filho'] as $ind => $sc_init)
          {
