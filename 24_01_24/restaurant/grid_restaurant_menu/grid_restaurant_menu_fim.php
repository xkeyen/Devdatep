...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["restaurant_____grid_restaurant_menu"]))
   {
      unset($_SESSION['session_sec_aplicacao']["restaurant_____grid_restaurant_menu"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_restaurant_menu'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_restaurant_menu</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_restaurant_menu']['embutida_filho'] as $ind => $sc_init)
          {
