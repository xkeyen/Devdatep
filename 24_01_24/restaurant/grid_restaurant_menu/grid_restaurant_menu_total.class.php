...
class grid_restaurant_menu_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_restaurant_menu']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_restaurant_menu']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_category($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_restaurant_menu']['contr_total_geral'] = "OK";
   } 

   //-----  tb_menu_category_id_category
   function quebra_tb_menu_category_id_category_category($tb_menu_category_id_category, $arg_sum_tb_menu_category_id_category) 
   {
      global $tot_tb_menu_category_id_category;
      $tot_tb_menu_category_id_category = array() ;  
      $tot_tb_menu_category_id_category[0] = $tb_menu_category_id_category ; 
   }
