  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_order_status" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_order_status_form();
	}
...
?>
  ...
  // ---------- Validate id_order_status_
  function do_ajax_form_tb_order_status_validate_id_order_status_(iNumLinha)
  {
    var nomeCampo_id_order_status_ = "id_order_status_" + iNumLinha;
    var var_id_order_status_ = scAjaxGetFieldHidden(nomeCampo_id_order_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_status_validate_id_order_status_(var_id_order_status_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_status_validate_id_order_status__cb);
  } // do_ajax_form_tb_order_status_validate_id_order_status_

  function do_ajax_form_tb_order_status_validate_id_order_status__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_order_status_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_order_status_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_status_validate_id_order_status__cb

  // ---------- Validate order_status_descr_
  function do_ajax_form_tb_order_status_validate_order_status_descr_(iNumLinha)
  {
    var nomeCampo_order_status_descr_ = "order_status_descr_" + iNumLinha;
    var var_order_status_descr_ = scAjaxGetFieldText(nomeCampo_order_status_descr_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_status_validate_order_status_descr_(var_order_status_descr_, iNumLinha, var_script_case_init, do_ajax_form_tb_order_status_validate_order_status_descr__cb);
  } // do_ajax_form_tb_order_status_validate_order_status_descr_

  function do_ajax_form_tb_order_status_validate_order_status_descr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "order_status_descr_" + iLineNumber;
    }
    else
    {
      sFieldValid = "order_status_descr_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_order_status_validate_order_status_descr__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tb_order_status_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tb_order_status_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_order_status_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tb_order_status_add_new_line_cb);
  } // do_ajax_form_tb_order_status_add_new_line

  function do_ajax_form_tb_order_status_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tb_order_status_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tb_order_status_backup_line(iNumLinha)
  {
    var var_id_order_status_ = scAjaxGetFieldHidden("id_order_status_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_order_status_backup_line(var_id_order_status_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tb_order_status_backup_line_cb);
  } // do_ajax_form_tb_order_status_backup_line

  function do_ajax_form_tb_order_status_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tb_order_status_backup_line_cb

  function do_ajax_form_tb_order_status_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tb_order_status_cancel_insert

  function do_ajax_form_tb_order_status_cancel_update(iSeqVert)
  {
    do_ajax_form_tb_order_status_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tb_order_status_cancel_update

  function do_ajax_form_tb_order_status_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tb_order_status_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tb_order_status_table_refresh()
  {
    var var_id_order_status_ = document.F2.id_order_status_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_order_status_table_refresh(var_id_order_status_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_order_status_table_refresh_cb);
  } //  do_ajax_form_tb_order_status_table_refresh

  function do_ajax_form_tb_order_status_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_order_status_.value = scAjaxGetKeyValue("id_order_status_");
    ...
    scAjaxAlert(do_ajax_form_tb_order_status_table_refresh_cb_after_alert);
  } // do_ajax_form_tb_order_status_table_refresh_cb
  function do_ajax_form_tb_order_status_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tb_order_status_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tb_order_status_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tb_order_status_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_order_status_ = scAjaxGetFieldHidden("id_order_status_" + iNumLinha);
    var var_order_status_descr_ = scAjaxGetFieldText("order_status_descr_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tb_order_status_submit_form(var_id_order_status_, var_order_status_descr_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_order_status_submit_form_cb);
  } // do_ajax_form_tb_order_status_submit_form

  function do_ajax_form_tb_order_status_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_order_status_submit_form_cb_after_alert);
  } // do_ajax_form_tb_order_status_submit_form_cb
  function do_ajax_form_tb_order_status_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_order_status_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_order_status_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_order_status_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_order_status_navigate_form();
    }
  }

  function perform_ajax_form_tb_order_status_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tb_order_status_cancel_insert(sc_form_tb_order_status_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_order_status_navigate_form(var_id_order_status_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_order_status_navigate_form_cb);
  } // do_ajax_form_tb_order_status_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_order_status']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_order_status_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_order_status_.value = scAjaxGetKeyValue("id_order_status_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_order_status_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_order_status_navigate_form_cb
  function do_ajax_form_tb_order_status_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tb_order_status_navigate_form_cb_after_alert

    function sc_form_tb_order_status_get_last_line_number()
    {
    ...
    } //sc_form_tb_order_status_get_last_line_number

  function sc_hide_form_tb_order_status_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_order_status_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "order_status_descr_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_order_status_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_status_fld_id_order_status'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["order_status_descr_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_order_status_fld_order_status_descr'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_order_status_"][iNumLinha] = "id_order_status_" + iNumLinha;
    ajax_field_mult["order_status_descr_"][iNumLinha] = "order_status_descr_" + iNumLinha;
    ajax_field_id["id_order_status_" + iNumLinha] = new Array("hidden_field_label_id_order_status_", "hidden_field_data_id_order_status_" + iNumLinha);
    ajax_field_id["order_status_descr_" + iNumLinha] = new Array("hidden_field_label_order_status_descr_", "hidden_field_data_order_status_descr_" + iNumLinha);
    ajax_error_count["id_order_status_" + iNumLinha] = "off";
    ajax_error_count["order_status_descr_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_order_status_" + iNumLinha] = "on";
    ajax_read_only["order_status_descr_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_order_status_" + iNumLinha] = "on";
    ajax_read_only["order_status_descr_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_order_status_" + iNumLinha] = null;
    ajax_error_list["order_status_descr_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_order_status_": new Array(),
    "order_status_descr_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_order_status_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_order_status_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_order_status_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_order_status_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_order_status_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["order_status_descr_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["order_status_descr_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["order_status_descr_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["order_status_descr_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["order_status_descr_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_order_status_'])) ? $this->nmgp_cmp_readonly['id_order_status_'] : 'on';
?>
    scAjaxFieldRead("id_order_status_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['order_status_descr_'])) ? $this->nmgp_cmp_readonly['order_status_descr_'] : 'off';
?>
    scAjaxFieldRead("order_status_descr_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_order_status_" + iSeq, "on");
    scAjaxFieldRead("order_status_descr_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_order_status_" + iRow] || "on" == ajax_error_count["order_status_descr_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_order_status_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_order_status_descr_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_order_status_" + iRow] && "off" == ajax_error_count["order_status_descr_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_order_status_" + iRow] = "off";
        ajax_error_count["order_status_descr_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_order_status_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_order_status_descr_" + iRow).removeClass("scFormErrorLine");
    }
  }
