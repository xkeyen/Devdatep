  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_restaurant_menu_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_restaurant_menu_mob_form();
	}
...
?>
  ...
  // ---------- Validate active_menu
  function do_ajax_form_tb_restaurant_menu_mob_validate_active_menu()
  {
    var nomeCampo_active_menu = "active_menu";
    var var_active_menu = scAjaxGetFieldRadio(nomeCampo_active_menu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_active_menu(var_active_menu, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_active_menu_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_active_menu

  function do_ajax_form_tb_restaurant_menu_mob_validate_active_menu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active_menu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_active_menu_cb

  // ---------- Validate to_kitchen
  function do_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen()
  {
    var nomeCampo_to_kitchen = "to_kitchen";
    var var_to_kitchen = scAjaxGetFieldRadio(nomeCampo_to_kitchen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen(var_to_kitchen, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen

  function do_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "to_kitchen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_to_kitchen_cb

  // ---------- Validate id_category
  function do_ajax_form_tb_restaurant_menu_mob_validate_id_category()
  {
    var nomeCampo_id_category = "id_category";
    var var_id_category = scAjaxGetFieldSelect(nomeCampo_id_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_id_category(var_id_category, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_id_category_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_id_category

  function do_ajax_form_tb_restaurant_menu_mob_validate_id_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_id_category_cb

  // ---------- Validate header
  function do_ajax_form_tb_restaurant_menu_mob_validate_header()
  {
    var nomeCampo_header = "header";
    var var_header = scAjaxGetFieldText(nomeCampo_header);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_header(var_header, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_header_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_header

  function do_ajax_form_tb_restaurant_menu_mob_validate_header_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "header";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_header_cb

  // ---------- Validate description
  function do_ajax_form_tb_restaurant_menu_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldEditorHtml(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_description(var_description, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_description_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_description

  function do_ajax_form_tb_restaurant_menu_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_description_cb

  // ---------- Validate price
  function do_ajax_form_tb_restaurant_menu_mob_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldText(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_price(var_price, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_price_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_price

  function do_ajax_form_tb_restaurant_menu_mob_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_price_cb

  // ---------- Validate image_bin
  function do_ajax_form_tb_restaurant_menu_mob_validate_image_bin()
  {
    var nomeCampo_image_bin = "image_bin";
    var var_image_bin = scAjaxGetFieldText(nomeCampo_image_bin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_menu_mob_validate_image_bin(var_image_bin, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_validate_image_bin_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_validate_image_bin

  function do_ajax_form_tb_restaurant_menu_mob_validate_image_bin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "image_bin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_menu_mob_validate_image_bin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_restaurant_menu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_restaurant_menu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_active_menu = scAjaxGetFieldRadio("active_menu");
    var var_to_kitchen = scAjaxGetFieldRadio("to_kitchen");
    var var_id_category = scAjaxGetFieldSelect("id_category");
    var var_header = scAjaxGetFieldText("header");
    var var_description = scAjaxGetFieldEditorHtml("description");
    var var_price = scAjaxGetFieldText("price");
    var var_image_bin = scAjaxGetFieldText("image_bin");
    var var_id_menu = scAjaxGetFieldText("id_menu");
    var var_image_bin_ul_name = scAjaxSpecCharProtect(document.F1.image_bin_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_image_bin_ul_type = document.F1.image_bin_ul_type.value;
    var var_image_bin_limpa = document.F1.image_bin_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tb_restaurant_menu_mob_submit_form(var_active_menu, var_to_kitchen, var_id_category, var_header, var_description, var_price, var_image_bin, var_id_menu, var_image_bin_ul_name, var_image_bin_ul_type, var_image_bin_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_restaurant_menu_mob_submit_form_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_submit_form

  function do_ajax_form_tb_restaurant_menu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.image_bin_limpa && document.F1.image_bin_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("image_bin", oImgTemp, "", "", "", "N");
      }
    document.F1.image_bin_ul_name.value = '';
    document.F1.image_bin_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_restaurant_menu_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_restaurant_menu_mob_submit_form_cb
  function do_ajax_form_tb_restaurant_menu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_restaurant_menu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_restaurant_menu_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_restaurant_menu_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_restaurant_menu_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_restaurant_menu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_menu = document.F2.id_menu.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_restaurant_menu_mob_navigate_form(var_id_menu, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb);
  } // do_ajax_form_tb_restaurant_menu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_menu.value = scAjaxGetKeyValue("id_menu");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb
  function do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_restaurant_menu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_restaurant_menu_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_restaurant_menu_mob_form()
  {
  ...
  ajax_field_list[0] = "active_menu";
  ajax_field_list[1] = "to_kitchen";
  ajax_field_list[2] = "id_category";
  ajax_field_list[3] = "header";
  ajax_field_list[4] = "description";
  ajax_field_list[5] = "price";
  ajax_field_list[6] = "image_bin";
  ...
  var ajax_error_list = {
    "active_menu": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_active_menu'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "to_kitchen": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_to_kitchen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_category": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_id_category'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "header": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_header'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "price": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_price'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "image_bin": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_menu_fld_image_bin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["active_menu"][1] = "active_menu";
  ajax_field_mult["to_kitchen"][1] = "to_kitchen";
  ajax_field_mult["id_category"][1] = "id_category";
  ajax_field_mult["header"][1] = "header";
  ajax_field_mult["description"][1] = "description";
  ajax_field_mult["price"][1] = "price";
  ajax_field_mult["image_bin"][1] = "image_bin";

  var ajax_field_id = {
    "active_menu": new Array("hidden_field_label_active_menu", "hidden_field_data_active_menu"),
    "to_kitchen": new Array("hidden_field_label_to_kitchen", "hidden_field_data_to_kitchen"),
    "id_category": new Array("hidden_field_label_id_category", "hidden_field_data_id_category"),
    "header": new Array("hidden_field_label_header", "hidden_field_data_header"),
    ...
    "image_bin": new Array("hidden_field_label_image_bin", "hidden_field_data_image_bin")
  };
