<?php  
  ...
  session_start() ;
  class form_tb_restaurant_menu_form_teste
  {
   function form_tb_restaurant_menu_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tb_restaurant_menu/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tb_restaurant_menu</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_tb_restaurant_menu"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tb_restaurant_menu_form_teste();
  $frm_teste->form_tb_restaurant_menu_teste();
?>
