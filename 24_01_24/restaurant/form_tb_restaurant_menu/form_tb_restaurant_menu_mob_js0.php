...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tb_restaurant_menu_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
    document.getElementById('form_tb_restaurant_menu_mob_form0').style.width='1px';
    document.getElementById('form_tb_restaurant_menu_mob_form0').style.height='0px';
    document.getElementById('form_tb_restaurant_menu_mob_form0').style.display='none';
    document.getElementById('form_tb_restaurant_menu_mob_form0').style.overflow='scroll';
    document.getElementById('form_tb_restaurant_menu_mob_form1').style.width='1px';
    document.getElementById('form_tb_restaurant_menu_mob_form1').style.height='0px';
    document.getElementById('form_tb_restaurant_menu_mob_form1').style.display='none';
    document.getElementById('form_tb_restaurant_menu_mob_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_menu_mob']['pdf_view']) {
?>
...
?>
    ...
    displayChange_page(pag_ativa.substr(32), 'off');
    pag_ativa = N_pagina;
    sc_tab_pag(pag_ativa, 'scTabActive');
    displayChange_page(pag_ativa.substr(32), 'on');
}
