  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_restaurant_tables" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_restaurant_tables_form();
	}
...
?>
  ...
  // ---------- Validate id_table_
  function do_ajax_form_tb_restaurant_tables_validate_id_table_(iNumLinha)
  {
    var nomeCampo_id_table_ = "id_table_" + iNumLinha;
    var var_id_table_ = scAjaxGetFieldHidden(nomeCampo_id_table_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_tables_validate_id_table_(var_id_table_, iNumLinha, var_script_case_init, do_ajax_form_tb_restaurant_tables_validate_id_table__cb);
  } // do_ajax_form_tb_restaurant_tables_validate_id_table_

  function do_ajax_form_tb_restaurant_tables_validate_id_table__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_table_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_table_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_tables_validate_id_table__cb

  // ---------- Validate seats_
  function do_ajax_form_tb_restaurant_tables_validate_seats_(iNumLinha)
  {
    var nomeCampo_seats_ = "seats_" + iNumLinha;
    var var_seats_ = scAjaxGetFieldText(nomeCampo_seats_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_tables_validate_seats_(var_seats_, iNumLinha, var_script_case_init, do_ajax_form_tb_restaurant_tables_validate_seats__cb);
  } // do_ajax_form_tb_restaurant_tables_validate_seats_

  function do_ajax_form_tb_restaurant_tables_validate_seats__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "seats_" + iLineNumber;
    }
    else
    {
      sFieldValid = "seats_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_tables_validate_seats__cb

  // ---------- Validate id_room_
  function do_ajax_form_tb_restaurant_tables_validate_id_room_(iNumLinha)
  {
    var nomeCampo_id_room_ = "id_room_" + iNumLinha;
    var var_id_room_ = scAjaxGetFieldSelect(nomeCampo_id_room_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_tables_validate_id_room_(var_id_room_, iNumLinha, var_script_case_init, do_ajax_form_tb_restaurant_tables_validate_id_room__cb);
  } // do_ajax_form_tb_restaurant_tables_validate_id_room_

  function do_ajax_form_tb_restaurant_tables_validate_id_room__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_restaurant_tables_validate_id_room__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tb_restaurant_tables_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tb_restaurant_tables_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_restaurant_tables_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tb_restaurant_tables_add_new_line_cb);
  } // do_ajax_form_tb_restaurant_tables_add_new_line

  function do_ajax_form_tb_restaurant_tables_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tb_restaurant_tables_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tb_restaurant_tables_backup_line(iNumLinha)
  {
    var var_id_table_ = scAjaxGetFieldHidden("id_table_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_restaurant_tables_backup_line(var_id_table_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tb_restaurant_tables_backup_line_cb);
  } // do_ajax_form_tb_restaurant_tables_backup_line

  function do_ajax_form_tb_restaurant_tables_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tb_restaurant_tables_backup_line_cb

  function do_ajax_form_tb_restaurant_tables_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tb_restaurant_tables_cancel_insert

  function do_ajax_form_tb_restaurant_tables_cancel_update(iSeqVert)
  {
    do_ajax_form_tb_restaurant_tables_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tb_restaurant_tables_cancel_update

  function do_ajax_form_tb_restaurant_tables_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tb_restaurant_tables_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tb_restaurant_tables_table_refresh()
  {
    var var_id_table_ = document.F2.id_table_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_restaurant_tables_table_refresh(var_id_table_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_restaurant_tables_table_refresh_cb);
  } //  do_ajax_form_tb_restaurant_tables_table_refresh

  function do_ajax_form_tb_restaurant_tables_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_table_.value = scAjaxGetKeyValue("id_table_");
    ...
    scAjaxAlert(do_ajax_form_tb_restaurant_tables_table_refresh_cb_after_alert);
  } // do_ajax_form_tb_restaurant_tables_table_refresh_cb
  function do_ajax_form_tb_restaurant_tables_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tb_restaurant_tables_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tb_restaurant_tables_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tb_restaurant_tables_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_table_ = scAjaxGetFieldHidden("id_table_" + iNumLinha);
    var var_seats_ = scAjaxGetFieldText("seats_" + iNumLinha);
    var var_id_room_ = scAjaxGetFieldSelect("id_room_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tb_restaurant_tables_submit_form(var_id_table_, var_seats_, var_id_room_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_restaurant_tables_submit_form_cb);
  } // do_ajax_form_tb_restaurant_tables_submit_form

  function do_ajax_form_tb_restaurant_tables_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_restaurant_tables_submit_form_cb_after_alert);
  } // do_ajax_form_tb_restaurant_tables_submit_form_cb
  function do_ajax_form_tb_restaurant_tables_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_restaurant_tables_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_restaurant_tables_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_restaurant_tables_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_restaurant_tables_navigate_form();
    }
  }

  function perform_ajax_form_tb_restaurant_tables_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_restaurant_tables_navigate_form(var_id_table_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_restaurant_tables_navigate_form_cb);
  } // do_ajax_form_tb_restaurant_tables_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_restaurant_tables']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_restaurant_tables_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_table_.value = scAjaxGetKeyValue("id_table_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_restaurant_tables_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_restaurant_tables_navigate_form_cb
  function do_ajax_form_tb_restaurant_tables_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tb_restaurant_tables_navigate_form_cb_after_alert

    function sc_form_tb_restaurant_tables_get_last_line_number()
    {
    ...
    } //sc_form_tb_restaurant_tables_get_last_line_number

  function sc_hide_form_tb_restaurant_tables_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_table_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "seats_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_room_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_table_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_tables_fld_id_table'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["seats_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_tables_fld_seats'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["id_room_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_restaurant_tables_fld_id_room'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_table_"][iNumLinha] = "id_table_" + iNumLinha;
    ajax_field_mult["seats_"][iNumLinha] = "seats_" + iNumLinha;
    ajax_field_mult["id_room_"][iNumLinha] = "id_room_" + iNumLinha;
    ajax_field_id["id_table_" + iNumLinha] = new Array("hidden_field_label_id_table_", "hidden_field_data_id_table_" + iNumLinha);
    ajax_field_id["seats_" + iNumLinha] = new Array("hidden_field_label_seats_", "hidden_field_data_seats_" + iNumLinha);
    ajax_field_id["id_room_" + iNumLinha] = new Array("hidden_field_label_id_room_", "hidden_field_data_id_room_" + iNumLinha);
    ajax_error_count["id_table_" + iNumLinha] = "off";
    ajax_error_count["seats_" + iNumLinha] = "off";
    ajax_error_count["id_room_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_table_" + iNumLinha] = "on";
    ajax_read_only["seats_" + iNumLinha] = "off";
    ajax_read_only["id_room_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_table_" + iNumLinha] = "on";
    ajax_read_only["seats_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_table_" + iNumLinha] = null;
    ajax_error_list["seats_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_table_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_table_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_table_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_table_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_table_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["seats_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["seats_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["seats_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["seats_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["seats_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_table_'])) ? $this->nmgp_cmp_readonly['id_table_'] : 'on';
?>
    scAjaxFieldRead("id_table_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['seats_'])) ? $this->nmgp_cmp_readonly['seats_'] : 'off';
?>
    scAjaxFieldRead("seats_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_room_'])) ? $this->nmgp_cmp_readonly['id_room_'] : 'off';
?>
  ...
  {
    scAjaxFieldRead("id_table_" + iSeq, "on");
    scAjaxFieldRead("seats_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_table_" + iRow] || "on" == ajax_error_count["seats_" + iRow] || "on" == ajax_error_count["id_room_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_table_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_seats_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_table_" + iRow] && "off" == ajax_error_count["seats_" + iRow] && "off" == ajax_error_count["id_room_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_table_" + iRow] = "off";
        ajax_error_count["seats_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_table_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_seats_" + iRow).removeClass("scFormErrorLine");
