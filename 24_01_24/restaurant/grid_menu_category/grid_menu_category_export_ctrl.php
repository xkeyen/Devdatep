<?php
@session_start() ;
$_SESSION['scriptcase']['grid_menu_category']['sc_process_barr'] = true;
require_once('../grid_menu_category/index.php');
unset($_SESSION['scriptcase']['grid_menu_category']['sc_process_barr']);
$ExportCtrl = new grid_menu_category_export_control;
$ExportCtrl->Export_barr();

class grid_menu_category_export_control
{
