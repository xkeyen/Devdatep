...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tb_customers/form_tb_customers_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tb_customers_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_tb_customers_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_tb_customers']['error_buffer']) && '' != $_SESSION['scriptcase']['form_tb_customers']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_tb_customers']['error_buffer'];
}
...
<?php
 include_once("form_tb_customers_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_tb_customers_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tb_customers_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tb_customers_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_customer_line" id="hidden_field_data_id_customer" style="<?php echo $sStyleHidden_id_customer; ?>"> <span class="scFormLabelOddFormat css_id_customer_label" style=""><span id="id_label_id_customer"><?php echo $this->nm_new_label['id_customer']; ?></span></span><br><span id="id_read_on_id_customer" class="css_id_customer_line" style="<?php echo $sStyleReadLab_id_customer; ?>"><?php echo $this->form_format_readonly("id_customer", $this->form_encode_input($this->id_customer)); ?></span><span id="id_read_off_id_customer" class="css_read_off_id_customer" style="<?php echo $sStyleReadInp_id_customer; ?>"><input type="hidden" name="id_customer" value="<?php echo $this->form_encode_input($id_customer) . "\">"?><span id="id_ajax_label_id_customer"><?php echo nl2br($id_customer); ?></span>
</span></span> </TD>
   <?php }
      else
      {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_name_line" id="hidden_field_data_customer_name" style="<?php echo $sStyleHidden_customer_name; ?>"> <span class="scFormLabelOddFormat css_customer_name_label" style=""><span id="id_label_customer_name"><?php echo $this->nm_new_label['customer_name']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_gender_line" id="hidden_field_data_customer_gender" style="<?php echo $sStyleHidden_customer_gender; ?>"> <span class="scFormLabelOddFormat css_customer_gender_label" style=""><span id="id_label_customer_gender"><?php echo $this->nm_new_label['customer_gender']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_customer_gender'][] = 'M'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_customer_gender'][] = 'F'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_birthday_line" id="hidden_field_data_customer_birthday" style="<?php echo $sStyleHidden_customer_birthday; ?>"> <span class="scFormLabelOddFormat css_customer_birthday_label" style=""><span id="id_label_customer_birthday"><?php echo $this->nm_new_label['customer_birthday']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_num_doc_line" id="hidden_field_data_customer_num_doc" style="<?php echo $sStyleHidden_customer_num_doc; ?>"> <span class="scFormLabelOddFormat css_customer_num_doc_label" style=""><span id="id_label_customer_num_doc"><?php echo $this->nm_new_label['customer_num_doc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_doctype_line" id="hidden_field_data_doctype" style="<?php echo $sStyleHidden_doctype; ?>"> <span class="scFormLabelOddFormat css_doctype_label" style=""><span id="id_label_doctype"><?php echo $this->nm_new_label['doctype']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_country_line" id="hidden_field_data_id_country" style="<?php echo $sStyleHidden_id_country; ?>"> <span class="scFormLabelOddFormat css_id_country_label" style=""><span id="id_label_id_country"><?php echo $this->nm_new_label['id_country']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AF'; ?>
 <option  value="AL" <?php  if ($this->id_country == "AL") { echo " selected" ;} ?>>Albania</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AL'; ?>
 <option  value="DZ" <?php  if ($this->id_country == "DZ") { echo " selected" ;} ?>>Algeria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DZ'; ?>
 <option  value="AS" <?php  if ($this->id_country == "AS") { echo " selected" ;} ?>>American Samoa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AS'; ?>
 <option  value="AD" <?php  if ($this->id_country == "AD") { echo " selected" ;} ?>>Andorra</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AD'; ?>
 <option  value="AO" <?php  if ($this->id_country == "AO") { echo " selected" ;} ?>>Angola</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AO'; ?>
 <option  value="AI" <?php  if ($this->id_country == "AI") { echo " selected" ;} ?>>Anguilla</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AI'; ?>
 <option  value="AQ" <?php  if ($this->id_country == "AQ") { echo " selected" ;} ?>>Antarctica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AQ'; ?>
 <option  value="AG" <?php  if ($this->id_country == "AG") { echo " selected" ;} ?>>Antigua and Barbuda</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AG'; ?>
 <option  value="AR" <?php  if ($this->id_country == "AR") { echo " selected" ;} ?>>Argentina</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AR'; ?>
 <option  value="AM" <?php  if ($this->id_country == "AM") { echo " selected" ;} ?>>Armenia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AM'; ?>
 <option  value="AW" <?php  if ($this->id_country == "AW") { echo " selected" ;} ?>>Aruba</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AW'; ?>
 <option  value="AU" <?php  if ($this->id_country == "AU") { echo " selected" ;} ?>>Australia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AU'; ?>
 <option  value="AT" <?php  if ($this->id_country == "AT") { echo " selected" ;} ?>>Austria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AT'; ?>
 <option  value="AZ" <?php  if ($this->id_country == "AZ") { echo " selected" ;} ?>>Azerbaijan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AZ'; ?>
 <option  value="BS" <?php  if ($this->id_country == "BS") { echo " selected" ;} ?>>Bahamas</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BS'; ?>
 <option  value="BH" <?php  if ($this->id_country == "BH") { echo " selected" ;} ?>>Bahrain</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BH'; ?>
 <option  value="BD" <?php  if ($this->id_country == "BD") { echo " selected" ;} ?>>Bangladesh</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BD'; ?>
 <option  value="BB" <?php  if ($this->id_country == "BB") { echo " selected" ;} ?>>Barbados</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BB'; ?>
 <option  value="BY" <?php  if ($this->id_country == "BY") { echo " selected" ;} ?>>Belarus</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BY'; ?>
 <option  value="BE" <?php  if ($this->id_country == "BE") { echo " selected" ;} ?>>Belgium</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BE'; ?>
 <option  value="BZ" <?php  if ($this->id_country == "BZ") { echo " selected" ;} ?>>Belize</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BZ'; ?>
 <option  value="BJ" <?php  if ($this->id_country == "BJ") { echo " selected" ;} ?>>Benin</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BJ'; ?>
 <option  value="BM" <?php  if ($this->id_country == "BM") { echo " selected" ;} ?>>Bermuda</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BM'; ?>
 <option  value="BT" <?php  if ($this->id_country == "BT") { echo " selected" ;} ?>>Bhutan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BT'; ?>
 <option  value="BO" <?php  if ($this->id_country == "BO") { echo " selected" ;} ?>>Bolivia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BO'; ?>
 <option  value="BA" <?php  if ($this->id_country == "BA") { echo " selected" ;} ?>>Bosnia and Herzegovina</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BA'; ?>
 <option  value="BW" <?php  if ($this->id_country == "BW") { echo " selected" ;} ?>>Botswana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BW'; ?>
 <option  value="BV" <?php  if ($this->id_country == "BV") { echo " selected" ;} ?>>Bouvet Island</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BV'; ?>
 <option  value="BR" <?php  if ($this->id_country == "BR") { echo " selected" ;} ?><?php  if (empty($this->id_country)) { echo " selected" ;} ?>>Brasil</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BR'; ?>
 <option  value="IO" <?php  if ($this->id_country == "IO") { echo " selected" ;} ?>>British Indian Ocean Territory</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IO'; ?>
 <option  value="BN" <?php  if ($this->id_country == "BN") { echo " selected" ;} ?>>Brunei Darussalam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BN'; ?>
 <option  value="BG" <?php  if ($this->id_country == "BG") { echo " selected" ;} ?>>Bulgaria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BG'; ?>
 <option  value="BF" <?php  if ($this->id_country == "BF") { echo " selected" ;} ?>>Burkina Faso</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BF'; ?>
 <option  value="BI" <?php  if ($this->id_country == "BI") { echo " selected" ;} ?>>Burundi</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'BI'; ?>
 <option  value="KH" <?php  if ($this->id_country == "KH") { echo " selected" ;} ?>>Cambodia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KH'; ?>
 <option  value="CM" <?php  if ($this->id_country == "CM") { echo " selected" ;} ?>>Cameroon</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CM'; ?>
 <option  value="CA" <?php  if ($this->id_country == "CA") { echo " selected" ;} ?>>Canada</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CA'; ?>
 <option  value="CV" <?php  if ($this->id_country == "CV") { echo " selected" ;} ?>>Cape Verde</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CV'; ?>
 <option  value="KY" <?php  if ($this->id_country == "KY") { echo " selected" ;} ?>>Cayman Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KY'; ?>
 <option  value="CF" <?php  if ($this->id_country == "CF") { echo " selected" ;} ?>>Central African Republic</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CF'; ?>
 <option  value="TD" <?php  if ($this->id_country == "TD") { echo " selected" ;} ?>>Chad</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TD'; ?>
 <option  value="CL" <?php  if ($this->id_country == "CL") { echo " selected" ;} ?>>Chile</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CL'; ?>
 <option  value="CN" <?php  if ($this->id_country == "CN") { echo " selected" ;} ?>>China</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CN'; ?>
 <option  value="CX" <?php  if ($this->id_country == "CX") { echo " selected" ;} ?>>Christmas Island</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CX'; ?>
 <option  value="CC" <?php  if ($this->id_country == "CC") { echo " selected" ;} ?>>Cocos (Keeling) Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CC'; ?>
 <option  value="CO" <?php  if ($this->id_country == "CO") { echo " selected" ;} ?>>Colombia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CO'; ?>
 <option  value="KM" <?php  if ($this->id_country == "KM") { echo " selected" ;} ?>>Comoros</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KM'; ?>
 <option  value="CG" <?php  if ($this->id_country == "CG") { echo " selected" ;} ?>>Congo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CG'; ?>
 <option  value="CK" <?php  if ($this->id_country == "CK") { echo " selected" ;} ?>>Cook Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CK'; ?>
 <option  value="CR" <?php  if ($this->id_country == "CR") { echo " selected" ;} ?>>Costa Rica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CR'; ?>
 <option  value="CI" <?php  if ($this->id_country == "CI") { echo " selected" ;} ?>>Cote d Ivoire</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CI'; ?>
 <option  value="HR" <?php  if ($this->id_country == "HR") { echo " selected" ;} ?>>Croatia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HR'; ?>
 <option  value="CU" <?php  if ($this->id_country == "CU") { echo " selected" ;} ?>>Cuba</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CU'; ?>
 <option  value="CY" <?php  if ($this->id_country == "CY") { echo " selected" ;} ?>>Cyprus</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CY'; ?>
 <option  value="CZ" <?php  if ($this->id_country == "CZ") { echo " selected" ;} ?>>Czech Republic</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CZ'; ?>
 <option  value="DK" <?php  if ($this->id_country == "DK") { echo " selected" ;} ?>>Denmark</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DK'; ?>
 <option  value="DJ" <?php  if ($this->id_country == "DJ") { echo " selected" ;} ?>>Djibouti</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DJ'; ?>
 <option  value="DM" <?php  if ($this->id_country == "DM") { echo " selected" ;} ?>>Dominica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DM'; ?>
 <option  value="DO" <?php  if ($this->id_country == "DO") { echo " selected" ;} ?>>Dominican Republic</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DO'; ?>
 <option  value="TP" <?php  if ($this->id_country == "TP") { echo " selected" ;} ?>>East Timor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TP'; ?>
 <option  value="EC" <?php  if ($this->id_country == "EC") { echo " selected" ;} ?>>Ecuador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'EC'; ?>
 <option  value="EG" <?php  if ($this->id_country == "EG") { echo " selected" ;} ?>>Egypt</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'EG'; ?>
 <option  value="SV" <?php  if ($this->id_country == "SV") { echo " selected" ;} ?>>El Salvador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SV'; ?>
 <option  value="GQ" <?php  if ($this->id_country == "GQ") { echo " selected" ;} ?>>Equatorial Guinea</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GQ'; ?>
 <option  value="ER" <?php  if ($this->id_country == "ER") { echo " selected" ;} ?>>Eritrea</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ER'; ?>
 <option  value="EE" <?php  if ($this->id_country == "EE") { echo " selected" ;} ?>>Estonia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'EE'; ?>
 <option  value="ET" <?php  if ($this->id_country == "ET") { echo " selected" ;} ?>>Ethiopia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ET'; ?>
 <option  value="FK" <?php  if ($this->id_country == "FK") { echo " selected" ;} ?>>Falkland Islands (Malvinas)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FK'; ?>
 <option  value="FO" <?php  if ($this->id_country == "FO") { echo " selected" ;} ?>>Faroe Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FO'; ?>
 <option  value="FJ" <?php  if ($this->id_country == "FJ") { echo " selected" ;} ?>>Fiji</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FJ'; ?>
 <option  value="FI" <?php  if ($this->id_country == "FI") { echo " selected" ;} ?>>Finland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FI'; ?>
 <option  value="FR" <?php  if ($this->id_country == "FR") { echo " selected" ;} ?>>France</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FR'; ?>
 <option  value="FX" <?php  if ($this->id_country == "FX") { echo " selected" ;} ?>>France Metropolitan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FX'; ?>
 <option  value="GF" <?php  if ($this->id_country == "GF") { echo " selected" ;} ?>>French Guiana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GF'; ?>
 <option  value="PF" <?php  if ($this->id_country == "PF") { echo " selected" ;} ?>>French Polynesia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PF'; ?>
 <option  value="TF" <?php  if ($this->id_country == "TF") { echo " selected" ;} ?>>French Southern Territories</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TF'; ?>
 <option  value="GA" <?php  if ($this->id_country == "GA") { echo " selected" ;} ?>>Gabon</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GA'; ?>
 <option  value="GM" <?php  if ($this->id_country == "GM") { echo " selected" ;} ?>>Gambia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GM'; ?>
 <option  value="GE" <?php  if ($this->id_country == "GE") { echo " selected" ;} ?>>Georgia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GE'; ?>
 <option  value="DE" <?php  if ($this->id_country == "DE") { echo " selected" ;} ?>>Germany</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'DE'; ?>
 <option  value="GH" <?php  if ($this->id_country == "GH") { echo " selected" ;} ?>>Ghana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GH'; ?>
 <option  value="GI" <?php  if ($this->id_country == "GI") { echo " selected" ;} ?>>Gibraltar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GI'; ?>
 <option  value="GR" <?php  if ($this->id_country == "GR") { echo " selected" ;} ?>>Greece</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GR'; ?>
 <option  value="GL" <?php  if ($this->id_country == "GL") { echo " selected" ;} ?>>Greenland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GL'; ?>
 <option  value="GD" <?php  if ($this->id_country == "GD") { echo " selected" ;} ?>>Grenada</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GD'; ?>
 <option  value="GP" <?php  if ($this->id_country == "GP") { echo " selected" ;} ?>>Guadeloupe</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GP'; ?>
 <option  value="GU" <?php  if ($this->id_country == "GU") { echo " selected" ;} ?>>Guam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GU'; ?>
 <option  value="GT" <?php  if ($this->id_country == "GT") { echo " selected" ;} ?>>Guatemala</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GT'; ?>
 <option  value="GN" <?php  if ($this->id_country == "GN") { echo " selected" ;} ?>>Guinea</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GN'; ?>
 <option  value="GW" <?php  if ($this->id_country == "GW") { echo " selected" ;} ?>>Guinea-Bissau</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GW'; ?>
 <option  value="GY" <?php  if ($this->id_country == "GY") { echo " selected" ;} ?>>Guyana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GY'; ?>
 <option  value="HT" <?php  if ($this->id_country == "HT") { echo " selected" ;} ?>>Haiti</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HT'; ?>
 <option  value="HM" <?php  if ($this->id_country == "HM") { echo " selected" ;} ?>>Heard Island and McDonald Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HM'; ?>
 <option  value="HN" <?php  if ($this->id_country == "HN") { echo " selected" ;} ?>>Honduras</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HN'; ?>
 <option  value="HK" <?php  if ($this->id_country == "HK") { echo " selected" ;} ?>>Hong Kong</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HK'; ?>
 <option  value="HU" <?php  if ($this->id_country == "HU") { echo " selected" ;} ?>>Hungary</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'HU'; ?>
 <option  value="IS" <?php  if ($this->id_country == "IS") { echo " selected" ;} ?>>Iceland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IS'; ?>
 <option  value="IN" <?php  if ($this->id_country == "IN") { echo " selected" ;} ?>>India</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IN'; ?>
 <option  value="ID" <?php  if ($this->id_country == "ID") { echo " selected" ;} ?>>Indonesia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ID'; ?>
 <option  value="IR" <?php  if ($this->id_country == "IR") { echo " selected" ;} ?>>Iran (Islamic Republic of)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IR'; ?>
 <option  value="IQ" <?php  if ($this->id_country == "IQ") { echo " selected" ;} ?>>Iraq</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IQ'; ?>
 <option  value="IE" <?php  if ($this->id_country == "IE") { echo " selected" ;} ?>>Ireland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IE'; ?>
 <option  value="IL" <?php  if ($this->id_country == "IL") { echo " selected" ;} ?>>Israel</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IL'; ?>
 <option  value="IT" <?php  if ($this->id_country == "IT") { echo " selected" ;} ?>>Italy</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'IT'; ?>
 <option  value="JM" <?php  if ($this->id_country == "JM") { echo " selected" ;} ?>>Jamaica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'JM'; ?>
 <option  value="JP" <?php  if ($this->id_country == "JP") { echo " selected" ;} ?>>Japan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'JP'; ?>
 <option  value="JO" <?php  if ($this->id_country == "JO") { echo " selected" ;} ?>>Jordan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'JO'; ?>
 <option  value="KZ" <?php  if ($this->id_country == "KZ") { echo " selected" ;} ?>>Kazakhstan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KZ'; ?>
 <option  value="KE" <?php  if ($this->id_country == "KE") { echo " selected" ;} ?>>Kenya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KE'; ?>
 <option  value="KI" <?php  if ($this->id_country == "KI") { echo " selected" ;} ?>>Kiribati</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KI'; ?>
 <option  value="KP" <?php  if ($this->id_country == "KP") { echo " selected" ;} ?>>Korea Democratic People Republic of</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KP'; ?>
 <option  value="KR" <?php  if ($this->id_country == "KR") { echo " selected" ;} ?>>Korea Republic of</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KR'; ?>
 <option  value="KW" <?php  if ($this->id_country == "KW") { echo " selected" ;} ?>>Kuwait</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KW'; ?>
 <option  value="KG" <?php  if ($this->id_country == "KG") { echo " selected" ;} ?>>Kyrgyzstan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KG'; ?>
 <option  value="LA" <?php  if ($this->id_country == "LA") { echo " selected" ;} ?>>Lao People Democratic Republic</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LA'; ?>
 <option  value="LT" <?php  if ($this->id_country == "LT") { echo " selected" ;} ?>>Latin America</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LT'; ?>
 <option  value="LV" <?php  if ($this->id_country == "LV") { echo " selected" ;} ?>>Latvia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LV'; ?>
 <option  value="LB" <?php  if ($this->id_country == "LB") { echo " selected" ;} ?>>Lebanon</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LB'; ?>
 <option  value="LS" <?php  if ($this->id_country == "LS") { echo " selected" ;} ?>>Lesotho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LS'; ?>
 <option  value="LR" <?php  if ($this->id_country == "LR") { echo " selected" ;} ?>>Liberia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LR'; ?>
 <option  value="LY" <?php  if ($this->id_country == "LY") { echo " selected" ;} ?>>Libyan Arab Jamahiriya</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LY'; ?>
 <option  value="LI" <?php  if ($this->id_country == "LI") { echo " selected" ;} ?>>Liechtenstein</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LI'; ?>
 <option  value="LX" <?php  if ($this->id_country == "LX") { echo " selected" ;} ?>>Lithuania</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LX'; ?>
 <option  value="LU" <?php  if ($this->id_country == "LU") { echo " selected" ;} ?>>Luxembourg</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LU'; ?>
 <option  value="MO" <?php  if ($this->id_country == "MO") { echo " selected" ;} ?>>Macau</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MO'; ?>
 <option  value="MK" <?php  if ($this->id_country == "MK") { echo " selected" ;} ?>>Macedonia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MK'; ?>
 <option  value="MG" <?php  if ($this->id_country == "MG") { echo " selected" ;} ?>>Madagascar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MG'; ?>
 <option  value="MW" <?php  if ($this->id_country == "MW") { echo " selected" ;} ?>>Malawi</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MW'; ?>
 <option  value="MY" <?php  if ($this->id_country == "MY") { echo " selected" ;} ?>>Malaysia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MY'; ?>
 <option  value="MV" <?php  if ($this->id_country == "MV") { echo " selected" ;} ?>>Maldives</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MV'; ?>
 <option  value="ML" <?php  if ($this->id_country == "ML") { echo " selected" ;} ?>>Mali</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ML'; ?>
 <option  value="MT" <?php  if ($this->id_country == "MT") { echo " selected" ;} ?>>Malta</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MT'; ?>
 <option  value="MH" <?php  if ($this->id_country == "MH") { echo " selected" ;} ?>>Marshall Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MH'; ?>
 <option  value="MQ" <?php  if ($this->id_country == "MQ") { echo " selected" ;} ?>>Martinique</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MQ'; ?>
 <option  value="MR" <?php  if ($this->id_country == "MR") { echo " selected" ;} ?>>Mauritania</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MR'; ?>
 <option  value="MU" <?php  if ($this->id_country == "MU") { echo " selected" ;} ?>>Mauritius</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MU'; ?>
 <option  value="YT" <?php  if ($this->id_country == "YT") { echo " selected" ;} ?>>Mayotte</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'YT'; ?>
 <option  value="MX" <?php  if ($this->id_country == "MX") { echo " selected" ;} ?>>Mexico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MX'; ?>
 <option  value="FM" <?php  if ($this->id_country == "FM") { echo " selected" ;} ?>>Micronesia (Federated States of)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'FM'; ?>
 <option  value="MD" <?php  if ($this->id_country == "MD") { echo " selected" ;} ?>>Moldova Republic of</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MD'; ?>
 <option  value="MC" <?php  if ($this->id_country == "MC") { echo " selected" ;} ?>>Monaco</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MC'; ?>
 <option  value="MN" <?php  if ($this->id_country == "MN") { echo " selected" ;} ?>>Mongolia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MN'; ?>
 <option  value="MS" <?php  if ($this->id_country == "MS") { echo " selected" ;} ?>>Montserrat</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MS'; ?>
 <option  value="MA" <?php  if ($this->id_country == "MA") { echo " selected" ;} ?>>Morocco</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MA'; ?>
 <option  value="MZ" <?php  if ($this->id_country == "MZ") { echo " selected" ;} ?>>Mozambique</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MZ'; ?>
 <option  value="MM" <?php  if ($this->id_country == "MM") { echo " selected" ;} ?>>Myanmar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MM'; ?>
 <option  value="NA" <?php  if ($this->id_country == "NA") { echo " selected" ;} ?>>Namibia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NA'; ?>
 <option  value="NR" <?php  if ($this->id_country == "NR") { echo " selected" ;} ?>>Nauru</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NR'; ?>
 <option  value="NP" <?php  if ($this->id_country == "NP") { echo " selected" ;} ?>>Nepal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NP'; ?>
 <option  value="NL" <?php  if ($this->id_country == "NL") { echo " selected" ;} ?>>Netherlands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NL'; ?>
 <option  value="AN" <?php  if ($this->id_country == "AN") { echo " selected" ;} ?>>Netherlands Antilles</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AN'; ?>
 <option  value="NC" <?php  if ($this->id_country == "NC") { echo " selected" ;} ?>>New Caledonia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NC'; ?>
 <option  value="NZ" <?php  if ($this->id_country == "NZ") { echo " selected" ;} ?>>New Zealand</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NZ'; ?>
 <option  value="NI" <?php  if ($this->id_country == "NI") { echo " selected" ;} ?>>Nicaragua</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NI'; ?>
 <option  value="NE" <?php  if ($this->id_country == "NE") { echo " selected" ;} ?>>Niger</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NE'; ?>
 <option  value="NG" <?php  if ($this->id_country == "NG") { echo " selected" ;} ?>>Nigeria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NG'; ?>
 <option  value="NU" <?php  if ($this->id_country == "NU") { echo " selected" ;} ?>>Niue</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NU'; ?>
 <option  value="NF" <?php  if ($this->id_country == "NF") { echo " selected" ;} ?>>Norfolk Island</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NF'; ?>
 <option  value="MP" <?php  if ($this->id_country == "MP") { echo " selected" ;} ?>>Northern Mariana Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'MP'; ?>
 <option  value="NO" <?php  if ($this->id_country == "NO") { echo " selected" ;} ?>>Norway</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'NO'; ?>
 <option  value="OM" <?php  if ($this->id_country == "OM") { echo " selected" ;} ?>>Oman</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'OM'; ?>
 <option  value="PK" <?php  if ($this->id_country == "PK") { echo " selected" ;} ?>>Pakistan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PK'; ?>
 <option  value="PW" <?php  if ($this->id_country == "PW") { echo " selected" ;} ?>>Palau</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PW'; ?>
 <option  value="PA" <?php  if ($this->id_country == "PA") { echo " selected" ;} ?>>Panama</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PA'; ?>
 <option  value="PG" <?php  if ($this->id_country == "PG") { echo " selected" ;} ?>>Papua New Guinea</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PG'; ?>
 <option  value="PY" <?php  if ($this->id_country == "PY") { echo " selected" ;} ?>>Paraguay</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PY'; ?>
 <option  value="PE" <?php  if ($this->id_country == "PE") { echo " selected" ;} ?>>Peru</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PE'; ?>
 <option  value="PH" <?php  if ($this->id_country == "PH") { echo " selected" ;} ?>>Philippines</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PH'; ?>
 <option  value="PN" <?php  if ($this->id_country == "PN") { echo " selected" ;} ?>>Pitcairn</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PN'; ?>
 <option  value="PL" <?php  if ($this->id_country == "PL") { echo " selected" ;} ?>>Poland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PL'; ?>
 <option  value="PT" <?php  if ($this->id_country == "PT") { echo " selected" ;} ?>>Portugal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PT'; ?>
 <option  value="PR" <?php  if ($this->id_country == "PR") { echo " selected" ;} ?>>Puerto Rico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PR'; ?>
 <option  value="QA" <?php  if ($this->id_country == "QA") { echo " selected" ;} ?>>Qatar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'QA'; ?>
 <option  value="RE" <?php  if ($this->id_country == "RE") { echo " selected" ;} ?>>Reunion</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'RE'; ?>
 <option  value="RO" <?php  if ($this->id_country == "RO") { echo " selected" ;} ?>>Romania</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'RO'; ?>
 <option  value="RU" <?php  if ($this->id_country == "RU") { echo " selected" ;} ?>>Russian Federation</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'RU'; ?>
 <option  value="RW" <?php  if ($this->id_country == "RW") { echo " selected" ;} ?>>Rwanda</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'RW'; ?>
 <option  value="SH" <?php  if ($this->id_country == "SH") { echo " selected" ;} ?>>Saint Helena</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SH'; ?>
 <option  value="KN" <?php  if ($this->id_country == "KN") { echo " selected" ;} ?>>Saint Kitts and Nevis</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'KN'; ?>
 <option  value="LC" <?php  if ($this->id_country == "LC") { echo " selected" ;} ?>>Saint Lucia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LC'; ?>
 <option  value="PM" <?php  if ($this->id_country == "PM") { echo " selected" ;} ?>>Saint Pierre and Miquelon</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'PM'; ?>
 <option  value="VC" <?php  if ($this->id_country == "VC") { echo " selected" ;} ?>>Saint Vincent and the Grenadines</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VC'; ?>
 <option  value="WS" <?php  if ($this->id_country == "WS") { echo " selected" ;} ?>>Samoa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'WS'; ?>
 <option  value="SM" <?php  if ($this->id_country == "SM") { echo " selected" ;} ?>>San Marino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SM'; ?>
 <option  value="ST" <?php  if ($this->id_country == "ST") { echo " selected" ;} ?>>Sao Tome and Principe</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ST'; ?>
 <option  value="SA" <?php  if ($this->id_country == "SA") { echo " selected" ;} ?>>Saudi Arabia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SA'; ?>
 <option  value="SN" <?php  if ($this->id_country == "SN") { echo " selected" ;} ?>>Senegal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SN'; ?>
 <option  value="SC" <?php  if ($this->id_country == "SC") { echo " selected" ;} ?>>Seychelles</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SC'; ?>
 <option  value="SL" <?php  if ($this->id_country == "SL") { echo " selected" ;} ?>>Sierra Leone</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SL'; ?>
 <option  value="SG" <?php  if ($this->id_country == "SG") { echo " selected" ;} ?>>Singapore</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SG'; ?>
 <option  value="SK" <?php  if ($this->id_country == "SK") { echo " selected" ;} ?>>Slovakia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SK'; ?>
 <option  value="SI" <?php  if ($this->id_country == "SI") { echo " selected" ;} ?>>Slovenia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SI'; ?>
 <option  value="SB" <?php  if ($this->id_country == "SB") { echo " selected" ;} ?>>Solomon Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SB'; ?>
 <option  value="SO" <?php  if ($this->id_country == "SO") { echo " selected" ;} ?>>Somalia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SO'; ?>
 <option  value="ZA" <?php  if ($this->id_country == "ZA") { echo " selected" ;} ?>>South Africa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ZA'; ?>
 <option  value="GS" <?php  if ($this->id_country == "GS") { echo " selected" ;} ?>>South Georgia and the South Sandwich</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GS'; ?>
 <option  value="ES" <?php  if ($this->id_country == "ES") { echo " selected" ;} ?>>Spain</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ES'; ?>
 <option  value="LK" <?php  if ($this->id_country == "LK") { echo " selected" ;} ?>>Sri Lanka</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'LK'; ?>
 <option  value="SD" <?php  if ($this->id_country == "SD") { echo " selected" ;} ?>>Sudan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SD'; ?>
 <option  value="SR" <?php  if ($this->id_country == "SR") { echo " selected" ;} ?>>Suriname</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SR'; ?>
 <option  value="SJ" <?php  if ($this->id_country == "SJ") { echo " selected" ;} ?>>Svalbard and Jan Mayen Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SJ'; ?>
 <option  value="SZ" <?php  if ($this->id_country == "SZ") { echo " selected" ;} ?>>Swaziland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SZ'; ?>
 <option  value="SE" <?php  if ($this->id_country == "SE") { echo " selected" ;} ?>>Sweden</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SE'; ?>
 <option  value="CH" <?php  if ($this->id_country == "CH") { echo " selected" ;} ?>>Switzerland</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'CH'; ?>
 <option  value="SY" <?php  if ($this->id_country == "SY") { echo " selected" ;} ?>>Syrian Arab Republic</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'SY'; ?>
 <option  value="TW" <?php  if ($this->id_country == "TW") { echo " selected" ;} ?>>Taiwan Republic of China</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TW'; ?>
 <option  value="TJ" <?php  if ($this->id_country == "TJ") { echo " selected" ;} ?>>Tajikistan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TJ'; ?>
 <option  value="TZ" <?php  if ($this->id_country == "TZ") { echo " selected" ;} ?>>Tanzania United Republic of</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TZ'; ?>
 <option  value="TH" <?php  if ($this->id_country == "TH") { echo " selected" ;} ?>>Thailand</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TH'; ?>
 <option  value="TG" <?php  if ($this->id_country == "TG") { echo " selected" ;} ?>>Togo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TG'; ?>
 <option  value="TK" <?php  if ($this->id_country == "TK") { echo " selected" ;} ?>>Tokelau</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TK'; ?>
 <option  value="TO" <?php  if ($this->id_country == "TO") { echo " selected" ;} ?>>Tonga</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TO'; ?>
 <option  value="TT" <?php  if ($this->id_country == "TT") { echo " selected" ;} ?>>Trinidad and Tobago</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TT'; ?>
 <option  value="TN" <?php  if ($this->id_country == "TN") { echo " selected" ;} ?>>Tunisia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TN'; ?>
 <option  value="TR" <?php  if ($this->id_country == "TR") { echo " selected" ;} ?>>Turkey</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TR'; ?>
 <option  value="TM" <?php  if ($this->id_country == "TM") { echo " selected" ;} ?>>Turkmenistan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TM'; ?>
 <option  value="TC" <?php  if ($this->id_country == "TC") { echo " selected" ;} ?>>Turks and Caicos Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TC'; ?>
 <option  value="TV" <?php  if ($this->id_country == "TV") { echo " selected" ;} ?>>Tuvalu</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'TV'; ?>
 <option  value="UG" <?php  if ($this->id_country == "UG") { echo " selected" ;} ?>>Uganda</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'UG'; ?>
 <option  value="UA" <?php  if ($this->id_country == "UA") { echo " selected" ;} ?>>Ukraine</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'UA'; ?>
 <option  value="AE" <?php  if ($this->id_country == "AE") { echo " selected" ;} ?>>United Arab Emirates</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'AE'; ?>
 <option  value="GB" <?php  if ($this->id_country == "GB") { echo " selected" ;} ?>>United Kingdom</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'GB'; ?>
 <option  value="US" <?php  if ($this->id_country == "US") { echo " selected" ;} ?>>United States</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'US'; ?>
 <option  value="UM" <?php  if ($this->id_country == "UM") { echo " selected" ;} ?>>United States Minor Outlying Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'UM'; ?>
 <option  value="UY" <?php  if ($this->id_country == "UY") { echo " selected" ;} ?>>Uruguay</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'UY'; ?>
 <option  value="UZ" <?php  if ($this->id_country == "UZ") { echo " selected" ;} ?>>Uzbekistan</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'UZ'; ?>
 <option  value="VU" <?php  if ($this->id_country == "VU") { echo " selected" ;} ?>>Vanuatu</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VU'; ?>
 <option  value="VA" <?php  if ($this->id_country == "VA") { echo " selected" ;} ?>>Vatican City State (Holy See)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VA'; ?>
 <option  value="VE" <?php  if ($this->id_country == "VE") { echo " selected" ;} ?>>Venezuela</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VE'; ?>
 <option  value="VN" <?php  if ($this->id_country == "VN") { echo " selected" ;} ?>>Viet Nam</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VN'; ?>
 <option  value="VG" <?php  if ($this->id_country == "VG") { echo " selected" ;} ?>>Virgin Islands (British)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VG'; ?>
 <option  value="VI" <?php  if ($this->id_country == "VI") { echo " selected" ;} ?>>Virgin Islands (U.S.)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'VI'; ?>
 <option  value="WF" <?php  if ($this->id_country == "WF") { echo " selected" ;} ?>>Wallis and Futuna Islands</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'WF'; ?>
 <option  value="EH" <?php  if ($this->id_country == "EH") { echo " selected" ;} ?>>Western Sahara</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'EH'; ?>
 <option  value="YE" <?php  if ($this->id_country == "YE") { echo " selected" ;} ?>>Yemen</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'YE'; ?>
 <option  value="YU" <?php  if ($this->id_country == "YU") { echo " selected" ;} ?>>Yugoslavia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'YU'; ?>
 <option  value="ZR" <?php  if ($this->id_country == "ZR") { echo " selected" ;} ?>>Zaire</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ZR'; ?>
 <option  value="ZM" <?php  if ($this->id_country == "ZM") { echo " selected" ;} ?>>Zambia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ZM'; ?>
 <option  value="ZW" <?php  if ($this->id_country == "ZW") { echo " selected" ;} ?>>Zimbabwe</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['Lookup_id_country'][] = 'ZW'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_address_line" id="hidden_field_data_customer_address" style="<?php echo $sStyleHidden_customer_address; ?>"> <span class="scFormLabelOddFormat css_customer_address_label" style=""><span id="id_label_customer_address"><?php echo $this->nm_new_label['customer_address']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_phone1_line" id="hidden_field_data_customer_phone1" style="<?php echo $sStyleHidden_customer_phone1; ?>"> <span class="scFormLabelOddFormat css_customer_phone1_label" style=""><span id="id_label_customer_phone1"><?php echo $this->nm_new_label['customer_phone1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customer_phone2_line" id="hidden_field_data_customer_phone2" style="<?php echo $sStyleHidden_customer_phone2; ?>"> <span class="scFormLabelOddFormat css_customer_phone2_label" style=""><span id="id_label_customer_phone2"><?php echo $this->nm_new_label['customer_phone2']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tb_customers_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tb_customers_mob");
 parent.scAjaxDetailHeight("form_tb_customers_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
