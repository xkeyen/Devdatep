  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_customers" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_customers_form();
	}
...
?>
  ...
  function do_ajax_form_tb_customers_validate_id_customer()
  {
    var nomeCampo_id_customer = "id_customer";
    var var_id_customer = scAjaxGetFieldHidden(nomeCampo_id_customer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_id_customer(var_id_customer, var_script_case_init, do_ajax_form_tb_customers_validate_id_customer_cb);
  } // do_ajax_form_tb_customers_validate_id_customer

  function do_ajax_form_tb_customers_validate_id_customer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_id_customer_cb

  // ---------- Validate customer_name
  function do_ajax_form_tb_customers_validate_customer_name()
  {
    var nomeCampo_customer_name = "customer_name";
    var var_customer_name = scAjaxGetFieldText(nomeCampo_customer_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_name(var_customer_name, var_script_case_init, do_ajax_form_tb_customers_validate_customer_name_cb);
  } // do_ajax_form_tb_customers_validate_customer_name

  function do_ajax_form_tb_customers_validate_customer_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_name_cb

  // ---------- Validate customer_gender
  function do_ajax_form_tb_customers_validate_customer_gender()
  {
    var nomeCampo_customer_gender = "customer_gender";
    var var_customer_gender = scAjaxGetFieldRadio(nomeCampo_customer_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_gender(var_customer_gender, var_script_case_init, do_ajax_form_tb_customers_validate_customer_gender_cb);
  } // do_ajax_form_tb_customers_validate_customer_gender

  function do_ajax_form_tb_customers_validate_customer_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_gender_cb

  // ---------- Validate customer_birthday
  function do_ajax_form_tb_customers_validate_customer_birthday()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_birthday(var_customer_birthday, var_script_case_init, do_ajax_form_tb_customers_validate_customer_birthday_cb);
  } // do_ajax_form_tb_customers_validate_customer_birthday

  function do_ajax_form_tb_customers_validate_customer_birthday_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_birthday_cb

  // ---------- Validate customer_num_doc
  function do_ajax_form_tb_customers_validate_customer_num_doc()
  {
    var nomeCampo_customer_num_doc = "customer_num_doc";
    var var_customer_num_doc = scAjaxGetFieldText(nomeCampo_customer_num_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_num_doc(var_customer_num_doc, var_script_case_init, do_ajax_form_tb_customers_validate_customer_num_doc_cb);
  } // do_ajax_form_tb_customers_validate_customer_num_doc

  function do_ajax_form_tb_customers_validate_customer_num_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_num_doc_cb

  // ---------- Validate doctype
  function do_ajax_form_tb_customers_validate_doctype()
  {
    var nomeCampo_doctype = "doctype";
    var var_doctype = scAjaxGetFieldText(nomeCampo_doctype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_doctype(var_doctype, var_script_case_init, do_ajax_form_tb_customers_validate_doctype_cb);
  } // do_ajax_form_tb_customers_validate_doctype

  function do_ajax_form_tb_customers_validate_doctype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doctype";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_doctype_cb

  // ---------- Validate id_country
  function do_ajax_form_tb_customers_validate_id_country()
  {
    var nomeCampo_id_country = "id_country";
    var var_id_country = scAjaxGetFieldSelect(nomeCampo_id_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_id_country(var_id_country, var_script_case_init, do_ajax_form_tb_customers_validate_id_country_cb);
  } // do_ajax_form_tb_customers_validate_id_country

  function do_ajax_form_tb_customers_validate_id_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_id_country_cb

  // ---------- Validate customer_address
  function do_ajax_form_tb_customers_validate_customer_address()
  {
    var nomeCampo_customer_address = "customer_address";
    var var_customer_address = scAjaxGetFieldText(nomeCampo_customer_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_address(var_customer_address, var_script_case_init, do_ajax_form_tb_customers_validate_customer_address_cb);
  } // do_ajax_form_tb_customers_validate_customer_address

  function do_ajax_form_tb_customers_validate_customer_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_address_cb

  // ---------- Validate customer_phone1
  function do_ajax_form_tb_customers_validate_customer_phone1()
  {
    var nomeCampo_customer_phone1 = "customer_phone1";
    var var_customer_phone1 = scAjaxGetFieldText(nomeCampo_customer_phone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_phone1(var_customer_phone1, var_script_case_init, do_ajax_form_tb_customers_validate_customer_phone1_cb);
  } // do_ajax_form_tb_customers_validate_customer_phone1

  function do_ajax_form_tb_customers_validate_customer_phone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_phone1_cb

  // ---------- Validate customer_phone2
  function do_ajax_form_tb_customers_validate_customer_phone2()
  {
    var nomeCampo_customer_phone2 = "customer_phone2";
    var var_customer_phone2 = scAjaxGetFieldText(nomeCampo_customer_phone2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_customers_validate_customer_phone2(var_customer_phone2, var_script_case_init, do_ajax_form_tb_customers_validate_customer_phone2_cb);
  } // do_ajax_form_tb_customers_validate_customer_phone2

  function do_ajax_form_tb_customers_validate_customer_phone2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_customers_validate_customer_phone2_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_customers_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_customers_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_customers_submit_form(var_id_customer, var_customer_name, var_customer_gender, var_customer_birthday, var_customer_num_doc, var_doctype, var_id_country, var_customer_address, var_customer_phone1, var_customer_phone2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_customers_submit_form_cb);
  } // do_ajax_form_tb_customers_submit_form

  function do_ajax_form_tb_customers_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_customers_submit_form_cb_after_alert);
  } // do_ajax_form_tb_customers_submit_form_cb
  function do_ajax_form_tb_customers_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_customers_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_customers_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_customers_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_customers_navigate_form();
    }
  }

  function perform_ajax_form_tb_customers_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_customers_navigate_form(var_id_customer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_customers_navigate_form_cb);
  } // do_ajax_form_tb_customers_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_customers']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_customers_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_customers_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_customers_navigate_form_cb
  function do_ajax_form_tb_customers_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_customers_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_customers_navigate_form_cb_after_alert

  function sc_hide_form_tb_customers_form()
  {
