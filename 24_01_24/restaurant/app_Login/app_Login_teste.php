<?php  
  ...
  session_start() ;
  class app_Login_form_teste
  {
   function app_Login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "app_Login/img";
...
?> 
<br> 
<B><FONT SIZE="4">app_Login</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="app_Login"> 
</form> 
...
<?php
  ...
  $frm_teste = new app_Login_form_teste();
  $frm_teste->app_Login_teste();
?>
