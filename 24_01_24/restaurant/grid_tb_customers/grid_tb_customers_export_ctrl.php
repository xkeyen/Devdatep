<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tb_customers']['sc_process_barr'] = true;
require_once('../grid_tb_customers/index.php');
unset($_SESSION['scriptcase']['grid_tb_customers']['sc_process_barr']);
$ExportCtrl = new grid_tb_customers_export_control;
$ExportCtrl->Export_barr();

class grid_tb_customers_export_control
{
