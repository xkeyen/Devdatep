...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['form_agenda']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
    ...
    function ValidateField_id_tecnico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_tecnico, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_cliente, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_estado_actual(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->estado_actual, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_evaluacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->evaluacion, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
