<?php  
  ...
  session_start() ;
  class Grafico_pais_form_teste
  {
  function Grafico_pais_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">Grafico_pais</FONT></B> 
<br> 
<br> 
...
<input type=submit value="Grafico_pais"> 
</form> 
...
<?php
  ...
  $frm_teste = new Grafico_pais_form_teste();
  $frm_teste->Grafico_pais_teste();
?>
