<?php
@session_start() ;
$_SESSION['scriptcase']['Grafico_pais']['sc_process_barr'] = true;
require_once('../Grafico_pais/index.php');
unset($_SESSION['scriptcase']['Grafico_pais']['sc_process_barr']);
$ExportCtrl = new Grafico_pais_export_control;
$ExportCtrl->Export_barr();

class Grafico_pais_export_control
{
