<?php
@session_start() ;
$_SESSION['scriptcase']['grid_agenda']['sc_process_barr'] = true;
require_once('../grid_agenda/index.php');
unset($_SESSION['scriptcase']['grid_agenda']['sc_process_barr']);
$ExportCtrl = new grid_agenda_export_control;
$ExportCtrl->Export_barr();

class grid_agenda_export_control
{
