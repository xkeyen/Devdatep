<?php  
  ...
  session_start() ;
  class pdfreport_aplicaciones_form_teste
  {
  function pdfreport_aplicaciones_teste()
  {
...
<html> 
<HEAD>
 <title>pdfreport_aplicaciones</title> 
...
<input type=submit value="pdfreport_aplicaciones"> 
</form> 
...
<?php
  ...
  $frm_teste = new pdfreport_aplicaciones_form_teste();
  $frm_teste->pdfreport_aplicaciones_teste();
?>
