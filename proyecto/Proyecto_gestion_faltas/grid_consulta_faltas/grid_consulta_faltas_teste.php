<?php  
  ...
  session_start() ;
  class grid_consulta_faltas_form_teste
  {
  function grid_consulta_faltas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_consulta_faltas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_consulta_faltas"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_consulta_faltas_form_teste();
  $frm_teste->grid_consulta_faltas_teste();
?>
