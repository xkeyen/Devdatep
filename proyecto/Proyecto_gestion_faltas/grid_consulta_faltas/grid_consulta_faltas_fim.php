...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____grid_consulta_faltas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____grid_consulta_faltas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_consulta_faltas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['embutida_filho'] as $ind => $sc_init)
          {
