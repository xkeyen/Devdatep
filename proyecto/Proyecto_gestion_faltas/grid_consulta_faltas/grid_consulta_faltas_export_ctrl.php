<?php
@session_start() ;
$_SESSION['scriptcase']['grid_consulta_faltas']['sc_process_barr'] = true;
require_once('../grid_consulta_faltas/index.php');
unset($_SESSION['scriptcase']['grid_consulta_faltas']['sc_process_barr']);
$ExportCtrl = new grid_consulta_faltas_export_control;
$ExportCtrl->Export_barr();

class grid_consulta_faltas_export_control
{
