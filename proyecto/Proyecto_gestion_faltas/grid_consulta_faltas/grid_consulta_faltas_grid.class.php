<?php
class grid_consulta_faltas_grid
{
   var $Ini;
   var $Erro;
   var $Db;
   ...
   var $arg_sum_area;
   var $Label_area;
   var $sc_proc_quebra_area;
   var $count_area;
   var $colaborador;
   var $desc_falta;
   var $tipo_falta_descripcion;
   var $fecha_falta;
   var $tipo_sancion;
   var $estado_sancion;
   var $fecha_sancion;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['charts_html'] = '';
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_consulta_faltas/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_consulta_faltas_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
    if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false) {
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_consulta_faltas'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new grid_consulta_faltas_grafico();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['graf_pdf'] == "S")
       { 
           if (isset($_GET['flash_graf']) && 'pdf' == $_GET['flash_graf'] && $Gera_graf)
           {
               $this->grafico_pdf_flash();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "grid";
           } 
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf")
           { 
               $flag_apaga_pdf_log = FALSE;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "igual";
           } 
           $this->nm_fim_grid($flag_apaga_pdf_log);
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'] .= "colaborador?#?" . "COLABORADOR" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'] .= "desc_falta?#?" . "DESC FALTA" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'] .= "fecha_falta?#?" . "FECHA FALTA" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'] .= "usuario_registro?#?" . "USUARIO REGISTRO" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['mostra_edit'] = "N";
   }
   $this->sc_proc_quebra_area = false;
   $this->NM_cont_body   = 0; 
   $this->NM_emb_tree_no = false; 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_consulta_faltas", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['desc_falta'] = " asc";
   $this->Cmps_ord_def["fl.fault_name"] = "";
   $this->Cmps_ord_def['tipo_falta_descripcion'] = " asc";
   $this->Cmps_ord_def["ft.fault_type_description"] = "";
   $this->Cmps_ord_def['fecha_falta'] = " desc";
   $this->Cmps_ord_def["f.fault_practitioner_date"] = "";
   $this->Cmps_ord_def['tipo_sancion'] = " asc";
   $this->Cmps_ord_def["fr.sanction_type_name"] = "";
   $this->Cmps_ord_def['estado_sancion'] = " asc";
   $this->Cmps_ord_def["fp.sanction_description"] = "";
   $this->Cmps_ord_def['fecha_sancion'] = " desc";
   $this->Cmps_ord_def["f.sanction_date"] = "";
   $this->Cmps_ord_def['evidencia'] = " asc";
   ...
   $this->Cmps_ord_def["f.fault_register_date"] = "";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_ant'];  
   ...
   { 
       ...
       $fecha_falta_2 = (isset($Busca_temp['fecha_falta_input_2'])) ? $Busca_temp['fecha_falta_input_2'] : ""; 
       $this->fecha_falta_2 = $fecha_falta_2; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "muda_qt_linhas";
   } 
   $this->sc_where_Max = "f" . "u" . "ll";

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_consulta_faltas'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_consulta_faltas'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_consulta_faltas/grid_consulta_faltas_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_consulta_faltas_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao']       = "igual" ; 
...
// 
   ...
   $this->arg_sum_area = "";
   $this->count_area = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['tot_geral'][1];
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->colaborador = $this->rs_grid->fields[0] ;  
       $this->desc_falta = $this->rs_grid->fields[1] ;  
       $this->tipo_falta_descripcion = $this->rs_grid->fields[2] ;  
       $this->fecha_falta = $this->rs_grid->fields[3] ;  
       $this->tipo_sancion = $this->rs_grid->fields[4] ;  
       $this->estado_sancion = $this->rs_grid->fields[5] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_consulta_faltas_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_consulta_faltas_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_consulta_faltas_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_consulta_faltas_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_consulta_faltas_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida']) {  
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-grid_consulta_faltas-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_consulta_faltas-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_consulta_faltas-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_consulta_faltas-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-d73a4d58\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_consulta_faltas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_consulta_faltas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_consulta_faltas_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_consulta_faltas_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_consulta_faltas_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_consulta_faltas_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pdf_res'])
               ...
               {
                   $groupByLabel = sprintf("AREA", "f.area_id");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_consulta_faltas']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_consulta_faltas']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_consulta_faltas']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_consulta_faltas']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida']) ? "grid_consulta_faltas_" : "";
   $this->css_sep = " ";
   $this->css_colaborador_label = $compl_css_emb . "css_colaborador_label";
   $this->css_colaborador_grid_line = $compl_css_emb . "css_colaborador_grid_line";
   $this->css_desc_falta_label = $compl_css_emb . "css_desc_falta_label";
   $this->css_desc_falta_grid_line = $compl_css_emb . "css_desc_falta_grid_line";
   $this->css_tipo_falta_descripcion_label = $compl_css_emb . "css_tipo_falta_descripcion_label";
   $this->css_tipo_falta_descripcion_grid_line = $compl_css_emb . "css_tipo_falta_descripcion_grid_line";
   $this->css_fecha_falta_label = $compl_css_emb . "css_fecha_falta_label";
   $this->css_fecha_falta_grid_line = $compl_css_emb . "css_fecha_falta_grid_line";
   $this->css_tipo_sancion_label = $compl_css_emb . "css_tipo_sancion_label";
   $this->css_tipo_sancion_grid_line = $compl_css_emb . "css_tipo_sancion_grid_line";
   $this->css_estado_sancion_label = $compl_css_emb . "css_estado_sancion_label";
   $this->css_estado_sancion_grid_line = $compl_css_emb . "css_estado_sancion_grid_line";
   $this->css_fecha_sancion_label = $compl_css_emb . "css_fecha_sancion_label";
   $this->css_fecha_sancion_grid_line = $compl_css_emb . "css_fecha_sancion_grid_line";
   $this->css_evidencia_label = $compl_css_emb . "css_evidencia_label";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_consulta_faltas__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_consulta_faltas-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_registro_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_registro_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left  " . $classColFld . $classColTitle . $classColActions . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_registro_label'] . "\" >\r\n");
   $nm_saida->saida("<style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_consulta_faltas_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 }
 function NM_label_colaborador()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['colaborador']) || $this->NM_cmp_hidden['colaborador'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_colaborador_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_colaborador_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "colaborador";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "g1.general_name";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_colaborador_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_colaborador_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
 ...
 function NM_label_desc_falta()
 {
   ...
   if (!isset($this->NM_cmp_hidden['desc_falta']) || $this->NM_cmp_hidden['desc_falta'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_desc_falta_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_desc_falta_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "desc_falta";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "fl.fault_name";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "fl.fault_name";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_desc_falta_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_desc_falta_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_tipo_falta_descripcion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['tipo_falta_descripcion']) || $this->NM_cmp_hidden['tipo_falta_descripcion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_tipo_falta_descripcion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tipo_falta_descripcion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_tipo_falta_descripcion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_tipo_falta_descripcion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_fecha_falta()
 {
   ...
   if (!isset($this->NM_cmp_hidden['fecha_falta']) || $this->NM_cmp_hidden['fecha_falta'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fecha_falta_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_falta_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $NM_cmp_class = "fecha_falta";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "f.fault_practitioner_date";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "f.fault_practitioner_date";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fecha_falta_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fecha_falta_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_tipo_sancion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['tipo_sancion']) || $this->NM_cmp_hidden['tipo_sancion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_tipo_sancion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tipo_sancion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "tipo_sancion";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "fr.sanction_type_name";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "fr.sanction_type_name";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_tipo_sancion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_tipo_sancion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_estado_sancion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['estado_sancion']) || $this->NM_cmp_hidden['estado_sancion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_estado_sancion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_estado_sancion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "estado_sancion";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "fp.sanction_description";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "fp.sanction_description";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_estado_sancion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_estado_sancion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_fecha_sancion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fecha_sancion']) || $this->NM_cmp_hidden['fecha_sancion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fecha_sancion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_sancion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $NM_cmp_class = "fecha_sancion";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "f.sanction_date";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "f.sanction_date";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fecha_sancion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fecha_sancion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_evidencia()
 {
   ...
   if (!isset($this->NM_cmp_hidden['evidencia']) || $this->NM_cmp_hidden['evidencia'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_evidencia_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_evidencia_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "evidencia";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "f.evidence";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "f.evidence";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_evidencia_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_evidencia_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_usuario_registro()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['usuario_registro']) || $this->NM_cmp_hidden['usuario_registro'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_usuario_registro_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_usuario_registro_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "usuario_registro";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "g2.general_name";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "g2.general_name";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_usuario_registro_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_usuario_registro_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_perfil_r()
 {
   ...
   if (!isset($this->NM_cmp_hidden['perfil_r']) || $this->NM_cmp_hidden['perfil_r'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_perfil_r_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_perfil_r_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "perfil_r";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "d2.division_name";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "d2.division_name";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_perfil_r_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_perfil_r_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_fecha_registro()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fecha_registro_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_registro_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $NM_cmp_class = "fecha_registro";
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "f.fault_register_date";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "f.fault_register_date";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fecha_registro_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fecha_registro_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['colaborador'])) ? $this->New_label['colaborador'] : "COLABORADOR";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['colaborador'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['desc_falta'])) ? $this->New_label['desc_falta'] : "DESC FALTA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['desc_falta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo_falta_descripcion'])) ? $this->New_label['tipo_falta_descripcion'] : "TIPO FALTA DESCRIPCION";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['tipo_falta_descripcion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha_falta'])) ? $this->New_label['fecha_falta'] : "FECHA FALTA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['fecha_falta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo_sancion'])) ? $this->New_label['tipo_sancion'] : "TIPO SANCION";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['tipo_sancion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['estado_sancion'])) ? $this->New_label['estado_sancion'] : "ESTADO SANCION";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['estado_sancion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha_sancion'])) ? $this->New_label['fecha_sancion'] : "FECHA SANCION";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['fecha_sancion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['evidencia'])) ? $this->New_label['evidencia'] : "EVIDENCIA";
   ...
   $SC_Label = (isset($this->New_label['fecha_registro'])) ? $this->New_label['fecha_registro'] : "FECHA REGISTRO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['labels']['fecha_registro'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_consulta_faltas']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cols_emb']))
               {
                   $cont_col = 0;
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_consulta_faltas#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_consulta_faltas#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-d73a4d58\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['area'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['area'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']);
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_consulta_faltas_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_area = " = " . $this->Db->qstr($this->area);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
                  ...
                  $temp = $cmp . "_Old";
                  if ($SC_arg_Gby[$cmp] != $this->$temp || $gb_ok || $NM_prim_qb)
                  {
                      $SC_lst_Gby[] = $cmp;
                      $gb_ok = true;
                  }
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby']][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Page_break_PDF'][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  $Qb_page = false;
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_fecha_registro_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_fecha_registro_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['mostra_edit'] != "N"){ 
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "grid_consulta_faltas/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_consulta_faltas&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "grid_consulta_faltas/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_consulta_faltas&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 $this->grid_fixed_column_no++;} 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_colaborador()
 {
      ...
      if (!isset($this->NM_cmp_hidden['colaborador']) || $this->NM_cmp_hidden['colaborador'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->colaborador));
              $conteudo_original = NM_encode_input(sc_strip_script($this->colaborador));
          }
          else {
              $conteudo = sc_strip_script($this->colaborador); 
              $conteudo_original = sc_strip_script($this->colaborador); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'colaborador', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'colaborador', $str_tem_display, $conteudo_original); 
          } 
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_colaborador_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_colaborador_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_colaborador_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_desc_falta()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['desc_falta']) || $this->NM_cmp_hidden['desc_falta'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->desc_falta));
              $conteudo_original = NM_encode_input(sc_strip_script($this->desc_falta));
          }
          else {
              $conteudo = sc_strip_script($this->desc_falta); 
              $conteudo_original = sc_strip_script($this->desc_falta); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'desc_falta', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'desc_falta', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_desc_falta_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_desc_falta_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_desc_falta_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_tipo_falta_descripcion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['tipo_falta_descripcion']) || $this->NM_cmp_hidden['tipo_falta_descripcion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->tipo_falta_descripcion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->tipo_falta_descripcion));
          }
          else {
              $conteudo = sc_strip_script($this->tipo_falta_descripcion); 
              $conteudo_original = sc_strip_script($this->tipo_falta_descripcion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tipo_falta_descripcion', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'tipo_falta_descripcion', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_tipo_falta_descripcion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_tipo_falta_descripcion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_tipo_falta_descripcion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fecha_falta()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fecha_falta']) || $this->NM_cmp_hidden['fecha_falta'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->fecha_falta)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->fecha_falta)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_falta', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecha_falta', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fecha_falta_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fecha_falta_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fecha_falta_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_tipo_sancion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['tipo_sancion']) || $this->NM_cmp_hidden['tipo_sancion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->tipo_sancion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->tipo_sancion));
          }
          else {
              $conteudo = sc_strip_script($this->tipo_sancion); 
              $conteudo_original = sc_strip_script($this->tipo_sancion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tipo_sancion', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'tipo_sancion', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_tipo_sancion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_tipo_sancion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_tipo_sancion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_estado_sancion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['estado_sancion']) || $this->NM_cmp_hidden['estado_sancion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->estado_sancion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->estado_sancion));
          }
          else {
              $conteudo = sc_strip_script($this->estado_sancion); 
              $conteudo_original = sc_strip_script($this->estado_sancion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'estado_sancion', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'estado_sancion', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_estado_sancion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_estado_sancion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_estado_sancion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fecha_sancion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fecha_sancion']) || $this->NM_cmp_hidden['fecha_sancion'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->fecha_sancion)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->fecha_sancion)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_sancion', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecha_sancion', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fecha_sancion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fecha_sancion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fecha_sancion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_evidencia()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['evidencia']) || $this->NM_cmp_hidden['evidencia'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->evidencia));
              $conteudo_original = NM_encode_input(sc_strip_script($this->evidencia));
          }
          else {
              $conteudo = sc_strip_script($this->evidencia); 
              $conteudo_original = sc_strip_script($this->evidencia); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'evidencia', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'evidencia', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_evidencia_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_evidencia_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_evidencia_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_usuario_registro()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['usuario_registro']) || $this->NM_cmp_hidden['usuario_registro'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->usuario_registro));
              $conteudo_original = NM_encode_input(sc_strip_script($this->usuario_registro));
          }
          else {
              $conteudo = sc_strip_script($this->usuario_registro); 
              $conteudo_original = sc_strip_script($this->usuario_registro); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'usuario_registro', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'usuario_registro', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
 ...
 function NM_grid_perfil_r()
 {
      ...
      if (!isset($this->NM_cmp_hidden['perfil_r']) || $this->NM_cmp_hidden['perfil_r'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->perfil_r));
              $conteudo_original = NM_encode_input(sc_strip_script($this->perfil_r));
          }
          else {
              $conteudo = sc_strip_script($this->perfil_r); 
              $conteudo_original = sc_strip_script($this->perfil_r); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'perfil_r', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'perfil_r', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_perfil_r_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_perfil_r_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_perfil_r_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fecha_registro()
 {
      ...
      if (!isset($this->NM_cmp_hidden['fecha_registro']) || $this->NM_cmp_hidden['fecha_registro'] != "off") { 
          ...
          $conteudo_original = NM_encode_input(sc_strip_script($this->fecha_registro)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_registro', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecha_registro', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fecha_registro_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fecha_registro_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fecha_registro_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 }
 function quebra_area_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global $$Var_name_gb, $Desc_Gb_Ant;
   $this->sc_proc_quebra_area = true; 
   $this->Tot->quebra_area_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_area = $$Var_name_gb;
   $conteudo = $tot_area[0] ;  
   $this->count_area = $tot_area[1];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->area)); 
   }
   else {
       $conteudo = sc_strip_script($this->area); 
   }
   $this->Lookup->lookup_sc_free_group_by_area($conteudo , $this->area) ; 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['area']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['area']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "AREA"; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_area = false; 
 } 
 function quebra_area_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $tot_area = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['area'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_area = 0; 
   $cont_quebra_area++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_consulta_faltas_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_consulta_faltas_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_consulta_faltas_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_consulta_faltas, 'grid_consulta_faltas'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_consulta_faltas_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_consulta_faltas_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_consulta_faltas_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_consulta_faltas, 'grid_consulta_faltas'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_consulta_faltas'][$this->NM_cont_body][$this->Tab_Nv_tree['area']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_consulta_faltas_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $this->Label_area = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_area .= "<tr>"; 
       $this->Label_area .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_area .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_area .= "</tr>"; 
   } 
   $this->Label_area .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   ...
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_area . $nm_fecha_pdf_old . "\r\n");
   ...
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['area'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_consulta_faltas'][$this->NM_cont_body][$this->Tab_Nv_tree['area']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_consulta_faltas_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("      <input type=\"hidden\" name=\"nmgp_schema\" value=\"\"/> \r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'])
          {
          ...
          $SC_Label_atu['colaborador'] = (isset($this->New_label['colaborador'])) ? $this->New_label['colaborador'] : 'COLABORADOR'; 
          $SC_Label_atu['desc_falta'] = (isset($this->New_label['desc_falta'])) ? $this->New_label['desc_falta'] : 'DESC FALTA'; 
          $SC_Label_atu['tipo_falta_descripcion'] = (isset($this->New_label['tipo_falta_descripcion'])) ? $this->New_label['tipo_falta_descripcion'] : 'TIPO FALTA DESCRIPCION'; 
          $SC_Label_atu['fecha_falta'] = (isset($this->New_label['fecha_falta'])) ? $this->New_label['fecha_falta'] : 'FECHA FALTA'; 
          $SC_Label_atu['tipo_sancion'] = (isset($this->New_label['tipo_sancion'])) ? $this->New_label['tipo_sancion'] : 'TIPO SANCION'; 
          $SC_Label_atu['estado_sancion'] = (isset($this->New_label['estado_sancion'])) ? $this->New_label['estado_sancion'] : 'ESTADO SANCION'; 
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          $nm_saida->saida("         </td> \r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_modal'])
        {
      ...
      if (is_file($this->Ini->path_css . "schemas.ini") && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $tst_schema = explode("/", $this->Ini->str_schema_all);
          $nm_saida->saida("          <select class=\"" . $this->css_css_toolbar_obj . "\" style=\"vertical-align: middle;\" name=\"nmgp_schema_x\" onChange=\"document.F0_top.nmgp_opcao.value='change_schema'; sc_ind = this.selectedIndex; document.F0_top.nmgp_schema.value=this.options[sc_ind].value; document.F0_top.submit(); return false\">\r\n");
          foreach ($arq_sch as $cada_schema)
          {
              $par_schema = explode("#nm#", $cada_schema);
              $obj_sel = ($tst_schema[0] == $par_schema[0]) ? " selected" : "";
              $nm_saida->saida("           <option value=\"" . NM_encode_input($par_schema[0]) . "\"" . $obj_sel . ">" . $par_schema[1] . "</option>\r\n");
          }
          $nm_saida->saida("          </select>\r\n");
          $NM_btn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      ...
      if ($this->nmgp_botoes['group_3'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']))
      {
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_consulta_faltas&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_consulta_faltas&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['json'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_json_res = "n";
          $Tem_json_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_json_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "json_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_json_res . "&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['SC_Gb_Free_cmp']))
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'])?'none':'';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "colaborador")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "colaborador";
                           $lin_obj = $this->grid_search_colaborador($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "desc_falta")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "desc_falta";
                           $lin_obj = $this->grid_search_desc_falta($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "fecha_falta")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "fecha_falta";
                           $lin_obj = $this->grid_search_fecha_falta($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "usuario_registro")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "usuario_registro";
                           $lin_obj = $this->grid_search_usuario_registro($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('colaborador','desc_falta','fecha_falta','usuario_registro');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_colaborador($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_colaborador_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_colaborador_cond_" . $ind . "' name='cond_grid_search_colaborador_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"colaborador\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_colaborador_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $colaborador = $val_cmp;
       if ($colaborador != "")
       {
       $colaborador_look = (is_string($colaborador) ? substr($this->Db->qstr($colaborador), 1, -1) : $colaborador); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct g1.general_name from " . $this->Ini->nm_tabela . " where g1.general_name = '$colaborador_look' order by g1.general_name"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$colaborador]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$colaborador];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_colaborador_val_" . $ind . "' name='val_grid_search_colaborador_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_colaborador" . $ind . "' name='val_grid_search_colaborador_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_desc_falta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_desc_falta_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_desc_falta_cond_" . $ind . "' name='cond_grid_search_desc_falta_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"desc_falta\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_desc_falta_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $desc_falta = $val_cmp;
       if ($desc_falta != "")
       {
       $desc_falta_look = (is_string($desc_falta) ? substr($this->Db->qstr($desc_falta), 1, -1) : $desc_falta); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct fl.fault_name from " . $this->Ini->nm_tabela . " where fl.fault_name = '$desc_falta_look' order by fl.fault_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
       ...
       if (isset($nmgp_def_dados[0][$desc_falta]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$desc_falta];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_desc_falta_val_" . $ind . "' name='val_grid_search_desc_falta_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_desc_falta" . $ind . "' name='val_grid_search_desc_falta_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_fecha_falta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_fecha_falta_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_fecha_falta_cond_" . $ind . "' name='cond_grid_search_fecha_falta_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_change_bw(\"fecha_falta\", $ind)'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_fecha_falta_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_ano_val_" . $ind . "' name='val_grid_search_fecha_falta_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_mes_val_" . $ind . "' name='val_grid_search_fecha_falta_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_dia_val_" . $ind . "' name='val_grid_search_fecha_falta_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "h")
           {
               $val_cmp = (isset($val_r['hor'])) ? $val_r['hor'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_hor_val_" . $ind . "' name='val_grid_search_fecha_falta_hor_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "i")
           {
               $val_cmp = (isset($val_r['min'])) ? $val_r['min'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_min_val_" . $ind . "' name='val_grid_search_fecha_falta_min_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "s")
           {
               $val_cmp = (isset($val_r['seg'])) ? $val_r['seg'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_seg_val_" . $ind . "' name='val_grid_search_fecha_falta_seg_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "&nbsp;";
       ...
       $lin_obj .= "       <span id=\"grid_fecha_falta_in_2_" . $ind . "\" style=\"display:" . $display_in_2 . "\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__ano_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__mes_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__dia_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "h")
           {
               $val_cmp = (isset($val_r['hor'])) ? $val_r['hor'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__hor_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__hor_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "i")
           {
               $val_cmp = (isset($val_r['min'])) ? $val_r['min'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__min_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__min_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "s")
           {
               $val_cmp = (isset($val_r['seg'])) ? $val_r['seg'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fecha_falta_v2__seg_val_" . $ind . "' name='val_grid_search_fecha_falta_v2__seg_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "&nbsp;";
       $lin_obj .= "" . $date_format_show . "";
   ...
   function grid_search_usuario_registro($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_usuario_registro_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_usuario_registro_cond_" . $ind . "' name='cond_grid_search_usuario_registro_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"usuario_registro\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_usuario_registro_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $usuario_registro = $val_cmp;
       if ($usuario_registro != "")
       {
       $usuario_registro_look = (is_string($usuario_registro) ? substr($this->Db->qstr($usuario_registro), 1, -1) : $usuario_registro); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct g2.general_name from " . $this->Ini->nm_tabela . " where g2.general_name = '$usuario_registro_look' order by g2.general_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
       ...
       if (isset($nmgp_def_dados[0][$usuario_registro]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$usuario_registro];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_usuario_registro_val_" . $ind . "' name='val_grid_search_usuario_registro_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_usuario_registro" . $ind . "' name='val_grid_search_usuario_registro_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function lookup_ajax_colaborador($colaborador)
   {
       $colaborador = substr($this->Db->qstr($colaborador), 1, -1);
       $this->NM_case_insensitive = false;
       $colaborador_look = (is_string($colaborador) ? substr($this->Db->qstr($colaborador), 1, -1) : $colaborador); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct g1.general_name from " . $this->Ini->nm_tabela . " where  g1.general_name like '%" . $colaborador . "%' order by g1.general_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_consulta_faltas_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_desc_falta($desc_falta)
   {
       $desc_falta = substr($this->Db->qstr($desc_falta), 1, -1);
       $this->NM_case_insensitive = false;
       $desc_falta_look = (is_string($desc_falta) ? substr($this->Db->qstr($desc_falta), 1, -1) : $desc_falta); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct fl.fault_name from " . $this->Ini->nm_tabela . " where  fl.fault_name like '%" . $desc_falta . "%' order by fl.fault_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_usuario_registro($usuario_registro)
   {
       $usuario_registro = substr($this->Db->qstr($usuario_registro), 1, -1);
       $this->NM_case_insensitive = false;
       $usuario_registro_look = (is_string($usuario_registro) ? substr($this->Db->qstr($usuario_registro), 1, -1) : $usuario_registro); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct g2.general_name from " . $this->Ini->nm_tabela . " where  g2.general_name like '%" . $usuario_registro . "%' order by g2.general_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Proyecto_gestion_faltas/grid_consulta_faltas";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_consulta_faltas_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_consulta_faltas_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_consulta_faltas_valida_hora(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_consulta_faltas_valida_min(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_consulta_faltas_valida_seg(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       $nm_saida->saida("     if (obj.value != \"\" && (obj.value < 0 || obj.value > 59))\r\n");
       $nm_saida->saida("     {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_mes'] =  'sc_grid_consulta_faltas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_dia'] =  'sc_grid_consulta_faltas_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_hor'] =  'sc_grid_consulta_faltas_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_min'] =  'sc_grid_consulta_faltas_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_seg'] =  'sc_grid_consulta_faltas_valida_seg(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_v2__mes'] =  'sc_grid_consulta_faltas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_v2__dia'] =  'sc_grid_consulta_faltas_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_v2__hor'] =  'sc_grid_consulta_faltas_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_v2__min'] =  'sc_grid_consulta_faltas_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fecha_falta_v2__seg'] =  'sc_grid_consulta_faltas_valida_seg(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_mes']", 'value' => 'sc_grid_consulta_faltas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_dia']", 'value' => 'sc_grid_consulta_faltas_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_hor']", 'value' => 'sc_grid_consulta_faltas_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_min']", 'value' => 'sc_grid_consulta_faltas_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_seg']", 'value' => 'sc_grid_consulta_faltas_valida_seg(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_v2__mes']", 'value' => 'sc_grid_consulta_faltas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_v2__dia']", 'value' => 'sc_grid_consulta_faltas_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_v2__hor']", 'value' => 'sc_grid_consulta_faltas_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_v2__min']", 'value' => 'sc_grid_consulta_faltas_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fecha_falta_v2__seg']", 'value' => 'sc_grid_consulta_faltas_valida_seg(this)');
       } 
       ...
       $nm_saida->saida("                 if (tmp == 'fecha_falta')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_hor';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_min';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_seg';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_v2__dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_v2__mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_v2__hor';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_v2__min';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fecha_falta_v2__seg';\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'colaborador')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_colaborador = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_colaborador\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                             field: \"colaborador\",\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_colaborador_val_\" + x_colaborador).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_colaborador_val_\" + x_colaborador).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'desc_falta')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_desc_falta = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_desc_falta\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                             nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                             origem: \"grid\",\r\n");
       $nm_saida->saida("                             field: \"desc_falta\",\r\n");
       $nm_saida->saida("                             max_itens: \"10\",\r\n");
       $nm_saida->saida("                             cod_desc: \"N\",\r\n");
       $nm_saida->saida("                             script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           },\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_desc_falta_val_\" + x_desc_falta).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_desc_falta_val_\" + x_desc_falta).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'usuario_registro')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_usuario_registro = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_usuario_registro\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                             nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                             origem: \"grid\",\r\n");
       $nm_saida->saida("                             field: \"usuario_registro\",\r\n");
       $nm_saida->saida("                             max_itens: \"10\",\r\n");
       $nm_saida->saida("                             cod_desc: \"N\",\r\n");
       $nm_saida->saida("                             script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           },\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_usuario_registro_val_\" + x_usuario_registro).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_usuario_registro_val_\" + x_usuario_registro).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'colaborador')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'desc_falta')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'fecha_falta')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'usuario_registro')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][0]) &&
                (
                    (
                    ...
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_consulta_faltas_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_consulta_faltas_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_consulta_faltas', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_consulta_faltas\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_consulta_faltas_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_consulta_faltas_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_consulta_faltas/grid_consulta_faltas_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_consulta_faltas_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['grid_consulta_faltas_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_consulta_faltas@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_consulta_faltas_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_consulta_faltas_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_consulta_faltas_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_consulta_faltas']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_consulta_faltas_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta_faltas']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_consulta_faltas')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_consulta_faltas', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
