...
<?php
   ...
   $Ord_Cmp = new grid_consulta_faltas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_consulta_faltas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["colaborador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["colaborador"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["colaborador"] : "COLABORADOR";
   ...
   $tab_labels["desc_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["desc_falta"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["desc_falta"] : "DESC FALTA";
   ...
   $tab_labels["tipo_falta_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["tipo_falta_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["tipo_falta_descripcion"] : "TIPO FALTA DESCRIPCION";
   ...
   $tab_labels["fecha_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["fecha_falta"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["fecha_falta"] : "FECHA FALTA";
   ...
   $tab_labels["tipo_sancion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["tipo_sancion"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["tipo_sancion"] : "TIPO SANCION";
   ...
   $tab_labels["estado_sancion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["estado_sancion"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["estado_sancion"] : "ESTADO SANCION";
   ...
   $tab_labels["fecha_sancion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["fecha_sancion"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["fecha_sancion"] : "FECHA SANCION";
   ...
   $tab_labels["evidencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["evidencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['labels']["evidencia"] : "EVIDENCIA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_consulta_faltas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_consulta_faltas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
