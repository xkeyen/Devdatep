<?php
@session_start() ;
$_SESSION['scriptcase']['resumen004']['sc_process_barr'] = true;
require_once('../resumen004/index.php');
unset($_SESSION['scriptcase']['resumen004']['sc_process_barr']);
$ExportCtrl = new resumen004_export_control;
$ExportCtrl->Export_barr();

class resumen004_export_control
{
