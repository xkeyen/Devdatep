...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "resumen001/resumen001_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new resumen001_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_resumen001.zip";
          $this->Arquivo   .= "_resumen001" . $this->Xls_tp;
          $this->Tit_doc    = "resumen001" . $this->Xls_tp;
          $this->Tit_zip    = "resumen001.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_area_registro = " = " . $this->Db->qstr($this->area_registro);
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_total_faltas()
   {
         ...
         if (is_numeric($this->total_faltas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->total_faltas);
         $this->Xls_col++;
   }
   //----- porcentaje_faltas
   function NM_export_porcentaje_faltas()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->porcentaje_faltas = $this->porcentaje_faltas / 100;
         $this->porcentaje_faltas = NM_charset_to_utf8($this->porcentaje_faltas);
         if (is_numeric($this->porcentaje_faltas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '0.00%';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porcentaje_faltas);
         $this->Xls_col++;
   }
   //----- area_registro
   ...
   //----- total_faltas
   function NM_sub_cons_total_faltas()
   {
         $this->total_faltas = NM_charset_to_utf8($this->total_faltas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_faltas;
   ...
   //----- porcentaje_faltas
   function NM_sub_cons_porcentaje_faltas()
   {
         $this->porcentaje_faltas = $this->porcentaje_faltas / 100;
         $this->porcentaje_faltas = NM_charset_to_utf8($this->porcentaje_faltas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porcentaje_faltas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['nolabel'])
       {
 ...
 function quebra_area_registro_AREA_REGISTRO($area_registro) 
 {
   ...
   function quebra_area_registro_AREA_REGISTRO_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['resumen001']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
