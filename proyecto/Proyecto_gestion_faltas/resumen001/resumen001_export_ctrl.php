<?php
@session_start() ;
$_SESSION['scriptcase']['resumen001']['sc_process_barr'] = true;
require_once('../resumen001/index.php');
unset($_SESSION['scriptcase']['resumen001']['sc_process_barr']);
$ExportCtrl = new resumen001_export_control;
$ExportCtrl->Export_barr();

class resumen001_export_control
{
