...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____resumen001"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____resumen001"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen001']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['resumen001']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen001']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['resumen001']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['resumen001']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['resumen001']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['resumen001']['embutida_filho'] as $ind => $sc_init)
          {
