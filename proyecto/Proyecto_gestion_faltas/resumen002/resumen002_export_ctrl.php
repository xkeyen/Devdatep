<?php
@session_start() ;
$_SESSION['scriptcase']['resumen002']['sc_process_barr'] = true;
require_once('../resumen002/index.php');
unset($_SESSION['scriptcase']['resumen002']['sc_process_barr']);
$ExportCtrl = new resumen002_export_control;
$ExportCtrl->Export_barr();

class resumen002_export_control
{
