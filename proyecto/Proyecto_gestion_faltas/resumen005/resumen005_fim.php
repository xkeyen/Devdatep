...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____resumen005"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Proyecto_gestion_faltas_____resumen005"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen005']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['resumen005']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen005']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['resumen005']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['resumen005']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['resumen005']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['resumen005']['embutida_filho'] as $ind => $sc_init)
          {
