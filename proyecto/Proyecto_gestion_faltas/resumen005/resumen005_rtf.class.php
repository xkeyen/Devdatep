...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_falta()
   {
         ...
         $this->falta = str_replace('<', '&lt;', $this->falta);
         $this->falta = str_replace('>', '&gt;', $this->falta);
         $this->Texto_tag .= "<td>" . $this->falta . "</td>\r\n";
   }
   //----- cantidad
   ...
   function NM_export_total_sanciones()
   {
         ...
         $this->total_sanciones = str_replace('<', '&lt;', $this->total_sanciones);
         $this->total_sanciones = str_replace('>', '&gt;', $this->total_sanciones);
         $this->Texto_tag .= "<td>" . $this->total_sanciones . "</td>\r\n";
   }
