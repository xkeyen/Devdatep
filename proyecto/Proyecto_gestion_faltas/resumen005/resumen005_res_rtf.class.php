...
class resumen005_res_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "resumen005.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['pivot_group_by'];
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['arr_export']['data'];
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen005']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
