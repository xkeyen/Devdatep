<?php
@session_start() ;
$_SESSION['scriptcase']['resumen005']['sc_process_barr'] = true;
require_once('../resumen005/index.php');
unset($_SESSION['scriptcase']['resumen005']['sc_process_barr']);
$ExportCtrl = new resumen005_export_control;
$ExportCtrl->Export_barr();

class resumen005_export_control
{
