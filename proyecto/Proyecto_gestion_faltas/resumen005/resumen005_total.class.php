...
class resumen005_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['resumen005']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['resumen005']['campos_busca']))
      { 
