...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_desc_falta"  <?php echo $str_hide_desc_falta?>><INPUT  type="text" id="SC_desc_falta" name="desc_falta" value="<?php echo NM_encode_input($desc_falta) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
