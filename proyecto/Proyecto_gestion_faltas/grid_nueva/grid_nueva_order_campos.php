...
<?php
   ...
   $Ord_Cmp = new grid_nueva_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_nueva_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['colaborador'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['colaborador'] = "colaborador";
   }
   else
   {
       $tab_def_campos['colaborador'] = "g1.general_name";
   }
   $tab_labels["colaborador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["colaborador"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["colaborador"] : "COLABORADOR";
   $tab_ger_campos['desc_falta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desc_falta'] = "desc_falta";
   }
   else
   {
       $tab_def_campos['desc_falta'] = "fl.fault_name";
   }
   $tab_labels["desc_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["desc_falta"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["desc_falta"] : "DESC FALTA";
   $tab_ger_campos['tipo_falta_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipo_falta_descripcion'] = "tipo_falta_descripcion";
   }
   else
   {
       $tab_def_campos['tipo_falta_descripcion'] = "ft.fault_type_description";
   }
   $tab_labels["tipo_falta_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["tipo_falta_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["tipo_falta_descripcion"] : "TIPO FALTA DESCRIPCION";
   $tab_ger_campos['fecha_falta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fecha_falta'] = "fecha_falta";
   }
   else
   {
       $tab_def_campos['fecha_falta'] = "f.fault_practitioner_date";
   }
   $tab_labels["fecha_falta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["fecha_falta"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["fecha_falta"] : "FECHA FALTA";
   $tab_ger_campos['tipo_sancion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipo_sancion'] = "tipo_sancion";
   }
   else
   {
       $tab_def_campos['tipo_sancion'] = "fr.sanction_type_name";
   }
   $tab_labels["tipo_sancion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["tipo_sancion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["tipo_sancion"] : "SANCION";
   $tab_ger_campos['estado_sancion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['estado_sancion'] = "estado_sancion";
   }
   else
   {
       $tab_def_campos['estado_sancion'] = "fp.sanction_description";
   }
   $tab_labels["estado_sancion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["estado_sancion"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["estado_sancion"] : "ESTADO SANCION";
   $tab_ger_campos['fecha_registro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fecha_registro'] = "fecha_registro";
   }
   else
   {
       $tab_def_campos['fecha_registro'] = "f.fault_register_date";
   }
   $tab_labels["fecha_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["fecha_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["fecha_registro"] : "FECHA REGISTRO";
   $tab_ger_campos['evidencia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evidencia'] = "evidencia";
   }
   else
   {
       $tab_def_campos['evidencia'] = "f.evidence";
   }
   $tab_labels["evidencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["evidencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["evidencia"] : "EVIDENCIA";
   $tab_ger_campos['usuario_registro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['usuario_registro'] = "usuario_registro";
   }
   else
   {
       $tab_def_campos['usuario_registro'] = "g2.general_name";
   }
   $tab_labels["usuario_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["usuario_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["usuario_registro"] : "USUARIO";
   $tab_ger_campos['area_registro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['area_registro'] = "area_registro";
   }
   else
   {
       $tab_def_campos['area_registro'] = "fq.area_name";
   }
   $tab_labels["area_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["area_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['labels']["area_registro"] : "AREA USUARIO";
   $tab_ger_campos['desc_falta'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_nueva']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_nueva']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_nueva_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_nueva']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
