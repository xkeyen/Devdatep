<?php  
  ...
  session_start() ;
  class grid_nueva_form_teste
  {
  function grid_nueva_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_nueva</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_nueva"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_nueva_form_teste();
  $frm_teste->grid_nueva_teste();
?>
