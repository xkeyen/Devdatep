<?php
@session_start() ;
$_SESSION['scriptcase']['resumen003']['sc_process_barr'] = true;
require_once('../resumen003/index.php');
unset($_SESSION['scriptcase']['resumen003']['sc_process_barr']);
$ExportCtrl = new resumen003_export_control;
$ExportCtrl->Export_barr();

class resumen003_export_control
{
