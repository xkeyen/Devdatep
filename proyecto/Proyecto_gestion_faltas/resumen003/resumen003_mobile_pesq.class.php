...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "ingreso_de_faltas";$Nm_numeric[] = "porcentaje";$Nm_numeric[] = "ingreso_de_faltas";$Nm_numeric[] = "porcentaje";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_persona_cond" name="persona_cond" onChange="nm_campos_between(document.getElementById('id_vis_persona'), this, 'persona')">
      ...
      <br><span id="id_hide_persona"  <?php echo $str_hide_persona?>><?php
      if ($persona != "")
      {
      $persona_look = (is_string($persona) ? substr($this->Db->qstr($persona), 1, -1) : $persona); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_porcentaje_cond" name="porcentaje_cond" onChange="nm_campos_between(document.getElementById('id_vis_porcentaje'), this, 'porcentaje')">
